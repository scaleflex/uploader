import { E as Qe, F as Ze, G as ae, H as dt, I as H, J as Ve, K as ct, L as pt, M as ut, N as Ue, O as ht, Q as ft, R as xt } from "./sfx-uploader-CBE6hdR8.js";
import { T as ai, V as li, W as di } from "./sfx-uploader-CBE6hdR8.js";
import { LitElement as E, css as v, nothing as m, html as a, svg as _ } from "lit";
import { property as c, state as x } from "lit/decorators.js";
import { classMap as et } from "lit/directives/class-map.js";
function tt(l, e, t = !1) {
  const s = (e == null ? void 0 : e.language) ?? "en", i = l.model ?? [], o = l.store ?? {}, r = i.find((f) => f.applies_to === "FILES");
  let n = (r == null ? void 0 : r.groups) ?? [];
  if (Array.isArray(e == null ? void 0 : e.fields)) {
    const f = new Set(e.fields);
    n = n.map((g) => ({
      ...g,
      fields: g.fields.filter((b) => f.has(b.ckey))
    })).filter((g) => g.fields.length > 0);
  }
  n = n.map((f) => ({
    ...f,
    fields: f.fields.filter((g) => !g.hide)
  })).filter((f) => f.fields.length > 0);
  const d = n.flatMap((f) => f.fields), u = new Map(d.map((f) => [f.key, f])), p = o.force_filling_metadata_on_upload === !0, h = o.regional_variants_groups ?? [];
  return {
    groups: n,
    fields: d,
    fieldsByKey: u,
...
const mt = "https://hub.scaleflex.com/api", ie = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map();
async function ti(l, e, t, s) {
  const i = ie.get(t);
  if (i) return i;
  const o = G.get(t);
  if (o) return o;
...
async function gt(l, e, t) {
  var p, h, f, g, b;
  const i = `${(t == null ? void 0 : t.hubApiBase) ?? mt}/project/${encodeURIComponent(e)}`, o = (t == null ? void 0 : t.hubHeaders) ?? l, r = await fetch(i, { headers: o });
  if (!r.ok)
    throw new Error(
  ...
  const u = (t == null ? void 0 : t.productsEnabled) ?? ((b = (g = d == null ? void 0 : d.airstore) == null ? void 0 : g.ui) == null ? void 0 : b.products_enabled) === !0;
  return tt(d.metadata, t, u);
}
function ii(l) {
  var e;
  l ? (ie.delete(l), (e = G.get(l)) == null || e.catch(() => {
  }), G.delete(l)) : (ie.clear(), G.clear());
}
function it(l, e, t) {
  let s = e;
  switch (l.regional_variants_group_uuid && s != null && typeof s == "object" && !Array.isArray(s) && (s = s[t ?? "en"]), l.type) {
    case "geopoint":
      return bt(s);
    case "boolean":
...
function ve(l, e, t, s) {
  ...
  switch (l.type) {
    ...
    case "date": {
      if (!e)
        ...
        const r = e instanceof Date ? e : new Date(e), n = r.getFullYear(), d = String(r.getMonth() + 1).padStart(2, "0"), u = String(r.getDate()).padStart(2, "0");
        i = `${n}-${d}-${u}`;
      }
      break;
    }
  ...
  if (l.regional_variants_group_uuid) {
    const r = s ?? "en";
    return { ...((o = t == null ? void 0 : t.meta) == null ? void 0 : o[l.key]) ?? {}, [r]: i };
  }
  return i;
}
function bt(l) {
...
function si(l, e) {
  ...
  return {
    search(r, n, d) {
      if (s && clearTimeout(s), i && i.abort(), o = !1, !n.trim()) {
        d([]);
        return;
      }
      s = setTimeout(async () => {
        ...
        try {
          const p = `${t}/v5/metadata/autocomplete?q=${encodeURIComponent(n.trim())}&meta_key=_${encodeURIComponent(r)}&limit=20`, h = await fetch(p, { headers: e, signal: i.signal });
          if (o) return;
          if (!h.ok) {
            d([]);
            return;
          ...
          if (o) return;
          const g = ((u = f.data) == null ? void 0 : u.tags) ?? f.tags ?? [];
          d(
            g.map((b) => ({
              sid: b.sid || void 0,
    ...
    cancel() {
      o = !0, s && clearTimeout(s), i && i.abort();
    }
  };
}
const Ye = { base_node: null, nodes: [] };
function ri(l, e) {
  const t = l.replace(/\/$/, "");
  let s = null, i = null, o = !1, r = null, n = null;
  return {
    fetchTaxonomies() {
      return n || (n = (async () => {
        var u;
        ...
        try {
          ...
          const h = await p.json(), f = (h == null ? void 0 : h.taxonomies) ?? ((u = h == null ? void 0 : h.data) == null ? void 0 : u.taxonomies) ?? (h == null ? void 0 : h.data) ?? h;
    ...
    async fetchNodes(d, u = "", p = 10) {
      r && r.abort(), r = new AbortController();
      try {
        const h = new URLSearchParams();
        u && h.set("base", u), h.set("limit", String(p));
        const f = `${t}/v5/taxonomy/${encodeURIComponent(d)}/nodes?${h.toString()}`, g = await fetch(f, { headers: e, signal: r.signal });
        if (!g.ok) return Ye;
        const b = await g.json(), R = (b == null ? void 0 : b.data) ?? b;
        return {
          base_node: (R == null ? void 0 : R.base_node) ?? null,
          nodes: Array.isArray(R == null ? void 0 : R.nodes) ? R.nodes : []
        };
      } catch {
        return Ye;
      }
    ...
    autocomplete(d, u, p) {
      if (s && clearTimeout(s), i && i.abort(), o = !1, !u.trim()) {
        p([]);
        return;
      }
      s = setTimeout(async () => {
        ...
        i = new AbortController();
        try {
          const f = `${t}/v5/metadata/autocomplete?q=${encodeURIComponent(u.trim())}&meta_key=_${encodeURIComponent(d)}`, g = await fetch(f, {
            headers: e,
            signal: i.signal
          });
          if (o) return;
          ...
          if (o) return;
          const R = ((h = b == null ? void 0 : b.data) == null ? void 0 : h.tags) ?? (b == null ? void 0 : b.tags) ?? [];
          p(
            R.map((B) => ({
    ...
    cancel() {
      o = !0, s && clearTimeout(s), i && i.abort(), r && r.abort();
    }
  };
}
var vt = Object.defineProperty, j = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && vt(e, t, i), i;
};
...
j([
  c({ attribute: !1 })
], T.prototype, "taxonodes");
j([
  c({ type: Boolean })
], T.prototype, "disabled");
j([
  x()
], T.prototype, "_collapsed");
customElements.define("sfx-metadata-form", T);
const oe = v`
...
`;
var _t = Object.defineProperty, M = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && _t(e, t, i), i;
};
const Se = class Se extends E {
  constructor() {
    super(...arguments), this.config = null, this.taxonomyEntry = null, this.disabled = !1, this._error = null, this._dispatching = !1, this._handleChildBlur = (e) => {
      this._dispatching || (e.stopPropagation(), this._onFieldBlur(e));
    };
  }
  get _isRequired() {
    return Qe(this.field, this.config ?? void 0);
  }
  _onFieldBlur(e) {
    var r;
    const { key: t, value: s } = e.detail, i = Ze(this.field, s, this.config ?? void 0);
    if (i) {
      this._error = i;
      return;
    }
    this._error = null;
    const o = ve(this.field, s, void 0, (r = this.config) == null ? void 0 : r.language);
  ...
  _renderField(e, t) {
    ...
    switch (e.type) {
      ...
      case "taxonomy-node":
        return a`<sfx-meta-taxonomy-node-field .field=${e} .value=${t} .taxonomyService=${this.taxonomyService} .entry=${this.taxonomyEntry} ?disabled=${s}></sfx-meta-taxonomy-node-field>`;
      case "boolean":
  ...
  render() {
    ...
    const e = this.field;
    if (!e) return m;
    const t = it(e, this.value, (o = this.config) == null ? void 0 : o.language), i = e.type === "textarea" ? "field-row field-row--top" : "field-row";
    return a`
...
var wt = Object.defineProperty, ye = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && wt(e, t, i), i;
};
...
Ce.styles = [oe];
let pe = Ce;
customElements.define("sfx-meta-text-field", pe);
...
let ue = Ee;
customElements.define("sfx-meta-textarea-field", ue);
var kt = Object.defineProperty, _e = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && kt(e, t, i), i;
};
...
customElements.define("sfx-meta-select-field", W);
var $t = Object.defineProperty, we = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && $t(e, t, i), i;
};
...
we([
  x()
], X.prototype, "_activeIndex");
customElements.define("sfx-meta-multi-select-field", X);
function V(l, e) {
  var t, s;
  return ((t = l.label) == null ? void 0 : t.trim().toLowerCase()) === ((s = e.label) == null ? void 0 : s.trim().toLowerCase());
}
function rt(l) {
  return l.trim().replace(/\s+/g, " ");
}
function St(l) {
  return rt(l).replace(/\s/g, "-");
}
function ne(l) {
  return { label: rt(l), value: St(l) };
}
var Ct = Object.defineProperty, Z = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Ct(e, t, i), i;
};
const Ae = class Ae extends S {
  ...
  _addTag(e) {
    if (this._tags.some((s) => V(s, e))) return;
  ...
  _removeTag(e) {
    const t = this._tags.filter((s) => !V(s, e));
    this.value = t, this._emit("field-change", t);
  }
  _onBlur() {
    ...
    if (this._activeIndex >= t && (this._activeIndex = Math.max(t - 1, -1)), !(t === 0 && e.key !== "Enter"))
      switch (e.key) {
        ...
        case "Enter": {
          ...
          this._activeIndex >= 0 && this._activeIndex < s.length ? this._addTag(s[this._activeIndex]) : this._activeIndex === s.length && this._canCreate ? this._addTag(ne(this._query)) : this._activeIndex === -1 && this._canCreate ? this._addTag(ne(this._query)) : this._activeIndex === -1 && s.length && this._addTag(s[0]);
          break;
        }
      }
  }
  get _suggestions() {
    var o;
    const e = this._query.toLowerCase().trim(), t = this._tags, s = (((o = this.field) == null ? void 0 : o.possible_values) ?? []).map((r) => ({ value: r.api_value || r.internal_unique_value, label: r.label })).filter((r) => !t.some((n) => V(n, r))).filter((r) => !e || r.label.toLowerCase().includes(e)), i = this._results.filter(
      (r) => !t.some((n) => V(n, r)) && !s.some((n) => V(n, r))
    );
    return [...s, ...i];
  }
  get _canCreate() {
    ...
    const t = ne(e);
    return !this._tags.some((s) => V(s, t)) && !this._suggestions.some((s) => V(s, t));
  }
  render() {
    var i, o;
      ...
      this._activeIndex = n;
          ...
          ${this._canCreate ? a`
            <div class="option create ${s === this._activeIndex ? "active" : ""}"
              @mousedown=${(r) => {
      r.preventDefault(), this._addTag(ne(this._query));
    }}
              @mouseenter=${() => {
      this._activeIndex = s;
    }}>
...
Z([
  c({ attribute: !1 })
], P.prototype, "autocomplete");
Z([
  x()
], P.prototype, "_query");
Z([
  x()
], P.prototype, "_results");
Z([
  x()
], P.prototype, "_loading");
Z([
  x()
], P.prototype, "_dropdownOpen");
Z([
  x()
], P.prototype, "_activeIndex");
customElements.define("sfx-meta-tags-field", P);
var Et = Object.defineProperty, ot = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Et(e, t, i), i;
};
const U = [
  ...
  get _currentLabel() {
    ...
    return ((t = U.find((s) => s.value === e)) == null ? void 0 : t.label) ?? "";
  }
  disconnectedCallback() {
    super.disconnectedCallback(), document.removeEventListener("mousedown", this._boundOutsideClick);
  }
  _openDropdown() {
    ...
    this._activeIndex = Math.max(U.findIndex((t) => t.value === e), 0), document.addEventListener("mousedown", this._boundOutsideClick), this.updateComplete.then(() => {
      var t;
  ...
  _onKeydown(e) {
    ...
    switch (e.key) {
      case "ArrowDown":
        e.preventDefault(), this._activeIndex = Math.min(this._activeIndex + 1, U.length - 1), this._scrollActive();
        break;
      case "ArrowUp":
        e.preventDefault(), this._activeIndex = Math.max(this._activeIndex - 1, 0), this._scrollActive();
        break;
      case "Home":
        ...
        break;
      case "End":
        e.preventDefault(), this._activeIndex = U.length - 1, this._scrollActive();
        break;
      case "Enter":
      case " ":
        this._activeIndex >= 0 && this._activeIndex < U.length && (e.preventDefault(), this._onSelect(U[this._activeIndex], !0));
        break;
    }
  }
  render() {
...
customElements.define("sfx-meta-boolean-field", se);
...
De.styles = [oe];
let he = De;
customElements.define("sfx-meta-number-field", he);
...
let fe = ze;
customElements.define("sfx-meta-date-field", fe);
...
let xe = Re;
customElements.define("sfx-meta-geo-point-field", xe);
var Tt = Object.defineProperty, A = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Tt(e, t, i), i;
};
const J = { uuid: "__root__", name: "", ltree: "" }, qe = class qe extends S {
  constructor() {
    super(...arguments), this.entry = null, this._open = !1, this._query = "", this._drillStack = [J], this._currentNodes = [], this._searchResults = [], this._loading = !1, this._activeIndex = -1, this._resolvedTaxonomyUuid = null, this._taxonomyResolutionFailed = !1, this._boundOutsideClick = this._onOutsideClick.bind(this), this._searchSeq = 0;
  }
  get _taxonomySuid() {
    var t, s;
    const e = ((s = (t = this.field) == null ? void 0 : t.model) == null ? void 0 : s.parameters) ?? void 0;
  ...
  async _resolveTaxonomyUuid() {
    ...
    const t = await this.taxonomyService.fetchTaxonomies(), s = t.find((n) => n.suid === e);
    return s ? (this._resolvedTaxonomyUuid = s.uuid, this._taxonomyResolutionFailed = !1, s.uuid) : (console.warn(
      `[sfx-uploader] taxonomy '${e}' not found in catalogue. Field "${((i = this.field) == null ? void 0 : i.ckey) ?? ((o = this.field) == null ? void 0 : o.key)}" model:`,
  ...
  _seedDrillStackFromEntry() {
    const e = this.entry;
    if (!(e != null && e.lineage)) return [J];
    const t = e.lineage.split(".").filter(Boolean);
    if (t.length <= 1) return [J];
    const s = t.slice(0, -1), o = (e.path ? e.path.split(/\s*[›>]\s*/).filter(Boolean) : []).slice(0, -1), r = [J];
    let n = "";
    for (let d = 0; d < s.length; d++)
      n = n ? `${n}.${s[d]}` : s[d], r.push({
        uuid: `__seed_${n}`,
        name: o[d] ?? s[d],
        ltree: n
      });
  ...
  async _loadCurrentNodes() {
    ...
    const s = this._drillStack[this._drillStack.length - 1].ltree, i = await this.taxonomyService.fetchNodes(t, s);
    e === this._searchSeq && (this._currentNodes = i.nodes, this._loading = !1, this._activeIndex = -1);
  }
  _onSearchInput(e) {
    var i;
    const t = e.target.value;
    if (this._query = t, this._activeIndex = -1, !t.trim() || !this.taxonomyService) {
      this._searchResults = [], this._loading = !1, (i = this.taxonomyService) == null || i.cancel();
      return;
    }
    this._loading = !0;
    const s = ++this._searchSeq;
    this.taxonomyService.autocomplete(this.field.ckey, t, (o) => {
      s === this._searchSeq && (this._searchResults = o, this._loading = !1);
    });
  }
  async _drillInto(e) {
    this._drillStack = [
  ...
  _buildTreeEntry(e) {
    const s = [...this._drillStack.filter((i) => i.uuid !== J.uuid).map((i) => i.name), e.name].filter(Boolean).join(" › ");
    return {
      uuid: e.uuid,
      suid: e.slug,
      name: e.name,
  ...
  _buildAutocompleteEntry(e) {
    const t = e.path || e.tag, s = t.split(/\s*[›>]\s*/).filter(Boolean).pop() ?? e.tag;
    return {
      uuid: e.uuid,
      suid: e.suid,
      name: s,
  ...
  _selectTreeNode(e) {
    const t = e.uuid || e.slug, s = this._buildTreeEntry(e);
    this.value = t, this.entry = s, this._emit("field-change", t), this._emitTaxonomyEntry(s), this._close();
  }
  _selectAutocomplete(e) {
    const t = e.suid || e.uuid, s = this._buildAutocompleteEntry(e);
    this.value = t, this.entry = s, this._emit("field-change", t), this._emitTaxonomyEntry(s), this._close();
  }
  _clear(e) {
  ...
  _onKeydown(e) {
    var s, i;
    if (e.key === "Escape") {
      this._open = !1, this._activeIndex = -1, document.removeEventListener("mousedown", this._boundOutsideClick), (s = this.taxonomyService) == null || s.cancel(), this._emit("field-escape"), (i = this.renderRoot.querySelector(".trigger")) == null || i.focus();
      return;
    }
  ...
  _renderBreadcrumb() {
    ...
    return e.length <= 1 ? m : a`
      <div class="breadcrumb">
        ${e.map((t, s) => {
      const i = s === e.length - 1, o = t.uuid === J.uuid ? "Root" : t.name;
      return a`
  ...
  _renderTree() {
    if (this._loading && this._currentNodes.length === 0)
      return a`<div class="empty">Loading…</div>`;
    if (this._taxonomyResolutionFailed)
      return a`<div class="empty">Taxonomy not found</div>`;
    if (this._currentNodes.length === 0)
      return a`<div class="empty">No nodes</div>`;
    const e = this._selectedScalar;
    return a`
      <div class="scroll" role="listbox">
        ${this._currentNodes.map((t, s) => {
      const i = t.children.count_direct > 0, o = !!e && (e === t.uuid || e === t.slug);
      return a`
  ...
  _renderSearch() {
    return this._loading && this._searchResults.length === 0 ? a`<div class="empty">Loading…</div>` : this._searchResults.length === 0 ? a`<div class="empty">No results</div>` : a`
      <div class="scroll" role="listbox">
  ...
  render() {
    ...
    if (!this._taxonomySuid)
      return a`<div class="misconfigured" role="alert">Field is missing taxonomy config</div>`;
    const e = ((o = this.field) == null ? void 0 : o.title) ?? "", t = e ? `Select ${e.toLowerCase()}` : "Select a node", s = this._displayPath, i = !!s;
    return a`
...
A([
  x()
], k.prototype, "_drillStack");
A([
  x()
], k.prototype, "_currentNodes");
A([
  x()
], k.prototype, "_searchResults");
A([
  x()
...
A([
  x()
], k.prototype, "_resolvedTaxonomyUuid");
A([
  x()
], k.prototype, "_taxonomyResolutionFailed");
customElements.define("sfx-meta-taxonomy-node-field", k);
const re = "This field is not supported during upload. You can edit it later in the asset library.", nt = a`
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ${_`<rect x="3" y="7" width="10" height="7" rx="1.5"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/>`}
  </svg>
`, Pe = class Pe extends E {
  render() {
    return a`
      <div
        class="unsupported"
...
Pe.styles = v`
  ...
  `;
let me = Pe;
customElements.define("sfx-meta-unsupported-field", me);
var It = Object.defineProperty, ee = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && It(e, t, i), i;
};
const Fe = class Fe extends E {
  constructor() {
    super(...arguments), this.taxonomyEntry = null, this.disabled = !1;
  }
  render() {
...
ee([
  c({ attribute: !1 })
], F.prototype, "taxonomyService");
ee([
  c({ attribute: !1 })
], F.prototype, "taxonomyEntry");
ee([
  c({ type: Boolean })
], F.prototype, "disabled");
customElements.define("sfx-metadata-field-edit", F);
var At = Object.defineProperty, ke = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && At(e, t, i), i;
};
    ...
    switch (t) {
      ...
      case "multi-select":
        return !Array.isArray(e) || e.length === 0 ? "" : e.map((n) => {
          var u;
          const d = (u = this.field.possible_values) == null ? void 0 : u.find(
...
function ge(l, e) {
  return l === "DELETE" ? de.has(e) || ce.has(e) : !0;
}
function Dt(l, e, t, s) {
  const i = de.has(s), o = ce.has(s);
  switch (l) {
    case "SET":
      return t;
    case "ADD": {
      if (i) {
        ...
        if (s === "tags") {
          ...
          for (const f of n) {
            const g = typeof f == "string" ? f : String(f);
            p.has(g) || (p.add(g), h.push(g));
          }
          return h;
        }
        const d = new Set(r.map((p) => JSON.stringify(p))), u = [...r];
        for (const p of n) {
          const h = JSON.stringify(p);
          d.has(h) || (d.add(h), u.push(p));
        }
        return u;
      }
      if (o) {
    ...
    case "DELETE": {
      if (i) {
        ...
        if (s === "tags") {
          ...
          return r.filter(
            (p) => !u.has(typeof p == "string" ? p : String(p))
          );
        }
        const d = new Set(
          n.map((u) => JSON.stringify(u))
        );
        return r.filter(
          (u) => !d.has(JSON.stringify(u))
        );
      }
      if (o) {
        const r = typeof t == "string" ? t : "";
...
function at(l, e, t, s, i) {
  const o = i ?? "en", r = !!l.regional_variants_group_uuid, n = {
    meta: { [l.key]: e }
  }, d = ve(l, t, n, i), u = (g) => r && g !== null && typeof g == "object" && !Array.isArray(g), p = u(e) ? e[o] : e, h = u(d) ? d[o] : d, f = Dt(s, p, h, l.type);
  return r ? {
    ...u(e) ? e : {},
    [o]: f
  } : f;
...
`;
var Kt = Object.defineProperty, w = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Kt(e, t, i), i;
};
const Ke = class Ke extends E {
  constructor() {
    super(...arguments), this.files = [], this.config = null, this.initialFieldKey = null, this._activeFieldKey = "", this._staged = /* @__PURE__ */ new Map(), this._stagedTaxonodes = /* @__PURE__ */ new Map(), this._selected = /* @__PURE__ */ new Set(), this._sortAsc = !0, this._pendingOp = null, this._confirmVisible = !1, this._missingRequiredFieldKey = null, this._missingRequiredKeys = /* @__PURE__ */ new Set(), this._confirmResolve = null, this._originalFiles = /* @__PURE__ */ new Map(), this._onKeyDown = async (e) => {
      ...
      H(s) && (!i || ge(t, i.type)) ? this._pendingOp = null : this._pendingOp = { operation: t, value: s };
      ...
      if (!t) return;
      const { operation: s, value: i, taxonomyEntry: o } = e.detail, r = (d = this.config) == null ? void 0 : d.language, n = [];
      for (const u of this._selected) {
        const p = this._staged.get(u), h = p != null && p.has(t.key) ? p.get(t.key) : this._originalValue(u, t.key) ?? null, f = at(
          t,
          h,
          i,
          s,
      ...
      const { fileId: t, fieldKey: s, entry: i } = e.detail;
      this._setStagedTaxonodeSingle(t, s, i);
      ...
      const e = [], t = [];
      for (const [i, o] of this._staged) {
        if (!this._originalFiles.get(i)) continue;
        const n = {}, d = {};
        for (const [u, p] of o) {
          const h = this._originalValue(i, u);
          if (JSON.stringify(p) !== JSON.stringify(h))
            if (Ve(u)) {
              const f = Ue(u);
              if (!f) continue;
              const g = p === "" || p == null;
              f === "position" ? d.position = g ? void 0 : Number(p) : d.ref = g ? void 0 : String(p);
            } else
              n[u] = p;
        }
        Object.keys(n).length > 0 && e.push({ fileId: i, meta: n }), Object.keys(d).length > 0 && t.push({ fileId: i, product: d });
      }
      this.dispatchEvent(
      ...
      const s = [];
      for (const [i, o] of this._stagedTaxonodes) {
        const r = this._originalFiles.get(i);
        if (!r) continue;
        const n = r.taxonodes ?? {}, d = {};
        for (const [u, p] of o) {
          const h = n[u] ?? null;
          JSON.stringify(p ?? null) !== JSON.stringify(h ?? null) && (d[u] = p ?? null);
        }
        Object.keys(d).length > 0 && s.push({ fileId: i, taxonodes: d });
      }
      s.length > 0 && this.dispatchEvent(
  ...
  _initStaged() {
    var n, d;
    const e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Set(), i = /* @__PURE__ */ new Map(), o = ((n = this.schema) == null ? void 0 : n.productsEnabled) === !0;
    for (const u of this.files) {
      const p = /* @__PURE__ */ new Map();
      if (u.meta)
        for (const [h, f] of Object.entries(u.meta))
          p.set(h, f);
      if (o) {
        const h = u.product;
        h.ref !== void 0 && p.set(ct, h.ref), h.position !== void 0 && p.set(pt, h.position);
      }
      e.set(u.id, p), u.taxonodes && t.set(
        u.id,
        new Map(Object.entries(u.taxonodes))
      ), s.add(u.id), i.set(u.id, u);
    }
    this._staged = e, this._stagedTaxonodes = t, this._selected = s, this._originalFiles = i;
  ...
  _setStagedTaxonodeBulk(e, t, s) {
    const i = new Map(this._stagedTaxonodes);
    for (const o of e) {
      const r = new Map(i.get(o) ?? /* @__PURE__ */ new Map());
      r.set(t, s), i.set(o, r);
    }
    this._stagedTaxonodes = i;
  }
  _setStagedTaxonodeSingle(e, t, s) {
    const i = new Map(this._stagedTaxonodes), o = new Map(i.get(e) ?? /* @__PURE__ */ new Map());
    o.set(t, s), i.set(e, o), this._stagedTaxonodes = i;
  }
  // -----------------------------------------------------------------------
  ...
  _originalValue(e, t) {
    var i, o;
    const s = this._originalFiles.get(e);
    if (s) {
      if (Ve(t)) {
        const r = Ue(t);
        return r ? (i = s.product) == null ? void 0 : i[r] : void 0;
      }
      return (o = s.meta) == null ? void 0 : o[t];
    }
  }
  /**
  ...
  _refreshMissingRequired() {
    ...
    i && (this._missingRequiredKeys = e);
  }
  /** Fields where ANY file has a non-empty staged value that differs from original. */
  get _filledFields() {
    var t;
    const e = /* @__PURE__ */ new Set();
    for (const s of ((t = this.schema) == null ? void 0 : t.fields) ?? [])
      for (const [i, o] of this._staged) {
        const r = o.get(s.key), n = this._originalValue(i, s.key);
        if (r !== void 0 && !H(r) && JSON.stringify(r) !== JSON.stringify(n)) {
          e.add(s.key);
          break;
        }
      }
  ...
  get _hasPendingValue() {
    return this._pendingOp != null && !H(this._pendingOp.value);
  }
  ...
  render() {
    var u, p, h;
    if (!((p = (u = this.schema) == null ? void 0 : u.fields) != null && p.length))
      return a`
      ...
      `;
    const e = this._activeField, t = this._sortedFiles, s = this._selected.size === this.files.length && this.files.length > 0, i = this._selected.size > 0 && !s, o = this._missingRequiredFieldKey, r = o ? ((h = this.schema.fieldsByKey.get(o)) == null ? void 0 : h.title) || o : "", n = o != null && this._activeFieldKey === o, d = o != null && !n;
    return a`
      <div class="fm-overlay" @click=${this._onClose}>
        <div class="fm-modal" @click=${(f) => f.stopPropagation()}>
          <!-- Top bar -->
...
var Bt = Object.defineProperty, Y = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Bt(e, t, i), i;
};
const Ne = class Ne extends E {
  ...
  _isRequired(e) {
    return Qe(e, this.config ?? void 0);
  }
  _toggleGroup(e) {
    const t = new Set(this._collapsed);
    t.has(e) ? t.delete(e) : t.add(e), this._collapsed = t;
  ...
  updated(e) {
    var s, i;
    if ((s = super.updated) == null || s.call(this, e), !e.has("activeFieldKey") || !this.activeFieldKey) return;
        ...
        (s) => a`
                  ...
                  >
                    ...
                    ${this._isRequired(s) ? a`<span
                          class=${et({
          "field-required": !0,
          unmet: this.missingRequiredKeys.has(s.key)
        })}
                          aria-hidden="true"
                        >*</span>` : m}
                  </button>
...
Y([
  c({ attribute: !1 })
], O.prototype, "missingRequiredKeys");
Y([
  c({ attribute: !1 })
], O.prototype, "config");
Y([
...
Y([
  x()
], O.prototype, "_isNarrow");
customElements.define("sfx-bulk-meta-sidebar", O);
var jt = Object.defineProperty, K = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && jt(e, t, i), i;
}, q;
const D = (q = class extends E {
  constructor() {
    super(...arguments), this.config = null, this.selectedCount = 0, this._operation = "SET", this._value = void 0, this._pendingTaxonode = null, this._opDropdownOpen = !1, this._availableOps = [], this._onTaxonomyEntryChange = (e) => {
      ...
      if (!t || !q._ENTER_APPLY_TYPES.has(t)) return;
  ...
  get _effectiveValue() {
    var e;
    return this._value ?? q._emptyValueForType((e = this.field) == null ? void 0 : e.type);
  }
  willUpdate(e) {
    e.has("field") && this.field && (this._availableOps = Ot(this.field.type), this._operation = "SET", this._value = void 0, this._pendingTaxonode = null, this._emitPendingChange());
  }
  _onOpSelect(e) {
  ...
  _onApply() {
    ...
    ), this._value = void 0, this._pendingTaxonode = null, this._operation === "DELETE" && !ge(this._operation, (t = this.field) == null ? void 0 : t.type) && (this._operation = "SET"), this._emitPendingChange());
  }
  get _isApplyDisabled() {
    var e, t;
    return this.selectedCount === 0 ? !0 : this._operation === "DELETE" ? de.has((e = this.field) == null ? void 0 : e.type) ? H(this._value) : ce.has((t = this.field) == null ? void 0 : t.type) ? H(this._value) : !1 : H(this._value);
  }
  render() {
...
}, q.styles = [qt], q._ENTER_APPLY_TYPES = /* @__PURE__ */ new Set([
  "text",
  "numeric",
  "decimal2",
  "date",
...
K([
  x()
], D.prototype, "_pendingTaxonode");
K([
  x()
], D.prototype, "_opDropdownOpen");
let Mt = D;
customElements.define("sfx-bulk-meta-op-bar", Mt);
var Vt = Object.defineProperty, N = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Vt(e, t, i), i;
};
const Be = class Be extends E {
  ...
  _getTaxonodeEntry(e) {
    ...
    return t != null && t.has(this.field.key) ? t.get(this.field.key) ?? null : ((s = e.taxonodes) == null ? void 0 : s[this.field.key]) ?? null;
  }
  render() {
    return a`
      ${this.files.map(
...
var Ut = Object.defineProperty, z = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Ut(e, t, i), i;
};
const je = class je extends E {
  constructor() {
    super(...arguments), this.taxonomyEntry = null, this.selected = !1, this.pendingOp = null, this.config = null, this._error = null, this._onFieldBlur = (e) => {
      var r;
      e.stopPropagation();
      const { value: t } = e.detail, s = Ze(this.field, t, this.config ?? void 0);
      if (s) {
        this._error = s;
        return;
      }
  ...
  _computePreviewValue() {
    ...
    return !e || !this.field ? this.value : at(
      this.field,
      this.value,
      e.value,
      e.operation,
...
const Yt = /* @__PURE__ */ new Set(["multi-select", "tags"]);
function He(l, e, t) {
  return !e.regional_variants_group_uuid || l == null || typeof l != "object" || Array.isArray(l) ? l : l[t ?? "en"];
}
function Ge(l) {
  return Array.isArray(l) ? l : [];
}
function We(l) {
  return l == null || l === "" || Array.isArray(l) && l.length === 0 ? !0 : typeof l == "object" && !Array.isArray(l) ? !Object.values(l).some(
    (e) => e != null && e !== ""
  ) : !1;
}
function be(l, e) {
  var s;
  const t = (s = l.possible_values) == null ? void 0 : s.find(
...
function Jt(l, e) {
  const t = l.map((n) => typeof n == "string" ? n : String(n)), s = e.map((n) => typeof n == "string" ? n : String(n)), i = new Set(t), o = new Set(s), r = [];
  for (const n of s)
    r.push({ label: n, state: i.has(n) ? "kept" : "added" });
  for (const n of t)
    o.has(n) || r.push({ label: n, state: "removed" });
  return r;
}
function Ht(l, e, t) {
  const s = new Set(l.map((r) => JSON.stringify(r))), i = new Set(e.map((r) => JSON.stringify(r))), o = [];
  for (const r of e) {
    const n = JSON.stringify(r), d = typeof r == "string" ? be(t, r) : String(r);
    o.push({ label: d, state: s.has(n) ? "kept" : "added" });
  }
  for (const r of l) {
    const n = JSON.stringify(r);
    if (!i.has(n)) {
      const d = typeof r == "string" ? be(t, r) : String(r);
...
function Gt(l, e, t, s) {
  const i = s == null ? void 0 : s.language, o = He(e, l, i), r = He(t, l, i);
  if (Yt.has(l.type)) {
    const n = Ge(o), d = Ge(r);
    return l.type === "tags" ? { kind: "array", items: Jt(n, d) } : { kind: "array", items: Ht(n, d, l) };
  }
  return {
    kind: "scalar",
    oldDisplay: Xe(l, o),
...
var Wt = Object.defineProperty, te = (l, e, t, s) => {
  for (var i = void 0, o = l.length - 1, r; o >= 0; o--)
    (r = l[o]) && (i = r(e, t, i) || i);
  return i && Wt(e, t, i), i;
};
const Me = class Me extends E {
  ...
  _renderTaxonomyScalar() {
    var r, n;
    const e = ((r = this.newTaxonomyEntry) == null ? void 0 : r.path) ?? "", t = ((n = this.oldTaxonomyEntry) == null ? void 0 : n.path) ?? "", s = !t, i = !e, o = `Will change from ${s ? "empty" : t} to ${i ? "empty" : e}`;
    return a`
      <div class="diff-wrap diff-scalar-text" aria-label="Bulk operation preview">
...
te([
  c({ attribute: !1 })
], L.prototype, "oldTaxonomyEntry");
te([
  c({ attribute: !1 })
], L.prototype, "newTaxonomyEntry");
te([
  c({ attribute: !1 })
], L.prototype, "config");
...
export {
  ...
  ii as clearSchemaCache,
  si as createTagsAutocomplete,
  ri as createTaxonomyService,
  ai as deepMergeMeta,
  ti as fetchMetadataSchema,
  li as getFilesWithMissingRequired,
  di as isAssetHasMetadataValue,
  H as isEmpty,
  it as mapValueFromBackend,
  ve as mapValueToBackend,
