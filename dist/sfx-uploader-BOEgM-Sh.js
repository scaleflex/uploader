...
var Zl = Object.defineProperty, Q = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Zl(e, t, o), o;
};
      ...
      if ((((s = (o = this.config) == null ? void 0 : o.connectors) == null ? void 0 : s.providers) ?? []).includes(e)) {
        if (Yr.has(e)) {
          if (!customElements.get("sfx-search-provider-browser")) {
            const { SfxSearchProviderBrowser: a } = await import("./search-provider-browser-CkYnl6c3.js");
          ...
          const { SfxProviderBrowser: a } = await import("./provider-browser-CmajnQOO.js");
  ...
  async _preloadMetadataSchema(e) {
    ...
    if (!(!t || !this._apiBase || !this._authHeaders))
      try {
        ...
        } = await import("./index-MJxikhqz.js"), [l, c] = await Promise.all([
