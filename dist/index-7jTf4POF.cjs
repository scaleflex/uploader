"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const x=require("./sfx-uploader-DJY_2MqA.cjs"),o=require("lit"),d=require("lit/decorators.js");function se(a,e){const t=(e==null?void 0:e.language)??"en",s=a.model??[],i=a.store??{},n=s.find(c=>c.applies_to==="FILES");let r=(n==null?void 0:n.groups)??[];if(Array.isArray(e==null?void 0:e.fields)){const c=new Set(e.fields);r=r.map(f=>({...f,fields:f.fields.filter(m=>c.has(m.ckey))})).filter(f=>f.fields.length>0)}r=r.map(c=>({...c,fields:c.fields.filter(f=>!f.hide)})).filter(c=>c.fields.length>0);const l=r.flatMap(c=>c.fields),p=new Map(l.map(c=>[c.key,c])),u=i.force_filling_metadata_on_upload===!0,h=i.regional_variants_groups??[];return{groups:r,fields:l,fieldsByKey:p,forceFillingOnUpload:u,regionalVariantsGroups:h,language:t}}const je="https://hub.scaleflex.com/api",N=new Map,F=new Map;async function Ke(a,e,t,s){const i=N.get(t);if(i)return i;const n=F.get(t);if(n)return n;if(s!=null&&s.rawMetadata){const l=se(s.rawMetadata,s);return N.set(t,l),l}const r=Ne(e,t,s);F.set(t,r);try{const l=await r;return N.set(t,l),l}finally{F.delete(t)}}async function Ne(a,e,t){var u,h,c;const i=`${(t==null?void 0:t.hubApiBase)??je}/project/${encodeURIComponent(e)}`,n=(t==null?void 0:t.hubHeaders)??a,r=await fetch(i,{headers:n});if(!r.ok)throw new Error(`Failed to fetch metadata schema (HTTP ${r.status})`);const l=await r.json(),p=((h=(u=l.data)==null?void 0:u.project)==null?void 0:h.data)??((c=l.project)==null?void 0:c.data);if(!(p!=null&&p.metadata))throw new Error("No metadata in project response");return se(p.metadata,t)}function Me(a){var e;a?(N.delete(a),(e=F.get(a))==null||e.catch(()=>{}),F.delete(a)):(N.clear(),F.clear())}function re(a,e,t){let s=e;switch(a.regional_variants_group_uuid&&s!=null&&typeof s=="object"&&!Array.isArray(s)&&(s=s[t??"en"]),a.type){case"geopoint":return Ve(s);case"boolean":return s===!0?"true":s===!1?"false":"null";case"date":return s?new Date(s):null;case"decimal2":return s!=null?String(s):"";case"tags":return Array.isArray(s)?s.map(i=>typeof i=="string"?{value:i,label:i}:i):[];case"multi-select":return s||[];default:return s??""}}function J(a,e,t,s){var n;let i;switch(a.type){case"geopoint":{const r=e;!r||r.latitude===""||r.latitude==null||r.longitude===""||r.longitude==null?i=null:i=`(${r.latitude},${r.longitude})`;break}case"boolean":e==="true"?i=!0:e==="false"?i=!1:i=null;break;case"date":{if(!e)i=null;else{const r=e instanceof Date?e:new Date(e),l=r.getFullYear(),p=String(r.getMonth()+1).padStart(2,"0"),u=String(r.getDate()).padStart(2,"0");i=`${l}-${p}-${u}`}break}case"tags":i=Array.isArray(e)?e.map(r=>(r==null?void 0:r.label)??""):[];break;case"select-one":i=e===""?null:e;break;case"numeric":{if(e===""||e==null){i=null;break}const r=Number(e);i=Number.isFinite(r)?Math.round(r):null;break}case"decimal2":{if(e===""||e==null){i=null;break}const r=Number(e);i=Number.isFinite(r)?r:null;break}default:i=e}if(a.regional_variants_group_uuid){const r=s??"en";return{...((n=t==null?void 0:t.meta)==null?void 0:n[a.key])??{},[r]:i}}return i}function Ve(a){if(typeof a=="string"){const e=/\(([^)]+)\)/.exec(a);if(e){const t=e[1].split(",");if(t.length===2)return{latitude:t[0].trim(),longitude:t[1].trim()}}}return{latitude:"",longitude:""}}function He(a,e){let t=null,s=null,i=!1;return{search(n,r,l){if(t&&clearTimeout(t),s&&s.abort(),i=!1,!r.trim()){l([]);return}t=setTimeout(async()=>{var p;s=new AbortController;try{const u=`${a}/v5/metadata/autocomplete?q=${encodeURIComponent(r.trim())}&meta_key=_${encodeURIComponent(n)}&limit=20`,h=await fetch(u,{headers:e,signal:s.signal});if(i)return;if(!h.ok){l([]);return}const c=await h.json();if(i)return;const f=((p=c.data)==null?void 0:p.tags)??c.tags??[];l(f.map(m=>({sid:m.sid||void 0,value:m.tag||m.value||m.label||"",label:m.tag||m.label||m.value||""})))}catch{i||l([])}},200)},cancel(){i=!0,t&&clearTimeout(t),s&&s.abort()}}}var Ye=Object.defineProperty,q=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&Ye(e,t,i),i};const ce=class ce extends o.LitElement{constructor(){super(...arguments),this.schema=null,this.meta={},this.config=null,this.disabled=!1,this._collapsed=new Set}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_renderGroup(e){const t=!this._collapsed.has(e.uuid);return o.html`
      <div class="group">
  ...
  `;let k=ce;q([d.property({attribute:!1})],k.prototype,"schema");q([d.property({attribute:!1})],k.prototype,"meta");q([d.property({attribute:!1})],k.prototype,"config");q([d.property({attribute:!1})],k.prototype,"autocomplete");q([d.property({type:Boolean})],k.prototype,"disabled");q([d.state()],k.prototype,"_collapsed");customElements.define("sfx-metadata-form",k);const H=o.css`
...
`;var Ue=Object.defineProperty,B=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&Ue(e,t,i),i};const he=class he extends o.LitElement{constructor(){super(...arguments),this.config=null,this.disabled=!1,this._error=null,this._dispatching=!1,this._handleChildBlur=e=>{this._dispatching||(e.stopPropagation(),this._onFieldBlur(e))}}get _isRequired(){return x.isFieldRequired(this.field,this.config??void 0)}_onFieldBlur(e){var r;const{key:t,value:s}=e.detail,i=x.validateField(this.field,s,this.config??void 0);if(i){this._error=i;return}this._error=null;const n=J(this.field,s,void 0,(r=this.config)==null?void 0:r.language);this._dispatching=!0,this.dispatchEvent(new CustomEvent("field-blur",{detail:{key:t,value:n},bubbles:!0,composed:!0})),this._dispatching=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("field-blur",this._handleChildBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("field-blur",this._handleChildBlur)}_renderField(e,t){const s=this.disabled;switch(e.type){case"text":case"attachment-uri":return o.html`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`;case"textarea":return o.html`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-textarea-field>`;case"select-one":return o.html`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-select-field>`;case"multi-select":return o.html`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-multi-select-field>`;case"tags":return o.html`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${s}></sfx-meta-tags-field>`;case"boolean":return o.html`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return o.html`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-number-field>`;case"date":return o.html`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-date-field>`;case"geopoint":return o.html`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-geo-point-field>`;default:return o.html`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`}}render(){var n;const e=this.field;if(!e)return o.nothing;const t=re(e,this.value,(n=this.config)==null?void 0:n.language),i=e.type==="textarea"?"field-row field-row--top":"field-row";return o.html`
    ...
    `}};he.styles=[Je];let $=he;B([d.property({attribute:!1})],$.prototype,"field");B([d.property({attribute:!1})],$.prototype,"value");B([d.property({attribute:!1})],$.prototype,"config");B([d.property({attribute:!1})],$.prototype,"autocomplete");B([d.property({type:Boolean})],$.prototype,"disabled");B([d.state()],$.prototype,"_error");customElements.define("sfx-metadata-field",$);var Ge=Object.defineProperty,ne=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&Ge(e,t,i),i};class b extends o.LitElement{constructor(){super(...arguments),this.value="",this.disabled=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{key:this.field.key,...t!==void 0?{value:t}:{}},bubbles:!0,composed:!0}))}}ne([d.property({attribute:!1})],b.prototype,"field");ne([d.property({attribute:!1})],b.prototype,"value");ne([d.property({type:Boolean})],b.prototype,"disabled");const ue=class ue extends b{_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var s,i;const e=((s=this.field)==null?void 0:s.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return o.html`
      <input
        type="text"
        .value=${this.value??""}
      ...
      />
    `}};ue.styles=[H];let W=ue;customElements.define("sfx-meta-text-field",W);const fe=class fe extends b{firstUpdated(){const e=this.renderRoot.querySelector("textarea");e&&this._autoResize(e)}_autoResize(e){e.style.height="auto",e.style.height=`${Math.max(80,e.scrollHeight)}px`}_onInput(e){const t=e.target;this._autoResize(t),this._emit("field-change",t.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var s,i;const e=((s=this.field)==null?void 0:s.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return o.html`
      <textarea
        .value=${this.value??""}
        placeholder=${((i=this.field)==null?void 0:i.placeholder)||t}
        ?disabled=${this.disabled}
    ...
    `];let C=ge;j([d.property({attribute:!1})],C.prototype,"autocomplete");j([d.state()],C.prototype,"_query");j([d.state()],C.prototype,"_results");j([d.state()],C.prototype,"_loading");j([d.state()],C.prototype,"_dropdownOpen");j([d.state()],C.prototype,"_activeIndex");customElements.define("sfx-meta-tags-field",C);var et=Object.defineProperty,Le=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&et(e,t,i),i};const O=[{label:"True",value:"true"},{label:"False",value:"false"}],be=class be extends b{constructor(){super(...arguments),this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _currentLabel(){var t;if(this.value==null)return"";const e=String(this.value);return((t=O.find(s=>s.value===e))==null?void 0:t.label)??""}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_openDropdown(){this._open=!0;const e=this.value==null?"":String(this.value);this._activeIndex=Math.max(O.findIndex(t=>t.value===e),0),document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".dropdown"))==null||t.focus()})}_closeAndSubmit(e=!1){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-blur",this.value),e&&this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".trigger"))==null||t.focus()})}_onOutsideClick(e){e.composedPath().includes(this)||this._closeAndSubmit()}_onSelect(e,t=!1){this.value=e.value,this._emit("field-change",e.value),this._closeAndSubmit(t)}_clear(e){e.stopPropagation(),this.value=null,this._emit("field-change",null),this._emit("field-blur",null)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){var t;if(e.key==="Escape"){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-escape"),(t=this.renderRoot.querySelector(".trigger"))==null||t.focus();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,O.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=O.length-1,this._scrollActive();break;case"Enter":case" ":this._activeIndex>=0&&this._activeIndex<O.length&&(e.preventDefault(),this._onSelect(O[this._activeIndex],!0));break}}render(){var i,n;const e=this.value==null?"":String(this.value),t=((i=this.field)==null?void 0:i.title)??"",s=t?`Select ${t.toLowerCase()}`:"Select an option";return o.html`
      ...
      `:o.nothing}
    `}};be.styles=[oe];let M=be;Le([d.state()],M.prototype,"_open");Le([d.state()],M.prototype,"_activeIndex");customElements.define("sfx-meta-boolean-field",M);const ve=class ve extends b{get _step(){var e;return((e=this.field)==null?void 0:e.type)==="decimal2"?"0.01":"1"}get _inputMode(){var e;return((e=this.field)==null?void 0:e.type)==="decimal2"?"decimal":"numeric"}_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var e;return o.html`
      <input
        type="number"
        step=${this._step}
    ...
    `];let Z=ye;customElements.define("sfx-meta-date-field",Z);const _e=class _e extends b{get _geo(){const e=this.value;return{latitude:(e==null?void 0:e.latitude)??"",longitude:(e==null?void 0:e.longitude)??""}}_onInput(e,t){const s=t.target.value,i={...this._geo,[e]:s};this.value=i,this._emit("field-change",i)}_onBlur(e){const t=e.relatedTarget;t&&this.renderRoot.contains(t)||this._emit("field-blur",this._geo)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){const e=this._geo;return o.html`
      <div class="grid">
        <div>
  ...
  `;let V=ke;Re([d.property({attribute:!1})],V.prototype,"field");Re([d.property({attribute:!1})],V.prototype,"value");customElements.define("sfx-metadata-field-view",V);const de=new Set(["multi-select","tags","integer-list"]),pe=new Set(["text","textarea","attachment-uri"]);function st(a){return de.has(a)?[{key:"SET",label:"Set"},{key:"ADD",label:"Add to"},{key:"DELETE",label:"Remove from"}]:pe.has(a)?[{key:"SET",label:"Set"},{key:"ADD",label:"Append"},{key:"DELETE",label:"Remove"}]:[{key:"SET",label:"Set"},{key:"DELETE",label:"Clear"}]}function te(a,e){return a==="DELETE"?de.has(e)||pe.has(e):!0}function rt(a,e,t,s){const i=de.has(s),n=pe.has(s);switch(a){case"SET":return t;case"ADD":{if(i){const r=Array.isArray(e)?e:[],l=Array.isArray(t)?t:[];if(l.length===0)return r;if(s==="tags"){const h=new Set(r.map(f=>f)),c=[...r];for(const f of l){const m=typeof f=="string"?f:String(f);h.has(m)||(h.add(m),c.push(m))}return c}const p=new Set(r.map(h=>JSON.stringify(h))),u=[...r];for(const h of l){const c=JSON.stringify(h);p.has(c)||(p.add(c),u.push(h))}return u}if(n){const r=typeof t=="string"?t:"";if(!r)return e??"";const l=typeof e=="string"?e:"";return l?`${l} ${r}`:r}return t}case"DELETE":{if(i){const r=Array.isArray(e)?e:[],l=Array.isArray(t)?t:[];if(l.length===0)return r;if(s==="tags"){const u=new Set(l.map(h=>typeof h=="string"?h:String(h)));return r.filter(h=>!u.has(typeof h=="string"?h:String(h)))}const p=new Set(l.map(u=>JSON.stringify(u)));return r.filter(u=>!p.has(JSON.stringify(u)))}if(n){const r=typeof t=="string"?t:"";return r?(typeof e=="string"?e:"").replaceAll(r,"").replace(/\s{2,}/g," ").trim():""}return s==="geopoint"?{latitude:"",longitude:""}:null}default:return t}}function qe(a,e,t,s,i){const n=i??"en",r=!!a.regional_variants_group_uuid,l={meta:{[a.key]:e}},p=J(a,t,l,i),u=m=>r&&m!==null&&typeof m=="object"&&!Array.isArray(m),h=u(e)?e[n]:e,c=u(p)?p[n]:p,f=rt(s,h,c,a.type);return r?{...u(e)?e:{},[n]:f}:f}const Be=o.css`
  .fm-checkbox {
...
`;var ct=Object.defineProperty,y=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&ct(e,t,i),i};const $e=class $e extends o.LitElement{constructor(){super(...arguments),this.files=[],this.config=null,this.initialFieldKey=null,this._activeFieldKey="",this._staged=new Map,this._selected=new Set,this._sortAsc=!0,this._pendingOp=null,this._confirmVisible=!1,this._confirmResolve=null,this._originalFiles=new Map,this._onKeyDown=async e=>{if(e.key!=="Escape")return;if(this._confirmVisible){e.stopPropagation(),this._onConfirmCancel();return}e.composedPath().some(i=>i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement||i instanceof HTMLSelectElement)||await this._confirmDiscardPending()&&this._emitClose()},this._onConfirmOk=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!0),this._confirmResolve=null},this._onConfirmCancel=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null},this._onConfirmKeydown=e=>{var l,p;if(e.key!=="Tab")return;const t=(l=this.shadowRoot)==null?void 0:l.querySelector(".fm-confirm");if(!t)return;const s=t.querySelectorAll("button");if(s.length===0)return;const i=s[0],n=s[s.length-1],r=(p=this.shadowRoot)==null?void 0:p.activeElement;e.shiftKey&&r===i?(e.preventDefault(),n.focus()):!e.shiftKey&&r===n&&(e.preventDefault(),i.focus())},this._onPendingChange=e=>{const{operation:t,value:s}=e.detail,i=this._activeField;x.isEmpty(s)&&(!i||te(t,i.type))?this._pendingOp=null:this._pendingOp={operation:t,value:s}},this._onFieldSelect=async e=>{await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e.detail.fieldKey)},this._onBulkApply=e=>{var l,p,u;const t=this._activeField;if(!t)return;const{operation:s,value:i}=e.detail,n=(l=this.config)==null?void 0:l.language,r=[];for(const h of this._selected){const c=this._staged.get(h),f=c!=null&&c.has(t.key)?c.get(t.key):((u=(p=this._originalFiles.get(h))==null?void 0:p.meta)==null?void 0:u[t.key])??null,m=qe(t,f,i,s,n);r.push([h,t.key,m])}this._setStagedBulk(r)},this._onRowFieldChange=e=>{const t=this._activeField;t&&this._setStagedValue(e.detail.fileId,t.key,e.detail.value)},this._onRowToggle=e=>{const t=new Set(this._selected);t.has(e.detail.fileId)?t.delete(e.detail.fileId):t.add(e.detail.fileId),this._selected=t},this._onSelectAll=()=>{this._selected.size===this.files.length?this._selected=new Set:this._selected=new Set(this.files.map(e=>e.id))},this._onSortToggle=()=>{this._sortAsc=!this._sortAsc},this._onSave=async()=>{if(!await this._confirmDiscardPending())return;const e=[];for(const[t,s]of this._staged){const i=this._originalFiles.get(t);if(!i)continue;const n={};for(const[r,l]of s)JSON.stringify(l)!==JSON.stringify(i.meta[r])&&(n[r]=l);Object.keys(n).length>0&&e.push({fileId:t,meta:n})}this.dispatchEvent(new CustomEvent("metadata-save-batch",{detail:{changes:e},bubbles:!0,composed:!0})),this._emitClose()},this._onCancel=async()=>{await this._confirmDiscardPending()&&this._emitClose()},this._onClose=async()=>{await this._confirmDiscardPending()&&this._emitClose()}}connectedCallback(){super.connectedCallback(),this._initStaged(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null}_initStaged(){var n,r,l,p;const e=new Map,t=new Set,s=new Map;for(const u of this.files){const h=new Map;if(u.meta)for(const[c,f]of Object.entries(u.meta))h.set(c,f);e.set(u.id,h),t.add(u.id),s.set(u.id,u)}this._staged=e,this._selected=t,this._originalFiles=s;const i=this.initialFieldKey;i&&((r=(n=this.schema)==null?void 0:n.fieldsByKey)!=null&&r.has(i))?this._activeFieldKey=i:((p=(l=this.schema)==null?void 0:l.fields)==null?void 0:p.length)>0&&(this._activeFieldKey=this.schema.fields[0].key)}_setStagedValue(e,t,s){const i=new Map(this._staged),n=new Map(i.get(e)??new Map);n.set(t,s),i.set(e,n),this._staged=i}_setStagedBulk(e){const t=new Map(this._staged);for(const[s,i,n]of e){const r=new Map(t.get(s)??new Map);r.set(i,n),t.set(s,r)}this._staged=t}get _activeField(){var e,t;return(t=(e=this.schema)==null?void 0:e.fieldsByKey)==null?void 0:t.get(this._activeFieldKey)}get _filledFields(){var t,s;const e=new Set;for(const i of((t=this.schema)==null?void 0:t.fields)??[])for(const[n,r]of this._staged){const l=r.get(i.key),p=(s=this._originalFiles.get(n))==null?void 0:s.meta[i.key];if(l!==void 0&&!x.isEmpty(l)&&JSON.stringify(l)!==JSON.stringify(p)){e.add(i.key);break}}return e}get _hasPendingValue(){return this._pendingOp!=null&&!x.isEmpty(this._pendingOp.value)}_confirmDiscardPending(){return this._hasPendingValue?new Promise(e=>{this._confirmResolve=e,this._confirmVisible=!0}):Promise.resolve(!0)}updated(e){var t;(t=super.updated)==null||t.call(this,e),e.has("_confirmVisible")&&this._confirmVisible&&requestAnimationFrame(()=>{var i;const s=(i=this.shadowRoot)==null?void 0:i.querySelector(".fm-confirm .btn-ghost");s==null||s.focus()})}_emitClose(){this.dispatchEvent(new CustomEvent("metadata-close",{bubbles:!0,composed:!0}))}get _sortedFiles(){const e=[...this.files];return e.sort((t,s)=>{const i=t.name.localeCompare(s.name)||t.id.localeCompare(s.id);return this._sortAsc?i:-i}),e}render(){var n,r;if(!((r=(n=this.schema)==null?void 0:n.fields)!=null&&r.length))return o.html`
    ...
    `}};$e.styles=[ot];let g=$e;y([d.property({attribute:!1})],g.prototype,"schema");y([d.property({attribute:!1})],g.prototype,"files");y([d.property({attribute:!1})],g.prototype,"config");y([d.property({attribute:!1})],g.prototype,"autocomplete");y([d.property({attribute:!1})],g.prototype,"initialFieldKey");y([d.state()],g.prototype,"_activeFieldKey");y([d.state()],g.prototype,"_staged");y([d.state()],g.prototype,"_selected");y([d.state()],g.prototype,"_sortAsc");y([d.state()],g.prototype,"_pendingOp");y([d.state()],g.prototype,"_confirmVisible");customElements.define("sfx-bulk-metadata-modal",g);const Ie={text:o.html`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    ${o.svg`<path d="M6.67 8.67a3.33 3.33 0 0 0 5.03.36l2-2a3.33 3.33 0 0 0-4.71-4.71l-1.15 1.14"/><path d="M9.33 7.33a3.33 3.33 0 0 0-5.03-.36l-2 2a3.33 3.33 0 0 0 4.71 4.71l1.14-1.14"/>`}
  </svg>`};function ht(a){return Ie[a]??Ie.text}var ut=Object.defineProperty,K=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&ut(e,t,i),i};const Ce=class Ce extends o.LitElement{constructor(){super(...arguments),this.activeFieldKey="",this.filledFields=new Set,this.config=null,this._collapsed=new Set,this._isNarrow=!1,this._resizeTimer=null,this._onResize=()=>{this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(this._updateNarrow,100)},this._updateNarrow=()=>{this._resizeTimer=null;const e=window.innerWidth<=768;e!==this._isNarrow&&(this._isNarrow=e)}}connectedCallback(){super.connectedCallback(),this._updateNarrow(),window.addEventListener("resize",this._onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._onResize),this._resizeTimer&&(clearTimeout(this._resizeTimer),this._resizeTimer=null)}_isRequired(e){return x.isFieldRequired(e,this.config??void 0)}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_onFieldClick(e){this.dispatchEvent(new CustomEvent("field-select",{detail:{fieldKey:e},bubbles:!0,composed:!0}))}updated(e){var s,i;if((s=super.updated)==null||s.call(this,e),!e.has("activeFieldKey")||!this.activeFieldKey)return;const t=(i=this.renderRoot)==null?void 0:i.querySelector(".field-item.active");t==null||t.scrollIntoView({block:"nearest"})}render(){return this.schema?o.html`
      ${this.schema.groups.map(e=>{const t=this._isNarrow||!this._collapsed.has(e.uuid);return o.html`
          ...
          ${t?e.fields.map(s=>o.html`
                  ...
                  >
                    <span class="field-icon" aria-hidden="true">${ht(s.type)}</span>
                ...
                `):o.nothing}
        `})}
    `:o.nothing}};Ce.styles=[nt];let S=Ce;K([d.property({attribute:!1})],S.prototype,"schema");K([d.property({attribute:!1})],S.prototype,"activeFieldKey");K([d.property({attribute:!1})],S.prototype,"filledFields");K([d.property({attribute:!1})],S.prototype,"config");K([d.state()],S.prototype,"_collapsed");K([d.state()],S.prototype,"_isNarrow");customElements.define("sfx-bulk-meta-sidebar",S);var ft=Object.defineProperty,T=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&ft(e,t,i),i},w;const E=(w=class extends o.LitElement{constructor(){super(...arguments),this.config=null,this.selectedCount=0,this._operation="SET",this._value=void 0,this._opDropdownOpen=!1,this._availableOps=[],this._onOpDropdownClose=e=>{if(!this._opDropdownOpen)return;const t=this.renderRoot.querySelector(".op-dropdown-wrap");if(!t)return;e.composedPath().includes(t)||(this._opDropdownOpen=!1)},this._onFieldBlur=e=>{e.stopPropagation(),this._value=e.detail.value,this._emitPendingChange()},this._onFieldChange=e=>{e.stopPropagation(),this._value=e.detail.value,this._emitPendingChange()},this._onFieldEscape=e=>{e.stopPropagation()},this._onValueKeydown=e=>{var n;if(e.key!=="Enter")return;const t=(n=this.field)==null?void 0:n.type;if(!t||!w._ENTER_APPLY_TYPES.has(t))return;const s=e.composedPath().find(r=>r instanceof HTMLElement);if((s==null?void 0:s.tagName)==="TEXTAREA")return;e.preventDefault();const i=e.composedPath().find(r=>r instanceof HTMLInputElement);i&&i.value!==void 0&&(this._value=i.value),this._onApply()}}static _emptyValueForType(e){switch(e){case"multi-select":case"tags":case"integer-list":return[];case"boolean":return"null";case"geopoint":return{latitude:"",longitude:""};default:return""}}get _effectiveValue(){var e;return this._value??w._emptyValueForType((e=this.field)==null?void 0:e.type)}willUpdate(e){e.has("field")&&this.field&&(this._availableOps=st(this.field.type),this._operation="SET",this._value=void 0,this._emitPendingChange())}_onOpSelect(e){this._operation=e,this._opDropdownOpen=!1,this._emitPendingChange()}_onOpToggle(){this._opDropdownOpen=!this._opDropdownOpen}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onOpDropdownClose,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onOpDropdownClose,!0)}_emitPendingChange(){this.dispatchEvent(new CustomEvent("pending-change",{detail:{operation:this._operation,value:this._value},bubbles:!0,composed:!0}))}_onApply(){var e;this._isApplyDisabled||(this.dispatchEvent(new CustomEvent("bulk-apply",{detail:{operation:this._operation,value:this._value},bubbles:!0,composed:!0})),this._value=void 0,this._operation==="DELETE"&&!te(this._operation,(e=this.field)==null?void 0:e.type)&&(this._operation="SET"),this._emitPendingChange())}get _isApplyDisabled(){var e,t;if(this.selectedCount===0)return!0;if(this._operation==="DELETE"){const s=new Set(["multi-select","tags","integer-list"]),i=new Set(["text","textarea","attachment-uri"]);return s.has((e=this.field)==null?void 0:e.type)?x.isEmpty(this._value):i.has((t=this.field)==null?void 0:t.type)?x.isEmpty(this._value):!1}return x.isEmpty(this._value)}render(){if(!this.field)return o.nothing;const e=this._availableOps.length>1,t=this._availableOps.find(s=>s.key===this._operation);return o.html`
      <div class="op-bar">
        ...
        ${te(this._operation,this.field.type)?o.html`
    ...
    `}},w.styles=[at],w._ENTER_APPLY_TYPES=new Set(["text","numeric","decimal2","date","geopoint","attachment-uri"]),w);T([d.property({attribute:!1})],E.prototype,"field");T([d.property({attribute:!1})],E.prototype,"autocomplete");T([d.property({attribute:!1})],E.prototype,"config");T([d.property({type:Number})],E.prototype,"selectedCount");T([d.state()],E.prototype,"_operation");T([d.state()],E.prototype,"_value");T([d.state()],E.prototype,"_opDropdownOpen");let mt=E;customElements.define("sfx-bulk-meta-op-bar",mt);var xt=Object.defineProperty,P=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&xt(e,t,i),i};const Se=class Se extends o.LitElement{constructor(){super(...arguments),this.files=[],this.staged=new Map,this.selected=new Set,this.pendingOp=null,this.config=null}_getEffectiveValue(e){const t=this.staged.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key):e.meta[this.field.key]}render(){return o.html`
      ${this.files.map(e=>o.html`
          ...
          ></sfx-bulk-meta-row>
        `)}
    `}};Se.styles=[pt];let _=Se;P([d.property({attribute:!1})],_.prototype,"files");P([d.property({attribute:!1})],_.prototype,"field");P([d.property({attribute:!1})],_.prototype,"staged");P([d.property({attribute:!1})],_.prototype,"selected");P([d.property({attribute:!1})],_.prototype,"pendingOp");P([d.property({attribute:!1})],_.prototype,"config");P([d.property({attribute:!1})],_.prototype,"autocomplete");customElements.define("sfx-bulk-meta-table",_);var gt=Object.defineProperty,A=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&gt(e,t,i),i};const Ee=class Ee extends o.LitElement{constructor(){super(...arguments),this.selected=!1,this.pendingOp=null,this.config=null,this._error=null,this._onFieldBlur=e=>{var r;e.stopPropagation();const{value:t}=e.detail,s=x.validateField(this.field,t,this.config??void 0);if(s){this._error=s;return}this._error=null;const i={meta:{...this.file.meta,[this.field.key]:this.value}},n=J(this.field,t,i,(r=this.config)==null?void 0:r.language);JSON.stringify(n)!==JSON.stringify(this.value)&&this.dispatchEvent(new CustomEvent("row-field-change",{detail:{fileId:this.file.id,value:n},bubbles:!0,composed:!0}))}}willUpdate(e){e.has("field")&&(this._error=null)}_onCheckboxChange(){this.dispatchEvent(new CustomEvent("row-toggle",{detail:{fileId:this.file.id},bubbles:!0,composed:!0}))}_computePreviewValue(){var t;const e=this.pendingOp;return!e||!this.field?this.value:qe(this.field,this.value,e.value,e.operation,(t=this.config)==null?void 0:t.language)}_getExtension(e){const t=e.lastIndexOf(".");return t>0?e.slice(t+1).toUpperCase():"?"}render(){var t;const e=this.file;return o.html`
      <div class="row">
        <div class="row-check">
          <input
            type="checkbox"
        ...
        ${e.previewUrl?o.html`<img class="row-thumb" src=${e.previewUrl} alt="" />`:o.html`<img class="row-thumb row-thumb-fallback"
              src=${x.getFileTypeIconUrl(this._getExtension(e.name))}
              alt="${this._getExtension(e.name)} file"
              @error=${s=>{const i=s.target,n=x.getDefaultFileTypeIconUrl();!i.dataset.fallback&&i.src!==n&&(i.dataset.fallback="1",i.src=n)}}
            />`}

        <div class="row-name" title=${e.name}>${e.name}</div>
        <div class="row-size">${e.size?x.formatFileSize(e.size):"—"}</div>
    ...
    `}};Ee.styles=[lt];let v=Ee;A([d.property({attribute:!1})],v.prototype,"file");A([d.property({attribute:!1})],v.prototype,"field");A([d.property({attribute:!1})],v.prototype,"value");A([d.property({type:Boolean})],v.prototype,"selected");A([d.property({attribute:!1})],v.prototype,"pendingOp");A([d.property({attribute:!1})],v.prototype,"config");A([d.property({attribute:!1})],v.prototype,"autocomplete");A([d.state()],v.prototype,"_error");customElements.define("sfx-bulk-meta-row",v);const bt=new Set(["multi-select","tags","integer-list"]);function Oe(a,e,t){return!e.regional_variants_group_uuid||a==null||typeof a!="object"||Array.isArray(a)?a:a[t??"en"]}function De(a){return Array.isArray(a)?a:[]}function ze(a){return a==null||a===""||Array.isArray(a)&&a.length===0?!0:typeof a=="object"&&!Array.isArray(a)?!Object.values(a).some(e=>e!=null&&e!==""):!1}function ie(a,e){var s;const t=(s=a.possible_values)==null?void 0:s.find(i=>i.internal_unique_value===e||i.api_value===e);return(t==null?void 0:t.label)??String(e)}function Te(a,e){if(e==null||e==="")return"";switch(a.type){case"boolean":return e===!0?"True":e===!1?"False":"None";case"date":{if(typeof e!="string"||e.length===0)return"";try{return new Date(e+"T00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return e}}case"numeric":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:0}):String(e)}case"decimal2":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:2}):String(e)}case"select-one":return ie(a,String(e));case"geopoint":{if(typeof e=="object"&&e!==null&&!Array.isArray(e)){const t=e;return!t.latitude&&!t.longitude?"":`(${t.latitude??""}, ${t.longitude??""})`}if(typeof e=="string"){const t=e.match(/^\((.+),(.+)\)$/);if(t)return`(${t[1].trim()}, ${t[2].trim()})`}return String(e)}default:return String(e)}}function vt(a,e){const t=a.map(l=>typeof l=="string"?l:String(l)),s=e.map(l=>typeof l=="string"?l:String(l)),i=new Set(t),n=new Set(s),r=[];for(const l of s)r.push({label:l,state:i.has(l)?"kept":"added"});for(const l of t)n.has(l)||r.push({label:l,state:"removed"});return r}function yt(a,e,t){const s=new Set(a.map(r=>JSON.stringify(r))),i=new Set(e.map(r=>JSON.stringify(r))),n=[];for(const r of e){const l=JSON.stringify(r),p=typeof r=="string"?ie(t,r):String(r);n.push({label:p,state:s.has(l)?"kept":"added"})}for(const r of a){const l=JSON.stringify(r);if(!i.has(l)){const p=typeof r=="string"?ie(t,r):String(r);n.push({label:p,state:"removed"})}}return n}function _t(a,e,t,s){const i=s==null?void 0:s.language,n=Oe(e,a,i),r=Oe(t,a,i);if(bt.has(a.type)){const l=De(n),p=De(r);return a.type==="tags"?{kind:"array",items:vt(l,p)}:{kind:"array",items:yt(l,p,a)}}return{kind:"scalar",oldDisplay:Te(a,n),newDisplay:Te(a,r),oldEmpty:ze(n),newEmpty:ze(r)}}var wt=Object.defineProperty,G=(a,e,t,s)=>{for(var i=void 0,n=a.length-1,r;n>=0;n--)(r=a[n])&&(i=r(e,t,i)||i);return i&&wt(e,t,i),i};const Ae=class Ae extends o.LitElement{constructor(){super(...arguments),this.config=null}_renderArrayDiff(e){return o.html`
    ...
    `}render(){if(!this.field)return o.nothing;const e=_t(this.field,this.oldValue,this.newValue,this.config);return e.kind==="array"?this._renderArrayDiff(e):this._renderScalarDiff(e)}};Ae.styles=[dt];let z=Ae;G([d.property({attribute:!1})],z.prototype,"field");G([d.property({attribute:!1})],z.prototype,"oldValue");G([d.property({attribute:!1})],z.prototype,"newValue");G([d.property({attribute:!1})],z.prototype,"config");customElements.define("sfx-bulk-meta-diff-view",z);exports.deepMergeMeta=x.deepMergeMeta;exports.getFilesWithMissingRequired=x.getFilesWithMissingRequired;exports.isAssetHasMetadataValue=x.isAssetHasMetadataValue;exports.isEmpty=x.isEmpty;exports.validateField=x.validateField;exports.SfxBulkMetadataModal=g;exports.clearSchemaCache=Me;exports.createTagsAutocomplete=He;exports.fetchMetadataSchema=Ke;exports.mapValueFromBackend=re;exports.mapValueToBackend=J;exports.parseMetadataSchema=se;
