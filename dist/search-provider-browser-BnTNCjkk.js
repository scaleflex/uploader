import { LitElement as x, css as b, html as s, nothing as d } from "lit";
import { property as p, state as n } from "lit/decorators.js";
import { m as g, s as f } from "./sfx-uploader-jd8_cGGr.js";
var m = Object.defineProperty, a = (h, r, e, t) => {
  for (var i = void 0, l = h.length - 1, u; l >= 0; l--)
    (u = h[l]) && (i = u(r, e, i) || i);
  return i && m(r, e, i), i;
};
const c = class c extends x {
  constructor() {
    super(...arguments), this.provider = "unsplash", this.companionUrl = "", this.transformThumbnail = (r) => r, this._loading = !1, this._loadingMore = !1, this._items = [], this._selectedIds = /* @__PURE__ */ new Set(), this._error = null, this._searchQuery = "", this._nextPageQuery = null, this._searched = !1, this._onResultsScroll = (r) => {
  ...
  get _providerLabel() {
    var e;
    return ((e = g([this.provider])[0]) == null ? void 0 : e.label) ?? this.provider;
  }
  async _doSearch() {
    ...
    if (r) {
      ...
      try {
        const e = await f(this.companionUrl, this.provider, r), t = /* @__PURE__ */ new Set();
...
a([
  p({ attribute: !1 })
], o.prototype, "transformThumbnail");
a([
  n()
