import { noChange as It, html as f, LitElement as pe, css as ne, svg as Pe, render as Ue, nothing as $ } from "lit";
import { property as O, state as I, query as fi } from "lit/decorators.js";
import { repeat as Yt } from "lit/directives/repeat.js";
import { directive as To, Directive as Lo, PartType as zo } from "lit/directive.js";
import { unsafeSVG as ye } from "lit/directives/unsafe-svg.js";
import { unsafeHTML as Bi } from "lit/directives/unsafe-html.js";
import { classMap as Io } from "lit/directives/class-map.js";
const D = (r) => typeof r == "string", Ge = () => {
...
}, Ni = (r) => r == null ? "" : String(r), Ao = (r, e, t) => {
  r.forEach((i) => {
    e[i] && (t[i] = e[i]);
  });
}, jo = /###/g, Hi = (r) => r && r.includes("###") ? r.replace(jo, ".") : r, qi = (r) => !r || D(r), tt = (r, e, t) => {
  ...
  for (const i in e)
    i !== "__proto__" && i !== "constructor" && (i in r ? D(r[i]) || r[i] instanceof String || D(e[i]) || e[i] instanceof String ? t && (r[i] = e[i]) : Br(r[i], e[i], t) : r[i] = e[i]);
  return r;
}, me = (r) => r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Bo = {
  "&": "&amp;",
  "<": "&lt;",
...
const qo = [" ", ",", "?", "!", ";"], Vo = new Ho(20), Ko = (r, e, t) => {
  e = e || "", t = t || "";
  const i = qo.filter((n) => !e.includes(n) && !t.includes(n));
  if (i.length === 0) return !0;
  const o = Vo.getRegExp(`(${i.map((n) => n === "?" ? "\\?" : n).join("|")})`);
  let s = !o.test(r);
  if (!s) {
    const n = r.indexOf(t);
  ...
  return o;
}, rt = (r) => r == null ? void 0 : r.replace(/_/g, "-"), Yo = {
  type: "logger",
  log(r) {
    this.output("log", r);
  },
...
class Ki extends Tt {
  ...
  getResource(e, t, i, o = {}) {
    ...
    return !l && !t && !i && e.includes(".") && (e = a[0], t = a[1], i = a.slice(2).join(".")), l || !n || !D(i) ? l : Wt((d = (c = this.data) == null ? void 0 : c[e]) == null ? void 0 : d[t], i, s);
  }
  ...
  addResourceBundle(e, t, i, o, s, n = {
    ...
    let l = $t(this.data, a) || {};
    n.skipCopy || (i = JSON.parse(JSON.stringify(i))), o ? Br(l, i, s) : l = {
      ...l,
      ...i
...
function Wo() {
  ...
  return e.get = (i, o) => {
    var s;
    return (s = t == null ? void 0 : t.revoke) == null || s.call(t), o === Hr ? r : (r.push(o), t = Proxy.revocable(i, e), t.proxy);
  }, Proxy.revocable(/* @__PURE__ */ Object.create(null), e).proxy;
}
function Me(r, e) {
  const {
    [Hr]: t
  } = r(Wo()), i = (e == null ? void 0 : e.keySeparator) ?? ".", o = (e == null ? void 0 : e.nsSeparator) ?? ":", s = (e == null ? void 0 : e.enableSelector) === "strict";
  if (t.length > 1 && o) {
...
class Pt extends Tt {
  constructor(e, t = {}) {
    super(), Ao(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = ge.create("translator"), this.checkedLoadedFor = {};
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, t) {
    ...
    const n = i && e.includes(i), a = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Ko(e, i, o);
    if (n && !a) {
  ...
  translate(e, t, i) {
    ...
    const v = (k == null ? void 0 : k.usedKey) || a, C = (k == null ? void 0 : k.exactUsedKey) || a, L = ["[object Number]", "[object Function]", "[object RegExp]"], _ = o.joinArrays !== void 0 ? o.joinArrays : this.options.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, w = o.count !== void 0 && !D(o.count), b = Pt.hasDefaultValue(o), R = w ? this.pluralResolver.getSuffix(p, o.count, o) : "", E = o.ordinal && w ? this.pluralResolver.getSuffix(p, o.count, {
      ordinal: !1
    }) : "", A = w && !o.ordinal && o.count === 0, z = A && o[`defaultValue${this.options.pluralSeparator}zero`] || o[`defaultValue${R}`] || o[`defaultValue${E}`] || o.defaultValue;
    let T = m;
    y && !m && b && (T = z);
    const J = At(T), de = Object.prototype.toString.apply(T);
    if (y && T && J && !L.includes(de) && !(D(_) && Array.isArray(T))) {
      ...
      if (Y || F || h) {
        if (this.logger.log(h ? "updateKey" : "missingKey", p, c, w && !h ? `${a}${this.pluralResolver.getSuffix(p, o.count, o)}` : a, h ? z : m), n) {
        ...
        const U = (S, j, H) => {
          var Q;
          const q = b && H !== m ? H : x;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(S, c, j, q, h, o) : (Q = this.backendConnector) != null && Q.saveMissing && this.backendConnector.saveMissing(S, c, j, q, h, o), this.emit("missingKey", S, c, j, m);
        };
      ...
      m = this.extendTranslation(m, e, o, k, i), Y && m === a && this.options.appendNamespaceToMissingKey && (m = `${c}${d}${a}`), (Y || F) && this.options.parseMissingKeyHandler && (m = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${c}${d}${a}` : a, F ? m : void 0, o));
    }
  ...
  extendTranslation(e, t, i, o, s) {
    ...
    if ((l = this.i18nFormat) != null && l.parse)
      ...
      let u = i.replace && !D(i.replace) ? i.replace : i;
    ...
    return e != null && (a != null && a.length) && i.applyPostProcessor !== !1 && (e = Nr.handle(a, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...o,
  ...
  resolve(e, t = {}) {
    ...
    return D(e) && (e = [e]), Array.isArray(e) && (e = e.map((l) => typeof l == "function" ? Me(l, {
      ...
      const u = t.count !== void 0 && !D(t.count), k = u && !t.ordinal && t.count === 0, m = t.context !== void 0 && (D(t.context) || typeof t.context == "number") && t.context !== "", v = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      p.forEach((C) => {
        var L, _;
        this.isValidLookup(i) || (a = C, !this.checkedLoadedFor[`${v[0]}-${C}`] && ((L = this.utils) != null && L.hasLoadedNamespace) && !((_ = this.utils) != null && _.hasLoadedNamespace(a)) && (this.checkedLoadedFor[`${v[0]}-${C}`] = !0, this.logger.warn(`key "${o}" for languages "${v.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), v.forEach((y) => {
          var R;
          if (this.isValidLookup(i)) return;
          n = y;
          const w = [d];
          if ((R = this.i18nFormat) != null && R.addLookupKeys)
            this.i18nFormat.addLookupKeys(w, d, y, C, t);
          else {
            let E;
            ...
            if (u && (t.ordinal && E.startsWith(z) && w.push(d + E.replace(z, this.options.pluralSeparator)), w.push(d + E), k && w.push(d + A)), m) {
              const T = `${d}${this.options.contextSeparator || "_"}${t.context}`;
              w.push(T), u && (t.ordinal && E.startsWith(z) && w.push(T + E.replace(z, this.options.pluralSeparator)), w.push(T + E), k && w.push(T + A));
            }
          }
          let b;
          for (; b = w.pop(); )
...
class Ji {
  ...
  init(e = {}) {
    ...
    this.escape = t !== void 0 ? t : No, this.escapeValue = i !== void 0 ? i : !0, this.useRawValueToEscape = o !== void 0 ? o : !1, this.prefix = s ? me(s) : n || "{{", this.suffix = a ? me(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = d ? "" : p ? me(p) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : d ? me(d) : "", this.nestingPrefix = u ? me(u) : k || me("$t("), this.nestingSuffix = m ? me(m) : v || me(")"), this.nestingOptionsSeparator = C || ",", this.maxReplaces = L || 1e3, this.alwaysFormat = _ !== void 0 ? _ : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, t, i, o) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (m) => {
      if (!m.includes(this.formatSeparator)) {
        const _ = Xi(t, l, m, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(Xi(t, l, C, this.options.keySeparator, this.options.ignoreJSONStructure), L, i, {
        ...o,
        ...t,
        interpolationkey: C
      });
    ...
    return [{
      ...
      regex: this.regexp,
      safeValue: (m) => this.escapeValue ? jt(this.escape(m)) : jt(m)
    }].forEach((m) => {
  ...
  nest(e, t, i = {}) {
    ...
    const a = (l, c) => {
      ...
      const k = u.match(/'/g), m = u.match(/"/g);
      (((k == null ? void 0 : k.length) ?? 0) % 2 === 0 && !m || ((m == null ? void 0 : m.length) ?? 0) % 2 !== 0) && (u = u.replace(/'/g, '"'));
      try {
        n = JSON.parse(u), c && (n = {
          ...c,
          ...n
    ...
    for (; o = this.nestingRegexp.exec(e); ) {
      ...
      D(s) || (s = Ni(s)), s || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${e}`), s = ""), l.length && (s = l.reduce((d, p) => this.format(d, p, i.lng, {
        ...i,
...
class Zo {
  ...
  init(e, t = {
    ...
    const i = t.cacheInBuiltFormats ? Zi : Jo;
    this.formats = {
      number: i((o, s) => {
...
class es extends Tt {
  ...
  loaded(e, t, i) {
    ...
    this.queue.forEach((l) => {
      Do(l.loaded, [s], n), Qo(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const d = l.loaded[c];
    ...
    if (!(i == null || i === "")) {
      if ((u = this.backend) != null && u.create) {
        ...
        if (m.length < 6)
          try {
            let v;
            m.length === 5 ? v = m(e, t, i, o, k) : v = m(e, t, i, o), v && typeof v.then == "function" ? v.then((C) => a(null, C)).catch(a) : a(null, v);
          } catch (v) {
            a(v);
          }
        else
...
class it extends Tt {
  ...
  init(e = {}, t) {
    ...
    if (!this.options.isClone) {
      ...
      let c;
      this.modules.formatter ? c = this.modules.formatter : c = Zo;
      const d = new Yi(this.options);
      this.store = new Ki(this.options.resources, this.options);
      const p = this.services;
      p.logger = ge, p.resourceStore = this.store, p.languageUtils = d, p.pluralResolver = new Go(d, {
        prepend: this.options.pluralSeparator
      }), c && (p.formatter = o(c), p.formatter.init && p.formatter.init(p, this.options), this.options.interpolation.format = p.formatter.format.bind(p.formatter)), p.interpolator = new Ji(this.options), p.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, p.backendConnector = new es(o(this.modules.backend), p.resourceStore, p, this.options), p.backendConnector.on("*", (u, ...k) => {
        this.emit(u, ...k);
      }), this.modules.languageDetector && (p.languageDetector = o(this.modules.languageDetector), p.languageDetector.init && p.languageDetector.init(p, this.options.detection, this.options)), this.modules.i18nFormat && (p.i18nFormat = o(this.modules.i18nFormat), p.i18nFormat.init && p.i18nFormat.init(this)), this.translator = new Pt(this.services, this.options), this.translator.on("*", (u, ...k) => {
        this.emit(u, ...k);
  ...
  getFixedT(e, t, i, o) {
    const s = o == null ? void 0 : o.scopeNs, n = (a, l, ...c) => {
      ...
      let m;
      return d.keyPrefix && Array.isArray(a) ? m = a.map((v) => (typeof v == "function" && (v = Me(v, u)), `${d.keyPrefix}${k}${v}`)) : (typeof a == "function" && (a = Me(a, u)), m = d.keyPrefix ? `${d.keyPrefix}${k}${a}` : a), this.t(m, d);
    };
  ...
  cloneInstance(e = {}, t = xt) {
    ...
    if (e.interpolation) {
      ...
      s.services.interpolator = new Ji(c);
    }
...
function Vr(r) {
  return !(typeof r != "string" || r.length === 0 || r.length > 128 || qr.indexOf(r) > -1 || r.indexOf("..") > -1 || r.indexOf("\\") > -1 || /[?#%\s@]/.test(r) || /[\x00-\x1F\x7F]/.test(r));
}
function Kr(r) {
  return !(!Vr(r) || r.indexOf("/") > -1);
}
function is(r) {
  return Vr(r);
}
...
function ns(r) {
  return ss(r) ? r : Promise.resolve(r);
}
const as = /\{\{(.+?)\}\}/g;
function er(r, e) {
  let t = !1;
  const i = r.replace(as, (o, s) => {
    const n = s.trim();
    if (qr.indexOf(n) > -1) return o;
    const a = e[n];
    if (a == null) return o;
    const l = rs[n] || Kr, c = String(a).split("+");
...
const tr = Yr() && Re ? Re.XMLHttpRequest : void 0, ls = typeof ActiveXObject == "function" && Re ? Re.ActiveXObject : void 0, Wr = [
  "__proto__",
  "constructor",
  "prototype"
], Gt = (r, e) => {
  if (e && typeof e == "object") {
    ...
    for (const i of Object.keys(e))
      Wr.indexOf(i) > -1 || (t += "&" + encodeURIComponent(i) + "=" + encodeURIComponent(e[i]));
    if (!t) return r;
  ...
  try {
    const o = tr ? new tr() : new ls("MSXML2.XMLHTTP.3.0");
    ...
    if (s = typeof s == "function" ? s() : s, s) for (const n of Object.keys(s))
      Wr.indexOf(n) > -1 || o.setRequestHeader(n, s[n]);
  ...
  }), Et && e.indexOf("file:") !== 0) return cs(r, e, t, i);
  if (Yr() || typeof ActiveXObject == "function") return ds(r, e, t, i);
...
var Gr = class {
  ...
  _readAny(r, e, t, i, o) {
    ...
    typeof this.options.loadPath == "function" && (s = this.options.loadPath(r, t)), s = ns(s), s.then((n) => {
      if (!n) return o(null, {});
      const a = er(n, {
        lng: r.join("+"),
        ns: t.join("+")
  ...
  loadUrl(r, e, t, i) {
    const o = typeof t == "string" ? [t] : t, s = typeof i == "string" ? [i] : i, n = this.options.parseLoadPayload(o, s), a = bt(os(r));
    this.options.request(this.options, r, n, (l, c) => {
      ...
      if (!c && l && l.message) {
        ...
        if ([
          ...
          "network",
          "load"
        ].find((k) => u.indexOf(k) > -1)) return e("failed loading " + a + ": " + bt(l.message), !0);
      }
      if (l) return e(l, !1);
      let d, p;
      try {
  ...
  create(r, e, t, i, o) {
    ...
    r.forEach((c) => {
      ...
      this.options.request(this.options, p, s, (u, k) => {
        n += 1, a.push(u), l.push(k), n === r.length && typeof o == "function" && o(a, l);
      });
    });
  }
  reload() {
...
Gr.type = "backend";
const Xr = "f7b2366e-fcb6-4f1a-8f23-8de48422989a", fs = "https://i18n-fastly.ultrafast.io", hs = "https://neo.wordplex.io", Xt = "uploader";
let $e = null;
async function gs(r = "en") {
  return $e ? ($e.language !== r && await $e.changeLanguage(r), { i18n: $e, isNew: !1 }) : ($e = ae.createInstance(), await $e.use(Gr).init({
    lng: r,
    fallbackLng: "en",
    ns: [Xt],
    defaultNS: Xt,
    ...
    backend: {
      ...
      loadPath: `${fs}/api/export/grid/f2/${Xr}?langs={{lng}}&separator=+&response_format=i18next_multi`,
      parse(e, t) {
        var s;
...
const ms = "sfxUploaderTranslationsMissingKeysEnabled";
class xs {
  constructor() {
    this.enabled = !1, this._missingKeys = {}, this._timer = null, this.debounceDelay = 2e3, this.enabled = typeof localStorage < "u" && localStorage.getItem(ms) === "true", this.enabled && console.log(
...
curl '${hs}/api/import/request-translations' \\
  --data-raw '{"grid_uuid":"${Xr}","translations_requests":${JSON.stringify(
...
const bs = new xs(), Mt = (r) => r.includes("-") ? r : r.replace(/[A-Z]/g, (e) => `-${e.toLowerCase()}`);
class vs extends Lo {
  constructor(e) {
    if (super(e), this._appliedProps = /* @__PURE__ */ new Set(), e.type !== zo.ELEMENT)
...
const Ss = "SAME_ASSET_EXISTS_SKIP_UPLOAD", $s = "ERROR_SHA1_CONFLICT";
function pt(r) {
  return (r == null ? void 0 : r.code) === Ss || (r == null ? void 0 : r.code) === $s;
}
function hi(r, e) {
  return {
    ...r,
...
const Jr = /[!#$%^&*()=+{}\[\];"<>\\,\/?~\t\n\r\s`]/;
function Yl(r) {
  return r == null || r === "" ? null : typeof r != "string" || Jr.test(r) ? "productRefInvalid" : null;
}
function Wl(r) {
...
function Ps(r, e) {
  ...
  let i = !1;
  const o = Cs(e.apiBase, e.folder, e.extraParams);
  t.open("POST", o);
...
async function Os(r, e, t, i, o, s = !1) {
  const n = Se(r), a = ut(e), l = s ? `${n}/search/${a}/get/${i}` : `${n}/${a}/get/${i}`, c = s ? { Accept: "application/json", "Content-Type": "application/json" } : Lt(t), d = await fetch(l, {
    method: "POST",
    headers: c,
    credentials: "same-origin",
    body: JSON.stringify({
...
function eo(r) {
  const t = `${Ls(r.companionUrl)}/api/${r.token}`;
  let i;
  try {
    i = new WebSocket(t);
  } catch {
  ...
  return i.onmessage = (n) => {
    ...
    if (!o)
      try {
        ...
        switch (d.action) {
          case "progress": {
            const p = d.payload, u = p.bytesUploaded ?? 0, k = p.bytesTotal ?? (r.expectedSize || 1);
            r.onProgress(u, k);
            break;
          }
          case "success": {
            ...
            if (s(), i.close(), (a = p.response) != null && a.responseText)
              try {
                ...
                if (pt(u)) {
                  r.onComplete(hi(u, r.uploadFile));
                  return;
                }
...
function zs(r, e) {
  ...
  let i = !1, o = null;
  const s = Zr(e.apiBase, e.folder, e.extraParams), n = Qr(r, e.folder), a = !t.token;
  return Os(t.companionUrl, t.provider, t.token, t.requestPath, {
    fileId: t.fileId,
    endpoint: s,
...
function Is(r, e) {
  ...
  let i = !1, o = null;
  const s = new AbortController(), n = Zr(e.apiBase, e.folder, e.extraParams);
  return Fs(e.companionUrl, t, s.signal).then((a) => {
    var c;
    if (i) return null;
    (c = e.onMeta) == null || c.call(e, { name: a.name, type: a.type, size: a.size });
    const l = Qr(r, e.folder);
    return a.name && (l.name = a.name), a.type && (l.type = a.type), Ts(
      e.companionUrl,
      t,
      {
        fileId: r.id,
...
function Ds(r, e, t) {
  return e = st(e), Ms(r, bi() ? Reflect.construct(e, t || [], st(r).constructor) : e.apply(r, t));
}
function Ms(r, e) {
...
function Zt(r) {
  ...
  return Zt = function(i) {
    ...
    function o() {
      return Hs(i, arguments, st(this).constructor);
    }
...
var Je = /* @__PURE__ */ (function(r) {
  function e(t) {
    ...
    if (js(this, e), i = Ds(this, e, [t]), i.originalRequest = s, i.originalResponse = n, i.causingError = o, o != null && (t += ", caused by ".concat(o.toString())), s != null) {
...
const io = "3.7.8", Js = io, Ye = typeof Buffer == "function", sr = typeof TextDecoder == "function" ? new TextDecoder() : void 0, nr = typeof TextEncoder == "function" ? new TextEncoder() : void 0, Zs = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", Ze = Array.prototype.slice.call(Zs), vt = ((r) => {
  let e = {};
  return r.forEach((t, i) => e[t] = i), e;
})(Ze), Qs = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/, ie = String.fromCharCode.bind(String), ar = typeof Uint8Array.from == "function" ? Uint8Array.from.bind(Uint8Array) : (r) => new Uint8Array(Array.prototype.slice.call(r, 0)), ro = (r) => r.replace(/=/g, "").replace(/[+\/]/g, (e) => e == "+" ? "-" : "_"), oo = (r) => r.replace(/[^A-Za-z0-9\+\/]/g, ""), so = (r) => {
  let e, t, i, o, s = "";
  const n = r.length % 3;
...
}, vi = typeof btoa == "function" ? (r) => btoa(r) : Ye ? (r) => Buffer.from(r, "binary").toString("base64") : so, Qt = Ye ? (r) => Buffer.from(r).toString("base64") : (r) => {
  let t = [];
  for (let i = 0, o = r.length; i < o; i += 4096)
    t.push(ie.apply(null, r.subarray(i, i + 4096)));
  return vi(t.join(""));
}, wt = (r, e = !1) => e ? ro(Qt(r)) : Qt(r), en = (r) => {
  if (r.length < 2) {
...
}, tn = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, no = (r) => r.replace(tn, en), lr = Ye ? (r) => Buffer.from(r, "utf8").toString("base64") : nr ? (r) => Qt(nr.encode(r)) : (r) => vi(no(r)), Be = (r, e = !1) => e ? ro(lr(r)) : lr(r), cr = (r) => Be(r, !0), rn = /[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g, on = (r) => {
  switch (r.length) {
    case 4:
...
}, ao = (r) => r.replace(rn, on), lo = (r) => {
  if (r = r.replace(/\s+/g, ""), !Qs.test(r))
  ...
  return o.join("");
}, yi = typeof atob == "function" ? (r) => atob(oo(r)) : Ye ? (r) => Buffer.from(r, "base64").toString("binary") : lo, co = Ye ? (r) => ar(Buffer.from(r, "base64")) : (r) => ar(yi(r).split("").map((e) => e.charCodeAt(0))), po = (r) => co(uo(r)), sn = Ye ? (r) => Buffer.from(r, "base64").toString("utf8") : sr ? (r) => sr.decode(co(r)) : (r) => ao(yi(r)), uo = (r) => oo(r.replace(/[-_]/g, (e) => e == "-" ? "+" : "/")), ei = (r) => sn(uo(r)), nn = (r) => {
  if (typeof r != "string")
    return !1;
  ...
  const r = (e, t) => Object.defineProperty(String.prototype, e, fo(t));
  ...
  const r = (e, t) => Object.defineProperty(Uint8Array.prototype, e, fo(t));
  r("toBase64", function(e) {
    return wt(this, e);
  }), r("toBase64URI", function() {
    return wt(this, !0);
...
function un() {
  ...
  var c = [
    ...
    // Extract from the back.
    function(y, w) {
      return u(w.protocol) ? y.replace(/\\/g, "/") : y;
    },
    ["/", "pathname"],
    // Extract from the back.
    ["@", "auth", 1],
  ...
  function p(_) {
    var y;
    typeof window < "u" ? y = window : typeof dr < "u" ? y = dr : typeof self < "u" ? y = self : y = {};
    var w = y.location || {};
    _ = _ || w;
    var b = {}, R = typeof _, E;
    if (_.protocol === "blob:")
      b = new v(unescape(_.pathname), {});
    else if (R === "string") {
      b = new v(_, {});
      ...
      for (E in _)
        E in d || (b[E] = _[E]);
      b.slashes === void 0 && (b.slashes = o.test(_.href));
    }
    return b;
  }
  function u(_) {
  ...
  function k(_, y) {
    _ = l(_), _ = _.replace(i, ""), y = y || {};
    var w = n.exec(_), b = w[1] ? w[1].toLowerCase() : "", R = !!w[2], E = !!w[3], A = 0, z;
    return R ? E ? (z = w[2] + w[3] + w[4], A = w[2].length + w[3].length) : (z = w[2] + w[4], A = w[2].length) : E ? (z = w[3] + w[4], A = w[3].length) : z = w[4], b === "file:" ? A >= 2 && (z = z.slice(2)) : u(b) ? z = w[4] : b ? R && (z = z.slice(2)) : A >= 2 && u(y.protocol) && (z = w[4]), {
      protocol: b,
      slashes: R || u(b),
      slashesCount: A,
      rest: z
  ...
  function m(_, y) {
    if (_ === "") return y;
    for (var w = (y || "/").split("/").slice(0, -1).concat(_.split("/")), b = w.length, R = w[b - 1], E = !1, A = 0; b--; )
      w[b] === "." ? w.splice(b, 1) : w[b] === ".." ? (w.splice(b, 1), A++) : A && (b === 0 && (E = !0), w.splice(b, 1), A--);
    return E && w.unshift(""), (R === "." || R === "..") && w.push(""), w.join("/");
  }
  function v(_, y, w) {
    if (_ = l(_), _ = _.replace(i, ""), !(this instanceof v))
      return new v(_, y, w);
    var b, R, E, A, z, T, J = c.slice(), de = typeof y, F = this, Y = 0;
    for (de !== "object" && de !== "string" && (w = y, y = null), w && typeof w != "function" && (w = e.parse), y = p(y), R = k(_ || "", y), b = !R.protocol && !R.slashes, F.slashes = R.slashes || b && y.slashes, F.protocol = R.protocol || y.protocol || "", _ = R.rest, (R.protocol === "file:" && (R.slashesCount !== 2 || a.test(_)) || !R.slashes && (R.protocol || R.slashesCount < 2 || !u(F.protocol))) && (J[3] = [/(.*)/, "pathname"]); Y < J.length; Y++) {
      if (A = J[Y], typeof A == "function") {
        _ = A(_, F);
        continue;
      }
      E = A[0], T = A[1], E !== E ? F[T] = _ : typeof E == "string" ? (z = E === "@" ? _.lastIndexOf(E) : _.indexOf(E), ~z && (typeof A[2] == "number" ? (F[T] = _.slice(0, z), _ = _.slice(z + A[2])) : (F[T] = _.slice(z), _ = _.slice(0, z)))) : (z = E.exec(_)) && (F[T] = z[1], _ = _.slice(0, z.index)), F[T] = F[T] || b && A[3] && y[T] || "", A[4] && (F[T] = F[T].toLowerCase());
    }
    w && (F.query = w(F.query)), b && y.slashes && F.pathname.charAt(0) !== "/" && (F.pathname !== "" || y.pathname !== "") && (F.pathname = m(F.pathname, y.pathname)), F.pathname.charAt(0) !== "/" && u(F.protocol) && (F.pathname = "/" + F.pathname), r(F.port, F.protocol) || (F.host = F.hostname, F.port = ""), F.username = F.password = "", F.auth && (z = F.auth.indexOf(":"), ~z ? (F.username = F.auth.slice(0, z), F.username = encodeURIComponent(decodeURIComponent(F.username)), F.password = F.auth.slice(z + 1), F.password = encodeURIComponent(decodeURIComponent(F.password))) : F.username = encodeURIComponent(decodeURIComponent(F.auth)), F.auth = F.password ? F.username + ":" + F.password : F.username), F.origin = F.protocol !== "file:" && u(F.protocol) && F.host ? F.protocol + "//" + F.host : "null", F.href = F.toString();
  }
  function C(_, y, w) {
    var b = this;
    switch (_) {
      case "query":
        typeof y == "string" && y.length && (y = (w || e.parse)(y)), b[_] = y;
        break;
      case "port":
        b[_] = y, r(y, b.protocol) ? y && (b.host = b.hostname + ":" + y) : (b.host = b.hostname, b[_] = "");
        break;
      case "hostname":
        b[_] = y, b.port && (y += ":" + b.port), b.host = y;
        break;
      case "host":
        b[_] = y, s.test(y) ? (y = y.split(":"), b.port = y.pop(), b.hostname = y.join(":")) : (b.hostname = y, b.port = "");
        break;
      case "protocol":
        b.protocol = y.toLowerCase(), b.slashes = !w;
        break;
      case "pathname":
      case "hash":
        if (y) {
          var R = _ === "pathname" ? "/" : "#";
          b[_] = y.charAt(0) !== R ? R + y : y;
        } else
          b[_] = y;
        break;
      case "username":
      case "password":
        b[_] = encodeURIComponent(y);
        break;
      case "auth":
        var E = y.indexOf(":");
  ...
  function L(_) {
    ...
    var y, w = this, b = w.host, R = w.protocol;
    R && R.charAt(R.length - 1) !== ":" && (R += ":");
    var E = R + (w.protocol && w.slashes || u(w.protocol) ? "//" : "");
    return w.username ? (E += w.username, w.password && (E += ":" + w.password), E += "@") : w.password ? (E += ":" + w.password, E += "@") : w.protocol !== "file:" && u(w.protocol) && !b && w.pathname !== "/" && (E += "@"), (b[b.length - 1] === ":" || s.test(w.hostname) && !w.port) && (b += ":"), E += b + w.pathname, y = typeof w.query == "object" ? _(w.query) : w.query, y && (E += y.charAt(0) !== "?" ? "?" + y : y), w.hash && (E += w.hash), E;
  }
  return v.prototype = { set: C, toString: L }, v.extractProtocol = k, v.location = p, v.trimLeft = l, v.qs = e, Nt = v, Nt;
}
var fn = un();
const hn = /* @__PURE__ */ cn(fn);
function gn() {
...
function ti() {
  ...
  function d(x, h, g, P) {
    var U = h && h.prototype instanceof L ? h : L, S = Object.create(U.prototype), j = new Y(P || []);
  ...
  e.wrap = d;
  var u = "suspendedStart", k = "suspendedYield", m = "executing", v = "completed", C = {};
  function L() {
  }
  function _() {
  }
  ...
  var E = y.prototype = L.prototype = Object.create(w);
  function A(x) {
  ...
  function T(x, h, g) {
    ...
    return function(U, S) {
      ...
      for (g.method = U, g.arg = S; ; ) {
        ...
        var q = p(x, h, g);
        if (q.type === "normal") {
          if (P = g.done ? v : k, q.arg === C) continue;
  ...
  return _.prototype = y, o(E, "constructor", { value: y, configurable: !0 }), o(y, "constructor", { value: _, configurable: !0 }), _.displayName = c(y, l, "GeneratorFunction"), e.isGeneratorFunction = function(x) {
    ...
    return j.type = h, j.arg = g, S ? (this.method = "next", this.next = S.finallyLoc, C) : this.complete(j);
...
var _t = "tus-v1", kt = "ietf-draft-03", Qe = "ietf-draft-05", $n = {
  endpoint: null,
  uploadUrl: null,
  metadata: {},
  ...
  return kn(r, [{
    ...
    value: function() {
      ...
      var n = this._parallelUploadUrls != null ? this._parallelUploadUrls.length : this.options.parallelUploads, a = (t = this.options.parallelUploadBoundaries) !== null && t !== void 0 ? t : Pn(this._source.size, n);
          ...
          return new Promise(function(v, C) {
            var L = ze(ze({}, i.options), {}, {
              ...
              onProgress: function(w) {
                s = s - u + w, u = w, i._emitProgress(s, o);
              },
      ...
      Promise.all(l).then(function() {
        ...
        i.url = _r(i.options.endpoint, p), "Created upload at ".concat(i.url), i._emitSuccess(d);
      }).catch(function(d) {
        i._emitError(d);
      });
    }
    ...
    value: function(t) {
      ...
      if (this._parallelUploads != null) {
        var o = yn(this._parallelUploads), s;
        try {
          for (o.s(); !(s = o.n()).done; ) {
            var n = s.value;
            n.abort(t);
...
function ii() {
  return ii = mn(/* @__PURE__ */ ti().mark(function r(e, t, i) {
    var o;
...
function wr(r, e, t) {
  return t.retryDelays == null || e >= t.retryDelays.length || r.originalRequest == null ? !1 : t && typeof t.onShouldRetry == "function" ? t.onShouldRetry(r, e, t) : vo(r);
}
function vo(r) {
  var e = r.originalResponse ? r.originalResponse.getStatus() : 0;
  return (!je(e, 400) || e === 409 || e === 423) && Cn();
}
function _r(r, e) {
  return new hn(e, r).toString();
}
function Pn(r, e) {
...
var kr = /* @__PURE__ */ (function() {
  function r(e) {
    On(this, r), this._file = e, this.size = e.size;
  }
  return Tn(r, [{
    key: "slice",
    value: function(t, i) {
      if (Un())
        return Rn(this._file.slice(t, i));
...
function An(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, Dn(i.key), i);
  }
}
function jn(r, e, t) {
  return e && An(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Dn(r) {
  var e = Mn(r, "string");
...
var Nn = /* @__PURE__ */ (function() {
  function r(e) {
    In(this, r), this._buffer = void 0, this._bufferOffset = 0, this._reader = e, this._done = !1;
  }
  return jn(r, [{
    key: "slice",
    value: function(t, i) {
    ...
    value: function(t, i) {
      ...
      return this._reader.read().then(function(l) {
        ...
        return d ? o._done = !0 : o._buffer === void 0 ? o._buffer = c : o._buffer = Bn(o._buffer, c), o._readUntilEnoughDataOrDone(t, i);
      });
    }
  }, {
...
function Vn(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, Yn(i.key), i);
  }
}
function Kn(r, e, t) {
  return e && Vn(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Yn(r) {
  var e = Wn(r, "string");
...
var Gn = /* @__PURE__ */ (function() {
  ...
  return Kn(r, [{
    key: "openFile",
    value: (function() {
      var e = Hn(/* @__PURE__ */ ri().mark(function i(o, s) {
        var n;
        return ri().wrap(function(l) {
          for (; ; ) switch (l.prev = l.next) {
            case 0:
              if (!(yo() && o && typeof o.uri < "u")) {
                l.next = 11;
                break;
              }
              return l.prev = 1, l.next = 4, En(o.uri);
            case 4:
            ...
            case 17:
              return l.abrupt("return", Promise.resolve(new Nn(o, s)));
            case 18:
...
function Xn(r, e) {
  return yo() ? Promise.resolve(Jn(r, e)) : Promise.resolve(["tus-br", r.name, r.type, r.size, r.lastModified, e.endpoint].join("-"));
}
function Jn(r, e) {
  var t = r.exif ? Zn(JSON.stringify(r.exif)) : "noexif";
...
function na(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, la(i.key), i);
  }
}
function aa(r, e, t) {
...
var da = oi, pa = /* @__PURE__ */ (function() {
  function r() {
    sa(this, r);
  }
  return aa(r, [{
...
function fa(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, _o(i.key), i);
  }
}
function ha(r, e, t) {
  return t && fa(r, t), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function ga(r, e, t) {
  return e = Rt(e), ma(r, wo() ? Reflect.construct(e, t || [], Rt(r).constructor) : e.apply(r, t));
}
function ma(r, e) {
...
var Er = De(De({}, Ut.defaultOptions), {}, {
  ...
  function e() {
    ...
    return ua(this, e), i = De(De({}, Er), i), ga(this, e, [t, i]);
  }
  return ba(e, r), ha(e, null, [{
    key: "terminate",
    value: function(i) {
...
const _a = 10 * 1024 * 1024, ka = 5 * 1024 * 1024, Sa = "https://eu-on-24001.connector.filerobot.com/files", $a = "https://eu-on-24001.connector.filerobot.com/json";
function Ca(r, e) {
  if (!e || !r.file) return !1;
  const t = e.sizeThreshold ?? _a;
  return r.size >= t;
}
function Pa(r, e) {
  const { tusConfig: t } = e, i = e.apiBase.replace(/\/+$/, ""), o = t.endpoint || Sa, s = t.jsonBase || $a, n = t.chunkSize ?? ka, a = t.resumable !== !1, l = t.parallelChunks ?? 1, c = t.retryDelays ?? [0, 1e3, 3e3, 5e3], d = i.split("/").pop() || "";
  let p = !1, u = !1, k = !1;
  const m = {
    name: r.name,
    type: r.type,
  ...
  gi(r.product) && (m.product = JSON.stringify(mi(r.product)));
  const v = async () => `tus-${r.id}-${o}`, C = new wa(r.file, {
    endpoint: o,
    chunkSize: n,
    retryDelays: c,
    parallelUploads: l,
    ...
    onUploadUrlAvailable() {
      C.url && e.onUploadUrlAvailable && !k && (k = !0, e.onUploadUrlAvailable(C.url));
    },
    onProgress(b, R) {
  ...
  return a ? C.findPreviousUploads().then((b) => {
    b.length > 0 && !u && C.resumeFromPreviousUpload(b[0]), u || w();
  }) : w(), {
    abort() {
      u = !0, p = !1, y(), C.abort(!0);
    },
...
const St = "_sfxRelativePath", Ur = 8, Ra = /* @__PURE__ */ new Set([
  "node_modules",
  "__MACOSX",
  "$RECYCLE.BIN",
...
function Oa(r) {
  return r ? r.startsWith(".") ? !0 : Ra.has(r) : !1;
}
function ki(r, e) {
  if (e) {
    try {
...
async function ko(r) {
  ...
  const s = [];
  return await So(i, "", s), { files: s, hadDirectories: o };
}
...
async function za(r, e, t) {
  try {
    ...
    if (r.isDirectory) {
      if (Oa(r.name)) return;
      const i = e ? `${e}/${r.name}` : r.name, o = await Aa(r);
      await So(o, i, t);
    }
  } catch (i) {
...
class ja {
  ...
  startUpload(e) {
    var u, k;
    const t = (k = (u = this.config).resolveUploadParams) == null ? void 0 : k.call(u, e), i = !!t && Object.keys(t).length > 0, o = !i && !e.remoteInfo && !e.remoteUrl && Ca(e, this.config.tusConfig);
    ...
    const l = La(
      ...
      G(this.store, e.id, { progress: _, bytesUploaded: m, speed: a }), this.updateTotalProgress();
    };
    let p;
    if (e.remoteInfo)
      ...
      p = Ps(e, { ...c, onProgress: d });
    this.activeUploads.set(e.id, p);
  }
  handleComplete(e, t) {
    var d, p, u, k, m, v, C, L, _, y;
    this.activeUploads.delete(e);
    const i = this.store.getState().files.get(e), o = ((d = i == null ? void 0 : i.previewUrl) == null ? void 0 : d.startsWith("blob:")) ?? !1, s = ((u = (p = t.file) == null ? void 0 : p.url) == null ? void 0 : u.cdn) ?? ((m = (k = t.file) == null ? void 0 : k.url) == null ? void 0 : m.cdn_permalink) ?? ((C = (v = t.file) == null ? void 0 : v.url) == null ? void 0 : C.permalink) ?? null, n = s ? ((_ = (L = this.config).transformPreviewUrl) == null ? void 0 : _.call(L, s)) ?? s : null, a = {
      status: "complete",
      progress: 100,
      response: t,
      alreadyExisted: pt(t)
...
async function Ma(r) {
  ...
  if (r.mode === "security-template") {
    const t = await Da(r.container, r.securityTemplateId);
    return { apiBase: e, headers: ai(r, t), sassKey: t };
  }
  return { apiBase: e, headers: ai(r) };
}
const Ba = "https://ai.scaleflex.com", Rr = 300, Na = 0.85, Ha = 3e4;
function Or(r) {
  return r === "low" ? 0.6 : r === "high" ? 0.9 : 0.75;
}
...
async function Ya(r) {
  const e = await Ka(r);
  try {
    const t = e.width > Rr ? Rr / e.width : 1, i = Math.max(1, Math.round(e.width * t)), o = Math.max(1, Math.round(e.height * t)), s = document.createElement("canvas");
...
async function Fr(r, e) {
  var a, l;
  const t = new AbortController(), i = setTimeout(() => t.abort(), Ha), o = () => t.abort();
  ...
  try {
    n();
    const c = await qa(r, s);
    n();
    const d = await Ya(c);
    n();
    const u = `${(e.endpoint || Ba).replace(/\/+$/, "")}/images/embedding/vectorize/image?threshold=${encodeURIComponent(String(e.threshold))}`, k = new FormData();
    k.append("file", d, Va(r.name));
    ...
    return (v.similar_assets ?? []).map(([C, L, _]) => ({
      uuid: C,
      score: L,
      url: _
    }));
...
const Ot = "sfx-uploader:last-upload:", $o = 1;
function Wa(r) {
  var s, n, a, l, c, d, p, u, k;
  const { file: e, previewUrl: t, ...i } = r;
  let o = null;
  return r.status === "complete" && (r.previewUrl && !r.previewUrl.startsWith("blob:") ? o = r.previewUrl : o = ((a = (n = (s = r.response) == null ? void 0 : s.file) == null ? void 0 : n.url) == null ? void 0 : a.permalink) ?? ((d = (c = (l = r.response) == null ? void 0 : l.file) == null ? void 0 : c.url) == null ? void 0 : d.cdn_permalink) ?? ((k = (u = (p = r.response) == null ? void 0 : p.file) == null ? void 0 : u.url) == null ? void 0 : k.cdn) ?? null), { ...i, previewUrl: o };
}
function Ga(r) {
  try {
    ...
    return (t == null ? void 0 : t.__schemaVersion) !== $o ? null : t;
  } catch {
    return null;
  }
}
...
const Qa = /* @__PURE__ */ new Set([".ds_store", "thumbs.db", "desktop.ini"]);
function Vt(r) {
  const e = (r.split(/[\\/]/).pop() ?? r).toLowerCase();
  return e.startsWith(".ds_store") ? !0 : Qa.has(e);
}
const el = "https://scaleflex.cloudimg.io/v7/assets/file-types/v3/", Co = {
  _default: "9a518a",
  // Images
  png: "96cd9a",
  jpg: "06e819",
...
function li(r) {
  ...
  return `${el}${e}.svg?vh=${Co[r]}`;
}
function Po(r) {
  const e = (r == null ? void 0 : r.toLowerCase().replaceAll(".", "")) || "";
  return e in Co ? li(e) : li("_default");
}
function Eo() {
  return li("_default");
}
...
function ol(r) {
  return r.filter((e) => e in zr).map((e) => zr[e]);
}
function Ee(r) {
  return r.brandStyle ? f`<span
    class=${Io({ "brand-ico": !0, "brand-ico--transparent": r.brandStyle.background === "transparent" })}
    ${Z(r.brandStyle)}
  >${Bi(r.brandHtml)}</span>` : Bi(r.brandHtml);
}
var sl = Object.defineProperty, Uo = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && sl(e, t, o), o;
};
const nl = '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>', al = '<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>', ll = '<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>', cl = '<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>', et = [
  { id: "device", labelKey: "myDevice", label: "My Device", icon: nl, iconColor: "#2563eb" },
  { id: "url", labelKey: "urlLink", label: "URL link", icon: al, iconColor: "#16a34a" },
  { id: "camera", labelKey: "camera", label: "Camera", icon: ll, iconColor: "#7c3aed" },
...
function dl(r, e) {
  ...
  for (const o of r ?? []) {
    ...
    const s = o.type === ci.LANGUAGES ? pl(o.variants, e) : void 0;
...
function fl(r) {
  return Ro.has(r.type) || ul.has(r.ckey);
}
const He = "product.ref", qe = "product.position", hl = "__product__", gl = /* @__PURE__ */ new Set([
  He,
  qe
]);
function ml(r) {
...
function ic(r, e, t) {
  ...
  if (di(e)) return null;
  if (r.key === He)
    return typeof e != "string" || Jr.test(e) ? "Reference contains invalid characters" : null;
  if (r.key === qe) {
    const s = Number(e);
...
function Oo(r, e) {
  var t;
  return fl(r) ? !1 : (t = e == null ? void 0 : e.requiredFields) != null && t.includes(r.ckey) ? !0 : !!r.required;
}
function Ci(r) {
  return [...r.values()].filter((e) => wl.has(e.status));
}
function Pi(r, e) {
  return r.fields.filter((t) => Oo(t, e));
}
function rc(r, e, t) {
  const i = Ci(r);
...
var Sl = Object.defineProperty, le = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Sl(e, t, o), o;
};
const Ir = 3, pi = new CSSStyleSheet();
pi.replaceSync(`
...
const oe = (we = class extends pe {
  constructor() {
    super(...arguments), this.t = (e, t) => typeof t == "string" ? t : e, this.compact = !1, this.externalDragOver = !1, this.accept = "", this.multi = !0, this.directory = !1, this.sources = [], this.sourcesLayout = "pills", this.mode = "modal", this._resizeObserver = null, this._dragOver = !1, this._moreOpen = !1, this._visiblePills = Ir, this._dragCounter = 0, this._onDragEnter = (e) => {
      ...
      t && ko(t).then(({ files: i, hadDirectories: o }) => {
  ...
  _updateDropdownPortal() {
    if (this._moreOpen) {
      ...
      this._portalContainer || (this._portalContainer = document.createElement("div"), this._portalContainer.setAttribute("data-sfx-more-dropdown", ""), Fo(this).appendChild(this._portalContainer), this._injectDropdownStyles()), Ue(
  ...
  _updateVisiblePills() {
    ...
    this.sourcesLayout === "cards" ? e <= 480 ? this._visiblePills = 2 : e <= 768 ? this._visiblePills = 3 : this._visiblePills = 5 : e <= 768 ? this._visiblePills = 1 : this._visiblePills = Ir;
  }
  connectedCallback() {
...
Oi.styles = ne`
  ...
  `;
let Ar = Oi;
var $l = Object.defineProperty, W = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && $l(e, t, o), o;
};
...
const Fi = class Fi extends pe {
  ...
  _openPortal() {
    ...
    this._portalContainer || (this._portalContainer = document.createElement("div"), this._portalContainer.setAttribute("data-sfx-tile-dropdown", ""), Fo(this).appendChild(this._portalContainer), this._injectTileDropdownStyles()), Ue(
...
var Cl = Object.defineProperty, ee = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Cl(e, t, o), o;
};
const Ti = class Ti extends pe {
  ...
  render() {
    ...
    const e = this.file;
    if (!e) return $;
    const t = ue(e), i = e.status === "complete", o = e.status === "uploading", s = e.status === "paused", n = e.status === "error" || e.status === "failed", a = e.status === "rejected", l = this.mode === "review", c = Za(e.name), d = t === "image" && !ve(e.type), p = this.selectMode && d && !l, u = this.similarCount >= 0, k = p && !u && this.similarStatus === "", m = !l && !i && !o && !s && !n && e.status !== "rejected" && this.similarStatus !== "searching" && !this.reviewPick, v = m, C = [
      "tile",
      i ? "done" : "",
      o ? "uploading" : "",
      s ? "paused" : "",
          ...
          ${e.previewUrl ? f`<img class="preview-img" src=${e.previewUrl} alt="" />` : f`
                ...
                <div class="type-icon">
                  <img
                    ...
                    alt="${c ? `${c} file` : "File"}"
                    @error=${(y) => {
      const w = y.target, b = Eo();
      !w.dataset.fallback && w.src !== b && (w.dataset.fallback = "1", w.src = b);
    }}
                  />
                </div>
              `}
...
`;
var Pl = Object.defineProperty, xe = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Pl(e, t, o), o;
};
const jr = 7, El = 4, Li = class Li extends pe {
  constructor() {
    super(...arguments), this.t = (e, t) => typeof t == "string" ? t : e, this.fileCount = 0, this.totalSize = 0, this.thumbnails = [], this.primaryLabel = "Done", this.failedFiles = [], this.alreadyExistedCount = 0, this.showMinimize = !1, this._maxThumbs = jr, this._updateMaxThumbs = () => {
      const e = window.innerWidth <= 768 ? El : jr;
...
var Ul = Object.defineProperty, gt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Ul(e, t, o), o;
};
...
var Rl = Object.defineProperty, ce = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Rl(e, t, o), o;
};
...
const Ol = 'button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';
function Ei(r, e) {
  return (t) => {
    if (t.key !== "Tab") return;
    const i = r();
    ...
    if (!o) return;
    const s = Array.from(o.querySelectorAll(Ol));
...
var Fl = Object.defineProperty, zt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Fl(e, t, o), o;
};
...
var Tl = Object.defineProperty, mt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Tl(e, t, o), o;
};
...
var Ll = Object.defineProperty, We = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Ll(e, t, o), o;
};
...
var zl = Object.defineProperty, Ui = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && zl(e, t, o), o;
};
...
var Il = Object.defineProperty, N = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Il(e, t, o), o;
};
const Dr = /* @__PURE__ */ new Set(["unsplash"]), be = 10, Al = 3, jl = [
  "auto",
  "mobile",
  "tablet",
  "desktop",
...
const B = (V = class extends pe {
  constructor() {
    super(), this.config = null, this._isOpen = !1, this._activeConnector = null, this._showUrlDialog = !1, this._showCameraDialog = !1, this._showScreenCastDialog = !1, this._similarSelectMode = !1, this._similarSelectedIds = /* @__PURE__ */ new Set(), this._similarRunIds = [], this._similarActiveIds = /* @__PURE__ */ new Set(), this._similarResults = /* @__PURE__ */ new Map(), this._previewPanelTab = "details", this._similarDismissTimer = null, this._similarAbort = null, this._previewFileId = null, this._previewDims = "—", this._fileInfoOpen = !0, this._splitPct = 58, this._showSettings = !1, this._setResize = !0, this._setMaxW = 2e3, this._setMaxH = 2e3, this._setTranscode = !1, this._setResolution = "auto", this._setResolutionOpen = !1, this._setProtocol = "hls", this._setResumable = !1, this._isResizing = !1, this._splitRafId = 0, this._previewDefaultApplied = !1, this._fullscreenPreviewUrl = null, this._fullscreenVideoFile = null, this._fsZoom = 1, this._fsPanX = 0, this._fsPanY = 0, this._fsDragging = !1, this._fsDragStartX = 0, this._fsDragStartY = 0, this._fsPanStartX = 0, this._fsPanStartY = 0, this._bodyDragOver = !1, this._isMinimized = !1, this._isPillExpanded = !1, this._metadataSchema = null, this._regionalFilters = {}, this._bulkMetadataOpen = !1, this._bulkMetadataInitialFieldKey = null, this._isReviewing = !1, this._reviewFiles = [], this._hasStoredReview = !1, this._metadataAutocomplete = null, this._taxonomyService = null, this._ultratagsService = null, this._onRegionalChange = (e) => {
      ...
      if ((((s = (o = this.config) == null ? void 0 : o.connectors) == null ? void 0 : s.providers) ?? []).includes(e)) {
        if (Dr.has(e)) {
          if (!customElements.get("sfx-search-provider-browser")) {
            const { SfxSearchProviderBrowser: a } = await import("./search-provider-browser-DU7Hs3vj.js");
          ...
          const { SfxProviderBrowser: a } = await import("./provider-browser-DMTPnUrP.js");
      ...
      const { url: t, name: i } = e.detail, o = (p = this.config) == null ? void 0 : p.callbacks, s = Tr(i), n = s.startsWith("image/");
      if (Vt(i)) return;
      ...
      Le(this._store, d), this._dispatchPublic(M.FILE_ADDED, { file: d }), (k = o == null ? void 0 : o.onFileAdded) == null || k.call(o, d), this._store.getState().queueConfig.autoProceed && this.upload();
    }, this._onUrlCancel = () => {
      this._showUrlDialog = !1;
      ...
      for (const l of e.detail.files) {
        ...
        if (k) {
          ...
          Le(this._store, v), this._dispatchPublic(M.FILE_REJECTED, {
            file: v,
            reason: k
          }), (n = t == null ? void 0 : t.onFileRejected) == null || n.call(t, v, k);
          continue;
        }
        const m = {
          id: Ie(),
    ...
    }, this._store = _s(), this._storeCtrl = new ks(this, this._store);
  }
  ...
  upload() {
    ...
    this.dispatchEvent(t) && (this._dispatchPublic(M.UPLOAD_STARTED, { files: e }), (l = (a = (n = this.config) == null ? void 0 : n.callbacks) == null ? void 0 : a.onUploadStarted) == null || l.call(a, e), this._engine.uploadAll(), (c = this.config) != null && c.minimizeOnUpload && ((d = this.config) == null ? void 0 : d.mode) !== "inline" && !this._isMinimized && (this._isMinimized = !0, this._isPillExpanded = !0, (k = (u = (p = this.config) == null ? void 0 : p.callbacks) == null ? void 0 : u.onMinimize) == null || k.call(u), this._dispatchFloatGeometryEvent(M.MINIMIZE), this.requestUpdate()));
  }
  ...
  _ensureEngine() {
    var e, t;
    !this._engine && this._apiBase && this._authHeaders && (this._engine = new ja(this._store, {
      apiBase: this._apiBase,
      authHeaders: this._authHeaders,
      tusConfig: this._normalizeTusConfig(),
  ...
  async _preloadMetadataSchema(e) {
    ...
    if (!(!t || !this._apiBase || !this._authHeaders))
      try {
        const { fetchMetadataSchema: i, createTagsAutocomplete: o, createTaxonomyService: s, createUltratagsService: n } = await import("./index-CPNZ8vyz.js"), a = await i(
          this._apiBase,
          this._authHeaders,
          t.projectUuid,
          t
        ...
        this._metadataAutocomplete = o(
          ...
          this._apiBase,
          this._authHeaders
        ), this._metadataSchema = a.productsEnabled ? yl(a, this._storeCtrl.state.t) : a;
        const l = this._metadataSchema.fields.filter((c) => Oo(c, t)).map((c) => c.key);
  ...
  _firstMissingRequiredFieldKey() {
    var e;
    return !this._metadataEnforcing || !this._metadataSchema ? null : _l(
  ...
  _onStoreChange() {
    ...
    for (const [m, v] of e.files) {
      ...
      v.status === "uploading" && C.progress !== v.progress && (this._dispatchPublic(M.UPLOAD_PROGRESS, {
        ...
        progress: v.progress,
        speed: v.speed
      }), (d = i == null ? void 0 : i.onUploadProgress) == null || d.call(i, v, v.progress, v.speed)), v.relativeFolder && C.status !== v.status && Mr.has(v.status) && !this._firedFolders.has(v.relativeFolder) && this._maybeDispatchFolderComplete(v.relativeFolder, e, i);
    }
    ...
    if (t.isUploading && !e.isUploading) {
      ...
      if (!m.some((C) => C.status === "cancelled")) {
        const C = m.filter((w) => w.status === "complete"), L = m.filter(
        ...
        const y = (k = this.config) == null ? void 0 : k.closeOnComplete;
        if (y !== !1 && y != null) {
          const w = typeof y == "number" ? y : 1500;
  ...
  _maybeDispatchFolderComplete(e, t, i) {
    ...
    if (o.length === 0 || o.some((l) => !Mr.has(l.status))) return;
  ...
  get _mergedSources() {
    ...
    const t = e.providers.length > 0 ? ol(e.providers) : [], i = e.customSources ?? [], o = e.coreSources ? new Set(e.coreSources) : null, s = o ? et.filter((u) => o.has(u.id)) : et, n = e.companionUrl ? s : s.filter((u) => u.id !== "url"), a = n.filter(
  ...
  _processIncomingFiles(e) {
    ...
    for (const p of e) {
      ...
      if (C) {
        ...
        const y = v.startsWith("image/") && !ve(v) ? URL.createObjectURL(p) : null, w = {
          id: Ie(),
          status: "rejected",
          file: p,
          remoteUrl: null,
      ...
      if (Le(this._store, _), this._dispatchPublic(M.FILE_ADDED, { file: _ }), (d = t == null ? void 0 : t.onFileAdded) == null || d.call(t, _), p.type.startsWith("video/")) {
        il(p).then((w) => {
          if (!w) return;
          const b = this._store.getState(), R = b.files.get(_.id);
          if (R) {
            const E = new Map(b.files);
            E.set(_.id, { ...R, previewUrl: w }), this._store.setState({ files: E });
          } else
        ...
        y.preload = "metadata", y.src = URL.createObjectURL(p), y.onerror = () => {
          ...
          const w = y.duration;
          if (URL.revokeObjectURL(y.src), !isFinite(w)) return;
          const b = this._store.getState(), R = b.files.get(_.id);
          if (R) {
            const E = new Map(b.files);
            E.set(_.id, { ...R, duration: w }), this._store.setState({ files: E });
          }
        };
      }
    }
  ...
  _checkSimilarSingleFile(e) {
    ...
    const i = Or((n = (s = this.config) == null ? void 0 : s.similarityCheck) == null ? void 0 : n.confidence), o = (l = (a = this.config) == null ? void 0 : a.similarityCheck) == null ? void 0 : l.endpoint;
    this._similarActiveIds = new Set(this._similarActiveIds).add(e.id), Fr(e, { ...t, threshold: i, endpoint: o }).then((c) => {
  ...
  _runSimilarityCheck(e) {
    ...
    const i = Or((k = (u = this.config) == null ? void 0 : u.similarityCheck) == null ? void 0 : k.confidence), o = (v = (m = this.config) == null ? void 0 : m.similarityCheck) == null ? void 0 : v.endpoint, s = new AbortController();
    ...
    const c = e.length, d = () => {
      ...
      if (!s.signal.aborted)
        for (; a < Al && n.length > 0; ) {
          const C = n.shift();
          a += 1, this._similarActiveIds = new Set(this._similarActiveIds).add(C.id), Fr(C, { ...t, threshold: i, endpoint: o, signal: s.signal }).then((L) => {
  ...
  _locateFile(e) {
    var s, n, a;
    if (!e) return;
    const t = ys(e, this.config ?? void 0), i = this.dispatchEvent(
  ...
  _renderHeader() {
    ...
    const o = t === "modal" ? this._onModalDismiss : this._onInlineDismiss, s = i === "back" ? f`<button
          ...
          </button>` : $, n = (w = this.config) == null ? void 0 : w.uploadSettings, a = n !== !1 && (n == null || n.enabled !== !1), l = n !== !1 && n != null && n.showResumableSwitcher === !0, c = [...this._storeCtrl.state.files.values()], d = c.some(
      (E) => ue(E) === "image" && !ve(E.type)
  ...
  _renderUploadOverlay(e) {
    var d;
    const t = this._storeCtrl.state, i = t.t, o = Math.round(t.totalProgress ?? 0), s = e.filter((p) => p.status !== "rejected" && p.status !== "cancelled"), n = s.length, a = s.filter((p) => p.status === "complete").length, l = s.filter((p) => ni(p.status)), c = [];
    return n > 1 && c.push(i("nOfNComplete", "{{completed}} of {{total}} complete", { completed: a, total: n })), this._lastEta > 0 && c.push(i("etaLeft", "~{{eta}} left", { eta: qt(this._lastEta) })), f`
      ...
      return f`
              <div class="float-item">
                ...
                <div class="float-item-status">
                  ${d.status === "complete" ? f`${(u = this.config) != null && u.showLocateButton && ((m = (k = d.response) == null ? void 0 : k.file) != null && m.uuid) ? f`<button
  ...
  _renderPreviewLayout(e) {
    ...
    const n = i.reduce((R, E) => R + (E.size || 0), 0), a = !!((L = (C = this.config) == null ? void 0 : C.similarityCheck) != null && L.enabled), l = i.filter(
      ...
      l.length,
      be
    ), d = c > 0 && this._similarSelectedIds.size >= c, p = this._similarSelectedIds.size >= be, u = this._similarResults.get(o.id), k = u !== void 0, m = k ? this._previewPanelTab : "details";
    return f`
      <div class="preview-topbar"></div>
      <div class="preview-layout">
        <div class="file-grid-side" ${Z({ flex: String(this._splitPct) })}>
          ${((_ = this.config) == null ? void 0 : _.mode) === "inline" && ((y = this.config) != null && y.inlineHeader) ? this._renderInlineHeader(this.config.inlineHeader) : $}
  ...
  _renderBody() {
    ...
    ), s = this._phase, n = Lr(e.restrictions), a = i.length > 0, l = !!((m = (k = this.config) == null ? void 0 : k.similarityCheck) != null && m.enabled), c = i.filter(
        ...
        ${this._activeConnector && ((z = this.config) != null && z.connectors) ? f`
              ...
              >
                <div class="connector-modal">
                  ${Dr.has(this._activeConnector) ? f`
                        <sfx-search-provider-browser
                          .t=${t}
