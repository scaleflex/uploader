"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const t=require("lit"),a=require("lit/decorators.js"),l=require("./sfx-uploader-ETkgtuBT.cjs");var u=Object.defineProperty,n=(c,r,e,s)=>{for(var o=void 0,d=c.length-1,h;d>=0;d--)(h=c[d])&&(o=h(r,e,o)||o);return o&&u(r,e,o),o};const p=class p extends t.LitElement{constructor(){super(...arguments),this.provider="unsplash",this.companionUrl="",this.transformThumbnail=r=>r,this._loading=!1,this._loadingMore=!1,this._items=[],this._selectedIds=new Set,this._error=null,this._searchQuery="",this._nextPageQuery=null,this._searched=!1,this._onResultsScroll=r=>{if(!this._nextPageQuery||this._loadingMore)return;const e=r.target;e.scrollHeight-e.scrollTop-e.clientHeight<200&&this._onLoadMore()},this._onSearchInput=r=>{this._searchQuery=r.target.value},this._onSearchKeydown=r=>{r.key==="Enter"&&this._doSearch()},this._onAddSelected=()=>{const e=this._items.filter(s=>this._selectedIds.has(s.id)).map(s=>({companionUrl:this.companionUrl,provider:this.provider,token:"",requestPath:s.requestPath,fileId:s.id,name:s.name||s.id,mimeType:s.mimeType,size:s.size,thumbnail:s.thumbnail}));this.dispatchEvent(new CustomEvent("connector-files-selected",{detail:{files:e},bubbles:!0,composed:!0}))},this._onClose=()=>{this.dispatchEvent(new CustomEvent("connector-close",{bubbles:!0,composed:!0}))}}get _providerLabel(){var e;return((e=l.getProviderSources([this.provider])[0])==null?void 0:e.label)??this.provider}async _doSearch(){const r=this._searchQuery.trim();if(r){this._loading=!0,this._error=null,this._items=[],this._selectedIds=new Set,this._nextPageQuery=null,this._searched=!0;try{const e=await l.searchProvider(this.companionUrl,this.provider,r),s=new Set;this._items=e.items.filter(o=>s.has(o.id)?!1:(s.add(o.id),!0)),this._nextPageQuery=e.nextPageQuery}catch(e){this._error=e instanceof Error?e.message:"Search failed"}finally{this._loading=!1}}}async _onLoadMore(){if(!(!this._nextPageQuery||this._loadingMore)){this._loadingMore=!0;try{const r=await l.searchProvider(this.companionUrl,this.provider,this._searchQuery.trim(),this._nextPageQuery),e=new Set(this._items.map(o=>o.id)),s=r.items.filter(o=>!e.has(o.id));this._items=[...this._items,...s],this._nextPageQuery=r.nextPageQuery}catch{}finally{this._loadingMore=!1}}}_toggleSelect(r){const e=new Set(this._selectedIds);e.has(r.id)?e.delete(r.id):e.add(r.id),this._selectedIds=e}render(){return t.html`
      ...
      <div class="results" @scroll=${this._onResultsScroll}>
        <div class="results-grid">
          ${this._items.map(e=>{var s;return t.html`
              ...
              >
                ${e.thumbnail?t.html`<img src=${this.transformThumbnail(e.thumbnail)} alt=${e.name} loading="lazy" referrerpolicy="no-referrer" />`:t.nothing}
                <div class="check">
  ...
  `;let i=p;n([a.property({type:String})],i.prototype,"provider");n([a.property({type:String})],i.prototype,"companionUrl");n([a.property({attribute:!1})],i.prototype,"transformThumbnail");n([a.state()],i.prototype,"_loading");n([a.state()],i.prototype,"_loadingMore");n([a.state()],i.prototype,"_items");n([a.state()],i.prototype,"_selectedIds");n([a.state()],i.prototype,"_error");n([a.state()],i.prototype,"_searchQuery");n([a.state()],i.prototype,"_nextPageQuery");n([a.state()],i.prototype,"_searched");exports.SfxSearchProviderBrowser=i;
