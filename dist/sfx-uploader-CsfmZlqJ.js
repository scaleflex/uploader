import { noChange as Kt, svg as ke, html as u, LitElement as pe, css as ne, render as Fe, nothing as $ } from "lit";
import { property as F, state as I, query as Ci } from "lit/decorators.js";
import { repeat as si } from "lit/directives/repeat.js";
import { directive as Wo, Directive as Go, PartType as Xo } from "lit/directive.js";
import { unsafeSVG as _e } from "lit/directives/unsafe-svg.js";
import { unsafeHTML as Qi } from "lit/directives/unsafe-html.js";
import { classMap as Jo } from "lit/directives/class-map.js";
const j = (r) => typeof r == "string", Je = () => {
  let r, e;
  const t = new Promise((i, o) => {
    r = i, e = o;
  });
  return t.resolve = r, t.reject = e, t;
}, er = (r) => r == null ? "" : String(r), Zo = (r, e, t) => {
  r.forEach((i) => {
    e[i] && (t[i] = e[i]);
  });
}, Qo = /###/g, tr = (r) => r && r.includes("###") ? r.replace(Qo, ".") : r, ir = (r) => !r || j(r), rt = (r, e, t) => {
  ...
  let s = e[e.length - 1], n = e.slice(0, e.length - 1), a = rt(r, n, Object);
  for (; a.obj === void 0 && n.length; )
    s = `${n[n.length - 1]}.${s}`, n = n.slice(0, n.length - 1), a = rt(r, n, Object), a != null && a.obj && typeof a.obj[`${a.k}.${s}`] < "u" && (a.obj = void 0);
  a.obj[`${a.k}.${s}`] = t;
}, es = (r, e, t, i) => {
  const {
    obj: o,
  ...
  const i = Ft(r, t);
  return i !== void 0 ? i : Ft(e, t);
}, io = (r, e, t) => {
  for (const i in e)
    i !== "__proto__" && i !== "constructor" && (i in r ? j(r[i]) || r[i] instanceof String || j(e[i]) || e[i] instanceof String ? t && (r[i] = e[i]) : io(r[i], e[i], t) : r[i] = e[i]);
  return r;
}, ve = (r) => r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), is = {
  "&": "&amp;",
  "<": "&lt;",
...
const ss = [" ", ",", "?", "!", ";"], ns = new os(20), as = (r, e, t) => {
  e = e || "", t = t || "";
  const i = ss.filter((n) => !e.includes(n) && !t.includes(n));
  if (i.length === 0) return !0;
  const o = ns.getRegExp(`(${i.map((n) => n === "?" ? "\\?" : n).join("|")})`);
  let s = !o.test(r);
  if (!s) {
    const n = r.indexOf(t);
  ...
  return o;
}, st = (r) => r == null ? void 0 : r.replace(/_/g, "-"), ls = {
  type: "logger",
  log(r) {
    this.output("log", r);
  },
...
class Ot {
  ...
  init(e, t = {}) {
    this.prefix = t.prefix || "i18next:", this.logger = e || ls, this.options = t, this.debug = t.debug;
  }
  log(...e) {
...
class or extends Bt {
  ...
  getResource(e, t, i, o = {}) {
    ...
    return !l && !t && !i && e.includes(".") && (e = a[0], t = a[1], i = a.slice(2).join(".")), l || !n || !j(i) ? l : ni((d = (c = this.data) == null ? void 0 : c[e]) == null ? void 0 : d[t], i, s);
  }
  addResource(e, t, i, o, s = {
    ...
    let a = [e, t];
    i && (a = a.concat(n ? i.split(n) : i)), e.includes(".") && (a = e.split("."), o = t, t = a[1]), this.addNamespaces(t), rr(this.data, a, o), s.silent || this.emit("added", e, t, i, o);
  }
  ...
  addResourceBundle(e, t, i, o, s, n = {
    ...
    n.skipCopy || (i = JSON.parse(JSON.stringify(i))), o ? io(l, i, s) : l = {
      ...l,
      ...i
    }, rr(this.data, a, l), n.silent || this.emit("added", e, t, i);
  }
...
function cs() {
  ...
  return e.get = (i, o) => {
    var s;
    return (s = t == null ? void 0 : t.revoke) == null || s.call(t), o === oo ? r : (r.push(o), t = Proxy.revocable(i, e), t.proxy);
  }, Proxy.revocable(/* @__PURE__ */ Object.create(null), e).proxy;
}
function Ne(r, e) {
  const {
    [oo]: t
  } = r(cs()), i = (e == null ? void 0 : e.keySeparator) ?? ".", o = (e == null ? void 0 : e.nsSeparator) ?? ":", s = (e == null ? void 0 : e.enableSelector) === "strict";
  if (t.length > 1 && o) {
...
const Yt = (r) => !j(r) && typeof r != "boolean" && typeof r != "number";
class Tt extends Bt {
  constructor(e, t = {}) {
    super(), Zo(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = xe.create("translator"), this.checkedLoadedFor = {};
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, t) {
    ...
    const n = i && e.includes(i), a = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !as(e, i, o);
    if (n && !a) {
  ...
  translate(e, t, i) {
    ...
    typeof e == "function" && (e = Ne(e, {
      ...this.options,
      ...o
    })), Array.isArray(e) || (e = [String(e)]), e = e.map((O) => typeof O == "function" ? Ne(O, {
      ...this.options,
      ...o
    }) : String(O));
    ...
    let m = k == null ? void 0 : k.res;
    const v = (k == null ? void 0 : k.usedKey) || a, S = (k == null ? void 0 : k.exactUsedKey) || a, L = ["[object Number]", "[object Function]", "[object RegExp]"], _ = o.joinArrays !== void 0 ? o.joinArrays : this.options.joinArrays, w = !this.i18nFormat || this.i18nFormat.handleAsObject, y = o.count !== void 0 && !j(o.count), x = Tt.hasDefaultValue(o), U = y ? this.pluralResolver.getSuffix(p, o.count, o) : "", E = o.ordinal && y ? this.pluralResolver.getSuffix(p, o.count, {
      ordinal: !1
    }) : "", A = y && !o.ordinal && o.count === 0, z = A && o[`defaultValue${this.options.pluralSeparator}zero`] || o[`defaultValue${U}`] || o[`defaultValue${E}`] || o.defaultValue;
    let T = m;
    w && !m && x && (T = z);
    const J = Yt(T), de = Object.prototype.toString.apply(T);
    if (w && T && J && !L.includes(de) && !(j(_) && Array.isArray(T))) {
      if (!o.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
        const O = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(v, T, {
          ...o,
          ns: l
        }) : `key '${a} (${this.language})' returned an object instead of string.`;
        return s ? (k.res = O, k.usedParams = this.getUsedParamsDetails(o), k) : O;
      }
      if (n) {
        const O = Array.isArray(T), Y = O ? [] : {}, ge = O ? S : v;
        for (const b in T)
          if (Object.prototype.hasOwnProperty.call(T, b)) {
            const h = `${ge}${n}${b}`;
            x && !m ? Y[b] = this.translate(h, {
              ...o,
              defaultValue: Yt(z) ? z[b] : void 0,
              joinArrays: !1,
              ns: l
            }) : Y[b] = this.translate(h, {
              ...o,
              joinArrays: !1,
              ns: l
            }), Y[b] === h && (Y[b] = T[b]);
    ...
    } else if (w && j(_) && Array.isArray(m))
      m = m.join(_), m && (m = this.extendTranslation(m, e, o, i));
    else {
      let O = !1, Y = !1;
      !this.isValidLookup(m) && x && (O = !0, m = z), this.isValidLookup(m) || (Y = !0, m = a);
      const b = (o.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && Y ? void 0 : m, h = x && z !== m && this.options.updateMissing;
      if (Y || O || h) {
        if (this.logger.log(h ? "updateKey" : "missingKey", p, c, y && !h ? `${a}${this.pluralResolver.getSuffix(p, o.count, o)}` : a, h ? z : m), n) {
        ...
        const R = (C, D, H) => {
          var ee;
          const q = x && H !== m ? H : b;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(C, c, D, q, h, o) : (ee = this.backendConnector) != null && ee.saveMissing && this.backendConnector.saveMissing(C, c, D, q, h, o), this.emit("missingKey", C, c, D, m);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && y ? g.forEach((C) => {
          const D = this.pluralResolver.getSuffixes(C, o);
          A && o[`defaultValue${this.options.pluralSeparator}zero`] && !D.includes(`${this.options.pluralSeparator}zero`) && D.push(`${this.options.pluralSeparator}zero`), D.forEach((H) => {
            R([C], a + H, o[`defaultValue${H}`] || z);
          });
        }) : R(g, a, z));
      }
      m = this.extendTranslation(m, e, o, k, i), Y && m === a && this.options.appendNamespaceToMissingKey && (m = `${c}${d}${a}`), (Y || O) && this.options.parseMissingKeyHandler && (m = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${c}${d}${a}` : a, O ? m : void 0, o));
    }
    return s ? (k.res = m, k.usedParams = this.getUsedParamsDetails(o), k) : m;
  }
  extendTranslation(e, t, i, o, s) {
    ...
    if ((l = this.i18nFormat) != null && l.parse)
      ...
      let f = i.replace && !j(i.replace) ? i.replace : i;
      if (this.options.interpolation.defaultVariables && (f = {
        ...this.options.interpolation.defaultVariables,
        ...f
      }), e = this.interpolator.interpolate(e, f, i.lng || this.language || o.usedLng, i), d) {
        const k = e.match(this.interpolator.nestingRegexp), m = k && k.length;
        p < m && (i.nest = !1);
      }
    ...
    return e != null && (a != null && a.length) && i.applyPostProcessor !== !1 && (e = ro.handle(a, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...o,
  ...
  resolve(e, t = {}) {
    let i, o, s, n, a;
    return j(e) && (e = [e]), Array.isArray(e) && (e = e.map((l) => typeof l == "function" ? Ne(l, {
      ...this.options,
      ...t
    }) : l)), e.forEach((l) => {
      ...
      const f = t.count !== void 0 && !j(t.count), k = f && !t.ordinal && t.count === 0, m = t.context !== void 0 && (j(t.context) || typeof t.context == "number") && t.context !== "", v = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      p.forEach((S) => {
        var L, _;
        this.isValidLookup(i) || (a = S, !this.checkedLoadedFor[`${v[0]}-${S}`] && ((L = this.utils) != null && L.hasLoadedNamespace) && !((_ = this.utils) != null && _.hasLoadedNamespace(a)) && (this.checkedLoadedFor[`${v[0]}-${S}`] = !0, this.logger.warn(`key "${o}" for languages "${v.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), v.forEach((w) => {
          var U;
          if (this.isValidLookup(i)) return;
          n = w;
          const y = [d];
          if ((U = this.i18nFormat) != null && U.addLookupKeys)
            this.i18nFormat.addLookupKeys(y, d, w, S, t);
          else {
            let E;
            f && (E = this.pluralResolver.getSuffix(w, t.count, t));
            const A = `${this.options.pluralSeparator}zero`, z = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (f && (t.ordinal && E.startsWith(z) && y.push(d + E.replace(z, this.options.pluralSeparator)), y.push(d + E), k && y.push(d + A)), m) {
              const T = `${d}${this.options.contextSeparator || "_"}${t.context}`;
              y.push(T), f && (t.ordinal && E.startsWith(z) && y.push(T + E.replace(z, this.options.pluralSeparator)), y.push(T + E), k && y.push(T + A));
            }
          }
          let x;
          for (; x = y.pop(); )
            this.isValidLookup(i) || (s = x, i = this.getResource(w, S, x, t));
        }));
      });
    }), {
      res: i,
...
class ds {
  constructor(e, t = {}) {
    this.languageUtils = e, this.options = t, this.logger = xe.create("pluralResolver"), this.pluralRulesCache = {};
  }
  clearCache() {
    this.pluralRulesCache = {};
  }
  getRule(e, t = {}) {
    const i = st(e === "dev" ? "en" : e), o = t.ordinal ? "ordinal" : "cardinal", s = JSON.stringify({
      cleanedCode: i,
      type: o
    });
  ...
  getSuffixes(e, t = {}) {
    let i = this.getRule(e, t);
    return i || (i = this.getRule("dev", t)), i ? i.resolvedOptions().pluralCategories.sort((o, s) => nr[o] - nr[s]).map((o) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${o}`) : [];
  }
  getSuffix(e, t, i = {}) {
...
const lr = (r, e, t, i = ".", o = !0) => {
  let s = ts(r, e, t);
  return !s && o && j(t) && (s = ni(r, t, i), s === void 0 && (s = ni(e, t, i))), s;
}, Wt = (r) => r.replace(/\$/g, "$$$$");
class cr {
  constructor(e = {}) {
    var t;
    this.logger = xe.create("interpolator"), this.options = e, this.format = ((t = e == null ? void 0 : e.interpolation) == null ? void 0 : t.format) || ((i) => i), this.init(e);
  }
  init(e = {}) {
    ...
    this.escape = t !== void 0 ? t : rs, this.escapeValue = i !== void 0 ? i : !0, this.useRawValueToEscape = o !== void 0 ? o : !1, this.prefix = s ? ve(s) : n || "{{", this.suffix = a ? ve(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = d ? "" : p ? ve(p) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : d ? ve(d) : "", this.nestingPrefix = f ? ve(f) : k || ve("$t("), this.nestingSuffix = m ? ve(m) : v || ve(")"), this.nestingOptionsSeparator = S || ",", this.maxReplaces = L || 1e3, this.alwaysFormat = _ !== void 0 ? _ : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, t, i, o) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (m) => {
      if (!m.includes(this.formatSeparator)) {
        const _ = lr(t, l, m, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      const v = m.split(this.formatSeparator), S = v.shift().trim(), L = v.join(this.formatSeparator).trim();
      return this.format(lr(t, l, S, this.options.keySeparator, this.options.ignoreJSONStructure), L, i, {
        ...o,
        ...t,
        interpolationkey: S
      });
    ...
    const d = (o == null ? void 0 : o.missingInterpolationHandler) || this.options.missingInterpolationHandler, p = ((k = o == null ? void 0 : o.interpolation) == null ? void 0 : k.skipOnVariables) !== void 0 ? o.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables;
    return [{
      regex: this.regexpUnescape,
      safeValue: (m) => Wt(m)
    }, {
      regex: this.regexp,
      safeValue: (m) => this.escapeValue ? Wt(this.escape(m)) : Wt(m)
    }].forEach((m) => {
      for (a = 0; s = m.regex.exec(e); ) {
        ...
        else !j(n) && !this.useRawValueToEscape && (n = er(n));
        const S = m.safeValue(n);
        if (e = e.replace(s[0], S), p ? (m.regex.lastIndex += n.length, m.regex.lastIndex -= s[0].length) : m.regex.lastIndex = 0, a++, a >= this.maxReplaces)
          break;
      }
    }), e;
  }
  nest(e, t, i = {}) {
    ...
    const a = (l, c) => {
      ...
      const p = l.split(new RegExp(`${ve(d)}[ ]*{`));
      let f = `{${p[1]}`;
      l = p[0], f = this.interpolate(f, n);
      const k = f.match(/'/g), m = f.match(/"/g);
      (((k == null ? void 0 : k.length) ?? 0) % 2 === 0 && !m || ((m == null ? void 0 : m.length) ?? 0) % 2 !== 0) && (f = f.replace(/'/g, '"'));
      try {
        n = JSON.parse(f), c && (n = {
          ...c,
          ...n
    ...
    for (; o = this.nestingRegexp.exec(e); ) {
      ...
      j(s) || (s = er(s)), s || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${e}`), s = ""), l.length && (s = l.reduce((d, p) => this.format(d, p, i.lng, {
        ...i,
...
const ps = (r) => {
  ...
  return (t, i, o) => {
    ...
    let a = e[n];
    return a || (a = r(st(i), o), e[n] = a), a(t);
  };
}, us = (r) => (e, t, i) => r(st(t), i)(e);
class fs {
  constructor(e = {}) {
  ...
  init(e, t = {
    ...
    const i = t.cacheInBuiltFormats ? dr : us;
    this.formats = {
      number: i((o, s) => {
  ...
  format(e, t, i, o = {}) {
    ...
    return s.reduce((a, l) => {
      ...
      if (this.formats[c]) {
        let f = a;
        try {
          const k = ((p = o == null ? void 0 : o.formatParams) == null ? void 0 : p[o.interpolationkey]) || {}, m = k.locale || k.lng || o.locale || o.lng || i;
          f = this.formats[c](a, m, {
            ...d,
            ...o,
            ...k
          });
...
class gs extends Bt {
  ...
  queueLoad(e, t, i, o) {
    ...
    return e.forEach((c) => {
      ...
      t.forEach((p) => {
        const f = `${c}|${p}`;
        !i.reload && this.store.hasResourceBundle(c, p) ? this.state[f] = 2 : this.state[f] < 0 || (this.state[f] === 1 ? n[f] === void 0 && (n[f] = !0) : (this.state[f] = 1, d = !1, n[f] === void 0 && (n[f] = !0), s[f] === void 0 && (s[f] = !0), l[p] === void 0 && (l[p] = !0)));
      }), d || (a[c] = !0);
  ...
  loaded(e, t, i) {
    ...
    this.queue.forEach((l) => {
      es(l.loaded, [s], n), hs(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const d = l.loaded[c];
    ...
    if (!(i == null || i === "")) {
      if ((f = this.backend) != null && f.create) {
        ...
        if (m.length < 6)
          try {
            let v;
            m.length === 5 ? v = m(e, t, i, o, k) : v = m(e, t, i, o), v && typeof v.then == "function" ? v.then((S) => a(null, S)).catch(a) : a(null, v);
          } catch (v) {
            a(v);
          }
        else
...
}), pr = (r) => (j(r.ns) && (r.ns = [r.ns]), j(r.fallbackLng) && (r.fallbackLng = [r.fallbackLng]), j(r.fallbackNS) && (r.fallbackNS = [r.fallbackNS]), r.supportedLngs && !r.supportedLngs.includes("cimode") && (r.supportedLngs = r.supportedLngs.concat(["cimode"])), r), vt = () => {
}, ms = (r) => {
...
class ot extends Bt {
  constructor(e = {}, t) {
    if (super(), this.options = pr(e), this.services = {}, this.logger = xe, this.modules = {
      external: []
    }, ms(this), t && !this.isInitialized && !e.isClone) {
  ...
  init(e = {}, t) {
    ...
    if (!this.options.isClone) {
      ...
      let c;
      this.modules.formatter ? c = this.modules.formatter : c = fs;
      const d = new sr(this.options);
      this.store = new or(this.options.resources, this.options);
      const p = this.services;
      p.logger = xe, p.resourceStore = this.store, p.languageUtils = d, p.pluralResolver = new ds(d, {
        prepend: this.options.pluralSeparator
      }), c && (p.formatter = o(c), p.formatter.init && p.formatter.init(p, this.options), this.options.interpolation.format = p.formatter.format.bind(p.formatter)), p.interpolator = new cr(this.options), p.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, p.backendConnector = new gs(o(this.modules.backend), p.resourceStore, p, this.options), p.backendConnector.on("*", (f, ...k) => {
        this.emit(f, ...k);
    ...
    if (this.format = this.options.interpolation.format, t || (t = vt), this.options.fallbackLng && !this.services.languageDetector && !this.options.lng) {
  ...
  reloadResources(e, t, i) {
    const o = Je();
    return typeof e == "function" && (i = e, e = void 0), typeof t == "function" && (i = t, t = void 0), e || (e = this.languages), t || (t = this.options.ns), i || (i = vt), this.services.backendConnector.reload(e, t, (s) => {
      o.resolve(), i(s);
    }), o;
  }
  use(e) {
    ...
    return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && ro.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
  }
  ...
  changeLanguage(e, t) {
    ...
    const o = (a) => {
      ...
      c && (this.language || o(c), this.translator.language || this.translator.changeLanguage(c), (p = (d = this.services.languageDetector) == null ? void 0 : d.cacheUserLanguage) == null || p.call(d, c)), this.loadResources(c, (f) => {
        s(f, c);
      });
    };
  ...
  getFixedT(e, t, i, o) {
    const s = o == null ? void 0 : o.scopeNs, n = (a, l, ...c) => {
      ...
      Array.isArray(s) && !p && (f.ns = s), typeof d.keyPrefix == "function" && (d.keyPrefix = Ne(d.keyPrefix, f));
      const k = this.options.keySeparator || ".";
      let m;
      return d.keyPrefix && Array.isArray(a) ? m = a.map((v) => (typeof v == "function" && (v = Ne(v, f)), `${d.keyPrefix}${k}${v}`)) : (typeof a == "function" && (a = Ne(a, f)), m = d.keyPrefix ? `${d.keyPrefix}${k}${a}` : a), this.t(m, d);
    };
  ...
  cloneInstance(e = {}, t = vt) {
    ...
    if ((e.debug !== void 0 || e.prefix !== void 0) && (s.logger = s.logger.clone(e)), ["store", "services", "language"].forEach((a) => {
      ...
      s.store = new or(a, o), s.services.resourceStore = s.store;
    }
    if (e.interpolation) {
      const l = {
        ...Gt().interpolation,
      ...
      s.services.interpolator = new cr(c);
    }
    return s.translator = new Tt(s.services, o), s.translator.on("*", (a, ...l) => {
      s.emit(a, ...l);
...
function no(r) {
  return !(typeof r != "string" || r.length === 0 || r.length > 128 || so.indexOf(r) > -1 || r.indexOf("..") > -1 || r.indexOf("\\") > -1 || /[?#%\s@]/.test(r) || /[\x00-\x1F\x7F]/.test(r));
}
function ao(r) {
  return !(!no(r) || r.indexOf("/") > -1);
}
function xs(r) {
  return no(r);
}
...
function ws(r) {
  return ys(r) ? r : Promise.resolve(r);
}
const _s = /\{\{(.+?)\}\}/g;
function ur(r, e) {
  let t = !1;
  const i = r.replace(_s, (o, s) => {
    const n = s.trim();
    if (so.indexOf(n) > -1) return o;
    const a = e[n];
    if (a == null) return o;
    const l = bs[n] || ao, c = String(a).split("+");
...
const Oe = typeof globalThis < "u" ? globalThis : typeof global < "u" ? global : typeof window < "u" ? window : void 0;
let Lt;
typeof fetch == "function" ? Lt = fetch : Oe && typeof Oe.fetch == "function" && (Lt = Oe.fetch);
const fr = lo() && Oe ? Oe.XMLHttpRequest : void 0, ks = typeof ActiveXObject == "function" && Oe ? Oe.ActiveXObject : void 0, co = [
  "__proto__",
  "constructor",
  "prototype"
], ai = (r, e) => {
  if (e && typeof e == "object") {
    ...
    for (const i of Object.keys(e))
      co.indexOf(i) > -1 || (t += "&" + encodeURIComponent(i) + "=" + encodeURIComponent(e[i]));
    if (!t) return r;
  ...
  typeof fetch == "function" ? fetch(r, e).then(o).catch(t) : Lt(r, e).then(o).catch(t);
}, Ss = (r, e, t, i) => {
  r.queryStringParams && (e = ai(e, r.queryStringParams));
  ...
  try {
    ...
    try {
      Object.keys(s).forEach((c) => {
        delete n[c];
      }), hr(e, n, i, a), r._omitFetchOptions = !0;
    } catch (c) {
      i(c);
    }
  }
}, $s = (r, e, t, i) => {
  t && typeof t == "object" && (t = ai("", t).slice(1)), r.queryStringParams && (e = ai(e, r.queryStringParams));
  try {
    const o = fr ? new fr() : new ks("MSXML2.XMLHTTP.3.0");
    ...
    if (s = typeof s == "function" ? s() : s, s) for (const n of Object.keys(s))
      co.indexOf(n) > -1 || o.setRequestHeader(n, s[n]);
  ...
  }), Lt && e.indexOf("file:") !== 0) return Ss(r, e, t, i);
  if (lo() || typeof ActiveXObject == "function") return $s(r, e, t, i);
...
var po = class {
  ...
  _readAny(r, e, t, i, o) {
    ...
    typeof this.options.loadPath == "function" && (s = this.options.loadPath(r, t)), s = ws(s), s.then((n) => {
      if (!n) return o(null, {});
      const a = ur(n, {
        lng: r.join("+"),
        ns: t.join("+")
      ...
      if (a == null) {
        const l = r.map(yt).join(", "), c = t.map(yt).join(", ");
  ...
  loadUrl(r, e, t, i) {
    const o = typeof t == "string" ? [t] : t, s = typeof i == "string" ? [i] : i, n = this.options.parseLoadPayload(o, s), a = yt(vs(r));
    this.options.request(this.options, r, n, (l, c) => {
      ...
      if (!c && l && l.message) {
        ...
        if ([
          ...
          "network",
          "load"
        ].find((k) => f.indexOf(k) > -1)) return e("failed loading " + a + ": " + yt(l.message), !0);
      }
      if (l) return e(l, !1);
      let d, p;
      try {
...
po.type = "backend";
const uo = "f7b2366e-fcb6-4f1a-8f23-8de48422989a", Es = "https://i18n-fastly.ultrafast.io", Us = "https://neo.wordplex.io", li = "uploader";
let me = null;
...
function Rs(r) {
  return ci.add(r), () => ci.delete(r);
}
async function Fs(r = "en") {
  return me ? (me.language !== r && (await me.changeLanguage(r), wt()), { i18n: me, isNew: !1 }) : (me = ae.createInstance(), await me.use(po).init({
    lng: r,
    fallbackLng: "en",
    ns: [li],
    defaultNS: li,
    ...
    interpolation: {
      // Interpolated values are rendered through Lit template bindings, which
      // insert text nodes (never parsed as HTML) — i18next's default HTML
      // escaping would show "R&D" as "R&amp;D" literally.
      escapeValue: !1
    },
    backend: {
      ...
      loadPath: `${Es}/api/export/grid/f2/${uo}?langs={{lng}}&separator=+&response_format=i18next_multi`,
      parse(e, t) {
        var s;
  ...
  }), me.on("languageChanged", wt), me.on("loaded", wt), wt(), { i18n: me, isNew: !0 });
}
function Os() {
  return me;
}
const Ts = "sfxUploaderTranslationsMissingKeysEnabled";
class Ls {
  constructor() {
    this.enabled = !1, this._missingKeys = {}, this._timer = null, this.debounceDelay = 2e3, this.enabled = typeof localStorage < "u" && localStorage.getItem(Ts) === "true", this.enabled && console.log(
...
curl '${Us}/api/import/request-translations' \\
  --data-raw '{"grid_uuid":"${uo}","translations_requests":${JSON.stringify(
...
const zs = new Ls(), Xt = (r, e) => r.replace(/\{\{(\w+)\}\}/g, (t, i) => String(e[i] ?? "")), ue = (r, e, t) => {
  if (typeof e == "string")
    return Xt(e, t ?? {});
  if (typeof e == "object" && e !== null) {
    ...
    if (o !== void 0) {
      const s = String(
        (o === 1 ? i.defaultValue_one : i.defaultValue_other) ?? i.defaultValue ?? r
      );
      return Xt(s, i);
    }
    return Xt(String(i.defaultValue ?? r), i);
  }
  return r;
}, Ee = (r, e, t) => {
  const i = Os();
  return !i || !i.isInitialized ? ue(r, e, t) : typeof e == "string" ? i.t(r, e, t ?? {}) : i.t(r, e ?? {});
}, Jt = (r) => r.includes("-") ? r : r.replace(/[A-Z]/g, (e) => `-${e.toLowerCase()}`);
class Is extends Go {
  constructor(e) {
    if (super(e), this._appliedProps = /* @__PURE__ */ new Set(), e.type !== Xo.ELEMENT)
  ...
  update(e, [t]) {
    if (t === this._lastStyles) return Kt;
    this._lastStyles = t;
    const { style: i } = e.element, o = t ?? {};
    for (const s of this._appliedProps)
      (!(s in o) || o[s] == null || o[s] === "") && (i.removeProperty(Jt(s)), this._appliedProps.delete(s));
    for (const [s, n] of Object.entries(o))
      n != null && n !== "" ? (i.setProperty(Jt(s), n), this._appliedProps.add(s)) : this._appliedProps.has(s) && (i.removeProperty(Jt(s)), this._appliedProps.delete(s));
    return Kt;
  }
}
const Z = Wo(Is);
...
const fo = ke`<line x1="2" y1="12" x2="5" y2="12" /><line x1="19" y1="12" x2="22" y2="12" /><line x1="12" y1="2" x2="12" y2="5" /><line x1="12" y1="19" x2="12" y2="22" /><circle cx="12" cy="12" r="7" />`, $t = u`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${fo}</svg>`;
class Ds {
  constructor(e) {
...
const Bs = "SAME_ASSET_EXISTS_SKIP_UPLOAD", Ns = "ERROR_SHA1_CONFLICT";
function ft(r) {
  return (r == null ? void 0 : r.code) === Bs || (r == null ? void 0 : r.code) === Ns;
}
function Pi(r, e) {
  return {
    ...r,
...
const ho = /[!#$%^&*()=+{}\[\];"<>\\,\/?~\t\n\r\s`]/;
function Fc(r) {
  return r == null || r === "" ? null : typeof r != "string" || ho.test(r) ? "productRefInvalid" : null;
}
function Oc(r) {
...
function qs(r, e) {
  ...
  let i = !1;
  const o = Hs(e.apiBase, e.folder, e.extraParams);
  t.open("POST", o);
  ...
  t.upload.addEventListener("progress", (n) => {
    ...
    t.status >= 200 && t.status < 300 && n.status === "success" ? e.onComplete(n) : ft(n) ? e.onComplete(Pi(n, r)) : e.onError(
      new Error(zt(n, `Upload failed (HTTP ${t.status})`))
    );
  ...
  if (r.file) {
    ...
    s.append("info[files[]]", JSON.stringify(n)), Object.keys(r.meta).length > 0 && s.append("meta[files[]]", JSON.stringify(r.meta)), r.tags.length > 0 && s.append("tags[files[]]", JSON.stringify(r.tags)), Ei(r.product) && s.append(
      "product[files[]]",
      JSON.stringify(Ui(r.product))
...
function Tc(r, e) {
  const t = Pe(r), i = btoa(JSON.stringify({ origin: window.location.origin })), o = ht(e);
  return `${t}/${o}/connect?state=${encodeURIComponent(i)}`;
}
async function Ks(r, e, t, i = "", o) {
  const s = Pe(r), n = i ? `/${i}` : "", a = ht(e), l = await fetch(`${s}/${a}/list${n}`, {
    method: "GET",
    headers: Nt(t),
    credentials: "same-origin",
    signal: o
...
async function Ys(r, e, t, i) {
  const o = Pe(r), s = await fetch(`${o}/${t}`, {
    method: "GET",
    headers: Nt(e),
    credentials: "same-origin",
    signal: i
...
async function Lc(r, e, t, i, o, s) {
  const n = [];
  async function a(l, c) {
    let d = null, p = !0;
    do {
      if (s != null && s.aborted) throw new DOMException("Aborted", "AbortError");
      const f = p ? await Ks(r, e, t, l, s) : await Ys(r, t, d, s);
      p = !1, d = f.nextPagePath;
      for (const k of f.items) {
        if (s != null && s.aborted) throw new DOMException("Aborted", "AbortError");
        if (k.isFolder) {
          const m = c ? `${c}/${k.name}` : k.name;
          await a(k.requestPath, m);
        } else
...
async function zc(r, e, t, i) {
  const o = Pe(r), s = ht(e), n = i ? `q=${encodeURIComponent(t)}&${i}` : `q=${encodeURIComponent(t)}`, a = await fetch(`${o}/search/${s}/list?${n}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json"
...
async function Ws(r, e, t, i, o, s = !1) {
  const n = Pe(r), a = ht(e), l = s ? `${n}/search/${a}/get/${i}` : `${n}/${a}/get/${i}`, c = s ? { Accept: "application/json", "Content-Type": "application/json" } : Nt(t), d = await fetch(l, {
    method: "POST",
    headers: c,
    credentials: "same-origin",
    body: JSON.stringify({
...
async function Gs(r, e, t) {
  const i = Pe(r), o = await fetch(`${i}/url/meta`, {
    method: "POST",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json"
...
async function Xs(r, e, t, i) {
  const o = Pe(r), s = await fetch(`${o}/url/get`, {
    method: "POST",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json"
...
async function Ic(r, e, t) {
  const i = Pe(r), o = ht(e), s = await fetch(`${i}/${o}/logout`, {
    method: "GET",
    headers: Nt(t),
    credentials: "same-origin"
  });
...
function mo(r, e) {
  ...
  return r.meta && Object.keys(r.meta).length > 0 && (t.meta = JSON.stringify(r.meta)), r.tags && r.tags.length > 0 && (t.tags = JSON.stringify(r.tags)), Ei(r.product) && (t.product = JSON.stringify(Ui(r.product))), t;
}
function xo(r) {
  const t = `${Js(r.companionUrl)}/api/${r.token}`;
  let i;
  try {
    i = new WebSocket(t);
  } catch {
  ...
  return i.onmessage = (n) => {
    ...
    if (!o)
      try {
        ...
        switch (d.action) {
          case "progress": {
            const p = d.payload, f = p.bytesUploaded ?? 0, k = p.bytesTotal ?? (r.expectedSize || 1);
            r.onProgress(f, k);
            break;
          }
          case "success": {
            ...
            if (s(), i.close(), (a = p.response) != null && a.responseText)
              try {
                ...
                if (ft(f)) {
                  r.onComplete(Pi(f, r.uploadFile));
                  return;
                }
                r.onError(new Error(zt(f, "Upload failed")));
                return;
              } catch {
              }
...
function Zs(r, e) {
  ...
  let i = !1, o = null;
  const s = go(e.apiBase, e.folder, e.extraParams), n = mo(r, e.folder), a = !t.token;
  return Ws(t.companionUrl, t.provider, t.token, t.requestPath, {
    fileId: t.fileId,
    endpoint: s,
...
function Qs(r, e) {
  ...
  let i = !1, o = null;
  const s = new AbortController(), n = go(e.apiBase, e.folder, e.extraParams);
  return Gs(e.companionUrl, t, s.signal).then((a) => {
    var c;
    if (i) return null;
    (c = e.onMeta) == null || c.call(e, { name: a.name, type: a.type, size: a.size });
    const l = mo(r, e.folder);
    return a.name && (l.name = a.name), a.type && (l.type = a.type), Xs(
      e.companionUrl,
      t,
      {
        fileId: r.id,
...
function rn(r, e, t) {
  return e = at(e), on(r, Fi() ? Reflect.construct(e, t || [], at(r).constructor) : e.apply(r, t));
}
function on(r, e) {
...
function pi(r) {
  ...
  return pi = function(i) {
    ...
    function o() {
      return an(i, arguments, at(this).constructor);
    }
    return o.prototype = Object.create(i.prototype, { constructor: { value: o, enumerable: !1, writable: !0, configurable: !0 } }), nt(o, i);
  }, pi(r);
}
function an(r, e, t) {
...
function nt(r, e) {
  return nt = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(i, o) {
...
var Qe = /* @__PURE__ */ (function(r) {
  function e(t) {
    ...
    if (tn(this, e), i = rn(this, e, [t]), i.originalRequest = s, i.originalResponse = n, i.causingError = o, o != null && (t += ", caused by ".concat(o.toString())), s != null) {
...
function dn(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, un(i.key), i);
  }
}
function pn(r, e, t) {
  return e && dn(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function un(r) {
  var e = fn(r, "string");
...
const vo = "3.7.8", gn = vo, Ge = typeof Buffer == "function", xr = typeof TextDecoder == "function" ? new TextDecoder() : void 0, br = typeof TextEncoder == "function" ? new TextEncoder() : void 0, mn = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", et = Array.prototype.slice.call(mn), _t = ((r) => {
  let e = {};
  return r.forEach((t, i) => e[t] = i), e;
})(et), xn = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/, ie = String.fromCharCode.bind(String), vr = typeof Uint8Array.from == "function" ? Uint8Array.from.bind(Uint8Array) : (r) => new Uint8Array(Array.prototype.slice.call(r, 0)), yo = (r) => r.replace(/=/g, "").replace(/[+\/]/g, (e) => e == "+" ? "-" : "_"), wo = (r) => r.replace(/[^A-Za-z0-9\+\/]/g, ""), _o = (r) => {
  let e, t, i, o, s = "";
  const n = r.length % 3;
  for (let a = 0; a < r.length; ) {
    if ((t = r.charCodeAt(a++)) > 255 || (i = r.charCodeAt(a++)) > 255 || (o = r.charCodeAt(a++)) > 255)
      throw new TypeError("invalid character found");
    e = t << 16 | i << 8 | o, s += et[e >> 18 & 63] + et[e >> 12 & 63] + et[e >> 6 & 63] + et[e & 63];
  }
  return n ? s.slice(0, n - 3) + "===".substring(n) : s;
}, Oi = typeof btoa == "function" ? (r) => btoa(r) : Ge ? (r) => Buffer.from(r, "binary").toString("base64") : _o, ui = Ge ? (r) => Buffer.from(r).toString("base64") : (r) => {
  let t = [];
  for (let i = 0, o = r.length; i < o; i += 4096)
    t.push(ie.apply(null, r.subarray(i, i + 4096)));
  return Oi(t.join(""));
}, Ct = (r, e = !1) => e ? yo(ui(r)) : ui(r), bn = (r) => {
  if (r.length < 2) {
...
}, vn = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, ko = (r) => r.replace(vn, bn), yr = Ge ? (r) => Buffer.from(r, "utf8").toString("base64") : br ? (r) => ui(br.encode(r)) : (r) => Oi(ko(r)), He = (r, e = !1) => e ? yo(yr(r)) : yr(r), wr = (r) => He(r, !0), yn = /[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g, wn = (r) => {
  switch (r.length) {
    case 4:
...
}, So = (r) => r.replace(yn, wn), $o = (r) => {
  if (r = r.replace(/\s+/g, ""), !xn.test(r))
    throw new TypeError("malformed base64.");
  r += "==".slice(2 - (r.length & 3));
  let e, t, i, o = [];
  for (let s = 0; s < r.length; )
    e = _t[r.charAt(s++)] << 18 | _t[r.charAt(s++)] << 12 | (t = _t[r.charAt(s++)]) << 6 | (i = _t[r.charAt(s++)]), t === 64 ? o.push(ie(e >> 16 & 255)) : i === 64 ? o.push(ie(e >> 16 & 255, e >> 8 & 255)) : o.push(ie(e >> 16 & 255, e >> 8 & 255, e & 255));
  return o.join("");
}, Ti = typeof atob == "function" ? (r) => atob(wo(r)) : Ge ? (r) => Buffer.from(r, "base64").toString("binary") : $o, Co = Ge ? (r) => vr(Buffer.from(r, "base64")) : (r) => vr(Ti(r).split("").map((e) => e.charCodeAt(0))), Po = (r) => Co(Eo(r)), _n = Ge ? (r) => Buffer.from(r, "base64").toString("utf8") : xr ? (r) => xr.decode(Co(r)) : (r) => So(Ti(r)), Eo = (r) => wo(r.replace(/[-_]/g, (e) => e == "-" ? "+" : "/")), fi = (r) => _n(Eo(r)), kn = (r) => {
  if (typeof r != "string")
    return !1;
  ...
  const r = (e, t) => Object.defineProperty(String.prototype, e, Uo(t));
  ...
  const r = (e, t) => Object.defineProperty(Uint8Array.prototype, e, Uo(t));
  r("toBase64", function(e) {
    return Ct(this, e);
  }), r("toBase64URI", function() {
    return Ct(this, !0);
...
var Zt, kr;
function Pn() {
  return kr || (kr = 1, Zt = function(e, t) {
...
function En() {
  ...
  return kt.stringify = s, kt.parse = o, kt;
}
var Qt, $r;
function Un() {
  if ($r) return Qt;
  $r = 1;
  var r = Pn(), e = En(), t = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/, i = /[\n\r\t]/g, o = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, s = /:\d+$/, n = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i, a = /^[a-zA-Z]:/;
  function l(_) {
  ...
  function p(_) {
    var w;
    typeof window < "u" ? w = window : typeof _r < "u" ? w = _r : typeof self < "u" ? w = self : w = {};
    var y = w.location || {};
    _ = _ || y;
    var x = {}, U = typeof _, E;
    if (_.protocol === "blob:")
      x = new v(unescape(_.pathname), {});
    else if (U === "string") {
      x = new v(_, {});
      for (E in d) delete x[E];
    } else if (U === "object") {
      for (E in _)
        E in d || (x[E] = _[E]);
  ...
  function k(_, w) {
    _ = l(_), _ = _.replace(i, ""), w = w || {};
    var y = n.exec(_), x = y[1] ? y[1].toLowerCase() : "", U = !!y[2], E = !!y[3], A = 0, z;
    return U ? E ? (z = y[2] + y[3] + y[4], A = y[2].length + y[3].length) : (z = y[2] + y[4], A = y[2].length) : E ? (z = y[3] + y[4], A = y[3].length) : z = y[4], x === "file:" ? A >= 2 && (z = z.slice(2)) : f(x) ? z = y[4] : x ? U && (z = z.slice(2)) : A >= 2 && f(w.protocol) && (z = y[4]), {
      protocol: x,
      slashes: U || f(x),
      slashesCount: A,
      rest: z
  ...
  function m(_, w) {
    if (_ === "") return w;
    for (var y = (w || "/").split("/").slice(0, -1).concat(_.split("/")), x = y.length, U = y[x - 1], E = !1, A = 0; x--; )
      y[x] === "." ? y.splice(x, 1) : y[x] === ".." ? (y.splice(x, 1), A++) : A && (x === 0 && (E = !0), y.splice(x, 1), A--);
    return E && y.unshift(""), (U === "." || U === "..") && y.push(""), y.join("/");
  }
  function v(_, w, y) {
    if (_ = l(_), _ = _.replace(i, ""), !(this instanceof v))
      return new v(_, w, y);
    var x, U, E, A, z, T, J = c.slice(), de = typeof w, O = this, Y = 0;
    for (de !== "object" && de !== "string" && (y = w, w = null), y && typeof y != "function" && (y = e.parse), w = p(w), U = k(_ || "", w), x = !U.protocol && !U.slashes, O.slashes = U.slashes || x && w.slashes, O.protocol = U.protocol || w.protocol || "", _ = U.rest, (U.protocol === "file:" && (U.slashesCount !== 2 || a.test(_)) || !U.slashes && (U.protocol || U.slashesCount < 2 || !f(O.protocol))) && (J[3] = [/(.*)/, "pathname"]); Y < J.length; Y++) {
      if (A = J[Y], typeof A == "function") {
        _ = A(_, O);
        continue;
      }
      E = A[0], T = A[1], E !== E ? O[T] = _ : typeof E == "string" ? (z = E === "@" ? _.lastIndexOf(E) : _.indexOf(E), ~z && (typeof A[2] == "number" ? (O[T] = _.slice(0, z), _ = _.slice(z + A[2])) : (O[T] = _.slice(z), _ = _.slice(0, z)))) : (z = E.exec(_)) && (O[T] = z[1], _ = _.slice(0, z.index)), O[T] = O[T] || x && A[3] && w[T] || "", A[4] && (O[T] = O[T].toLowerCase());
    }
    y && (O.query = y(O.query)), x && w.slashes && O.pathname.charAt(0) !== "/" && (O.pathname !== "" || w.pathname !== "") && (O.pathname = m(O.pathname, w.pathname)), O.pathname.charAt(0) !== "/" && f(O.protocol) && (O.pathname = "/" + O.pathname), r(O.port, O.protocol) || (O.host = O.hostname, O.port = ""), O.username = O.password = "", O.auth && (z = O.auth.indexOf(":"), ~z ? (O.username = O.auth.slice(0, z), O.username = encodeURIComponent(decodeURIComponent(O.username)), O.password = O.auth.slice(z + 1), O.password = encodeURIComponent(decodeURIComponent(O.password))) : O.username = encodeURIComponent(decodeURIComponent(O.auth)), O.auth = O.password ? O.username + ":" + O.password : O.username), O.origin = O.protocol !== "file:" && f(O.protocol) && O.host ? O.protocol + "//" + O.host : "null", O.href = O.toString();
  }
  function S(_, w, y) {
    var x = this;
    switch (_) {
      case "query":
        typeof w == "string" && w.length && (w = (y || e.parse)(w)), x[_] = w;
        break;
      case "port":
        x[_] = w, r(w, x.protocol) ? w && (x.host = x.hostname + ":" + w) : (x.host = x.hostname, x[_] = "");
        break;
      case "hostname":
        x[_] = w, x.port && (w += ":" + x.port), x.host = w;
        break;
      case "host":
        x[_] = w, s.test(w) ? (w = w.split(":"), x.port = w.pop(), x.hostname = w.join(":")) : (x.hostname = w, x.port = "");
        break;
      case "protocol":
        x.protocol = w.toLowerCase(), x.slashes = !y;
        break;
      case "pathname":
      case "hash":
        if (w) {
          var U = _ === "pathname" ? "/" : "#";
          x[_] = w.charAt(0) !== U ? U + w : w;
        } else
          x[_] = w;
        break;
      case "username":
      case "password":
        x[_] = encodeURIComponent(w);
        break;
      case "auth":
        var E = w.indexOf(":");
        ~E ? (x.username = w.slice(0, E), x.username = encodeURIComponent(decodeURIComponent(x.username)), x.password = w.slice(E + 1), x.password = encodeURIComponent(decodeURIComponent(x.password))) : x.username = encodeURIComponent(decodeURIComponent(w));
    }
    for (var A = 0; A < c.length; A++) {
      var z = c[A];
      z[4] && (x[z[1]] = x[z[1]].toLowerCase());
    }
  ...
  function L(_) {
    ...
    var w, y = this, x = y.host, U = y.protocol;
    U && U.charAt(U.length - 1) !== ":" && (U += ":");
    var E = U + (y.protocol && y.slashes || f(y.protocol) ? "//" : "");
    return y.username ? (E += y.username, y.password && (E += ":" + y.password), E += "@") : y.password ? (E += ":" + y.password, E += "@") : y.protocol !== "file:" && f(y.protocol) && !x && y.pathname !== "/" && (E += "@"), (x[x.length - 1] === ":" || s.test(y.hostname) && !y.port) && (x += ":"), E += x + y.pathname, w = typeof y.query == "object" ? _(y.query) : y.query, w && (E += w.charAt(0) !== "?" ? "?" + w : w), y.hash && (E += y.hash), E;
  }
  return v.prototype = { set: S, toString: L }, v.extractProtocol = k, v.location = p, v.trimLeft = l, v.qs = e, Qt = v, Qt;
}
var Rn = Un();
const Fn = /* @__PURE__ */ Cn(Rn);
function On() {
...
function hi() {
  ...
  var r, e = {}, t = Object.prototype, i = t.hasOwnProperty, o = Object.defineProperty || function(b, h, g) {
    b[h] = g.value;
  }, s = typeof Symbol == "function" ? Symbol : {}, n = s.iterator || "@@iterator", a = s.asyncIterator || "@@asyncIterator", l = s.toStringTag || "@@toStringTag";
  function c(b, h, g) {
    return Object.defineProperty(b, h, { value: g, enumerable: !0, configurable: !0, writable: !0 }), b[h];
  }
  try {
    c({}, "");
  } catch {
  ...
  function d(b, h, g, P) {
    var R = h && h.prototype instanceof L ? h : L, C = Object.create(R.prototype), D = new Y(P || []);
    return o(C, "_invoke", { value: T(b, g, D) }), C;
  }
  function p(b, h, g) {
    try {
      return { type: "normal", arg: b.call(h, g) };
    } catch (P) {
      return { type: "throw", arg: P };
    }
  }
  e.wrap = d;
  var f = "suspendedStart", k = "suspendedYield", m = "executing", v = "completed", S = {};
  function L() {
  }
  function _() {
  }
  ...
  var x = Object.getPrototypeOf, U = x && x(x(ge([])));
  U && U !== t && i.call(U, n) && (y = U);
  var E = w.prototype = L.prototype = Object.create(y);
  function A(b) {
  ...
  function z(b, h) {
    ...
    var P;
    o(this, "_invoke", { value: function(C, D) {
      function H() {
        return new h(function(q, ee) {
          g(C, D, q, ee);
        });
      }
  ...
  function J(b, h) {
    var g = h.method, P = b.iterator[g];
    if (P === r) return h.delegate = null, g === "throw" && b.iterator.return && (h.method = "return", h.arg = r, J(b, h), h.method === "throw") || g !== "return" && (h.method = "throw", h.arg = new TypeError("The iterator does not provide a '" + g + "' method")), S;
    var R = p(P, b.iterator, h.arg);
    if (R.type === "throw") return h.method = "throw", h.arg = R.arg, h.delegate = null, S;
    var C = R.arg;
    return C ? C.done ? (h[b.resultName] = C.value, h.next = b.nextLoc, h.method !== "return" && (h.method = "next", h.arg = r), h.delegate = null, S) : C : (h.method = "throw", h.arg = new TypeError("iterator result is not an object"), h.delegate = null, S);
  }
  function de(b) {
    var h = { tryLoc: b[0] };
  ...
  function Y(b) {
    this.tryEntries = [{ tryLoc: "root" }], b.forEach(de, this), this.reset(!0);
  }
  function ge(b) {
    if (b || b === "") {
      var h = b[n];
      ...
      if (!isNaN(b.length)) {
        var g = -1, P = function R() {
          for (; ++g < b.length; ) if (i.call(b, g)) return R.value = b[g], R.done = !1, R;
          return R.value = r, R.done = !0, R;
        };
        return P.next = P;
      }
    }
    throw new TypeError(Te(b) + " is not iterable");
  }
  return _.prototype = w, o(E, "constructor", { value: w, configurable: !0 }), o(w, "constructor", { value: _, configurable: !0 }), _.displayName = c(w, l, "GeneratorFunction"), e.isGeneratorFunction = function(b) {
    var h = typeof b == "function" && b.constructor;
    return !!h && (h === _ || (h.displayName || h.name) === "GeneratorFunction");
  }, e.mark = function(b) {
    return Object.setPrototypeOf ? Object.setPrototypeOf(b, w) : (b.__proto__ = w, c(b, l, "GeneratorFunction")), b.prototype = Object.create(E), b;
  }, e.awrap = function(b) {
    return { __await: b };
  }, A(z.prototype), c(z.prototype, a, function() {
    return this;
  }), e.AsyncIterator = z, e.async = function(b, h, g, P, R) {
    R === void 0 && (R = Promise);
    var C = new z(d(b, h, g, P), R);
    return e.isGeneratorFunction(h) ? C : C.next().then(function(D) {
    ...
    return g.reverse(), function R() {
      for (; g.length; ) {
        var C = g.pop();
        if (C in h) return R.value = C, R.done = !1, R;
      }
      return R.done = !0, R;
    };
  }, e.values = ge, Y.prototype = { constructor: Y, reset: function(h) {
    if (this.prev = 0, this.next = 0, this.sent = this._sent = r, this.done = !1, this.delegate = null, this.method = "next", this.arg = r, this.tryEntries.forEach(O), !h) for (var g in this) g.charAt(0) === "t" && i.call(this, g) && !isNaN(+g.slice(1)) && (this[g] = r);
  }, stop: function() {
    this.done = !0;
    ...
    var g = this;
    function P(ee, te) {
      return D.type = "throw", D.arg = h, g.next = ee, te && (g.method = "next", g.arg = r), !!te;
    }
    for (var R = this.tryEntries.length - 1; R >= 0; --R) {
      var C = this.tryEntries[R], D = C.completion;
      if (C.tryLoc === "root") return P("end");
      if (C.tryLoc <= this.prev) {
        var H = i.call(C, "catchLoc"), q = i.call(C, "finallyLoc");
        if (H && q) {
          if (this.prev < C.catchLoc) return P(C.catchLoc, !0);
          if (this.prev < C.finallyLoc) return P(C.finallyLoc);
        } else if (H) {
          if (this.prev < C.catchLoc) return P(C.catchLoc, !0);
        } else {
    ...
    C && (h === "break" || h === "continue") && C.tryLoc <= g && g <= C.finallyLoc && (C = null);
    var D = C ? C.completion : {};
    return D.type = h, D.arg = g, C ? (this.method = "next", this.next = C.finallyLoc, S) : this.complete(D);
  }, complete: function(h, g) {
    if (h.type === "throw") throw h.arg;
    return h.type === "break" || h.type === "continue" ? this.next = h.arg : h.type === "return" ? (this.rval = this.arg = h.arg, this.method = "return", this.next = "end") : h.type === "normal" && g && (this.next = g), S;
  }, finish: function(h) {
    for (var g = this.tryEntries.length - 1; g >= 0; --g) {
      var P = this.tryEntries[g];
      if (P.finallyLoc === h) return this.complete(P.completion, P.afterLoc), O(P), S;
    }
  }, catch: function(h) {
    for (var g = this.tryEntries.length - 1; g >= 0; --g) {
      var P = this.tryEntries[g];
    ...
    return this.delegate = { iterator: ge(h), resultName: g, nextLoc: P }, this.method === "next" && (this.arg = r), S;
  } }, e;
}
function Cr(r, e, t, i, o, s, n) {
  try {
...
function Ae(r) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Er(Object(t), !0).forEach(function(i) {
      Dn(r, i, t[i]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(t)) : Er(Object(t)).forEach(function(i) {
...
function Dn(r, e, t) {
  return e = Lo(e), e in r ? Object.defineProperty(r, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : r[e] = t, r;
}
function jn(r, e) {
  if (!(r instanceof e))
    throw new TypeError("Cannot call a class as a function");
...
function Ur(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, Lo(i.key), i);
  }
}
function Mn(r, e, t) {
  return e && Ur(r.prototype, e), t && Ur(r, t), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Lo(r) {
  var e = Bn(r, "string");
...
var Pt = "tus-v1", Et = "ietf-draft-03", tt = "ietf-draft-05", Nn = {
  endpoint: null,
  uploadUrl: null,
  metadata: {},
  ...
  return Mn(r, [{
    ...
    value: function() {
      ...
      if (![Pt, Et, tt].includes(this.options.protocol)) {
    ...
    value: function() {
      ...
      var n = this._parallelUploadUrls != null ? this._parallelUploadUrls.length : this.options.parallelUploads, a = (t = this.options.parallelUploadBoundaries) !== null && t !== void 0 ? t : qn(this._source.size, n);
      ...
      var l = a.map(function(d, p) {
        var f = 0;
        return i._source.slice(d.start, d.end).then(function(k) {
          var m = k.value;
          return new Promise(function(v, S) {
            var L = Ae(Ae({}, i.options), {}, {
              ...
              headers: Ae(Ae({}, i.options.headers), {}, {
              ...
              onProgress: function(y) {
                s = s - f + y, f = y, i._emitProgress(s, o);
              },
              // Wait until every partial upload has an upload URL, so we can add
              // them to the URL storage.
              onUploadUrlAvailable: function() {
                i._parallelUploadUrls[p] = _.url, i._parallelUploadUrls.filter(function(y) {
                  return !!y;
      ...
      Promise.all(l).then(function() {
        ...
        i.url = Lr(i.options.endpoint, p), "Created upload at ".concat(i.url), i._emitSuccess(d);
      }).catch(function(d) {
        i._emitError(d);
      });
    }
    ...
    value: function(t) {
      ...
      if (this._parallelUploads != null) {
        var o = An(this._parallelUploads), s;
        try {
          for (o.s(); !(s = o.n()).done; ) {
            var n = s.value;
            n.abort(t);
    ...
    value: function(t, i, o, s) {
      this._emitError(new Qe(o, s, t, i));
    }
  }, {
    key: "_emitError",
    value: function(t) {
      ...
      if (!this._aborted) {
        if (this.options.retryDelays != null) {
          ...
          if (o && (this._retryAttempt = 0), Tr(t, this._retryAttempt, this.options)) {
    ...
    value: function() {
      ...
      var o = Rr(this.options.metadata);
      o !== "" && i.setHeader("Upload-Metadata", o);
      var s;
      this.options.uploadDataDuringCreation && !this.options.uploadLengthDeferred ? (this._offset = 0, s = this._addChunkToRequest(i)) : ((this.options.protocol === Et || this.options.protocol === tt) && i.setHeader("Upload-Complete", "?0"), s = this._sendRequest(i, null)), s.then(function(n) {
        if (!Me(n.getStatus(), 200)) {
        ...
        if (t.url = Lr(t.options.endpoint, a), "Created upload at ".concat(t.url), typeof t.options.onUploadUrlAvailable == "function" && t.options.onUploadUrlAvailable(), t._size === 0) {
    ...
    value: function() {
      ...
      o.then(function(s) {
        ...
        if (!Me(n, 200)) {
          ...
          if (Me(n, 400) && t._removeFromUrlStorage(), !t.options.endpoint) {
        ...
        if (Number.isNaN(l) && !t.options.uploadLengthDeferred && t.options.protocol === Pt) {
    ...
    value: function(t) {
      ...
      return t.setProgressHandler(function(n) {
      ...
      }), this.options.protocol === Pt ? t.setHeader("Content-Type", "application/offset+octet-stream") : this.options.protocol === tt && t.setHeader("Content-Type", "application/partial-upload"), (s === Number.POSITIVE_INFINITY || s > this._size) && !this.options.uploadLengthDeferred && (s = this._size), this._source.slice(o, s).then(function(n) {
        ...
        var d = i._offset + c;
        return !i.options.uploadLengthDeferred && l && d !== i._size ? Promise.reject(new Error("upload was configured with a size of ".concat(i._size, " bytes, but the source is done after ").concat(d, " bytes"))) : a === null ? i._sendRequest(t) : ((i.options.protocol === Et || i.options.protocol === tt) && t.setHeader("Upload-Complete", l ? "?1" : "?0"), i._emitProgress(i._offset, i._size), i._sendRequest(t, a));
      });
    }
    /**
    ...
    value: function(t) {
      ...
      return Or(t, i, this.options);
    }
  }], [{
    key: "terminate",
    value: function(t) {
      var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o = Fr("DELETE", t, i);
      return Or(o, null, i).then(function(s) {
        if (s.getStatus() !== 204)
          throw new Qe("tus: unexpected response while terminating upload", null, o, s);
      }).catch(function(s) {
        if (s instanceof Qe || (s = new Qe("tus: failed to terminate upload", s, o, null)), !Tr(s, 0, i))
          throw s;
        var n = i.retryDelays[0], a = i.retryDelays.slice(1), l = Ae(Ae({}, i), {}, {
          retryDelays: a
        });
...
function Rr(r) {
  return Object.entries(r).map(function(e) {
    var t = Oo(e, 2), i = t[0], o = t[1];
    return "".concat(i, " ").concat($n.encode(String(o)));
  }).join(",");
}
function Me(r, e) {
  return r >= e && r < e + 100;
...
function Fr(r, e, t) {
  ...
  t.protocol === Et ? i.setHeader("Upload-Draft-Interop-Version", "5") : t.protocol === tt ? i.setHeader("Upload-Draft-Interop-Version", "6") : i.setHeader("Tus-Resumable", "1.0.0");
  for (var o = t.headers || {}, s = 0, n = Object.entries(o); s < n.length; s++) {
    var a = Oo(n[s], 2), l = a[0], c = a[1];
    i.setHeader(l, c);
  }
  if (t.addRequestId) {
    var d = On();
...
function gi() {
  return gi = Tn(/* @__PURE__ */ hi().mark(function r(e, t, i) {
    var o;
    return hi().wrap(function(n) {
...
function Tr(r, e, t) {
  return t.retryDelays == null || e >= t.retryDelays.length || r.originalRequest == null ? !1 : t && typeof t.onShouldRetry == "function" ? t.onShouldRetry(r, e, t) : zo(r);
}
function zo(r) {
  var e = r.originalResponse ? r.originalResponse.getStatus() : 0;
  return (!Me(e, 400) || e === 409 || e === 423) && Hn();
}
function Lr(r, e) {
  return new Fn(e, r).toString();
}
function qn(r, e) {
...
function Xn(r, e, t) {
  return e && Gn(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Jn(r) {
  var e = Zn(r, "string");
...
var zr = /* @__PURE__ */ (function() {
  function r(e) {
    Wn(this, r), this._file = e, this.size = e.size;
  }
  return Xn(r, [{
    key: "slice",
    value: function(t, i) {
      if (Kn())
        return Yn(this._file.slice(t, i));
...
function ea(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, ia(i.key), i);
  }
}
function ta(r, e, t) {
  return e && ea(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function ia(r) {
  var e = ra(r, "string");
...
var sa = /* @__PURE__ */ (function() {
  function r(e) {
    Qn(this, r), this._buffer = void 0, this._bufferOffset = 0, this._reader = e, this._done = !1;
  }
  return ta(r, [{
    key: "slice",
    value: function(t, i) {
    ...
    value: function(t, i) {
      var o = this, s = i <= this._bufferOffset + Ir(this._buffer);
      if (this._done || s) {
      ...
      return this._reader.read().then(function(l) {
        ...
        return d ? o._done = !0 : o._buffer === void 0 ? o._buffer = c : o._buffer = oa(o._buffer, c), o._readUntilEnoughDataOrDone(t, i);
      });
    }
  }, {
...
function mi() {
  ...
  function z(b, h) {
    function g(R, C, D, H) {
      ...
      if (q.type !== "throw") {
        var ee = q.arg, te = ee.value;
        return te && Le(te) == "object" && i.call(te, "__await") ? h.resolve(te.__await).then(function(se) {
          g("next", se, D, H);
        }, function(se) {
          g("throw", se, D, H);
        }) : h.resolve(te).then(function(se) {
  ...
  function ge(b) {
    ...
    throw new TypeError(Le(b) + " is not iterable");
  }
  return _.prototype = w, o(E, "constructor", { value: w, configurable: !0 }), o(w, "constructor", { value: _, configurable: !0 }), _.displayName = c(w, l, "GeneratorFunction"), e.isGeneratorFunction = function(b) {
    var h = typeof b == "function" && b.constructor;
    return !!h && (h === _ || (h.displayName || h.name) === "GeneratorFunction");
...
function la(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, da(i.key), i);
  }
}
function ca(r, e, t) {
  return e && la(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function da(r) {
  var e = pa(r, "string");
...
var ua = /* @__PURE__ */ (function() {
  ...
  return ca(r, [{
    key: "openFile",
    value: (function() {
      var e = na(/* @__PURE__ */ mi().mark(function i(o, s) {
        var n;
        return mi().wrap(function(l) {
          for (; ; ) switch (l.prev = l.next) {
            case 0:
              if (!(Io() && o && typeof o.uri < "u")) {
                l.next = 11;
                break;
              }
              return l.prev = 1, l.next = 4, Vn(o.uri);
            case 4:
              return n = l.sent, l.abrupt("return", new zr(n));
            case 8:
            ...
            case 11:
              ...
              return l.abrupt("return", Promise.resolve(new zr(o)));
            case 13:
            ...
            case 17:
              return l.abrupt("return", Promise.resolve(new sa(o, s)));
            case 18:
...
function fa(r, e) {
  return Io() ? Promise.resolve(ha(r, e)) : Promise.resolve(["tus-br", r.name, r.type, r.size, r.lastModified, e.endpoint].join("-"));
}
function ha(r, e) {
  var t = r.exif ? ga(JSON.stringify(r.exif)) : "noexif";
...
function ma(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, xa(i.key), i);
  }
}
function zi(r, e, t) {
  return e && ma(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function xa(r) {
  var e = ba(r, "string");
...
var va = /* @__PURE__ */ (function() {
  ...
  function r(e, t) {
    Li(this, r), this._xhr = new XMLHttpRequest(), this._xhr.open(e, t, !0), this._method = e, this._url = t, this._headers = {};
  }
  return zi(r, [{
    key: "getMethod",
    value: function() {
...
function Sa(r, e, t) {
  return e && ka(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function $a(r) {
  var e = Ca(r, "string");
...
var xi = !1;
try {
  xi = "localStorage" in window;
  var ei = "tusSupport", Dr = localStorage.getItem(ei);
  localStorage.setItem(ei, Dr), Dr === null && localStorage.removeItem(ei);
} catch (r) {
...
var Pa = xi, Ea = /* @__PURE__ */ (function() {
  function r() {
    _a(this, r);
  }
  return Sa(r, [{
...
function Ra(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, Do(i.key), i);
  }
}
function Fa(r, e, t) {
  return t && Ra(r, t), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Oa(r, e, t) {
  return e = At(e), Ta(r, Ao() ? Reflect.construct(e, t || [], At(r).constructor) : e.apply(r, t));
}
function Ta(r, e) {
...
function bi(r, e) {
  return bi = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(i, o) {
    return i.__proto__ = o, i;
  }, bi(r, e);
}
function jr(r, e) {
...
var Mr = Be(Be({}, It.defaultOptions), {}, {
  httpStack: new va(),
  fileReader: new ua(),
  urlStorage: Pa ? new Ea() : new hn(),
  fingerprint: fa
  ...
  function e() {
    ...
    return Ua(this, e), i = Be(Be({}, Mr), i), Oa(this, e, [t, i]);
  }
  return za(e, r), Fa(e, null, [{
    key: "terminate",
    value: function(i) {
      var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      return o = Be(Be({}, Mr), o), It.terminate(i, o);
    }
  }]);
})(It);
const ja = 10 * 1024 * 1024, Ma = 5 * 1024 * 1024, Ba = "https://eu-on-24001.connector.filerobot.com/files", Na = "https://eu-on-24001.connector.filerobot.com/json";
function Ha(r, e) {
  if (!e || !r.file) return !1;
  const t = e.sizeThreshold ?? ja;
  return r.size >= t;
}
function qa(r, e) {
  const { tusConfig: t } = e, i = e.apiBase.replace(/\/+$/, ""), o = t.endpoint || Ba, s = t.jsonBase || Na, n = t.chunkSize ?? Ma, a = t.resumable !== !1, l = t.parallelChunks ?? 1, c = t.retryDelays ?? [0, 1e3, 3e3, 5e3], d = i.split("/").pop() || "";
  let p = !1, f = !1, k = !1;
  const m = {
    name: r.name,
    type: r.type,
  ...
  Ei(r.product) && (m.product = JSON.stringify(Ui(r.product)));
  const v = async () => `tus-${r.id}-${o}`, S = new Da(r.file, {
    endpoint: o,
    chunkSize: n,
    retryDelays: c,
    parallelUploads: l,
    ...
    onBeforeRequest(x) {
      ...
      for (const [E, A] of Object.entries(U))
        x.setHeader(E, A);
      x.setHeader("X-Filerobot-Token", d);
    },
    ...
    onUploadUrlAvailable() {
      S.url && e.onUploadUrlAvailable && !k && (k = !0, e.onUploadUrlAvailable(S.url));
    },
    onProgress(x, U) {
      !f && !p && e.onProgress(x, U);
    },
    onSuccess() {
      var E;
      if (f) return;
      w();
      const x = S.url || "", U = (E = x.match(/files\/([^/?]+)/)) == null ? void 0 : E[1];
      U ? Ka(s, U, r.size).then((A) => {
        f || e.onComplete(
          ft(A) ? Pi(A, r) : A
        );
      }).catch((A) => {
    ...
    onShouldRetry(x, U, E) {
      var z;
      const A = (z = x.originalResponse) == null ? void 0 : z.getStatus();
  ...
  typeof window < "u" && (L = () => {
    var x;
    !p && !f && (p = !0, S.abort(!1), (x = e.onPause) == null || x.call(e));
  }, _ = () => {
    var x;
    p && !f && (p = !1, S.start(), (x = e.onResume) == null || x.call(e));
  }, window.addEventListener("offline", L), window.addEventListener("online", _));
  const w = () => {
    L && window.removeEventListener("offline", L), _ && window.removeEventListener("online", _);
  }, y = () => {
    try {
      S.start();
    } catch (x) {
      w(), e.onError(x instanceof Error ? x : new Error(String(x)));
    }
  };
  return a ? S.findPreviousUploads().then((x) => {
    x.length > 0 && !f && S.resumeFromPreviousUpload(x[0]), f || y();
  }) : y(), {
    abort() {
      f = !0, p = !1, w(), S.abort(!0);
    },
...
async function Ka(r, e, t) {
  ...
  for (let n = 0; n <= s; n++) {
    ...
    if (!(n < s))
      throw new Error(
        zt(l, "File record not available after upload")
      );
  }
  throw new Error("File record not available after upload");
}
const Ut = "_sfxRelativePath", Br = 8, Ya = /* @__PURE__ */ new Set([
  "node_modules",
  "__MACOSX",
  "$RECYCLE.BIN",
...
function Wa(r) {
  return r ? r.startsWith(".") ? !0 : Ya.has(r) : !1;
}
function Ii(r, e) {
  if (e) {
    try {
...
async function jo(r) {
  ...
  const s = [];
  return await Mo(i, "", s), { files: s, hadDirectories: o };
}
async function Mo(r, e, t) {
  for (let i = 0; i < r.length; i += Br) {
    const o = r.slice(i, i + Br);
    await Promise.all(o.map((s) => Za(s, e, t)));
  }
}
async function Za(r, e, t) {
  try {
    ...
    if (r.isDirectory) {
      if (Wa(r.name)) return;
      const i = e ? `${e}/${r.name}` : r.name, o = await el(r);
      await Mo(o, i, t);
    }
  } catch (i) {
...
class tl {
  ...
  uploadAll() {
    ...
    for (const i of e.values())
      i.status === "idle" ? (X(this.store, i.id, { status: "queued" }), t = !0) : i.status === "queued" && (t = !0);
  ...
  retryFile(e) {
    ...
    !t || t.status !== "error" && t.status !== "failed" || (X(this.store, e, {
      status: "queued",
      error: null,
      progress: 0,
      bytesUploaded: 0,
  ...
  retryAll() {
    ...
    for (const t of e.values())
      (t.status === "error" || t.status === "failed") && X(this.store, t.id, {
        status: "queued",
        error: null,
        progress: 0,
        bytesUploaded: 0,
  ...
  pauseFile(e) {
    ...
    t && "pause" in t && (t.pause(), this.activeUploads.delete(e), this.pausedUploads.set(e, t), X(this.store, e, { status: "paused" }), this.processQueue());
  }
  /**
  ...
  resumeFile(e) {
    ...
    this.activeUploads.size < i ? (this.pausedUploads.delete(e), t.resume(), this.activeUploads.set(e, t), X(this.store, e, { status: "uploading" })) : X(this.store, e, { status: "queued" });
  }
  /**
  ...
  cancelFile(e) {
    const t = this.store.getState().files.get(e);
    !t || !vi(t.status) || (this.abortPausedUpload(e), this.abortUpload(e), X(this.store, e, { status: "cancelled" }));
  }
  /**
  ...
  cancelAll() {
    const { files: e } = this.store.getState();
    for (const t of e.values())
      vi(t.status) && (this.abortPausedUpload(t.id), this.abortUpload(t.id), X(this.store, t.id, { status: "cancelled" }));
  ...
  processQueue() {
    ...
    for (const a of n) {
      ...
      l ? (this.pausedUploads.delete(a.id), l.resume(), this.activeUploads.set(a.id, l), X(this.store, a.id, { status: "uploading" })) : this.startUpload(a);
    }
  }
  startUpload(e) {
    var f, k;
    const t = (k = (f = this.config).resolveUploadParams) == null ? void 0 : k.call(f, e), i = !!t && Object.keys(t).length > 0, o = !i && !e.remoteInfo && !e.remoteUrl && Ha(e, this.config.tusConfig);
    X(this.store, e.id, { status: "uploading", error: null, isTus: o });
    ...
    const l = Ja(
      ...
      const S = Date.now(), L = (S - n) / 1e3;
      if (L > 0) {
        const w = (m - s) / L;
        a = a === 0 ? w : 0.3 * w + 0.7 * a;
      }
      s = m, n = S;
      const _ = v > 0 ? Math.min(m / v * 100, 100) : 0;
      X(this.store, e.id, { progress: _, bytesUploaded: m, speed: a }), this.updateTotalProgress();
    };
    let p;
    if (e.remoteInfo)
      p = Zs(e, { ...c, onProgress: d });
    else if (e.remoteUrl) {
      ...
      const m = qa(e, {
        ...
        onUploadUrlAvailable: (v) => {
          X(this.store, e.id, { tusUploadUrl: v });
        },
        // Sync UI state when tus pauses/resumes internally (e.g. network offline/online)
        onPause: () => {
          this.activeUploads.delete(e.id), this.pausedUploads.set(e.id, m), X(this.store, e.id, { status: "paused" }), this.processQueue();
        },
        onResume: () => {
          this.pausedUploads.delete(e.id), this.activeUploads.set(e.id, m), X(this.store, e.id, { status: "uploading" });
        }
      });
      p = m;
    } else
      p = qs(e, { ...c, onProgress: d });
    this.activeUploads.set(e.id, p);
  }
  handleComplete(e, t) {
    var c, d, p, f, k, m, v, S, L, _, w;
    this.activeUploads.delete(e);
    const i = this.store.getState().files.get(e), o = ((c = i == null ? void 0 : i.previewUrl) == null ? void 0 : c.startsWith("blob:")) ?? !1, s = ((p = (d = t.file) == null ? void 0 : d.url) == null ? void 0 : p.cdn) ?? ((k = (f = t.file) == null ? void 0 : f.url) == null ? void 0 : k.cdn_permalink) ?? ((v = (m = t.file) == null ? void 0 : m.url) == null ? void 0 : v.permalink) ?? null, n = {
      status: "complete",
      progress: 100,
      response: t,
      alreadyExisted: ft(t)
    ...
    if (i && s && i.type.startsWith("image/") && !o) {
      const y = ((_ = (L = this.config).transformPreviewUrl) == null ? void 0 : _.call(L, s, (S = t.file) == null ? void 0 : S.url)) ?? s;
      y && (n.previewUrl = y);
    }
    const a = (w = t.file) == null ? void 0 : w.size, l = typeof a == "number" ? a : a == null ? void 0 : a.bytes;
    typeof l == "number" && (n.size = l), X(this.store, e, n), this.updateTotalProgress(), this.checkAllComplete(), this.processQueue();
  }
  handleError(e, t) {
    this.activeUploads.delete(e);
    ...
    if (s <= o.maxRetries) {
      ...
      const a = setTimeout(() => {
        this.retryTimers.delete(e), X(this.store, e, { status: "queued" }), this.processQueue();
      }, n);
...
async function il(r, e, t) {
  const i = `${Ai(r, t)}/key/${encodeURIComponent(e)}`, o = new AbortController(), s = setTimeout(() => o.abort(), 3e4);
  try {
...
async function rl(r, e) {
  const t = Ai(r.container, e);
  if (r.mode === "security-template") {
    const i = await il(r.container, r.securityTemplateId, e);
    return { apiBase: t, headers: yi(r, i), sassKey: i };
  }
  return { apiBase: t, headers: yi(r) };
}
const ol = "https://ai.scaleflex.com", Nr = 300, sl = 0.85, nl = 3e4;
function Hr(r) {
...
async function dl(r) {
  const e = await cl(r);
  try {
    const t = e.width > Nr ? Nr / e.width : 1, i = Math.max(1, Math.round(e.width * t)), o = Math.max(1, Math.round(e.height * t)), s = document.createElement("canvas");
...
async function qr(r, e) {
  var a, l;
  const t = new AbortController(), i = setTimeout(() => t.abort(), nl), o = () => t.abort();
  ...
  try {
    n();
    const c = await al(r, s);
    n();
    const d = await dl(c);
    n();
    const f = `${(e.endpoint || ol).replace(/\/+$/, "")}/images/embedding/vectorize/image?threshold=${encodeURIComponent(String(e.threshold))}`, k = new FormData();
    k.append("file", d, ll(r.name));
    ...
    return (v.similar_assets ?? []).map(([S, L, _]) => ({
      uuid: S,
      score: L,
      url: _
    }));
...
const Dt = "sfx-uploader:last-upload:", Bo = 1;
function pl(r) {
  var s, n, a, l, c, d, p, f, k;
  const { file: e, previewUrl: t, ...i } = r;
  let o = null;
  return r.status === "complete" && (r.previewUrl && !r.previewUrl.startsWith("blob:") ? o = r.previewUrl : o = ((a = (n = (s = r.response) == null ? void 0 : s.file) == null ? void 0 : n.url) == null ? void 0 : a.permalink) ?? ((d = (c = (l = r.response) == null ? void 0 : l.file) == null ? void 0 : c.url) == null ? void 0 : d.cdn_permalink) ?? ((k = (f = (p = r.response) == null ? void 0 : p.file) == null ? void 0 : f.url) == null ? void 0 : k.cdn) ?? null), { ...i, previewUrl: o };
}
function ul(r) {
  try {
    const e = sessionStorage.getItem(Dt + r);
    if (!e) return null;
    const t = JSON.parse(e);
    return (t == null ? void 0 : t.__schemaVersion) !== Bo ? null : t;
  } catch {
    return null;
  }
}
function fl(r, e) {
  try {
    sessionStorage.setItem(Dt + r, JSON.stringify(e));
  } catch {
  }
}
const Ze = {
  ...
  exists(r) {
    try {
      return sessionStorage.getItem(Dt + r) != null;
    } catch {
      return !1;
    }
  },
  ...
  clear(r) {
    try {
      sessionStorage.removeItem(Dt + r);
    } catch {
    }
  }
}, M = {
...
const ml = /* @__PURE__ */ new Set([".ds_store", "thumbs.db", "desktop.ini"]);
function ii(r) {
  const e = (r.split(/[\\/]/).pop() ?? r).toLowerCase();
  return e.startsWith(".ds_store") ? !0 : ml.has(e);
}
const xl = "https://scaleflex.cloudimg.io/v7/assets/file-types/v3/", No = {
  _default: "9a518a",
  // Images
  png: "96cd9a",
  jpg: "06e819",
...
function wi(r) {
  ...
  return `${xl}${e}.svg?vh=${No[r]}`;
}
function Ho(r) {
  const e = (r == null ? void 0 : r.toLowerCase().replaceAll(".", "")) || "";
  return e in No ? wi(e) : wi("_default");
}
function qo() {
  return wi("_default");
}
...
function ri(r, e, t) {
  ...
  if (e.maxFileSize != null && r.size > 0 && r.size > e.maxFileSize) {
    ...
    return {
      code: "max-file-size",
      message: Ee("fileExceedsSizeLimit", "File exceeds {{limit}} MB limit", { limit: s })
    };
  }
  if (e.maxTotalFilesSize != null && r.size > 0) {
    ...
    if (s > e.maxTotalFilesSize)
      return {
        code: "max-total-size",
        message: Ee("totalSizeLimitExceeded", "Total file size limit exceeded")
      };
  }
  if (e.maxNumberOfFiles != null) {
    ...
    if (s >= e.maxNumberOfFiles)
      return {
        code: "max-files",
        message: Ee("maxFilesAllowed", "Maximum {{count}} files allowed", { count: e.maxNumberOfFiles })
      };
  }
  if (e.allowedFileTypes != null) {
    ...
    if (!s.some((l) => l.startsWith(".") ? n === l.toLowerCase() : l.endsWith("/*") ? r.type.startsWith(l.slice(0, -1)) : r.type === l))
      return { code: "type-not-allowed", message: Ee("fileTypeNotAllowed", "File type not allowed") };
  }
  if (e.blockedFileTypes != null) {
    const s = e.blockedFileTypes, n = "." + (((o = r.name.split(".").pop()) == null ? void 0 : o.toLowerCase()) ?? "");
    if (s.some((l) => l.startsWith(".") ? n === l.toLowerCase() : l.endsWith("/*") ? r.type.startsWith(l.slice(0, -1)) : r.type === l))
      return { code: "type-blocked", message: Ee("fileTypeBlocked", "File type is blocked") };
  }
  return null;
}
function Kr(r) {
...
function wl(r) {
  return r.filter((e) => e in Yr).map((e) => Yr[e]);
}
function Re(r) {
  return r.brandStyle ? u`<span
    class=${Jo({ "brand-ico": !0, "brand-ico--transparent": r.brandStyle.background === "transparent" })}
    ${Z(r.brandStyle)}
  >${Qi(r.brandHtml)}</span>` : Qi(r.brandHtml);
}
var _l = Object.defineProperty, Vo = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && _l(e, t, o), o;
};
const kl = '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>', Sl = '<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>', $l = '<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>', Cl = '<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>', it = [
  { id: "device", labelKey: "myDevice", label: "My Device", icon: kl, iconColor: "#2563eb" },
  { id: "url", labelKey: "urlLink", label: "URL link", icon: Sl, iconColor: "#16a34a" },
  { id: "camera", labelKey: "camera", label: "Camera", icon: $l, iconColor: "#7c3aed" },
  { id: "screen-cast", labelKey: "screenCapture", label: "Screen capture", icon: Cl, iconColor: "#ea580c" }
], Ni = class Ni extends pe {
  constructor() {
    super(...arguments), this.t = ue, this.sources = it;
  }
  _handleClick(e) {
    this.dispatchEvent(
    ...
    return u`
      ...
      (e) => u`
          <button @click=${() => this._handleClick(e)}>
            ${e.brandHtml ? Re(e) : ke`<svg viewBox="0 0 24 24" class=${e.fillIcon ? "fill-icon" : ""}>${_e(e.icon)}</svg>`}
...
function Fl(r, e, t) {
  const i = El(r, t.targetCkey);
  switch (Rl(i, e.uuid), t.type) {
    case "hide":
      i.hidden = !0;
      break;
    case "require":
    ...
    case "allow_values": {
      ...
      i.allowedValues = i.allowedValues === void 0 ? [...o] : Ul(i.allowedValues, o);
      break;
    }
    case "set_values": {
      const o = t.setValues ?? [];
...
function Ll(r) {
  ...
  return i === "image" ? e.add("image") : i === "video" ? e.add("video") : i === "audio" ? e.add("audio") : i === "application" && e.add("document"), Tl.has(t) && e.add("archive"), e;
}
function zl(r, e) {
...
function Al(r, e) {
  ...
  for (const i of e)
    i.active && zl(i, r.mime) && Il(i, r.meta) && Ol(t, i);
  return t;
}
function Rt(r, e, t) {
  ...
  const s = t.filter((a) => o.has(a.triggerCkey)), n = Al({ mime: r.mime, meta: i }, s);
...
function Ml(r, e, t) {
  ...
  for (const o of e.groups)
    for (const s of o.fields)
      jl(s, o, t) && s.key in r && (i || (i = { ...r }), delete i[s.key]);
  return i ?? r;
}
const Ve = "product.ref", Ke = "product.position", Bl = "__product__", Nl = /* @__PURE__ */ new Set([
  Ve,
  Ke
]);
function Hl(r) {
...
function ql(r) {
  return r === Ve ? "ref" : r === Ke ? "position" : null;
}
function Vl(r) {
  return [
    {
...
function Ac(r, e, t) {
  var o;
  if ((((o = t == null ? void 0 : t.requiredFields) == null ? void 0 : o.includes(r.ckey)) || !!r.required) && Mt(e))
    return `${r.title} is required`;
  if (Mt(e)) return null;
  if (r.key === Ve)
    return typeof e != "string" || ho.test(e) ? "Reference contains invalid characters" : null;
  if (r.key === Ke) {
    const s = Number(e);
...
function Wl(r, e) {
  ...
  for (const o of r ?? []) {
    ...
    const s = o.type === _i.LANGUAGES ? Gl(o.variants, e) : void 0;
...
function Jl(r) {
  return Ko.has(r.type) || Xl.has(r.ckey);
}
function Zl(r) {
  return r == null ? [] : Array.isArray(r) ? r.map(String) : [String(r)];
}
...
function ki(r, e) {
  var t;
  return Jl(r) ? !1 : (t = e == null ? void 0 : e.requiredFields) != null && t.includes(r.ckey) ? !0 : !!r.required;
}
function Ht(r) {
  return [...r.values()].filter((e) => tc.has(e.status));
}
function ic(r, e) {
  return e.enforceRequiredBeforeUpload === !1 ? !1 : e.enforceRequiredBeforeUpload === !0 ? !0 : r.forceFillingOnUpload !== void 0 ? r.forceFillingOnUpload : e.requiredFields && e.requiredFields.length > 0 ? !0 : r.fields.some((t) => !!t.required);
}
function ji(r, e, t) {
  if (!e) return ki(r, t);
  const i = e.get(r.ckey);
  return i != null && i.hidden ? !1 : i != null && i.required ? !0 : ki(r, t);
}
function qt(r, e, t) {
...
function Bc(r, e, t, i) {
  ...
  for (const a of e.fields) {
    const l = o.filter((c) => {
      ...
      return ji(a, d, t) ? !Di(c.meta[a.key]) : !1;
    });
...
function rc(r, e, t, i) {
  ...
  for (const n of e.fields)
    if (o.some((l) => {
      ...
      return ji(n, c, t) ? !Di(l.meta[n.key]) : !1;
    })) return n.key;
  return null;
}
function oc(r, e, t) {
...
function nc(r, e, t) {
  ...
  const o = qt(i, e, t), s = /* @__PURE__ */ new Map();
  for (const n of i) {
    const a = o.get(n.id);
...
var ac = Object.defineProperty, le = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && ac(e, t, o), o;
};
const Jr = 3, Si = new CSSStyleSheet();
Si.replaceSync(`
...
`);
var Se;
const oe = (Se = class extends pe {
  constructor() {
    super(...arguments), this.t = ue, this.compact = !1, this.externalDragOver = !1, this.accept = "", this.multi = !0, this.directory = !1, this.sources = [], this.sourcesLayout = "pills", this.mode = "modal", this._resizeObserver = null, this._dragOver = !1, this._moreOpen = !1, this._visiblePills = Jr, this._dragCounter = 0, this._onDragEnter = (e) => {
      ...
      t && jo(t).then(({ files: i, hadDirectories: o }) => {
  ...
  _updateDropdownPortal() {
    if (this._moreOpen) {
      ...
      this._portalContainer || (this._portalContainer = document.createElement("div"), this._portalContainer.setAttribute("data-sfx-more-dropdown", ""), Yo(this).appendChild(this._portalContainer), this._injectDropdownStyles()), Fe(
          ...
          (t) => u`
              ...
              >
                <div class="sfx-more-item-ico">
                  ${t.brandHtml ? Re(t) : t.iconColor ? u`<svg
                        viewBox="0 0 24 24"
                        ${Z({ color: t.iconColor })}
                      >
                        ${_e(t.icon)}
                      </svg>` : ke`<svg viewBox="0 0 24 24">${_e(
            t.icon
          )}</svg>`}
                </div>
    ...
    } else this._portalContainer && (Fe($, this._portalContainer), this._portalContainer.remove(), this._portalContainer = null);
  }
  _injectDropdownStyles() {
    var t;
    const e = (t = this._portalContainer) == null ? void 0 : t.getRootNode();
    e && (e.adoptedStyleSheets.includes(Si) || (e.adoptedStyleSheets = [...e.adoptedStyleSheets, Si]));
  }
  ...
  _updateVisiblePills() {
    ...
    this.sourcesLayout === "cards" ? e <= 480 ? this._visiblePills = 2 : e <= 768 ? this._visiblePills = 3 : this._visiblePills = 5 : e <= 768 ? this._visiblePills = 1 : this._visiblePills = Jr;
  }
  connectedCallback() {
    super.connectedCallback(), document.addEventListener("paste", this._onPaste), document.addEventListener("click", this._onDocClick), document.addEventListener("keydown", this._onDocKeyDown), window.addEventListener("scroll", this._onScrollOrResize, !0), window.addEventListener("resize", this._onScrollOrResize), this._updateVisiblePills(), typeof ResizeObserver < "u" && (this._resizeObserver = new ResizeObserver((e) => {
      var o;
      const i = (((o = e[0]) == null ? void 0 : o.contentRect.width) ?? this.getBoundingClientRect().width) >= Se._WIDE_THRESHOLD_PX;
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), document.removeEventListener("paste", this._onPaste), document.removeEventListener("click", this._onDocClick), document.removeEventListener("keydown", this._onDocKeyDown), window.removeEventListener("scroll", this._onScrollOrResize, !0), window.removeEventListener("resize", this._onScrollOrResize), this._resizeTimer && clearTimeout(this._resizeTimer), this._resizeObserver && (this._resizeObserver.disconnect(), this._resizeObserver = null), this._portalContainer && (Fe($, this._portalContainer), this._portalContainer.remove(), this._portalContainer = null);
  }
  _renderPill(e) {
    return u`
      <button
      ...
      >
        ${e.brandHtml ? Re(e) : u`<span
              class="pill-ico"
              ${Z(e.iconColor ? { color: e.iconColor } : null)}
            >
              ${ke`<svg viewBox="0 0 24 24" class=${e.fillIcon ? "fill-icon" : ""}>${_e(e.icon)}</svg>`}
            </span>`}
        ${e.labelKey ? this.t(e.labelKey, e.label) : e.label}
      </button>
    `;
  ...
  _renderCard(e) {
    return u`
      ...
      >
        ${e.brandHtml ? u`<span class="card-ico">${Re(e)}</span>` : u`<span
              class="card-ico"
              ${Z(e.iconColor ? { color: e.iconColor } : null)}
            >
              ${ke`<svg viewBox="0 0 24 24" class=${e.fillIcon ? "fill-icon" : ""}>${_e(e.icon)}</svg>`}
    ...
    return u`
      ...
      (o) => u`
        ...
        s.stopPropagation(), this._onSourceIconClick(o);
                      ...
                      >
                        ${o.brandHtml ? Re(o) : ke`<svg viewBox="0 0 24 24" class=${o.fillIcon ? "fill-icon" : ""}>${_e(o.icon)}</svg>`}
                      </button>
                    `
    )}
                </div>
...
le([
  Ci("input[data-sfx-dz-files]")
], oe.prototype, "fileInput");
le([
  Ci("input[data-sfx-dz-folder]")
], oe.prototype, "folderInput");
let qc = oe;
class lc {
  constructor(e) {
    this._unsubscribe = null, this._host = e, e.addController(this);
  }
  hostConnected() {
    this._unsubscribe = Rs(() => this._host.requestUpdate());
  }
  hostDisconnected() {
    var e;
    (e = this._unsubscribe) == null || e.call(this), this._unsubscribe = null;
  }
}
const Hi = class Hi extends pe {
  constructor() {
    super(...arguments), this._i18nController = new lc(this);
  }
  render() {
    return u`
      <div class="line"></div>
      <div class="label">${Ee("orImportFrom", "or import from")}</div>
      <div class="line"></div>
    `;
  }
};
Hi.styles = ne`
  ...
  `;
let Zr = Hi;
var cc = Object.defineProperty, W = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && cc(e, t, o), o;
};
...
const qi = class qi extends pe {
  ...
  _openPortal() {
    ...
    this._portalContainer || (this._portalContainer = document.createElement("div"), this._portalContainer.setAttribute("data-sfx-tile-dropdown", ""), Yo(this).appendChild(this._portalContainer), this._injectTileDropdownStyles()), Fe(
        ...
        ${e.map((t) => u`
          ...
          >
            <span class="sfx-tile-dropdown-ico" ${Z(t.iconColor && !t.brandHtml ? { color: t.iconColor } : null)}>
              ${t.brandHtml ? Re(t) : ke`<svg viewBox="0 0 24 24" class=${t.fillIcon ? "fill-icon" : ""}>${_e(t.icon)}</svg>`}
            </span>
            ${t.labelKey ? this.t(t.labelKey, t.label) : t.label}
          </button>
        `)}
  ...
  _closePortal() {
    this._portalContainer && (Fe($, this._portalContainer), this._portalContainer.remove(), this._portalContainer = null);
  }
  _injectTileDropdownStyles() {
    var t;
    const e = (t = this._portalContainer) == null ? void 0 : t.getRootNode();
    e && (e.adoptedStyleSheets.includes($i) || (e.adoptedStyleSheets = [...e.adoptedStyleSheets, $i]));
  }
  connectedCallback() {
  ...
  render() {
    ...
    return u`
      ...
      (s, n) => {
        ...
        return u`<sfx-file-item .t=${this.t} .file=${s} .mode=${this.mode} .allowRename=${this.allowRename} .showLocateButton=${this.showLocateButton} .showCopyCdnButton=${this.showCopyCdnButton} .showCheckSimilar=${this.showCheckSimilar} .selectMode=${this.selectMode} .isSelected=${this.selectedIds.has(s.id)} .selectionActive=${this.selectedIds.size > 0} .selectionFull=${this.selectionFull} .previewOpen=${this.previewOpen} .similarStatus=${this._statusFor(s.id)} .similarCount=${(a == null ? void 0 : a.length) ?? -1} .similarResults=${a ?? []} ${Z({ "--tile-index": String(n) })}></sfx-file-item>`;
      }
    )}
      </div>
    `;
...
var dc = Object.defineProperty, Q = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && dc(e, t, o), o;
};
const Vi = class Vi extends pe {
  ...
  render() {
    ...
    const e = this.file;
    if (!e) return $;
    const t = fe(e), i = e.status === "complete", o = e.status === "uploading", s = e.status === "paused", n = e.status === "error" || e.status === "failed", a = e.status === "rejected", l = this.mode === "review", c = l || this.reviewPick || !this.allowRename, d = gl(e.name), p = t === "image" && !we(e.type), f = this.selectMode && p && !l, k = this.similarCount >= 0, m = f && !k && this.similarStatus === "", v = !l && !i && !o && !s && !n && e.status !== "rejected" && this.similarStatus !== "searching" && !this.reviewPick, S = v, L = [
      "tile",
      i ? "done" : "",
      o ? "uploading" : "",
      s ? "paused" : "",
      ...
      l ? "review" : "",
      m ? "selectable" : "",
      m && this.isSelected ? "selected" : "",
      this.selectionActive && !p && !l ? "select-dimmed" : "",
      S ? "cs-overlay" : "",
          ...
          ${e.previewUrl ? u`<img class="preview-img" src=${e.previewUrl} alt="" />` : u`
                ...
                <div class="type-icon">
                  <img
                    ...
                    @error=${(y) => {
      const x = y.target, U = qo();
      !x.dataset.fallback && x.src !== U && (x.dataset.fallback = "1", x.src = U);
    }}
                  />
                </div>
              `}
          ...
          <!-- Review-mode hover actions: Locate (deep-link to the asset
               ...
               dead button. -->
          ${l && i && ((_ = e.response) != null && _.file) && (this.showLocateButton || this.showCopyCdnButton) ? u`
                <div class="review-actions">
                  ${this.showLocateButton && e.response.file.uuid ? u`<button class="review-action secondary" @click=${this._locate} aria-label=${this.t("locate", "Locate")}>
                        <svg viewBox="0 0 24 24">${fo}</svg>
                        ${this.t("locate", "Locate")}
                      </button>` : $}
                  ${this.showCopyCdnButton && ((w = e.response.file.url) != null && w.cdn) ? u`<button class="review-action primary ${this._copied ? "copied" : ""}" @click=${this._copyCdn} title=${this.t("copyCdn", "Copy CDN")} aria-label=${this.t("copyCdnLink", "Copy CDN link to clipboard")}>
        ...
        <div class="info">
          <input class="name-input" type="text" .value=${e.name} title=${e.name}
            ...
            ?readonly=${c}
            @change=${c ? $ : this._rename} @click=${(y) => y.stopPropagation()} />
...
`;
var pc = Object.defineProperty, be = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && pc(e, t, o), o;
};
const Qr = 7, uc = 4, Ki = class Ki extends pe {
  constructor() {
    super(...arguments), this.t = ue, this.fileCount = 0, this.totalSize = 0, this.thumbnails = [], this.primaryLabel = "Done", this.failedFiles = [], this.alreadyExistedCount = 0, this.showMinimize = !1, this.canLocate = !1, this._maxThumbs = Qr, this._updateMaxThumbs = () => {
      const e = window.innerWidth <= 768 ? uc : Qr;
  ...
  _locate() {
    this.dispatchEvent(
      new CustomEvent("locate-file", { bubbles: !0, composed: !0 })
    );
  }
  ...
  render() {
    const e = this.thumbnails.slice(0, this._maxThumbs), t = this.thumbnails.length - this._maxThumbs, i = this.fileCount > 0, o = this.failedFiles.length > 0, s = o && !i, n = i && !o && this.alreadyExistedCount >= this.fileCount, a = n && this.canLocate, l = this.fileCount - this.alreadyExistedCount;
    return u`
      ...
      <div class="card" role="status" aria-live="polite">
        ...
        ${e.length > 0 ? u`
              <div class="thumbs">
                ${e.map(
      (c) => u`<img class="thumb" src=${c} alt="" />`
    )}
                ${t > 0 ? u`<div class="thumb-more">+${t}</div>` : $}
              </div>
            ` : $}

        ${i && !n ? u`<div class="summary">${this.t("uploadedSize", "{{size}} uploaded", { size: Ue(this.totalSize) })}</div>` : $}
        ...
        <div class="actions">
          ...
          ${this.canLocate && !a ? this._locateButton(!1) : $}
          ...
          ${a ? u`<button class="btn-ghost" @click=${this._primaryAction}>${this.primaryLabel}</button>${this._locateButton(!0)}` : u`<button class="btn-primary" @click=${this._primaryAction}>${this.primaryLabel}</button>`}
        </div>
      </div>
    `;
  }
...
be([
  F({ type: Number })
], he.prototype, "fileCount");
be([
  F({ type: Number })
], he.prototype, "totalSize");
be([
  F({ type: Array })
], he.prototype, "thumbnails");
be([
  F({ type: String })
], he.prototype, "primaryLabel");
be([
  F({ type: Array })
], he.prototype, "failedFiles");
be([
  F({ type: Number })
], he.prototype, "alreadyExistedCount");
be([
  F({ type: Boolean })
], he.prototype, "showMinimize");
be([
  F({ type: Boolean })
], he.prototype, "canLocate");
be([
  I()
], he.prototype, "_maxThumbs");
var fc = Object.defineProperty, xt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && fc(e, t, o), o;
};
const Yi = class Yi extends pe {
  constructor() {
    super(...arguments), this.t = ue, this.files = [], this.showLocateButton = !1, this.showCopyCdnButton = !1, this._filter = "all", this._setFilter = (e) => () => {
      this._filter = e;
    }, this._onBack = () => {
...
xt([
  F({ type: Boolean })
], $e.prototype, "showLocateButton");
xt([
  F({ type: Boolean })
], $e.prototype, "showCopyCdnButton");
xt([
  I()
], $e.prototype, "_filter");
customElements.define("sfx-last-upload-review", $e);
var hc = Object.defineProperty, ce = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && hc(e, t, o), o;
};
const Wi = class Wi extends pe {
  constructor() {
    super(...arguments), this.t = ue, this.uploadState = "idle", this.fileCount = 0, this.totalSize = 0, this.failedCount = 0, this.showFillMetadata = !1, this.requireMetadataFirst = !1, this.completedCount = 0, this.uploadProgress = 0, this.showCheckSimilar = !1, this.selectMode = !1, this.selectedCount = 0, this.maxSelection = 0, this.allSelected = !1;
  }
  _clear() {
    this.dispatchEvent(
...
const gc = 'button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';
function Mi(r, e) {
  return (t) => {
    if (t.key !== "Tab") return;
    const i = r();
    ...
    if (!o) return;
    const s = Array.from(o.querySelectorAll(gc));
...
var mc = Object.defineProperty, Vt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && mc(e, t, o), o;
};
const Gi = class Gi extends pe {
  constructor() {
    super(...arguments), this.t = ue, this._url = "", this._name = "", this._error = "", this._onBackdropClick = (e) => {
      e.target === e.currentTarget && this._cancel();
    }, this._onUrlInput = (e) => {
      this._url = e.target.value, this._error = "", this._autoName();
    }, this._onNameInput = (e) => {
      this._name = e.target.value;
    }, this._focusTrap = Mi(() => this.shadowRoot, ".card"), this._onKeyDown = (e) => {
      var t;
...
var xc = Object.defineProperty, bt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && xc(e, t, o), o;
};
const Xi = class Xi extends pe {
  constructor() {
    super(...arguments), this.t = ue, this._stream = null, this._error = "", this._captured = null, this._previewUrl = "", this._onBackdropClick = (e) => {
      e.target === e.currentTarget && this._cancel();
    }, this._focusTrap = Mi(() => this.shadowRoot, ".card"), this._onKeyDown = (e) => {
...
bt([
  I()
], ze.prototype, "_stream");
bt([
  I()
], ze.prototype, "_error");
bt([
  I()
], ze.prototype, "_captured");
bt([
  I()
], ze.prototype, "_previewUrl");
var bc = Object.defineProperty, Xe = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && bc(e, t, o), o;
};
const Ji = class Ji extends pe {
  constructor() {
    super(...arguments), this.t = ue, this._stream = null, this._recording = !1, this._error = "", this._recordedBlob = null, this._previewUrl = "", this._recorder = null, this._chunks = [], this._onBackdropClick = (e) => {
      e.target === e.currentTarget && this._cancel();
    }, this._focusTrap = Mi(() => this.shadowRoot, ".card"), this._onKeyDown = (e) => {
      e.key === "Escape" && this._cancel(), this._focusTrap(e);
...
Xe([
  I()
], Ce.prototype, "_recording");
Xe([
  I()
], Ce.prototype, "_error");
Xe([
  I()
], Ce.prototype, "_recordedBlob");
Xe([
  I()
], Ce.prototype, "_previewUrl");
var vc = Object.defineProperty, Bi = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && vc(e, t, o), o;
};
const Zi = class Zi extends pe {
  constructor() {
    super(...arguments), this.t = ue, this.duration = 6e3, this._toasts = [], this._nextId = 0;
  }
  show(e, t = "error") {
...
var yc = Object.defineProperty, N = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && yc(e, t, o), o;
};
const eo = /* @__PURE__ */ new Set(["unsplash"]), ye = 10, wc = 3, _c = [
  "auto",
  "mobile",
  "tablet",
  "desktop",
...
const B = (V = class extends pe {
  constructor() {
    super(), this.config = null, this._isOpen = !1, this._activeConnector = null, this._showUrlDialog = !1, this._showCameraDialog = !1, this._showScreenCastDialog = !1, this._similarSelectMode = !1, this._similarSelectedIds = /* @__PURE__ */ new Set(), this._similarRunIds = [], this._similarActiveIds = /* @__PURE__ */ new Set(), this._similarResults = /* @__PURE__ */ new Map(), this._previewPanelTab = "details", this._similarDismissTimer = null, this._similarAbort = null, this._previewFileId = null, this._previewDims = "—", this._fileInfoOpen = !0, this._splitPct = 58, this._showSettings = !1, this._setResize = !0, this._setMaxW = 2e3, this._setMaxH = 2e3, this._setTranscode = !1, this._setResolution = "auto", this._setResolutionOpen = !1, this._setProtocol = "hls", this._setResumable = !1, this._isResizing = !1, this._splitRafId = 0, this._previewDefaultApplied = !1, this._fullscreenPreviewUrl = null, this._fullscreenVideoFile = null, this._fsZoom = 1, this._fsPanX = 0, this._fsPanY = 0, this._fsDragging = !1, this._fsDragStartX = 0, this._fsDragStartY = 0, this._fsPanStartX = 0, this._fsPanStartY = 0, this._bodyDragOver = !1, this._isMinimized = !1, this._isPillExpanded = !1, this._metadataSchema = null, this._metadataDependencies = [], this._warnedHubSchemaSkip = !1, this._warnedHubDepsSkip = !1, this._regionalFilters = {}, this._bulkMetadataOpen = !1, this._bulkMetadataInitialFieldKey = null, this._isReviewing = !1, this._reviewFiles = [], this._hasStoredReview = !1, this._metadataAutocomplete = null, this._taxonomyService = null, this._ultratagsService = null, this._onRegionalChange = (e) => {
      ...
      if ((((s = (o = this.config) == null ? void 0 : o.connectors) == null ? void 0 : s.providers) ?? []).includes(e)) {
        if (eo.has(e)) {
          if (!customElements.get("sfx-search-provider-browser")) {
            const { SfxSearchProviderBrowser: a } = await import("./search-provider-browser-DpAXNEga.js");
          ...
          const { SfxProviderBrowser: a } = await import("./provider-browser-B20d1ng-.js");
      ...
      const { url: t, name: i } = e.detail, o = (p = this.config) == null ? void 0 : p.callbacks, s = Vr(i), n = s.startsWith("image/");
      if (ii(i)) return;
      ...
      if (c) {
        ...
        Ie(this._store, m), this._dispatchPublic(M.FILE_REJECTED, {
          file: m,
          reason: c.message
        }), (f = o == null ? void 0 : o.onFileRejected) == null || f.call(o, m, c.message);
        return;
      }
      const d = {
        id: De(),
      ...
      Ie(this._store, d), this._dispatchPublic(M.FILE_ADDED, { file: d }), (k = o == null ? void 0 : o.onFileAdded) == null || k.call(o, d), this._store.getState().queueConfig.autoProceed && this.upload();
    }, this._onUrlCancel = () => {
      this._showUrlDialog = !1;
      ...
      this._similarSelectedIds = e.detail.selected ? new Set(
        this._similarUncheckedFiles().slice(0, ye).map((t) => t.id)
      ) : /* @__PURE__ */ new Set();
    ...
    }, this._onSuccessCardLocate = () => {
      const e = this._soleLocatableFile([
        ...this._storeCtrl.state.files.values()
      ]);
      e && this._locateFile(e);
      ...
      for (const a of i)
        a.previewUrl && URL.revokeObjectURL(a.previewUrl), e || (this._dispatchPublic(M.FILE_REMOVED, { file: a }), (n = t == null ? void 0 : t.onFileRemoved) == null || n.call(t, a));
      ...
      e != null && Ze.clear(e), this._isReviewing = !1, this._reviewFiles = [], this._hasStoredReview = !1;
      ...
      for (const l of e.detail.files) {
        ...
        if (k) {
          ...
          Ie(this._store, v), this._dispatchPublic(M.FILE_REJECTED, {
            file: v,
            reason: k.message
          }), (n = t == null ? void 0 : t.onFileRejected) == null || n.call(t, v, k.message);
          continue;
        }
        const m = {
          id: De(),
        ...
        Ie(this._store, m), this._dispatchPublic(M.FILE_ADDED, { file: m }), (a = t == null ? void 0 : t.onFileAdded) == null || a.call(t, m);
      }
    ...
    }, this._store = js(), this._storeCtrl = new Ms(this, this._store);
  }
  ...
  upload() {
    ...
    this._dispatchPublic(M.UPLOAD_STARTED, { files: o }), (c = (l = (a = this.config) == null ? void 0 : a.callbacks) == null ? void 0 : l.onUploadStarted) == null || c.call(l, o), this._engine.uploadAll(), (d = this.config) != null && d.minimizeOnUpload && ((p = this.config) == null ? void 0 : p.mode) !== "inline" && !this._isMinimized && (this._isMinimized = !0, this._isPillExpanded = !0, (m = (k = (f = this.config) == null ? void 0 : f.callbacks) == null ? void 0 : k.onMinimize) == null || m.call(k), this._dispatchFloatGeometryEvent(M.MINIMIZE), this.requestUpdate());
  }
  ...
  connectedCallback() {
    ...
    const e = this._lastUploadId;
    this._hasStoredReview = e != null && Ze.exists(e), this._initI18n(typeof navigator < "u" ? navigator.language : void 0), typeof MutationObserver < "u" && (this._hostStyleObserver = new MutationObserver(() => this._syncPortalOffsetVars()), this._hostStyleObserver.observe(this, { attributes: !0, attributeFilter: ["style"] }));
  }
  async _initI18n(e) {
    try {
      const { i18n: t, isNew: i } = await Fs(e || "en");
      i && t.on(
        "missingKey",
        (s, n, a, l, c, d) => {
          const p = a.match(/_(?:zero|one|two|few|many|other)$/), f = p && (d != null && d[`defaultValue${p[0]}`]) ? String(d[`defaultValue${p[0]}`]) : l;
          zs.handleMissingKey(a, f, n);
        }
      );
      const o = (s, n, a) => Ee(s, n, a);
  ...
  _applyConfig(e) {
    ...
    this._hasStoredReview = o != null && Ze.exists(o), this._resolveAuthAndEngine(e), (e.mode === "inline" || !e.mode) && (this._isOpen = !0);
  }
  async _resolveAuthAndEngine(e) {
    var o, s, n, a;
    const t = e.auth;
    if (t.mode === "sass-key") {
      this._apiBase = Ai(t.container, e.apiDomain), this._authHeaders = yi(t), this._ensureEngine(), (s = this._engine) == null || s.updateConfig({
    ...
    try {
      const l = await rl(t, e.apiDomain);
  ...
  _ensureEngine() {
    var e, t;
    !this._engine && this._apiBase && this._authHeaders && (this._engine = new tl(this._store, {
      apiBase: this._apiBase,
      authHeaders: this._authHeaders,
      tusConfig: this._normalizeTusConfig(),
  ...
  async _preloadMetadataSchema(e) {
    ...
    try {
      const {
        fetchMetadataSchema: o,
        fetchDependencies: s,
        hasCachedSchema: n,
        hasCachedDependencies: a,
        canReachHub: l,
        HUB_HEADERS_HINT: c,
        createTagsAutocomplete: d,
        createTaxonomyService: p,
        createUltratagsService: f
      } = await import("./index-C0FKSqHZ.js"), k = l(t), m = k || !!t.rawMetadata || n(t.projectUuid), v = k || a(t.projectUuid);
      if (!m) {
        this._warnedHubSchemaSkip || (this._warnedHubSchemaSkip = !0, console.warn(
          `[sfx-uploader] metadataConfig is set but no usable Hub auth is configured — skipping metadata schema and dependencies. ${c}`
        ), this._showToast(
          i("metadataUnavailable", "Metadata is unavailable — missing Hub session headers"),
          "warning"
        )), this._metadataSchema = null, this._metadataDependencies = [];
        return;
      }
      let S;
      v ? S = s(t.projectUuid, this._authHeaders, {
        hubApiBase: t.hubApiBase,
        hubHeaders: t.hubHeaders
      }).catch((y) => (console.warn(
        "[sfx-uploader] Failed to load metadata dependencies:",
        y
      ), [])) : (this._warnedHubDepsSkip || (this._warnedHubDepsSkip = !0, console.warn(
        `[sfx-uploader] No usable Hub auth — metadata dependency rules are disabled (the schema itself loads without the Hub). ${c}`
      )), S = Promise.resolve([]));
      const [L, _] = await Promise.all([
        o(this._apiBase, this._authHeaders, t.projectUuid, t),
        S
      ]);
      this._metadataDependencies = _, this._metadataAutocomplete = d(
        this._apiBase,
        this._authHeaders
      ), this._taxonomyService = p(
        this._apiBase,
        this._authHeaders
      ), this._ultratagsService = f(
        this._apiBase,
        this._authHeaders
      ), this._metadataSchema = L.productsEnabled ? Yl(L, this._storeCtrl.state.t) : L;
      const w = this._metadataSchema.fields.filter((y) => ki(y, t)).map((y) => y.key);
      this._dispatchPublic(M.METADATA_SCHEMA, {
        schema: this._metadataSchema,
        requiredFieldKeys: w
      }), this._applyDependencySetValuesPrefill();
    } catch (o) {
      console.error("[sfx-uploader] Failed to load metadata schema:", o), this._showToast(i("metadataLoadFailed", "Failed to load metadata schema"), "warning");
    }
  }
  /**
  ...
  _applyDependencySetValuesPrefill(e) {
    ...
    for (const a of n) {
      ...
      for (const d of t.fields) {
        ...
        (p == null ? void 0 : p.setValue) !== void 0 && (p.hidden || Mt(a.meta[d.key]) && (c[d.key] = Dl(d, p.setValue)));
      }
  ...
  _resolvedSchemaFor(e) {
    return !this._metadataSchema || this._metadataDependencies.length === 0 ? null : Rt(
  ...
  get _metadataEnforcing() {
    ...
    return !e || !this._metadataSchema ? !1 : ic(this._metadataSchema, e);
  }
  _firstMissingRequiredFieldKey() {
    var e;
    return !this._metadataEnforcing || !this._metadataSchema ? null : rc(
  ...
  _firstConflictedFieldKey() {
    return this._metadataSchema ? nc(
      this._store.getState().files,
      this._metadataSchema,
      this._metadataDependencies
    ) : null;
  ...
  _onStoreChange() {
    ...
    for (const [m, v] of e.files) {
      ...
      if (S.status !== v.status)
        switch (v.status) {
          case "uploading":
            S.status === "paused" && (this._dispatchPublic(M.UPLOAD_RESUMED, { file: v }), (s = i == null ? void 0 : i.onUploadResumed) == null || s.call(i, v));
            break;
          case "complete":
      ...
      v.status === "uploading" && S.progress !== v.progress && (this._dispatchPublic(M.UPLOAD_PROGRESS, {
        file: v,
        progress: v.progress,
        speed: v.speed
      }), (d = i == null ? void 0 : i.onUploadProgress) == null || d.call(i, v, v.progress, v.speed)), v.relativeFolder && S.status !== v.status && to.has(v.status) && !this._firedFolders.has(v.relativeFolder) && this._maybeDispatchFolderComplete(v.relativeFolder, e, i);
    }
    ...
    if (t.isUploading && !e.isUploading) {
      ...
      if (!m.some((S) => S.status === "cancelled")) {
        const S = m.filter((y) => y.status === "complete"), L = m.filter(
          (y) => y.status === "failed" || y.status === "error"
        );
        if (S.length === 0 && L.length === 0) return;
        const _ = this._lastUploadId;
        if (_ != null) {
          const y = [...S, ...L];
          Ze.save(_, y), this._hasStoredReview = y.length > 0;
        }
        this._dispatchPublic(M.ALL_COMPLETE, { successful: S, failed: L }), (f = i == null ? void 0 : i.onAllComplete) == null || f.call(i, S, L);
        const w = (k = this.config) == null ? void 0 : k.closeOnComplete;
        if (w !== !1 && w != null) {
          const y = typeof w == "number" ? w : 1500;
          this._closeOnCompleteTimer = setTimeout(() => {
            var x, U, E;
            this._closeOnCompleteTimer = null, this._phase === "complete" && (this._dispatchPublic(M.COMPLETE_ACTION, {}), (E = (U = (x = this.config) == null ? void 0 : x.callbacks) == null ? void 0 : U.onCompleteAction) == null || E.call(U), this.close());
          }, y);
        }
      }
    }
  ...
  _maybeDispatchFolderComplete(e, t, i) {
    ...
    if (o.length === 0 || o.some((l) => !to.has(l.status))) return;
  ...
  get _mergedSources() {
    ...
    if (this._cachedSourcesConfig = e, !e)
      return this._cachedSources = it.filter((f) => f.id !== "url"), this._cachedSources;
    const t = e.providers.length > 0 ? wl(e.providers) : [], i = e.customSources ?? [], o = e.coreSources ? new Set(e.coreSources) : null, s = o ? it.filter((f) => o.has(f.id)) : it, n = e.companionUrl ? s : s.filter((f) => f.id !== "url"), a = n.filter(
  ...
  _processIncomingFiles(e) {
    ...
    let o = 0, s = !1;
    for (const p of e) {
      if (ii(p.name)) continue;
      if (s) {
        o++;
        continue;
      }
      const f = i ? Xa(Ga(p)) : "", k = this._store.getState();
      if ([...k.files.values()].some(
        (w) => w.name === p.name && w.size === p.size && w.relativeFolder === f && w.status !== "rejected" && w.status !== "cancelled"
      )) continue;
      const v = p.type || Vr(p.name), S = ri(
      ...
      if (S) {
        ...
        const w = v.startsWith("image/") && !we(v) ? URL.createObjectURL(p) : null, y = {
          id: De(),
          status: "rejected",
          file: p,
          remoteUrl: null,
        ...
        Ie(this._store, y), this._dispatchPublic(M.FILE_REJECTED, {
          file: y,
          reason: S.message
        }), (l = t == null ? void 0 : t.onFileRejected) == null || l.call(t, y, S.message);
        const x = (c = this.config) == null ? void 0 : c.rejectedFileAutoRemoveDelay, U = x === !1 || x === 0 || x === void 0 ? 0 : x;
        if (U > 0) {
          const E = y.id, A = setTimeout(() => {
            this._rejectedTimers.delete(E);
            const z = this._store.getState().files.get(E);
            z && z.status === "rejected" && gr(this._store, E);
          }, U);
      ...
      let L = null;
      v.startsWith("image/") && !we(v) && (L = URL.createObjectURL(p));
      const _ = {
        id: De(),
        status: "idle",
        file: p,
      ...
      if (Ie(this._store, _), this._dispatchPublic(M.FILE_ADDED, { file: _ }), (d = t == null ? void 0 : t.onFileAdded) == null || d.call(t, _), p.type.startsWith("video/")) {
        vl(p).then((y) => {
          if (!y) return;
          const x = this._store.getState(), U = x.files.get(_.id);
          if (U) {
            const E = new Map(x.files);
            E.set(_.id, { ...U, previewUrl: y }), this._store.setState({ files: E });
          } else
            URL.revokeObjectURL(y);
        });
        const w = document.createElement("video");
        w.preload = "metadata", w.src = URL.createObjectURL(p), w.onerror = () => {
          URL.revokeObjectURL(w.src);
        }, w.onloadedmetadata = () => {
          const y = w.duration;
          if (URL.revokeObjectURL(w.src), !isFinite(y)) return;
          const x = this._store.getState(), U = x.files.get(_.id);
          if (U) {
            const E = new Map(x.files);
            E.set(_.id, { ...U, duration: y }), this._store.setState({ files: E });
          }
        };
      }
    }
  ...
  _removeFile(e) {
    ...
    (t.status === "uploading" || t.status === "queued" || t.status === "retrying" || t.status === "paused") && ((s = this._engine) == null || s.cancelFile(e)), gr(this._store, e), (n = this._engine) == null || n.recompute(), this._dimCache.delete(e);
  ...
  _checkSimilarSingleFile(e) {
    ...
    const i = Hr((n = (s = this.config) == null ? void 0 : s.similarityCheck) == null ? void 0 : n.confidence), o = (l = (a = this.config) == null ? void 0 : a.similarityCheck) == null ? void 0 : l.endpoint;
    this._similarActiveIds = new Set(this._similarActiveIds).add(e.id), qr(e, { ...t, threshold: i, endpoint: o }).then((c) => {
  ...
  _runSimilarityCheck(e) {
    ...
    this._similarRunIds = e.map((S) => S.id);
    const i = Hr((k = (f = this.config) == null ? void 0 : f.similarityCheck) == null ? void 0 : k.confidence), o = (v = (m = this.config) == null ? void 0 : m.similarityCheck) == null ? void 0 : v.endpoint, s = new AbortController();
    ...
    const c = e.length, d = () => {
      if (!s.signal.aborted) {
        if (!this._previewFileId) {
          const S = e.find(
            (L) => {
              var _;
              return (((_ = this._similarResults.get(L.id)) == null ? void 0 : _.length) ?? 0) > 0;
            }
          );
          S && (this._previewFileId = S.id, this._showSettings = !1, this._previewPanelTab = "similar");
        }
      ...
      if (!s.signal.aborted)
        for (; a < wc && n.length > 0; ) {
          const S = n.shift();
          a += 1, this._similarActiveIds = new Set(this._similarActiveIds).add(S.id), qr(S, { ...t, threshold: i, endpoint: o, signal: s.signal }).then((L) => {
            s.signal.aborted || (this._similarMarkInactive(S.id), this._similarSetResults(S.id, L));
          }).catch((L) => {
            s.signal.aborted || (console.error("[sfx-uploader] Similarity check failed for", S.name, L), this._similarMarkInactive(S.id), this._similarSetResults(S.id, []));
          }).finally(() => {
  ...
  _locateFile(e) {
    var s, n, a;
    if (!e) return;
    const t = As(e, this.config ?? void 0), i = this.dispatchEvent(
  ...
  _renderHeader() {
          ...
          <div class="float-header-left">
            ...
            <div>
              ...
              <div class="float-subtitle">
                ${e("nOfNComplete", "{{completed}} of {{total}} complete", { completed: J, total: T })}${this._lastEta > 0 ? ` · ${e("etaLeft", "~{{eta}} left", { eta: ti(this._lastEta) })}` : ""}
              </div>
            </div>
          </div>
        </div>
    ...
    const i = ((w = this.config) == null ? void 0 : w.header) ?? (t === "modal" ? "close" : !0);
    if (i === !1) return $;
    const o = t === "modal" ? this._onModalDismiss : this._onInlineDismiss, s = i === "back" ? u`<button
          ...
          </button>` : $, n = (y = this.config) == null ? void 0 : y.uploadSettings, a = n !== !1 && (n == null || n.enabled !== !1), l = n !== !1 && n != null && n.showResumableSwitcher === !0, c = [...this._storeCtrl.state.files.values()], d = c.some(
      (E) => fe(E) === "image" && !we(E.type)
    ), p = c.some((E) => fe(E) === "pdf"), f = c.some((E) => fe(E) === "vid"), m = a && (d || p || f || l) ? u`<button
      ...
      this._showSettings = !this._showSettings;
          ...
          </button>` : $, v = (U = (x = this._metadataSchema) == null ? void 0 : x.regionalVariantsGroups) != null && U.length ? u`<sfx-regional-settings
        ...
        ></sfx-regional-settings>` : $, S = i === "close" ? u`<button
  ...
  _renderUploadOverlay(e) {
    var d;
    const t = this._storeCtrl.state, i = t.t, o = Math.round(t.totalProgress ?? 0), s = e.filter((p) => p.status !== "rejected" && p.status !== "cancelled"), n = s.length, a = s.filter((p) => p.status === "complete").length, l = s.filter((p) => vi(p.status)), c = [];
    return n > 1 && c.push(i("nOfNComplete", "{{completed}} of {{total}} complete", { completed: a, total: n })), this._lastEta > 0 && c.push(i("etaLeft", "~{{eta}} left", { eta: ti(this._lastEta) })), u`
      <div class="upload-overlay">
        ...
        <div class="upload-overlay-actions">
          ...
          ${(d = this.config) != null && d.minimizeOnUpload ? u`<button
  ...
  _renderFloatingPill(e) {
    const t = this._storeCtrl.state, i = t.t, o = Math.round(t.totalProgress ?? 0), s = this._phase === "complete", n = e.filter((p) => p.status === "complete").length, a = e.filter((p) => p.status === "failed").length, l = e.filter(
      (p) => p.status === "complete" && p.alreadyExisted
    ).length, c = n > 0 && a === 0 && l >= n, d = this._soleLocatableFile(e);
    return this._isPillExpanded === !1 ? u`
        <div class="upload-float float-collapsed">
          <div class="float-collapsed-left">
            ${s ? a > 0 ? n > 0 ? u`<div class="float-collapsed-icon warn">
                    ...
                    </div>` : c ? u`<div class="float-collapsed-icon info">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
      ...
      <div class="upload-float">
        ...
        ${s && l > 0 && !c ? u`<div class="float-info-note" role="status">
        ...
        <div class="float-items">
          ${si([...e].reverse(), (p) => p.id, (p) => {
      var k, m, v;
      const f = p.status === "failed" || p.status === "error";
      return u`
              <div class="float-item">
                <div
                  class="float-item-thumb"
                  ${Z(p.previewUrl ? { "background-image": `url(${p.previewUrl})`, "background-size": "cover", "background-position": "center" } : null)}
                >
                  ${p.previewUrl ? $ : u`<svg
                        viewBox="0 0 24 24"
                        fill="none"
                ...
                <div class="float-item-status">
                  ${p.status === "complete" ? u`${(k = this.config) != null && k.showLocateButton && ((v = (m = p.response) == null ? void 0 : m.file) != null && v.uuid) ? u`<button
                        ...
                        ${p.alreadyExisted ? u`<div
                            ...
                            </div>`}` : f ? u` <div class="float-item-error-wrap">
                          <svg
                          ...
                          <span class="float-item-tooltip"
                            >${p.error || i("uploadFailed", "Upload failed")}</span
                          >
                        </div>
                        <button
                          ...
                          @click=${() => {
        var S;
        this._ensureEngine(), (S = this._engine) == null || S.retryFile(p.id);
      }}
                        >
                          <svg
                            viewBox="0 0 24 24"
                        ...
                        <button
                          ...
                          @click=${() => {
        var S;
        return (S = this._engine) == null ? void 0 : S.resumeFile(p.id);
      }}
                        >
                          <svg viewBox="0 0 24 24" fill="currentColor">
                            <polygon points="5,3 19,12 5,21" />
                        ...
                        ${p.status === "uploading" && p.isTus ? u`<button
                              class="float-item-act"
                              title=${i("pause", "Pause")}
                              aria-label=${i("pauseUpload", "Pause upload")}
                              @click=${() => {
        var S;
        return (S = this._engine) == null ? void 0 : S.pauseFile(p.id);
      }}
                            >
                              <svg viewBox="0 0 24 24" fill="currentColor">
                                <rect x="6" y="4" width="4" height="16" rx="1" />
                        ...
                        ${p.status === "uploading" || p.status === "queued" || p.status === "retrying" ? u`<button
                              class="float-item-act del"
                              title=${i("remove", "Remove")}
                              aria-label=${i("removeFile", "Remove file")}
                              @click=${() => this._removeFile(p.id)}
  ...
  _renderPreviewLayout(e) {
    ...
    const t = this._storeCtrl.state.t, i = [...e].reverse(), o = i.find((U) => U.id === this._previewFileId) ?? i[0], s = ((v = o.name.split(".").pop()) == null ? void 0 : v.toUpperCase()) || "";
    new Date(o.addedAt).toLocaleDateString(
      "en-US",
      { month: "short", day: "numeric", year: "numeric" }
    ), this._store.getState().targetFolder;
    const n = i.reduce((U, E) => U + (E.size || 0), 0), a = !!((L = (S = this.config) == null ? void 0 : S.similarityCheck) != null && L.enabled), l = i.filter(
      (U) => fe(U) === "image" && !we(U.type) && !this._similarResults.has(U.id)
    ).map((U) => U.id), c = Math.min(
      l.length,
      ye
    ), d = c > 0 && this._similarSelectedIds.size >= c, p = this._similarSelectedIds.size >= ye, f = this._similarResults.get(o.id), k = f !== void 0, m = k ? this._previewPanelTab : "details";
    return u`
      <div class="preview-topbar"></div>
      <div class="preview-layout">
        <div class="file-grid-side" ${Z({ flex: String(this._splitPct) })}>
          ${((_ = this.config) == null ? void 0 : _.mode) === "inline" && ((w = this.config) != null && w.inlineHeader) ? this._renderInlineHeader(this.config.inlineHeader) : $}
      ...
      this._previewPanelTab = "similar";
              ...
              ` : $}
          ${m === "similar" ? this._renderSimilarPanel(o, f ?? []) : u`
      ...
      !E.dataset.fallback && E.src !== A && (E.dataset.fallback = "1", E.src = A);
              ...
              `}
          ${this._metadataSchema && ((y = this.config) != null && y.metadataConfig) ? u`<div class="preview-meta-list">
                <div class="preview-file-info">
                  ${s}${o.size ? ` · ${Ue(o.size)}` : ""}${this._previewDims !== "—" ? ` · ${this._previewDims}` : ""}
                </div>
              </div>` : $}
  ...
  _renderSettingsPanel() {
    ...
    const e = this._storeCtrl.state.t, t = [...this._storeCtrl.state.files.values()], i = t.some(
      (f) => fe(f) === "image" && !we(f.type)
    ), o = t.some((f) => fe(f) === "pdf"), s = t.some((f) => fe(f) === "vid"), n = (p = this.config) == null ? void 0 : p.uploadSettings, a = !!n && n.showResumableSwitcher === !0, l = (f) => {
      switch (f) {
        case "auto":
  ...
  _renderBody() {
    ...
    ), s = this._phase, n = Kr(e.restrictions), a = i.length > 0, l = !!((m = (k = this.config) == null ? void 0 : k.similarityCheck) != null && m.enabled), c = i.filter(
      (T) => fe(T) === "image" && !we(T.type) && !this._similarResults.has(T.id)
    ).map((T) => T.id), d = Math.min(
      c.length,
      ye
    ), p = d > 0 && this._similarSelectedIds.size >= d, f = this._similarSelectedIds.size >= ye;
    return u`
      <div
        class="content"
      ...
      >
        ...
        >
          ${((v = this.config) == null ? void 0 : v.mode) === "inline" && ((S = this.config) != null && S.inlineHeader) && !this._previewFileId && s !== "uploading" && s !== "complete" && !this._isReviewing ? this._renderInlineHeader(this.config.inlineHeader) : $}
          ${this._isReviewing ? u`
      ...
      (T) => T.status === "failed" || T.status === "error"
        ...
        ${this._activeConnector && ((z = this.config) != null && z.connectors) ? u`
              <div
                class="connector-modal-backdrop"
                @click=${this._onConnectorBackdropClick}
              >
                <div class="connector-modal">
                  ${eo.has(this._activeConnector) ? u`
                        <sfx-search-provider-browser
                          .t=${t}
