...
const ys = "SAME_ASSET_EXISTS_SKIP_UPLOAD";
function pt(r) {
  return (r == null ? void 0 : r.code) === ys;
}
function fi(r, e) {
  return {
    ...r,
...
function _s(r, e) {
  ...
  let i = !1;
  const o = ws(e.apiBase, e.folder, e.extraParams);
  t.open("POST", o);
...
async function Cs(r, e, t, i, o, s = !1) {
...
function Xr(r) {
  const t = `${Us(r.companionUrl)}/api/${r.token}`;
  let i;
  try {
    i = new WebSocket(t);
  } catch {
...
function Rs(r, e) {
  ...
  return Cs(t.companionUrl, t.provider, t.token, t.requestPath, {
    fileId: t.fileId,
    endpoint: s,
...
function Os(r, e) {
  ...
  return Ps(e.companionUrl, t, s.signal).then((a) => {
    var d;
    if (i) return null;
    (d = e.onMeta) == null || d.call(e, { name: a.name, type: a.type, size: a.size });
    const l = Gr(r, e.folder);
    return a.name && (l.name = a.name), a.type && (l.type = a.type), Es(
      e.companionUrl,
      t,
      {
        fileId: r.id,
...
function Ls(r, e, t) {
  return e = st(e), zs(r, xi() ? Reflect.construct(e, t || [], st(r).constructor) : e.apply(r, t));
}
function zs(r, e) {
...
function Jt(r) {
  ...
  return Jt = function(i) {
    ...
    function o() {
      return js(i, arguments, st(this).constructor);
    }
...
var Je = /* @__PURE__ */ (function(r) {
  function e(t) {
    ...
    if (Ts(this, e), i = Ls(this, e, [t]), i.originalRequest = s, i.originalResponse = n, i.causingError = o, o != null && (t += ", caused by ".concat(o.toString())), s != null) {
...
function Ns(r, e, t) {
  return e && Bs(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Hs(r) {
  var e = qs(r, "string");
...
const Zr = "3.7.8", Ks = Zr, Ye = typeof Buffer == "function", or = typeof TextDecoder == "function" ? new TextDecoder() : void 0, sr = typeof TextEncoder == "function" ? new TextEncoder() : void 0, Ys = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", Ze = Array.prototype.slice.call(Ys), vt = ((r) => {
  let e = {};
  return r.forEach((t, i) => e[t] = i), e;
})(Ze), Ws = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/, ie = String.fromCharCode.bind(String), nr = typeof Uint8Array.from == "function" ? Uint8Array.from.bind(Uint8Array) : (r) => new Uint8Array(Array.prototype.slice.call(r, 0)), Qr = (r) => r.replace(/=/g, "").replace(/[+\/]/g, (e) => e == "+" ? "-" : "_"), eo = (r) => r.replace(/[^A-Za-z0-9\+\/]/g, ""), to = (r) => {
  let e, t, i, o, s = "";
  const n = r.length % 3;
...
}, Xs = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, io = (r) => r.replace(Xs, Gs), ar = Ye ? (r) => Buffer.from(r, "utf8").toString("base64") : sr ? (r) => Zt(sr.encode(r)) : (r) => bi(io(r)), Be = (r, e = !1) => e ? Qr(ar(r)) : ar(r), lr = (r) => Be(r, !0), Js = /[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g, Zs = (r) => {
  switch (r.length) {
    case 4:
...
}, ro = (r) => r.replace(Js, Zs), oo = (r) => {
  if (r = r.replace(/\s+/g, ""), !Ws.test(r))
  ...
  return o.join("");
}, vi = typeof atob == "function" ? (r) => atob(eo(r)) : Ye ? (r) => Buffer.from(r, "base64").toString("binary") : oo, so = Ye ? (r) => nr(Buffer.from(r, "base64")) : (r) => nr(vi(r).split("").map((e) => e.charCodeAt(0))), no = (r) => so(ao(r)), Qs = Ye ? (r) => Buffer.from(r, "base64").toString("utf8") : or ? (r) => or.decode(so(r)) : (r) => ro(vi(r)), ao = (r) => eo(r.replace(/[-_]/g, (e) => e == "-" ? "+" : "/")), Qt = (r) => Qs(ao(r)), en = (r) => {
  if (typeof r != "string")
    return !1;
...
var _t = "tus-v1", kt = "ietf-draft-03", Qe = "ietf-draft-05", yn = {
  endpoint: null,
  uploadUrl: null,
  metadata: {},
  ...
  return bn(r, [{
    ...
    value: function() {
      ...
      var n = this._parallelUploadUrls != null ? this._parallelUploadUrls.length : this.options.parallelUploads, a = (t = this.options.parallelUploadBoundaries) !== null && t !== void 0 ? t : _n(this._source.size, n);
    ...
    value: function(t) {
      ...
      if (this._parallelUploads != null) {
        var o = gn(this._parallelUploads), s;
        try {
          for (o.s(); !(s = o.n()).done; ) {
            var n = s.value;
            n.abort(t);
...
function xr(r) {
  return Object.entries(r).map(function(e) {
    ...
    return "".concat(i, " ").concat(rn.encode(String(o)));
  }).join(",");
}
function je(r, e) {
  return r >= e && r < e + 100;
...
function ti() {
  return ti = pn(/* @__PURE__ */ ei().mark(function r(e, t, i) {
    var o;
...
function go(r) {
  ...
  return (!je(e, 400) || e === 409 || e === 423) && wn();
}
function wr(r, e) {
  return new dn(e, r).toString();
}
function _n(r, e) {
...
function En(r, e, t) {
  return e && Pn(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Un(r) {
  var e = Rn(r, "string");
...
var _r = /* @__PURE__ */ (function() {
  function r(e) {
    Cn(this, r), this._file = e, this.size = e.size;
  }
  return En(r, [{
    key: "slice",
    value: function(t, i) {
      if (Sn())
        return $n(this._file.slice(t, i));
...
function Fn(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, Ln(i.key), i);
  }
}
function Tn(r, e, t) {
  return e && Fn(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Ln(r) {
  var e = zn(r, "string");
...
var An = /* @__PURE__ */ (function() {
  function r(e) {
    On(this, r), this._buffer = void 0, this._bufferOffset = 0, this._reader = e, this._done = !1;
  }
  return Tn(r, [{
    key: "slice",
    value: function(t, i) {
    ...
    value: function(t, i) {
      ...
      return this._reader.read().then(function(l) {
        ...
        return c ? o._done = !0 : o._buffer === void 0 ? o._buffer = d : o._buffer = In(o._buffer, d), o._readUntilEnoughDataOrDone(t, i);
      });
    }
  }, {
...
function Mn(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, Nn(i.key), i);
  }
}
function Bn(r, e, t) {
...
var qn = /* @__PURE__ */ (function() {
  ...
  return Bn(r, [{
    key: "openFile",
    value: (function() {
      var e = jn(/* @__PURE__ */ ii().mark(function i(o, s) {
        var n;
        return ii().wrap(function(l) {
          for (; ; ) switch (l.prev = l.next) {
            case 0:
              ...
              return l.prev = 1, l.next = 4, kn(o.uri);
            case 4:
            ...
            case 17:
              return l.abrupt("return", Promise.resolve(new An(o, s)));
            case 18:
...
function Vn(r, e) {
  return mo() ? Promise.resolve(Kn(r, e)) : Promise.resolve(["tus-br", r.name, r.type, r.size, r.lastModified, e.endpoint].join("-"));
}
function Kn(r, e) {
  var t = r.exif ? Yn(JSON.stringify(r.exif)) : "noexif";
...
function ta(r, e) {
  for (var t = 0; t < e.length; t++) {
    var i = e[t];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(r, ra(i.key), i);
  }
}
function ia(r, e, t) {
  return e && ta(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function ra(r) {
  var e = oa(r, "string");
...
var sa = ri, na = /* @__PURE__ */ (function() {
  function r() {
    ea(this, r);
  }
  return ia(r, [{
...
function da(r, e, t) {
  return t && la(r, t), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function ca(r, e, t) {
  return e = Rt(e), pa(r, xo() ? Reflect.construct(e, t || [], Rt(r).constructor) : e.apply(r, t));
}
function pa(r, e) {
...
var Pr = De(De({}, Ut.defaultOptions), {}, {
  httpStack: new Jn(),
  fileReader: new qn(),
  urlStorage: sa ? new na() : new Vs(),
  fingerprint: Vn
}), ma = /* @__PURE__ */ (function(r) {
  function e() {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return aa(this, e), i = De(De({}, Pr), i), ca(this, e, [t, i]);
  }
  return fa(e, r), da(e, null, [{
    key: "terminate",
    value: function(i) {
...
const xa = 10 * 1024 * 1024, ba = 5 * 1024 * 1024, va = "https://eu-on-24001.connector.filerobot.com/files", ya = "https://eu-on-24001.connector.filerobot.com/json";
function wa(r, e) {
  if (!e || !r.file) return !1;
  const t = e.sizeThreshold ?? xa;
  return r.size >= t;
}
function _a(r, e) {
  const { tusConfig: t } = e, i = e.apiBase.replace(/\/+$/, ""), o = t.endpoint || va, s = t.jsonBase || ya, n = t.chunkSize ?? ba, a = t.resumable !== !1, l = t.parallelChunks ?? 1, d = t.retryDelays ?? [0, 1e3, 3e3, 5e3], c = i.split("/").pop() || "";
  let p = !1, f = !1, _ = !1;
  const b = {
    name: r.name,
    type: r.type,
  ...
  const y = async () => `tus-${r.id}-${o}`, P = new ma(r.file, {
    endpoint: o,
    chunkSize: n,
    retryDelays: d,
    parallelUploads: l,
...
const St = "_sfxRelativePath", Er = 8, $a = /* @__PURE__ */ new Set([
  "node_modules",
  "__MACOSX",
  "$RECYCLE.BIN",
...
function Ca(r) {
  return r ? r.startsWith(".") ? !0 : $a.has(r) : !1;
}
function _i(r, e) {
  if (e) {
    try {
...
async function yo(r, e, t) {
  for (let i = 0; i < r.length; i += Er) {
    ...
    await Promise.all(o.map((s) => Ra(s, e, t)));
  }
}
async function Ra(r, e, t) {
  try {
    ...
    if (r.isDirectory) {
      if (Ca(r.name)) return;
      const i = e ? `${e}/${r.name}` : r.name, o = await Fa(r);
      await yo(o, i, t);
    }
  } catch (i) {
...
class Ta {
  ...
  startUpload(e) {
    var f, _;
    const t = (_ = (f = this.config).resolveUploadParams) == null ? void 0 : _.call(f, e), i = !!t && Object.keys(t).length > 0, o = !i && !e.remoteInfo && !e.remoteUrl && wa(e, this.config.tusConfig);
  ...
  updateTotalProgress() {
    ...
    for (const s of e.values())
      (s.status === "queued" || s.status === "uploading" || s.status === "paused" || s.status === "retrying" || s.status === "complete" || s.status === "failed") && (t += s.size, i += s.status === "complete" ? s.size : s.bytesUploaded), s.status === "uploading" && (o += s.speed);
    this.store.setState({
      totalBytes: t,
...
async function za(r) {
  ...
  if (r.mode === "security-template") {
    const t = await La(r.container, r.securityTemplateId);
...
const Ba = /* @__PURE__ */ new Set([".ds_store", "thumbs.db", "desktop.ini"]);
function Vt(r) {
  const e = (r.split(/[\\/]/).pop() ?? r).toLowerCase();
  return e.startsWith(".ds_store") ? !0 : Ba.has(e);
}
const Na = "https://scaleflex.cloudimg.io/v7/assets/file-types/v3/", _o = {
  _default: "9a518a",
  // Images
  png: "96cd9a",
  jpg: "06e819",
...
var Ya = Object.defineProperty, $o = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Ya(e, t, o), o;
};
const Wa = '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>', Ga = '<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>', Xa = '<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>', Ja = '<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>', et = [
  { id: "device", labelKey: "myDevice", label: "My Device", icon: Wa, iconColor: "#2563eb" },
  { id: "url", labelKey: "urlLink", label: "URL link", icon: Ga, iconColor: "#16a34a" },
  { id: "camera", labelKey: "camera", label: "Camera", icon: Xa, iconColor: "#7c3aed" },
  { id: "screen-cast", labelKey: "screenCapture", label: "Screen capture", icon: Ja, iconColor: "#ea580c" }
...
function Za(r, e) {
  ...
  for (const o of r ?? []) {
    ...
    const s = o.type === li.LANGUAGES ? Qa(o.variants, e) : void 0;
...
function tl(r) {
  return Co.has(r.type) || el.has(r.ckey);
}
const He = "product.ref", qe = "product.position", il = "__product__", rl = /* @__PURE__ */ new Set([
  He,
  qe
]);
function ol(r) {
...
function Po(r, e) {
  var t;
  return tl(r) ? !1 : (t = e == null ? void 0 : e.requiredFields) != null && t.includes(r.ckey) ? !0 : !!r.required;
}
function $i(r) {
  return [...r.values()].filter((e) => dl.has(e.status));
}
function Ci(r, e) {
...
var ul = Object.defineProperty, le = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && ul(e, t, o), o;
};
...
Ri.styles = ne`
  ...
  `;
let Tr = Ri;
var fl = Object.defineProperty, G = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && fl(e, t, o), o;
};
...
var hl = Object.defineProperty, ee = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && hl(e, t, o), o;
};
const Fi = class Fi extends ce {
  ...
  render() {
    ...
    const e = this.file;
    if (!e) return $;
    const t = pe(e), i = e.status === "complete", o = e.status === "uploading", s = e.status === "paused", n = e.status === "error" || e.status === "failed", a = e.status === "rejected", l = this.mode === "review", d = Ma(e.name), c = t === "image" && !ve(e.type), p = this.selectMode && c && !l, f = this.similarCount >= 0, _ = p && !f && this.similarStatus === "", b = !l && !i && !o && !s && !n && e.status !== "rejected" && this.similarStatus !== "searching" && !this.reviewPick, y = b, P = [
      "tile",
      i ? "done" : "",
      o ? "uploading" : "",
      s ? "paused" : "",
...
`;
var gl = Object.defineProperty, me = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && gl(e, t, o), o;
};
const Lr = 7, ml = 4, Ti = class Ti extends ce {
  constructor() {
    super(...arguments), this.t = (e, t) => typeof t == "string" ? t : e, this.fileCount = 0, this.totalSize = 0, this.thumbnails = [], this.primaryLabel = "Done", this.failedFiles = [], this.alreadyExistedCount = 0, this.showMinimize = !1, this._maxThumbs = Lr, this._updateMaxThumbs = () => {
      const e = window.innerWidth <= 768 ? ml : Lr;
...
var xl = Object.defineProperty, gt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && xl(e, t, o), o;
};
...
var bl = Object.defineProperty, de = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && bl(e, t, o), o;
};
...
const vl = 'button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';
function Pi(r, e) {
  return (t) => {
    if (t.key !== "Tab") return;
    const i = r();
    ...
    if (!o) return;
    const s = Array.from(o.querySelectorAll(vl));
...
var yl = Object.defineProperty, zt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && yl(e, t, o), o;
};
...
var wl = Object.defineProperty, mt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && wl(e, t, o), o;
};
...
var _l = Object.defineProperty, We = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && _l(e, t, o), o;
};
...
var kl = Object.defineProperty, Ei = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && kl(e, t, o), o;
};
...
var Sl = Object.defineProperty, N = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Sl(e, t, o), o;
};
const zr = /* @__PURE__ */ new Set(["unsplash"]), be = 10, $l = [
  "auto",
  "mobile",
  "tablet",
  "desktop",
...
const B = (V = class extends ce {
      ...
      if ((((s = (o = this.config) == null ? void 0 : o.connectors) == null ? void 0 : s.providers) ?? []).includes(e)) {
        if (zr.has(e)) {
          if (!customElements.get("sfx-search-provider-browser")) {
            const { SfxSearchProviderBrowser: a } = await import("./search-provider-browser-PGcQPy3k.js");
          ...
          const { SfxProviderBrowser: a } = await import("./provider-browser-Czs3C307.js");
  ...
  async _preloadMetadataSchema(e) {
    ...
    if (!(!t || !this._apiBase || !this._authHeaders))
      try {
        const { fetchMetadataSchema: i, createTagsAutocomplete: o, createTaxonomyService: s, createUltratagsService: n } = await import("./index-DBGvPP8X.js"), a = await i(
          this._apiBase,
          this._authHeaders,
          t.projectUuid,
          t
        ...
        this._metadataAutocomplete = o(
          ...
          this._apiBase,
          this._authHeaders
        ), this._metadataSchema = a.productsEnabled ? ll(a, this._storeCtrl.state.t) : a;
  ...
  _firstMissingRequiredFieldKey() {
    var e;
    return !this._metadataEnforcing || !this._metadataSchema ? null : cl(
  ...
  get _mergedSources() {
    ...
    const t = e.providers.length > 0 ? Ka(e.providers) : [], i = e.customSources ?? [], o = e.coreSources ? new Set(e.coreSources) : null, s = o ? et.filter((f) => o.has(f.id)) : et, n = e.companionUrl ? s : s.filter((f) => f.id !== "url"), a = n.filter(
  ...
  _processIncomingFiles(e) {
    ...
    for (const p of e) {
      ...
      const f = i ? Ea(Pa(p)) : "", _ = this._store.getState();
