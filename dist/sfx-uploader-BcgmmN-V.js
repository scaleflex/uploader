...
class Ut extends It {
  ...
  translate(e, t, i) {
    ...
    let m = _ == null ? void 0 : _.res;
    const v = (_ == null ? void 0 : _.usedKey) || a, C = (_ == null ? void 0 : _.exactUsedKey) || a, z = ["[object Number]", "[object Function]", "[object RegExp]"], k = o.joinArrays !== void 0 ? o.joinArrays : this.options.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, w = o.count !== void 0 && !j(o.count), x = Ut.hasDefaultValue(o), U = w ? this.pluralResolver.getSuffix(p, o.count, o) : "", E = o.ordinal && w ? this.pluralResolver.getSuffix(p, o.count, {
      ordinal: !1
    }) : "", A = w && !o.ordinal && o.count === 0, L = A && o[`defaultValue${this.options.pluralSeparator}zero`] || o[`defaultValue${U}`] || o[`defaultValue${E}`] || o.defaultValue;
    let T = m;
    y && !m && x && (T = L);
    const J = Nt(T), de = Object.prototype.toString.apply(T);
    if (y && T && J && !z.includes(de) && !(j(k) && Array.isArray(T))) {
      ...
      let F = !1, Y = !1;
      !this.isValidLookup(m) && x && (F = !0, m = L), this.isValidLookup(m) || (Y = !0, m = a);
      const b = (o.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && Y ? void 0 : m, h = x && L !== m && this.options.updateMissing;
      if (Y || F || h) {
        if (this.logger.log(h ? "updateKey" : "missingKey", p, c, w && !h ? `${a}${this.pluralResolver.getSuffix(p, o.count, o)}` : a, h ? L : m), n) {
        ...
        const R = (S, D, H) => {
          var ee;
          const q = x && H !== m ? H : b;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(S, c, D, q, h, o) : (ee = this.backendConnector) != null && ee.saveMissing && this.backendConnector.saveMissing(S, c, D, q, h, o), this.emit("missingKey", S, c, D, m);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && w ? g.forEach((S) => {
          ...
          A && o[`defaultValue${this.options.pluralSeparator}zero`] && !D.includes(`${this.options.pluralSeparator}zero`) && D.push(`${this.options.pluralSeparator}zero`), D.forEach((H) => {
            R([S], a + H, o[`defaultValue${H}`] || L);
          });
        }) : R(g, a, L));
      }
      m = this.extendTranslation(m, e, o, _, i), Y && m === a && this.options.appendNamespaceToMissingKey && (m = `${c}${d}${a}`), (Y || F) && this.options.parseMissingKeyHandler && (m = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${c}${d}${a}` : a, F ? m : void 0, o));
    }
    return s ? (_.res = m, _.usedParams = this.getUsedParamsDetails(o), _) : m;
  }
  extendTranslation(e, t, i, o, s) {
    ...
    if ((l = this.i18nFormat) != null && l.parse)
      ...
      if (this.options.interpolation.defaultVariables && (u = {
        ...
        const _ = e.match(this.interpolator.nestingRegexp), m = _ && _.length;
        p < m && (i.nest = !1);
      }
  ...
  resolve(e, t = {}) {
    ...
    return j(e) && (e = [e]), Array.isArray(e) && (e = e.map((l) => typeof l == "function" ? Me(l, {
      ...
      const u = t.count !== void 0 && !j(t.count), _ = u && !t.ordinal && t.count === 0, m = t.context !== void 0 && (j(t.context) || typeof t.context == "number") && t.context !== "", v = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      p.forEach((C) => {
        var z, k;
        this.isValidLookup(i) || (a = C, !this.checkedLoadedFor[`${v[0]}-${C}`] && ((z = this.utils) != null && z.hasLoadedNamespace) && !((k = this.utils) != null && k.hasLoadedNamespace(a)) && (this.checkedLoadedFor[`${v[0]}-${C}`] = !0, this.logger.warn(`key "${o}" for languages "${v.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), v.forEach((y) => {
          var U;
          if (this.isValidLookup(i)) return;
          n = y;
          const w = [d];
          if ((U = this.i18nFormat) != null && U.addLookupKeys)
            ...
            if (u && (t.ordinal && E.startsWith(L) && w.push(d + E.replace(L, this.options.pluralSeparator)), w.push(d + E), _ && w.push(d + A)), m) {
              const T = `${d}${this.options.contextSeparator || "_"}${t.context}`;
              w.push(T), u && (t.ordinal && E.startsWith(L) && w.push(T + E.replace(L, this.options.pluralSeparator)), w.push(T + E), _ && w.push(T + A));
            }
          }
          let x;
          for (; x = w.pop(); )
            this.isValidLookup(i) || (s = x, i = this.getResource(y, C, x, t));
        }));
      });
    }), {
      res: i,
...
class ir {
  ...
  interpolate(e, t, i, o) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (m) => {
      ...
      const v = m.split(this.formatSeparator), C = v.shift().trim(), z = v.join(this.formatSeparator).trim();
      return this.format(tr(t, l, C, this.options.keySeparator, this.options.ignoreJSONStructure), z, i, {
        ...o,
        ...t,
        interpolationkey: C
      });
    ...
    const d = (o == null ? void 0 : o.missingInterpolationHandler) || this.options.missingInterpolationHandler, p = ((_ = o == null ? void 0 : o.interpolation) == null ? void 0 : _.skipOnVariables) !== void 0 ? o.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables;
    return [{
  ...
  nest(e, t, i = {}) {
    ...
    const a = (l, c) => {
      ...
      const _ = u.match(/'/g), m = u.match(/"/g);
      (((_ == null ? void 0 : _.length) ?? 0) % 2 === 0 && !m || ((m == null ? void 0 : m.length) ?? 0) % 2 !== 0) && (u = u.replace(/'/g, '"'));
      try {
        n = JSON.parse(u), c && (n = {
          ...c,
          ...n
  ...
  format(e, t, i, o = {}) {
    ...
    return s.reduce((a, l) => {
      ...
      if (this.formats[c]) {
        let u = a;
        try {
          const _ = ((p = o == null ? void 0 : o.formatParams) == null ? void 0 : p[o.interpolationkey]) || {}, m = _.locale || _.lng || o.locale || o.lng || i;
    ...
    if (!(i == null || i === "")) {
      if ((u = this.backend) != null && u.create) {
        ...
        if (m.length < 6)
          try {
            let v;
            m.length === 5 ? v = m(e, t, i, o, _) : v = m(e, t, i, o), v && typeof v.then == "function" ? v.then((C) => a(null, C)).catch(a) : a(null, v);
          } catch (v) {
            a(v);
          }
        else
...
class it extends It {
  ...
  init(e = {}, t) {
    ...
    if (!this.options.isClone) {
      ...
      }, p.backendConnector = new as(o(this.modules.backend), p.resourceStore, p, this.options), p.backendConnector.on("*", (u, ..._) => {
        this.emit(u, ..._);
      }), this.modules.languageDetector && (p.languageDetector = o(this.modules.languageDetector), p.languageDetector.init && p.languageDetector.init(p, this.options.detection, this.options)), this.modules.i18nFormat && (p.i18nFormat = o(this.modules.i18nFormat), p.i18nFormat.init && p.i18nFormat.init(this)), this.translator = new Ut(this.services, this.options), this.translator.on("*", (u, ..._) => {
        this.emit(u, ..._);
  ...
  getFixedT(e, t, i, o) {
    const s = o == null ? void 0 : o.scopeNs, n = (a, l, ...c) => {
      ...
      let m;
      return d.keyPrefix && Array.isArray(a) ? m = a.map((v) => (typeof v == "function" && (v = Me(v, u)), `${d.keyPrefix}${_}${v}`)) : (typeof a == "function" && (a = Me(a, u)), m = d.keyPrefix ? `${d.keyPrefix}${_}${a}` : a), this.t(m, d);
    };
...
var ro = class {
    ...
    this.options.request(this.options, r, n, (l, c) => {
      ...
      if (!c && l && l.message) {
        ...
        if ([
          ...
          "network",
          "load"
        ].find((_) => u.indexOf(_) > -1)) return e("failed loading " + a + ": " + bt(l.message), !0);
      }
      if (l) return e(l, !1);
      let d, p;
      try {
  ...
  create(r, e, t, i, o) {
    ...
    r.forEach((c) => {
      ...
      this.options.request(this.options, p, s, (u, _) => {
        n += 1, a.push(u), l.push(_), n === r.length && typeof o == "function" && o(a, l);
      });
    });
  }
  reload() {
...
async function kc(r, e, t, i, o, s) {
  ...
  async function a(l, c) {
    ...
    do {
      ...
      for (const _ of u.items) {
        if (s != null && s.aborted) throw new DOMException("Aborted", "AbortError");
        if (_.isFolder) {
          const m = c ? `${c}/${_.name}` : _.name;
          await a(_.requestPath, m);
        } else
          n.push({ ..._, relativeFolder: c });
      }
    } while (d);
  }
  ...
  return i.onmessage = (n) => {
    ...
    if (!o)
      try {
        ...
        switch (d.action) {
          case "progress": {
            const p = d.payload, u = p.bytesUploaded ?? 0, _ = p.bytesTotal ?? (r.expectedSize || 1);
            r.onProgress(u, _);
            break;
          }
          case "success": {
...
function vn() {
  ...
  function p(k) {
    ...
    if (k.protocol === "blob:")
      ...
      for (E in k)
        E in d || (x[E] = k[E]);
      x.slashes === void 0 && (x.slashes = o.test(k.href));
    }
    return x;
  }
  function u(k) {
  ...
  function _(k, y) {
    ...
    var w = n.exec(k), x = w[1] ? w[1].toLowerCase() : "", U = !!w[2], E = !!w[3], A = 0, L;
    return U ? E ? (L = w[2] + w[3] + w[4], A = w[2].length + w[3].length) : (L = w[2] + w[4], A = w[2].length) : E ? (L = w[3] + w[4], A = w[3].length) : L = w[4], x === "file:" ? A >= 2 && (L = L.slice(2)) : u(x) ? L = w[4] : x ? U && (L = L.slice(2)) : A >= 2 && u(y.protocol) && (L = w[4]), {
      protocol: x,
      slashes: U || u(x),
      slashesCount: A,
      rest: L
  ...
  function m(k, y) {
    if (k === "") return y;
    for (var w = (y || "/").split("/").slice(0, -1).concat(k.split("/")), x = w.length, U = w[x - 1], E = !1, A = 0; x--; )
      w[x] === "." ? w.splice(x, 1) : w[x] === ".." ? (w.splice(x, 1), A++) : A && (x === 0 && (E = !0), w.splice(x, 1), A--);
    return E && w.unshift(""), (U === "." || U === "..") && w.push(""), w.join("/");
  }
  function v(k, y, w) {
    if (k = l(k), k = k.replace(i, ""), !(this instanceof v))
      return new v(k, y, w);
    var x, U, E, A, L, T, J = c.slice(), de = typeof y, F = this, Y = 0;
    for (de !== "object" && de !== "string" && (w = y, y = null), w && typeof w != "function" && (w = e.parse), y = p(y), U = _(k || "", y), x = !U.protocol && !U.slashes, F.slashes = U.slashes || x && y.slashes, F.protocol = U.protocol || y.protocol || "", k = U.rest, (U.protocol === "file:" && (U.slashesCount !== 2 || a.test(k)) || !U.slashes && (U.protocol || U.slashesCount < 2 || !u(F.protocol))) && (J[3] = [/(.*)/, "pathname"]); Y < J.length; Y++) {
      if (A = J[Y], typeof A == "function") {
        k = A(k, F);
        continue;
      }
      E = A[0], T = A[1], E !== E ? F[T] = k : typeof E == "string" ? (L = E === "@" ? k.lastIndexOf(E) : k.indexOf(E), ~L && (typeof A[2] == "number" ? (F[T] = k.slice(0, L), k = k.slice(L + A[2])) : (F[T] = k.slice(L), k = k.slice(0, L)))) : (L = E.exec(k)) && (F[T] = L[1], k = k.slice(0, L.index)), F[T] = F[T] || x && A[3] && y[T] || "", A[4] && (F[T] = F[T].toLowerCase());
    }
    w && (F.query = w(F.query)), x && y.slashes && F.pathname.charAt(0) !== "/" && (F.pathname !== "" || y.pathname !== "") && (F.pathname = m(F.pathname, y.pathname)), F.pathname.charAt(0) !== "/" && u(F.protocol) && (F.pathname = "/" + F.pathname), r(F.port, F.protocol) || (F.host = F.hostname, F.port = ""), F.username = F.password = "", F.auth && (L = F.auth.indexOf(":"), ~L ? (F.username = F.auth.slice(0, L), F.username = encodeURIComponent(decodeURIComponent(F.username)), F.password = F.auth.slice(L + 1), F.password = encodeURIComponent(decodeURIComponent(F.password))) : F.username = encodeURIComponent(decodeURIComponent(F.auth)), F.auth = F.password ? F.username + ":" + F.password : F.username), F.origin = F.protocol !== "file:" && u(F.protocol) && F.host ? F.protocol + "//" + F.host : "null", F.href = F.toString();
  }
  function C(k, y, w) {
    var x = this;
    switch (k) {
      case "query":
        typeof y == "string" && y.length && (y = (w || e.parse)(y)), x[k] = y;
        break;
      case "port":
        x[k] = y, r(y, x.protocol) ? y && (x.host = x.hostname + ":" + y) : (x.host = x.hostname, x[k] = "");
        break;
      case "hostname":
        x[k] = y, x.port && (y += ":" + x.port), x.host = y;
        break;
      case "host":
        x[k] = y, s.test(y) ? (y = y.split(":"), x.port = y.pop(), x.hostname = y.join(":")) : (x.hostname = y, x.port = "");
        break;
      case "protocol":
        x.protocol = y.toLowerCase(), x.slashes = !w;
        break;
      case "pathname":
      case "hash":
        if (y) {
          var U = k === "pathname" ? "/" : "#";
          x[k] = y.charAt(0) !== U ? U + y : y;
        } else
          x[k] = y;
        break;
      case "username":
      case "password":
        x[k] = encodeURIComponent(y);
        break;
      case "auth":
        var E = y.indexOf(":");
        ~E ? (x.username = y.slice(0, E), x.username = encodeURIComponent(decodeURIComponent(x.username)), x.password = y.slice(E + 1), x.password = encodeURIComponent(decodeURIComponent(x.password))) : x.username = encodeURIComponent(decodeURIComponent(y));
    }
    for (var A = 0; A < c.length; A++) {
      var L = c[A];
      L[4] && (x[L[1]] = x[L[1]].toLowerCase());
    }
    return x.auth = x.password ? x.username + ":" + x.password : x.username, x.origin = x.protocol !== "file:" && u(x.protocol) && x.host ? x.protocol + "//" + x.host : "null", x.href = x.toString(), x;
  }
  function z(k) {
    (!k || typeof k != "function") && (k = e.stringify);
    var y, w = this, x = w.host, U = w.protocol;
    U && U.charAt(U.length - 1) !== ":" && (U += ":");
    var E = U + (w.protocol && w.slashes || u(w.protocol) ? "//" : "");
    return w.username ? (E += w.username, w.password && (E += ":" + w.password), E += "@") : w.password ? (E += ":" + w.password, E += "@") : w.protocol !== "file:" && u(w.protocol) && !x && w.pathname !== "/" && (E += "@"), (x[x.length - 1] === ":" || s.test(w.hostname) && !w.port) && (x += ":"), E += x + w.pathname, y = typeof w.query == "object" ? k(w.query) : w.query, y && (E += y.charAt(0) !== "?" ? "?" + y : y), w.hash && (E += w.hash), E;
  }
  return v.prototype = { set: C, toString: z }, v.extractProtocol = _, v.location = p, v.trimLeft = l, v.qs = e, Yt = v, Yt;
}
var yn = vn();
...
function ai() {
  ...
  function d(b, h, g, P) {
    var R = h && h.prototype instanceof z ? h : z, S = Object.create(R.prototype), D = new Y(P || []);
    return o(S, "_invoke", { value: T(b, g, D) }), S;
  }
  function p(b, h, g) {
    try {
  ...
  e.wrap = d;
  var u = "suspendedStart", _ = "suspendedYield", m = "executing", v = "completed", C = {};
  function z() {
  }
  function k() {
  }
  ...
  var x = Object.getPrototypeOf, U = x && x(x(he([])));
  U && U !== t && i.call(U, n) && (w = U);
  var E = y.prototype = z.prototype = Object.create(w);
  function A(b) {
  ...
  function T(b, h, g) {
    ...
    return function(R, S) {
      ...
      for (g.method = R, g.arg = S; ; ) {
        ...
        var q = p(b, h, g);
        if (q.type === "normal") {
          if (P = g.done ? v : _, q.arg === C) continue;
  ...
  function J(b, h) {
    ...
    if (P === r) return h.delegate = null, g === "throw" && b.iterator.return && (h.method = "return", h.arg = r, J(b, h), h.method === "throw") || g !== "return" && (h.method = "throw", h.arg = new TypeError("The iterator does not provide a '" + g + "' method")), C;
    var R = p(P, b.iterator, h.arg);
    if (R.type === "throw") return h.method = "throw", h.arg = R.arg, h.delegate = null, C;
    var S = R.arg;
    return S ? S.done ? (h[b.resultName] = S.value, h.next = b.nextLoc, h.method !== "return" && (h.method = "next", h.arg = r), h.delegate = null, C) : S : (h.method = "throw", h.arg = new TypeError("iterator result is not an object"), h.delegate = null, C);
  }
  function de(b) {
    var h = { tryLoc: b[0] };
  ...
  function he(b) {
    ...
    throw new TypeError(Oe(b) + " is not iterable");
  }
  return k.prototype = y, o(E, "constructor", { value: y, configurable: !0 }), o(y, "constructor", { value: k, configurable: !0 }), k.displayName = c(y, l, "GeneratorFunction"), e.isGeneratorFunction = function(b) {
    var h = typeof b == "function" && b.constructor;
    return !!h && (h === k || (h.displayName || h.name) === "GeneratorFunction");
  }, e.mark = function(b) {
    return Object.setPrototypeOf ? Object.setPrototypeOf(b, y) : (b.__proto__ = y, c(b, l, "GeneratorFunction")), b.prototype = Object.create(E), b;
  }, e.awrap = function(b) {
    return { __await: b };
  }, A(L.prototype), c(L.prototype, a, function() {
    return this;
  }), e.AsyncIterator = L, e.async = function(b, h, g, P, R) {
    R === void 0 && (R = Promise);
    var S = new L(d(b, h, g, P), R);
    ...
    return g.reverse(), function R() {
      for (; g.length; ) {
        var S = g.pop();
        if (S in h) return R.value = S, R.done = !1, R;
      }
      return R.done = !0, R;
    };
    ...
    for (var R = this.tryEntries.length - 1; R >= 0; --R) {
      var S = this.tryEntries[R], D = S.completion;
  ...
  return Rn(r, [{
    ...
    value: function() {
      ...
      var l = a.map(function(d, p) {
        var u = 0;
        return i._source.slice(d.start, d.end).then(function(_) {
          var m = _.value;
          return new Promise(function(v, C) {
            var z = ze(ze({}, i.options), {}, {
...
function ci() {
  ...
  function he(b) {
    ...
    throw new TypeError(Fe(b) + " is not iterable");
  }
  return k.prototype = y, o(E, "constructor", { value: y, configurable: !0 }), o(y, "constructor", { value: k, configurable: !0 }), k.displayName = c(y, l, "GeneratorFunction"), e.isGeneratorFunction = function(b) {
    var h = typeof b == "function" && b.constructor;
    return !!h && (h === k || (h.displayName || h.name) === "GeneratorFunction");
...
function La(r, e) {
  ...
  const v = async () => `tus-${r.id}-${o}`, C = new Ea(r.file, {
    ...
    onUploadUrlAvailable() {
      C.url && e.onUploadUrlAvailable && !_ && (_ = !0, e.onUploadUrlAvailable(C.url));
    },
    onProgress(x, U) {
      !u && !p && e.onProgress(x, U);
    },
    onSuccess() {
      var E;
      if (u) return;
      y();
      const x = C.url || "", U = (E = x.match(/files\/([^/?]+)/)) == null ? void 0 : E[1];
      U ? Ia(s, U, r.size).then((A) => {
        u || e.onComplete(
          pt(A) ? yi(A, r) : A
        );
      }).catch((A) => {
    ...
    onShouldRetry(x, U, E) {
      var L;
      const A = (L = x.originalResponse) == null ? void 0 : L.getStatus();
  ...
  typeof window < "u" && (z = () => {
    var x;
    !p && !u && (p = !0, C.abort(!1), (x = e.onPause) == null || x.call(e));
  }, k = () => {
    var x;
    p && !u && (p = !1, C.start(), (x = e.onResume) == null || x.call(e));
  }, window.addEventListener("offline", z), window.addEventListener("online", k));
  const y = () => {
    z && window.removeEventListener("offline", z), k && window.removeEventListener("online", k);
  }, w = () => {
    try {
      C.start();
    } catch (x) {
  ...
  return a ? C.findPreviousUploads().then((x) => {
    x.length > 0 && !u && C.resumeFromPreviousUpload(x[0]), u || w();
  }) : w(), {
    abort() {
      u = !0, p = !1, y(), C.abort(!0);
    },
...
class Va {
  ...
  cancelFile(e) {
    const t = this.store.getState().files.get(e);
    !t || !ui(t.status) || (this.abortPausedUpload(e), this.abortUpload(e), X(this.store, e, { status: "cancelled" }));
  }
  /**
  ...
  cancelAll() {
    const { files: e } = this.store.getState();
    for (const t of e.values())
      ui(t.status) && (this.abortPausedUpload(t.id), this.abortUpload(t.id), X(this.store, t.id, { status: "cancelled" }));
  ...
  startUpload(e) {
    var u, _;
    const t = (_ = (u = this.config).resolveUploadParams) == null ? void 0 : _.call(u, e), i = !!t && Object.keys(t).length > 0, o = !i && !e.remoteInfo && !e.remoteUrl && Ta(e, this.config.tusConfig);
    ...
    const l = Ba(
      ...
      X(this.store, e.id, { progress: k, bytesUploaded: m, speed: a }), this.updateTotalProgress();
    };
    let p;
    if (e.remoteInfo)
  ...
  handleComplete(e, t) {
    var c, d, p, u, _, m, v, C, z, k, y;
    this.activeUploads.delete(e);
    const i = this.store.getState().files.get(e), o = ((c = i == null ? void 0 : i.previewUrl) == null ? void 0 : c.startsWith("blob:")) ?? !1, s = ((p = (d = t.file) == null ? void 0 : d.url) == null ? void 0 : p.cdn) ?? ((_ = (u = t.file) == null ? void 0 : u.url) == null ? void 0 : _.cdn_permalink) ?? ((v = (m = t.file) == null ? void 0 : m.url) == null ? void 0 : v.permalink) ?? null, n = {
      status: "complete",
      progress: 100,
      response: t,
      alreadyExisted: pt(t)
    ...
    if (i && s && i.type.startsWith("image/") && !o) {
      const w = ((k = (z = this.config).transformPreviewUrl) == null ? void 0 : k.call(z, s, (C = t.file) == null ? void 0 : C.url)) ?? s;
      w && (n.previewUrl = w);
    }
    const a = (y = t.file) == null ? void 0 : y.size, l = typeof a == "number" ? a : a == null ? void 0 : a.bytes;
...
async function Ar(r, e) {
  ...
  try {
    ...
    const d = await el(c);
    n();
    const u = `${(e.endpoint || Wa).replace(/\/+$/, "")}/images/embedding/vectorize/image?threshold=${encodeURIComponent(String(e.threshold))}`, _ = new FormData();
    _.append("file", d, Za(r.name));
    ...
    return (v.similar_assets ?? []).map(([C, z, k]) => ({
      uuid: C,
      score: z,
      url: k
    }));
...
function tl(r) {
  var s, n, a, l, c, d, p, u, _;
  const { file: e, previewUrl: t, ...i } = r;
  let o = null;
  return r.status === "complete" && (r.previewUrl && !r.previewUrl.startsWith("blob:") ? o = r.previewUrl : o = ((a = (n = (s = r.response) == null ? void 0 : s.file) == null ? void 0 : n.url) == null ? void 0 : a.permalink) ?? ((d = (c = (l = r.response) == null ? void 0 : l.file) == null ? void 0 : c.url) == null ? void 0 : d.cdn_permalink) ?? ((_ = (u = (p = r.response) == null ? void 0 : p.file) == null ? void 0 : u.url) == null ? void 0 : _.cdn) ?? null), { ...i, previewUrl: o };
}
function il(r) {
  try {
...
var Jl = Object.defineProperty, le = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Jl(e, t, o), o;
};
...
Ii.styles = ne`
  ...
  `;
let Vr = Ii;
var Zl = Object.defineProperty, W = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Zl(e, t, o), o;
};
...
var Ql = Object.defineProperty, Q = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && Ql(e, t, o), o;
};
const Di = class Di extends pe {
  ...
  render() {
    ...
    const e = this.file;
    if (!e) return $;
    const t = ue(e), i = e.status === "complete", o = e.status === "uploading", s = e.status === "paused", n = e.status === "error" || e.status === "failed", a = e.status === "rejected", l = this.mode === "review", c = l || this.reviewPick || !this.allowRename, d = sl(e.name), p = t === "image" && !ve(e.type), u = this.selectMode && p && !l, _ = this.similarCount >= 0, m = u && !_ && this.similarStatus === "", v = !l && !i && !o && !s && !n && e.status !== "rejected" && this.similarStatus !== "searching" && !this.reviewPick, C = v, z = [
      "tile",
      i ? "done" : "",
      o ? "uploading" : "",
      s ? "paused" : "",
      ...
      !x.dataset.fallback && x.src !== U && (x.dataset.fallback = "1", x.src = U);
          ...
          ${l && i && ((k = e.response) != null && k.file) && (this.showLocateButton || this.showCopyCdnButton) ? f`
                <div class="review-actions">
                  ...
                  ${this.showCopyCdnButton && ((y = e.response.file.url) != null && y.cdn) ? f`<button class="review-action primary ${this._copied ? "copied" : ""}" @click=${this._copyCdn} title=${this.t("copyCdn", "Copy CDN")} aria-label=${this.t("copyCdnLink", "Copy CDN link to clipboard")}>
        ...
        <div class="info">
          <input class="name-input" type="text" .value=${e.name} title=${e.name}
            ...
            ?readonly=${c}
            @change=${c ? $ : this._rename} @click=${(w) => w.stopPropagation()} />
          <div class="meta">${d || ""}${e.size ? ` · ${Ce(e.size)}` : ""}${this._dims ? ` · ${this._dims}` : ""}</div>
        </div>
      </div>
...
`;
var ec = Object.defineProperty, xe = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && ec(e, t, o), o;
};
const Kr = 7, tc = 4, ji = class ji extends pe {
  constructor() {
    super(...arguments), this.t = (e, t) => typeof t == "string" ? t : e, this.fileCount = 0, this.totalSize = 0, this.thumbnails = [], this.primaryLabel = "Done", this.failedFiles = [], this.alreadyExistedCount = 0, this.showMinimize = !1, this._maxThumbs = Kr, this._updateMaxThumbs = () => {
      const e = window.innerWidth <= 768 ? tc : Kr;
...
var ic = Object.defineProperty, gt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && ic(e, t, o), o;
};
...
var rc = Object.defineProperty, ce = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && rc(e, t, o), o;
};
...
const oc = 'button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';
function Ti(r, e) {
  return (t) => {
    if (t.key !== "Tab") return;
    const i = r();
    ...
    if (!o) return;
    const s = Array.from(o.querySelectorAll(oc));
...
var nc = Object.defineProperty, mt = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && nc(e, t, o), o;
};
...
var ac = Object.defineProperty, We = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && ac(e, t, o), o;
};
...
var lc = Object.defineProperty, Li = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && lc(e, t, o), o;
};
...
var cc = Object.defineProperty, N = (r, e, t, i) => {
  for (var o = void 0, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = n(e, t, o) || o);
  return o && cc(e, t, o), o;
};
const Yr = /* @__PURE__ */ new Set(["unsplash"]), be = 10, dc = 3, pc = [
  "auto",
  "mobile",
  "tablet",
  "desktop",
...
const B = (V = class extends pe {
  constructor() {
    super(), this.config = null, this._isOpen = !1, this._activeConnector = null, this._showUrlDialog = !1, this._showCameraDialog = !1, this._showScreenCastDialog = !1, this._similarSelectMode = !1, this._similarSelectedIds = /* @__PURE__ */ new Set(), this._similarRunIds = [], this._similarActiveIds = /* @__PURE__ */ new Set(), this._similarResults = /* @__PURE__ */ new Map(), this._previewPanelTab = "details", this._similarDismissTimer = null, this._similarAbort = null, this._previewFileId = null, this._previewDims = "—", this._fileInfoOpen = !0, this._splitPct = 58, this._showSettings = !1, this._setResize = !0, this._setMaxW = 2e3, this._setMaxH = 2e3, this._setTranscode = !1, this._setResolution = "auto", this._setResolutionOpen = !1, this._setProtocol = "hls", this._setResumable = !1, this._isResizing = !1, this._splitRafId = 0, this._previewDefaultApplied = !1, this._fullscreenPreviewUrl = null, this._fullscreenVideoFile = null, this._fsZoom = 1, this._fsPanX = 0, this._fsPanY = 0, this._fsDragging = !1, this._fsDragStartX = 0, this._fsDragStartY = 0, this._fsPanStartX = 0, this._fsPanStartY = 0, this._bodyDragOver = !1, this._isMinimized = !1, this._isPillExpanded = !1, this._metadataSchema = null, this._metadataDependencies = [], this._regionalFilters = {}, this._bulkMetadataOpen = !1, this._bulkMetadataInitialFieldKey = null, this._isReviewing = !1, this._reviewFiles = [], this._hasStoredReview = !1, this._metadataAutocomplete = null, this._taxonomyService = null, this._ultratagsService = null, this._onRegionalChange = (e) => {
      ...
      if ((((s = (o = this.config) == null ? void 0 : o.connectors) == null ? void 0 : s.providers) ?? []).includes(e)) {
        if (Yr.has(e)) {
          if (!customElements.get("sfx-search-provider-browser")) {
            const { SfxSearchProviderBrowser: a } = await import("./search-provider-browser-BEO3zhZx.js");
          ...
          const { SfxProviderBrowser: a } = await import("./provider-browser-aqr-2sKz.js");
      ...
      Le(this._store, d), this._dispatchPublic(M.FILE_ADDED, { file: d }), (_ = o == null ? void 0 : o.onFileAdded) == null || _.call(o, d), this._store.getState().queueConfig.autoProceed && this.upload();
    }, this._onUrlCancel = () => {
      this._showUrlDialog = !1;
      ...
      for (const l of e.detail.files) {
        ...
        if (_) {
          ...
          Le(this._store, v), this._dispatchPublic(M.FILE_REJECTED, {
            file: v,
            reason: _
          }), (n = t == null ? void 0 : t.onFileRejected) == null || n.call(t, v, _);
          continue;
        }
        const m = {
          id: Ie(),
  ...
  upload() {
    ...
    this._dispatchPublic(M.UPLOAD_STARTED, { files: o }), (c = (l = (a = this.config) == null ? void 0 : a.callbacks) == null ? void 0 : l.onUploadStarted) == null || c.call(l, o), this._engine.uploadAll(), (d = this.config) != null && d.minimizeOnUpload && ((p = this.config) == null ? void 0 : p.mode) !== "inline" && !this._isMinimized && (this._isMinimized = !0, this._isPillExpanded = !0, (m = (_ = (u = this.config) == null ? void 0 : u.callbacks) == null ? void 0 : _.onMinimize) == null || m.call(_), this._dispatchFloatGeometryEvent(M.MINIMIZE), this.requestUpdate());
  }
  ...
  async _preloadMetadataSchema(e) {
    ...
    if (!(!t || !this._apiBase || !this._authHeaders))
      try {
        ...
        } = await import("./index-B4TPQgki.js"), [l, c] = await Promise.all([
  ...
  get _metadataEnforcing() {
    ...
    return !e || !this._metadataSchema ? !1 : Kl(this._metadataSchema, e);
  }
  _firstMissingRequiredFieldKey() {
    var e;
    return !this._metadataEnforcing || !this._metadataSchema ? null : Yl(
  ...
  _firstConflictedFieldKey() {
    return this._metadataSchema ? Xl(
      this._store.getState().files,
      this._metadataSchema,
      this._metadataDependencies
    ) : null;
  ...
  _onStoreChange() {
    ...
    for (const [m, v] of e.files) {
      ...
      if (C.status !== v.status)
        switch (v.status) {
          ...
          case "error":
          case "failed": {
            const z = new Error(v.error ?? "Upload failed");
            this._dispatchPublic(M.UPLOAD_ERROR, {
              file: v,
              error: z
            }), (a = i == null ? void 0 : i.onUploadError) == null || a.call(i, v, z);
            break;
          }
          case "retrying":
    ...
    if (t.isUploading && !e.isUploading) {
      ...
      if (!m.some((C) => C.status === "cancelled")) {
        const C = m.filter((w) => w.status === "complete"), z = m.filter(
          (w) => w.status === "failed" || w.status === "error"
        );
        if (C.length === 0 && z.length === 0) return;
        const k = this._lastUploadId;
        if (k != null) {
          const w = [...C, ...z];
          Xe.save(k, w), this._hasStoredReview = w.length > 0;
        }
        this._dispatchPublic(M.ALL_COMPLETE, { successful: C, failed: z }), (u = i == null ? void 0 : i.onAllComplete) == null || u.call(i, C, z);
        const y = (_ = this.config) == null ? void 0 : _.closeOnComplete;
        if (y !== !1 && y != null) {
  ...
  _processIncomingFiles(e) {
    ...
    for (const p of e) {
      ...
      const u = i ? Ma(ja(p)) : "", _ = this._store.getState();
      ...
      if (C) {
        ...
        if (U > 0) {
          const E = w.id, A = setTimeout(() => {
            ...
            const L = this._store.getState().files.get(E);
            L && L.status === "rejected" && lr(this._store, E);
          }, U);
      ...
      let z = null;
      v.startsWith("image/") && !ve(v) && (z = URL.createObjectURL(p));
      const k = {
        id: Ie(),
        status: "idle",
        file: p,
      ...
      if (Le(this._store, k), this._dispatchPublic(M.FILE_ADDED, { file: k }), (d = t == null ? void 0 : t.onFileAdded) == null || d.call(t, k), p.type.startsWith("video/")) {
        cl(p).then((w) => {
          if (!w) return;
          const x = this._store.getState(), U = x.files.get(k.id);
          if (U) {
            const E = new Map(x.files);
            E.set(k.id, { ...U, previewUrl: w }), this._store.setState({ files: E });
          } else
        ...
        y.preload = "metadata", y.src = URL.createObjectURL(p), y.onerror = () => {
          ...
          if (U) {
            const E = new Map(x.files);
            E.set(k.id, { ...U, duration: w }), this._store.setState({ files: E });
          }
        };
      }
    }
  ...
  _runSimilarityCheck(e) {
    ...
    const i = Ir((_ = (u = this.config) == null ? void 0 : u.similarityCheck) == null ? void 0 : _.confidence), o = (v = (m = this.config) == null ? void 0 : m.similarityCheck) == null ? void 0 : v.endpoint, s = new AbortController();
    ...
    const c = e.length, d = () => {
      if (!s.signal.aborted) {
        if (!this._previewFileId) {
          const C = e.find(
            (z) => {
              var k;
              return (((k = this._similarResults.get(z.id)) == null ? void 0 : k.length) ?? 0) > 0;
            }
          );
      ...
      if (!s.signal.aborted)
        for (; a < dc && n.length > 0; ) {
          const C = n.shift();
          a += 1, this._similarActiveIds = new Set(this._similarActiveIds).add(C.id), Ar(C, { ...t, threshold: i, endpoint: o, signal: s.signal }).then((z) => {
            s.signal.aborted || (this._similarMarkInactive(C.id), this._similarSetResults(C.id, z));
          }).catch((z) => {
            s.signal.aborted || (console.error("[sfx-uploader] Similarity check failed for", C.name, z), this._similarMarkInactive(C.id), this._similarSetResults(C.id, []));
          }).finally(() => {
  ...
  _renderHeader() {
    ...
    const e = this._storeCtrl.state.t, t = ((z = this.config) == null ? void 0 : z.mode) ?? "modal";
    if (this._phase === "uploading") {
      const L = [...this._storeCtrl.state.files.values()].filter((de) => de.status !== "rejected" && de.status !== "cancelled"), T = L.length, J = L.filter((de) => de.status === "complete").length;
      return f`
    ...
    const o = t === "modal" ? this._onModalDismiss : this._onInlineDismiss, s = i === "back" ? f`<button
      ...
      this._showSettings = !this._showSettings;
          ...
          </button>` : $, v = (U = (x = this._metadataSchema) == null ? void 0 : x.regionalVariantsGroups) != null && U.length ? f`<sfx-regional-settings
      ...
      return f`
              <div class="float-item">
                ...
                <div class="float-item-status">
                  ${d.status === "complete" ? f`${(u = this.config) != null && u.showLocateButton && ((m = (_ = d.response) == null ? void 0 : _.file) != null && m.uuid) ? f`<button
  ...
  _renderPreviewLayout(e) {
    ...
    const n = i.reduce((U, E) => U + (E.size || 0), 0), a = !!((z = (C = this.config) == null ? void 0 : C.similarityCheck) != null && z.enabled), l = i.filter(
      (U) => ue(U) === "image" && !ve(U.type) && !this._similarResults.has(U.id)
    ).map((U) => U.id), c = Math.min(
      l.length,
      be
    ), d = c > 0 && this._similarSelectedIds.size >= c, p = this._similarSelectedIds.size >= be, u = this._similarResults.get(o.id), _ = u !== void 0, m = _ ? this._previewPanelTab : "details";
    return f`
      ...
      !E.dataset.fallback && E.src !== A && (E.dataset.fallback = "1", E.src = A);
          ...
          ${this._metadataSchema && ((x = this.config) != null && x.metadataConfig) ? f`
                <div
  ...
  _renderSettingsPanel() {
    ...
    const e = this._storeCtrl.state.t, t = [...this._storeCtrl.state.files.values()], i = t.some(
      ...
      const m = parseInt(_.target.value, 10);
  ...
  _renderBody() {
    ...
    ), s = this._phase, n = jr(e.restrictions), a = i.length > 0, l = !!((m = (_ = this.config) == null ? void 0 : _.similarityCheck) != null && m.enabled), c = i.filter(
