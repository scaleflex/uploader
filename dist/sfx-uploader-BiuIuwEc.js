...
const B = (V = class extends pe {
      ...
      if ((((s = (o = this.config) == null ? void 0 : o.connectors) == null ? void 0 : s.providers) ?? []).includes(e)) {
        if (Dr.has(e)) {
          if (!customElements.get("sfx-search-provider-browser")) {
            const { SfxSearchProviderBrowser: a } = await import("./search-provider-browser-BZGh42po.js");
          ...
          const { SfxProviderBrowser: a } = await import("./provider-browser-jwBwrsfd.js");
  ...
  async _preloadMetadataSchema(e) {
    ...
    if (!(!t || !this._apiBase || !this._authHeaders))
      try {
        const { fetchMetadataSchema: i, createTagsAutocomplete: o, createTaxonomyService: s, createUltratagsService: n } = await import("./index-CM6PVCVR.js"), a = await i(
          this._apiBase,
          this._authHeaders,
          t.projectUuid,
          t
