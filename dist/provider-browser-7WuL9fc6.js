...
import { property as x, state as d } from "lit/decorators.js";
import { q as _, t as $, m as z, u as C, A as v, v as I, w as k, x as S } from "./sfx-uploader-jd8_cGGr.js";
...
var A = Object.defineProperty, l = (n, e, r, i) => {
...
const b = class b extends y {
  constructor() {
    super(...arguments), this.provider = "google-drive", this.companionUrl = "", this.transformThumbnail = (e) => e, this._authenticated = !1, this._loading = !1, this._items = [], this._selectedIds = /* @__PURE__ */ new Set(), this._breadcrumbs = [], this._nextPagePath = null, this._error = null, this._loadingMore = !1, this._username = null, this._cleanupAuthListener = null, this._authWindow = null, this._handleConnect = () => {
      var r;
