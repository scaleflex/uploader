...
import { u as C, v as A, A as y, w as I, m as M, x as L, y as B, t as $ } from "./sfx-uploader-C-WTaPb9.js";
import { fallbackT as V } from "@scaleflex/dam-ui/i18n";
...
function T(l, e) {
  const t = (r) => {
    ...
    const s = typeof r.data == "string" ? E(r.data) : r.data;
...
var j = Object.defineProperty, h = (l, e, t, r) => {
...
const w = class w extends S {
  constructor() {
    super(...arguments), this.t = V, this.provider = "google-drive", this.companionUrl = "", this.multi = !0, this.maxSelect = null, this.transformThumbnail = (e) => e, this._authenticated = !1, this._loading = !1, this._items = [], this._selectedIds = /* @__PURE__ */ new Set(), this._breadcrumbs = [], this._nextPagePath = null, this._error = null, this._loadingMore = !1, this._username = null, this._resolvingFolders = !1, this._resolveProgress = 0, this._cleanupAuthListener = null, this._authWindow = null, this._resolveAbort = null, this._handleConnect = () => {
      ...
      const e = C(this.companionUrl, this.provider);
      this._authWindow = window.open(e, "_blank", "width=600,height=600"), (t = this._cleanupAuthListener) == null || t.call(this), this._cleanupAuthListener = T(this._authWindow, (r) => {
        var s;
        this._authWindow = null, (s = this._cleanupAuthListener) == null || s.call(this), this._cleanupAuthListener = null, H(this.provider, r), this._authenticated = !0, this._loadFolder("");
      });
      ...
      if (e) {
        try {
          await I(this.companionUrl, this.provider, e);
        } catch {
        }
        _(this.provider);
      }
  ...
  async _loadFolder(e) {
    ...
    try {
      const r = await L(this.companionUrl, this.provider, t, e);
  ...
  get _selectedFileCount() {
    return this._items.filter((e) => !e.isFolder && this._selectedIds.has(e.id)).length;
  }
  _toggleSelect(e, t) {
    if (!this.multi) {
    ...
    return n`
      ...
      transform: "scale(2.2)"
        ...
        <div class="auth-content">
          ...
          <div class="auth-text">
            ${this.t(
      "connectProviderHint",
      "Sign in to browse and select files from your {{provider}} account",
      { provider: this._providerLabel }
        ...
        <button class="connect-btn" @click=${this._handleConnect}>
          ...
          ${this.t("signInToProvider", "Sign in to {{provider}}", {
      provider: this._providerLabel
    })}
        </button>
      </div>
