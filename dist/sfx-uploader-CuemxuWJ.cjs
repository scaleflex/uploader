"use strict";const a=require("lit"),S=require("lit/decorators.js"),re=require("lit/directives/unsafe-svg.js"),de=require("lit/directives/unsafe-html.js");class wr{constructor(e){this.listeners=new Set,this._notifying=!1,this._pendingState=null,this.state=e}getState(){return this.state}setState(e){if(this._notifying){this._pendingState={...this._pendingState||{},...e};return}const t=this.state;this.state={...t,...e},this._notifying=!0;try{this.listeners.forEach(r=>r(this.state,t))}finally{this._notifying=!1}if(this._pendingState){const r=this._pendingState;this._pendingState=null,this.setState(r)}}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}destroy(){this.listeners.clear()}}function M(i,e,t){const r=i.getState().files,o=r.get(e);if(!o)return;const n=new Map(r);n.set(e,{...o,...t}),i.setState({files:n})}function he(i,e){const t=new Map(i.getState().files);t.set(e.id,e),i.setState({files:t})}function Nt(i,e){const t=i.getState().files;if(!t.has(e))return;const r=new Map(t);r.delete(e),i.setState({files:r})}function _r(){return new wr({files:new Map,queueConfig:{concurrency:3,autoProceed:!1,retryConfig:{maxRetries:0,baseDelay:1e3,maxDelay:3e4,backoffFactor:2}},isPaused:!1,restrictions:{maxFileSize:null,maxTotalFilesSize:null,maxNumberOfFiles:null,minNumberOfFiles:null,allowedFileTypes:null,blockedFileTypes:null},targetFolder:"/",totalProgress:0,totalSpeed:0,totalBytesUploaded:0,totalBytes:0,isUploading:!1})}class Jr{constructor(e,t){this.host=e,this.store=t,e.addController(this)}get state(){return this.store.getState()}setState(e){this.store.setState(e)}hostConnected(){this.unsubscribe=this.store.subscribe(()=>{this.host.requestUpdate()})}hostDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this)}}function Qr(i,e){const t=new XMLHttpRequest;let r=!1;const n=`${e.apiBase.replace(/\/+$/,"")}/v4/files?folder=${encodeURIComponent(e.folder)}`;t.open("POST",n);for(const[l,d]of Object.entries(e.authHeaders))t.setRequestHeader(l,d);t.upload.addEventListener("progress",l=>{l.lengthComputable&&!r&&e.onProgress(l.loaded,l.total)}),t.addEventListener("load",()=>{if(r)return;let l;try{l=JSON.parse(t.responseText)}catch{e.onError(new Error(`Invalid JSON response (HTTP ${t.status})`));return}t.status>=200&&t.status<300&&l.status==="success"?e.onComplete(l):e.onError(new Error(l.hint||l.msg||`Upload failed (HTTP ${t.status})`))}),t.addEventListener("error",()=>{r||e.onError(new Error("Network error — check your connection"))}),t.addEventListener("timeout",()=>{r||e.onError(new Error("Upload timed out"))});const s=new FormData;if(i.file){const l={name:i.name,type:i.type};s.append("info[files[]]",JSON.stringify(l)),Object.keys(i.meta).length>0&&s.append("meta[files[]]",JSON.stringify(i.meta)),i.tags.length>0&&s.append("tags[files[]]",JSON.stringify(i.tags)),s.append("files[]",i.file,i.name)}return t.timeout=6e4,t.send(s),{abort(){r=!0,t.abort()}}}function ei(i,e){const t=new XMLHttpRequest;let r=!1;const n=`${e.apiBase.replace(/\/+$/,"")}/v4/files/upload_url`;t.open("POST",n);for(const[l,d]of Object.entries(e.authHeaders))t.setRequestHeader(l,d);if(t.setRequestHeader("Content-Type","application/json"),t.addEventListener("load",()=>{if(r)return;let l;try{l=JSON.parse(t.responseText)}catch{e.onError(new Error(`Invalid JSON response (HTTP ${t.status})`));return}t.status>=200&&t.status<300&&l.status==="success"?e.onComplete(l):e.onError(new Error(l.hint||l.msg||`Upload failed (HTTP ${t.status})`))}),t.addEventListener("error",()=>{r||e.onError(new Error("Network error — check your connection"))}),t.addEventListener("timeout",()=>{r||e.onError(new Error("Upload timed out"))}),!i.remoteUrl)return e.onError(new Error("Remote URL is required for URL upload")),{abort(){}};const s={files_urls:[{url:i.remoteUrl,name:i.name}],dir:e.folder};return t.timeout=6e4,t.send(JSON.stringify(s)),{abort(){r=!0,t.abort()}}}function et(i){return{Accept:"application/json","Content-Type":"application/json","uppy-auth-token":i}}function Ce(i){return i.replace(/\/+$/,"")}const ti={"google-drive":"drive",dropbox:"dropbox",onedrive:"onedrive",box:"box",instagram:"instagram",facebook:"facebook",unsplash:"unsplash"};function Ie(i){return ti[i]??i}function ri(i,e){const t=Ce(i),r=btoa(JSON.stringify({origin:window.location.origin})),o=Ie(e);return`${t}/${o}/connect?state=${encodeURIComponent(r)}`}async function ii(i,e,t,r=""){const o=Ce(i),n=r?`/${r}`:"",s=Ie(e),l=await fetch(`${o}/${s}/list${n}`,{method:"GET",headers:et(t),credentials:"same-origin"});if(l.status===401)throw new tt;if(!l.ok){const d=await l.json().catch(()=>null);throw new Error((d==null?void 0:d.message)||`Companion list failed (HTTP ${l.status})`)}return l.json()}async function oi(i,e,t){const r=Ce(i),o=await fetch(`${r}/${t}`,{method:"GET",headers:et(e),credentials:"same-origin"});if(o.status===401)throw new tt;if(!o.ok){const n=await o.json().catch(()=>null);throw new Error((n==null?void 0:n.message)||`Companion list failed (HTTP ${o.status})`)}return o.json()}async function ni(i,e,t,r){const o=Ce(i),n=Ie(e),s=r?`q=${encodeURIComponent(t)}&${r}`:`q=${encodeURIComponent(t)}`,l=await fetch(`${o}/search/${n}/list?${s}`,{method:"GET",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin"});if(!l.ok){const d=await l.json().catch(()=>null);throw new Error((d==null?void 0:d.message)||`Search failed (HTTP ${l.status})`)}return l.json()}async function si(i,e,t,r,o,n=!1){const s=Ce(i),l=Ie(e),d=n?`${s}/search/${l}/get/${r}`:`${s}/${l}/get/${r}`,f=n?{Accept:"application/json","Content-Type":"application/json"}:et(t),h=await fetch(d,{method:"POST",headers:f,credentials:"same-origin",body:JSON.stringify({...o,httpMethod:o.httpMethod??"POST",useFormData:o.useFormData??!0,fieldname:o.fieldname??"files[]"})});if(h.status===401)throw new tt;if(!h.ok){const _=await h.json().catch(()=>null);throw new Error((_==null?void 0:_.message)||`Companion upload failed (HTTP ${h.status})`)}return h.json()}async function ai(i,e,t){const r=Ce(i),o=Ie(e),n=await fetch(`${r}/${o}/logout`,{method:"GET",headers:et(t),credentials:"same-origin"});return n.ok?n.json():{ok:!1,revoked:!1}}function li(i){var o;const t=((o=/^(?:https?:\/\/|\/\/)?(?:[^@\n]+@)?(?:www\.)?([^\n]+)/i.exec(i))==null?void 0:o[1])??i;return`${location.protocol==="https:"?"wss":"ws"}://${t}`}class tt extends Error{constructor(){super("Authentication expired"),this.name="AuthExpiredError"}}function di(i,e){const t=i.remoteInfo;if(!t)return e.onError(new Error("remoteInfo is required for companion upload")),{abort(){}};let r=!1,o=null;const s=`${e.apiBase.replace(/\/+$/,"")}/v4/files?folder=${encodeURIComponent(e.folder)}`,l={};i.meta&&Object.keys(i.meta).length>0&&Object.assign(l,i.meta),i.tags&&i.tags.length>0&&(l.tags=i.tags);const d=!t.token;return si(t.companionUrl,t.provider,t.token,t.requestPath,{fileId:t.fileId,endpoint:s,headers:e.authHeaders,size:t.size,metadata:Object.keys(l).length>0?l:void 0},d).then(f=>{if(r)return;const _=`${li(t.companionUrl)}/api/${f.token}`;try{o=new WebSocket(_)}catch{e.onError(new Error("Failed to connect to upload progress channel"));return}o.onmessage=E=>{var O,P,v;if(!r)try{const U=JSON.parse(E.data);switch(U.action){case"progress":{const R=U.payload,m=R.bytesUploaded??0,x=R.bytesTotal??(t.size||1);e.onProgress(m,x);break}case"success":{const R=U.payload;if(o==null||o.close(),(O=R.response)!=null&&O.responseText)try{const m=JSON.parse(R.response.responseText);if(m.status==="success"){e.onComplete(m);return}e.onError(new Error(m.msg||"Upload failed"));return}catch{}e.onError(new Error("Upload completed but no valid response received"));break}case"error":{o==null||o.close();const R=U.payload;let m=((P=R.error)==null?void 0:P.message)||"Upload failed";if((v=R.response)!=null&&v.responseText)try{const x=JSON.parse(R.response.responseText);m=x.hint||x.msg||x.message||m}catch{}e.onError(new Error(m));break}}}catch{}},o.onerror=()=>{r||e.onError(new Error("Upload progress connection failed"))},o.onclose=()=>{o=null}}).catch(f=>{r||e.onError(f instanceof Error?f:new Error(String(f)))}),{abort(){if(r=!0,o){try{o.send(JSON.stringify({action:"cancel",payload:{}}))}catch{}o.close(),o=null}}}}function lt(i){"@babel/helpers - typeof";return lt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},lt(i)}function ci(i,e,t){return Object.defineProperty(i,"prototype",{writable:!1}),i}function pi(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function fi(i,e,t){return e=Re(e),ui(i,_t()?Reflect.construct(e,t||[],Re(i).constructor):e.apply(i,t))}function ui(i,e){if(e&&(lt(e)==="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return hi(i)}function hi(i){if(i===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return i}function gi(i,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");i.prototype=Object.create(e&&e.prototype,{constructor:{value:i,writable:!0,configurable:!0}}),Object.defineProperty(i,"prototype",{writable:!1}),e&&Oe(i,e)}function dt(i){var e=typeof Map=="function"?new Map:void 0;return dt=function(r){if(r===null||!mi(r))return r;if(typeof r!="function")throw new TypeError("Super expression must either be null or a function");if(typeof e<"u"){if(e.has(r))return e.get(r);e.set(r,o)}function o(){return vi(r,arguments,Re(this).constructor)}return o.prototype=Object.create(r.prototype,{constructor:{value:o,enumerable:!1,writable:!0,configurable:!0}}),Oe(o,r)},dt(i)}function vi(i,e,t){if(_t())return Reflect.construct.apply(null,arguments);var r=[null];r.push.apply(r,e);var o=new(i.bind.apply(i,r));return t&&Oe(o,t.prototype),o}function _t(){try{var i=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(_t=function(){return!!i})()}function mi(i){try{return Function.toString.call(i).indexOf("[native code]")!==-1}catch{return typeof i=="function"}}function Oe(i,e){return Oe=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(r,o){return r.__proto__=o,r},Oe(i,e)}function Re(i){return Re=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},Re(i)}var Ee=(function(i){function e(t){var r,o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null,n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:null,s=arguments.length>3&&arguments[3]!==void 0?arguments[3]:null;if(pi(this,e),r=fi(this,e,[t]),r.originalRequest=n,r.originalResponse=s,r.causingError=o,o!=null&&(t+=", caused by ".concat(o.toString())),n!=null){var l=n.getHeader("X-Request-ID")||"n/a",d=n.getMethod(),f=n.getURL(),h=s?s.getStatus():"n/a",_=s?s.getBody()||"":"n/a";t+=", originated from request (method: ".concat(d,", url: ").concat(f,", response code: ").concat(h,", response text: ").concat(_,", request id: ").concat(l,")")}return r.message=t,r}return gi(e,i),ci(e)})(dt(Error));function Te(i){"@babel/helpers - typeof";return Te=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Te(i)}function xi(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function bi(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,wi(r.key),r)}}function yi(i,e,t){return e&&bi(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function wi(i){var e=_i(i,"string");return Te(e)=="symbol"?e:e+""}function _i(i,e){if(Te(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(Te(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}var ki=(function(){function i(){xi(this,i)}return yi(i,[{key:"listAllUploads",value:function(){return Promise.resolve([])}},{key:"findUploadsByFingerprint",value:function(t){return Promise.resolve([])}},{key:"removeUpload",value:function(t){return Promise.resolve()}},{key:"addUpload",value:function(t,r){return Promise.resolve(null)}}])})();const kr="3.7.8",Si=kr,$e=typeof Buffer=="function",Yt=typeof TextDecoder=="function"?new TextDecoder:void 0,Vt=typeof TextEncoder=="function"?new TextEncoder:void 0,Ci="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",Pe=Array.prototype.slice.call(Ci),Ne=(i=>{let e={};return i.forEach((t,r)=>e[t]=r),e})(Pe),$i=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,q=String.fromCharCode.bind(String),Gt=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):i=>new Uint8Array(Array.prototype.slice.call(i,0)),Sr=i=>i.replace(/=/g,"").replace(/[+\/]/g,e=>e=="+"?"-":"_"),Cr=i=>i.replace(/[^A-Za-z0-9\+\/]/g,""),$r=i=>{let e,t,r,o,n="";const s=i.length%3;for(let l=0;l<i.length;){if((t=i.charCodeAt(l++))>255||(r=i.charCodeAt(l++))>255||(o=i.charCodeAt(l++))>255)throw new TypeError("invalid character found");e=t<<16|r<<8|o,n+=Pe[e>>18&63]+Pe[e>>12&63]+Pe[e>>6&63]+Pe[e&63]}return s?n.slice(0,s-3)+"===".substring(s):n},kt=typeof btoa=="function"?i=>btoa(i):$e?i=>Buffer.from(i,"binary").toString("base64"):$r,ct=$e?i=>Buffer.from(i).toString("base64"):i=>{let t=[];for(let r=0,o=i.length;r<o;r+=4096)t.push(q.apply(null,i.subarray(r,r+4096)));return kt(t.join(""))},Ge=(i,e=!1)=>e?Sr(ct(i)):ct(i),Ui=i=>{if(i.length<2){var e=i.charCodeAt(0);return e<128?i:e<2048?q(192|e>>>6)+q(128|e&63):q(224|e>>>12&15)+q(128|e>>>6&63)+q(128|e&63)}else{var e=65536+(i.charCodeAt(0)-55296)*1024+(i.charCodeAt(1)-56320);return q(240|e>>>18&7)+q(128|e>>>12&63)+q(128|e>>>6&63)+q(128|e&63)}},Ei=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Ur=i=>i.replace(Ei,Ui),Wt=$e?i=>Buffer.from(i,"utf8").toString("base64"):Vt?i=>ct(Vt.encode(i)):i=>kt(Ur(i)),we=(i,e=!1)=>e?Sr(Wt(i)):Wt(i),Xt=i=>we(i,!0),Pi=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,zi=i=>{switch(i.length){case 4:var e=(7&i.charCodeAt(0))<<18|(63&i.charCodeAt(1))<<12|(63&i.charCodeAt(2))<<6|63&i.charCodeAt(3),t=e-65536;return q((t>>>10)+55296)+q((t&1023)+56320);case 3:return q((15&i.charCodeAt(0))<<12|(63&i.charCodeAt(1))<<6|63&i.charCodeAt(2));default:return q((31&i.charCodeAt(0))<<6|63&i.charCodeAt(1))}},Er=i=>i.replace(Pi,zi),Pr=i=>{if(i=i.replace(/\s+/g,""),!$i.test(i))throw new TypeError("malformed base64.");i+="==".slice(2-(i.length&3));let e,t,r,o=[];for(let n=0;n<i.length;)e=Ne[i.charAt(n++)]<<18|Ne[i.charAt(n++)]<<12|(t=Ne[i.charAt(n++)])<<6|(r=Ne[i.charAt(n++)]),t===64?o.push(q(e>>16&255)):r===64?o.push(q(e>>16&255,e>>8&255)):o.push(q(e>>16&255,e>>8&255,e&255));return o.join("")},St=typeof atob=="function"?i=>atob(Cr(i)):$e?i=>Buffer.from(i,"base64").toString("binary"):Pr,zr=$e?i=>Gt(Buffer.from(i,"base64")):i=>Gt(St(i).split("").map(e=>e.charCodeAt(0))),Or=i=>zr(Rr(i)),Oi=$e?i=>Buffer.from(i,"base64").toString("utf8"):Yt?i=>Yt.decode(zr(i)):i=>Er(St(i)),Rr=i=>Cr(i.replace(/[-_]/g,e=>e=="-"?"+":"/")),pt=i=>Oi(Rr(i)),Ri=i=>{if(typeof i!="string")return!1;const e=i.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(e)||!/[^\s0-9a-zA-Z\-_]/.test(e)},Tr=i=>({value:i,enumerable:!1,writable:!0,configurable:!0}),Dr=function(){const i=(e,t)=>Object.defineProperty(String.prototype,e,Tr(t));i("fromBase64",function(){return pt(this)}),i("toBase64",function(e){return we(this,e)}),i("toBase64URI",function(){return we(this,!0)}),i("toBase64URL",function(){return we(this,!0)}),i("toUint8Array",function(){return Or(this)})},jr=function(){const i=(e,t)=>Object.defineProperty(Uint8Array.prototype,e,Tr(t));i("toBase64",function(e){return Ge(this,e)}),i("toBase64URI",function(){return Ge(this,!0)}),i("toBase64URL",function(){return Ge(this,!0)})},Ti=()=>{Dr(),jr()},Di={version:kr,VERSION:Si,atob:St,atobPolyfill:Pr,btoa:kt,btoaPolyfill:$r,fromBase64:pt,toBase64:we,encode:we,encodeURI:Xt,encodeURL:Xt,utob:Ur,btou:Er,decode:pt,isValid:Ri,fromUint8Array:Ge,toUint8Array:Or,extendString:Dr,extendUint8Array:jr,extendBuiltins:Ti};var Kt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ji(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var ot,Zt;function Li(){return Zt||(Zt=1,ot=function(e,t){if(t=t.split(":")[0],e=+e,!e)return!1;switch(t){case"http":case"ws":return e!==80;case"https":case"wss":return e!==443;case"ftp":return e!==21;case"gopher":return e!==70;case"file":return!1}return e!==0}),ot}var Ye={},Jt;function Fi(){if(Jt)return Ye;Jt=1;var i=Object.prototype.hasOwnProperty,e;function t(s){try{return decodeURIComponent(s.replace(/\+/g," "))}catch{return null}}function r(s){try{return encodeURIComponent(s)}catch{return null}}function o(s){for(var l=/([^=?#&]+)=?([^&]*)/g,d={},f;f=l.exec(s);){var h=t(f[1]),_=t(f[2]);h===null||_===null||h in d||(d[h]=_)}return d}function n(s,l){l=l||"";var d=[],f,h;typeof l!="string"&&(l="?");for(h in s)if(i.call(s,h)){if(f=s[h],!f&&(f===null||f===e||isNaN(f))&&(f=""),h=r(h),f=r(f),h===null||f===null)continue;d.push(h+"="+f)}return d.length?l+d.join("&"):""}return Ye.stringify=n,Ye.parse=o,Ye}var nt,Qt;function Ai(){if(Qt)return nt;Qt=1;var i=Li(),e=Fi(),t=/^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/,r=/[\n\r\t]/g,o=/^[A-Za-z][A-Za-z0-9+-.]*:\/\//,n=/:\d+$/,s=/^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,l=/^[a-zA-Z]:/;function d(m){return(m||"").toString().replace(t,"")}var f=[["#","hash"],["?","query"],function(x,g){return E(g.protocol)?x.replace(/\\/g,"/"):x},["/","pathname"],["@","auth",1],[NaN,"host",void 0,1,1],[/:(\d*)$/,"port",void 0,1],[NaN,"hostname",void 0,1,1]],h={hash:1,query:1};function _(m){var x;typeof window<"u"?x=window:typeof Kt<"u"?x=Kt:typeof self<"u"?x=self:x={};var g=x.location||{};m=m||g;var b={},z=typeof m,C;if(m.protocol==="blob:")b=new v(unescape(m.pathname),{});else if(z==="string"){b=new v(m,{});for(C in h)delete b[C]}else if(z==="object"){for(C in m)C in h||(b[C]=m[C]);b.slashes===void 0&&(b.slashes=o.test(m.href))}return b}function E(m){return m==="file:"||m==="ftp:"||m==="http:"||m==="https:"||m==="ws:"||m==="wss:"}function O(m,x){m=d(m),m=m.replace(r,""),x=x||{};var g=s.exec(m),b=g[1]?g[1].toLowerCase():"",z=!!g[2],C=!!g[3],j=0,D;return z?C?(D=g[2]+g[3]+g[4],j=g[2].length+g[3].length):(D=g[2]+g[4],j=g[2].length):C?(D=g[3]+g[4],j=g[3].length):D=g[4],b==="file:"?j>=2&&(D=D.slice(2)):E(b)?D=g[4]:b?z&&(D=D.slice(2)):j>=2&&E(x.protocol)&&(D=g[4]),{protocol:b,slashes:z||E(b),slashesCount:j,rest:D}}function P(m,x){if(m==="")return x;for(var g=(x||"/").split("/").slice(0,-1).concat(m.split("/")),b=g.length,z=g[b-1],C=!1,j=0;b--;)g[b]==="."?g.splice(b,1):g[b]===".."?(g.splice(b,1),j++):j&&(b===0&&(C=!0),g.splice(b,1),j--);return C&&g.unshift(""),(z==="."||z==="..")&&g.push(""),g.join("/")}function v(m,x,g){if(m=d(m),m=m.replace(r,""),!(this instanceof v))return new v(m,x,g);var b,z,C,j,D,V,Q=f.slice(),ue=typeof x,$=this,K=0;for(ue!=="object"&&ue!=="string"&&(g=x,x=null),g&&typeof g!="function"&&(g=e.parse),x=_(x),z=O(m||"",x),b=!z.protocol&&!z.slashes,$.slashes=z.slashes||b&&x.slashes,$.protocol=z.protocol||x.protocol||"",m=z.rest,(z.protocol==="file:"&&(z.slashesCount!==2||l.test(m))||!z.slashes&&(z.protocol||z.slashesCount<2||!E($.protocol)))&&(Q[3]=[/(.*)/,"pathname"]);K<Q.length;K++){if(j=Q[K],typeof j=="function"){m=j(m,$);continue}C=j[0],V=j[1],C!==C?$[V]=m:typeof C=="string"?(D=C==="@"?m.lastIndexOf(C):m.indexOf(C),~D&&(typeof j[2]=="number"?($[V]=m.slice(0,D),m=m.slice(D+j[2])):($[V]=m.slice(D),m=m.slice(0,D)))):(D=C.exec(m))&&($[V]=D[1],m=m.slice(0,D.index)),$[V]=$[V]||b&&j[3]&&x[V]||"",j[4]&&($[V]=$[V].toLowerCase())}g&&($.query=g($.query)),b&&x.slashes&&$.pathname.charAt(0)!=="/"&&($.pathname!==""||x.pathname!=="")&&($.pathname=P($.pathname,x.pathname)),$.pathname.charAt(0)!=="/"&&E($.protocol)&&($.pathname="/"+$.pathname),i($.port,$.protocol)||($.host=$.hostname,$.port=""),$.username=$.password="",$.auth&&(D=$.auth.indexOf(":"),~D?($.username=$.auth.slice(0,D),$.username=encodeURIComponent(decodeURIComponent($.username)),$.password=$.auth.slice(D+1),$.password=encodeURIComponent(decodeURIComponent($.password))):$.username=encodeURIComponent(decodeURIComponent($.auth)),$.auth=$.password?$.username+":"+$.password:$.username),$.origin=$.protocol!=="file:"&&E($.protocol)&&$.host?$.protocol+"//"+$.host:"null",$.href=$.toString()}function U(m,x,g){var b=this;switch(m){case"query":typeof x=="string"&&x.length&&(x=(g||e.parse)(x)),b[m]=x;break;case"port":b[m]=x,i(x,b.protocol)?x&&(b.host=b.hostname+":"+x):(b.host=b.hostname,b[m]="");break;case"hostname":b[m]=x,b.port&&(x+=":"+b.port),b.host=x;break;case"host":b[m]=x,n.test(x)?(x=x.split(":"),b.port=x.pop(),b.hostname=x.join(":")):(b.hostname=x,b.port="");break;case"protocol":b.protocol=x.toLowerCase(),b.slashes=!g;break;case"pathname":case"hash":if(x){var z=m==="pathname"?"/":"#";b[m]=x.charAt(0)!==z?z+x:x}else b[m]=x;break;case"username":case"password":b[m]=encodeURIComponent(x);break;case"auth":var C=x.indexOf(":");~C?(b.username=x.slice(0,C),b.username=encodeURIComponent(decodeURIComponent(b.username)),b.password=x.slice(C+1),b.password=encodeURIComponent(decodeURIComponent(b.password))):b.username=encodeURIComponent(decodeURIComponent(x))}for(var j=0;j<f.length;j++){var D=f[j];D[4]&&(b[D[1]]=b[D[1]].toLowerCase())}return b.auth=b.password?b.username+":"+b.password:b.username,b.origin=b.protocol!=="file:"&&E(b.protocol)&&b.host?b.protocol+"//"+b.host:"null",b.href=b.toString(),b}function R(m){(!m||typeof m!="function")&&(m=e.stringify);var x,g=this,b=g.host,z=g.protocol;z&&z.charAt(z.length-1)!==":"&&(z+=":");var C=z+(g.protocol&&g.slashes||E(g.protocol)?"//":"");return g.username?(C+=g.username,g.password&&(C+=":"+g.password),C+="@"):g.password?(C+=":"+g.password,C+="@"):g.protocol!=="file:"&&E(g.protocol)&&!b&&g.pathname!=="/"&&(C+="@"),(b[b.length-1]===":"||n.test(g.hostname)&&!g.port)&&(b+=":"),C+=b+g.pathname,x=typeof g.query=="object"?m(g.query):g.query,x&&(C+=x.charAt(0)!=="?"?"?"+x:x),g.hash&&(C+=g.hash),C}return v.prototype={set:U,toString:R},v.extractProtocol=O,v.location=_,v.trimLeft=d,v.qs=e,nt=v,nt}var Ii=Ai();const Bi=ji(Ii);function Mi(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(i){var e=Math.random()*16|0,t=i==="x"?e:e&3|8;return t.toString(16)})}function ft(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ft=function(){return e};var i,e={},t=Object.prototype,r=t.hasOwnProperty,o=Object.defineProperty||function(u,c,p){u[c]=p.value},n=typeof Symbol=="function"?Symbol:{},s=n.iterator||"@@iterator",l=n.asyncIterator||"@@asyncIterator",d=n.toStringTag||"@@toStringTag";function f(u,c,p){return Object.defineProperty(u,c,{value:p,enumerable:!0,configurable:!0,writable:!0}),u[c]}try{f({},"")}catch{f=function(p,y,k){return p[y]=k}}function h(u,c,p,y){var k=c&&c.prototype instanceof R?c:R,w=Object.create(k.prototype),T=new K(y||[]);return o(w,"_invoke",{value:V(u,p,T)}),w}function _(u,c,p){try{return{type:"normal",arg:u.call(c,p)}}catch(y){return{type:"throw",arg:y}}}e.wrap=h;var E="suspendedStart",O="suspendedYield",P="executing",v="completed",U={};function R(){}function m(){}function x(){}var g={};f(g,s,function(){return this});var b=Object.getPrototypeOf,z=b&&b(b(le([])));z&&z!==t&&r.call(z,s)&&(g=z);var C=x.prototype=R.prototype=Object.create(g);function j(u){["next","throw","return"].forEach(function(c){f(u,c,function(p){return this._invoke(c,p)})})}function D(u,c){function p(k,w,T,L){var F=_(u[k],u,w);if(F.type!=="throw"){var N=F.arg,H=N.value;return H&&ce(H)=="object"&&r.call(H,"__await")?c.resolve(H.__await).then(function(Y){p("next",Y,T,L)},function(Y){p("throw",Y,T,L)}):c.resolve(H).then(function(Y){N.value=Y,T(N)},function(Y){return p("throw",Y,T,L)})}L(F.arg)}var y;o(this,"_invoke",{value:function(w,T){function L(){return new c(function(F,N){p(w,T,F,N)})}return y=y?y.then(L,L):L()}})}function V(u,c,p){var y=E;return function(k,w){if(y===P)throw Error("Generator is already running");if(y===v){if(k==="throw")throw w;return{value:i,done:!0}}for(p.method=k,p.arg=w;;){var T=p.delegate;if(T){var L=Q(T,p);if(L){if(L===U)continue;return L}}if(p.method==="next")p.sent=p._sent=p.arg;else if(p.method==="throw"){if(y===E)throw y=v,p.arg;p.dispatchException(p.arg)}else p.method==="return"&&p.abrupt("return",p.arg);y=P;var F=_(u,c,p);if(F.type==="normal"){if(y=p.done?v:O,F.arg===U)continue;return{value:F.arg,done:p.done}}F.type==="throw"&&(y=v,p.method="throw",p.arg=F.arg)}}}function Q(u,c){var p=c.method,y=u.iterator[p];if(y===i)return c.delegate=null,p==="throw"&&u.iterator.return&&(c.method="return",c.arg=i,Q(u,c),c.method==="throw")||p!=="return"&&(c.method="throw",c.arg=new TypeError("The iterator does not provide a '"+p+"' method")),U;var k=_(y,u.iterator,c.arg);if(k.type==="throw")return c.method="throw",c.arg=k.arg,c.delegate=null,U;var w=k.arg;return w?w.done?(c[u.resultName]=w.value,c.next=u.nextLoc,c.method!=="return"&&(c.method="next",c.arg=i),c.delegate=null,U):w:(c.method="throw",c.arg=new TypeError("iterator result is not an object"),c.delegate=null,U)}function ue(u){var c={tryLoc:u[0]};1 in u&&(c.catchLoc=u[1]),2 in u&&(c.finallyLoc=u[2],c.afterLoc=u[3]),this.tryEntries.push(c)}function $(u){var c=u.completion||{};c.type="normal",delete c.arg,u.completion=c}function K(u){this.tryEntries=[{tryLoc:"root"}],u.forEach(ue,this),this.reset(!0)}function le(u){if(u||u===""){var c=u[s];if(c)return c.call(u);if(typeof u.next=="function")return u;if(!isNaN(u.length)){var p=-1,y=function k(){for(;++p<u.length;)if(r.call(u,p))return k.value=u[p],k.done=!1,k;return k.value=i,k.done=!0,k};return y.next=y}}throw new TypeError(ce(u)+" is not iterable")}return m.prototype=x,o(C,"constructor",{value:x,configurable:!0}),o(x,"constructor",{value:m,configurable:!0}),m.displayName=f(x,d,"GeneratorFunction"),e.isGeneratorFunction=function(u){var c=typeof u=="function"&&u.constructor;return!!c&&(c===m||(c.displayName||c.name)==="GeneratorFunction")},e.mark=function(u){return Object.setPrototypeOf?Object.setPrototypeOf(u,x):(u.__proto__=x,f(u,d,"GeneratorFunction")),u.prototype=Object.create(C),u},e.awrap=function(u){return{__await:u}},j(D.prototype),f(D.prototype,l,function(){return this}),e.AsyncIterator=D,e.async=function(u,c,p,y,k){k===void 0&&(k=Promise);var w=new D(h(u,c,p,y),k);return e.isGeneratorFunction(c)?w:w.next().then(function(T){return T.done?T.value:w.next()})},j(C),f(C,d,"Generator"),f(C,s,function(){return this}),f(C,"toString",function(){return"[object Generator]"}),e.keys=function(u){var c=Object(u),p=[];for(var y in c)p.push(y);return p.reverse(),function k(){for(;p.length;){var w=p.pop();if(w in c)return k.value=w,k.done=!1,k}return k.done=!0,k}},e.values=le,K.prototype={constructor:K,reset:function(c){if(this.prev=0,this.next=0,this.sent=this._sent=i,this.done=!1,this.delegate=null,this.method="next",this.arg=i,this.tryEntries.forEach($),!c)for(var p in this)p.charAt(0)==="t"&&r.call(this,p)&&!isNaN(+p.slice(1))&&(this[p]=i)},stop:function(){this.done=!0;var c=this.tryEntries[0].completion;if(c.type==="throw")throw c.arg;return this.rval},dispatchException:function(c){if(this.done)throw c;var p=this;function y(N,H){return T.type="throw",T.arg=c,p.next=N,H&&(p.method="next",p.arg=i),!!H}for(var k=this.tryEntries.length-1;k>=0;--k){var w=this.tryEntries[k],T=w.completion;if(w.tryLoc==="root")return y("end");if(w.tryLoc<=this.prev){var L=r.call(w,"catchLoc"),F=r.call(w,"finallyLoc");if(L&&F){if(this.prev<w.catchLoc)return y(w.catchLoc,!0);if(this.prev<w.finallyLoc)return y(w.finallyLoc)}else if(L){if(this.prev<w.catchLoc)return y(w.catchLoc,!0)}else{if(!F)throw Error("try statement without catch or finally");if(this.prev<w.finallyLoc)return y(w.finallyLoc)}}}},abrupt:function(c,p){for(var y=this.tryEntries.length-1;y>=0;--y){var k=this.tryEntries[y];if(k.tryLoc<=this.prev&&r.call(k,"finallyLoc")&&this.prev<k.finallyLoc){var w=k;break}}w&&(c==="break"||c==="continue")&&w.tryLoc<=p&&p<=w.finallyLoc&&(w=null);var T=w?w.completion:{};return T.type=c,T.arg=p,w?(this.method="next",this.next=w.finallyLoc,U):this.complete(T)},complete:function(c,p){if(c.type==="throw")throw c.arg;return c.type==="break"||c.type==="continue"?this.next=c.arg:c.type==="return"?(this.rval=this.arg=c.arg,this.method="return",this.next="end"):c.type==="normal"&&p&&(this.next=p),U},finish:function(c){for(var p=this.tryEntries.length-1;p>=0;--p){var y=this.tryEntries[p];if(y.finallyLoc===c)return this.complete(y.completion,y.afterLoc),$(y),U}},catch:function(c){for(var p=this.tryEntries.length-1;p>=0;--p){var y=this.tryEntries[p];if(y.tryLoc===c){var k=y.completion;if(k.type==="throw"){var w=k.arg;$(y)}return w}}throw Error("illegal catch attempt")},delegateYield:function(c,p,y){return this.delegate={iterator:le(c),resultName:p,nextLoc:y},this.method==="next"&&(this.arg=i),U}},e}function er(i,e,t,r,o,n,s){try{var l=i[n](s),d=l.value}catch(f){t(f);return}l.done?e(d):Promise.resolve(d).then(r,o)}function Hi(i){return function(){var e=this,t=arguments;return new Promise(function(r,o){var n=i.apply(e,t);function s(d){er(n,r,o,s,l,"next",d)}function l(d){er(n,r,o,s,l,"throw",d)}s(void 0)})}}function Lr(i,e){return Yi(i)||Ni(i,e)||Fr(i,e)||qi()}function qi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Ni(i,e){var t=i==null?null:typeof Symbol<"u"&&i[Symbol.iterator]||i["@@iterator"];if(t!=null){var r,o,n,s,l=[],d=!0,f=!1;try{if(n=(t=t.call(i)).next,e!==0)for(;!(d=(r=n.call(t)).done)&&(l.push(r.value),l.length!==e);d=!0);}catch(h){f=!0,o=h}finally{try{if(!d&&t.return!=null&&(s=t.return(),Object(s)!==s))return}finally{if(f)throw o}}return l}}function Yi(i){if(Array.isArray(i))return i}function ce(i){"@babel/helpers - typeof";return ce=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},ce(i)}function Vi(i,e){var t=typeof Symbol<"u"&&i[Symbol.iterator]||i["@@iterator"];if(!t){if(Array.isArray(i)||(t=Fr(i))||e){t&&(i=t);var r=0,o=function(){};return{s:o,n:function(){return r>=i.length?{done:!0}:{done:!1,value:i[r++]}},e:function(f){throw f},f:o}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var n=!0,s=!1,l;return{s:function(){t=t.call(i)},n:function(){var f=t.next();return n=f.done,f},e:function(f){s=!0,l=f},f:function(){try{!n&&t.return!=null&&t.return()}finally{if(s)throw l}}}}function Fr(i,e){if(i){if(typeof i=="string")return tr(i,e);var t=Object.prototype.toString.call(i).slice(8,-1);if(t==="Object"&&i.constructor&&(t=i.constructor.name),t==="Map"||t==="Set")return Array.from(i);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return tr(i,e)}}function tr(i,e){(e==null||e>i.length)&&(e=i.length);for(var t=0,r=new Array(e);t<e;t++)r[t]=i[t];return r}function rr(i,e){var t=Object.keys(i);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(i);e&&(r=r.filter(function(o){return Object.getOwnPropertyDescriptor(i,o).enumerable})),t.push.apply(t,r)}return t}function ge(i){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?rr(Object(t),!0).forEach(function(r){Gi(i,r,t[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(t)):rr(Object(t)).forEach(function(r){Object.defineProperty(i,r,Object.getOwnPropertyDescriptor(t,r))})}return i}function Gi(i,e,t){return e=Ar(e),e in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}function Wi(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function ir(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,Ar(r.key),r)}}function Xi(i,e,t){return e&&ir(i.prototype,e),t&&ir(i,t),Object.defineProperty(i,"prototype",{writable:!1}),i}function Ar(i){var e=Ki(i,"string");return ce(e)=="symbol"?e:e+""}function Ki(i,e){if(ce(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(ce(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}var We="tus-v1",Xe="ietf-draft-03",ze="ietf-draft-05",Zi={endpoint:null,uploadUrl:null,metadata:{},metadataForPartialUploads:{},fingerprint:null,uploadSize:null,onProgress:null,onChunkComplete:null,onSuccess:null,onError:null,onUploadUrlAvailable:null,overridePatchMethod:!1,headers:{},addRequestId:!1,onBeforeRequest:null,onAfterResponse:null,onShouldRetry:Ir,chunkSize:Number.POSITIVE_INFINITY,retryDelays:[0,1e3,3e3,5e3],parallelUploads:1,parallelUploadBoundaries:null,storeFingerprintForResuming:!0,removeFingerprintOnSuccess:!1,uploadLengthDeferred:!1,uploadDataDuringCreation:!1,urlStorage:null,fileReader:null,httpStack:null,protocol:We},Ke=(function(){function i(e,t){Wi(this,i),"resume"in t&&console.log("tus: The `resume` option has been removed in tus-js-client v2. Please use the URL storage API instead."),this.options=t,this.options.chunkSize=Number(this.options.chunkSize),this._urlStorage=this.options.urlStorage,this.file=e,this.url=null,this._req=null,this._fingerprint=null,this._urlStorageKey=null,this._offset=null,this._aborted=!1,this._size=null,this._source=null,this._retryAttempt=0,this._retryTimeout=null,this._offsetBeforeRetry=0,this._parallelUploads=null,this._parallelUploadUrls=null}return Xi(i,[{key:"findPreviousUploads",value:function(){var t=this;return this.options.fingerprint(this.file,this.options).then(function(r){return t._urlStorage.findUploadsByFingerprint(r)})}},{key:"resumeFromPreviousUpload",value:function(t){this.url=t.uploadUrl||null,this._parallelUploadUrls=t.parallelUploadUrls||null,this._urlStorageKey=t.urlStorageKey}},{key:"start",value:function(){var t=this,r=this.file;if(!r){this._emitError(new Error("tus: no file or stream to upload provided"));return}if(![We,Xe,ze].includes(this.options.protocol)){this._emitError(new Error("tus: unsupported protocol ".concat(this.options.protocol)));return}if(!this.options.endpoint&&!this.options.uploadUrl&&!this.url){this._emitError(new Error("tus: neither an endpoint or an upload URL is provided"));return}var o=this.options.retryDelays;if(o!=null&&Object.prototype.toString.call(o)!=="[object Array]"){this._emitError(new Error("tus: the `retryDelays` option must either be an array or null"));return}if(this.options.parallelUploads>1)for(var n=0,s=["uploadUrl","uploadSize","uploadLengthDeferred"];n<s.length;n++){var l=s[n];if(this.options[l]){this._emitError(new Error("tus: cannot use the ".concat(l," option when parallelUploads is enabled")));return}}if(this.options.parallelUploadBoundaries){if(this.options.parallelUploads<=1){this._emitError(new Error("tus: cannot use the `parallelUploadBoundaries` option when `parallelUploads` is disabled"));return}if(this.options.parallelUploads!==this.options.parallelUploadBoundaries.length){this._emitError(new Error("tus: the `parallelUploadBoundaries` must have the same length as the value of `parallelUploads`"));return}}this.options.fingerprint(r,this.options).then(function(d){return t._fingerprint=d,t._source?t._source:t.options.fileReader.openFile(r,t.options.chunkSize)}).then(function(d){if(t._source=d,t.options.uploadLengthDeferred)t._size=null;else if(t.options.uploadSize!=null){if(t._size=Number(t.options.uploadSize),Number.isNaN(t._size)){t._emitError(new Error("tus: cannot convert `uploadSize` option into a number"));return}}else if(t._size=t._source.size,t._size==null){t._emitError(new Error("tus: cannot automatically derive upload's size from input. Specify it manually using the `uploadSize` option or use the `uploadLengthDeferred` option"));return}t.options.parallelUploads>1||t._parallelUploadUrls!=null?t._startParallelUpload():t._startSingleUpload()}).catch(function(d){t._emitError(d)})}},{key:"_startParallelUpload",value:function(){var t,r=this,o=this._size,n=0;this._parallelUploads=[];var s=this._parallelUploadUrls!=null?this._parallelUploadUrls.length:this.options.parallelUploads,l=(t=this.options.parallelUploadBoundaries)!==null&&t!==void 0?t:Qi(this._source.size,s);this._parallelUploadUrls&&l.forEach(function(h,_){h.uploadUrl=r._parallelUploadUrls[_]||null}),this._parallelUploadUrls=new Array(l.length);var d=l.map(function(h,_){var E=0;return r._source.slice(h.start,h.end).then(function(O){var P=O.value;return new Promise(function(v,U){var R=ge(ge({},r.options),{},{uploadUrl:h.uploadUrl||null,storeFingerprintForResuming:!1,removeFingerprintOnSuccess:!1,parallelUploads:1,parallelUploadBoundaries:null,metadata:r.options.metadataForPartialUploads,headers:ge(ge({},r.options.headers),{},{"Upload-Concat":"partial"}),onSuccess:v,onError:U,onProgress:function(g){n=n-E+g,E=g,r._emitProgress(n,o)},onUploadUrlAvailable:function(){r._parallelUploadUrls[_]=m.url,r._parallelUploadUrls.filter(function(g){return!!g}).length===l.length&&r._saveUploadInUrlStorage()}}),m=new i(P,R);m.start(),r._parallelUploads.push(m)})})}),f;Promise.all(d).then(function(){f=r._openRequest("POST",r.options.endpoint),f.setHeader("Upload-Concat","final;".concat(r._parallelUploadUrls.join(" ")));var h=or(r.options.metadata);return h!==""&&f.setHeader("Upload-Metadata",h),r._sendRequest(f,null)}).then(function(h){if(!xe(h.getStatus(),200)){r._emitHttpError(f,h,"tus: unexpected response while creating upload");return}var _=h.getHeader("Location");if(_==null){r._emitHttpError(f,h,"tus: invalid or missing Location header");return}r.url=lr(r.options.endpoint,_),"Created upload at ".concat(r.url),r._emitSuccess(h)}).catch(function(h){r._emitError(h)})}},{key:"_startSingleUpload",value:function(){if(this._aborted=!1,this.url!=null){"Resuming upload from previous URL: ".concat(this.url),this._resumeUpload();return}if(this.options.uploadUrl!=null){"Resuming upload from provided URL: ".concat(this.options.uploadUrl),this.url=this.options.uploadUrl,this._resumeUpload();return}this._createUpload()}},{key:"abort",value:function(t){var r=this;if(this._parallelUploads!=null){var o=Vi(this._parallelUploads),n;try{for(o.s();!(n=o.n()).done;){var s=n.value;s.abort(t)}}catch(l){o.e(l)}finally{o.f()}}return this._req!==null&&this._req.abort(),this._aborted=!0,this._retryTimeout!=null&&(clearTimeout(this._retryTimeout),this._retryTimeout=null),!t||this.url==null?Promise.resolve():i.terminate(this.url,this.options).then(function(){return r._removeFromUrlStorage()})}},{key:"_emitHttpError",value:function(t,r,o,n){this._emitError(new Ee(o,n,t,r))}},{key:"_emitError",value:function(t){var r=this;if(!this._aborted){if(this.options.retryDelays!=null){var o=this._offset!=null&&this._offset>this._offsetBeforeRetry;if(o&&(this._retryAttempt=0),ar(t,this._retryAttempt,this.options)){var n=this.options.retryDelays[this._retryAttempt++];this._offsetBeforeRetry=this._offset,this._retryTimeout=setTimeout(function(){r.start()},n);return}}if(typeof this.options.onError=="function")this.options.onError(t);else throw t}}},{key:"_emitSuccess",value:function(t){this.options.removeFingerprintOnSuccess&&this._removeFromUrlStorage(),typeof this.options.onSuccess=="function"&&this.options.onSuccess({lastResponse:t})}},{key:"_emitProgress",value:function(t,r){typeof this.options.onProgress=="function"&&this.options.onProgress(t,r)}},{key:"_emitChunkComplete",value:function(t,r,o){typeof this.options.onChunkComplete=="function"&&this.options.onChunkComplete(t,r,o)}},{key:"_createUpload",value:function(){var t=this;if(!this.options.endpoint){this._emitError(new Error("tus: unable to create upload because no endpoint is provided"));return}var r=this._openRequest("POST",this.options.endpoint);this.options.uploadLengthDeferred?r.setHeader("Upload-Defer-Length","1"):r.setHeader("Upload-Length","".concat(this._size));var o=or(this.options.metadata);o!==""&&r.setHeader("Upload-Metadata",o);var n;this.options.uploadDataDuringCreation&&!this.options.uploadLengthDeferred?(this._offset=0,n=this._addChunkToRequest(r)):((this.options.protocol===Xe||this.options.protocol===ze)&&r.setHeader("Upload-Complete","?0"),n=this._sendRequest(r,null)),n.then(function(s){if(!xe(s.getStatus(),200)){t._emitHttpError(r,s,"tus: unexpected response while creating upload");return}var l=s.getHeader("Location");if(l==null){t._emitHttpError(r,s,"tus: invalid or missing Location header");return}if(t.url=lr(t.options.endpoint,l),"Created upload at ".concat(t.url),typeof t.options.onUploadUrlAvailable=="function"&&t.options.onUploadUrlAvailable(),t._size===0){t._emitSuccess(s),t._source.close();return}t._saveUploadInUrlStorage().then(function(){t.options.uploadDataDuringCreation?t._handleUploadResponse(r,s):(t._offset=0,t._performUpload())})}).catch(function(s){t._emitHttpError(r,null,"tus: failed to create upload",s)})}},{key:"_resumeUpload",value:function(){var t=this,r=this._openRequest("HEAD",this.url),o=this._sendRequest(r,null);o.then(function(n){var s=n.getStatus();if(!xe(s,200)){if(s===423){t._emitHttpError(r,n,"tus: upload is currently locked; retry later");return}if(xe(s,400)&&t._removeFromUrlStorage(),!t.options.endpoint){t._emitHttpError(r,n,"tus: unable to resume upload (new upload cannot be created without an endpoint)");return}t.url=null,t._createUpload();return}var l=Number.parseInt(n.getHeader("Upload-Offset"),10);if(Number.isNaN(l)){t._emitHttpError(r,n,"tus: invalid or missing offset value");return}var d=Number.parseInt(n.getHeader("Upload-Length"),10);if(Number.isNaN(d)&&!t.options.uploadLengthDeferred&&t.options.protocol===We){t._emitHttpError(r,n,"tus: invalid or missing length value");return}typeof t.options.onUploadUrlAvailable=="function"&&t.options.onUploadUrlAvailable(),t._saveUploadInUrlStorage().then(function(){if(l===d){t._emitProgress(d,d),t._emitSuccess(n);return}t._offset=l,t._performUpload()})}).catch(function(n){t._emitHttpError(r,null,"tus: failed to resume upload",n)})}},{key:"_performUpload",value:function(){var t=this;if(!this._aborted){var r;this.options.overridePatchMethod?(r=this._openRequest("POST",this.url),r.setHeader("X-HTTP-Method-Override","PATCH")):r=this._openRequest("PATCH",this.url),r.setHeader("Upload-Offset","".concat(this._offset));var o=this._addChunkToRequest(r);o.then(function(n){if(!xe(n.getStatus(),200)){t._emitHttpError(r,n,"tus: unexpected response while uploading chunk");return}t._handleUploadResponse(r,n)}).catch(function(n){t._aborted||t._emitHttpError(r,null,"tus: failed to upload chunk at offset ".concat(t._offset),n)})}}},{key:"_addChunkToRequest",value:function(t){var r=this,o=this._offset,n=this._offset+this.options.chunkSize;return t.setProgressHandler(function(s){r._emitProgress(o+s,r._size)}),this.options.protocol===We?t.setHeader("Content-Type","application/offset+octet-stream"):this.options.protocol===ze&&t.setHeader("Content-Type","application/partial-upload"),(n===Number.POSITIVE_INFINITY||n>this._size)&&!this.options.uploadLengthDeferred&&(n=this._size),this._source.slice(o,n).then(function(s){var l=s.value,d=s.done,f=l!=null&&l.size?l.size:0;r.options.uploadLengthDeferred&&d&&(r._size=r._offset+f,t.setHeader("Upload-Length","".concat(r._size)));var h=r._offset+f;return!r.options.uploadLengthDeferred&&d&&h!==r._size?Promise.reject(new Error("upload was configured with a size of ".concat(r._size," bytes, but the source is done after ").concat(h," bytes"))):l===null?r._sendRequest(t):((r.options.protocol===Xe||r.options.protocol===ze)&&t.setHeader("Upload-Complete",d?"?1":"?0"),r._emitProgress(r._offset,r._size),r._sendRequest(t,l))})}},{key:"_handleUploadResponse",value:function(t,r){var o=Number.parseInt(r.getHeader("Upload-Offset"),10);if(Number.isNaN(o)){this._emitHttpError(t,r,"tus: invalid or missing offset value");return}if(this._emitProgress(o,this._size),this._emitChunkComplete(o-this._offset,o,this._size),this._offset=o,o===this._size){this._emitSuccess(r),this._source.close();return}this._performUpload()}},{key:"_openRequest",value:function(t,r){var o=nr(t,r,this.options);return this._req=o,o}},{key:"_removeFromUrlStorage",value:function(){var t=this;this._urlStorageKey&&(this._urlStorage.removeUpload(this._urlStorageKey).catch(function(r){t._emitError(r)}),this._urlStorageKey=null)}},{key:"_saveUploadInUrlStorage",value:function(){var t=this;if(!this.options.storeFingerprintForResuming||!this._fingerprint||this._urlStorageKey!==null)return Promise.resolve();var r={size:this._size,metadata:this.options.metadata,creationTime:new Date().toString()};return this._parallelUploads?r.parallelUploadUrls=this._parallelUploadUrls:r.uploadUrl=this.url,this._urlStorage.addUpload(this._fingerprint,r).then(function(o){t._urlStorageKey=o})}},{key:"_sendRequest",value:function(t){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null;return sr(t,r,this.options)}}],[{key:"terminate",value:function(t){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},o=nr("DELETE",t,r);return sr(o,null,r).then(function(n){if(n.getStatus()!==204)throw new Ee("tus: unexpected response while terminating upload",null,o,n)}).catch(function(n){if(n instanceof Ee||(n=new Ee("tus: failed to terminate upload",n,o,null)),!ar(n,0,r))throw n;var s=r.retryDelays[0],l=r.retryDelays.slice(1),d=ge(ge({},r),{},{retryDelays:l});return new Promise(function(f){return setTimeout(f,s)}).then(function(){return i.terminate(t,d)})})}}])})();function or(i){return Object.entries(i).map(function(e){var t=Lr(e,2),r=t[0],o=t[1];return"".concat(r," ").concat(Di.encode(String(o)))}).join(",")}function xe(i,e){return i>=e&&i<e+100}function nr(i,e,t){var r=t.httpStack.createRequest(i,e);t.protocol===Xe?r.setHeader("Upload-Draft-Interop-Version","5"):t.protocol===ze?r.setHeader("Upload-Draft-Interop-Version","6"):r.setHeader("Tus-Resumable","1.0.0");for(var o=t.headers||{},n=0,s=Object.entries(o);n<s.length;n++){var l=Lr(s[n],2),d=l[0],f=l[1];r.setHeader(d,f)}if(t.addRequestId){var h=Mi();r.setHeader("X-Request-ID",h)}return r}function sr(i,e,t){return ut.apply(this,arguments)}function ut(){return ut=Hi(ft().mark(function i(e,t,r){var o;return ft().wrap(function(s){for(;;)switch(s.prev=s.next){case 0:if(typeof r.onBeforeRequest!="function"){s.next=3;break}return s.next=3,r.onBeforeRequest(e);case 3:return s.next=5,e.send(t);case 5:if(o=s.sent,typeof r.onAfterResponse!="function"){s.next=9;break}return s.next=9,r.onAfterResponse(e,o);case 9:return s.abrupt("return",o);case 10:case"end":return s.stop()}},i)})),ut.apply(this,arguments)}function Ji(){var i=!0;return typeof navigator<"u"&&navigator.onLine===!1&&(i=!1),i}function ar(i,e,t){return t.retryDelays==null||e>=t.retryDelays.length||i.originalRequest==null?!1:t&&typeof t.onShouldRetry=="function"?t.onShouldRetry(i,e,t):Ir(i)}function Ir(i){var e=i.originalResponse?i.originalResponse.getStatus():0;return(!xe(e,400)||e===409||e===423)&&Ji()}function lr(i,e){return new Bi(e,i).toString()}function Qi(i,e){for(var t=Math.floor(i/e),r=[],o=0;o<e;o++)r.push({start:t*o,end:t*(o+1)});return r[e-1].end=i,r}Ke.defaultOptions=Zi;var Br=function(){return typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative"};function eo(i){return new Promise(function(e,t){var r=new XMLHttpRequest;r.responseType="blob",r.onload=function(){var o=r.response;e(o)},r.onerror=function(o){t(o)},r.open("GET",i),r.send()})}var to=function(){return typeof window<"u"&&(typeof window.PhoneGap<"u"||typeof window.Cordova<"u"||typeof window.cordova<"u")};function ro(i){return new Promise(function(e,t){var r=new FileReader;r.onload=function(){var o=new Uint8Array(r.result);e({value:o})},r.onerror=function(o){t(o)},r.readAsArrayBuffer(i)})}function De(i){"@babel/helpers - typeof";return De=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},De(i)}function io(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function oo(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,so(r.key),r)}}function no(i,e,t){return e&&oo(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function so(i){var e=ao(i,"string");return De(e)=="symbol"?e:e+""}function ao(i,e){if(De(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(De(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}var dr=(function(){function i(e){io(this,i),this._file=e,this.size=e.size}return no(i,[{key:"slice",value:function(t,r){if(to())return ro(this._file.slice(t,r));var o=this._file.slice(t,r),n=r>=this.size;return Promise.resolve({value:o,done:n})}},{key:"close",value:function(){}}])})();function je(i){"@babel/helpers - typeof";return je=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},je(i)}function lo(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function co(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,fo(r.key),r)}}function po(i,e,t){return e&&co(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function fo(i){var e=uo(i,"string");return je(e)=="symbol"?e:e+""}function uo(i,e){if(je(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(je(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}function cr(i){return i===void 0?0:i.size!==void 0?i.size:i.length}function ho(i,e){if(i.concat)return i.concat(e);if(i instanceof Blob)return new Blob([i,e],{type:i.type});if(i.set){var t=new i.constructor(i.length+e.length);return t.set(i),t.set(e,i.length),t}throw new Error("Unknown data type")}var go=(function(){function i(e){lo(this,i),this._buffer=void 0,this._bufferOffset=0,this._reader=e,this._done=!1}return po(i,[{key:"slice",value:function(t,r){return t<this._bufferOffset?Promise.reject(new Error("Requested data is before the reader's current offset")):this._readUntilEnoughDataOrDone(t,r)}},{key:"_readUntilEnoughDataOrDone",value:function(t,r){var o=this,n=r<=this._bufferOffset+cr(this._buffer);if(this._done||n){var s=this._getDataFromBuffer(t,r),l=s==null?this._done:!1;return Promise.resolve({value:s,done:l})}return this._reader.read().then(function(d){var f=d.value,h=d.done;return h?o._done=!0:o._buffer===void 0?o._buffer=f:o._buffer=ho(o._buffer,f),o._readUntilEnoughDataOrDone(t,r)})}},{key:"_getDataFromBuffer",value:function(t,r){t>this._bufferOffset&&(this._buffer=this._buffer.slice(t-this._bufferOffset),this._bufferOffset=t);var o=cr(this._buffer)===0;return this._done&&o?null:this._buffer.slice(0,r-t)}},{key:"close",value:function(){this._reader.cancel&&this._reader.cancel()}}])})();function pe(i){"@babel/helpers - typeof";return pe=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},pe(i)}function ht(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ht=function(){return e};var i,e={},t=Object.prototype,r=t.hasOwnProperty,o=Object.defineProperty||function(u,c,p){u[c]=p.value},n=typeof Symbol=="function"?Symbol:{},s=n.iterator||"@@iterator",l=n.asyncIterator||"@@asyncIterator",d=n.toStringTag||"@@toStringTag";function f(u,c,p){return Object.defineProperty(u,c,{value:p,enumerable:!0,configurable:!0,writable:!0}),u[c]}try{f({},"")}catch{f=function(p,y,k){return p[y]=k}}function h(u,c,p,y){var k=c&&c.prototype instanceof R?c:R,w=Object.create(k.prototype),T=new K(y||[]);return o(w,"_invoke",{value:V(u,p,T)}),w}function _(u,c,p){try{return{type:"normal",arg:u.call(c,p)}}catch(y){return{type:"throw",arg:y}}}e.wrap=h;var E="suspendedStart",O="suspendedYield",P="executing",v="completed",U={};function R(){}function m(){}function x(){}var g={};f(g,s,function(){return this});var b=Object.getPrototypeOf,z=b&&b(b(le([])));z&&z!==t&&r.call(z,s)&&(g=z);var C=x.prototype=R.prototype=Object.create(g);function j(u){["next","throw","return"].forEach(function(c){f(u,c,function(p){return this._invoke(c,p)})})}function D(u,c){function p(k,w,T,L){var F=_(u[k],u,w);if(F.type!=="throw"){var N=F.arg,H=N.value;return H&&pe(H)=="object"&&r.call(H,"__await")?c.resolve(H.__await).then(function(Y){p("next",Y,T,L)},function(Y){p("throw",Y,T,L)}):c.resolve(H).then(function(Y){N.value=Y,T(N)},function(Y){return p("throw",Y,T,L)})}L(F.arg)}var y;o(this,"_invoke",{value:function(w,T){function L(){return new c(function(F,N){p(w,T,F,N)})}return y=y?y.then(L,L):L()}})}function V(u,c,p){var y=E;return function(k,w){if(y===P)throw Error("Generator is already running");if(y===v){if(k==="throw")throw w;return{value:i,done:!0}}for(p.method=k,p.arg=w;;){var T=p.delegate;if(T){var L=Q(T,p);if(L){if(L===U)continue;return L}}if(p.method==="next")p.sent=p._sent=p.arg;else if(p.method==="throw"){if(y===E)throw y=v,p.arg;p.dispatchException(p.arg)}else p.method==="return"&&p.abrupt("return",p.arg);y=P;var F=_(u,c,p);if(F.type==="normal"){if(y=p.done?v:O,F.arg===U)continue;return{value:F.arg,done:p.done}}F.type==="throw"&&(y=v,p.method="throw",p.arg=F.arg)}}}function Q(u,c){var p=c.method,y=u.iterator[p];if(y===i)return c.delegate=null,p==="throw"&&u.iterator.return&&(c.method="return",c.arg=i,Q(u,c),c.method==="throw")||p!=="return"&&(c.method="throw",c.arg=new TypeError("The iterator does not provide a '"+p+"' method")),U;var k=_(y,u.iterator,c.arg);if(k.type==="throw")return c.method="throw",c.arg=k.arg,c.delegate=null,U;var w=k.arg;return w?w.done?(c[u.resultName]=w.value,c.next=u.nextLoc,c.method!=="return"&&(c.method="next",c.arg=i),c.delegate=null,U):w:(c.method="throw",c.arg=new TypeError("iterator result is not an object"),c.delegate=null,U)}function ue(u){var c={tryLoc:u[0]};1 in u&&(c.catchLoc=u[1]),2 in u&&(c.finallyLoc=u[2],c.afterLoc=u[3]),this.tryEntries.push(c)}function $(u){var c=u.completion||{};c.type="normal",delete c.arg,u.completion=c}function K(u){this.tryEntries=[{tryLoc:"root"}],u.forEach(ue,this),this.reset(!0)}function le(u){if(u||u===""){var c=u[s];if(c)return c.call(u);if(typeof u.next=="function")return u;if(!isNaN(u.length)){var p=-1,y=function k(){for(;++p<u.length;)if(r.call(u,p))return k.value=u[p],k.done=!1,k;return k.value=i,k.done=!0,k};return y.next=y}}throw new TypeError(pe(u)+" is not iterable")}return m.prototype=x,o(C,"constructor",{value:x,configurable:!0}),o(x,"constructor",{value:m,configurable:!0}),m.displayName=f(x,d,"GeneratorFunction"),e.isGeneratorFunction=function(u){var c=typeof u=="function"&&u.constructor;return!!c&&(c===m||(c.displayName||c.name)==="GeneratorFunction")},e.mark=function(u){return Object.setPrototypeOf?Object.setPrototypeOf(u,x):(u.__proto__=x,f(u,d,"GeneratorFunction")),u.prototype=Object.create(C),u},e.awrap=function(u){return{__await:u}},j(D.prototype),f(D.prototype,l,function(){return this}),e.AsyncIterator=D,e.async=function(u,c,p,y,k){k===void 0&&(k=Promise);var w=new D(h(u,c,p,y),k);return e.isGeneratorFunction(c)?w:w.next().then(function(T){return T.done?T.value:w.next()})},j(C),f(C,d,"Generator"),f(C,s,function(){return this}),f(C,"toString",function(){return"[object Generator]"}),e.keys=function(u){var c=Object(u),p=[];for(var y in c)p.push(y);return p.reverse(),function k(){for(;p.length;){var w=p.pop();if(w in c)return k.value=w,k.done=!1,k}return k.done=!0,k}},e.values=le,K.prototype={constructor:K,reset:function(c){if(this.prev=0,this.next=0,this.sent=this._sent=i,this.done=!1,this.delegate=null,this.method="next",this.arg=i,this.tryEntries.forEach($),!c)for(var p in this)p.charAt(0)==="t"&&r.call(this,p)&&!isNaN(+p.slice(1))&&(this[p]=i)},stop:function(){this.done=!0;var c=this.tryEntries[0].completion;if(c.type==="throw")throw c.arg;return this.rval},dispatchException:function(c){if(this.done)throw c;var p=this;function y(N,H){return T.type="throw",T.arg=c,p.next=N,H&&(p.method="next",p.arg=i),!!H}for(var k=this.tryEntries.length-1;k>=0;--k){var w=this.tryEntries[k],T=w.completion;if(w.tryLoc==="root")return y("end");if(w.tryLoc<=this.prev){var L=r.call(w,"catchLoc"),F=r.call(w,"finallyLoc");if(L&&F){if(this.prev<w.catchLoc)return y(w.catchLoc,!0);if(this.prev<w.finallyLoc)return y(w.finallyLoc)}else if(L){if(this.prev<w.catchLoc)return y(w.catchLoc,!0)}else{if(!F)throw Error("try statement without catch or finally");if(this.prev<w.finallyLoc)return y(w.finallyLoc)}}}},abrupt:function(c,p){for(var y=this.tryEntries.length-1;y>=0;--y){var k=this.tryEntries[y];if(k.tryLoc<=this.prev&&r.call(k,"finallyLoc")&&this.prev<k.finallyLoc){var w=k;break}}w&&(c==="break"||c==="continue")&&w.tryLoc<=p&&p<=w.finallyLoc&&(w=null);var T=w?w.completion:{};return T.type=c,T.arg=p,w?(this.method="next",this.next=w.finallyLoc,U):this.complete(T)},complete:function(c,p){if(c.type==="throw")throw c.arg;return c.type==="break"||c.type==="continue"?this.next=c.arg:c.type==="return"?(this.rval=this.arg=c.arg,this.method="return",this.next="end"):c.type==="normal"&&p&&(this.next=p),U},finish:function(c){for(var p=this.tryEntries.length-1;p>=0;--p){var y=this.tryEntries[p];if(y.finallyLoc===c)return this.complete(y.completion,y.afterLoc),$(y),U}},catch:function(c){for(var p=this.tryEntries.length-1;p>=0;--p){var y=this.tryEntries[p];if(y.tryLoc===c){var k=y.completion;if(k.type==="throw"){var w=k.arg;$(y)}return w}}throw Error("illegal catch attempt")},delegateYield:function(c,p,y){return this.delegate={iterator:le(c),resultName:p,nextLoc:y},this.method==="next"&&(this.arg=i),U}},e}function pr(i,e,t,r,o,n,s){try{var l=i[n](s),d=l.value}catch(f){t(f);return}l.done?e(d):Promise.resolve(d).then(r,o)}function vo(i){return function(){var e=this,t=arguments;return new Promise(function(r,o){var n=i.apply(e,t);function s(d){pr(n,r,o,s,l,"next",d)}function l(d){pr(n,r,o,s,l,"throw",d)}s(void 0)})}}function mo(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function xo(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,yo(r.key),r)}}function bo(i,e,t){return e&&xo(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function yo(i){var e=wo(i,"string");return pe(e)=="symbol"?e:e+""}function wo(i,e){if(pe(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(pe(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}var _o=(function(){function i(){mo(this,i)}return bo(i,[{key:"openFile",value:(function(){var e=vo(ht().mark(function r(o,n){var s;return ht().wrap(function(d){for(;;)switch(d.prev=d.next){case 0:if(!(Br()&&o&&typeof o.uri<"u")){d.next=11;break}return d.prev=1,d.next=4,eo(o.uri);case 4:return s=d.sent,d.abrupt("return",new dr(s));case 8:throw d.prev=8,d.t0=d.catch(1),new Error("tus: cannot fetch `file.uri` as Blob, make sure the uri is correct and accessible. ".concat(d.t0));case 11:if(!(typeof o.slice=="function"&&typeof o.size<"u")){d.next=13;break}return d.abrupt("return",Promise.resolve(new dr(o)));case 13:if(typeof o.read!="function"){d.next=18;break}if(n=Number(n),Number.isFinite(n)){d.next=17;break}return d.abrupt("return",Promise.reject(new Error("cannot create source for stream without a finite value for the `chunkSize` option")));case 17:return d.abrupt("return",Promise.resolve(new go(o,n)));case 18:return d.abrupt("return",Promise.reject(new Error("source object may only be an instance of File, Blob, or Reader in this environment")));case 19:case"end":return d.stop()}},r,null,[[1,8]])}));function t(r,o){return e.apply(this,arguments)}return t})()}])})();function ko(i,e){return Br()?Promise.resolve(So(i,e)):Promise.resolve(["tus-br",i.name,i.type,i.size,i.lastModified,e.endpoint].join("-"))}function So(i,e){var t=i.exif?Co(JSON.stringify(i.exif)):"noexif";return["tus-rn",i.name||"noname",i.size||"nosize",t,e.endpoint].join("/")}function Co(i){var e=0;if(i.length===0)return e;for(var t=0;t<i.length;t++){var r=i.charCodeAt(t);e=(e<<5)-e+r,e&=e}return e}function Le(i){"@babel/helpers - typeof";return Le=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Le(i)}function Ct(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function $o(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,Uo(r.key),r)}}function $t(i,e,t){return e&&$o(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function Uo(i){var e=Eo(i,"string");return Le(e)=="symbol"?e:e+""}function Eo(i,e){if(Le(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(Le(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}var Po=(function(){function i(){Ct(this,i)}return $t(i,[{key:"createRequest",value:function(t,r){return new zo(t,r)}},{key:"getName",value:function(){return"XHRHttpStack"}}])})(),zo=(function(){function i(e,t){Ct(this,i),this._xhr=new XMLHttpRequest,this._xhr.open(e,t,!0),this._method=e,this._url=t,this._headers={}}return $t(i,[{key:"getMethod",value:function(){return this._method}},{key:"getURL",value:function(){return this._url}},{key:"setHeader",value:function(t,r){this._xhr.setRequestHeader(t,r),this._headers[t]=r}},{key:"getHeader",value:function(t){return this._headers[t]}},{key:"setProgressHandler",value:function(t){"upload"in this._xhr&&(this._xhr.upload.onprogress=function(r){r.lengthComputable&&t(r.loaded)})}},{key:"send",value:function(){var t=this,r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null;return new Promise(function(o,n){t._xhr.onload=function(){o(new Oo(t._xhr))},t._xhr.onerror=function(s){n(s)},t._xhr.send(r)})}},{key:"abort",value:function(){return this._xhr.abort(),Promise.resolve()}},{key:"getUnderlyingObject",value:function(){return this._xhr}}])})(),Oo=(function(){function i(e){Ct(this,i),this._xhr=e}return $t(i,[{key:"getStatus",value:function(){return this._xhr.status}},{key:"getHeader",value:function(t){return this._xhr.getResponseHeader(t)}},{key:"getBody",value:function(){return this._xhr.responseText}},{key:"getUnderlyingObject",value:function(){return this._xhr}}])})();function Fe(i){"@babel/helpers - typeof";return Fe=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Fe(i)}function Ro(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function To(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,jo(r.key),r)}}function Do(i,e,t){return e&&To(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function jo(i){var e=Lo(i,"string");return Fe(e)=="symbol"?e:e+""}function Lo(i,e){if(Fe(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(Fe(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(i)}var gt=!1;try{gt="localStorage"in window;var st="tusSupport",fr=localStorage.getItem(st);localStorage.setItem(st,fr),fr===null&&localStorage.removeItem(st)}catch(i){if(i.code===i.SECURITY_ERR||i.code===i.QUOTA_EXCEEDED_ERR)gt=!1;else throw i}var Fo=gt,Ao=(function(){function i(){Ro(this,i)}return Do(i,[{key:"findAllUploads",value:function(){var t=this._findEntries("tus::");return Promise.resolve(t)}},{key:"findUploadsByFingerprint",value:function(t){var r=this._findEntries("tus::".concat(t,"::"));return Promise.resolve(r)}},{key:"removeUpload",value:function(t){return localStorage.removeItem(t),Promise.resolve()}},{key:"addUpload",value:function(t,r){var o=Math.round(Math.random()*1e12),n="tus::".concat(t,"::").concat(o);return localStorage.setItem(n,JSON.stringify(r)),Promise.resolve(n)}},{key:"_findEntries",value:function(t){for(var r=[],o=0;o<localStorage.length;o++){var n=localStorage.key(o);if(n.indexOf(t)===0)try{var s=JSON.parse(localStorage.getItem(n));s.urlStorageKey=n,r.push(s)}catch{}}return r}}])})();function _e(i){"@babel/helpers - typeof";return _e=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_e(i)}function Io(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function Bo(i,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(i,Hr(r.key),r)}}function Mo(i,e,t){return t&&Bo(i,t),Object.defineProperty(i,"prototype",{writable:!1}),i}function Ho(i,e,t){return e=Ze(e),qo(i,Mr()?Reflect.construct(e,t||[],Ze(i).constructor):e.apply(i,t))}function qo(i,e){if(e&&(_e(e)==="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return No(i)}function No(i){if(i===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return i}function Mr(){try{var i=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(Mr=function(){return!!i})()}function Ze(i){return Ze=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},Ze(i)}function Yo(i,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");i.prototype=Object.create(e&&e.prototype,{constructor:{value:i,writable:!0,configurable:!0}}),Object.defineProperty(i,"prototype",{writable:!1}),e&&vt(i,e)}function vt(i,e){return vt=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(r,o){return r.__proto__=o,r},vt(i,e)}function ur(i,e){var t=Object.keys(i);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(i);e&&(r=r.filter(function(o){return Object.getOwnPropertyDescriptor(i,o).enumerable})),t.push.apply(t,r)}return t}function be(i){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?ur(Object(t),!0).forEach(function(r){Vo(i,r,t[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(t)):ur(Object(t)).forEach(function(r){Object.defineProperty(i,r,Object.getOwnPropertyDescriptor(t,r))})}return i}function Vo(i,e,t){return e=Hr(e),e in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}function Hr(i){var e=Go(i,"string");return _e(e)=="symbol"?e:e+""}function Go(i,e){if(_e(i)!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var r=t.call(i,e);if(_e(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(i)}var hr=be(be({},Ke.defaultOptions),{},{httpStack:new Po,fileReader:new _o,urlStorage:Fo?new Ao:new ki,fingerprint:ko}),Wo=(function(i){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null,r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return Io(this,e),r=be(be({},hr),r),Ho(this,e,[t,r])}return Yo(e,i),Mo(e,null,[{key:"terminate",value:function(r){var o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return o=be(be({},hr),o),Ke.terminate(r,o)}}])})(Ke);const Xo=10*1024*1024,Ko=5*1024*1024,Zo="https://eu-on-24001.connector.filerobot.com/files",Jo="https://eu-on-24001.connector.filerobot.com/json";function Qo(i,e){if(!e||!i.file)return!1;const t=e.sizeThreshold??Xo;return i.size>=t}function en(i,e){const{tusConfig:t}=e,r=e.apiBase.replace(/\/+$/,""),o=t.endpoint||Zo,n=t.chunkSize??Ko,s=t.resumable!==!1,l=t.parallelChunks??1,d=t.retryDelays??[0,1e3,3e3,5e3],f=r.split("/").pop()||"";let h=!1,_=!1,E=!1;const O={name:i.name,type:i.type,"filerobot-folder":e.folder},P=async()=>`tus-${i.id}-${o}`,v=new Wo(i.file,{endpoint:o,chunkSize:n,retryDelays:d,parallelUploads:l,storeFingerprintForResuming:s,removeFingerprintOnSuccess:!0,headers:{},metadata:O,fingerprint:P,onBeforeRequest(g){const b=e.getAuthHeaders?e.getAuthHeaders():e.authHeaders;for(const[z,C]of Object.entries(b))g.setHeader(z,C);g.setHeader("X-Filerobot-Token",f)},onUploadUrlAvailable(){v.url&&e.onUploadUrlAvailable&&!E&&(E=!0,e.onUploadUrlAvailable(v.url))},onProgress(g,b){!_&&!h&&e.onProgress(g,b)},onSuccess(){var z;if(_)return;m();const g=v.url||"",b=(z=g.match(/files\/([^/?]+)/))==null?void 0:z[1];b?rn(b,i.size).then(C=>{_||e.onComplete(C)}).catch(C=>{_||e.onError(C)}):e.onComplete({status:"success",file:{uuid:"",name:i.name,extension:i.name.split(".").pop()||"",type:i.type,size:i.size,url:{public:g,cdn:g},meta:i.meta,tags:i.tags,info:{},created_at:new Date().toISOString(),modified_at:new Date().toISOString()}})},onError(g){_||(m(),tn(g)?e.onError(new Error("Network error during upload — check your connection or firewall settings")):e.onError(g instanceof Error?g:new Error(String(g))))},onShouldRetry(g,b,z){var j;const C=(j=g.originalResponse)==null?void 0:j.getStatus();return C===429?!0:!(C&&C>400&&C<500&&C!==409)}});let U=null,R=null;typeof window<"u"&&(U=()=>{var g;!h&&!_&&(h=!0,v.abort(!1),(g=e.onPause)==null||g.call(e))},R=()=>{var g;h&&!_&&(h=!1,v.start(),(g=e.onResume)==null||g.call(e))},window.addEventListener("offline",U),window.addEventListener("online",R));const m=()=>{U&&window.removeEventListener("offline",U),R&&window.removeEventListener("online",R)},x=()=>{try{v.start()}catch(g){m(),e.onError(g instanceof Error?g:new Error(String(g)))}};return s?v.findPreviousUploads().then(g=>{g.length>0&&!_&&v.resumeFromPreviousUpload(g[0]),_||x()}):x(),{abort(){_=!0,h=!1,m(),v.abort(!0)},pause(){!h&&!_&&(h=!0,v.abort(!1))},resume(){h&&!_&&(h=!1,v.start())},isPaused(){return h}}}function tn(i){var e;if(i instanceof Ee){const t=(e=i.originalRequest)==null?void 0:e.getUnderlyingObject();return t&&typeof t.readyState=="number"&&typeof t.status=="number"?t.readyState!==0&&t.readyState!==4||t.status===0:i.originalResponse==null&&i.causingError!=null}return!1}async function rn(i,e){const t=`${Jo}/${i}`,r=e>1e8?13e3:6e3,o=3;for(let n=0;n<=o;n++){n>0&&await new Promise(d=>setTimeout(d,r));const s=await fetch(t);if(s.status===404&&n<o)continue;if(!s.ok)throw new Error(`Failed to fetch file record (HTTP ${s.status})`);const l=await s.json();if(l.file)return{status:"success",file:l.file};if(l.status==="success")return l;if(!(n<o))throw new Error(l.msg||"File record not available after upload")}throw new Error("File record not available after upload")}class qr{constructor(e,t){this.activeUploads=new Map,this.pausedUploads=new Map,this.retryTimers=new Map,this.unsubscribe=null,this.store=e,this.config=t}start(){this.unsubscribe||(this.unsubscribe=this.store.subscribe(()=>this.processQueue()),this.processQueue())}uploadAll(){const{files:e}=this.store.getState();let t=!1;for(const r of e.values())r.status==="idle"?(M(this.store,r.id,{status:"queued"}),t=!0):r.status==="queued"&&(t=!0);t&&(this.store.setState({isUploading:!0}),this.processQueue())}retryFile(e){const t=this.store.getState().files.get(e);!t||t.status!=="error"&&t.status!=="failed"||(M(this.store,e,{status:"queued",error:null,progress:0,bytesUploaded:0,speed:0}),this.processQueue())}retryAll(){const{files:e}=this.store.getState();for(const t of e.values())(t.status==="error"||t.status==="failed")&&M(this.store,t.id,{status:"queued",error:null,progress:0,bytesUploaded:0,speed:0});this.processQueue()}pauseFile(e){const t=this.activeUploads.get(e);t&&"pause"in t&&(t.pause(),this.activeUploads.delete(e),this.pausedUploads.set(e,t),M(this.store,e,{status:"paused"}),this.processQueue())}resumeFile(e){const t=this.pausedUploads.get(e);if(!t)return;const{concurrency:r}=this.store.getState().queueConfig;this.activeUploads.size<r?(this.pausedUploads.delete(e),t.resume(),this.activeUploads.set(e,t),M(this.store,e,{status:"uploading"})):M(this.store,e,{status:"queued"})}cancelFile(e){const t=this.store.getState().files.get(e);!t||!gr(t.status)||(this.abortPausedUpload(e),this.abortUpload(e),M(this.store,e,{status:"cancelled"}))}cancelAll(){const{files:e}=this.store.getState();for(const t of e.values())gr(t.status)&&(this.abortPausedUpload(t.id),this.abortUpload(t.id),M(this.store,t.id,{status:"cancelled"}));this.store.setState({isUploading:!1})}updateConfig(e){Object.assign(this.config,e)}destroy(){var e;for(const t of this.activeUploads.keys())this.abortUpload(t);for(const t of[...this.pausedUploads.keys()])this.abortPausedUpload(t);for(const t of this.retryTimers.values())clearTimeout(t);this.retryTimers.clear(),(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=null}processQueue(){const e=this.store.getState();if(e.isPaused)return;const{concurrency:t}=e.queueConfig,r=this.activeUploads.size,o=t-r;if(o<=0)return;const s=[...e.files.values()].filter(l=>l.status==="queued").sort((l,d)=>l.retryCount!==d.retryCount?d.retryCount-l.retryCount:l.addedAt-d.addedAt).slice(0,o);for(const l of s){const d=this.pausedUploads.get(l.id);d?(this.pausedUploads.delete(l.id),d.resume(),this.activeUploads.set(l.id,d),M(this.store,l.id,{status:"uploading"})):this.startUpload(l)}}startUpload(e){const t=!e.remoteInfo&&!e.remoteUrl&&Qo(e,this.config.tusConfig);M(this.store,e.id,{status:"uploading",error:null,isTus:t});let r=0,o=Date.now(),n=0;const s={apiBase:this.config.apiBase,authHeaders:this.config.authHeaders,folder:this.store.getState().targetFolder,onComplete:f=>this.handleComplete(e.id,f),onError:f=>this.handleError(e.id,f)},l=(f,h)=>{const _=Date.now(),E=(_-o)/1e3;if(E>0){const P=(f-r)/E;n=n===0?P:.3*P+.7*n}r=f,o=_;const O=h>0?Math.min(f/h*100,100):0;M(this.store,e.id,{progress:O,bytesUploaded:f,speed:n}),this.updateTotalProgress()};let d;if(e.remoteInfo)d=di(e,{...s,onProgress:l});else if(e.remoteUrl)d=ei(e,s);else if(t){const f=en(e,{...s,onProgress:l,tusConfig:this.config.tusConfig,getAuthHeaders:()=>this.config.authHeaders,onUploadUrlAvailable:h=>{M(this.store,e.id,{tusUploadUrl:h})},onPause:()=>{this.activeUploads.delete(e.id),this.pausedUploads.set(e.id,f),M(this.store,e.id,{status:"paused"}),this.processQueue()},onResume:()=>{this.pausedUploads.delete(e.id),this.activeUploads.set(e.id,f),M(this.store,e.id,{status:"uploading"})}});d=f}else d=Qr(e,{...s,onProgress:l});this.activeUploads.set(e.id,d)}handleComplete(e,t){this.activeUploads.delete(e),M(this.store,e,{status:"complete",progress:100,response:t}),this.updateTotalProgress(),this.checkAllComplete(),this.processQueue()}handleError(e,t){this.activeUploads.delete(e);const r=this.store.getState().files.get(e);if(!r)return;const{retryConfig:o}=this.store.getState().queueConfig,n=r.retryCount+1;if(n<=o.maxRetries){const s=Math.min(o.baseDelay*Math.pow(o.backoffFactor,r.retryCount),o.maxDelay);M(this.store,e,{status:"retrying",error:t.message,retryCount:n});const l=setTimeout(()=>{this.retryTimers.delete(e),M(this.store,e,{status:"queued"}),this.processQueue()},s);this.retryTimers.set(e,l)}else M(this.store,e,{status:"failed",error:t.message}),this.checkAllComplete(),this.processQueue()}abortPausedUpload(e){const t=this.pausedUploads.get(e);t&&(t.abort(),this.pausedUploads.delete(e))}abortUpload(e){var r;(r=this.activeUploads.get(e))==null||r.abort(),this.activeUploads.delete(e);const t=this.retryTimers.get(e);t&&(clearTimeout(t),this.retryTimers.delete(e))}updateTotalProgress(){const{files:e}=this.store.getState();let t=0,r=0,o=0;for(const n of e.values())(n.status==="queued"||n.status==="uploading"||n.status==="paused"||n.status==="retrying"||n.status==="complete"||n.status==="failed")&&(t+=n.size,r+=n.status==="complete"?n.size:n.bytesUploaded),n.status==="uploading"&&(o+=n.speed);this.store.setState({totalBytes:t,totalBytesUploaded:r,totalSpeed:o,totalProgress:t>0?Math.min(r/t*100,100):0})}checkAllComplete(){const{files:e}=this.store.getState();![...e.values()].some(r=>r.status==="queued"||r.status==="uploading"||r.status==="retrying"||r.status==="paused")&&this.store.getState().isUploading&&this.store.setState({isUploading:!1})}}function gr(i){return i==="queued"||i==="uploading"||i==="retrying"||i==="paused"}function rt(i){return`https://api.filerobot.com/${i}`}async function Nr(i,e){const t=`${rt(i)}/key/${encodeURIComponent(e)}`,r=new AbortController,o=setTimeout(()=>r.abort(),3e4);try{const n=await fetch(t,{signal:r.signal});if(clearTimeout(o),!n.ok)throw new Error(`SASS key exchange failed (HTTP ${n.status})`);const s=await n.json();if(s.status==="error")throw new Error(`SASS key exchange failed: ${s.msg||"Unknown error"}`);return s.key}catch(n){throw clearTimeout(o),n instanceof DOMException&&n.name==="AbortError"?new Error("SASS key exchange timed out"):n}}function Je(i,e){const t={};switch(i.mode){case"security-template":if(!e)throw new Error("[sfx-uploader] Cannot build auth headers for security-template mode: SASS key exchange has not been performed. Call resolveAuth() first or use sass-key mode with a pre-resolved key.");t["X-Filerobot-Key"]=e;break;case"sass-key":t["X-Filerobot-Key"]=i.sassKey;break}return i.airboxPuid&&(t["X-Filerobot-Airbox-Puid"]=i.airboxPuid),t}async function Yr(i){const e=rt(i.container);if(i.mode==="security-template"){const t=await Nr(i.container,i.securityTemplateId);return{apiBase:e,headers:Je(i,t),sassKey:t}}return{apiBase:e,headers:Je(i)}}const Ut="sfx-uploader:last-upload",Vr=1;function on(i){var n,s,l;const{file:e,previewUrl:t,...r}=i,o=i.status==="complete"&&((l=(s=(n=i.response)==null?void 0:n.file)==null?void 0:s.url)!=null&&l.cdn)?i.response.file.url.cdn:null;return{...r,previewUrl:o}}function nn(){try{const i=sessionStorage.getItem(Ut);if(!i)return null;const e=JSON.parse(i);return(e==null?void 0:e.__schemaVersion)!==Vr?null:e}catch{return null}}function sn(i){try{sessionStorage.setItem(Ut,JSON.stringify(i))}catch{}}const Ve={save(i){if(i.length===0){this.clear();return}const e={__schemaVersion:Vr,savedAt:Date.now(),files:i.map(on)};sn(e)},load(){const i=nn();return i?i.files.map(e=>({...e,file:null,previewUrl:e.previewUrl??null})):null},clear(){try{sessionStorage.removeItem(Ut)}catch{}}},A={FILE_ADDED:"sfx-file-added",FILE_REMOVED:"sfx-file-removed",FILE_REJECTED:"sfx-file-rejected",UPLOAD_STARTED:"sfx-upload-started",UPLOAD_PROGRESS:"sfx-upload-progress",UPLOAD_COMPLETE:"sfx-upload-complete",UPLOAD_ERROR:"sfx-upload-error",UPLOAD_RETRY:"sfx-upload-retry",UPLOAD_PAUSED:"sfx-upload-paused",UPLOAD_RESUMED:"sfx-upload-resumed",ALL_COMPLETE:"sfx-all-complete",TOTAL_PROGRESS:"sfx-total-progress",BEFORE_UPLOAD:"sfx-before-upload",OPEN:"sfx-open",CLOSE:"sfx-close",CANCEL:"sfx-cancel",COMPLETE_ACTION:"sfx-complete-action",FILE_PREVIEW:"sfx-file-preview",FILL_METADATA:"sfx-fill-metadata"};let an=0;function ve(){return`file-${Date.now()}-${++an}`}function ie(i){if(i<=0)return"0 B";const e=["B","KB","MB","GB"],t=Math.min(Math.floor(Math.log(i)/Math.log(1024)),e.length-1),r=i/Math.pow(1024,t);return`${t===0?r:r.toFixed(1)} ${e[t]}`}function at(i){if(!isFinite(i)||i<=0)return"0s";const e=Math.round(i);if(e<60)return`${e}s`;const t=Math.floor(e/60),r=e%60;return r>0?`${t}m ${r}s`:`${t}m`}function Gr(i){var t;const e=((t=i.name.split(".").pop())==null?void 0:t.toLowerCase())??"";return i.type.startsWith("image/")?"image":i.type.startsWith("video/")||["mp4","mov","avi","webm","mkv","flv","wmv"].includes(e)?"vid":i.type.startsWith("audio/")||["mp3","wav","ogg","flac","aac","m4a","wma"].includes(e)?"audio":i.type==="application/pdf"||e==="pdf"?"pdf":["xls","xlsx","csv","tsv","ods"].includes(e)?"sheet":["doc","docx","txt","rtf","odt","pages"].includes(e)?"doc":["ppt","pptx","key","odp"].includes(e)?"slide":["zip","rar","7z","tar","gz","bz2","xz","zst"].includes(e)?"zip":["js","ts","jsx","tsx","py","rb","go","rs","java","c","cpp","h","cs","php","swift","kt","sh","bash"].includes(e)?"code":["html","css","scss","xml","svg","json","yaml","yml","toml","md","mdx","ini","env","log"].includes(e)?"markup":["ttf","otf","woff","woff2","eot"].includes(e)?"font":["ai","psd","sketch","fig","xd","indd","eps"].includes(e)?"design":["exe","dmg","app","msi","deb","rpm","apk","ipa"].includes(e)?"binary":["sql","db","sqlite","mdb"].includes(e)?"data":"gen"}function ln(i){const e=i.lastIndexOf(".");return e>=0?i.slice(e+1).toUpperCase():""}const dn="https://scaleflex.cloudimg.io/v7/assets/file-types/v3/",Wr={_default:"9a518a",png:"96cd9a",jpg:"06e819",jpg2:"f0eb7f",jpeg:"6a65e9",gif:"c3c2c3",bmp:"d2243a",webp:"fedd74",svg:"a15e46",tiff:"1f30c3",tif:"b383c9",heic:"84adfe",avif:"536b30",ico:"79063d",psd:"be6140",psb:"678646",ai:"84b254",dwg:"971fb3",mp4:"42f175",webm:"26a84a",avi:"d22ba8",mpeg:"ba93bb",ogv:"74d453","3gp":"f0d388","3g2":"04c652",swf:"3955e2",fla:"daf585",m3u8:"7d5e62",mp3:"66bbef",wav:"d7a7d5",aac:"07f3f9",oga:"a5c622",opus:"9548b1",weba:"4dcf70",mid:"3f0e29",midi:"9fedec",cda:"85b83b",pdf:"18c5f7",doc:"d1b47c",docx:"1eb6b0",txt:"307979",rtf:"978c5f",xls:"13b5f7",xlsx:"79d64a",ppt:"4ee29b",pptx:"8b1568",csv:"4add78",odt:"940781",ods:"9fbe9a",odp:"bf892d",dbf:"457bd4",vsd:"8a9ccb",abw:"313dc7",epub:"15263d",azw:"a018b1",ics:"909f63",ogx:"f694d2",zip:"84f98b",rar:"1d6423","7z":"e007e5",tar:"603aed",gz:"de13f7",bz:"0374ff",bz2:"e14294",arc:"942fad",jar:"149796",mpkg:"dea655",ttf:"d2e2c1",otf:"c904fd",woff:"4b8177",woff2:"b532d3",eot:"a54980",js:"524691",mjs:"d57921",ts:"9af3ae",css:"287863",html:"fa7a87",htm:"21323d",xhtml:"e6d6a9",xul:"6c9c71",json:"104c9e",jsonld:"f30c0f",xml:"7f7194",php:"503e36",sh:"3b820e",csh:"08c0cc",exe:"ccca53",iso:"064b8f",bin:"1e9618"};function mt(i){const e=i==="_default"?"GENERIC":i.toUpperCase();return`${dn}${e}.svg?vh=${Wr[i]}`}function Et(i){const e=(i==null?void 0:i.toLowerCase().replaceAll(".",""))||"";return e in Wr?mt(e):mt("_default")}function Pt(){return mt("_default")}const cn={jpg:"image/jpeg",jpeg:"image/jpeg",png:"image/png",gif:"image/gif",webp:"image/webp",svg:"image/svg+xml",bmp:"image/bmp",ico:"image/x-icon",mp4:"video/mp4",mov:"video/quicktime",avi:"video/x-msvideo",webm:"video/webm",pdf:"application/pdf",zip:"application/zip",doc:"application/msword",docx:"application/vnd.openxmlformats-officedocument.wordprocessingml.document"};function pn(i){var t;const e=((t=i.split(".").pop())==null?void 0:t.toLowerCase())??"";return cn[e]||""}function fn(i){return new Promise(e=>{const t=document.createElement("video");t.preload="metadata",t.muted=!0,t.playsInline=!0;const r=URL.createObjectURL(i);let o=!1;const n=()=>{o||(o=!0,e(null)),t.removeAttribute("src"),t.load(),URL.revokeObjectURL(r)};t.addEventListener("seeked",()=>{try{const s=document.createElement("canvas");s.width=t.videoWidth||320,s.height=t.videoHeight||240;const l=s.getContext("2d");if(l){l.drawImage(t,0,0,s.width,s.height),s.toBlob(d=>{o||(o=!0,e(d?URL.createObjectURL(d):null),t.removeAttribute("src"),t.load(),URL.revokeObjectURL(r))},"image/jpeg",.7);return}}catch{}n()},{once:!0}),t.addEventListener("error",()=>n(),{once:!0}),setTimeout(()=>n(),5e3),t.src=r,t.addEventListener("loadeddata",()=>{t.currentTime=.1},{once:!0})})}function xt(i,e,t){var r,o;if(e.maxFileSize!=null&&i.size>0&&i.size>e.maxFileSize)return`File exceeds ${(e.maxFileSize/1048576).toFixed(1)} MB limit`;if(e.maxTotalFilesSize!=null&&i.size>0){let n=i.size;for(const s of t.values())s.status!=="rejected"&&s.status!=="cancelled"&&(n+=s.size);if(n>e.maxTotalFilesSize)return"Total file size limit exceeded"}if(e.maxNumberOfFiles!=null){let n=0;for(const s of t.values())s.status!=="rejected"&&s.status!=="cancelled"&&n++;if(n>=e.maxNumberOfFiles)return`Maximum ${e.maxNumberOfFiles} files allowed`}if(e.allowedFileTypes!=null){const n=e.allowedFileTypes,s="."+(((r=i.name.split(".").pop())==null?void 0:r.toLowerCase())??"");if(!n.some(d=>d.startsWith(".")?s===d.toLowerCase():d.endsWith("/*")?i.type.startsWith(d.slice(0,-1)):i.type===d))return"File type not allowed"}if(e.blockedFileTypes!=null){const n=e.blockedFileTypes,s="."+(((o=i.name.split(".").pop())==null?void 0:o.toLowerCase())??"");if(n.some(d=>d.startsWith(".")?s===d.toLowerCase():d.endsWith("/*")?i.type.startsWith(d.slice(0,-1)):i.type===d))return"File type is blocked"}return null}function un(i,e,t){return xt(i,e,t)}function vr(i){return i.allowedFileTypes?i.allowedFileTypes.join(","):""}const mr={"google-drive":{id:"google-drive",label:"Google Drive",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:transparent"><svg width="16" height="16" viewBox="0 0 87.3 78"><path d="M6.6 66.85l3.85 6.65c.8 1.4 1.95 2.5 3.3 3.3L27.5 53H0c0 1.55.4 3.1 1.2 4.5z" fill="#0066da"/><path d="M43.65 25L29.9 1.2C28.55 2 27.4 3.1 26.6 4.5L1.2 48.5C.4 49.9 0 51.45 0 53h27.5z" fill="#00ac47"/><path d="M73.55 76.8c1.35-.8 2.5-1.9 3.3-3.3l1.6-2.75 7.65-13.25c.8-1.4 1.2-2.95 1.2-4.5H59.8l5.65 10.85z" fill="#ea4335"/><path d="M43.65 25L57.4 1.2C56.05.4 54.5 0 52.9 0H34.4c-1.6 0-3.15.45-4.5 1.2z" fill="#00832d"/><path d="M59.8 53H27.5L13.75 76.8c1.35.8 2.9 1.2 4.5 1.2h50.8c1.6 0 3.15-.45 4.5-1.2z" fill="#2684fc"/><path d="M73.4 26.5l-12.7-22c-.8-1.4-1.95-2.5-3.3-3.3L43.65 25 59.8 53h27.45c0-1.55-.4-3.1-1.2-4.5z" fill="#ffba00"/></svg></span>'},dropbox:{id:"dropbox",label:"Dropbox",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:#0061ff"><svg width="11" height="11" viewBox="0 0 528 512" fill="white"><path d="M264.4 116.3l-132 84.3 132 84.3-132 84.3L0 284.1l132.3-84.3L0 116.3 132.3 32l132.1 84.3zm-132 284.5l132-84.3 132 84.3-132 84.4-132-84.4zm132-116.6l132.3-84.3-132.3-83.9 131.6-84.3L528 116.3l-132.3 84.1L528 284.7l-132.4 83.9-131.2-84.4z"/></svg></span>'},onedrive:{id:"onedrive",label:"OneDrive",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:#0078d4"><svg width="11" height="11" viewBox="0 0 24 24" fill="white"><path d="M10.5 13.5C10.5 11.57 12.07 10 14 10h6.5c.17 0 .34.01.5.02A6 6 0 009.01 11.6 4 4 0 0010.5 13.5zM12 14.5a5 5 0 00-5-5 5 5 0 00-5 5 3 3 0 003 3h9.5A3.5 3.5 0 0018 14c0-.18-.01-.35-.03-.52A5.48 5.48 0 0112 14.5z"/></svg></span>'},box:{id:"box",label:"Box",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:#0e50a0;font-size:9px;font-weight:800;color:#fff">box</span>'},instagram:{id:"instagram",label:"Instagram",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)"><svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M12 2.16c2.94 0 3.29.01 4.45.06 1.07.05 1.8.22 2.43.46.66.25 1.21.6 1.77 1.16.55.55.9 1.1 1.16 1.77.25.64.41 1.37.46 2.43.05 1.16.06 1.51.06 4.45s-.01 3.29-.06 4.45c-.05 1.07-.22 1.8-.46 2.43a4.9 4.9 0 01-1.16 1.77c-.55.55-1.1.9-1.77 1.16-.64.25-1.37.41-2.43.46-1.16.05-1.51.06-4.45.06s-3.29-.01-4.45-.06c-1.07-.05-1.8-.22-2.43-.46a4.9 4.9 0 01-1.77-1.16 4.9 4.9 0 01-1.16-1.77c-.25-.64-.41-1.37-.46-2.43C2.17 15.29 2.16 14.94 2.16 12s.01-3.29.06-4.45c.05-1.07.22-1.8.46-2.43a4.9 4.9 0 011.16-1.77A4.9 4.9 0 015.61 2.2c.64-.25 1.37-.41 2.43-.46C9.21 2.17 9.56 2.16 12 2.16zM12 16a4 4 0 110-8 4 4 0 010 8zm6.4-9.85a1.44 1.44 0 100 2.88 1.44 1.44 0 000-2.88z"/></svg></span>'},facebook:{id:"facebook",label:"Facebook",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:#1877f2"><svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.41 0 12.07c0 6.02 4.39 11.02 10.12 11.93v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.95.93-1.95 1.89v2.26h3.33l-.53 3.49h-2.8v8.44C19.61 23.09 24 18.09 24 12.07z"/></svg></span>'},unsplash:{id:"unsplash",label:"Unsplash",fillIcon:!0,icon:"",brandHtml:'<span class="brand-ico" style="background:#111"><svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M8.5 11.5v5h7v-5h5.5V21h-18v-9.5h5.5zm7-8v5h-7v-5h7z"/></svg></span>'}};function Xr(i){return i.filter(e=>e in mr).map(e=>mr[e])}var hn=Object.defineProperty,gn=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&hn(e,t,o),o};const vn='<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>',mn='<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>',xn='<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>',bn='<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>',ye=[{id:"device",label:"My Device",icon:vn,iconColor:"#2563eb"},{id:"url",label:"URL link",icon:mn,iconColor:"#16a34a"},{id:"camera",label:"Camera",icon:xn,iconColor:"#7c3aed"},{id:"screen-cast",label:"Screen capture",icon:bn,iconColor:"#ea580c"}],Tt=class Tt extends a.LitElement{constructor(){super(...arguments),this.sources=ye}_handleClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}render(){return a.html`
      ${this.sources.map(e=>a.html`
          <button @click=${()=>this._handleClick(e)}>
            ${e.brandHtml?de.unsafeHTML(e.brandHtml):a.svg`<svg viewBox="0 0 24 24" class=${e.fillIcon?"fill-icon":""}>${re.unsafeSVG(e.icon)}</svg>`}
            ${e.label}
          </button>
        `)}
    `}};Tt.styles=a.css`
  ...
  `;let Qe=Tt;gn([S.property({type:Array})],Qe.prototype,"sources");function Kr(i){let e=i;for(;e;){if(e instanceof ShadowRoot){e=e.host;continue}if(e instanceof HTMLDialogElement&&e.open)return e;if(e instanceof Element&&e.shadowRoot){const t=e.shadowRoot.querySelector("dialog[open]");if(t instanceof HTMLDialogElement)return t}e=e.parentNode}return document.body}var yn=Object.defineProperty,J=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&yn(e,t,o),o};const xr=3,bt=new CSSStyleSheet;bt.replaceSync(`
...
`);var oe;const X=(oe=class extends a.LitElement{constructor(){super(...arguments),this.compact=!1,this.externalDragOver=!1,this.accept="",this.sources=[],this.sourcesLayout="pills",this.mode="modal",this._resizeObserver=null,this._dragOver=!1,this._moreOpen=!1,this._visiblePills=xr,this._dragCounter=0,this._onDragEnter=e=>{e.preventDefault(),this._dragCounter++,this._dragCounter===1&&(this._dragOver=!0)},this._onDragOver=e=>{e.preventDefault()},this._onDragLeave=e=>{e.preventDefault(),this._dragCounter--,this._dragCounter<=0&&(this._dragCounter=0,this._dragOver=!1)},this._onDrop=e=>{var r;e.preventDefault(),e.stopPropagation(),this._dragCounter=0,this._dragOver=!1;const t=Array.from(((r=e.dataTransfer)==null?void 0:r.files)??[]);t.length>0&&this._emitFiles(t)},this._onClick=e=>{const t=this.shadowRoot.querySelector(".drop-zone");if(t&&this._rippleEl){const r=t.getBoundingClientRect();this._rippleEl.style.left=`${e.clientX-r.left}px`,this._rippleEl.style.top=`${e.clientY-r.top}px`,this._rippleEl.classList.remove("go"),this._rippleEl.offsetWidth,this._rippleEl.classList.add("go")}this.browse()},this._onKeyDown=e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.browse())},this._onFileChange=e=>{const t=e.target,r=Array.from(t.files??[]);r.length>0&&this._emitFiles(r),t.value=""},this._onPaste=e=>{var o;if(!this.isConnected||this.offsetWidth===0)return;const t=(o=e.clipboardData)==null?void 0:o.items;if(!t)return;const r=[];for(const n of t)if(n.kind==="file"){const s=n.getAsFile();s&&r.push(s)}r.length>0&&(e.preventDefault(),this._emitFiles(r))},this._portalContainer=null,this._onDocClick=e=>{var t;this._moreOpen&&((t=this._portalContainer)!=null&&t.contains(e.target)||(this._moreOpen=!1,this._updateDropdownPortal()))},this._onDocKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._updateDropdownPortal())},this._resizeTimer=null,this._onScrollOrResize=()=>{this._moreOpen&&this._positionDropdown(),this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(()=>this._updateVisiblePills(),100)}}browse(){var e;(e=this.fileInput)==null||e.click()}_onSourceIconClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}_emitFiles(e){this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:e},bubbles:!0,composed:!0}))}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._updateDropdownPortal()}_updateDropdownPortal(){if(this._moreOpen){const e=this.sources.slice(this._visiblePills);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-more-dropdown",""),Kr(this).appendChild(this._portalContainer),this._injectDropdownStyles()),a.render(a.html`<div class="sfx-more-dropdown open">
    ...
    `}_renderCard(e){return a.html`
      <button
        ...
        @click=${t=>{t.stopPropagation(),this._onSourceIconClick(e)}}
      >
        ${e.brandHtml?a.html`<span class="card-ico">${de.unsafeHTML(e.brandHtml)}</span>`:a.html`<span
              class="card-ico"
              style=${e.iconColor?`color:${e.iconColor}`:""}
            >
              ${a.svg`<svg viewBox="0 0 24 24" class=${e.fillIcon?"fill-icon":""}>${re.unsafeSVG(e.icon)}</svg>`}
        ...
        ${this.compact&&this.sources.length>0?a.html`
              <div class="sources-row">
                ${this.sources.map(o=>a.html`
                    ...
                    >
                      ${o.brandHtml?de.unsafeHTML(o.brandHtml):a.svg`<svg viewBox="0 0 24 24" class=${o.fillIcon?"fill-icon":""}>${re.unsafeSVG(o.icon)}</svg>`}
                    </button>
                  `)}
              </div>
            `:a.nothing}
  ...
  `,oe._WIDE_THRESHOLD_PX=1200,oe);J([S.property({type:Boolean,reflect:!0})],X.prototype,"compact");J([S.property({type:Boolean,attribute:"external-drag-over"})],X.prototype,"externalDragOver");J([S.property({type:String})],X.prototype,"accept");J([S.property({type:Array})],X.prototype,"sources");J([S.property({type:String,attribute:"sources-layout"})],X.prototype,"sourcesLayout");J([S.property({type:String,reflect:!0})],X.prototype,"mode");J([S.state()],X.prototype,"_dragOver");J([S.state()],X.prototype,"_moreOpen");J([S.state()],X.prototype,"_visiblePills");J([S.query(".ripple")],X.prototype,"_rippleEl");J([S.query('input[type="file"]')],X.prototype,"fileInput");let wn=X;const Dt=class Dt extends a.LitElement{render(){return a.html`
      <div class="line"></div>
  ...
  `;let yt=Dt;var _n=Object.defineProperty,ae=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&_n(e,t,o),o};const wt=new CSSStyleSheet;wt.replaceSync(`
...
`);const jt=class jt extends a.LitElement{constructor(){super(...arguments),this.files=[],this.showDropTile=!1,this.sources=[],this.accept="",this.mode="upload",this._moreOpen=!1,this._dropTileMaxVisible=3,this._portalContainer=null,this._outsideClickHandler=e=>{var o;if((o=this._portalContainer)!=null&&o.contains(e.target))return;const t=this.renderRoot.querySelector(".drop-tile-more-wrap"),r=e.composedPath();t&&r.includes(t)||(this._moreOpen=!1,this._closePortal(),document.removeEventListener("click",this._outsideClickHandler,!0))},this._onScrollOrResize=()=>{this._moreOpen&&this._positionPortal()},this._onKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._closePortal(),this._removeGlobalListeners())},this._updateDropTileMaxVisible=()=>{const e=window.innerWidth<=768?1:3;e!==this._dropTileMaxVisible&&(this._dropTileMaxVisible=e)}}_onDropTileClick(){const e=this.renderRoot.querySelector('input[type="file"]');e==null||e.click()}_onFileInput(e){const t=e.target,r=Array.from(t.files??[]);r.length>0&&this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:r},bubbles:!0,composed:!0})),t.value=""}_onSourceClick(e,t){if(e.stopPropagation(),t.id==="device"){const r=this.renderRoot.querySelector('input[type="file"]');r==null||r.click();return}this.dispatchEvent(new CustomEvent("source-click",{detail:{source:t},bubbles:!0,composed:!0}))}_addGlobalListeners(){requestAnimationFrame(()=>document.addEventListener("click",this._outsideClickHandler,!0)),document.addEventListener("keydown",this._onKeyDown),window.addEventListener("scroll",this._onScrollOrResize,!0),window.addEventListener("resize",this._onScrollOrResize)}_removeGlobalListeners(){document.removeEventListener("click",this._outsideClickHandler,!0),document.removeEventListener("keydown",this._onKeyDown),window.removeEventListener("scroll",this._onScrollOrResize,!0),window.removeEventListener("resize",this._onScrollOrResize)}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._moreOpen?(this._openPortal(),this._addGlobalListeners()):(this._closePortal(),this._removeGlobalListeners())}_openPortal(){const e=this.sources.slice(this._dropTileMaxVisible);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-tile-dropdown",""),Kr(this).appendChild(this._portalContainer),this._injectTileDropdownStyles()),a.render(a.html`<div class="sfx-tile-dropdown">
    ...
    `}render(){return a.html`
      <div class="grid">
        ...
        ${this.files.map((e,t)=>a.html`<sfx-file-item .file=${e} .mode=${this.mode} .getLocateUrl=${this.getLocateUrl} style="--tile-index:${t}"></sfx-file-item>`)}
      </div>
    `}};jt.styles=a.css`
    :host {
      display: block;
  ...
  `;let Z=jt;ae([S.property({attribute:!1})],Z.prototype,"files");ae([S.property({type:Boolean})],Z.prototype,"showDropTile");ae([S.property({attribute:!1})],Z.prototype,"sources");ae([S.property({type:String})],Z.prototype,"accept");ae([S.property({type:String})],Z.prototype,"mode");ae([S.property({attribute:!1})],Z.prototype,"getLocateUrl");ae([S.state()],Z.prototype,"_moreOpen");ae([S.state()],Z.prototype,"_dropTileMaxVisible");var kn=Object.defineProperty,Be=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&kn(e,t,o),o};const Lt=class Lt extends a.LitElement{constructor(){super(...arguments),this.mode="upload",this._dims="",this._copied=!1,this._copiedTimer=null}updated(e){var t,r,o,n,s;if(e.has("file")){if(this._dims="",(r=(t=this.file)==null?void 0:t.previewUrl)!=null&&r.startsWith("blob:")){const l=this.file.previewUrl,d=new Image;d.onload=()=>{var f;((f=this.file)==null?void 0:f.previewUrl)===l&&(this._dims=`${d.naturalWidth}×${d.naturalHeight}`)},d.src=l}else if((s=(n=(o=this.file)==null?void 0:o.response)==null?void 0:n.file)!=null&&s.info){const l=this.file.response.file.info;l.img_w&&l.img_h&&(this._dims=`${l.img_w}×${l.img_h}`)}}}disconnectedCallback(){super.disconnectedCallback(),this._copiedTimer!=null&&(clearTimeout(this._copiedTimer),this._copiedTimer=null)}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{fileId:this.file.id,...t},bubbles:!0,composed:!0}))}_remove(){this._emit("file-remove")}_retry(){this._emit("file-retry")}_pause(){this._emit("file-pause")}_resume(){this._emit("file-resume")}_rename(e){const t=e.target.value.trim();t&&this._emit("file-rename",{name:t})}_preview(e){e.stopPropagation(),this._emit("file-preview")}_locate(e){var o,n,s,l,d;if(e.stopPropagation(),!this.file)return;const r=((o=this.getLocateUrl)==null?void 0:o.call(this,this.file))||((d=(l=(s=(n=this.file)==null?void 0:n.response)==null?void 0:s.file)==null?void 0:l.url)==null?void 0:d.public);r&&window.open(r,"_blank","noopener,noreferrer")}async _copyCdn(e){var r,o,n,s;e.stopPropagation();const t=(s=(n=(o=(r=this.file)==null?void 0:r.response)==null?void 0:o.file)==null?void 0:n.url)==null?void 0:s.cdn;if(t){try{await navigator.clipboard.writeText(t)}catch{return}this._copied=!0,this._copiedTimer&&clearTimeout(this._copiedTimer),this._copiedTimer=window.setTimeout(()=>{this._copied=!1,this._copiedTimer=null},1400)}}render(){var _,E;const e=this.file;if(!e)return a.nothing;const t=Gr(e),r=e.status==="complete",o=e.status==="uploading",n=e.status==="paused",s=e.status==="error"||e.status==="failed",l=e.status==="rejected",d=this.mode==="review",f=ln(e.name),h=["tile",r?"done":"",o?"uploading":"",n?"paused":"",l?"rejected":"",d?"review":""].filter(Boolean).join(" ");return a.html`
      <div class=${h} tabindex="0">
        ...
        <div class="preview">
          ${e.previewUrl?a.html`<img class="preview-img" src=${e.previewUrl} alt="" />`:a.html`
                ...
                <div class="type-icon">
                  <img
                    ...
                    src=${Et(f)}
                    alt="${f?`${f} file`:"File"}"
                    @error=${O=>{const P=O.target,v=Pt();!P.dataset.fallback&&P.src!==v&&(P.dataset.fallback="1",P.src=v)}}
                  />
                </div>
              `}
          ...
          ${d&&r&&((E=(_=e.response)==null?void 0:_.file)!=null&&E.url)?a.html`
                <div class="review-actions">
                  ${e.response.file.url.public?a.html`<button class="review-action secondary" @click=${this._locate} title=${e.response.file.url.public} aria-label="Locate file in storage">
                  ...
                  ${e.response.file.url.cdn?a.html`<button class="review-action primary ${this._copied?"copied":""}" @click=${this._copyCdn} title="Copy CDN link" aria-label="Copy CDN link to clipboard">
        ...
        <div class="info">
          <input class="name-input" type="text" .value=${e.name} title=${e.name}
            ...
            ?readonly=${d}
            @change=${d?a.nothing:this._rename} @click=${O=>O.stopPropagation()} />
          <div class="meta">${f||""}${e.size?` · ${ie(e.size)}`:""}${this._dims?` · ${this._dims}`:""}</div>
        </div>
      </div>
    `}_formatDuration(e){const t=Math.floor(e/60),r=Math.floor(e%60);return`${t}:${r.toString().padStart(2,"0")}`}};Lt.styles=a.css`
    :host {
      display: block;
    }
  ...
  `;let ne=Lt;Be([S.property({attribute:!1})],ne.prototype,"file");Be([S.property({type:String})],ne.prototype,"mode");Be([S.property({attribute:!1})],ne.prototype,"getLocateUrl");Be([S.state()],ne.prototype,"_dims");Be([S.state()],ne.prototype,"_copied");const Me=a.css`
  .btn,
  .btn-ghost,
  .btn-primary,
  .btn-sec,
...
`;var Sn=Object.defineProperty,Ue=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&Sn(e,t,o),o};const br=7,Cn=4,Ft=class Ft extends a.LitElement{constructor(){super(...arguments),this.fileCount=0,this.totalSize=0,this.thumbnails=[],this.primaryLabel="Done",this.failedFiles=[],this._maxThumbs=br,this._updateMaxThumbs=()=>{const e=window.innerWidth<=768?Cn:br;e!==this._maxThumbs&&(this._maxThumbs=e)}}connectedCallback(){super.connectedCallback(),this._updateMaxThumbs(),window.addEventListener("resize",this._updateMaxThumbs)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._updateMaxThumbs)}_uploadMore(){this.dispatchEvent(new CustomEvent("upload-more",{bubbles:!0,composed:!0}))}_reviewFiles(){this.dispatchEvent(new CustomEvent("review-files",{bubbles:!0,composed:!0}))}_primaryAction(){this.dispatchEvent(new CustomEvent("primary-action",{bubbles:!0,composed:!0}))}_retryFile(e){this.dispatchEvent(new CustomEvent("file-retry",{bubbles:!0,composed:!0,detail:{fileId:e}}))}_retryAll(){this.dispatchEvent(new CustomEvent("retry-all",{bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-uploader",{bubbles:!0,composed:!0}))}render(){const e=this.thumbnails.slice(0,this._maxThumbs),t=this.thumbnails.length-this._maxThumbs,r=this.fileCount>0,o=this.failedFiles.length>0,n=o&&!r;return a.html`
      ...
      <div class="card" role="status" aria-live="polite">
        ...
        ${r?a.html`<div class="summary">${this.fileCount} ${this.fileCount===1?"file":"files"} · ${ie(this.totalSize)} uploaded</div>`:a.nothing}
  ...
  `];let ee=Ft;Ue([S.property({type:Number})],ee.prototype,"fileCount");Ue([S.property({type:Number})],ee.prototype,"totalSize");Ue([S.property({type:Array})],ee.prototype,"thumbnails");Ue([S.property({type:String})],ee.prototype,"primaryLabel");Ue([S.property({type:Array})],ee.prototype,"failedFiles");Ue([S.state()],ee.prototype,"_maxThumbs");var $n=Object.defineProperty,zt=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&$n(e,t,o),o};const At=class At extends a.LitElement{constructor(){super(...arguments),this.files=[],this._filter="all",this._setFilter=e=>()=>{this._filter=e},this._onBack=()=>{this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onClear=()=>{this.dispatchEvent(new CustomEvent("clear-history",{bubbles:!0,composed:!0}))}}get _filtered(){return this._filter==="success"?this.files.filter(e=>e.status==="complete"):this._filter==="failed"?this.files.filter(e=>e.status==="failed"||e.status==="error"):this.files}get _successCount(){return this.files.filter(e=>e.status==="complete").length}get _failedCount(){return this.files.filter(e=>e.status==="failed"||e.status==="error").length}render(){const e=this._filtered,t=this.files.length;return a.html`
      ...
      <div class="body">
        ${e.length===0?a.html`<div class="empty">No files match this filter.</div>`:a.html`<sfx-file-list .files=${e} mode="review" .getLocateUrl=${this.getLocateUrl}></sfx-file-list>`}
      </div>
    `}};At.styles=a.css`
    :host {
      display: flex;
  ...
  `];let se=Ht;qe([S.state()],se.prototype,"_stream");qe([S.state()],se.prototype,"_recording");qe([S.state()],se.prototype,"_error");qe([S.state()],se.prototype,"_recordedBlob");qe([S.state()],se.prototype,"_previewUrl");var Rn=Object.defineProperty,Zr=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&Rn(e,t,o),o};const qt=class qt extends a.LitElement{constructor(){super(...arguments),this.duration=6e3,this._toasts=[],this._nextId=0}show(e,t="error"){const r=++this._nextId;this._toasts=[...this._toasts,{id:r,message:e,type:t,leaving:!1}],setTimeout(()=>this._dismiss(r),this.duration)}_dismiss(e){const t=this._toasts.findIndex(o=>o.id===e);if(t===-1)return;const r=[...this._toasts];r[t]={...r[t],leaving:!0},this._toasts=r,setTimeout(()=>{this._toasts=this._toasts.filter(o=>o.id!==e)},200)}_iconForType(e){return e==="error"?a.html`<svg class="toast-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
  ...
  `;let Ae=qt;Zr([S.property({type:Number})],Ae.prototype,"duration");Zr([S.state()],Ae.prototype,"_toasts");customElements.define("sfx-toast",Ae);var Tn=Object.defineProperty,B=(i,e,t,r)=>{for(var o=void 0,n=i.length-1,s;n>=0;n--)(s=i[n])&&(o=s(e,t,o)||o);return o&&Tn(e,t,o),o};const yr=new Set(["unsplash"]),me={isTus:!1,tusUploadUrl:null};var G;const I=(G=class extends a.LitElement{constructor(){super(),this.config=null,this._isOpen=!1,this._activeConnector=null,this._showUrlDialog=!1,this._showCameraDialog=!1,this._showScreenCastDialog=!1,this._previewFileId=null,this._previewDims="—",this._fileInfoOpen=!0,this._splitPct=58,this._isResizing=!1,this._splitRafId=0,this._previewDefaultApplied=!1,this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._fullscreenZoomed=!1,this._fsPanX=0,this._fsPanY=0,this._fsDragging=!1,this._fsDragStartX=0,this._fsDragStartY=0,this._fsPanStartX=0,this._fsPanStartY=0,this._bodyDragOver=!1,this._isMinimized=!1,this._isPillExpanded=!1,this._metadataSchema=null,this._bulkMetadataOpen=!1,this._isReviewing=!1,this._reviewFiles=[],this._hasStoredReview=!1,this._metadataAutocomplete=null,this._videoBlobUrls=new Map,this._engine=null,this._cachedSources=ye,this._cachedSourcesConfig=void 0,this._rejectedTimers=new Map,this._closeOnCompleteTimer=null,this._apiBase=null,this._authHeaders=null,this._authResolveId=0,this._prevStoreState=null,this._unsubStoreEvents=null,this._portalContainer=null,this._onFileRename=e=>{this._onPreviewRename(e.detail.fileId,e.detail.name)},this._onPreviewMetadataBlur=e=>{const t=this._previewFileId;if(!t)return;const{key:r,value:o}=e.detail,n=this._store.getState().files.get(t);if(!n)return;const s=new Map(this._store.getState().files);s.set(t,{...n,meta:{...n.meta,[r]:o}}),this._store.setState({files:s})},this._onFilesSelected=e=>{this._processIncomingFiles(e.detail.files)},this._onDropTileSourceClick=e=>{e.stopPropagation(),this._handleSourceActivation(e.detail.source.id)},this._onSourceClick=async e=>{this._handleSourceActivation(e.detail.source)},this._handleSourceActivation=async e=>{var o,n;const t=this._mergedSources.find(s=>s.id===e);if(t!=null&&t.onActivate){try{t.onActivate(this)}catch(s){console.error(`[sfx-uploader] onActivate for custom source "${e}" threw:`,s)}return}if(e==="device"){const s=this.shadowRoot.querySelector("sfx-drop-zone");s==null||s.browse();return}if(e==="url"){this._showUrlDialog=!0;return}if(e==="camera"){this._showCameraDialog=!0;return}if(e==="screen-cast"){this._showScreenCastDialog=!0;return}if((((n=(o=this.config)==null?void 0:o.connectors)==null?void 0:n.providers)??[]).includes(e)){if(yr.has(e)){if(!customElements.get("sfx-search-provider-browser")){const{SfxSearchProviderBrowser:l}=await Promise.resolve().then(()=>require("./search-provider-browser-CqHgRhqM.cjs"));customElements.define("sfx-search-provider-browser",l)}}else if(!customElements.get("sfx-provider-browser")){const{SfxProviderBrowser:l}=await Promise.resolve().then(()=>require("./provider-browser-BooCl9Xv.cjs"));customElements.define("sfx-provider-browser",l)}this._activeConnector=e}},this._onUrlSubmit=e=>{var _,E,O;this._showUrlDialog=!1;const{url:t,name:r}=e.detail,o=(_=this.config)==null?void 0:_.callbacks,n=pn(r),s=n.startsWith("image/"),l=this._store.getState();if([...l.files.values()].some(P=>P.name===r&&P.status!=="rejected"&&P.status!=="cancelled"))return;const f=xt({name:r,size:0,type:n},l.restrictions,l.files);if(f){const P={id:ve(),status:"rejected",file:null,remoteUrl:t,name:r,size:0,type:n,previewUrl:null,duration:null,progress:0,speed:0,bytesUploaded:0,error:f,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],remoteInfo:null,...me};he(this._store,P),this._dispatchPublic(A.FILE_REJECTED,{file:P,reason:f}),(E=o==null?void 0:o.onFileRejected)==null||E.call(o,P,f);return}const h={id:ve(),status:"idle",file:null,remoteUrl:t,name:r,size:0,type:n,previewUrl:s?t:null,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],remoteInfo:null,...me};he(this._store,h),this._dispatchPublic(A.FILE_ADDED,{file:h}),(O=o==null?void 0:o.onFileAdded)==null||O.call(o,h),this._store.getState().queueConfig.autoProceed&&this.upload()},this._onUrlCancel=()=>{this._showUrlDialog=!1},this._onCameraCapture=e=>{this._showCameraDialog=!1,this._processIncomingFiles([e.detail.file])},this._onCameraCancel=()=>{this._showCameraDialog=!1},this._onScreenCastCapture=e=>{this._showScreenCastDialog=!1,this._processIncomingFiles([e.detail.file])},this._onScreenCastCancel=()=>{this._showScreenCastDialog=!1},this._onFileRemove=e=>{this._removeFile(e.detail.fileId)},this._onFilePreview=e=>{var r,o,n;const t=this._store.getState().files.get(e.detail.fileId);t&&(this._previewFileId=t.id,this._dispatchPublic(A.FILE_PREVIEW,{file:t}),(n=(o=(r=this.config)==null?void 0:r.callbacks)==null?void 0:o.onFilePreview)==null||n.call(o,t))},this._onFillMetadata=()=>{var t,r,o,n;const e=[...this._store.getState().files.values()].filter(s=>G._MODIFIABLE_STATUSES.has(s.status));(t=this.config)!=null&&t.metadataConfig&&this._metadataSchema&&(this._bulkMetadataOpen=!0),this._dispatchPublic(A.FILL_METADATA,{files:e}),(n=(o=(r=this.config)==null?void 0:r.callbacks)==null?void 0:o.onFillMetadata)==null||n.call(o,e)},this._onBulkMetadataSaveBatch=e=>{const{changes:t}=e.detail;if(!t.length)return;const r=new Map(this._store.getState().files);for(const{fileId:o,meta:n}of t){const s=r.get(o);s&&r.set(o,{...s,meta:{...s.meta,...n}})}this._store.setState({files:r})},this._onBulkMetadataClose=()=>{this._bulkMetadataOpen=!1},this._onFileRetry=e=>{var t;this._ensureEngine(),(t=this._engine)==null||t.retryFile(e.detail.fileId)},this._onFilePause=e=>{var t;(t=this._engine)==null||t.pauseFile(e.detail.fileId)},this._onFileResume=e=>{var t;(t=this._engine)==null||t.resumeFile(e.detail.fileId)},this._onRetryAll=()=>{var e;this._ensureEngine(),(e=this._engine)==null||e.retryAll()},this._onClearAll=()=>{var r,o,n;const e=(r=this.config)==null?void 0:r.callbacks;this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),(o=this._engine)==null||o.cancelAll();const t=[...this._store.getState().files.values()];for(const s of t)s.previewUrl&&URL.revokeObjectURL(s.previewUrl),this._dispatchPublic(A.FILE_REMOVED,{file:s}),(n=e==null?void 0:e.onFileRemoved)==null||n.call(e,s);this._revokeVideoBlobUrls();for(const s of this._rejectedTimers.values())clearTimeout(s);this._rejectedTimers.clear(),this._dimCache.clear(),this._previewFileId=null,this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._store.setState({files:new Map,isUploading:!1,totalProgress:0,totalSpeed:0,totalBytesUploaded:0,totalBytes:0})},this._onAddMore=()=>{var o;const e=this.shadowRoot.querySelector("sfx-drop-zone");if(e){e.browse();return}const t=this.shadowRoot.querySelector("sfx-file-list"),r=(o=t==null?void 0:t.shadowRoot)==null?void 0:o.querySelector('input[type="file"]');r==null||r.click()},this._onUploadStart=()=>{var e;if(this._phase==="complete"){((e=this.config)==null?void 0:e.clearOnComplete)!==!1&&this._onClearAll();return}this._hasUnfilledRequiredMetadata||this.upload()},this._onUploadMore=()=>{this._onClearAll()},this._onEnterReview=()=>{const e=[...this._store.getState().files.values()].filter(r=>r.status==="complete"||r.status==="failed"||r.status==="error");if(e.length>0){this._reviewFiles=e,this._isReviewing=!0;return}const t=Ve.load();!t||t.length===0||(this._reviewFiles=t,this._isReviewing=!0)},this._onExitReview=()=>{this._isReviewing=!1,this._reviewFiles=[]},this._onClearReview=()=>{Ve.clear(),this._isReviewing=!1,this._reviewFiles=[],this._hasStoredReview=!1},this._onConnectorFilesSelected=e=>{var r,o,n;const t=(r=this.config)==null?void 0:r.callbacks;for(const s of e.detail.files){const l=this._store.getState();if([...l.files.values()].some(_=>_.name===s.name&&_.size===s.size&&_.status!=="rejected"&&_.status!=="cancelled"))continue;const f=xt({name:s.name,size:s.size,type:s.mimeType},l.restrictions,l.files);if(f){const _={id:ve(),status:"rejected",file:null,remoteUrl:null,name:s.name,size:s.size,type:s.mimeType,previewUrl:s.thumbnail,duration:null,progress:0,speed:0,bytesUploaded:0,error:f,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],remoteInfo:s,...me};he(this._store,_),this._dispatchPublic(A.FILE_REJECTED,{file:_,reason:f}),(o=t==null?void 0:t.onFileRejected)==null||o.call(t,_,f);continue}const h={id:ve(),status:"idle",file:null,remoteUrl:null,name:s.name,size:s.size,type:s.mimeType,previewUrl:s.thumbnail,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],remoteInfo:s,...me};he(this._store,h),this._dispatchPublic(A.FILE_ADDED,{file:h}),(n=t==null?void 0:t.onFileAdded)==null||n.call(t,h)}this._activeConnector=null,this._store.getState().queueConfig.autoProceed&&this.upload()},this._onConnectorClose=()=>{this._activeConnector=null},this._onConnectorBackdropClick=e=>{e.target===e.currentTarget&&(this._activeConnector=null)},this._onPrimaryAction=()=>{var e,t,r,o,n;this._dispatchPublic(A.COMPLETE_ACTION,{}),(r=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onCompleteAction)==null||r.call(t),((o=this.config)==null?void 0:o.mode)==="modal"?this.close():((n=this.config)==null?void 0:n.clearOnComplete)!==!1&&this._onClearAll()},this._onInlineDismiss=()=>{var e,t,r;(r=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onCancel)==null||r.call(t),this._dispatchPublic(A.CANCEL,{})},this._onSuccessCardClose=()=>{var e,t,r,o;((e=this.config)==null?void 0:e.mode)==="inline"?(this._dispatchPublic(A.COMPLETE_ACTION,{}),(o=(r=(t=this.config)==null?void 0:t.callbacks)==null?void 0:r.onCompleteAction)==null||o.call(r),this._onClearAll()):this._onModalDismiss()},this._onModalDismiss=()=>{var e,t,r,o;this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll()),(o=(r=(t=this.config)==null?void 0:t.callbacks)==null?void 0:r.onCancel)==null||o.call(r),this._dispatchPublic(A.CANCEL,{}),this.close()},this._onMinimize=()=>{this._isMinimized=!0,this._isPillExpanded=!0,this.requestUpdate()},this._onPillClick=()=>{this._isPillExpanded=!this._isPillExpanded,this.requestUpdate()},this._onPillExpand=()=>{this._isMinimized=!1,this._isPillExpanded=!1,this._isOpen=!0,this.requestUpdate()},this._onPillDismiss=()=>{var e,t,r,o;this._isMinimized=!1,this._isPillExpanded=!1,this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll()),(o=(r=(t=this.config)==null?void 0:t.callbacks)==null?void 0:r.onCancel)==null||o.call(r),this._dispatchPublic(A.CANCEL,{}),this.close()},this._onModalBackdropClick=e=>{e.target===e.currentTarget&&this._onModalDismiss()},this._bodyLeaveTimer=null,this._onBodyDragEnter=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!0},this._onBodyDragOver=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!0},this._onBodyDragLeave=e=>{e.preventDefault(),this._bodyLeaveTimer&&clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=setTimeout(()=>{this._bodyDragOver=!1,this._bodyLeaveTimer=null},80)},this._onBodyDrop=e=>{var r;e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!1;const t=Array.from(((r=e.dataTransfer)==null?void 0:r.files)??[]);t.length>0&&this._onFilesSelected(new CustomEvent("files-selected",{detail:{files:t}}))},this._onKeyDown=e=>{var t,r;if(e.key==="Escape"){if(this._fullscreenPreviewUrl||this._fullscreenVideoFile){this._onFsClose();return}const o=((t=this.config)==null?void 0:t.mode)??"modal",n=((r=this.config)==null?void 0:r.header)??(o==="modal"?"close":!0);(n==="close"||n==="back")&&(o==="modal"&&this._isOpen?this._onModalDismiss():o==="inline"&&this._onInlineDismiss())}},this._dimCache=new Map,this._onSplitPointerDown=e=>{var r;e.preventDefault(),this._isResizing=!0;const t=(r=this.shadowRoot)==null?void 0:r.querySelector(".preview-layout");t==null||t.classList.add("resizing"),e.target.setPointerCapture(e.pointerId)},this._onSplitPointerMove=e=>{if(!this._isResizing||this._splitRafId)return;const t=e.clientX;this._splitRafId=requestAnimationFrame(()=>{var s;this._splitRafId=0;const r=(s=this.shadowRoot)==null?void 0:s.querySelector(".preview-layout");if(!r)return;const o=r.getBoundingClientRect(),n=(t-o.left)/o.width*100;this._splitPct=Math.max(25,Math.min(75,n))})},this._onSplitPointerUp=()=>{var t;this._isResizing=!1,this._splitRafId&&(cancelAnimationFrame(this._splitRafId),this._splitRafId=0);const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".preview-layout");e==null||e.classList.remove("resizing")},this._onFsToggleZoom=e=>{e==null||e.stopPropagation(),this._fullscreenZoomed=!this._fullscreenZoomed,this._fullscreenZoomed||(this._fsPanX=0,this._fsPanY=0)},this._onFsOverlayClick=e=>{this._fsDragDidMove||this._onFsToggleZoom(e)},this._fsDragDidMove=!1,this._onFsPanStart=e=>{this._fullscreenZoomed&&(this._fsDragging=!0,this._fsDragDidMove=!1,this._fsDragStartX=e.clientX,this._fsDragStartY=e.clientY,this._fsPanStartX=this._fsPanX,this._fsPanStartY=this._fsPanY,e.preventDefault())},this._onFsPanMove=e=>{if(!this._fsDragging)return;const t=e.clientX-this._fsDragStartX,r=e.clientY-this._fsDragStartY;(Math.abs(t)>3||Math.abs(r)>3)&&(this._fsDragDidMove=!0),this._fsPanX=this._fsPanStartX+t,this._fsPanY=this._fsPanStartY+r,this.requestUpdate()},this._onFsPanEnd=()=>{this._fsDragging=!1,requestAnimationFrame(()=>{this._fsDragDidMove=!1})},this._onFsTouchStart=e=>{if(!this._fullscreenZoomed||e.touches.length!==1)return;const t=e.touches[0];this._fsDragging=!0,this._fsDragDidMove=!1,this._fsDragStartX=t.clientX,this._fsDragStartY=t.clientY,this._fsPanStartX=this._fsPanX,this._fsPanStartY=this._fsPanY},this._onFsTouchMove=e=>{if(!this._fsDragging||e.touches.length!==1)return;const t=e.touches[0],r=t.clientX-this._fsDragStartX,o=t.clientY-this._fsDragStartY;(Math.abs(r)>3||Math.abs(o)>3)&&(this._fsDragDidMove=!0),this._fsPanX=this._fsPanStartX+r,this._fsPanY=this._fsPanStartY+o,this.requestUpdate(),e.preventDefault()},this._onFsClose=e=>{e==null||e.stopPropagation(),this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._fullscreenZoomed=!1,this._fsPanX=0,this._fsPanY=0},this._store=_r(),this._storeCtrl=new Jr(this,this._store)}open(){var e,t,r;this._isMinimized&&(this._isMinimized=!1,this._isPillExpanded=!1),!this._isOpen&&(this._isOpen=!0,(r=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onOpen)==null||r.call(t),this._dispatchPublic(A.OPEN,{}),this.requestUpdate())}close(){var e,t,r,o;this._isOpen&&(this._isOpen=!1,this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),((e=this.config)==null?void 0:e.clearOnClose)!==!1&&this._onClearAll(),this._previewFileId=null,(o=(r=(t=this.config)==null?void 0:t.callbacks)==null?void 0:r.onClose)==null||o.call(r),this._dispatchPublic(A.CLOSE,{}),this.requestUpdate())}upload(){var o,n,s,l,d,f,h;if(this._ensureEngine(),!this._engine){console.warn("[sfx-uploader] Cannot upload: auth not resolved yet");return}const e=[...this._store.getState().files.values()].filter(_=>_.status==="idle"||_.status==="queued");if((n=(o=this.config)==null?void 0:o.callbacks)!=null&&n.onBeforeUpload&&this.config.callbacks.onBeforeUpload(e)===!1)return;const t=new CustomEvent(A.BEFORE_UPLOAD,{bubbles:!0,composed:!0,cancelable:!0,detail:{files:e}});this.dispatchEvent(t)&&(this._dispatchPublic(A.UPLOAD_STARTED,{files:e}),(d=(l=(s=this.config)==null?void 0:s.callbacks)==null?void 0:l.onUploadStarted)==null||d.call(l,e),this._engine.uploadAll(),(f=this.config)!=null&&f.minimizeOnUpload&&((h=this.config)==null?void 0:h.mode)!=="inline"&&(this._isMinimized=!0,this._isPillExpanded=!0,this.requestUpdate()))}addFiles(e){this._processIncomingFiles(e)}resumeUpload(e){var t;if(e&&e.length>0){const r=this._store.getState().files,o=new Map(r);let n=!1;for(const s of e){const l=r.get(s.id);l&&(o.set(s.id,{...l,...s}),n=!0)}n&&this._store.setState({files:o})}this._ensureEngine(),(t=this._engine)==null||t.uploadAll()}cancelUpload(){var e;(e=this._engine)==null||e.cancelAll()}pauseFile(e){var t;(t=this._engine)==null||t.pauseFile(e)}resumeFile(e){var t;(t=this._engine)==null||t.resumeFile(e)}getFiles(){return[...this._store.getState().files.values()]}getFile(e){return this._store.getState().files.get(e)}updateFileMeta(e,t,r){const o=this._store.getState().files,n=o.get(e);if(!n||!G._MODIFIABLE_STATUSES.has(n.status))return;const s=new Map(o);s.set(e,{...n,meta:t!=null?{...n.meta,...t}:n.meta,tags:r??n.tags}),this._store.setState({files:s})}updateFilesMeta(e){const t=this._store.getState().files,r=new Map(t);let o=!1;for(const{fileId:n,meta:s,tags:l}of e){const d=t.get(n);!d||!G._MODIFIABLE_STATUSES.has(d.status)||(r.set(n,{...d,meta:s!=null?{...d.meta,...s}:d.meta,tags:l??d.tags}),o=!0)}o&&this._store.setState({files:r})}updated(e){if(e.has("config")&&this.config&&this._applyConfig(this.config),e.has("_previewFileId")&&this._previewFileId){const t=this._previewFileId,r=this._store.getState().files.get(t);r?this._getImageDimensions(r).then(o=>{this._previewFileId===t&&(this._previewDims=o?`${o.w} × ${o.h}`:"—")}):this._previewDims="—"}this._applyDefaultPreviewWidth(),this._updateFloatingPortal()}_applyDefaultPreviewWidth(){var r;const e=(r=this.shadowRoot)==null?void 0:r.querySelector(".preview-layout");if(!e){this._previewDefaultApplied=!1;return}this._previewDefaultApplied||e.getBoundingClientRect().width<=0||(this._splitPct=62.5,this._previewDefaultApplied=!0)}_injectFloatStyles(){if(document.querySelector("style[data-sfx-upload-float-styles]"))return;const e=document.createElement("style");e.setAttribute("data-sfx-upload-float-styles",""),e.textContent=`
    ...
    `}_renderHeader(){var s,l,d;if(this._phase==="complete")return a.nothing;const e=((s=this.config)==null?void 0:s.mode)??"modal";if(this._phase==="uploading"){const f=this._storeCtrl.state,h=[...f.files.values()],_=h.filter(O=>O.status==="complete").length,E=f.totalSpeed>0?(f.totalBytes-f.totalBytesUploaded)/f.totalSpeed:0;return a.html`
    ...
    `}_getImageDimensions(e){return e.previewUrl?this._dimCache.has(e.id)?Promise.resolve(this._dimCache.get(e.id)):new Promise(t=>{const r=new Image;r.onload=()=>{const o={w:r.naturalWidth,h:r.naturalHeight};this._dimCache.set(e.id,o),t(o)},r.onerror=()=>{this._dimCache.set(e.id,null),t(null)},r.src=e.previewUrl}):Promise.resolve(null)}_renderUploadOverlay(e){var s;const t=this._storeCtrl.state,r=Math.round(t.totalProgress??0),o=e.filter(l=>l.status==="complete").length,n=t.totalSpeed>0?(t.totalBytes-t.totalBytesUploaded)/t.totalSpeed:0;return a.html`
      <div class="upload-overlay">
        ...
        <div class="upload-overlay-subtitle">
          ${o} of ${e.length}
          complete${n>0?a.html` · ~${at(n)} left`:a.nothing}
        </div>
        <div class="upload-overlay-bar">
          <div class="upload-overlay-bar-fill" style="width:${r}%"></div>
        </div>
        ${(s=this.config)!=null&&s.minimizeOnUpload?a.html`<button
    ...
    `}_renderFloatingPill(e){const t=this._storeCtrl.state,r=Math.round(t.totalProgress??0),o=this._phase==="complete",n=e.filter(d=>d.status==="complete").length,s=e.filter(d=>d.status==="failed").length,l=t.totalSpeed>0?(t.totalBytes-t.totalBytesUploaded)/t.totalSpeed:0;return this._isPillExpanded===!1?a.html`
      ...
      <div class="upload-float">
        <div class="float-header">
          <div class="float-header-left">
            ...
            <div>
              ...
              <div class="float-subtitle">
                ${o?`${n} ${n===1?"file":"files"} uploaded${s>0?`, ${s} failed`:""}`:`${n} of ${e.length}${l>0?` · ~${at(l)} left`:""}`}
              </div>
            </div>
          </div>
        ...
        <div class="float-items">
          ${e.map(d=>{const f=d.status==="failed"||d.status==="error";return a.html`
              <div class="float-item">
                <div
                  class="float-item-thumb"
                  style=${d.previewUrl?`background-image:url(${d.previewUrl});background-size:cover;background-position:center`:""}
                >
                  ${d.previewUrl?a.nothing:a.html`<svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        stroke-width="1.5"
                ...
                <div class="float-item-info">
                  ...
                  <div class="float-item-size">${ie(d.size)}</div>
                </div>
                <div class="float-item-status">
                  ${d.status==="complete"?a.html`<div class="float-item-done">
                        <svg
                          viewBox="0 0 24 24"
                          fill="none"
                          stroke="currentColor"
                      ...
                      </div>`:f?a.html` <div class="float-item-error-wrap">
                          <svg
                        ...
                        <button
                          ...
                          @click=${()=>{var h;this._ensureEngine(),(h=this._engine)==null||h.retryFile(d.id)}}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        </button>`:d.status==="paused"?a.html`<svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="#d97706"
                        stroke-width="2"
    ...
    `}_renderPreviewLayout(e){var n,s,l,d,f;if(e.length===0)return a.nothing;const t=e.find(h=>h.id===this._previewFileId)??e[0],r=((n=t.name.split(".").pop())==null?void 0:n.toUpperCase())||"";new Date(t.addedAt).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),this._store.getState().targetFolder;const o=e.reduce((h,_)=>h+(_.size||0),0);return a.html`
        ...
        <div class="preview-panel" style="flex:${100-this._splitPct}">
                ...
                <div class="preview-media-area">
                  <div class="preview-doc-wrap ${Gr(t)}">
                    <img
                      ...
                      src=${Et(r)}
                      alt="${r?`${r} file`:"File"}"
                      @error=${h=>{const _=h.target,E=Pt();!_.dataset.fallback&&_.src!==E&&(_.dataset.fallback="1",_.src=E)}}
                    />
                  </div>
                  <button
                    class="preview-nav prev"
          ...
          ${this._metadataSchema&&((d=this.config)!=null&&d.metadataConfig)?a.html`<div class="preview-meta-list">
                <div class="preview-file-info">
                  ${r}${t.size?` · ${ie(t.size)}`:""}${this._previewDims!=="—"?` · ${this._previewDims}`:""}
                </div>
              </div>`:a.nothing}
      ...
      >
          ...
          ${this._isReviewing?a.html`
              ...
              `:r==="complete"?a.html`
                <sfx-success-card
                  ...
                  .failedFiles=${t.filter(v=>v.status==="failed").map(v=>({id:v.id,name:v.name,error:v.error||"Upload failed"}))}
              ...
              `:r==="uploading"?this._renderUploadOverlay(t):a.html`
                ${n?a.nothing:a.html`<sfx-drop-zone
                        ...
                        .accept=${o}
                        .sources=${this._mergedSources}
                        .sourcesLayout=${((f=this.config)==null?void 0:f.sourcesLayout)??"pills"}
        ...
        ${n&&r!=="complete"&&r!=="uploading"?a.html`
              <sfx-actions-bar
                ...
                .failedCount=${t.filter(v=>v.status==="failed"||v.status==="error").length}
        ...
        ${this._activeConnector&&((O=this.config)!=null&&O.connectors)?a.html`
              <div
        ...
        ${this._bulkMetadataOpen&&this._metadataSchema?a.html`
              <sfx-bulk-metadata-modal
                .schema=${this._metadataSchema}
                .files=${[...this._store.getState().files.values()].filter(v=>G._MODIFIABLE_STATUSES.has(v.status))}
  ...
  `,G._MODIFIABLE_STATUSES=new Set(["idle","queued","rejected"]),G._RESERVED_IDS=new Set(["device","camera","url","screen-cast"]),G);B([S.property({attribute:!1})],I.prototype,"config");B([S.state()],I.prototype,"_isOpen");B([S.state()],I.prototype,"_activeConnector");B([S.state()],I.prototype,"_showUrlDialog");B([S.state()],I.prototype,"_showCameraDialog");B([S.state()],I.prototype,"_showScreenCastDialog");B([S.state()],I.prototype,"_previewFileId");B([S.state()],I.prototype,"_previewDims");B([S.state()],I.prototype,"_fileInfoOpen");B([S.state()],I.prototype,"_splitPct");B([S.state()],I.prototype,"_fullscreenPreviewUrl");B([S.state()],I.prototype,"_fullscreenVideoFile");B([S.state()],I.prototype,"_fullscreenZoomed");B([S.state()],I.prototype,"_bodyDragOver");B([S.state()],I.prototype,"_isMinimized");B([S.state()],I.prototype,"_isPillExpanded");B([S.state()],I.prototype,"_metadataSchema");B([S.state()],I.prototype,"_bulkMetadataOpen");B([S.state()],I.prototype,"_isReviewing");B([S.state()],I.prototype,"_reviewFiles");B([S.state()],I.prototype,"_hasStoredReview");let Dn=I;exports.AuthExpiredError=tt;exports.CORE_SOURCES=ye;exports.PublicEvents=A;exports.SfxActionsBar=W;exports.SfxCameraDialog=fe;exports.SfxDropZone=wn;exports.SfxFileItem=ne;exports.SfxFileList=Z;exports.SfxImportDivider=yt;exports.SfxScreenCastDialog=se;exports.SfxSourcePills=Qe;exports.SfxSuccessCard=ee;exports.SfxUploader=Dn;exports.SfxUrlDialog=Se;exports.Store=wr;exports.UploadEngine=qr;exports.buildAuthHeaders=Je;exports.createStore=_r;exports.exchangeSassKey=Nr;exports.formatFileSize=ie;exports.getApiBase=rt;exports.getAuthUrl=ri;exports.getDefaultFileTypeIconUrl=Pt;exports.getFileTypeIconUrl=Et;exports.getProviderSources=Xr;exports.listFiles=ii;exports.listNextPage=oi;exports.logout=ai;exports.resolveAuth=Yr;exports.searchProvider=ni;
