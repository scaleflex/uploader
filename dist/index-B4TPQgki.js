import { G as vt, H as Ot, I as yt, J as _t, K as wt, L as X, M as _e, N as Ft, O as Lt, Q as re, R as lt, T as Dt, V as zt, W as qt, X as Pt, Y as dt, Z as Bt, _ as Kt, $ as Nt } from "./sfx-uploader-BcgmmN-V.js";
import { a0 as ds, a1 as cs, a2 as us } from "./sfx-uploader-BcgmmN-V.js";
...
function $t(n, e, t = !1) {
  ...
  const d = a.flatMap((f) => f.fields), c = new Map(d.map((f) => [f.key, f])), p = typeof o.force_filling_metadata_on_upload == "boolean" ? o.force_filling_metadata_on_upload : void 0, h = o.regional_variants_groups ?? [];
  return {
    groups: a,
    fields: d,
    fieldsByKey: c,
...
const jt = "https://hub.scaleflex.com/api", me = /* @__PURE__ */ new Map(), oe = /* @__PURE__ */ new Map();
async function es(n, e, t, i) {
...
async function Mt(n, e, t) {
  var p, h, f, b, v;
  const s = `${(t == null ? void 0 : t.hubApiBase) ?? jt}/project/${encodeURIComponent(e)}`, o = (t == null ? void 0 : t.hubHeaders) ?? n, r = await fetch(s, { headers: o });
  if (!r.ok)
    throw new Error(
...
function ts(n) {
  var e;
  n ? (me.delete(n), (e = oe.get(n)) == null || e.catch(() => {
  }), oe.delete(n)) : (me.clear(), oe.clear());
}
...
function Gt(n) {
  ...
  return {
    ...
    active: n.dep_active,
    formatMimetypes: Ut(n.dep_scope),
    ...
    triggerValues: e,
    actions: (n.dep_actions ?? []).map(Ht)
  };
}
function Yt(n) {
  if (!n) return [];
  const e = Array.isArray(n) ? n : n.dependencies;
  return Array.isArray(e) ? e.filter((t) => t == null ? void 0 : t.dep_active).map(Gt) : [];
}
function Jt(n, e, t) {
...
const Zt = 300, ct = 2, ei = 50, ut = "regvar:api", ti = "#ut", ii = {
  CREATE_ONLY: "create_only",
  UPSERT: "upsert"
}, si = (n) => typeof n == "string" && n.startsWith(ti), xe = (n) => `~${n.toUpperCase()}`, ri = (n, e) => {
  if (!(!n || !e))
    return n[e] ?? n[xe(e)];
}, ve = (n, e, t) => {
  var r, a, d;
...
}, pt = (n) => (typeof n == "string" ? n : "").toLowerCase().trim().replace(/[^\d\w]/g, "_").replace(/[\s]/g, "_").replace(/[_]{2,}/g, "_").replace(/[_]*$/g, "").replace(/^[_]*/g, ""), oi = (n) => {
  const e = {}, t = {};
  for (const i of n || [])
  ...
  return e;
}, fe = (n) => typeof n == "string" ? [n] : !n || typeof n != "object" ? [] : [n.sid, n.slug, n.uuid].filter(Boolean), Ee = (n, e, t) => {
  if (t) {
    const o = new Set(e.flatMap(fe));
    return n.filter((r) => !fe(r).some((a) => o.has(a)));
  }
  const i = new Set(n.flatMap(fe)), s = e.filter(
    (o) => !fe(o).some((r) => i.has(r))
  );
  return [...n, ...s];
}, ni = (n, e) => n.map((t) => {
...
const qe = "/v5/meta/ultratags", li = (n, e) => {
...
function ns(n, e) {
  ...
  return {
    list(o) {
      return s(), new Promise((r, a) => {
        t = setTimeout(async () => {
          ...
          try {
            const d = li(n, o), c = await fetch(d, {
              method: "GET",
              headers: e,
              signal: i.signal
            });
    ...
    async getBySids(o) {
      ...
      const r = di(n, o), a = await fetch(r, {
        method: "QUERY",
...
const ui = l`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
...
`;
var xi = Object.defineProperty, T = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && xi(e, t, s), s;
};
...
var mi = Object.defineProperty, Be = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && mi(e, t, s), s;
};
...
var bi = Object.defineProperty, we = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && bi(e, t, s), s;
};
...
var vi = Object.defineProperty, ke = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && vi(e, t, s), s;
};
...
function ge(n) {
  return { label: Ct(n), value: yi(n) };
}
var _i = Object.defineProperty, ae = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && _i(e, t, s), s;
};
    ...
    if (this._activeIndex >= t && (this._activeIndex = Math.max(t - 1, -1)), !(t === 0 && e.key !== "Enter"))
      switch (e.key) {
        ...
        case "Enter": {
          ...
          this._activeIndex >= 0 && this._activeIndex < i.length ? this._addTag(i[this._activeIndex]) : this._activeIndex === i.length && this._canCreate ? this._addTag(ge(this._query)) : this._activeIndex === -1 && this._canCreate ? this._addTag(ge(this._query)) : this._activeIndex === -1 && i.length && this._addTag(i[0]);
          break;
        }
      }
  }
      ...
      this._activeIndex = a;
          ...
          ${this._canCreate ? l`
            <div class="option create ${i === this._activeIndex ? "active" : ""}"
              @mousedown=${(r) => {
      r.preventDefault(), this._addTag(ge(this._query));
    }}
              @mouseenter=${() => {
      this._activeIndex = i;
    }}>
...
var wi = Object.defineProperty, Et = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && wi(e, t, s), s;
};
...
Et([
  x()
], de.prototype, "_activeIndex");
customElements.define("sfx-meta-boolean-field", de);
...
var ki = Object.defineProperty, N = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && ki(e, t, s), s;
};
...
var $i = Object.defineProperty, H = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && $i(e, t, s), s;
};
const Si = (n, e) => !!(e.uuid && n.uuid === e.uuid || e.sid && n.sid === e.sid || e.slug && n.slug === e.slug), Xe = class Xe extends F {
  constructor() {
  ...
  get _items() {
    return Array.isArray(this.value) ? this.value.map((e) => typeof e == "string" ? si(e) ? { sid: e } : { slug: e } : e) : [];
  }
  get _currentLang() {
...
H([
  u({ attribute: !1 })
], P.prototype, "ultratags");
H([
  u({ attribute: !1 })
], P.prototype, "language");
H([
  u({ attribute: !1 })
], P.prototype, "defaultLanguage");
H([
  u({ attribute: !1 })
], P.prototype, "restrictToItems");
H([
  x()
], P.prototype, "_query");
H([
...
customElements.define("sfx-meta-ultratags-field", P);
const ce = "This field is not supported during upload. You can edit it later in the asset library.", It = l`
...
var Ci = Object.defineProperty, j = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && Ci(e, t, s), s;
};
...
var Ei = Object.defineProperty, he = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && Ei(e, t, s), s;
};
...
var Ii = Object.defineProperty, $e = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && Ii(e, t, s), s;
};
...
function Tt(n, e, t, i, s) {
  const o = s ?? "en", r = !!n.regional_variants_group_uuid, a = {
    meta: { [n.key]: e }
  }, d = ze(n, t, a, s), c = (b) => r && b !== null && typeof b == "object" && !Array.isArray(b), p = c(e) ? e[o] : e, h = c(d) ? d[o] : d, f = Ai(i, p, h, n.type);
  return r ? {
    ...c(e) ? e : {},
    [o]: f
  } : f;
...
`;
var qi = Object.defineProperty, k = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && qi(e, t, s), s;
};
const st = class st extends D {
  ...
  _refreshMissingRequired() {
    const t = !!this.schema && !!this.config && qt(this.schema, this.config) ? Pt(
      this._staged,
      this._originalFiles,
      this.schema,
      this.config ?? void 0,
    ...
    if (this.schema && t.size > 0) {
      for (const r of this.schema.fields)
        if (t.has(r.key)) {
          i = r.key;
          break;
        }
...
var Ki = Object.defineProperty, z = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && Ki(e, t, s), s;
}, M;
const L = (M = class extends D {
  ...
  willUpdate(e) {
    e.has("field") && this.field && (this._availableOps = Ti(this.field.type), this._operation = "SET", this._value = void 0, this._pendingTaxonode = null, this._emitPendingChange());
  }
  _onOpSelect(e) {
...
}, M.styles = [Fi], M._ENTER_APPLY_TYPES = /* @__PURE__ */ new Set([
  "text",
  "numeric",
  "decimal2",
  "date",
...
let Ni = L;
customElements.define("sfx-bulk-meta-op-bar", Ni);
var ji = Object.defineProperty, B = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && ji(e, t, s), s;
};
...
var Mi = Object.defineProperty, q = (n, e, t, i) => {
  for (var s = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (s = r(e, t, s) || s);
  return s && Mi(e, t, s), s;
};
...
const Vi = /* @__PURE__ */ new Set(["multi-select", "tags", "ultratags"]);
function gt(n, e, t) {
...
function Yi(n, e, t, i) {
  ...
  if (Vi.has(n.type)) {
    ...
    const d = xt(r), c = xt(a);
    return n.type === "tags" ? { kind: "array", items: Ui(d, c) } : { kind: "array", items: Gi(d, c, n) };
  }
  return {
    kind: "scalar",
    oldDisplay: bt(n, r),
...
export {
  ...
  ss as clearDependenciesCache,
  ts as clearSchemaCache,
  rs as createTagsAutocomplete,
  os as createTaxonomyService,
  ns as createUltratagsService,
  ds as deepMergeMeta,
  is as fetchDependencies,
  es as fetchMetadataSchema,
  cs as getFilesWithMissingRequired,
  us as isAssetHasMetadataValue,
  re as isEmpty,
