...
function qe(n, e) {
  const t = (e == null ? void 0 : e.language) ?? "en", s = n.model ?? [], i = n.store ?? {}, o = s.find((p) => p.applies_to === "FILES");
  let r = (o == null ? void 0 : o.groups) ?? [];
  if (Array.isArray(e == null ? void 0 : e.fields)) {
    const p = new Set(e.fields);
    r = r.map((b) => ({
      ...b,
      fields: b.fields.filter((m) => p.has(m.ckey))
    })).filter((b) => b.fields.length > 0);
  }
  r = r.map((p) => ({
    ...p,
    fields: p.fields.filter((b) => !b.hide)
  })).filter((p) => p.fields.length > 0);
  const l = r.flatMap((p) => p.fields), c = new Map(l.map((p) => [p.key, p])), f = i.force_filling_metadata_on_upload === !0, u = i.regional_variants_groups ?? [];
  return {
    groups: r,
    fields: l,
    fieldsByKey: c,
    forceFillingOnUpload: f,
    regionalVariantsGroups: u,
    language: t
  };
}
const We = "https://hub.scaleflex.com/api", J = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map();
...
async function Xe(n, e, t) {
  var f, u, p;
  const i = `${(t == null ? void 0 : t.hubApiBase) ?? We}/project/${encodeURIComponent(e)}`, o = (t == null ? void 0 : t.hubHeaders) ?? n, r = await fetch(i, { headers: o });
  if (!r.ok)
    throw new Error(
      `Failed to fetch metadata schema (HTTP ${r.status})`
    );
  const l = await r.json(), c = ((u = (f = l.data) == null ? void 0 : f.project) == null ? void 0 : u.data) ?? ((p = l.project) == null ? void 0 : p.data);
  if (!(c != null && c.metadata))
    throw new Error("No metadata in project response");
  return qe(c.metadata, t);
}
function Pt(n) {
  var e;
  ...
  switch (n.type) {
    ...
    case "date": {
      if (!e)
        ...
        const r = e instanceof Date ? e : new Date(e), l = r.getFullYear(), c = String(r.getMonth() + 1).padStart(2, "0"), f = String(r.getDate()).padStart(2, "0");
        i = `${l}-${c}-${f}`;
      }
      break;
    }
  ...
  return {
    search(o, r, l) {
      ...
      t = setTimeout(async () => {
        ...
        try {
          const f = `${n}/v5/metadata/autocomplete?q=${encodeURIComponent(r.trim())}&meta_key=_${encodeURIComponent(o)}&limit=20`, u = await fetch(f, { headers: e, signal: s.signal });
          if (i) return;
          if (!u.ok) {
            l([]);
            return;
          ...
          if (i) return;
          const b = ((c = p.data) == null ? void 0 : c.tags) ?? p.tags ?? [];
          l(
            b.map((m) => ({
              sid: m.sid || void 0,
...
const xe = class xe extends k {
  ...
  get _isRequired() {
    return Le(this.field, this.config ?? void 0);
  }
  _onFieldBlur(e) {
    var r;
    const { key: t, value: s } = e.detail, i = Be(this.field, s, this.config ?? void 0);
    if (i) {
      this._error = i;
      return;
    }
  ...
  render() {
    ...
    const e = this.field;
    if (!e) return h;
    const t = je(e, this.value, (o = this.config) == null ? void 0 : o.language), i = e.type === "textarea" ? "field-row field-row--top" : "field-row";
    return a`
...
customElements.define("sfx-metadata-field", A);
...
customElements.define("sfx-meta-select-field", K);
          ...
          <div class="options-list">
            ${this._filtered.length ? this._filtered.map((r, l) => a`
                  <div class="option ${l === this._activeIndex ? "active" : ""}" role="option" aria-selected=${e.includes(r.value)}
                    @mousedown=${(c) => {
      c.preventDefault(), this._toggle(r);
    }}
                    @mouseenter=${() => {
      this._activeIndex = l;
    }}>
...
customElements.define("sfx-meta-multi-select-field", N);
function T(n, e) {
  var t, s;
...
var nt = Object.defineProperty, H = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && nt(e, t, i), i;
};
const ye = class ye extends _ {
  ...
  _addTag(e) {
    if (this._tags.some((s) => T(s, e))) return;
  ...
  _removeTag(e) {
    const t = this._tags.filter((s) => !T(s, e));
    this.value = t, this._emit("field-change", t);
  }
  _onBlur() {
  ...
  get _suggestions() {
    var o;
    const e = this._query.toLowerCase().trim(), t = this._tags, s = (((o = this.field) == null ? void 0 : o.possible_values) ?? []).map((r) => ({ value: r.api_value || r.internal_unique_value, label: r.label })).filter((r) => !t.some((l) => T(l, r))).filter((r) => !e || r.label.toLowerCase().includes(e)), i = this._results.filter(
      (r) => !t.some((l) => T(l, r)) && !s.some((l) => T(l, r))
    );
    return [...s, ...i];
  }
  get _canCreate() {
    ...
    const t = X(e);
    return !this._tags.some((s) => T(s, t)) && !this._suggestions.some((s) => T(s, t));
  }
  render() {
    var i, o;
        ...
        <div class="dropdown" role="listbox">
          ...
          ${t.map((r, l) => a`
            <div class="option ${l === this._activeIndex ? "active" : ""}" role="option"
              @mousedown=${(c) => {
      c.preventDefault(), this._addTag(r);
    }}
              @mouseenter=${() => {
      this._activeIndex = l;
    }}>
...
var at = Object.defineProperty, Ve = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && at(e, t, i), i;
};
const P = [
  ...
  get _currentLabel() {
    ...
    return ((t = P.find((s) => s.value === e)) == null ? void 0 : t.label) ?? "";
  }
  disconnectedCallback() {
    super.disconnectedCallback(), document.removeEventListener("mousedown", this._boundOutsideClick);
  }
  _openDropdown() {
    ...
    this._activeIndex = Math.max(P.findIndex((t) => t.value === e), 0), document.addEventListener("mousedown", this._boundOutsideClick), this.updateComplete.then(() => {
      var t;
  ...
  _onKeydown(e) {
    ...
    switch (e.key) {
      case "ArrowDown":
        e.preventDefault(), this._activeIndex = Math.min(this._activeIndex + 1, P.length - 1), this._scrollActive();
        break;
      case "ArrowUp":
        e.preventDefault(), this._activeIndex = Math.max(this._activeIndex - 1, 0), this._scrollActive();
        break;
      case "Home":
        ...
        break;
      case "End":
        e.preventDefault(), this._activeIndex = P.length - 1, this._scrollActive();
        break;
      case "Enter":
      case " ":
        this._activeIndex >= 0 && this._activeIndex < P.length && (e.preventDefault(), this._onSelect(P[this._activeIndex], !0));
        break;
    }
  }
  render() {
        ...
        <div class="dropdown" role="listbox" tabindex="-1" @keydown=${this._onKeydown}>
          ${P.map((r, l) => a`
            <div class="option ${r.value === e ? "selected" : ""} ${l === this._activeIndex ? "active" : ""}"
              ...
              @mousedown=${(c) => {
      c.preventDefault(), this._onSelect(r);
    }}
              @mouseenter=${() => {
      this._activeIndex = l;
    }}>
...
var dt = Object.defineProperty, Me = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && dt(e, t, i), i;
};
      ...
      case "multi-select":
        return !Array.isArray(e) || e.length === 0 ? "" : e.map((o) => {
          ...
          const r = (l = this.field.possible_values) == null ? void 0 : l.find(
            (c) => c.internal_unique_value === o || c.api_value === o
          );
  ...
  switch (n) {
    ...
    case "ADD": {
      if (i) {
        ...
        if (s === "tags") {
          const u = new Set(r.map((b) => b)), p = [...r];
          for (const b of l) {
            const m = typeof b == "string" ? b : String(b);
            u.has(m) || (u.add(m), p.push(m));
          }
          return p;
        }
        const c = new Set(r.map((u) => JSON.stringify(u))), f = [...r];
        for (const u of l) {
          const p = JSON.stringify(u);
          c.has(p) || (c.add(p), f.push(u));
        }
        return f;
      }
      if (o) {
    ...
    case "DELETE": {
      if (i) {
        ...
        if (s === "tags") {
          ...
          return r.filter(
            (u) => !f.has(typeof u == "string" ? u : String(u))
          );
        }
        const c = new Set(
          l.map((f) => JSON.stringify(f))
        );
        return r.filter(
          (f) => !c.has(JSON.stringify(f))
        );
      }
      if (o) {
        const r = typeof t == "string" ? t : "";
...
function He(n, e, t, s, i) {
  const o = i ?? "en", r = !!n.regional_variants_group_uuid, l = {
    meta: { [n.key]: e }
  }, c = ae(n, t, l, i), f = (m) => r && m !== null && typeof m == "object" && !Array.isArray(m), u = f(e) ? e[o] : e, p = f(c) ? c[o] : c, b = pt(s, u, p, n.type);
  return r ? {
    ...f(e) ? e : {},
    [o]: b
  } : b;
...
`;
var mt = Object.defineProperty, $ = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && mt(e, t, i), i;
};
const Ee = class Ee extends k {
  constructor() {
    super(...arguments), this.files = [], this.config = null, this.initialFieldKey = null, this._activeFieldKey = "", this._staged = /* @__PURE__ */ new Map(), this._selected = /* @__PURE__ */ new Set(), this._sortAsc = !0, this._pendingOp = null, this._confirmVisible = !1, this._confirmResolve = null, this._originalFiles = /* @__PURE__ */ new Map(), this._onKeyDown = async (e) => {
      ...
      const i = s[0], o = s[s.length - 1], r = (c = this.shadowRoot) == null ? void 0 : c.activeElement;
      ...
      q(s) && (!i || oe(t, i.type)) ? this._pendingOp = null : this._pendingOp = { operation: t, value: s };
      ...
      if (!t) return;
      const { operation: s, value: i } = e.detail, o = (l = this.config) == null ? void 0 : l.language, r = [];
      for (const u of this._selected) {
        const p = this._staged.get(u), b = p != null && p.has(t.key) ? p.get(t.key) : ((f = (c = this._originalFiles.get(u)) == null ? void 0 : c.meta) == null ? void 0 : f[t.key]) ?? null, m = He(
          t,
          b,
          i,
          s,
      ...
      for (const [t, s] of this._staged) {
        ...
        const o = {};
        for (const [r, l] of s)
          JSON.stringify(l) !== JSON.stringify(i.meta[r]) && (o[r] = l);
  ...
  _initStaged() {
    ...
    for (const f of this.files) {
      ...
      if (f.meta)
        for (const [p, b] of Object.entries(f.meta))
          u.set(p, b);
      e.set(f.id, u), t.add(f.id), s.set(f.id, f);
    }
    this._staged = e, this._selected = t, this._originalFiles = s;
    const i = this.initialFieldKey;
    i && ((r = (o = this.schema) == null ? void 0 : o.fieldsByKey) != null && r.has(i)) ? this._activeFieldKey = i : ((c = (l = this.schema) == null ? void 0 : l.fields) == null ? void 0 : c.length) > 0 && (this._activeFieldKey = this.schema.fields[0].key);
  }
  // -----------------------------------------------------------------------
  ...
  get _filledFields() {
    ...
    for (const i of ((t = this.schema) == null ? void 0 : t.fields) ?? [])
      for (const [o, r] of this._staged) {
        const l = r.get(i.key), c = (s = this._originalFiles.get(o)) == null ? void 0 : s.meta[i.key];
        if (l !== void 0 && !q(l) && JSON.stringify(l) !== JSON.stringify(c)) {
          e.add(i.key);
          break;
        }
      }
  ...
  get _hasPendingValue() {
    return this._pendingOp != null && !q(this._pendingOp.value);
  }
...
var yt = Object.defineProperty, Y = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && yt(e, t, i), i;
};
const Ae = class Ae extends k {
  ...
  _isRequired(e) {
    return Le(e, this.config ?? void 0);
  }
  _toggleGroup(e) {
    const t = new Set(this._collapsed);
    t.has(e) ? t.delete(e) : t.add(e), this._collapsed = t;
...
var _t = Object.defineProperty, L = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && _t(e, t, i), i;
}, S;
const D = (S = class extends k {
  constructor() {
  ...
  get _isApplyDisabled() {
    ...
    if (this._operation === "DELETE") {
      ...
      return s.has((e = this.field) == null ? void 0 : e.type) ? q(this._value) : i.has((t = this.field) == null ? void 0 : t.type) ? q(this._value) : !1;
    }
...
var kt = Object.defineProperty, B = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && kt(e, t, i), i;
};
...
var $t = Object.defineProperty, z = (n, e, t, s) => {
  for (var i = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (i = r(e, t, i) || i);
  return i && $t(e, t, i), i;
};
const Oe = class Oe extends k {
  constructor() {
    super(...arguments), this.selected = !1, this.pendingOp = null, this.config = null, this._error = null, this._onFieldBlur = (e) => {
      var r;
      e.stopPropagation();
      const { value: t } = e.detail, s = Be(this.field, t, this.config ?? void 0);
      if (s) {
        this._error = s;
        return;
      }
  ...
  _computePreviewValue() {
    ...
    return !e || !this.field ? this.value : He(
      this.field,
      this.value,
      e.value,
      e.operation,
...
function St(n, e) {
  const t = n.map((l) => typeof l == "string" ? l : String(l)), s = e.map((l) => typeof l == "string" ? l : String(l)), i = new Set(t), o = new Set(s), r = [];
  for (const l of s)
...
function Et(n, e, t) {
  ...
  for (const r of e) {
    const l = JSON.stringify(r), c = typeof r == "string" ? ne(t, r) : String(r);
    o.push({ label: c, state: s.has(l) ? "kept" : "added" });
  }
  for (const r of n) {
    const l = JSON.stringify(r);
    if (!i.has(l)) {
      const c = typeof r == "string" ? ne(t, r) : String(r);
      o.push({ label: c, state: "removed" });
    }
  }
  return o;
}
function At(n, e, t, s) {
  ...
  if (Ct.has(n.type)) {
    const l = Pe(o), c = Pe(r);
    return n.type === "tags" ? { kind: "array", items: St(l, c) } : { kind: "array", items: Et(l, c, n) };
  }
  return {
    kind: "scalar",
    oldDisplay: Re(n, o),
...
Z([
  d({ attribute: !1 })
], R.prototype, "newValue");
Z([
  d({ attribute: !1 })
], R.prototype, "config");
customElements.define("sfx-bulk-meta-diff-view", R);
export {
  v as SfxBulkMetadataModal,
  Pt as clearSchemaCache,
  Ft as createTagsAutocomplete,
  Bt as deepMergeMeta,
  Tt as fetchMetadataSchema,
  qt as getFilesWithMissingRequired,
  jt as isAssetHasMetadataValue,
  q as isEmpty,
  je as mapValueFromBackend,
  ae as mapValueToBackend,
  qe as parseMetadataSchema,
  Be as validateField
};
