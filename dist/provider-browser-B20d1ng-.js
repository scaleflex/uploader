...
import { w as P, y as C, z as A, A as y, B as I, o as M, D as B, E as L, F as $, G as V } from "./sfx-uploader-CsfmZlqJ.js";
...
const w = class w extends S {
  ...
  async _loadFolder(e) {
    ...
    try {
      const r = await B(this.companionUrl, this.provider, t, e);
  ...
  async _onLoadMore() {
    ...
    if (!(!e || !this._nextPagePath)) {
      this._loadingMore = !0;
      try {
        const t = await L(this.companionUrl, e, this._nextPagePath);
