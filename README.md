...
<p align="center">
  ...
  <a href="https://cdn.scaleflex.com/uploader/1.2.1/sfx-uploader.min.js">CDN</a> |
...
```
https://cdn.scaleflex.com/uploader/1.2.1/sfx-uploader.min.js
```

```html
<script src="https://cdn.scaleflex.com/uploader/1.2.1/sfx-uploader.min.js"></script>
```
