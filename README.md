...
<p align="center">
  ...
  <a href="https://cdn.scaleflex.com/uploader/0.2.9/sfx-uploader.min.js">CDN</a> |
...
```
https://cdn.scaleflex.com/uploader/0.2.9/sfx-uploader.min.js
```

```html
<script src="https://cdn.scaleflex.com/uploader/0.2.9/sfx-uploader.min.js"></script>
```
