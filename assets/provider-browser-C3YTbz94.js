          ...
          <div class="auth-ring">
            <div class="auth-logo">
              ${e!=null&&e.brandHtml?n`<span
                    ${H({display:"flex","align-items":"center","justify-content":"center",transform:"scale(2.2)"})}
                    >${$(e)}</span
                  >`:n`<svg
                    viewBox="0 0 24 24"
                    fill="none"
