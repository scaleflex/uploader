import{b as f}from"./index-B1yw8uEx.js";import{r as b}from"./code-block-C_3oxnLY.js";import{i as w}from"./custom-select-mLCaw8r4.js";const S={auto:"Auto",mobile:"Mobile",tablet:"Tablet",desktop:"Desktop",hq:"HQ",sample:"Sample"};let r=!0,n=!1,d=!1,l,i,c=!1,p="auto",g=!1;function x(){const t={};return d&&(t.resize=!0,l!=null&&(t.maxWidth=l),i!=null&&(t.maxHeight=i)),c&&(t.transcode=!0,t.resolution=p,t.protocol="hls"),g&&(t.resumable=!0),t}function h(){if(!r)return!1;const t=x(),o=Object.keys(t).length>0;if(!n&&!o)return;const e={};return n&&(e.showResumableSwitcher=!0),o&&(e.defaults=t),e}function a(){const t=document.getElementById("code-container");if(!t)return;t.innerHTML="";const o=h();let e;if(o===!1)e=`
