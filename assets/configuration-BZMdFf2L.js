    ...
    sassKey: string,
        ...
        <table class="config-table">
          ...
          <tbody>
            ...
            <tr><td><code>getLocateUrl</code></td><td><code>(file) =&gt; string | null | undefined</code></td><td><code>undefined</code></td><td>Host-supplied builder for the "Locate" button URL. Receives the completed <code>UploadFile</code> and should return a URL. Return <code>null</code> / <code>undefined</code> to fall back to the <code>adminUrl</code>-based default. When both are absent, Locate fires its event / callback but doesn't navigate. Pairs with <code>showLocateButton: true</code>.</td></tr>
            <tr><td><code>adminUrl</code></td><td><code>string</code></td><td><code>undefined</code></td><td>Base URL of the Filerobot admin / DAM app — used to build the default Locate target when <code>getLocateUrl</code> is not provided. The uploader navigates to <code>\${adminUrl}/library?lf=&lt;base64(uuid)&gt;</code>, the same deep-link the admin uses internally to scroll to and select a file. No default — hosts know their own admin deployment URL.</td></tr>
