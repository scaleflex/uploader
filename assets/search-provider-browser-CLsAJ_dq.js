import{i as x,a as g,g as b,s as u,c as s,A as d,n as f,r as n}from"./index-Do7Se9LN.js";var v=Object.defineProperty,a=(c,r,e,t)=>{for(var i=void 0,l=c.length-1,h;l>=0;l--)(h=c[l])&&(i=h(r,e,i)||i);return i&&v(r,e,i),i};const p=class p extends x{constructor(){super(...arguments),this.provider="unsplash",this.companionUrl="",this._loading=!1,this._loadingMore=!1,this._items=[],this._selectedIds=new Set,this._error=null,this._searchQuery="",this._nextPageQuery=null,this._searched=!1,this._onResultsScroll=r=>{if(!this._nextPageQuery||this._loadingMore)return;const e=r.target;e.scrollHeight-e.scrollTop-e.clientHeight<200&&this._onLoadMore()},this._onSearchInput=r=>{this._searchQuery=r.target.value},this._onSearchKeydown=r=>{r.key==="Enter"&&this._doSearch()},this._onAddSelected=()=>{const e=this._items.filter(t=>this._selectedIds.has(t.id)).map(t=>({companionUrl:this.companionUrl,provider:this.provider,token:"",requestPath:t.requestPath,fileId:t.id,name:t.name||t.id,mimeType:t.mimeType,size:t.size,thumbnail:t.thumbnail}));this.dispatchEvent(new CustomEvent("connector-files-selected",{detail:{files:e},bubbles:!0,composed:!0}))},this._onClose=()=>{this.dispatchEvent(new CustomEvent("connector-close",{bubbles:!0,composed:!0}))}}get _providerLabel(){var e;return((e=b([this.provider])[0])==null?void 0:e.label)??this.provider}async _doSearch(){const r=this._searchQuery.trim();if(r){this._loading=!0,this._error=null,this._items=[],this._selectedIds=new Set,this._nextPageQuery=null,this._searched=!0;try{const e=await u(this.companionUrl,this.provider,r),t=new Set;this._items=e.items.filter(i=>t.has(i.id)?!1:(t.add(i.id),!0)),this._nextPageQuery=e.nextPageQuery}catch(e){this._error=e instanceof Error?e.message:"Search failed"}finally{this._loading=!1}}}async _onLoadMore(){if(!(!this._nextPageQuery||this._loadingMore)){this._loadingMore=!0;try{const r=await u(this.companionUrl,this.provider,this._searchQuery.trim(),this._nextPageQuery),e=new Set(this._items.map(i=>i.id)),t=r.items.filter(i=>!e.has(i.id));this._items=[...this._items,...t],this._nextPageQuery=r.nextPageQuery}catch{}finally{this._loadingMore=!1}}}_toggleSelect(r){const e=new Set(this._selectedIds);e.has(r.id)?e.delete(r.id):e.add(r.id),this._selectedIds=e}render(){return s`
  ...
  `;let o=p;a([f({type:String})],o.prototype,"provider");a([f({type:String})],o.prototype,"companionUrl");a([n()],o.prototype,"_loading");a([n()],o.prototype,"_loadingMore");a([n()],o.prototype,"_items");a([n()],o.prototype,"_selectedIds");a([n()],o.prototype,"_error");a([n()],o.prototype,"_searchQuery");a([n()],o.prototype,"_nextPageQuery");a([n()],o.prototype,"_searched");export{o as SfxSearchProviderBrowser};
