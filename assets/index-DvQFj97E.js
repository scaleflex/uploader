 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class zi extends ti{}zi.directiveName="unsafeSVG",zi.resultType=2;const Ce=oi(zi);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xc=oi(class extends Wi{constructor(r){var e;if(super(r),r.type!==Yi.ATTRIBUTE||r.name!=="class"||((e=r.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var i,o;if(this.st===void 0){this.st=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!((i=this.nt)!=null&&i.has(s))&&this.st.add(s);return this.render(e)}const t=r.element.classList;for(const s of this.st)s in e||(t.remove(s),this.st.delete(s));for(const s in e){const n=!!e[s];n===this.st.has(s)||(o=this.nt)!=null&&o.has(s)||(n?(t.add(s),this.st.add(s)):(t.remove(s),this.st.delete(s)))}return he}});function Ie(r){return r.brandStyle?f`<span
    class=${xc({"brand-ico":!0,"brand-ico--transparent":r.brandStyle.background==="transparent"})}
    ${Q(r.brandStyle)}
  >${Co(r.brandHtml)}</span>`:Co(r.brandHtml)}var vc=Object.defineProperty,Es=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&vc(e,t,o),o};const bc='<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>',yc='<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>',wc='<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>',_c='<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>',ft=[{id:"device",labelKey:"myDevice",label:"My Device",icon:bc,iconColor:"#2563eb"},{id:"url",labelKey:"urlLink",label:"URL link",icon:yc,iconColor:"#16a34a"},{id:"camera",labelKey:"camera",label:"Camera",icon:wc,iconColor:"#7c3aed"},{id:"screen-cast",labelKey:"screenCapture",label:"Screen capture",icon:_c,iconColor:"#ea580c"}],pr=class pr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.sources=ft}_handleClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}render(){return f`
      ${this.sources.map(e=>f`
          <button @click=${()=>this._handleClick(e)}>
            ${e.brandHtml?Ie(e):Fe`<svg viewBox="0 0 24 24" class=${e.fillIcon?"fill-icon":""}>${Ce(e.icon)}</svg>`}
  ...
  `;let Ut=pr;Es([O({attribute:!1})],Ut.prototype,"t");Es([O({type:Array})],Ut.prototype,"sources");const Ii={LANGUAGES:"FTYPE_LANGUAGES"};function fd(r,e){if(!r.regional_variants_group_uuid)return;const t=e==null?void 0:e.regionalFilters;return t&&r.regional_variants_group_uuid in t?t[r.regional_variants_group_uuid]:e==null?void 0:e.language}function hd(r,e,t,i){if(!r.regional_variants_group_uuid||!e)return;const o=e.find(a=>a.uuid===r.regional_variants_group_uuid);if(!o)return;const s=(t==null?void 0:t[o.uuid])??i,n=o.variants.find(a=>a.api_value===s);if(n)return`${o.label}: ${n.label}`}function kc(r,e){var i;const t={};for(const o of r??[]){if(!((i=o.variants)!=null&&i.length))continue;const s=o.type===Ii.LANGUAGES?Sc(o.variants,e):void 0;t[o.uuid]=s??o.variants[0].api_value}return t}function Sc(r,e){var n;if(!e)return;const t=e.toLowerCase(),i=t.split("-")[0];let o,s;for(const a of r){const l=(n=a.api_value)==null?void 0:n.toLowerCase();if(l){if(l===t)return a.api_value;!o&&l===i&&(o=a.api_value),!s&&l.split("-")[0]===i&&(s=a.api_value)}}return o??s}const Ps=new Set(["asset-attachments","attachments-assets","integer-list"]),$c=new Set(["face_matcher"]);function gd(r){return Ps.has(r)}function Cc(r){return Ps.has(r.type)||$c.has(r.ckey)}const it="product.ref",rt="product.position",Ec="__product__",Pc=new Set([it,rt]);function Uc(r){return Pc.has(r)}function Rc(r){return r===it?"ref":r===rt?"position":null}function Oc(r){return[{key:it,ckey:it,uuid:"product-ref",title:r("productRefLabel","Product reference"),type:"text",placeholder:r("productRefPlaceholder","e.g. SKU-12345"),required:0,possible_values:[],regional_variants_group_uuid:null,permissions:[]},{key:rt,ckey:rt,uuid:"product-position",title:r("productPositionLabel","Position"),type:"numeric",placeholder:r("productPositionPlaceholder","0"),required:0,possible_values:[],regional_variants_group_uuid:null,permissions:[]}]}function Tc(r){return{uuid:Ec,isRoot:!1,name:r("productFieldsLabel","Product"),fields:Oc(r)}}function Ac(r,e){const t=Tc(e);let i=-1;for(let l=0;l<r.groups.length;l++)r.groups[l].isRoot&&(i=l);const o=i+1,s=[...r.groups.slice(0,o),t,...r.groups.slice(o)],n=s.flatMap(l=>l.fields),a=new Map(n.map(l=>[l.key,l]));return{...r,groups:s,fields:n,fieldsByKey:a}}function md(r,e,t){var o;if((((o=t==null?void 0:t.requiredFields)==null?void 0:o.includes(r.ckey))||!!r.required)&&Di(e))return`${r.title} is required`;if(Di(e))return null;if(r.key===it)return typeof e!="string"||Vn.test(e)?"Reference contains invalid characters":null;if(r.key===rt){const s=Number(e);return!Number.isFinite(s)||!Number.isInteger(s)?"Position must be an integer":null}switch(r.type){case"numeric":{const s=Number(e);if(!Number.isFinite(s))return"Must be a valid number";if(!Number.isInteger(s))return"Must be an integer";if(s<-1999999999||s>1999999999)return"Value out of range (±1,999,999,999)";break}case"decimal2":{const s=Number(e);if(!Number.isFinite(s))return"Must be a valid number";if(!/^\-?\d*\.?\d{0,2}$/.test(String(e)))return"Maximum 2 decimal places";if(s<-999999999999e-2||s>999999999999e-2)return"Value out of range (±9,999,999,999.99)";break}case"geopoint":{const s=e,n=s.latitude!==""&&s.latitude!=null,a=s.longitude!==""&&s.longitude!=null;if(n!==a)return"Both latitude and longitude are required";if(n&&a){const l=Number(s.latitude),c=Number(s.longitude);if(!Number.isFinite(l)||l<-90||l>90)return"Latitude must be between -90 and 90";if(!Number.isFinite(c)||c<-180||c>180)return"Longitude must be between -180 and 180"}break}case"attachment-uri":{try{const s=new URL(e);if(!["http:","https:"].includes(s.protocol))return"Only http and https URLs are allowed"}catch{return"Invalid URI"}break}}if(r.validation&&typeof e=="string")try{if(!new RegExp(r.validation).test(e))return"Value does not match expected format"}catch{}return null}function Di(r){return r==null?!0:Array.isArray(r)||typeof r=="string"?r.length===0:typeof r=="object"?!Object.values(r).some(e=>e!=null&&e!==""):!r}const Lc=new Set(["idle","queued","rejected"]);function nr(r){return!Di(r)}function Us(r,e){var t;return Cc(r)?!1:(t=e==null?void 0:e.requiredFields)!=null&&t.includes(r.ckey)?!0:!!r.required}function ar(r){return[...r.values()].filter(e=>Lc.has(e.status))}function lr(r,e){return r.fields.filter(t=>Us(t,e))}function xd(r,e,t){const i=ar(r);if(i.length===0)return{};const o={};for(const s of lr(e,t)){const n=i.filter(a=>!nr(a.meta[s.key]));n.length>0&&(o[s.key]=n)}return o}function Fc(r,e,t){const i=ar(r);if(i.length===0)return null;for(const o of lr(e,t))if(i.some(n=>!nr(n.meta[o.key])))return o.key;return null}function zc(r,e,t){var o;const i=r.get(e.id);return i&&i.has(t)?i.get(t):(o=e.meta)==null?void 0:o[t]}function vd(r,e,t,i){const o=new Set,s=ar(e);if(s.length===0)return o;for(const n of lr(t,i))s.some(l=>!nr(zc(r,l,n.key)))&&o.add(n.key);return o}function bd(r,e){const t={...r};for(const i of Object.keys(e)){const o=e[i];if(o==null||o==="")continue;const s=r[i];if(Array.isArray(o))if(Array.isArray(s)){const n=new Set(s.map(l=>JSON.stringify(l))),a=[...s];for(const l of o){const c=JSON.stringify(l);n.has(c)||(n.add(c),a.push(l))}t[i]=a}else t[i]=o;else t[i]=o}return t}function Rs(r){let e=r;for(;e;){if(e instanceof ShadowRoot){e=e.host;continue}if(e instanceof HTMLDialogElement&&e.open)return e;if(e instanceof Element&&e.shadowRoot){const t=e.shadowRoot.querySelector("dialog[open]");if(t instanceof HTMLDialogElement)return t}e=e.parentNode}return document.body}var Ic=Object.defineProperty,de=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Ic(e,t,o),o};const Eo=3,ji=new CSSStyleSheet;ji.replaceSync(`
...
`);var Ue;const ne=(Ue=class extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.compact=!1,this.externalDragOver=!1,this.accept="",this.multi=!0,this.directory=!1,this.sources=[],this.sourcesLayout="pills",this.mode="modal",this._resizeObserver=null,this._dragOver=!1,this._moreOpen=!1,this._visiblePills=Eo,this._dragCounter=0,this._onDragEnter=e=>{e.preventDefault(),this._dragCounter++,this._dragCounter===1&&(this._dragOver=!0)},this._onDragOver=e=>{e.preventDefault()},this._onDragLeave=e=>{e.preventDefault(),this._dragCounter--,this._dragCounter<=0&&(this._dragCounter=0,this._dragOver=!1)},this._onDrop=e=>{e.preventDefault(),e.stopPropagation(),this._dragCounter=0,this._dragOver=!1;const t=e.dataTransfer;t&&ws(t).then(({files:i,hadDirectories:o})=>{i.length>0?this._emitFiles(i,o):o&&this.dispatchEvent(new CustomEvent("folder-empty",{bubbles:!0,composed:!0}))})},this._onClick=e=>{const t=this.shadowRoot.querySelector(".dz-content");if(t&&this._rippleEl){const i=t.getBoundingClientRect();this._rippleEl.style.left=`${e.clientX-i.left}px`,this._rippleEl.style.top=`${e.clientY-i.top}px`,this._rippleEl.classList.remove("go"),this._rippleEl.offsetWidth,this._rippleEl.classList.add("go")}this.browse()},this._onKeyDown=e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.browse())},this._onFileChange=e=>{const t=e.target,i=Array.from(t.files??[]);for(const o of i){const s=o.webkitRelativePath;s&&or(o,s)}i.length>0&&this._emitFiles(i),t.value=""},this._onPaste=e=>{var o;if(!this.isConnected||this.offsetWidth===0)return;const t=(o=e.clipboardData)==null?void 0:o.items;if(!t)return;const i=[];for(const s of t)if(s.kind==="file"){const n=s.getAsFile();n&&i.push(n)}i.length>0&&(e.preventDefault(),this._emitFiles(i))},this._portalContainer=null,this._onDocClick=e=>{var t;this._moreOpen&&((t=this._portalContainer)!=null&&t.contains(e.target)||(this._moreOpen=!1,this._updateDropdownPortal()))},this._onDocKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._updateDropdownPortal())},this._resizeTimer=null,this._onScrollOrResize=()=>{this._moreOpen&&this._positionDropdown(),this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(()=>this._updateVisiblePills(),100)}}browse(e="files"){var t,i;if(e==="folder"&&this.directory&&this.multi){(t=this.folderInput)==null||t.click();return}(i=this.fileInput)==null||i.click()}_onSourceIconClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}_emitFiles(e,t=!1){this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:e,hadDirectories:t},bubbles:!0,composed:!0}))}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._updateDropdownPortal()}_updateDropdownPortal(){if(this._moreOpen){const e=this.sources.slice(this._visiblePills);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-more-dropdown",""),Rs(this).appendChild(this._portalContainer),this._injectDropdownStyles()),Pe(f`<div class="sfx-more-dropdown open">
          ${e.map(t=>f`
              ...
              >
                <div class="sfx-more-item-ico">
                  ${t.brandHtml?Ie(t):t.iconColor?f`<svg
                        viewBox="0 0 24 24"
                        ${Q({color:t.iconColor})}
                      >
                        ${Ce(t.icon)}
    ...
    `}_renderCard(e){return f`
      <button
        ...
        @click=${t=>{t.stopPropagation(),this._onSourceIconClick(e)}}
      >
        ${e.brandHtml?f`<span class="card-ico">${Ie(e)}</span>`:f`<span
              class="card-ico"
              ${Q(e.iconColor?{color:e.iconColor}:null)}
            >
              ${Fe`<svg viewBox="0 0 24 24" class=${e.fillIcon?"fill-icon":""}>${Ce(e.icon)}</svg>`}
          ...
          ${this.compact&&this.sources.length>0?f`
                <div class="sources-row">
                  ${this.sources.map(o=>f`
                      ...
                      >
                        ${o.brandHtml?Ie(o):Fe`<svg viewBox="0 0 24 24" class=${o.fillIcon?"fill-icon":""}>${Ce(o.icon)}</svg>`}
                      </button>
                    `)}
                </div>
              `:S}
  ...
  `,Ue._WIDE_THRESHOLD_PX=1200,Ue);de([O({attribute:!1})],ne.prototype,"t");de([O({type:Boolean,reflect:!0})],ne.prototype,"compact");de([O({type:Boolean,attribute:"external-drag-over"})],ne.prototype,"externalDragOver");de([O({type:String})],ne.prototype,"accept");de([O({type:Boolean})],ne.prototype,"multi");de([O({type:Boolean})],ne.prototype,"directory");de([O({type:Array})],ne.prototype,"sources");de([O({type:String,attribute:"sources-layout"})],ne.prototype,"sourcesLayout");de([O({type:String,reflect:!0})],ne.prototype,"mode");de([z()],ne.prototype,"_dragOver");de([z()],ne.prototype,"_moreOpen");de([z()],ne.prototype,"_visiblePills");de([Ki(".ripple")],ne.prototype,"_rippleEl");de([Ki("input[data-sfx-dz-files]")],ne.prototype,"fileInput");de([Ki("input[data-sfx-dz-folder]")],ne.prototype,"folderInput");let Dc=ne;const ur=class ur extends oe{render(){return f`
      <div class="line"></div>
  ...
  `;let Mi=ur;var jc=Object.defineProperty,X=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&jc(e,t,o),o};const Bi=new CSSStyleSheet;Bi.replaceSync(`
        ...
        ${e.map(t=>f`
          ...
          >
            <span class="sfx-tile-dropdown-ico" ${Q(t.iconColor&&!t.brandHtml?{color:t.iconColor}:null)}>
              ${t.brandHtml?Ie(t):Fe`<svg viewBox="0 0 24 24" class=${t.fillIcon?"fill-icon":""}>${Ce(t.icon)}</svg>`}
            </span>
            ${t.labelKey?this.t(t.labelKey,t.label):t.label}
          </button>
        `)}
          ...
          ${e.previewUrl?f`<img class="preview-img" src=${e.previewUrl} alt="" />`:f`
                ...
                <div class="type-icon">
                  <img
                    ...
                    src=${$s(c)}
                    alt="${c?`${c} file`:"File"}"
                    @error=${w=>{const y=w.target,m=Cs();!y.dataset.fallback&&y.src!==m&&(y.dataset.fallback="1",y.src=m)}}
                  />
                </div>
              `}
...
`;var Bc=Object.defineProperty,ye=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Bc(e,t,o),o};const Po=7,Nc=4,gr=class gr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.fileCount=0,this.totalSize=0,this.thumbnails=[],this.primaryLabel="Done",this.failedFiles=[],this.alreadyExistedCount=0,this.showMinimize=!1,this._maxThumbs=Po,this._updateMaxThumbs=()=>{const e=window.innerWidth<=768?Nc:Po;e!==this._maxThumbs&&(this._maxThumbs=e)}}connectedCallback(){super.connectedCallback(),this._updateMaxThumbs(),window.addEventListener("resize",this._updateMaxThumbs)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._updateMaxThumbs)}_uploadMore(){this.dispatchEvent(new CustomEvent("upload-more",{bubbles:!0,composed:!0}))}_reviewFiles(){this.dispatchEvent(new CustomEvent("review-files",{bubbles:!0,composed:!0}))}_primaryAction(){this.dispatchEvent(new CustomEvent("primary-action",{bubbles:!0,composed:!0}))}_retryFile(e){this.dispatchEvent(new CustomEvent("file-retry",{bubbles:!0,composed:!0,detail:{fileId:e}}))}_retryAll(){this.dispatchEvent(new CustomEvent("retry-all",{bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-uploader",{bubbles:!0,composed:!0}))}_minimize(){this.dispatchEvent(new CustomEvent("minimize-uploader",{bubbles:!0,composed:!0}))}render(){const e=this.thumbnails.slice(0,this._maxThumbs),t=this.thumbnails.length-this._maxThumbs,i=this.fileCount>0,o=this.failedFiles.length>0,s=o&&!i,n=i&&!o&&this.alreadyExistedCount>=this.fileCount,a=this.fileCount-this.alreadyExistedCount;return f`
                ...
                <div class="preview-media-area">
                  <div class="preview-doc-wrap ${ue(i)}">
                    <img
                      ...
                      src=${$s(o)}
                      alt="${o?`${o} file`:"File"}"
                      @error=${m=>{const R=m.target,U=Cs();!R.dataset.fallback&&R.src!==U&&(R.dataset.fallback="1",R.src=U)}}
                    />
                  </div>
                  <button
                    class="preview-nav prev"
  ...
  `,Y._FS_ZOOM_LEVELS=[1,2,3,4],Y._MODIFIABLE_STATUSES=new Set(["idle","queued","rejected"]),Y._RESERVED_IDS=new Set(["device","camera","url","screen-cast"]),Y);N([O({attribute:!1})],B.prototype,"config");N([z()],B.prototype,"_isOpen");N([z()],B.prototype,"_activeConnector");N([z()],B.prototype,"_showUrlDialog");N([z()],B.prototype,"_showCameraDialog");N([z()],B.prototype,"_showScreenCastDialog");N([z()],B.prototype,"_similarSelectMode");N([z()],B.prototype,"_similarSelectedIds");N([z()],B.prototype,"_similarRunIds");N([z()],B.prototype,"_similarActiveIds");N([z()],B.prototype,"_similarResults");N([z()],B.prototype,"_previewPanelTab");N([z()],B.prototype,"_previewFileId");N([z()],B.prototype,"_previewDims");N([z()],B.prototype,"_fileInfoOpen");N([z()],B.prototype,"_splitPct");N([z()],B.prototype,"_showSettings");N([z()],B.prototype,"_setResize");N([z()],B.prototype,"_setMaxW");N([z()],B.prototype,"_setMaxH");N([z()],B.prototype,"_setTranscode");N([z()],B.prototype,"_setResolution");N([z()],B.prototype,"_setResolutionOpen");N([z()],B.prototype,"_setProtocol");N([z()],B.prototype,"_setResumable");N([z()],B.prototype,"_fullscreenPreviewUrl");N([z()],B.prototype,"_fullscreenVideoFile");N([z()],B.prototype,"_fsZoom");N([z()],B.prototype,"_bodyDragOver");N([z()],B.prototype,"_isMinimized");N([z()],B.prototype,"_isPillExpanded");N([z()],B.prototype,"_metadataSchema");N([z()],B.prototype,"_regionalFilters");N([z()],B.prototype,"_bulkMetadataOpen");N([z()],B.prototype,"_bulkMetadataInitialFieldKey");N([z()],B.prototype,"_isReviewing");N([z()],B.prototype,"_reviewFiles");N([z()],B.prototype,"_hasStoredReview");let Qc=B;const ge=(r,e)=>{typeof customElements<"u"&&!customElements.get(r)&&customElements.define(r,e)};ge("sfx-uploader",Qc);ge("sfx-drop-zone",Dc);ge("sfx-import-divider",Mi);ge("sfx-source-pills",Ut);ge("sfx-file-list",K);ge("sfx-file-item",J);ge("sfx-success-card",fe);ge("sfx-actions-bar",se);ge("sfx-url-dialog",He);ge("sfx-camera-dialog",Oe);ge("sfx-screen-cast-dialog",be);const ed=[{pattern:"/",load:()=>V(()=>import("./landing-CwkBBD2Y.js"),[]).then(r=>r.default)},{pattern:"/docs/getting-started",load:()=>V(()=>import("./getting-started-BEsDf8Jc.js"),__vite__mapDeps([0,1])).then(r=>r.default)},{pattern:"/docs/configuration",load:()=>V(()=>import("./configuration-BGWWClla.js"),__vite__mapDeps([2,1])).then(r=>r.default)},{pattern:"/docs/api",load:()=>V(()=>import("./api-C3Pu2Ua4.js"),__vite__mapDeps([3,1])).then(r=>r.default)},{pattern:"/docs/theming",load:()=>V(()=>import("./theming-D5E2zXLD.js"),__vite__mapDeps([4,1])).then(r=>r.default)},{pattern:"/docs/types",load:()=>V(()=>import("./types-BP9Z4Qnu.js"),__vite__mapDeps([5,1])).then(r=>r.default)},{pattern:"/examples/basic",load:()=>V(()=>import("./basic-DjT2bDJ1.js"),__vite__mapDeps([6,7])).then(r=>r.default)},{pattern:"/examples/auto-upload",load:()=>V(()=>import("./auto-upload-DFD8TODN.js"),__vite__mapDeps([8,7])).then(r=>r.default)},{pattern:"/examples/restrictions",load:()=>V(()=>import("./restrictions-go5_WmZo.js"),__vite__mapDeps([9,7,10])).then(r=>r.default)},{pattern:"/examples/target-folder",load:()=>V(()=>import("./target-folder-DGxCEhPB.js"),__vite__mapDeps([11,7])).then(r=>r.default)},{pattern:"/examples/concurrency",load:()=>V(()=>import("./concurrency-CDSeJgIC.js"),__vite__mapDeps([12,7,10])).then(r=>r.default)},{pattern:"/examples/events",load:()=>V(()=>import("./events-BeOaPkzK.js"),__vite__mapDeps([13,7])).then(r=>r.default)},{pattern:"/examples/modal",load:()=>V(()=>import("./modal-R1MX1LlH.js"),__vite__mapDeps([14,7])).then(r=>r.default)},{pattern:"/examples/inline",load:()=>V(()=>import("./inline-CjFvzLVs.js"),__vite__mapDeps([15,7])).then(r=>r.default)},{pattern:"/examples/sources-layout",load:()=>V(()=>import("./sources-layout-6BC64gNH.js"),__vite__mapDeps([16,7])).then(r=>r.default)},{pattern:"/examples/core-sources",load:()=>V(()=>import("./core-sources-CJMuvQaY.js"),__vite__mapDeps([17,7])).then(r=>r.default)},{pattern:"/examples/header-button",load:()=>V(()=>import("./header-button-BqEJZ1UW.js"),__vite__mapDeps([18,7])).then(r=>r.default)},{pattern:"/examples/minimize-to-background",load:()=>V(()=>import("./minimize-to-background-CkCFuHXH.js"),__vite__mapDeps([19,7])).then(r=>r.default)},{pattern:"/examples/resumable-upload",load:()=>V(()=>import("./resumable-upload-BsPJCgMf.js"),__vite__mapDeps([20,7,10])).then(r=>r.default)},{pattern:"/examples/react-wrapper",load:()=>V(()=>import("./react-wrapper-DqFoKQCy.js"),__vite__mapDeps([21,1])).then(r=>r.default)},{pattern:"/examples/metadata",load:()=>V(()=>import("./metadata-ClSiknzI.js"),__vite__mapDeps([22,7])).then(r=>r.default)},{pattern:"/examples/full-screen",load:()=>V(()=>import("./full-screen-D6533dtt.js"),[]).then(r=>r.default)},{pattern:"/examples/last-upload-review",load:()=>V(()=>import("./last-upload-review-DKVD0YoG.js"),[]).then(r=>r.default)},{pattern:"/examples/similar-check",load:()=>V(()=>import("./similar-check-rdGta4ah.js"),__vite__mapDeps([23,7,10])).then(r=>r.default)},{pattern:"/examples/upload-settings",load:()=>V(()=>import("./upload-settings-E8kGMHmu.js"),__vite__mapDeps([24,7,10])).then(r=>r.default)}];let We=null,Oo=0;function td(r){const e=document.getElementById("content"),t=document.getElementById("sidebar"),i=document.getElementById("sidebar-docs"),o=document.getElementById("sidebar-examples"),s=document.querySelectorAll(".topbar-nav-link");async function n(){var k,w;const a=location.hash.slice(1)||"/",l=!a.startsWith("/");if(l&&We){(k=document.getElementById(a))==null||k.scrollIntoView({behavior:"smooth"});return}const c=l?"/":a,d=++Oo;We!=null&&We.destroy&&We.destroy();const p=ed.find(y=>y.pattern===c);if(!p){location.hash="#/";return}const u=c.startsWith("/docs/"),b=c.startsWith("/examples/"),x=u||b,_=c==="/";t.classList.toggle("hidden",!x),document.body.classList.toggle("has-sidebar",x),document.body.classList.toggle("is-home",_),i.classList.toggle("hidden",!u),o.classList.toggle("hidden",!b),t.querySelectorAll(".sidebar-link").forEach(y=>{y.classList.toggle("active",y.getAttribute("data-route")===c)});const E=u?"docs":b?"examples":"home";s.forEach(y=>{y.classList.toggle("active",y.getAttribute("data-section")===E)}),t.classList.remove("mobile-open"),l||window.scrollTo(0,0);const F=await p.load();d===Oo&&(We=F,e.innerHTML=F.render(),F.init&&F.init(r),l&&((w=document.getElementById(a))==null||w.scrollIntoView({behavior:"smooth"})))}window.addEventListener("hashchange",n),n()}const Os="sfx-uploader-demo-auth",To={container:"",securityTemplateId:""};function Ts(){try{const r=localStorage.getItem(Os);if(r)return{...To,...JSON.parse(r)}}catch{}return{...To}}function id(r){localStorage.setItem(Os,JSON.stringify(r))}function yd(r={}){const{container:e,securityTemplateId:t}=Ts();return{auth:{mode:"security-template",container:e,securityTemplateId:t},autoProceed:!1,connectors:{companionUrl:"https://eu-on-24001.connector.filerobot.com",providers:["google-drive","dropbox","box","onedrive"]},...r}}function rd(){const r=document.getElementById("auth-btn"),e=document.getElementById("auth-popover"),t=document.getElementById("auth-container"),i=document.getElementById("auth-sec-template"),o=document.getElementById("auth-save"),s=Ts();t.value=s.container,i.value=s.securityTemplateId,r.addEventListener("click",n=>{n.stopPropagation(),e.classList.toggle("hidden")}),o.addEventListener("click",()=>{id({container:t.value.trim(),securityTemplateId:i.value.trim()}),e.classList.add("hidden")}),document.addEventListener("click",n=>{!e.contains(n.target)&&!r.contains(n.target)&&e.classList.add("hidden")})}rd();const od=document.getElementById("uploader");td(od);var Lo;(Lo=document.getElementById("sidebar-toggle"))==null||Lo.addEventListener("click",()=>{var r;(r=document.getElementById("sidebar"))==null||r.classList.toggle("mobile-open")});export{S as A,vd as B,xc as C,Rc as D,$s as E,Cs as F,Se as G,bd as H,xd as I,nr as J,it as P,le as a,yd as b,f as c,ld as d,Zi as e,pd as f,mc as g,Gn as h,oe as i,Xn as j,Ie as k,cd as l,Q as m,O as n,Us as o,fd as p,Cc as q,z as r,dd as s,hd as t,gd as u,md as v,Fe as w,Di as x,Uc as y,rt as z};
