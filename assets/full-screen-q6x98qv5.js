import{b as i}from"./index-DvqKfEVw.js";const n={render(){return`
      <style>
    ...
    `},init(e){const t=document.getElementById("fs-uploader");t.config=i({mode:"inline",inlineHeader:{accent:"Airbox",title:"Q1 Marketing Assets",description:"Upload banners, logos and brand visuals for the Q1 campaign"}})},destroy(){const e=document.getElementById("fs-uploader");e&&e.close()}};export{n as default};
