import{o as vt,i as L,a as y,p as Ot,q as yt,A as g,c as l,n as u,r as m,t as _t,v as wt,u as X,w as _e,x as Dt,y as $,z as Lt,B as re,C as lt,P as Ft,D as zt,E as qt,F as kt,G as dt,H as Pt,I as Bt,J as Kt}from"./index-rSuEFgbT.js";import{K as ts,L as is,M as ss}from"./index-rSuEFgbT.js";function $t(n,e,t=!1){const i=(e==null?void 0:e.language)??"en",s=n.model??[],o=n.store??{},r=s.find(f=>f.applies_to==="FILES");let a=(r==null?void 0:r.groups)??[];if(Array.isArray(e==null?void 0:e.fields)){const f=new Set(e.fields);a=a.map(b=>({...b,fields:b.fields.filter(v=>f.has(v.ckey))})).filter(b=>b.fields.length>0)}a=a.map(f=>({...f,fields:f.fields.filter(b=>!b.hide)})).filter(f=>f.fields.length>0);const d=a.flatMap(f=>f.fields),c=new Map(d.map(f=>[f.key,f])),p=o.force_filling_metadata_on_upload===!0,h=o.regional_variants_groups??[];return{groups:a,fields:d,fieldsByKey:c,forceFillingOnUpload:p,regionalVariantsGroups:h,language:i,productsEnabled:t}}const Nt="https://hub.scaleflex.com/api",de=new Map,oe=new Map;async function Hi(n,e,t,i){const s=de.get(t);if(s)return s;const o=oe.get(t);if(o)return o;if(i!=null&&i.rawMetadata){const a=$t(i.rawMetadata,i,i.productsEnabled===!0);return de.set(t,a),a}const r=Mt(e,t,i);oe.set(t,r);try{const a=await r;return de.set(t,a),a}finally{oe.delete(t)}}async function Mt(n,e,t){var p,h,f,b,v;const s=`${(t==null?void 0:t.hubApiBase)??Nt}/project/${encodeURIComponent(e)}`,o=(t==null?void 0:t.hubHeaders)??n,r=await fetch(s,{headers:o});if(!r.ok)throw new Error(`Failed to fetch metadata schema (HTTP ${r.status})`);const a=await r.json(),d=((h=(p=a.data)==null?void 0:p.project)==null?void 0:h.data)??((f=a.project)==null?void 0:f.data);if(!(d!=null&&d.metadata))throw new Error("No metadata in project response");const c=(t==null?void 0:t.productsEnabled)??((v=(b=d==null?void 0:d.airstore)==null?void 0:b.ui)==null?void 0:v.products_enabled)===!0;return $t(d.metadata,t,c)}function Gi(n){var e;n?(de.delete(n),(e=oe.get(n))==null||e.catch(()=>{}),oe.delete(n)):(de.clear(),oe.clear())}const Vt=new Set(["image","video","audio","document","archive","design_template"]);function jt(n){if(!n||Array.isArray(n))return[];const e=n.format_mimetypes;return Array.isArray(e)?e.filter(t=>Vt.has(t)):[]}function Ut(n){const e={type:n.dep_action_type,targetCkey:n.dep_action_target_metadata_or_group_sys_key,targetFieldType:n.dep_action_target_metadata_field_type_key};return n.dep_action_type==="allow_values"&&(e.allowedValues=n.dep_action_target_field_allowed_values_sys_keys??[]),n.dep_action_type==="set_values"&&(e.setValues=n.dep_action_target_field_set_values_sys_keys??n.dep_action_target_field_allowed_set_sys_keys??[]),e}function Ht(n){const e=n.dep_metadata_trigger_values_sys_keys??n.dep_metadata_trigger_values??[];return{uuid:n.dep_uuid,name:n.dep_name,description:n.dep_description,active:n.dep_active,formatMimetypes:jt(n.dep_scope),triggerCkey:n.dep_metadata_trigger_sys_key,triggerFieldType:n.dep_metadata_trigger_field_type_key,triggerCondition:n.dep_metadata_trigger_condition_key,triggerValues:e,actions:(n.dep_actions??[]).map(Ut)}}function Gt(n){if(!n)return[];const e=Array.isArray(n)?n:n.dependencies;return Array.isArray(e)?e.filter(t=>t==null?void 0:t.dep_active).map(Ht):[]}function Yt(n,e,t){if(n.length===0||t.length===0)return new Map;const i=n.map(r=>vt({mime:r.mime,meta:r.meta},e,t)),s=new Map,o=new Set;for(const r of i)for(const a of r.keys())o.add(a);for(const r of o){const a=i.map(x=>x.get(r)),d=a.every(x=>(x==null?void 0:x.hidden)===!0),c=a.some(x=>(x==null?void 0:x.required)===!0);let p;if(a.every(x=>Array.isArray(x==null?void 0:x.allowedValues))){let x;for(const ie of a){const G=ie.allowedValues;if(x=x===void 0?[...G]:x.filter(Rt=>G.includes(Rt)),x.length===0)break}p=x}let f;const b=a.map(x=>x==null?void 0:x.setValue).filter(x=>x!==void 0);b.length===n.length&&Jt(b)&&(f=b[0]);const v=new Set;for(const x of a)if(x)for(const ie of x.contributingDependencyUuids)v.add(ie);const S={hidden:d,required:c,contributingDependencyUuids:[...v]};p!==void 0&&(S.allowedValues=p),f!==void 0&&(S.setValue=f),s.set(r,S)}return s}function Jt(n){if(n.length<=1)return!0;const e=n[0];if(typeof e=="string")return n.every(i=>i===e);const t=new Set(e);return n.every(i=>{if(!Array.isArray(i)||i.length!==e.length)return!1;for(const s of i)if(!t.has(s))return!1;return!0})}const Wt="https://hub.scaleflex.com/api",be=new Map,ne=new Map;async function Yi(n,e,t){const i=be.get(n);if(i)return i;const s=ne.get(n);if(s)return s;const o=Qt(e,t);ne.set(n,o);try{const r=await o;return be.set(n,r),r}finally{ne.delete(n)}}async function Qt(n,e){const i=`${(e==null?void 0:e.hubApiBase)??Wt}/metadata/dependencies`,s=(e==null?void 0:e.hubHeaders)??n,o=await fetch(i,{headers:s});if(!o.ok)throw new Error(`Failed to fetch metadata dependencies (HTTP ${o.status})`);const r=await o.json();return Gt(r)}function Ji(n){var e;n?(be.delete(n),(e=ne.get(n))==null||e.catch(()=>{}),ne.delete(n)):(be.clear(),ne.clear())}const Xt=300,ct=2,Zt=50,ut="regvar:api",ei="#ut",ti={CREATE_ONLY:"create_only",UPSERT:"upsert"},ii=n=>typeof n=="string"&&n.startsWith(ei),xe=n=>`~${n.toUpperCase()}`,si=(n,e)=>{if(!(!n||!e))return n[e]??n[xe(e)]},ve=(n,e,t)=>{var r,a,d;const i=(r=n.i18n)==null?void 0:r[e];if(i)return{value:i,isFallback:!1,sourceLang:e};const s=(a=n.i18n)==null?void 0:a[xe(e)];if(s)return{value:s,isFallback:!0,sourceLang:xe(e)};const o=si(n.i18n,t);if(o){const c=(d=n.i18n)!=null&&d[t]?t:xe(t);return{value:o,isFallback:!0,sourceLang:c}}return{value:"",isFallback:!1,sourceLang:null}},pt=n=>(typeof n=="string"?n:"").toLowerCase().trim().replace(/[^\d\w]/g,"_").replace(/[\s]/g,"_").replace(/[_]{2,}/g,"_").replace(/[_]*$/g,"").replace(/^[_]*/g,""),ri=n=>{const e={},t={};for(const i of n||[])i.sid&&(e[i.sid]=i),i.slug&&(t[i.slug]=i);return{bySid:e,bySlug:t}},ye=n=>{const e=[],t=new Map,i=o=>o.sid||o.slug||"",s=(o,r)=>{if(typeof o=="string"){if(!o||t.has(o))return;t.set(o,e.length),e.push({slug:o});return}if(!o||typeof o!="object")return;const a=o,d=i(a);if(!d)return;const c=t.get(d),p=c!==void 0?{...e[c]}:{};a.slug&&(p.slug=a.slug),a.sid&&(p.sid=a.sid),a.uuid&&(p.uuid=a.uuid);const h={...p.i18n,...a.i18n||{}};r&&a.label&&(h[r]=a.label),Object.keys(h).length>0&&(p.i18n=h),c!==void 0?e[c]=p:(t.set(d,e.length),a.slug&&a.slug!==d&&t.set(a.slug,e.length),e.push(p))};if(Array.isArray(n))for(const o of n)s(o);else if(n&&typeof n=="object"){const o=n;for(const[r,a]of Object.entries(o))if(Array.isArray(a))for(const d of a)s(d,r)}return e},ge=n=>typeof n=="string"?[n]:!n||typeof n!="object"?[]:[n.sid,n.slug,n.uuid].filter(Boolean),Ee=(n,e,t)=>{if(t){const o=new Set(e.flatMap(ge));return n.filter(r=>!ge(r).some(a=>o.has(a)))}const i=new Set(n.flatMap(ge)),s=e.filter(o=>!ge(o).some(r=>i.has(r)));return[...n,...s]},oi=(n,e)=>n.map(t=>{const i=t.sid&&e.bySid[t.sid]||t.slug&&e.bySlug[t.slug]||void 0;return i?{slug:t.slug||i.slug,sid:t.sid||i.sid,uuid:t.uuid||i.uuid,i18n:{...i.i18n||{},...t.i18n||{}}}:t});function St(n,e,t){let i=e;switch(n.regional_variants_group_uuid&&i!=null&&typeof i=="object"&&!Array.isArray(i)&&(i=i[t??"en"]),n.type){case"geopoint":return ni(i);case"boolean":return i===!0?"true":i===!1?"false":"null";case"date":return i?new Date(i):null;case"decimal2":return i!=null?String(i):"";case"tags":return Array.isArray(i)?i.map(s=>typeof s=="string"?{value:s,label:s}:s):[];case"ultratags":return ye(e);case"multi-select":return i||[];default:return i??""}}function ze(n,e,t,i){var o;let s;switch(n.type){case"geopoint":{const r=e;!r||r.latitude===""||r.latitude==null||r.longitude===""||r.longitude==null?s=null:s=`(${r.latitude},${r.longitude})`;break}case"boolean":e==="true"?s=!0:e==="false"?s=!1:s=null;break;case"date":{if(!e)s=null;else{const r=e instanceof Date?e:new Date(e),a=r.getFullYear(),d=String(r.getMonth()+1).padStart(2,"0"),c=String(r.getDate()).padStart(2,"0");s=`${a}-${d}-${c}`}break}case"tags":s=Array.isArray(e)?e.map(r=>(r==null?void 0:r.label)??""):[];break;case"ultratags":s=Array.isArray(e)?e.map(r=>typeof r=="string"?r:r.slug).filter(r=>!!r):[];break;case"select-one":s=e===""?null:e;break;case"numeric":{if(e===""||e==null){s=null;break}const r=Number(e);s=Number.isFinite(r)?Math.round(r):null;break}case"decimal2":{if(e===""||e==null){s=null;break}const r=Number(e);s=Number.isFinite(r)?r:null;break}default:s=e}if(n.regional_variants_group_uuid&&n.type!=="ultratags"){const r=i??"en";return{...((o=t==null?void 0:t.meta)==null?void 0:o[n.key])??{},[r]:s}}return s}function ni(n){if(typeof n=="string"){const e=/\(([^)]+)\)/.exec(n);if(e){const t=e[1].split(",");if(t.length===2)return{latitude:t[0].trim(),longitude:t[1].trim()}}}return{latitude:"",longitude:""}}function Wi(n,e){const t=n.replace(/\/$/,"");let i=null,s=null,o=!1;return{search(r,a,d){if(i&&clearTimeout(i),s&&s.abort(),o=!1,!a.trim()){d([]);return}i=setTimeout(async()=>{var c;s=new AbortController;try{const p=`${t}/v5/metadata/autocomplete?q=${encodeURIComponent(a.trim())}&meta_key=_${encodeURIComponent(r)}&limit=20`,h=await fetch(p,{headers:e,signal:s.signal});if(o)return;if(!h.ok){d([]);return}const f=await h.json();if(o)return;const b=((c=f.data)==null?void 0:c.tags)??f.tags??[];d(b.map(v=>({sid:v.sid||void 0,value:v.tag||v.value||v.label||"",label:v.tag||v.label||v.value||""})))}catch{o||d([])}},200)},cancel(){o=!0,i&&clearTimeout(i),s&&s.abort()}}}const ht={base_node:null,nodes:[]};function Qi(n,e){const t=n.replace(/\/$/,"");let i=null,s=null,o=!1,r=null,a=null;return{fetchTaxonomies(){return a||(a=(async()=>{var c;const d=`${t}/v5/taxonomies`;try{const p=await fetch(d,{headers:e});if(!p.ok)return console.warn(`[sfx-uploader] /v5/taxonomies returned ${p.status}`),[];const h=await p.json(),f=(h==null?void 0:h.taxonomies)??((c=h==null?void 0:h.data)==null?void 0:c.taxonomies)??(h==null?void 0:h.data)??h;return Array.isArray(f)?f:(console.warn("[sfx-uploader] /v5/taxonomies returned unexpected shape",h),[])}catch(p){return console.warn("[sfx-uploader] /v5/taxonomies request failed",p),[]}})(),a.then(d=>{d.length===0&&(a=null)},()=>{a=null}),a)},async fetchNodes(d,c="",p=10){r&&r.abort(),r=new AbortController;try{const h=new URLSearchParams;c&&h.set("base",c),h.set("limit",String(p));const f=`${t}/v5/taxonomy/${encodeURIComponent(d)}/nodes?${h.toString()}`,b=await fetch(f,{headers:e,signal:r.signal});if(!b.ok)return ht;const v=await b.json(),S=(v==null?void 0:v.data)??v;return{base_node:(S==null?void 0:S.base_node)??null,nodes:Array.isArray(S==null?void 0:S.nodes)?S.nodes:[]}}catch{return ht}},autocomplete(d,c,p){if(i&&clearTimeout(i),s&&s.abort(),o=!1,!c.trim()){p([]);return}i=setTimeout(async()=>{var h;s=new AbortController;try{const f=`${t}/v5/metadata/autocomplete?q=${encodeURIComponent(c.trim())}&meta_key=_${encodeURIComponent(d)}`,b=await fetch(f,{headers:e,signal:s.signal});if(o)return;if(!b.ok){p([]);return}const v=await b.json();if(o)return;const S=((h=v==null?void 0:v.data)==null?void 0:h.tags)??(v==null?void 0:v.tags)??[];p(S.map(x=>({tag:String(x.tag??x.path??""),path:String(x.path??x.tag??""),suid:String(x.suid??""),uuid:String(x.uuid??""),approx_count:typeof x.approx_count=="number"?x.approx_count:void 0})))}catch{o||p([])}},200)},cancel(){o=!0,i&&clearTimeout(i),s&&s.abort(),r&&r.abort()}}}const qe="/v5/meta/ultratags",ai=(n,e)=>{const t=new URLSearchParams;e.meta&&t.set("meta",e.meta),e.q&&t.set("q",e.q),e.sort&&t.set("sort",e.sort),typeof e.limit=="number"&&t.set("limit",String(e.limit)),e.after&&t.set("after",e.after),e.format&&t.set("format",e.format),e.lang&&t.set("lang",e.lang);const i=t.toString();return`${n}${qe}${i?`?${i}`:""}`},li=(n,e)=>{const t=new URLSearchParams;e.format&&t.set("format",e.format),e.lang&&t.set("lang",e.lang);const i=t.toString();return`${n}${qe}${i?`?${i}`:""}`};function Xi(n,e){let t=null,i=null;const s=()=>{t&&(clearTimeout(t),t=null),i&&(i.abort(),i=null)};return{list(o){return s(),new Promise((r,a)=>{t=setTimeout(async()=>{t=null,i=new AbortController;try{const d=ai(n,o),c=await fetch(d,{method:"GET",headers:e,signal:i.signal});if(!c.ok){a(new Error(`ultratags list failed: HTTP ${c.status}`));return}const p=await c.json();r(p)}catch(d){a(d)}},Xt)})},async getBySids(o){if(!o.sids||o.sids.length===0)return{items:[],stats:{count:0,total_count:0}};const r=li(n,o),a=await fetch(r,{method:"QUERY",headers:{...e,"Content-Type":"application/json"},body:JSON.stringify({ultratags_sids:o.sids})});if(!a.ok)throw new Error(`ultratags getBySids failed: HTTP ${a.status}`);return await a.json()},async create(o){const r=`${n}${qe}`,a=await fetch(r,{method:"POST",headers:{...e,"Content-Type":"application/json"},body:JSON.stringify(o)});if(!a.ok)throw new Error(`ultratags create failed: HTTP ${a.status}`);return await a.json()},cancel(){s()}}}var di=Object.defineProperty,P=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&di(e,t,s),s};const Ke=class Ke extends L{constructor(){super(...arguments),this.schema=null,this.meta={},this.config=null,this.taxonodes=null,this.resolvedSchema=null,this.dependencies=[],this.disabled=!1,this._collapsed=new Set}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_buildConflictsByCkey(){if(!this.schema||!this.resolvedSchema||this.resolvedSchema.size===0)return new Map;const e={};for(const i of this.schema.fields)i.key in this.meta&&(e[i.ckey]=this.meta[i.key]);const t=Ot(e,this.resolvedSchema);return new Map(t.map(i=>[i.ckey,i]))}_buildDependencyNames(){return this.dependencies.length===0?new Map:new Map(this.dependencies.map(e=>[e.uuid,e.name]))}_renderGroup(e,t,i){var a;const s=!this._collapsed.has(e.uuid),o=this.resolvedSchema,r=o?e.fields.filter(d=>!yt(d,e,o)):e.fields;return o&&e.ckey&&((a=o.get(e.ckey))!=null&&a.hidden)?g:r.length===0?g:l`
      <div class="group">
    ...
    `}render(){if(!this.schema||this.schema.groups.length===0)return l`<div class="empty">No metadata fields configured</div>`;const e=this._buildConflictsByCkey(),t=this._buildDependencyNames();return l`
  ...
  `;let E=Ke;P([u({attribute:!1})],E.prototype,"schema");P([u({attribute:!1})],E.prototype,"meta");P([u({attribute:!1})],E.prototype,"config");P([u({attribute:!1})],E.prototype,"autocomplete");P([u({attribute:!1})],E.prototype,"taxonomyService");P([u({attribute:!1})],E.prototype,"ultratags");P([u({attribute:!1})],E.prototype,"defaultLanguage");P([u({attribute:!1})],E.prototype,"taxonodes");P([u({attribute:!1})],E.prototype,"resolvedSchema");P([u({attribute:!1})],E.prototype,"dependencies");P([u({type:Boolean})],E.prototype,"disabled");P([m()],E.prototype,"_collapsed");customElements.define("sfx-metadata-form",E);const pe=y`
...
Controlled by ${c}: ${d.join(", ")}`}}return o}_onFieldBlur(e){const{key:t,value:i}=e.detail,s=wt(this.field,i,this.config??void 0);if(s){this._error=s;return}this._error=null;const o={meta:{[this.field.key]:this.value}},r=X(this.field,this.config),a=ze(this.field,i,o,r);this._dispatching=!0,this.dispatchEvent(new CustomEvent("field-blur",{detail:{key:t,value:a},bubbles:!0,composed:!0})),this._dispatching=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("field-blur",this._handleChildBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("field-blur",this._handleChildBlur)}_renderField(e,t){var o,r;const i=this.disabled;if(_e(e))return l`<sfx-meta-unsupported-field></sfx-meta-unsupported-field>`;const s=((o=this.resolvedState)==null?void 0:o.allowedValues)??null;switch(e.type){case"text":case"attachment-uri":return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`;case"textarea":return l`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-textarea-field>`;case"select-one":return l`<sfx-meta-select-field .field=${e} .value=${t} .allowedValues=${s} ?disabled=${i}></sfx-meta-select-field>`;case"multi-select":return l`<sfx-meta-multi-select-field .field=${e} .value=${t} .allowedValues=${s} ?disabled=${i}></sfx-meta-multi-select-field>`;case"tags":return l`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${i}></sfx-meta-tags-field>`;case"ultratags":return l`<sfx-meta-ultratags-field
          ...
          ?disabled=${i}></sfx-meta-ultratags-field>`;case"taxonomy-node":return l`<sfx-meta-taxonomy-node-field .field=${e} .value=${t} .taxonomyService=${this.taxonomyService} .entry=${this.taxonomyEntry} ?disabled=${i}></sfx-meta-taxonomy-node-field>`;case"boolean":return l`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return l`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-number-field>`;case"date":return l`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-date-field>`;case"geopoint":return l`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-geo-point-field>`;default:return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`}}render(){var d,c;const e=this.field;if(!e)return g;const t=X(e,this.config),i=St(e,this.value,t),s=Dt(e,this.regionalVariantsGroups,(d=this.config)==null?void 0:d.regionalFilters,(c=this.config)==null?void 0:c.language),r=e.type==="textarea"?"field-row field-row--top":"field-row",a=this.conflict?this._conflictTooltip():"";return l`
    ...
    `}};Ne.styles=[ci];let w=Ne;T([u({attribute:!1})],w.prototype,"field");T([u({attribute:!1})],w.prototype,"value");T([u({attribute:!1})],w.prototype,"config");T([u({attribute:!1})],w.prototype,"autocomplete");T([u({attribute:!1})],w.prototype,"taxonomyService");T([u({attribute:!1})],w.prototype,"taxonomyEntry");T([u({attribute:!1})],w.prototype,"ultratags");T([u({attribute:!1})],w.prototype,"defaultLanguage");T([u({attribute:!1})],w.prototype,"ultratagsRestrictToItems");T([u({attribute:!1})],w.prototype,"regionalVariantsGroups");T([u({attribute:!1})],w.prototype,"resolvedState");T([u({attribute:!1})],w.prototype,"conflict");T([u({attribute:!1})],w.prototype,"dependencyNames");T([u({type:Boolean})],w.prototype,"disabled");T([m()],w.prototype,"_error");customElements.define("sfx-metadata-field",w);var pi=Object.defineProperty,Be=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&pi(e,t,s),s};class O extends L{constructor(){super(...arguments),this.value="",this.disabled=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{key:this.field.key,...t!==void 0?{value:t}:{}},bubbles:!0,composed:!0}))}}Be([u({attribute:!1})],O.prototype,"field");Be([u({attribute:!1})],O.prototype,"value");Be([u({type:Boolean})],O.prototype,"disabled");const Me=class Me extends O{_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var i,s;const e=((i=this.field)==null?void 0:i.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return l`
      <input
        type="text"
        .value=${this.value??""}
      ...
      />
    `}};Me.styles=[pe];let Ie=Me;customElements.define("sfx-meta-text-field",Ie);const Ve=class Ve extends O{firstUpdated(){const e=this.renderRoot.querySelector("textarea");e&&this._autoResize(e)}_autoResize(e){e.style.height="auto",e.style.height=`${Math.max(80,e.scrollHeight)}px`}_onInput(e){const t=e.target;this._autoResize(t),this._emit("field-change",t.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var i,s;const e=((i=this.field)==null?void 0:i.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return l`
      <textarea
        .value=${this.value??""}
        placeholder=${((s=this.field)==null?void 0:s.placeholder)||t}
        ?disabled=${this.disabled}
    ...
    `];let ee=Ue;ke([u({attribute:!1})],ee.prototype,"allowedValues");ke([m()],ee.prototype,"_open");ke([m()],ee.prototype,"_search");ke([m()],ee.prototype,"_activeIndex");customElements.define("sfx-meta-multi-select-field",ee);function W(n,e){var t,i;return((t=n.label)==null?void 0:t.trim().toLowerCase())===((i=e.label)==null?void 0:i.trim().toLowerCase())}function Ct(n){return n.trim().replace(/\s+/g," ")}function gi(n){return Ct(n).replace(/\s/g,"-")}function me(n){return{label:Ct(n),value:gi(n)}}var mi=Object.defineProperty,ae=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&mi(e,t,s),s};const He=class He extends O{constructor(){super(...arguments),this._query="",this._results=[],this._loading=!1,this._dropdownOpen=!1,this._activeIndex=-1,this._blurTimeout=null}get _tags(){return Array.isArray(this.value)?this.value:[]}disconnectedCallback(){var e;super.disconnectedCallback(),this._blurTimeout&&clearTimeout(this._blurTimeout),(e=this.autocomplete)==null||e.cancel()}_onInput(e){var i,s,o;const t=e.target.value;if(this._query=t,this._dropdownOpen=!0,this._activeIndex=-1,!t.trim()||!((i=this.field)!=null&&i.ckey)){this._results=[],this._loading=!1,(s=this.autocomplete)==null||s.cancel();return}this._loading=!0,(o=this.autocomplete)==null||o.search(this.field.ckey,t,r=>{this._results=r,this._loading=!1})}_addTag(e){if(this._tags.some(i=>W(i,e)))return;const t=[...this._tags,e];this.value=t,this._query="",this._results=[],this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-change",t),this.updateComplete.then(()=>{var i;(i=this.renderRoot.querySelector(".input"))==null||i.focus()})}_removeTag(e){const t=this._tags.filter(i=>!W(i,e));this.value=t,this._emit("field-change",t)}_onBlur(){this._blurTimeout&&clearTimeout(this._blurTimeout),this._blurTimeout=setTimeout(()=>{this._blurTimeout=null,this.renderRoot.querySelector(".dropdown:hover")||(this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-blur",this._tags))},150)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}get _itemCount(){return this._suggestions.length+(this._canCreate?1:0)}_onKeydown(e){if(e.key==="Escape"){this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-escape");return}if(e.key==="Backspace"&&!this._query&&this._tags.length){this._removeTag(this._tags[this._tags.length-1]);return}if(!this._dropdownOpen)return;const t=this._itemCount;if(this._activeIndex>=t&&(this._activeIndex=Math.max(t-1,-1)),!(t===0&&e.key!=="Enter"))switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,-1),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t-1,this._scrollActive();break;case"Enter":{e.preventDefault();const i=this._suggestions;this._activeIndex>=0&&this._activeIndex<i.length?this._addTag(i[this._activeIndex]):this._activeIndex===i.length&&this._canCreate?this._addTag(me(this._query)):this._activeIndex===-1&&this._canCreate?this._addTag(me(this._query)):this._activeIndex===-1&&i.length&&this._addTag(i[0]);break}}}get _suggestions(){var o;const e=this._query.toLowerCase().trim(),t=this._tags,i=(((o=this.field)==null?void 0:o.possible_values)??[]).map(r=>({value:r.api_value||r.internal_unique_value,label:r.label})).filter(r=>!t.some(a=>W(a,r))).filter(r=>!e||r.label.toLowerCase().includes(e)),s=this._results.filter(r=>!t.some(a=>W(a,r))&&!i.some(a=>W(a,r)));return[...i,...s]}get _canCreate(){const e=this._query.trim();if(!e||this._loading)return!1;const t=me(e);return!this._tags.some(i=>W(i,t))&&!this._suggestions.some(i=>W(i,t))}render(){var s,o;const e=this._tags,t=this._suggestions,i=t.length;return l`
        ...
        <div class="dropdown" role="listbox">
          ...
          ${this._canCreate?l`
            <div class="option create ${i===this._activeIndex?"active":""}"
              @mousedown=${r=>{r.preventDefault(),this._addTag(me(this._query))}}
    ...
    `];let j=He;ae([u({attribute:!1})],j.prototype,"autocomplete");ae([m()],j.prototype,"_query");ae([m()],j.prototype,"_results");ae([m()],j.prototype,"_loading");ae([m()],j.prototype,"_dropdownOpen");ae([m()],j.prototype,"_activeIndex");customElements.define("sfx-meta-tags-field",j);var xi=Object.defineProperty,Et=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&xi(e,t,s),s};const Q=[{label:"True",value:"true"},{label:"False",value:"false"}],Ge=class Ge extends O{constructor(){super(...arguments),this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _currentLabel(){var t;if(this.value==null)return"";const e=String(this.value);return((t=Q.find(i=>i.value===e))==null?void 0:t.label)??""}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_openDropdown(){this._open=!0;const e=this.value==null?"":String(this.value);this._activeIndex=Math.max(Q.findIndex(t=>t.value===e),0),document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".dropdown"))==null||t.focus()})}_closeAndSubmit(e=!1){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-blur",this.value),e&&this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".trigger"))==null||t.focus()})}_onOutsideClick(e){e.composedPath().includes(this)||this._closeAndSubmit()}_onSelect(e,t=!1){this.value=e.value,this._emit("field-change",e.value),this._closeAndSubmit(t)}_clear(e){e.stopPropagation(),this.value=null,this._emit("field-change",null),this._emit("field-blur",null)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){var t;if(e.key==="Escape"){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-escape"),(t=this.renderRoot.querySelector(".trigger"))==null||t.focus();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,Q.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=Q.length-1,this._scrollActive();break;case"Enter":case" ":this._activeIndex>=0&&this._activeIndex<Q.length&&(e.preventDefault(),this._onSelect(Q[this._activeIndex],!0));break}}render(){var s,o;const e=this.value==null?"":String(this.value),t=((s=this.field)==null?void 0:s.title)??"",i=t?`Select ${t.toLowerCase()}`:"Select an option";return l`
      <button class="trigger" ?disabled=${this.disabled}
        role="combobox" aria-expanded=${this._open} aria-haspopup="listbox"
        @click=${()=>this._open?this._closeAndSubmit(!0):this._openDropdown()}
        @keydown=${this._onKeydown}>
    ...
    `];let Re=Je;customElements.define("sfx-meta-date-field",Re);const We=class We extends O{get _geo(){const e=this.value;return{latitude:(e==null?void 0:e.latitude)??"",longitude:(e==null?void 0:e.longitude)??""}}_onInput(e,t){const i=t.target.value,s={...this._geo,[e]:i};this.value=s,this._emit("field-change",s)}_onBlur(e){const t=e.relatedTarget;t&&this.renderRoot.contains(t)||this._emit("field-blur",this._geo)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){const e=this._geo;return l`
      <div class="grid">
        <div>
    ...
    `];let q=Xe;H([u({attribute:!1})],q.prototype,"ultratags");H([u({attribute:!1})],q.prototype,"language");H([u({attribute:!1})],q.prototype,"defaultLanguage");H([u({attribute:!1})],q.prototype,"restrictToItems");H([m()],q.prototype,"_query");H([m()],q.prototype,"_results");H([m()],q.prototype,"_loading");H([m()],q.prototype,"_dropdownOpen");H([m()],q.prototype,"_activeIndex");customElements.define("sfx-meta-ultratags-field",q);const ue="This field is not supported during upload. You can edit it later in the asset library.",It=l`
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ${$`<rect x="3" y="7" width="10" height="7" rx="1.5"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/>`}
  </svg>
`,Ze=class Ze extends L{render(){return l`
      <div
        class="unsupported"
        title=${ue}
        aria-label=${ue}
  ...
  `;let Y=tt;fe([u({attribute:!1})],Y.prototype,"field");fe([u({attribute:!1})],Y.prototype,"value");fe([u({attribute:!1})],Y.prototype,"taxonomyEntry");fe([u({attribute:!1})],Y.prototype,"language");fe([u({attribute:!1})],Y.prototype,"defaultLanguage");customElements.define("sfx-metadata-field-view",Y);var ki=Object.defineProperty,$e=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&ki(e,t,s),s};const it=class it extends L{constructor(){super(...arguments),this.groups=[],this.selectedFilters={},this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _filteredGroups(){return(this.groups??[]).filter(e=>{var t;return((t=e==null?void 0:e.variants)==null?void 0:t.length)>1})}get _options(){const e=[];for(const t of this._filteredGroups){let i=!0;for(const s of t.variants)e.push({groupUuid:t.uuid,value:s.api_value,label:s.label,isGroupStart:i,groupLabel:t.label}),i=!1}return e}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_toggle(){this._open?this._close():this._openDropdown()}_openDropdown(){this._open=!0;const t=this._options.findIndex(i=>this.selectedFilters[i.groupUuid]===i.value);this._activeIndex=t>=0?t:0,document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>this._scrollActive())}_close(){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick)}_onOutsideClick(e){e.composedPath().includes(this)||this._close()}_onSelect(e){this._close(),this.selectedFilters[e.groupUuid]!==e.value&&this.dispatchEvent(new CustomEvent("regional-change",{detail:{groupUuid:e.groupUuid,value:e.value},bubbles:!0,composed:!0}))}_scrollActive(){const e=this.renderRoot.querySelector(".option.active");e&&typeof e.scrollIntoView=="function"&&e.scrollIntoView({block:"nearest"})}_onKeydown(e){if(e.key==="Escape"&&this._open){e.stopPropagation(),this._close();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}const t=this._options;if(t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t.length-1,this._scrollActive();break;case"Enter":this._activeIndex>=0&&this._activeIndex<t.length&&(e.preventDefault(),this._onSelect(t[this._activeIndex]));break}}_triggerSummary(){var i;const e=this._filteredGroups;if(e.length===0)return"Regional settings";const t=[];for(const s of e){const o=this.selectedFilters[s.uuid]??((i=s.variants[0])==null?void 0:i.api_value),r=s.variants.find(a=>a.api_value===o);r&&t.push(e.length===1?r.label:`${s.label}: ${r.label}`)}return t.length?t.join(", "):"Regional settings"}render(){if(this._filteredGroups.length===0)return g;const t=this._options,i=this._triggerSummary();return l`
    ...
    `];let te=it;$e([u({attribute:!1})],te.prototype,"groups");$e([u({attribute:!1})],te.prototype,"selectedFilters");$e([m()],te.prototype,"_open");$e([m()],te.prototype,"_activeIndex");customElements.define("sfx-regional-settings",te);const Se=new Set(["multi-select","tags","ultratags"]),Ce=new Set(["text","textarea","attachment-uri"]);function $i(n){return Lt(n)?[]:Se.has(n)?[{key:"SET",label:"Set"},{key:"ADD",label:"Add to"},{key:"DELETE",label:"Remove from"}]:Ce.has(n)?[{key:"SET",label:"Set"},{key:"ADD",label:"Append"},{key:"DELETE",label:"Remove"}]:[{key:"SET",label:"Set"},{key:"DELETE",label:"Clear"}]}function Le(n,e){return n==="DELETE"?Se.has(e)||Ce.has(e):!0}function Si(n,e,t,i){const s=Se.has(i),o=Ce.has(i);switch(n){case"SET":return t;case"ADD":{if(s){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[];if(a.length===0)return r;if(i==="ultratags")return Ee(r,a,!1);if(i==="tags"){const p=new Set(r.map(f=>f)),h=[...r];for(const f of a){const b=typeof f=="string"?f:String(f);p.has(b)||(p.add(b),h.push(b))}return h}const d=new Set(r.map(p=>JSON.stringify(p))),c=[...r];for(const p of a){const h=JSON.stringify(p);d.has(h)||(d.add(h),c.push(p))}return c}if(o){const r=typeof t=="string"?t:"";if(!r)return e??"";const a=typeof e=="string"?e:"";return a?`${a} ${r}`:r}return t}case"DELETE":{if(s){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[];if(a.length===0)return r;if(i==="ultratags")return Ee(r,a,!0);if(i==="tags"){const c=new Set(a.map(p=>typeof p=="string"?p:String(p)));return r.filter(p=>!c.has(typeof p=="string"?p:String(p)))}const d=new Set(a.map(c=>JSON.stringify(c)));return r.filter(c=>!d.has(JSON.stringify(c)))}if(o){const r=typeof t=="string"?t:"";return r?(typeof e=="string"?e:"").replaceAll(r,"").replace(/\s{2,}/g," ").trim():""}return i==="geopoint"?{latitude:"",longitude:""}:null}default:return t}}function Tt(n,e,t,i,s){const o=s??"en",r=!!n.regional_variants_group_uuid,a={meta:{[n.key]:e}},d=ze(n,t,a,s),c=b=>r&&b!==null&&typeof b=="object"&&!Array.isArray(b),p=c(e)?e[o]:e,h=c(d)?d[o]:d,f=Si(i,p,h,n.type);return r?{...c(e)?e:{},[o]:f}:f}const At=y`
  .fm-checkbox {
...
`;var Oi=Object.defineProperty,k=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&Oi(e,t,s),s};const st=class st extends L{constructor(){super(...arguments),this.files=[],this.config=null,this.initialFieldKey=null,this.dependencies=[],this._activeFieldKey="",this._staged=new Map,this._stagedTaxonodes=new Map,this._selected=new Set,this._sortAsc=!0,this._pendingOp=null,this._confirmVisible=!1,this._missingRequiredFieldKey=null,this._missingRequiredKeys=new Set,this._confirmResolve=null,this._cachedBulkResolved=new Map,this._cachedPerFileResolved=new Map,this._originalFiles=new Map,this._onKeyDown=async e=>{if(e.key!=="Escape")return;if(this._confirmVisible){e.stopPropagation(),this._onConfirmCancel();return}e.composedPath().some(s=>s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement)||await this._confirmDiscardPending()&&this._emitClose()},this._onConfirmOk=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!0),this._confirmResolve=null},this._onConfirmCancel=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null},this._onConfirmKeydown=e=>{var a,d;if(e.key!=="Tab")return;const t=(a=this.shadowRoot)==null?void 0:a.querySelector(".fm-confirm");if(!t)return;const i=t.querySelectorAll("button");if(i.length===0)return;const s=i[0],o=i[i.length-1],r=(d=this.shadowRoot)==null?void 0:d.activeElement;e.shiftKey&&r===s?(e.preventDefault(),o.focus()):!e.shiftKey&&r===o&&(e.preventDefault(),s.focus())},this._onPendingChange=e=>{const{operation:t,value:i}=e.detail,s=this._activeField;re(i)&&(!s||Le(t,s.type))?this._pendingOp=null:this._pendingOp={operation:t,value:i}},this._onFieldSelect=async e=>{await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e.detail.fieldKey)},this._onJumpToNextRequired=async()=>{const e=this._missingRequiredFieldKey;e&&this._activeFieldKey!==e&&await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e)},this._onBulkApply=e=>{const t=this._activeField;if(!t)return;const{operation:i,value:s,taxonomyEntry:o}=e.detail,r=X(t,this.config),a=[];for(const d of this._selected){const c=this._staged.get(d),p=c!=null&&c.has(t.key)?c.get(t.key):this._originalValue(d,t.key)??null,h=Tt(t,p,s,i,r);a.push([d,t.key,h])}this._setStagedBulk(a),t.type==="taxonomy-node"&&o!==void 0&&this._setStagedTaxonodeBulk(this._selected,t.key,o)},this._onRowTaxonomyEntry=e=>{const{fileId:t,fieldKey:i,entry:s}=e.detail;this._setStagedTaxonodeSingle(t,i,s)},this._onRowFieldChange=e=>{const t=this._activeField;t&&this._setStagedValue(e.detail.fileId,t.key,e.detail.value)},this._onRowToggle=e=>{const t=new Set(this._selected);t.has(e.detail.fileId)?t.delete(e.detail.fileId):t.add(e.detail.fileId),this._selected=t},this._onSelectAll=()=>{this._selected.size===this.files.length?this._selected=new Set:this._selected=new Set(this.files.map(e=>e.id))},this._onSortToggle=()=>{this._sortAsc=!this._sortAsc},this._onSave=async()=>{if(this._missingRequiredFieldKey!=null||!await this._confirmDiscardPending())return;const e=[],t=[];for(const[s,o]of this._staged){if(!this._originalFiles.get(s))continue;const a={},d={};for(const[c,p]of o){const h=this._originalValue(s,c);if(JSON.stringify(p)!==JSON.stringify(h))if(lt(c)){const f=dt(c);if(!f)continue;const b=p===""||p==null;f==="position"?d.position=b?void 0:Number(p):d.ref=b?void 0:String(p)}else a[c]=p}Object.keys(a).length>0&&e.push({fileId:s,meta:a}),Object.keys(d).length>0&&t.push({fileId:s,product:d})}this.dispatchEvent(new CustomEvent("metadata-save-batch",{detail:{changes:e},bubbles:!0,composed:!0})),t.length>0&&this.dispatchEvent(new CustomEvent("product-save-batch",{detail:{changes:t},bubbles:!0,composed:!0}));const i=[];for(const[s,o]of this._stagedTaxonodes){const r=this._originalFiles.get(s);if(!r)continue;const a=r.taxonodes??{},d={};for(const[c,p]of o){const h=a[c]??null;JSON.stringify(p??null)!==JSON.stringify(h??null)&&(d[c]=p??null)}Object.keys(d).length>0&&i.push({fileId:s,taxonodes:d})}i.length>0&&this.dispatchEvent(new CustomEvent("taxonomy-save-batch",{detail:{changes:i},bubbles:!0,composed:!0})),this._emitClose()},this._onCancel=async()=>{await this._confirmDiscardPending()&&this._emitClose()},this._onClose=async()=>{await this._confirmDiscardPending()&&this._emitClose()}}connectedCallback(){super.connectedCallback(),this._initStaged(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null}_initStaged(){var a,d;const e=new Map,t=new Map,i=new Set,s=new Map,o=((a=this.schema)==null?void 0:a.productsEnabled)===!0;for(const c of this.files){const p=new Map;if(c.meta)for(const[h,f]of Object.entries(c.meta))p.set(h,f);if(o){const h=c.product;h.ref!==void 0&&p.set(Ft,h.ref),h.position!==void 0&&p.set(zt,h.position)}e.set(c.id,p),c.taxonodes&&t.set(c.id,new Map(Object.entries(c.taxonodes))),i.add(c.id),s.set(c.id,c)}this._staged=e,this._stagedTaxonodes=t,this._selected=i,this._originalFiles=s;const r=this.initialFieldKey;r&&((d=this.schema)!=null&&d.fieldsByKey.has(r))?this._activeFieldKey=r:this.schema&&this.schema.fields.length>0&&(this._activeFieldKey=this.schema.fields[0].key)}_setStagedValue(e,t,i){const s=new Map(this._staged),o=new Map(s.get(e)??new Map);o.set(t,i),s.set(e,o),this._staged=s}_setStagedBulk(e){const t=new Map(this._staged);for(const[i,s,o]of e){const r=new Map(t.get(i)??new Map);r.set(s,o),t.set(i,r)}this._staged=t}_setStagedTaxonodeBulk(e,t,i){const s=new Map(this._stagedTaxonodes);for(const o of e){const r=new Map(s.get(o)??new Map);r.set(t,i),s.set(o,r)}this._stagedTaxonodes=s}_setStagedTaxonodeSingle(e,t,i){const s=new Map(this._stagedTaxonodes),o=new Map(s.get(e)??new Map);o.set(t,i),s.set(e,o),this._stagedTaxonodes=s}get _activeField(){var e,t;return(t=(e=this.schema)==null?void 0:e.fieldsByKey)==null?void 0:t.get(this._activeFieldKey)}get _ultratagsPresentOnSelection(){var i,s;const e=this._activeField;if(!e||e.type!=="ultratags")return[];let t=[];for(const o of this._selected){const r=this._originalFiles.get(o),a=(i=this._staged.get(o))==null?void 0:i.get(e.key),d=a!==void 0?a:(s=r==null?void 0:r.meta)==null?void 0:s[e.key],c=ye(d);c.length&&(t=Ee(t,c,!1))}return t.filter(o=>typeof o!="string")}_originalValue(e,t){var s,o;const i=this._originalFiles.get(e);if(i){if(lt(t)){const r=dt(t);return r?(s=i.product)==null?void 0:s[r]:void 0}return(o=i.meta)==null?void 0:o[t]}}_refreshMissingRequired(){const e=this.schema?qt(this._staged,this._originalFiles,this.schema,this.config??void 0,this.dependencies):new Set;let t=null;if(this.schema&&e.size>0){for(const o of this.schema.fields)if(e.has(o.key)){t=o.key;break}}t!==this._missingRequiredFieldKey&&(this._missingRequiredFieldKey=t);const i=this._missingRequiredKeys;let s=i.size!==e.size;if(!s){for(const o of e)if(!i.has(o)){s=!0;break}}s&&(this._missingRequiredKeys=e)}_selectedFileInputs(){const e=[];for(const t of this.files){if(!this._selected.has(t.id))continue;const i=this._staged.get(t.id),s={...t.meta};if(i)for(const[o,r]of i)s[o]=r;e.push({id:t.id,mime:t.type??"",meta:s})}return e}_recomputeResolvedSchemas(){if(!this.schema||this.dependencies.length===0){this._cachedBulkResolved=new Map,this._cachedPerFileResolved=new Map;return}this._cachedBulkResolved=Yt(this._selectedFileInputs(),this.schema,this.dependencies);const e=new Map;for(const t of this.files){const i=this._staged.get(t.id),s={...t.meta};if(i)for(const[o,r]of i)s[o]=r;e.set(t.id,vt({mime:t.type??"",meta:s},this.schema,this.dependencies))}this._cachedPerFileResolved=e}_advanceActiveFieldIfHidden(){var i,s;if(!this.schema||this._cachedBulkResolved.size===0)return;const e=(i=this.schema.fieldsByKey)==null?void 0:i.get(this._activeFieldKey);if(!e||!((s=this._cachedBulkResolved.get(e.ckey))!=null&&s.hidden))return;const t=this.schema.fields.find(o=>{var r;return!((r=this._cachedBulkResolved.get(o.ckey))!=null&&r.hidden)});t&&t.key!==this._activeFieldKey&&(this._activeFieldKey=t.key)}get _filledFields(){var t;const e=new Set;for(const i of((t=this.schema)==null?void 0:t.fields)??[])for(const[s,o]of this._staged){const r=o.get(i.key),a=this._originalValue(s,i.key);if(r!==void 0&&!re(r)&&JSON.stringify(r)!==JSON.stringify(a)){e.add(i.key);break}}return e}get _hasPendingValue(){return this._pendingOp!=null&&!re(this._pendingOp.value)}_confirmDiscardPending(){return this._hasPendingValue?new Promise(e=>{this._confirmResolve=e,this._confirmVisible=!0}):Promise.resolve(!0)}willUpdate(e){(e.has("_staged")||e.has("schema")||e.has("config")||e.has("dependencies"))&&this._refreshMissingRequired(),(e.has("_staged")||e.has("_selected")||e.has("schema")||e.has("dependencies")||e.has("files"))&&(this._recomputeResolvedSchemas(),this._advanceActiveFieldIfHidden())}updated(e){var t;(t=super.updated)==null||t.call(this,e),e.has("_confirmVisible")&&this._confirmVisible&&requestAnimationFrame(()=>{var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector(".fm-confirm .btn-ghost");i==null||i.focus()})}_emitClose(){this.dispatchEvent(new CustomEvent("metadata-close",{bubbles:!0,composed:!0}))}get _sortedFiles(){const e=[...this.files];return e.sort((t,i)=>{const s=t.name.localeCompare(i.name)||t.id.localeCompare(i.id);return this._sortAsc?s:-s}),e}render(){var b,v,S,x,ie;if(!((v=(b=this.schema)==null?void 0:b.fields)!=null&&v.length))return l`
    ...
    `}};st.styles=[Ci];let _=st;k([u({attribute:!1})],_.prototype,"schema");k([u({attribute:!1})],_.prototype,"files");k([u({attribute:!1})],_.prototype,"config");k([u({attribute:!1})],_.prototype,"autocomplete");k([u({attribute:!1})],_.prototype,"taxonomyService");k([u({attribute:!1})],_.prototype,"ultratags");k([u({attribute:!1})],_.prototype,"defaultLanguage");k([u({attribute:!1})],_.prototype,"initialFieldKey");k([u({attribute:!1})],_.prototype,"dependencies");k([m()],_.prototype,"_activeFieldKey");k([m()],_.prototype,"_staged");k([m()],_.prototype,"_stagedTaxonodes");k([m()],_.prototype,"_selected");k([m()],_.prototype,"_sortAsc");k([m()],_.prototype,"_pendingOp");k([m()],_.prototype,"_confirmVisible");k([m()],_.prototype,"_missingRequiredFieldKey");k([m()],_.prototype,"_missingRequiredKeys");customElements.define("sfx-bulk-metadata-modal",_);const ft={text:l`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    ${$`<rect x="5" y="1.5" width="6" height="3" rx="0.5"/><rect x="1.5" y="11.5" width="4.5" height="3" rx="0.5"/><rect x="10" y="11.5" width="4.5" height="3" rx="0.5"/><path d="M8 4.5v3"/><path d="M3.75 11.5V8.5h8.5v3"/>`}
      ...
      ${this.schema.groups.map(t=>{var o;const i=this._isNarrow||!this._collapsed.has(t.uuid);if(e&&t.ckey&&((o=e.get(t.ckey))!=null&&o.hidden))return g;const s=e?t.fields.filter(r=>!yt(r,t,e)):t.fields;return s.length===0?g:l`
          ...
          ${i?s.map(r=>l`
                  ...
                  >
                    <span class="field-icon" aria-hidden="true">${Di(r.type)}</span>
    ...
    `}},V.styles=[Ii],V._ENTER_APPLY_TYPES=new Set(["text","numeric","decimal2","date","geopoint","attachment-uri"]),V);F([u({attribute:!1})],D.prototype,"field");F([u({attribute:!1})],D.prototype,"autocomplete");F([u({attribute:!1})],D.prototype,"taxonomyService");F([u({attribute:!1})],D.prototype,"ultratags");F([u({attribute:!1})],D.prototype,"defaultLanguage");F([u({attribute:!1})],D.prototype,"ultratagsPresentOnSelection");F([u({attribute:!1})],D.prototype,"config");F([u({type:Number})],D.prototype,"selectedCount");F([u({attribute:!1})],D.prototype,"allowedValues");F([m()],D.prototype,"_operation");F([m()],D.prototype,"_value");F([m()],D.prototype,"_pendingTaxonode");F([m()],D.prototype,"_opDropdownOpen");let zi=D;customElements.define("sfx-bulk-meta-op-bar",zi);var qi=Object.defineProperty,B=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&qi(e,t,s),s};const ot=class ot extends L{constructor(){super(...arguments),this.files=[],this.staged=new Map,this.stagedTaxonodes=new Map,this.selected=new Set,this.pendingOp=null,this.config=null,this.perFileResolved=new Map}_getEffectiveValue(e){const t=this.staged.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key):e.meta[this.field.key]}_getTaxonodeEntry(e){var i;const t=this.stagedTaxonodes.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key)??null:((i=e.taxonodes)==null?void 0:i[this.field.key])??null}render(){return l`
    ...
    `}};nt.styles=[Ti];let C=nt;z([u({attribute:!1})],C.prototype,"file");z([u({attribute:!1})],C.prototype,"field");z([u({attribute:!1})],C.prototype,"value");z([u({attribute:!1})],C.prototype,"taxonomyEntry");z([u({type:Boolean})],C.prototype,"selected");z([u({attribute:!1})],C.prototype,"pendingOp");z([u({attribute:!1})],C.prototype,"config");z([u({attribute:!1})],C.prototype,"autocomplete");z([u({attribute:!1})],C.prototype,"taxonomyService");z([u({attribute:!1})],C.prototype,"ultratags");z([u({attribute:!1})],C.prototype,"defaultLanguage");z([u({attribute:!1})],C.prototype,"allowedValues");z([m()],C.prototype,"_error");customElements.define("sfx-bulk-meta-row",C);const Bi=new Set(["multi-select","tags","ultratags"]);function gt(n,e,t){return!e.regional_variants_group_uuid||n==null||typeof n!="object"||Array.isArray(n)?n:n[t??"en"]}function mt(n){return Array.isArray(n)?n:[]}function xt(n){return n==null||n===""||Array.isArray(n)&&n.length===0?!0:typeof n=="object"&&!Array.isArray(n)?!Object.values(n).some(e=>e!=null&&e!==""):!1}function Fe(n,e){var i;const t=(i=n.possible_values)==null?void 0:i.find(s=>s.internal_unique_value===e||s.api_value===e);return(t==null?void 0:t.label)??String(e)}function bt(n,e){if(e==null||e==="")return"";switch(n.type){case"boolean":return e===!0?"True":e===!1?"False":"None";case"date":{if(typeof e!="string"||e.length===0)return"";try{return new Date(e+"T00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return e}}case"numeric":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:0}):String(e)}case"decimal2":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:2}):String(e)}case"select-one":return Fe(n,String(e));case"geopoint":{if(typeof e=="object"&&e!==null&&!Array.isArray(e)){const t=e;return!t.latitude&&!t.longitude?"":`(${t.latitude??""}, ${t.longitude??""})`}if(typeof e=="string"){const t=e.match(/^\((.+),(.+)\)$/);if(t)return`(${t[1].trim()}, ${t[2].trim()})`}return String(e)}default:return String(e)}}function Ki(n,e){const t=n.map(a=>typeof a=="string"?a:String(a)),i=e.map(a=>typeof a=="string"?a:String(a)),s=new Set(t),o=new Set(i),r=[];for(const a of i)r.push({label:a,state:s.has(a)?"kept":"added"});for(const a of t)o.has(a)||r.push({label:a,state:"removed"});return r}function Ni(n,e,t){const i=ye(n),s=ye(e),o=t||"en",r=h=>h.sid||h.slug||h.uuid||"",a=h=>ve({i18n:h.i18n,slug:h.slug||""},o,o).value||h.slug||h.sid||"",d=new Set(i.map(r).filter(Boolean)),c=new Set(s.map(r).filter(Boolean)),p=[];for(const h of s){const f=r(h);p.push({label:a(h),state:d.has(f)?"kept":"added"})}for(const h of i){const f=r(h);c.has(f)||p.push({label:a(h),state:"removed"})}return p}function Mi(n,e,t){const i=new Set(n.map(r=>JSON.stringify(r))),s=new Set(e.map(r=>JSON.stringify(r))),o=[];for(const r of e){const a=JSON.stringify(r),d=typeof r=="string"?Fe(t,r):String(r);o.push({label:d,state:i.has(a)?"kept":"added"})}for(const r of n){const a=JSON.stringify(r);if(!s.has(a)){const d=typeof r=="string"?Fe(t,r):String(r);o.push({label:d,state:"removed"})}}return o}function Vi(n,e,t,i){const s=X(n,i),o=i==null?void 0:i.language,r=gt(e,n,s),a=gt(t,n,s);if(Bi.has(n.type)){if(n.type==="ultratags")return{kind:"array",items:Ni(e,t,o)};const d=mt(r),c=mt(a);return n.type==="tags"?{kind:"array",items:Ki(d,c)}:{kind:"array",items:Mi(d,c,n)}}return{kind:"scalar",oldDisplay:bt(n,r),newDisplay:bt(n,a),oldEmpty:xt(r),newEmpty:xt(a)}}var ji=Object.defineProperty,le=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&ji(e,t,s),s};const at=class at extends L{constructor(){super(...arguments),this.oldTaxonomyEntry=null,this.newTaxonomyEntry=null,this.config=null}_renderArrayDiff(e){return l`
    ...
    `}render(){if(!this.field)return g;if(this.field.type==="taxonomy-node")return this._renderTaxonomyScalar();const e=Vi(this.field,this.oldValue,this.newValue,this.config);return e.kind==="array"?this._renderArrayDiff(e):this._renderScalarDiff(e)}};at.styles=[Ai];let U=at;le([u({attribute:!1})],U.prototype,"field");le([u({attribute:!1})],U.prototype,"oldValue");le([u({attribute:!1})],U.prototype,"newValue");le([u({attribute:!1})],U.prototype,"oldTaxonomyEntry");le([u({attribute:!1})],U.prototype,"newTaxonomyEntry");le([u({attribute:!1})],U.prototype,"config");customElements.define("sfx-bulk-meta-diff-view",U);export{_ as SfxBulkMetadataModal,Ji as clearDependenciesCache,Gi as clearSchemaCache,Wi as createTagsAutocomplete,Qi as createTaxonomyService,Xi as createUltratagsService,ts as deepMergeMeta,Yi as fetchDependencies,Hi as fetchMetadataSchema,is as getFilesWithMissingRequired,ss as isAssetHasMetadataValue,re as isEmpty,St as mapValueFromBackend,ze as mapValueToBackend,$t as parseMetadataSchema,vt as resolveForFileWithSchema,wt as validateField};
