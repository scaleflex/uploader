import{i as k,a as b,A as h,c as l,n as c,r as x,w as y,j as He,k as Je,m as Ue}from"./index-BlsVOKjW.js";function Le(n,e){const t=(e==null?void 0:e.language)??"en",s=n.model??[],i=n.store??{},o=s.find(u=>u.applies_to==="FILES");let r=(o==null?void 0:o.groups)??[];if(Array.isArray(e==null?void 0:e.fields)){const u=new Set(e.fields);r=r.map(g=>({...g,fields:g.fields.filter(m=>u.has(m.ckey))})).filter(g=>g.fields.length>0)}r=r.map(u=>({...u,fields:u.fields.filter(g=>!g.hide)})).filter(u=>u.fields.length>0);const a=r.flatMap(u=>u.fields),d=new Map(a.map(u=>[u.key,u])),p=i.force_filling_metadata_on_upload===!0,f=i.regional_variants_groups??[];return{groups:r,fields:a,fieldsByKey:d,forceFillingOnUpload:p,regionalVariantsGroups:f,language:t}}const Ge="https://hub.scaleflex.com/api",J=new Map,B=new Map;async function Dt(n,e,t,s){const i=J.get(t);if(i)return i;const o=B.get(t);if(o)return o;if(s!=null&&s.rawMetadata){const a=Le(s.rawMetadata,s);return J.set(t,a),a}const r=We(e,t,s);B.set(t,r);try{const a=await r;return J.set(t,a),a}finally{B.delete(t)}}async function We(n,e,t){var p,f,u;const i=`${(t==null?void 0:t.hubApiBase)??Ge}/project/${encodeURIComponent(e)}`,o=(t==null?void 0:t.hubHeaders)??n,r=await fetch(i,{headers:o});if(!r.ok)throw new Error(`Failed to fetch metadata schema (HTTP ${r.status})`);const a=await r.json(),d=((f=(p=a.data)==null?void 0:p.project)==null?void 0:f.data)??((u=a.project)==null?void 0:u.data);if(!(d!=null&&d.metadata))throw new Error("No metadata in project response");return Le(d.metadata,t)}function zt(n){var e;n?(J.delete(n),(e=B.get(n))==null||e.catch(()=>{}),B.delete(n)):(J.clear(),B.clear())}function Re(n,e,t){let s=e;switch(n.regional_variants_group_uuid&&s!=null&&typeof s=="object"&&!Array.isArray(s)&&(s=s[t??"en"]),n.type){case"geopoint":return Xe(s);case"boolean":return s===!0?"true":s===!1?"false":"null";case"date":return s?new Date(s):null;case"decimal2":return s!=null?String(s):"";case"tags":return Array.isArray(s)?s.map(i=>typeof i=="string"?{value:i,label:i}:i):[];case"multi-select":return s||[];default:return s??""}}function ae(n,e,t,s){var o;let i;switch(n.type){case"geopoint":{const r=e;!r||r.latitude===""||r.latitude==null||r.longitude===""||r.longitude==null?i=null:i=`(${r.latitude},${r.longitude})`;break}case"boolean":e==="true"?i=!0:e==="false"?i=!1:i=null;break;case"date":{if(!e)i=null;else{const r=e instanceof Date?e:new Date(e),a=r.getFullYear(),d=String(r.getMonth()+1).padStart(2,"0"),p=String(r.getDate()).padStart(2,"0");i=`${a}-${d}-${p}`}break}case"tags":i=Array.isArray(e)?e.map(r=>(r==null?void 0:r.label)??""):[];break;case"select-one":i=e===""?null:e;break;case"numeric":{if(e===""||e==null){i=null;break}const r=Number(e);i=Number.isFinite(r)?Math.round(r):null;break}case"decimal2":{if(e===""||e==null){i=null;break}const r=Number(e);i=Number.isFinite(r)?r:null;break}default:i=e}if(n.regional_variants_group_uuid){const r=s??"en";return{...((o=t==null?void 0:t.meta)==null?void 0:o[n.key])??{},[r]:i}}return i}function Xe(n){if(typeof n=="string"){const e=/\(([^)]+)\)/.exec(n);if(e){const t=e[1].split(",");if(t.length===2)return{latitude:t[0].trim(),longitude:t[1].trim()}}}return{latitude:"",longitude:""}}function je(n,e,t){var i;if((((i=t==null?void 0:t.requiredFields)==null?void 0:i.includes(n.ckey))||n.required===1)&&E(e))return`${n.title} is required`;if(E(e))return null;switch(n.type){case"numeric":{const o=Number(e);if(!Number.isFinite(o))return"Must be a valid number";if(!Number.isInteger(o))return"Must be an integer";if(o<-1999999999||o>1999999999)return"Value out of range (±1,999,999,999)";break}case"decimal2":{const o=Number(e);if(!Number.isFinite(o))return"Must be a valid number";if(!/^\-?\d*\.?\d{0,2}$/.test(String(e)))return"Maximum 2 decimal places";if(o<-999999999999e-2||o>999999999999e-2)return"Value out of range (±9,999,999,999.99)";break}case"geopoint":{const o=e,r=o.latitude!==""&&o.latitude!=null,a=o.longitude!==""&&o.longitude!=null;if(r!==a)return"Both latitude and longitude are required";if(r&&a){const d=Number(o.latitude),p=Number(o.longitude);if(!Number.isFinite(d)||d<-90||d>90)return"Latitude must be between -90 and 90";if(!Number.isFinite(p)||p<-180||p>180)return"Longitude must be between -180 and 180"}break}case"attachment-uri":{try{const o=new URL(e);if(!["http:","https:"].includes(o.protocol))return"Only http and https URLs are allowed"}catch{return"Invalid URI"}break}}if(n.validation&&typeof e=="string")try{if(!new RegExp(n.validation).test(e))return"Value does not match expected format"}catch{}return null}function E(n){return n==null?!0:Array.isArray(n)||typeof n=="string"?n.length===0:typeof n=="object"?!Object.values(n).some(e=>e!=null&&e!==""):!n}function Qe(n){return!E(n)}function Tt(n,e,t){const s=new Set(["idle","queued","rejected"]),i=[...n.values()].filter(d=>s.has(d.status));if(i.length===0)return{};const o=new Set((t==null?void 0:t.requiredFields)??[]),r=e.fields.filter(d=>d.required===1||o.has(d.ckey)),a={};for(const d of r){const p=i.filter(f=>!Qe(f.meta[d.key]));p.length>0&&(a[d.key]=p)}return a}function Pt(n,e){const t={...n};for(const s of Object.keys(e)){const i=e[s];if(i==null||i==="")continue;const o=n[s];if(Array.isArray(i))if(Array.isArray(o)){const r=new Set(o.map(d=>JSON.stringify(d))),a=[...o];for(const d of i){const p=JSON.stringify(d);r.has(p)||(r.add(p),a.push(d))}t[s]=a}else t[s]=i;else t[s]=i}return t}function Ft(n,e){let t=null,s=null,i=!1;return{search(o,r,a){if(t&&clearTimeout(t),s&&s.abort(),i=!1,!r.trim()){a([]);return}t=setTimeout(async()=>{var d;s=new AbortController;try{const p=`${n}/v5/metadata/autocomplete?q=${encodeURIComponent(r.trim())}&meta_key=_${encodeURIComponent(o)}&limit=20`,f=await fetch(p,{headers:e,signal:s.signal});if(i)return;if(!f.ok){a([]);return}const u=await f.json();if(i)return;const g=((d=u.data)==null?void 0:d.tags)??u.tags??[];a(g.map(m=>({sid:m.sid||void 0,value:m.tag||m.value||m.label||"",label:m.tag||m.label||m.value||""})))}catch{i||a([])}},200)},cancel(){i=!0,t&&clearTimeout(t),s&&s.abort()}}}var Ze=Object.defineProperty,V=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&Ze(e,t,i),i};const he=class he extends k{constructor(){super(...arguments),this.schema=null,this.meta={},this.config=null,this.disabled=!1,this._collapsed=new Set}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_renderGroup(e){const t=!this._collapsed.has(e.uuid);return l`
      <div class="group">
  ...
  `;let A=he;V([c({attribute:!1})],A.prototype,"schema");V([c({attribute:!1})],A.prototype,"meta");V([c({attribute:!1})],A.prototype,"config");V([c({attribute:!1})],A.prototype,"autocomplete");V([c({type:Boolean})],A.prototype,"disabled");V([x()],A.prototype,"_collapsed");customElements.define("sfx-metadata-form",A);const W=b`
...
`;var tt=Object.defineProperty,M=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&tt(e,t,i),i};const xe=class xe extends k{constructor(){super(...arguments),this.config=null,this.disabled=!1,this._error=null,this._dispatching=!1,this._handleChildBlur=e=>{this._dispatching||(e.stopPropagation(),this._onFieldBlur(e))}}get _isRequired(){var e,t;return(t=(e=this.config)==null?void 0:e.requiredFields)!=null&&t.includes(this.field.ckey)?!0:this.field.required===1}_onFieldBlur(e){var r;const{key:t,value:s}=e.detail,i=je(this.field,s,this.config??void 0);if(i){this._error=i;return}this._error=null;const o=ae(this.field,s,void 0,(r=this.config)==null?void 0:r.language);this._dispatching=!0,this.dispatchEvent(new CustomEvent("field-blur",{detail:{key:t,value:o},bubbles:!0,composed:!0})),this._dispatching=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("field-blur",this._handleChildBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("field-blur",this._handleChildBlur)}_renderField(e,t){const s=this.disabled;switch(e.type){case"text":case"attachment-uri":return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`;case"textarea":return l`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-textarea-field>`;case"select-one":return l`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-select-field>`;case"multi-select":return l`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-multi-select-field>`;case"tags":return l`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${s}></sfx-meta-tags-field>`;case"boolean":return l`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return l`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-number-field>`;case"date":return l`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-date-field>`;case"geopoint":return l`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-geo-point-field>`;default:return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`}}render(){var o;const e=this.field;if(!e)return h;const t=Re(e,this.value,(o=this.config)==null?void 0:o.language),i=e.type==="textarea"?"field-row field-row--top":"field-row";return l`
    ...
    `}};xe.styles=[et];let I=xe;M([c({attribute:!1})],I.prototype,"field");M([c({attribute:!1})],I.prototype,"value");M([c({attribute:!1})],I.prototype,"config");M([c({attribute:!1})],I.prototype,"autocomplete");M([c({type:Boolean})],I.prototype,"disabled");M([x()],I.prototype,"_error");customElements.define("sfx-metadata-field",I);var it=Object.defineProperty,de=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&it(e,t,i),i};class _ extends k{constructor(){super(...arguments),this.value="",this.disabled=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{key:this.field.key,...t!==void 0?{value:t}:{}},bubbles:!0,composed:!0}))}}de([c({attribute:!1})],_.prototype,"field");de([c({attribute:!1})],_.prototype,"value");de([c({type:Boolean})],_.prototype,"disabled");const be=class be extends _{_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var s,i;const e=((s=this.field)==null?void 0:s.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return l`
      <input
        type="text"
        .value=${this.value??""}
    ...
    `];let O=ye;Y([c({attribute:!1})],O.prototype,"autocomplete");Y([x()],O.prototype,"_query");Y([x()],O.prototype,"_results");Y([x()],O.prototype,"_loading");Y([x()],O.prototype,"_dropdownOpen");Y([x()],O.prototype,"_activeIndex");customElements.define("sfx-meta-tags-field",O);var at=Object.defineProperty,Ke=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&at(e,t,i),i};const F=[{label:"True",value:"true"},{label:"False",value:"false"}],_e=class _e extends _{constructor(){super(...arguments),this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _currentLabel(){var t;if(this.value==null)return"";const e=String(this.value);return((t=F.find(s=>s.value===e))==null?void 0:t.label)??""}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_openDropdown(){this._open=!0;const e=this.value==null?"":String(this.value);this._activeIndex=Math.max(F.findIndex(t=>t.value===e),0),document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".dropdown"))==null||t.focus()})}_closeAndSubmit(e=!1){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-blur",this.value),e&&this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".trigger"))==null||t.focus()})}_onOutsideClick(e){e.composedPath().includes(this)||this._closeAndSubmit()}_onSelect(e,t=!1){this.value=e.value,this._emit("field-change",e.value),this._closeAndSubmit(t)}_clear(e){e.stopPropagation(),this.value=null,this._emit("field-change",null),this._emit("field-blur",null)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){var t;if(e.key==="Escape"){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-escape"),(t=this.renderRoot.querySelector(".trigger"))==null||t.focus();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,F.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=F.length-1,this._scrollActive();break;case"Enter":case" ":this._activeIndex>=0&&this._activeIndex<F.length&&(e.preventDefault(),this._onSelect(F[this._activeIndex],!0));break}}render(){var i,o;const e=this.value==null?"":String(this.value),t=((i=this.field)==null?void 0:i.title)??"",s=t?`Select ${t.toLowerCase()}`:"Select an option";return l`
      <button class="trigger" ?disabled=${this.disabled}
        role="combobox" aria-expanded=${this._open} aria-haspopup="listbox"
        @click=${()=>this._open?this._closeAndSubmit(!0):this._openDropdown()}
        @keydown=${this._onKeydown}>
    ...
    `];let re=$e;customElements.define("sfx-meta-geo-point-field",re);var lt=Object.defineProperty,Q=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&lt(e,t,i),i};const Ce=class Ce extends k{constructor(){super(...arguments),this.disabled=!1}render(){const e=this.field,t=this.value,s=this.disabled;switch(e.type){case"text":case"attachment-uri":return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`;case"textarea":return l`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-textarea-field>`;case"select-one":return l`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-select-field>`;case"multi-select":return l`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-multi-select-field>`;case"tags":return l`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${s}></sfx-meta-tags-field>`;case"boolean":return l`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return l`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-number-field>`;case"date":return l`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-date-field>`;case"geopoint":return l`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-geo-point-field>`;default:return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`}}};Ce.styles=b`
    :host { display: block; }
  `;let q=Ce;Q([c({attribute:!1})],q.prototype,"field");Q([c({attribute:!1})],q.prototype,"value");Q([c({attribute:!1})],q.prototype,"autocomplete");Q([c({type:Boolean})],q.prototype,"disabled");customElements.define("sfx-metadata-field-edit",q);var dt=Object.defineProperty,Ve=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&dt(e,t,i),i};const Se=class Se extends k{_formatValue(){var s,i;const e=this.value,t=(s=this.field)==null?void 0:s.type;switch(t){case"boolean":return e==="true"?"True":e==="false"?"False":"";case"date":return e?e instanceof Date?e.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"}):typeof e=="string"&&e.length>0?e:"":"";case"numeric":case"decimal2":{if(e==null||e==="")return"";const o=Number(e);return Number.isFinite(o)?o.toLocaleString(void 0,{maximumFractionDigits:t==="decimal2"?2:0}):String(e)}case"select-one":{if(e==null||e==="")return"";const o=(i=this.field.possible_values)==null?void 0:i.find(r=>r.internal_unique_value===e||r.api_value===e);return(o==null?void 0:o.label)??String(e)}case"multi-select":return!Array.isArray(e)||e.length===0?"":e.map(o=>{var a;const r=(a=this.field.possible_values)==null?void 0:a.find(d=>d.internal_unique_value===o||d.api_value===o);return(r==null?void 0:r.label)??String(o)}).join(", ");case"tags":return!Array.isArray(e)||e.length===0?"":e.map(o=>o.label||o.value).join(", ");case"geopoint":{const o=e;return!o||o.latitude===""||o.latitude==null||o.longitude===""||o.longitude==null?"":`(${o.latitude}, ${o.longitude})`}case"attachment-uri":return!e||typeof e=="string"&&e.length===0?"":String(e);case"text":case"textarea":default:return e==null||e===""?"":String(e)}}render(){var s;const e=this._formatValue(),t=e==="";return((s=this.field)==null?void 0:s.type)==="attachment-uri"&&!t?l`
        <div class="value">
  ...
  `;let G=Se;Ve([c({attribute:!1})],G.prototype,"field");Ve([c({attribute:!1})],G.prototype,"value");customElements.define("sfx-metadata-field-view",G);const ue=new Set(["multi-select","tags","integer-list"]),fe=new Set(["text","textarea","attachment-uri"]);function ct(n){return ue.has(n)?[{key:"SET",label:"Set"},{key:"ADD",label:"Add to"},{key:"DELETE",label:"Remove from"}]:fe.has(n)?[{key:"SET",label:"Set"},{key:"ADD",label:"Append"},{key:"DELETE",label:"Remove"}]:[{key:"SET",label:"Set"},{key:"DELETE",label:"Clear"}]}function oe(n,e){return n==="DELETE"?ue.has(e)||fe.has(e):!0}function pt(n,e,t,s){const i=ue.has(s),o=fe.has(s);switch(n){case"SET":return t;case"ADD":{if(i){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[];if(a.length===0)return r;if(s==="tags"){const f=new Set(r.map(g=>g)),u=[...r];for(const g of a){const m=typeof g=="string"?g:String(g);f.has(m)||(f.add(m),u.push(m))}return u}const d=new Set(r.map(f=>JSON.stringify(f))),p=[...r];for(const f of a){const u=JSON.stringify(f);d.has(u)||(d.add(u),p.push(f))}return p}if(o){const r=typeof t=="string"?t:"";if(!r)return e??"";const a=typeof e=="string"?e:"";return a?`${a} ${r}`:r}return t}case"DELETE":{if(i){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[];if(a.length===0)return r;if(s==="tags"){const p=new Set(a.map(f=>typeof f=="string"?f:String(f)));return r.filter(f=>!p.has(typeof f=="string"?f:String(f)))}const d=new Set(a.map(p=>JSON.stringify(p)));return r.filter(p=>!d.has(JSON.stringify(p)))}if(o){const r=typeof t=="string"?t:"";return r?(typeof e=="string"?e:"").replaceAll(r,"").replace(/\s{2,}/g," ").trim():""}return s==="geopoint"?{latitude:"",longitude:""}:null}default:return t}}function Me(n,e,t,s,i){const o=i??"en",r=!!n.regional_variants_group_uuid,a={meta:{[n.key]:e}},d=ae(n,t,a,i),p=m=>r&&m!==null&&typeof m=="object"&&!Array.isArray(m),f=p(e)?e[o]:e,u=p(d)?d[o]:d,g=pt(s,f,u,n.type);return r?{...p(e)?e:{},[o]:g}:g}const Ye=b`
  .fm-checkbox {
...
`;var mt=Object.defineProperty,C=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&mt(e,t,i),i};const Ee=class Ee extends k{constructor(){super(...arguments),this.files=[],this.config=null,this._activeFieldKey="",this._staged=new Map,this._selected=new Set,this._sortAsc=!0,this._pendingOp=null,this._confirmVisible=!1,this._confirmResolve=null,this._originalFiles=new Map,this._onKeyDown=async e=>{if(e.key!=="Escape")return;if(this._confirmVisible){e.stopPropagation(),this._onConfirmCancel();return}e.composedPath().some(i=>i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement||i instanceof HTMLSelectElement)||await this._confirmDiscardPending()&&this._emitClose()},this._onConfirmOk=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!0),this._confirmResolve=null},this._onConfirmCancel=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null},this._onConfirmKeydown=e=>{var a,d;if(e.key!=="Tab")return;const t=(a=this.shadowRoot)==null?void 0:a.querySelector(".fm-confirm");if(!t)return;const s=t.querySelectorAll("button");if(s.length===0)return;const i=s[0],o=s[s.length-1],r=(d=this.shadowRoot)==null?void 0:d.activeElement;e.shiftKey&&r===i?(e.preventDefault(),o.focus()):!e.shiftKey&&r===o&&(e.preventDefault(),i.focus())},this._onPendingChange=e=>{const{operation:t,value:s}=e.detail,i=this._activeField;E(s)&&(!i||oe(t,i.type))?this._pendingOp=null:this._pendingOp={operation:t,value:s}},this._onFieldSelect=async e=>{await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e.detail.fieldKey)},this._onBulkApply=e=>{var a,d,p;const t=this._activeField;if(!t)return;const{operation:s,value:i}=e.detail,o=(a=this.config)==null?void 0:a.language,r=[];for(const f of this._selected){const u=this._staged.get(f),g=u!=null&&u.has(t.key)?u.get(t.key):((p=(d=this._originalFiles.get(f))==null?void 0:d.meta)==null?void 0:p[t.key])??null,m=Me(t,g,i,s,o);r.push([f,t.key,m])}this._setStagedBulk(r)},this._onRowFieldChange=e=>{const t=this._activeField;t&&this._setStagedValue(e.detail.fileId,t.key,e.detail.value)},this._onRowToggle=e=>{const t=new Set(this._selected);t.has(e.detail.fileId)?t.delete(e.detail.fileId):t.add(e.detail.fileId),this._selected=t},this._onSelectAll=()=>{this._selected.size===this.files.length?this._selected=new Set:this._selected=new Set(this.files.map(e=>e.id))},this._onSortToggle=()=>{this._sortAsc=!this._sortAsc},this._onSave=async()=>{if(!await this._confirmDiscardPending())return;const e=[];for(const[t,s]of this._staged){const i=this._originalFiles.get(t);if(!i)continue;const o={};for(const[r,a]of s)JSON.stringify(a)!==JSON.stringify(i.meta[r])&&(o[r]=a);Object.keys(o).length>0&&e.push({fileId:t,meta:o})}this.dispatchEvent(new CustomEvent("metadata-save-batch",{detail:{changes:e},bubbles:!0,composed:!0})),this._emitClose()},this._onCancel=async()=>{await this._confirmDiscardPending()&&this._emitClose()},this._onClose=async()=>{await this._confirmDiscardPending()&&this._emitClose()}}connectedCallback(){super.connectedCallback(),this._initStaged(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null}_initStaged(){var i,o;const e=new Map,t=new Set,s=new Map;for(const r of this.files){const a=new Map;if(r.meta)for(const[d,p]of Object.entries(r.meta))a.set(d,p);e.set(r.id,a),t.add(r.id),s.set(r.id,r)}this._staged=e,this._selected=t,this._originalFiles=s,((o=(i=this.schema)==null?void 0:i.fields)==null?void 0:o.length)>0&&(this._activeFieldKey=this.schema.fields[0].key)}_setStagedValue(e,t,s){const i=new Map(this._staged),o=new Map(i.get(e)??new Map);o.set(t,s),i.set(e,o),this._staged=i}_setStagedBulk(e){const t=new Map(this._staged);for(const[s,i,o]of e){const r=new Map(t.get(s)??new Map);r.set(i,o),t.set(s,r)}this._staged=t}get _activeField(){var e,t;return(t=(e=this.schema)==null?void 0:e.fieldsByKey)==null?void 0:t.get(this._activeFieldKey)}get _filledFields(){var t,s;const e=new Set;for(const i of((t=this.schema)==null?void 0:t.fields)??[])for(const[o,r]of this._staged){const a=r.get(i.key),d=(s=this._originalFiles.get(o))==null?void 0:s.meta[i.key];if(a!==void 0&&!E(a)&&JSON.stringify(a)!==JSON.stringify(d)){e.add(i.key);break}}return e}get _hasPendingValue(){return this._pendingOp!=null&&!E(this._pendingOp.value)}_confirmDiscardPending(){return this._hasPendingValue?new Promise(e=>{this._confirmResolve=e,this._confirmVisible=!0}):Promise.resolve(!0)}updated(e){var t;(t=super.updated)==null||t.call(this,e),e.has("_confirmVisible")&&this._confirmVisible&&requestAnimationFrame(()=>{var i;const s=(i=this.shadowRoot)==null?void 0:i.querySelector(".fm-confirm .btn-ghost");s==null||s.focus()})}_emitClose(){this.dispatchEvent(new CustomEvent("metadata-close",{bubbles:!0,composed:!0}))}get _sortedFiles(){const e=[...this.files];return e.sort((t,s)=>{const i=t.name.localeCompare(s.name)||t.id.localeCompare(s.id);return this._sortAsc?i:-i}),e}render(){var o,r;if(!((r=(o=this.schema)==null?void 0:o.fields)!=null&&r.length))return l`
      ...
      `;const e=this._activeField,t=this._sortedFiles,s=this._selected.size===this.files.length&&this.files.length>0,i=this._selected.size>0&&!s;return l`
      <div class="fm-overlay" @click=${this._onClose}>
        <div class="fm-modal" @click=${a=>a.stopPropagation()}>
          <!-- Top bar -->
          <div class="fm-topbar">
    ...
    `}};Ee.styles=[ut];let v=Ee;C([c({attribute:!1})],v.prototype,"schema");C([c({attribute:!1})],v.prototype,"files");C([c({attribute:!1})],v.prototype,"config");C([c({attribute:!1})],v.prototype,"autocomplete");C([x()],v.prototype,"_activeFieldKey");C([x()],v.prototype,"_staged");C([x()],v.prototype,"_selected");C([x()],v.prototype,"_sortAsc");C([x()],v.prototype,"_pendingOp");C([x()],v.prototype,"_confirmVisible");customElements.define("sfx-bulk-metadata-modal",v);const ze={text:l`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    `}},S.styles=[ht],S._ENTER_APPLY_TYPES=new Set(["text","numeric","decimal2","date","geopoint","attachment-uri"]),S);R([c({attribute:!1})],z.prototype,"field");R([c({attribute:!1})],z.prototype,"autocomplete");R([c({attribute:!1})],z.prototype,"config");R([c({type:Number})],z.prototype,"selectedCount");R([x()],z.prototype,"_operation");R([x()],z.prototype,"_value");R([x()],z.prototype,"_opDropdownOpen");let wt=z;customElements.define("sfx-bulk-meta-op-bar",wt);var kt=Object.defineProperty,j=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&kt(e,t,i),i};const Ie=class Ie extends k{constructor(){super(...arguments),this.files=[],this.staged=new Map,this.selected=new Set,this.pendingOp=null,this.config=null}_getEffectiveValue(e){const t=this.staged.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key):e.meta[this.field.key]}render(){return l`
      ${this.files.map(e=>l`
          <sfx-bulk-meta-row
            .file=${e}
            .field=${this.field}
          ...
          ></sfx-bulk-meta-row>
        `)}
    `}};Ie.styles=[gt];let $=Ie;j([c({attribute:!1})],$.prototype,"files");j([c({attribute:!1})],$.prototype,"field");j([c({attribute:!1})],$.prototype,"staged");j([c({attribute:!1})],$.prototype,"selected");j([c({attribute:!1})],$.prototype,"pendingOp");j([c({attribute:!1})],$.prototype,"config");j([c({attribute:!1})],$.prototype,"autocomplete");customElements.define("sfx-bulk-meta-table",$);var $t=Object.defineProperty,T=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&$t(e,t,i),i};const Oe=class Oe extends k{constructor(){super(...arguments),this.selected=!1,this.pendingOp=null,this.config=null,this._error=null,this._onFieldBlur=e=>{var r;e.stopPropagation();const{value:t}=e.detail,s=je(this.field,t,this.config??void 0);if(s){this._error=s;return}this._error=null;const i={meta:{...this.file.meta,[this.field.key]:this.value}},o=ae(this.field,t,i,(r=this.config)==null?void 0:r.language);JSON.stringify(o)!==JSON.stringify(this.value)&&this.dispatchEvent(new CustomEvent("row-field-change",{detail:{fileId:this.file.id,value:o},bubbles:!0,composed:!0}))}}willUpdate(e){e.has("field")&&(this._error=null)}_onCheckboxChange(){this.dispatchEvent(new CustomEvent("row-toggle",{detail:{fileId:this.file.id},bubbles:!0,composed:!0}))}_computePreviewValue(){var t;const e=this.pendingOp;return!e||!this.field?this.value:Me(this.field,this.value,e.value,e.operation,(t=this.config)==null?void 0:t.language)}_getExtension(e){const t=e.lastIndexOf(".");return t>0?e.slice(t+1).toUpperCase():"?"}render(){var t;const e=this.file;return l`
      <div class="row">
        <div class="row-check">
          <input
            type="checkbox"
        ...
        ${e.previewUrl?l`<img class="row-thumb" src=${e.previewUrl} alt="" />`:l`<img class="row-thumb row-thumb-fallback"
              ...
              @error=${s=>{const i=s.target,o=Je();!i.dataset.fallback&&i.src!==o&&(i.dataset.fallback="1",i.src=o)}}
            />`}
    ...
    `}};Oe.styles=[xt];let w=Oe;T([c({attribute:!1})],w.prototype,"file");T([c({attribute:!1})],w.prototype,"field");T([c({attribute:!1})],w.prototype,"value");T([c({type:Boolean})],w.prototype,"selected");T([c({attribute:!1})],w.prototype,"pendingOp");T([c({attribute:!1})],w.prototype,"config");T([c({attribute:!1})],w.prototype,"autocomplete");T([x()],w.prototype,"_error");customElements.define("sfx-bulk-meta-row",w);const Ct=new Set(["multi-select","tags","integer-list"]);function Te(n,e,t){return!e.regional_variants_group_uuid||n==null||typeof n!="object"||Array.isArray(n)?n:n[t??"en"]}function Pe(n){return Array.isArray(n)?n:[]}function Fe(n){return n==null||n===""||Array.isArray(n)&&n.length===0?!0:typeof n=="object"&&!Array.isArray(n)?!Object.values(n).some(e=>e!=null&&e!==""):!1}function ne(n,e){var s;const t=(s=n.possible_values)==null?void 0:s.find(i=>i.internal_unique_value===e||i.api_value===e);return(t==null?void 0:t.label)??String(e)}function qe(n,e){if(e==null||e==="")return"";switch(n.type){case"boolean":return e===!0?"True":e===!1?"False":"None";case"date":{if(typeof e!="string"||e.length===0)return"";try{return new Date(e+"T00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return e}}case"numeric":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:0}):String(e)}case"decimal2":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:2}):String(e)}case"select-one":return ne(n,String(e));case"geopoint":{if(typeof e=="object"&&e!==null&&!Array.isArray(e)){const t=e;return!t.latitude&&!t.longitude?"":`(${t.latitude??""}, ${t.longitude??""})`}if(typeof e=="string"){const t=e.match(/^\((.+),(.+)\)$/);if(t)return`(${t[1].trim()}, ${t[2].trim()})`}return String(e)}default:return String(e)}}function St(n,e){const t=n.map(a=>typeof a=="string"?a:String(a)),s=e.map(a=>typeof a=="string"?a:String(a)),i=new Set(t),o=new Set(s),r=[];for(const a of s)r.push({label:a,state:i.has(a)?"kept":"added"});for(const a of t)o.has(a)||r.push({label:a,state:"removed"});return r}function Et(n,e,t){const s=new Set(n.map(r=>JSON.stringify(r))),i=new Set(e.map(r=>JSON.stringify(r))),o=[];for(const r of e){const a=JSON.stringify(r),d=typeof r=="string"?ne(t,r):String(r);o.push({label:d,state:s.has(a)?"kept":"added"})}for(const r of n){const a=JSON.stringify(r);if(!i.has(a)){const d=typeof r=="string"?ne(t,r):String(r);o.push({label:d,state:"removed"})}}return o}function At(n,e,t,s){const i=s==null?void 0:s.language,o=Te(e,n,i),r=Te(t,n,i);if(Ct.has(n.type)){const a=Pe(o),d=Pe(r);return n.type==="tags"?{kind:"array",items:St(a,d)}:{kind:"array",items:Et(a,d,n)}}return{kind:"scalar",oldDisplay:qe(n,o),newDisplay:qe(n,r),oldEmpty:Fe(o),newEmpty:Fe(r)}}var It=Object.defineProperty,Z=(n,e,t,s)=>{for(var i=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=r(e,t,i)||i);return i&&It(e,t,i),i};const De=class De extends k{constructor(){super(...arguments),this.config=null}_renderArrayDiff(e){return l`
    ...
    `}render(){if(!this.field)return h;const e=At(this.field,this.oldValue,this.newValue,this.config);return e.kind==="array"?this._renderArrayDiff(e):this._renderScalarDiff(e)}};De.styles=[bt];let L=De;Z([c({attribute:!1})],L.prototype,"field");Z([c({attribute:!1})],L.prototype,"oldValue");Z([c({attribute:!1})],L.prototype,"newValue");Z([c({attribute:!1})],L.prototype,"config");customElements.define("sfx-bulk-meta-diff-view",L);export{v as SfxBulkMetadataModal,zt as clearSchemaCache,Ft as createTagsAutocomplete,Pt as deepMergeMeta,Dt as fetchMetadataSchema,Tt as getFilesWithMissingRequired,Qe as isAssetHasMetadataValue,E as isEmpty,Re as mapValueFromBackend,ae as mapValueToBackend,Le as parseMetadataSchema,je as validateField};
