 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wn=(r,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(r,e,t),t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Zi(r,e){return(t,i,o)=>{const s=n=>{var a;return((a=n.renderRoot)==null?void 0:a.querySelector(r))??null};return Wn(t,i,{get(){return s(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Gn}=cn,Qr=r=>r,eo=()=>document.createComment(""),pt=(r,e,t)=>{var s;const i=r._$AA.parentNode,o=e===void 0?r._$AB:e._$AA;if(t===void 0){const n=i.insertBefore(eo(),o),a=i.insertBefore(eo(),o);t=new Gn(n,a,r,r.options)}else{const n=t._$AB.nextSibling,a=t._$AM,l=a!==r;if(l){let c;(s=t._$AQ)==null||s.call(t,r),t._$AM=r,t._$AP!==void 0&&(c=r._$AU)!==a._$AU&&t._$AP(c)}if(n!==o||l){let c=t._$AA;for(;c!==n;){const d=Qr(c).nextSibling;Qr(i).insertBefore(c,o),c=d}}}return t},Le=(r,e,t=r)=>(r._$AI(e,t),r),Xn={},Jn=(r,e=Xn)=>r._$AH=e,Zn=r=>r._$AH,vi=r=>{r._$AR(),r._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const to=(r,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(r[o],o);return i},Ri=Tt(class extends li{constructor(r){if(super(r),r.type!==ai.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],s=[];let n=0;for(const a of r)o[n]=i?i(a,n):n,s[n]=t(a,n),n++;return{values:s,keys:o}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){const o=Zn(r),{values:s,keys:n}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=n,s;const a=this.ut??(this.ut=[]),l=[];let c,d,p=0,u=o.length-1,m=0,g=s.length-1;for(;p<=u&&m<=g;)if(o[p]===null)p++;else if(o[u]===null)u--;else if(a[p]===n[m])l[m]=Le(o[p],s[m]),p++,m++;else if(a[u]===n[g])l[g]=Le(o[u],s[g]),u--,g--;else if(a[p]===n[g])l[g]=Le(o[p],s[g]),pt(r,l[g+1],o[p]),p++,g--;else if(a[u]===n[m])l[m]=Le(o[u],s[m]),pt(r,o[p],o[u]),u--,m++;else if(c===void 0&&(c=to(n,m,g),d=to(a,p,u)),c.has(a[p]))if(c.has(a[u])){const v=d.get(n[m]),$=v!==void 0?o[v]:null;if($===null){const L=pt(r,o[p]);Le(L,s[m]),l[m]=L}else l[m]=Le($,s[m]),pt(r,o[p],$),o[v]=null;m++}else vi(o[u]),u--;else vi(o[p]),p++;for(;m<=g;){const v=pt(r,l[g+1]);Le(v,s[m]),l[m++]=v}for(;p<=u;){const v=o[p++];v!==null&&vi(v)}return this.ut=n,Jn(r,l),he}}),bi=r=>r.includes("-")?r:r.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`);class Qn extends li{constructor(e){if(super(e),this._appliedProps=new Set,e.type!==ai.ELEMENT)throw new Error("cspStyle must be used as an element directive: <el ${cspStyle({...})}>")}render(e){return he}update(e,[t]){if(t===this._lastStyles)return he;this._lastStyles=t;const{style:i}=e.element,o=t??{};for(const s of this._appliedProps)(!(s in o)||o[s]==null||o[s]==="")&&(i.removeProperty(bi(s)),this._appliedProps.delete(s));for(const[s,n]of Object.entries(o))n!=null&&n!==""?(i.setProperty(bi(s),n),this._appliedProps.add(s)):this._appliedProps.has(s)&&(i.removeProperty(bi(s)),this._appliedProps.delete(s));return he}}const Q=Tt(Qn);function ea(r,e){var n,a,l;const t=(n=e==null?void 0:e.getLocateUrl)==null?void 0:n.call(e,r);if(t)return t;const i=(e==null?void 0:e.adminUrl)??(typeof window<"u"?window.location.origin:void 0);if(!i)return null;const o=(l=(a=r.response)==null?void 0:a.file)==null?void 0:l.uuid;return o?`${i.replace(/\/+$/,"")}/library?lf=${encodeURIComponent(btoa(o))}`:null}class ta{constructor(e){this.listeners=new Set,this._notifying=!1,this._pendingState=null,this.state=e}getState(){return this.state}setState(e){if(this._notifying){this._pendingState={...this._pendingState||{},...e};return}const t=this.state;this.state={...t,...e},this._notifying=!0;try{this.listeners.forEach(i=>i(this.state,t))}finally{this._notifying=!1}if(this._pendingState){const i=this._pendingState;this._pendingState=null,this.setState(i)}}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}destroy(){this.listeners.clear()}}function J(r,e,t){const i=r.getState().files,o=i.get(e);if(!o)return;const s=new Map(i);s.set(e,{...o,...t}),r.setState({files:s})}function Ve(r,e){const t=new Map(r.getState().files);t.set(e.id,e),r.setState({files:t})}function io(r,e){const t=r.getState().files;if(!t.has(e))return;const i=new Map(t);i.delete(e),r.setState({files:i})}function ia(){return new ta({files:new Map,queueConfig:{concurrency:3,autoProceed:!1,retryConfig:{maxRetries:0,baseDelay:1e3,maxDelay:3e4,backoffFactor:2}},isPaused:!1,restrictions:{maxFileSize:null,maxTotalFilesSize:null,maxNumberOfFiles:null,minNumberOfFiles:null,allowedFileTypes:null,blockedFileTypes:null},targetFolder:"/",totalProgress:0,totalSpeed:0,totalBytesUploaded:0,totalBytes:0,isUploading:!1,t:(r,e,t)=>{const i=(o,s)=>o.replace(/\{\{(\w+)\}\}/g,(n,a)=>String(s[a]??""));if(typeof e=="string")return i(e,t??{});if(typeof e=="object"&&e!==null){const o=e,s=o.count;if(s!==void 0){const n=String((s===1?o.defaultValue_one:o.defaultValue_other)??o.defaultValue??r);return i(n,o)}return i(String(o.defaultValue??r),o)}return r}})}class ra{constructor(e,t){this.host=e,this.store=t,e.addController(this)}get state(){return this.store.getState()}setState(e){this.store.setState(e)}hostConnected(){this.unsubscribe=this.store.subscribe(()=>{this.host.requestUpdate()})}hostDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this)}}const oa="SAME_ASSET_EXISTS_SKIP_UPLOAD",sa="ERROR_SHA1_CONFLICT";function Lt(r){return(r==null?void 0:r.code)===oa||(r==null?void 0:r.code)===sa}function Qi(r,e){return{...r,status:"success",file:r.file??{uuid:r.existing_file_uuid??"",name:e.name,extension:e.name.split(".").pop()??"",type:e.type,size:e.size,url:{public:"",cdn:""},meta:{},tags:[],info:{},created_at:"",modified_at:""}}}const na=/[!#$%^&*()=+{}\[\];"<>\\,\/?~\t\n\r\s`]/;function er(r){return r?r.ref!=null&&r.ref!==""||r.position!=null:!1}function tr(r){const e={};return(r==null?void 0:r.ref)!=null&&r.ref!==""&&(e.ref=r.ref),(r==null?void 0:r.position)!=null&&(e.position=r.position),e}function ro(r,e){const t={...r??{}};for(const i of Object.keys(e)){const o=e[i];o===void 0?delete t[i]:t[i]=o}return t}function aa(r,e,t){let o=`${r.replace(/\/+$/,"")}/v4/files?folder=${encodeURIComponent(e)}`;if(t)for(const[s,n]of Object.entries(t))n!=null&&(o+=`&${encodeURIComponent(s)}=${encodeURIComponent(n)}`);return o}function la(r,e){const t=new XMLHttpRequest;let i=!1;const o=aa(e.apiBase,e.folder,e.extraParams);t.open("POST",o);for(const[n,a]of Object.entries(e.authHeaders))t.setRequestHeader(n,a);t.upload.addEventListener("progress",n=>{n.lengthComputable&&!i&&e.onProgress(n.loaded,n.total)}),t.addEventListener("load",()=>{if(i)return;let n;try{n=JSON.parse(t.responseText)}catch{e.onError(new Error(`Invalid JSON response (HTTP ${t.status})`));return}t.status>=200&&t.status<300&&n.status==="success"?e.onComplete(n):Lt(n)?e.onComplete(Qi(n,r)):e.onError(new Error(n.hint||n.msg||`Upload failed (HTTP ${t.status})`))}),t.addEventListener("error",()=>{i||e.onError(new Error("Network error — check your connection"))});const s=new FormData;if(r.file){const n={name:r.name,type:r.type};s.append("info[files[]]",JSON.stringify(n)),Object.keys(r.meta).length>0&&s.append("meta[files[]]",JSON.stringify(r.meta)),r.tags.length>0&&s.append("tags[files[]]",JSON.stringify(r.tags)),er(r.product)&&s.append("product[files[]]",JSON.stringify(tr(r.product))),s.append("files[]",r.file,r.name)}return t.send(s),{abort(){i=!0,t.abort()}}}function ci(r){return{Accept:"application/json","Content-Type":"application/json","uppy-auth-token":r}}function Oe(r){return r.replace(/\/+$/,"")}const ca={"google-drive":"drive",dropbox:"dropbox",onedrive:"onedrive",box:"box",instagram:"instagram",facebook:"facebook",unsplash:"unsplash"};function Ft(r){return ca[r]??r}function Ad(r,e){const t=Oe(r),i=btoa(JSON.stringify({origin:window.location.origin})),o=Ft(e);return`${t}/${o}/connect?state=${encodeURIComponent(i)}`}async function da(r,e,t,i="",o){const s=Oe(r),n=i?`/${i}`:"",a=Ft(e),l=await fetch(`${s}/${a}/list${n}`,{method:"GET",headers:ci(t),credentials:"same-origin",signal:o});if(l.status===401)throw new ir;if(!l.ok){const c=await l.json().catch(()=>null);throw new Error((c==null?void 0:c.message)||`Companion list failed (HTTP ${l.status})`)}return l.json()}async function pa(r,e,t,i){const o=Oe(r),s=await fetch(`${o}/${t}`,{method:"GET",headers:ci(e),credentials:"same-origin",signal:i});if(s.status===401)throw new ir;if(!s.ok){const n=await s.json().catch(()=>null);throw new Error((n==null?void 0:n.message)||`Companion list failed (HTTP ${s.status})`)}return s.json()}async function Td(r,e,t,i,o,s){const n=[];async function a(l,c){let d=null,p=!0;do{if(s!=null&&s.aborted)throw new DOMException("Aborted","AbortError");const u=p?await da(r,e,t,l,s):await pa(r,t,d,s);p=!1,d=u.nextPagePath;for(const m of u.items){if(s!=null&&s.aborted)throw new DOMException("Aborted","AbortError");if(m.isFolder){const g=c?`${c}/${m.name}`:m.name;await a(m.requestPath,g)}else n.push({...m,relativeFolder:c})}}while(d)}return await a(i,o),n}async function Ld(r,e,t,i){const o=Oe(r),s=Ft(e),n=i?`q=${encodeURIComponent(t)}&${i}`:`q=${encodeURIComponent(t)}`,a=await fetch(`${o}/search/${s}/list?${n}`,{method:"GET",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin"});if(!a.ok){const l=await a.json().catch(()=>null);throw new Error((l==null?void 0:l.message)||`Search failed (HTTP ${a.status})`)}return a.json()}async function ua(r,e,t,i,o,s=!1){const n=Oe(r),a=Ft(e),l=s?`${n}/search/${a}/get/${i}`:`${n}/${a}/get/${i}`,c=s?{Accept:"application/json","Content-Type":"application/json"}:ci(t),d=await fetch(l,{method:"POST",headers:c,credentials:"same-origin",body:JSON.stringify({...o,httpMethod:o.httpMethod??"POST",useFormData:o.useFormData??!0,fieldname:o.fieldname??"files[]"})});if(d.status===401)throw new ir;if(!d.ok){const p=await d.json().catch(()=>null);throw new Error((p==null?void 0:p.message)||`Companion upload failed (HTTP ${d.status})`)}return d.json()}async function fa(r,e,t){const i=Oe(r),o=await fetch(`${i}/url/meta`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin",body:JSON.stringify({url:e}),signal:t});if(!o.ok){const s=await o.json().catch(()=>null);throw new Error((s==null?void 0:s.message)||`Could not fetch URL metadata (HTTP ${o.status})`)}return o.json()}async function ha(r,e,t,i){const o=Oe(r),s=await fetch(`${o}/url/get`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin",body:JSON.stringify({url:e,...t,httpMethod:"POST",useFormData:!0,fieldname:"files[]"}),signal:i});if(!s.ok){const n=await s.json().catch(()=>null);throw new Error((n==null?void 0:n.message)||`Companion URL upload failed (HTTP ${s.status})`)}return s.json()}async function Fd(r,e,t){const i=Oe(r),o=Ft(e),s=await fetch(`${i}/${o}/logout`,{method:"GET",headers:ci(t),credentials:"same-origin"});return s.ok?s.json():{ok:!1,revoked:!1}}function ga(r){var o;const t=((o=/^(?:https?:\/\/|\/\/)?(?:[^@\n]+@)?(?:www\.)?([^\n]+)/i.exec(r))==null?void 0:o[1])??r;return`${/^https:\/\//i.test(r)?"wss":"ws"}://${t}`}class ir extends Error{constructor(){super("Authentication expired"),this.name="AuthExpiredError"}}function as(r,e,t){let o=`${r.replace(/\/+$/,"")}/v4/files?folder=${encodeURIComponent(e)}`;if(t)for(const[s,n]of Object.entries(t))n!=null&&(o+=`&${encodeURIComponent(s)}=${encodeURIComponent(n)}`);return o}function ls(r,e){const t={name:r.name,type:r.type,"filerobot-folder":e};return r.meta&&Object.keys(r.meta).length>0&&(t.meta=JSON.stringify(r.meta)),r.tags&&r.tags.length>0&&(t.tags=JSON.stringify(r.tags)),er(r.product)&&(t.product=JSON.stringify(tr(r.product))),t}function cs(r){const t=`${ga(r.companionUrl)}/api/${r.token}`;let i;try{i=new WebSocket(t)}catch{return r.onError(new Error("Failed to connect to upload progress channel")),null}let o=!1;const s=()=>{o=!0,i.onmessage=null,i.onerror=null,i.onclose=null};return i.onmessage=n=>{var a,l,c;if(!o)try{const d=JSON.parse(n.data);switch(d.action){case"progress":{const p=d.payload,u=p.bytesUploaded??0,m=p.bytesTotal??(r.expectedSize||1);r.onProgress(u,m);break}case"success":{const p=d.payload;if(s(),i.close(),(a=p.response)!=null&&a.responseText)try{const u=JSON.parse(p.response.responseText);if(u.status==="success"){r.onComplete(u);return}if(Lt(u)){r.onComplete(Qi(u,r.uploadFile));return}r.onError(new Error(u.msg||"Upload failed"));return}catch{}r.onError(new Error("Upload completed but no valid response received"));break}case"error":{const p=d.payload;s(),i.close();let u=((l=p.error)==null?void 0:l.message)||"Upload failed";if((c=p.response)!=null&&c.responseText)try{const m=JSON.parse(p.response.responseText);u=m.hint||m.msg||m.message||u}catch{}r.onError(new Error(u));break}}}catch{}},i.onerror=()=>{o||(s(),r.onError(new Error("Upload progress connection failed")))},i.onclose=()=>{o||(s(),r.onError(new Error("Upload progress connection closed unexpectedly")))},i}function ds(r){if(r){r.onmessage=null,r.onerror=null,r.onclose=null;try{r.send(JSON.stringify({action:"cancel",payload:{}}))}catch{}r.close()}}function ma(r,e){const t=r.remoteInfo;if(!t)return e.onError(new Error("remoteInfo is required for companion upload")),{abort(){}};let i=!1,o=null;const s=as(e.apiBase,e.folder,e.extraParams),n=ls(r,e.folder),a=!t.token;return ua(t.companionUrl,t.provider,t.token,t.requestPath,{fileId:t.fileId,endpoint:s,headers:e.authHeaders,size:t.size,metadata:n},a).then(l=>{i||(o=cs({companionUrl:t.companionUrl,token:l.token,uploadFile:r,expectedSize:t.size,onProgress:(c,d)=>{i||e.onProgress(c,d)},onComplete:c=>{i||e.onComplete(c)},onError:c=>{i||e.onError(c)}}))}).catch(l=>{i||e.onError(l instanceof Error?l:new Error(String(l)))}),{abort(){i=!0,ds(o),o=null}}}function xa(r,e){const t=r.remoteUrl;if(!t)return e.onError(new Error("Remote URL is required for URL upload")),{abort(){}};let i=!1,o=null;const s=new AbortController,n=as(e.apiBase,e.folder,e.extraParams);return fa(e.companionUrl,t,s.signal).then(a=>{var c;if(i)return null;(c=e.onMeta)==null||c.call(e,{name:a.name,type:a.type,size:a.size});const l=ls(r,e.folder);return a.name&&(l.name=a.name),a.type&&(l.type=a.type),ha(e.companionUrl,t,{fileId:r.id,endpoint:n,headers:e.authHeaders,size:a.size,metadata:l},s.signal).then(d=>({result:d,size:a.size}))}).then(a=>{i||!a||(o=cs({companionUrl:e.companionUrl,token:a.result.token,uploadFile:r,expectedSize:a.size,onProgress:(l,c)=>{i||e.onProgress(l,c)},onComplete:l=>{i||e.onComplete(l)},onError:l=>{i||e.onError(l)}}))}).catch(a=>{i||a&&a.name==="AbortError"||e.onError(a instanceof Error?a:new Error(String(a)))}),{abort(){i=!0,s.abort(),ds(o),o=null}}}function Ui(r){"@babel/helpers - typeof";return Ui=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ui(r)}function va(r,e,t){return Object.defineProperty(r,"prototype",{writable:!1}),r}function ba(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function ya(r,e,t){return e=Ct(e),wa(r,rr()?Reflect.construct(e,t||[],Ct(r).constructor):e.apply(r,t))}function wa(r,e){if(e&&(Ui(e)==="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return _a(r)}function _a(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function ka(r,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");r.prototype=Object.create(e&&e.prototype,{constructor:{value:r,writable:!0,configurable:!0}}),Object.defineProperty(r,"prototype",{writable:!1}),e&&$t(r,e)}function Oi(r){var e=typeof Map=="function"?new Map:void 0;return Oi=function(i){if(i===null||!$a(i))return i;if(typeof i!="function")throw new TypeError("Super expression must either be null or a function");if(typeof e<"u"){if(e.has(i))return e.get(i);e.set(i,o)}function o(){return Sa(i,arguments,Ct(this).constructor)}return o.prototype=Object.create(i.prototype,{constructor:{value:o,enumerable:!1,writable:!0,configurable:!0}}),$t(o,i)},Oi(r)}function Sa(r,e,t){if(rr())return Reflect.construct.apply(null,arguments);var i=[null];i.push.apply(i,e);var o=new(r.bind.apply(r,i));return t&&$t(o,t.prototype),o}function rr(){try{var r=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(rr=function(){return!!r})()}function $a(r){try{return Function.toString.call(r).indexOf("[native code]")!==-1}catch{return typeof r=="function"}}function $t(r,e){return $t=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(i,o){return i.__proto__=o,i},$t(r,e)}function Ct(r){return Ct=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},Ct(r)}var ft=(function(r){function e(t){var i,o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null,s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:null,n=arguments.length>3&&arguments[3]!==void 0?arguments[3]:null;if(ba(this,e),i=ya(this,e,[t]),i.originalRequest=s,i.originalResponse=n,i.causingError=o,o!=null&&(t+=", caused by ".concat(o.toString())),s!=null){var a=s.getHeader("X-Request-ID")||"n/a",l=s.getMethod(),c=s.getURL(),d=n?n.getStatus():"n/a",p=n?n.getBody()||"":"n/a";t+=", originated from request (method: ".concat(l,", url: ").concat(c,", response code: ").concat(d,", response text: ").concat(p,", request id: ").concat(a,")")}return i.message=t,i}return ka(e,r),va(e)})(Oi(Error));function Et(r){"@babel/helpers - typeof";return Et=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Et(r)}function Ca(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function Ea(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,Ra(i.key),i)}}function Pa(r,e,t){return e&&Ea(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function Ra(r){var e=Ua(r,"string");return Et(e)=="symbol"?e:e+""}function Ua(r,e){if(Et(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Et(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var Oa=(function(){function r(){Ca(this,r)}return Pa(r,[{key:"listAllUploads",value:function(){return Promise.resolve([])}},{key:"findUploadsByFingerprint",value:function(t){return Promise.resolve([])}},{key:"removeUpload",value:function(t){return Promise.resolve()}},{key:"addUpload",value:function(t,i){return Promise.resolve(null)}}])})();const ps="3.7.8",Aa=ps,at=typeof Buffer=="function",oo=typeof TextDecoder=="function"?new TextDecoder:void 0,so=typeof TextEncoder=="function"?new TextEncoder:void 0,Ta="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",ht=Array.prototype.slice.call(Ta),Nt=(r=>{let e={};return r.forEach((t,i)=>e[t]=i),e})(ht),La=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,re=String.fromCharCode.bind(String),no=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):r=>new Uint8Array(Array.prototype.slice.call(r,0)),us=r=>r.replace(/=/g,"").replace(/[+\/]/g,e=>e=="+"?"-":"_"),fs=r=>r.replace(/[^A-Za-z0-9\+\/]/g,""),hs=r=>{let e,t,i,o,s="";const n=r.length%3;for(let a=0;a<r.length;){if((t=r.charCodeAt(a++))>255||(i=r.charCodeAt(a++))>255||(o=r.charCodeAt(a++))>255)throw new TypeError("invalid character found");e=t<<16|i<<8|o,s+=ht[e>>18&63]+ht[e>>12&63]+ht[e>>6&63]+ht[e&63]}return n?s.slice(0,n-3)+"===".substring(n):s},or=typeof btoa=="function"?r=>btoa(r):at?r=>Buffer.from(r,"binary").toString("base64"):hs,Ai=at?r=>Buffer.from(r).toString("base64"):r=>{let t=[];for(let i=0,o=r.length;i<o;i+=4096)t.push(re.apply(null,r.subarray(i,i+4096)));return or(t.join(""))},Vt=(r,e=!1)=>e?us(Ai(r)):Ai(r),Fa=r=>{if(r.length<2){var e=r.charCodeAt(0);return e<128?r:e<2048?re(192|e>>>6)+re(128|e&63):re(224|e>>>12&15)+re(128|e>>>6&63)+re(128|e&63)}else{var e=65536+(r.charCodeAt(0)-55296)*1024+(r.charCodeAt(1)-56320);return re(240|e>>>18&7)+re(128|e>>>12&63)+re(128|e>>>6&63)+re(128|e&63)}},Ia=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,gs=r=>r.replace(Ia,Fa),ao=at?r=>Buffer.from(r,"utf8").toString("base64"):so?r=>Ai(so.encode(r)):r=>or(gs(r)),et=(r,e=!1)=>e?us(ao(r)):ao(r),lo=r=>et(r,!0),za=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,Da=r=>{switch(r.length){case 4:var e=(7&r.charCodeAt(0))<<18|(63&r.charCodeAt(1))<<12|(63&r.charCodeAt(2))<<6|63&r.charCodeAt(3),t=e-65536;return re((t>>>10)+55296)+re((t&1023)+56320);case 3:return re((15&r.charCodeAt(0))<<12|(63&r.charCodeAt(1))<<6|63&r.charCodeAt(2));default:return re((31&r.charCodeAt(0))<<6|63&r.charCodeAt(1))}},ms=r=>r.replace(za,Da),xs=r=>{if(r=r.replace(/\s+/g,""),!La.test(r))throw new TypeError("malformed base64.");r+="==".slice(2-(r.length&3));let e,t,i,o=[];for(let s=0;s<r.length;)e=Nt[r.charAt(s++)]<<18|Nt[r.charAt(s++)]<<12|(t=Nt[r.charAt(s++)])<<6|(i=Nt[r.charAt(s++)]),t===64?o.push(re(e>>16&255)):i===64?o.push(re(e>>16&255,e>>8&255)):o.push(re(e>>16&255,e>>8&255,e&255));return o.join("")},sr=typeof atob=="function"?r=>atob(fs(r)):at?r=>Buffer.from(r,"base64").toString("binary"):xs,vs=at?r=>no(Buffer.from(r,"base64")):r=>no(sr(r).split("").map(e=>e.charCodeAt(0))),bs=r=>vs(ys(r)),ja=at?r=>Buffer.from(r,"base64").toString("utf8"):oo?r=>oo.decode(vs(r)):r=>ms(sr(r)),ys=r=>fs(r.replace(/[-_]/g,e=>e=="-"?"+":"/")),Ti=r=>ja(ys(r)),Ma=r=>{if(typeof r!="string")return!1;const e=r.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(e)||!/[^\s0-9a-zA-Z\-_]/.test(e)},ws=r=>({value:r,enumerable:!1,writable:!0,configurable:!0}),_s=function(){const r=(e,t)=>Object.defineProperty(String.prototype,e,ws(t));r("fromBase64",function(){return Ti(this)}),r("toBase64",function(e){return et(this,e)}),r("toBase64URI",function(){return et(this,!0)}),r("toBase64URL",function(){return et(this,!0)}),r("toUint8Array",function(){return bs(this)})},ks=function(){const r=(e,t)=>Object.defineProperty(Uint8Array.prototype,e,ws(t));r("toBase64",function(e){return Vt(this,e)}),r("toBase64URI",function(){return Vt(this,!0)}),r("toBase64URL",function(){return Vt(this,!0)})},Ba=()=>{_s(),ks()},Na={version:ps,VERSION:Aa,atob:sr,atobPolyfill:xs,btoa:or,btoaPolyfill:hs,fromBase64:Ti,toBase64:et,encode:et,encodeURI:lo,encodeURL:lo,utob:gs,btou:ms,decode:Ti,isValid:Ma,fromUint8Array:Vt,toUint8Array:bs,extendString:_s,extendUint8Array:ks,extendBuiltins:Ba};var co=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ha(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var yi,po;function qa(){return po||(po=1,yi=function(e,t){if(t=t.split(":")[0],e=+e,!e)return!1;switch(t){case"http":case"ws":return e!==80;case"https":case"wss":return e!==443;case"ftp":return e!==21;case"gopher":return e!==70;case"file":return!1}return e!==0}),yi}var Ht={},uo;function Va(){if(uo)return Ht;uo=1;var r=Object.prototype.hasOwnProperty,e;function t(n){try{return decodeURIComponent(n.replace(/\+/g," "))}catch{return null}}function i(n){try{return encodeURIComponent(n)}catch{return null}}function o(n){for(var a=/([^=?#&]+)=?([^&]*)/g,l={},c;c=a.exec(n);){var d=t(c[1]),p=t(c[2]);d===null||p===null||d in l||(l[d]=p)}return l}function s(n,a){a=a||"";var l=[],c,d;typeof a!="string"&&(a="?");for(d in n)if(r.call(n,d)){if(c=n[d],!c&&(c===null||c===e||isNaN(c))&&(c=""),d=i(d),c=i(c),d===null||c===null)continue;l.push(d+"="+c)}return l.length?a+l.join("&"):""}return Ht.stringify=s,Ht.parse=o,Ht}var wi,fo;function Ka(){if(fo)return wi;fo=1;var r=qa(),e=Va(),t=/^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/,i=/[\n\r\t]/g,o=/^[A-Za-z][A-Za-z0-9+-.]*:\/\//,s=/:\d+$/,n=/^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,a=/^[a-zA-Z]:/;function l(k){return(k||"").toString().replace(t,"")}var c=[["#","hash"],["?","query"],function(_,w){return u(w.protocol)?_.replace(/\\/g,"/"):_},["/","pathname"],["@","auth",1],[NaN,"host",void 0,1,1],[/:(\d*)$/,"port",void 0,1],[NaN,"hostname",void 0,1,1]],d={hash:1,query:1};function p(k){var _;typeof window<"u"?_=window:typeof co<"u"?_=co:typeof self<"u"?_=self:_={};var w=_.location||{};k=k||w;var y={},U=typeof k,P;if(k.protocol==="blob:")y=new v(unescape(k.pathname),{});else if(U==="string"){y=new v(k,{});for(P in d)delete y[P]}else if(U==="object"){for(P in k)P in d||(y[P]=k[P]);y.slashes===void 0&&(y.slashes=o.test(k.href))}return y}function u(k){return k==="file:"||k==="ftp:"||k==="http:"||k==="https:"||k==="ws:"||k==="wss:"}function m(k,_){k=l(k),k=k.replace(i,""),_=_||{};var w=n.exec(k),y=w[1]?w[1].toLowerCase():"",U=!!w[2],P=!!w[3],z=0,F;return U?P?(F=w[2]+w[3]+w[4],z=w[2].length+w[3].length):(F=w[2]+w[4],z=w[2].length):P?(F=w[3]+w[4],z=w[3].length):F=w[4],y==="file:"?z>=2&&(F=F.slice(2)):u(y)?F=w[4]:y?U&&(F=F.slice(2)):z>=2&&u(_.protocol)&&(F=w[4]),{protocol:y,slashes:U||u(y),slashesCount:z,rest:F}}function g(k,_){if(k==="")return _;for(var w=(_||"/").split("/").slice(0,-1).concat(k.split("/")),y=w.length,U=w[y-1],P=!1,z=0;y--;)w[y]==="."?w.splice(y,1):w[y]===".."?(w.splice(y,1),z++):z&&(y===0&&(P=!0),w.splice(y,1),z--);return P&&w.unshift(""),(U==="."||U==="..")&&w.push(""),w.join("/")}function v(k,_,w){if(k=l(k),k=k.replace(i,""),!(this instanceof v))return new v(k,_,w);var y,U,P,z,F,T,Z=c.slice(),ue=typeof _,A=this,W=0;for(ue!=="object"&&ue!=="string"&&(w=_,_=null),w&&typeof w!="function"&&(w=e.parse),_=p(_),U=m(k||"",_),y=!U.protocol&&!U.slashes,A.slashes=U.slashes||y&&_.slashes,A.protocol=U.protocol||_.protocol||"",k=U.rest,(U.protocol==="file:"&&(U.slashesCount!==2||a.test(k))||!U.slashes&&(U.protocol||U.slashesCount<2||!u(A.protocol)))&&(Z[3]=[/(.*)/,"pathname"]);W<Z.length;W++){if(z=Z[W],typeof z=="function"){k=z(k,A);continue}P=z[0],T=z[1],P!==P?A[T]=k:typeof P=="string"?(F=P==="@"?k.lastIndexOf(P):k.indexOf(P),~F&&(typeof z[2]=="number"?(A[T]=k.slice(0,F),k=k.slice(F+z[2])):(A[T]=k.slice(F),k=k.slice(0,F)))):(F=P.exec(k))&&(A[T]=F[1],k=k.slice(0,F.index)),A[T]=A[T]||y&&z[3]&&_[T]||"",z[4]&&(A[T]=A[T].toLowerCase())}w&&(A.query=w(A.query)),y&&_.slashes&&A.pathname.charAt(0)!=="/"&&(A.pathname!==""||_.pathname!=="")&&(A.pathname=g(A.pathname,_.pathname)),A.pathname.charAt(0)!=="/"&&u(A.protocol)&&(A.pathname="/"+A.pathname),r(A.port,A.protocol)||(A.host=A.hostname,A.port=""),A.username=A.password="",A.auth&&(F=A.auth.indexOf(":"),~F?(A.username=A.auth.slice(0,F),A.username=encodeURIComponent(decodeURIComponent(A.username)),A.password=A.auth.slice(F+1),A.password=encodeURIComponent(decodeURIComponent(A.password))):A.username=encodeURIComponent(decodeURIComponent(A.auth)),A.auth=A.password?A.username+":"+A.password:A.username),A.origin=A.protocol!=="file:"&&u(A.protocol)&&A.host?A.protocol+"//"+A.host:"null",A.href=A.toString()}function $(k,_,w){var y=this;switch(k){case"query":typeof _=="string"&&_.length&&(_=(w||e.parse)(_)),y[k]=_;break;case"port":y[k]=_,r(_,y.protocol)?_&&(y.host=y.hostname+":"+_):(y.host=y.hostname,y[k]="");break;case"hostname":y[k]=_,y.port&&(_+=":"+y.port),y.host=_;break;case"host":y[k]=_,s.test(_)?(_=_.split(":"),y.port=_.pop(),y.hostname=_.join(":")):(y.hostname=_,y.port="");break;case"protocol":y.protocol=_.toLowerCase(),y.slashes=!w;break;case"pathname":case"hash":if(_){var U=k==="pathname"?"/":"#";y[k]=_.charAt(0)!==U?U+_:_}else y[k]=_;break;case"username":case"password":y[k]=encodeURIComponent(_);break;case"auth":var P=_.indexOf(":");~P?(y.username=_.slice(0,P),y.username=encodeURIComponent(decodeURIComponent(y.username)),y.password=_.slice(P+1),y.password=encodeURIComponent(decodeURIComponent(y.password))):y.username=encodeURIComponent(decodeURIComponent(_))}for(var z=0;z<c.length;z++){var F=c[z];F[4]&&(y[F[1]]=y[F[1]].toLowerCase())}return y.auth=y.password?y.username+":"+y.password:y.username,y.origin=y.protocol!=="file:"&&u(y.protocol)&&y.host?y.protocol+"//"+y.host:"null",y.href=y.toString(),y}function L(k){(!k||typeof k!="function")&&(k=e.stringify);var _,w=this,y=w.host,U=w.protocol;U&&U.charAt(U.length-1)!==":"&&(U+=":");var P=U+(w.protocol&&w.slashes||u(w.protocol)?"//":"");return w.username?(P+=w.username,w.password&&(P+=":"+w.password),P+="@"):w.password?(P+=":"+w.password,P+="@"):w.protocol!=="file:"&&u(w.protocol)&&!y&&w.pathname!=="/"&&(P+="@"),(y[y.length-1]===":"||s.test(w.hostname)&&!w.port)&&(y+=":"),P+=y+w.pathname,_=typeof w.query=="object"?k(w.query):w.query,_&&(P+=_.charAt(0)!=="?"?"?"+_:_),w.hash&&(P+=w.hash),P}return v.prototype={set:$,toString:L},v.extractProtocol=m,v.location=p,v.trimLeft=l,v.qs=e,wi=v,wi}var Ya=Ka();const Wa=Ha(Ya);function Ga(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(r){var e=Math.random()*16|0,t=r==="x"?e:e&3|8;return t.toString(16)})}function Li(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */Li=function(){return e};var r,e={},t=Object.prototype,i=t.hasOwnProperty,o=Object.defineProperty||function(b,h,x){b[h]=x.value},s=typeof Symbol=="function"?Symbol:{},n=s.iterator||"@@iterator",a=s.asyncIterator||"@@asyncIterator",l=s.toStringTag||"@@toStringTag";function c(b,h,x){return Object.defineProperty(b,h,{value:x,enumerable:!0,configurable:!0,writable:!0}),b[h]}try{c({},"")}catch{c=function(x,E,R){return x[E]=R}}function d(b,h,x,E){var R=h&&h.prototype instanceof L?h:L,C=Object.create(R.prototype),D=new W(E||[]);return o(C,"_invoke",{value:T(b,x,D)}),C}function p(b,h,x){try{return{type:"normal",arg:b.call(h,x)}}catch(E){return{type:"throw",arg:E}}}e.wrap=d;var u="suspendedStart",m="suspendedYield",g="executing",v="completed",$={};function L(){}function k(){}function _(){}var w={};c(w,n,function(){return this});var y=Object.getPrototypeOf,U=y&&y(y(xe([])));U&&U!==t&&i.call(U,n)&&(w=U);var P=_.prototype=L.prototype=Object.create(w);function z(b){["next","throw","return"].forEach(function(h){c(b,h,function(x){return this._invoke(h,x)})})}function F(b,h){function x(R,C,D,H){var q=p(b[R],b,C);if(q.type!=="throw"){var ee=q.arg,ie=ee.value;return ie&&Ne(ie)=="object"&&i.call(ie,"__await")?h.resolve(ie.__await).then(function(ae){x("next",ae,D,H)},function(ae){x("throw",ae,D,H)}):h.resolve(ie).then(function(ae){ee.value=ae,D(ee)},function(ae){return x("throw",ae,D,H)})}H(q.arg)}var E;o(this,"_invoke",{value:function(C,D){function H(){return new h(function(q,ee){x(C,D,q,ee)})}return E=E?E.then(H,H):H()}})}function T(b,h,x){var E=u;return function(R,C){if(E===g)throw Error("Generator is already running");if(E===v){if(R==="throw")throw C;return{value:r,done:!0}}for(x.method=R,x.arg=C;;){var D=x.delegate;if(D){var H=Z(D,x);if(H){if(H===$)continue;return H}}if(x.method==="next")x.sent=x._sent=x.arg;else if(x.method==="throw"){if(E===u)throw E=v,x.arg;x.dispatchException(x.arg)}else x.method==="return"&&x.abrupt("return",x.arg);E=g;var q=p(b,h,x);if(q.type==="normal"){if(E=x.done?v:m,q.arg===$)continue;return{value:q.arg,done:x.done}}q.type==="throw"&&(E=v,x.method="throw",x.arg=q.arg)}}}function Z(b,h){var x=h.method,E=b.iterator[x];if(E===r)return h.delegate=null,x==="throw"&&b.iterator.return&&(h.method="return",h.arg=r,Z(b,h),h.method==="throw")||x!=="return"&&(h.method="throw",h.arg=new TypeError("The iterator does not provide a '"+x+"' method")),$;var R=p(E,b.iterator,h.arg);if(R.type==="throw")return h.method="throw",h.arg=R.arg,h.delegate=null,$;var C=R.arg;return C?C.done?(h[b.resultName]=C.value,h.next=b.nextLoc,h.method!=="return"&&(h.method="next",h.arg=r),h.delegate=null,$):C:(h.method="throw",h.arg=new TypeError("iterator result is not an object"),h.delegate=null,$)}function ue(b){var h={tryLoc:b[0]};1 in b&&(h.catchLoc=b[1]),2 in b&&(h.finallyLoc=b[2],h.afterLoc=b[3]),this.tryEntries.push(h)}function A(b){var h=b.completion||{};h.type="normal",delete h.arg,b.completion=h}function W(b){this.tryEntries=[{tryLoc:"root"}],b.forEach(ue,this),this.reset(!0)}function xe(b){if(b||b===""){var h=b[n];if(h)return h.call(b);if(typeof b.next=="function")return b;if(!isNaN(b.length)){var x=-1,E=function R(){for(;++x<b.length;)if(i.call(b,x))return R.value=b[x],R.done=!1,R;return R.value=r,R.done=!0,R};return E.next=E}}throw new TypeError(Ne(b)+" is not iterable")}return k.prototype=_,o(P,"constructor",{value:_,configurable:!0}),o(_,"constructor",{value:k,configurable:!0}),k.displayName=c(_,l,"GeneratorFunction"),e.isGeneratorFunction=function(b){var h=typeof b=="function"&&b.constructor;return!!h&&(h===k||(h.displayName||h.name)==="GeneratorFunction")},e.mark=function(b){return Object.setPrototypeOf?Object.setPrototypeOf(b,_):(b.__proto__=_,c(b,l,"GeneratorFunction")),b.prototype=Object.create(P),b},e.awrap=function(b){return{__await:b}},z(F.prototype),c(F.prototype,a,function(){return this}),e.AsyncIterator=F,e.async=function(b,h,x,E,R){R===void 0&&(R=Promise);var C=new F(d(b,h,x,E),R);return e.isGeneratorFunction(h)?C:C.next().then(function(D){return D.done?D.value:C.next()})},z(P),c(P,l,"Generator"),c(P,n,function(){return this}),c(P,"toString",function(){return"[object Generator]"}),e.keys=function(b){var h=Object(b),x=[];for(var E in h)x.push(E);return x.reverse(),function R(){for(;x.length;){var C=x.pop();if(C in h)return R.value=C,R.done=!1,R}return R.done=!0,R}},e.values=xe,W.prototype={constructor:W,reset:function(h){if(this.prev=0,this.next=0,this.sent=this._sent=r,this.done=!1,this.delegate=null,this.method="next",this.arg=r,this.tryEntries.forEach(A),!h)for(var x in this)x.charAt(0)==="t"&&i.call(this,x)&&!isNaN(+x.slice(1))&&(this[x]=r)},stop:function(){this.done=!0;var h=this.tryEntries[0].completion;if(h.type==="throw")throw h.arg;return this.rval},dispatchException:function(h){if(this.done)throw h;var x=this;function E(ee,ie){return D.type="throw",D.arg=h,x.next=ee,ie&&(x.method="next",x.arg=r),!!ie}for(var R=this.tryEntries.length-1;R>=0;--R){var C=this.tryEntries[R],D=C.completion;if(C.tryLoc==="root")return E("end");if(C.tryLoc<=this.prev){var H=i.call(C,"catchLoc"),q=i.call(C,"finallyLoc");if(H&&q){if(this.prev<C.catchLoc)return E(C.catchLoc,!0);if(this.prev<C.finallyLoc)return E(C.finallyLoc)}else if(H){if(this.prev<C.catchLoc)return E(C.catchLoc,!0)}else{if(!q)throw Error("try statement without catch or finally");if(this.prev<C.finallyLoc)return E(C.finallyLoc)}}}},abrupt:function(h,x){for(var E=this.tryEntries.length-1;E>=0;--E){var R=this.tryEntries[E];if(R.tryLoc<=this.prev&&i.call(R,"finallyLoc")&&this.prev<R.finallyLoc){var C=R;break}}C&&(h==="break"||h==="continue")&&C.tryLoc<=x&&x<=C.finallyLoc&&(C=null);var D=C?C.completion:{};return D.type=h,D.arg=x,C?(this.method="next",this.next=C.finallyLoc,$):this.complete(D)},complete:function(h,x){if(h.type==="throw")throw h.arg;return h.type==="break"||h.type==="continue"?this.next=h.arg:h.type==="return"?(this.rval=this.arg=h.arg,this.method="return",this.next="end"):h.type==="normal"&&x&&(this.next=x),$},finish:function(h){for(var x=this.tryEntries.length-1;x>=0;--x){var E=this.tryEntries[x];if(E.finallyLoc===h)return this.complete(E.completion,E.afterLoc),A(E),$}},catch:function(h){for(var x=this.tryEntries.length-1;x>=0;--x){var E=this.tryEntries[x];if(E.tryLoc===h){var R=E.completion;if(R.type==="throw"){var C=R.arg;A(E)}return C}}throw Error("illegal catch attempt")},delegateYield:function(h,x,E){return this.delegate={iterator:xe(h),resultName:x,nextLoc:E},this.method==="next"&&(this.arg=r),$}},e}function ho(r,e,t,i,o,s,n){try{var a=r[s](n),l=a.value}catch(c){t(c);return}a.done?e(l):Promise.resolve(l).then(i,o)}function Xa(r){return function(){var e=this,t=arguments;return new Promise(function(i,o){var s=r.apply(e,t);function n(l){ho(s,i,o,n,a,"next",l)}function a(l){ho(s,i,o,n,a,"throw",l)}n(void 0)})}}function Ss(r,e){return Qa(r)||Za(r,e)||$s(r,e)||Ja()}function Ja(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Za(r,e){var t=r==null?null:typeof Symbol<"u"&&r[Symbol.iterator]||r["@@iterator"];if(t!=null){var i,o,s,n,a=[],l=!0,c=!1;try{if(s=(t=t.call(r)).next,e!==0)for(;!(l=(i=s.call(t)).done)&&(a.push(i.value),a.length!==e);l=!0);}catch(d){c=!0,o=d}finally{try{if(!l&&t.return!=null&&(n=t.return(),Object(n)!==n))return}finally{if(c)throw o}}return a}}function Qa(r){if(Array.isArray(r))return r}function Ne(r){"@babel/helpers - typeof";return Ne=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ne(r)}function el(r,e){var t=typeof Symbol<"u"&&r[Symbol.iterator]||r["@@iterator"];if(!t){if(Array.isArray(r)||(t=$s(r))||e){t&&(r=t);var i=0,o=function(){};return{s:o,n:function(){return i>=r.length?{done:!0}:{done:!1,value:r[i++]}},e:function(c){throw c},f:o}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var s=!0,n=!1,a;return{s:function(){t=t.call(r)},n:function(){var c=t.next();return s=c.done,c},e:function(c){n=!0,a=c},f:function(){try{!s&&t.return!=null&&t.return()}finally{if(n)throw a}}}}function $s(r,e){if(r){if(typeof r=="string")return go(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return go(r,e)}}function go(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function mo(r,e){var t=Object.keys(r);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(r);e&&(i=i.filter(function(o){return Object.getOwnPropertyDescriptor(r,o).enumerable})),t.push.apply(t,i)}return t}function Ke(r){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?mo(Object(t),!0).forEach(function(i){tl(r,i,t[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(t)):mo(Object(t)).forEach(function(i){Object.defineProperty(r,i,Object.getOwnPropertyDescriptor(t,i))})}return r}function tl(r,e,t){return e=Cs(e),e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}function il(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function xo(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,Cs(i.key),i)}}function rl(r,e,t){return e&&xo(r.prototype,e),t&&xo(r,t),Object.defineProperty(r,"prototype",{writable:!1}),r}function Cs(r){var e=ol(r,"string");return Ne(e)=="symbol"?e:e+""}function ol(r,e){if(Ne(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Ne(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var Kt="tus-v1",Yt="ietf-draft-03",gt="ietf-draft-05",sl={endpoint:null,uploadUrl:null,metadata:{},metadataForPartialUploads:{},fingerprint:null,uploadSize:null,onProgress:null,onChunkComplete:null,onSuccess:null,onError:null,onUploadUrlAvailable:null,overridePatchMethod:!1,headers:{},addRequestId:!1,onBeforeRequest:null,onAfterResponse:null,onShouldRetry:Es,chunkSize:Number.POSITIVE_INFINITY,retryDelays:[0,1e3,3e3,5e3],parallelUploads:1,parallelUploadBoundaries:null,storeFingerprintForResuming:!0,removeFingerprintOnSuccess:!1,uploadLengthDeferred:!1,uploadDataDuringCreation:!1,urlStorage:null,fileReader:null,httpStack:null,protocol:Kt},ti=(function(){function r(e,t){il(this,r),"resume"in t&&console.log("tus: The `resume` option has been removed in tus-js-client v2. Please use the URL storage API instead."),this.options=t,this.options.chunkSize=Number(this.options.chunkSize),this._urlStorage=this.options.urlStorage,this.file=e,this.url=null,this._req=null,this._fingerprint=null,this._urlStorageKey=null,this._offset=null,this._aborted=!1,this._size=null,this._source=null,this._retryAttempt=0,this._retryTimeout=null,this._offsetBeforeRetry=0,this._parallelUploads=null,this._parallelUploadUrls=null}return rl(r,[{key:"findPreviousUploads",value:function(){var t=this;return this.options.fingerprint(this.file,this.options).then(function(i){return t._urlStorage.findUploadsByFingerprint(i)})}},{key:"resumeFromPreviousUpload",value:function(t){this.url=t.uploadUrl||null,this._parallelUploadUrls=t.parallelUploadUrls||null,this._urlStorageKey=t.urlStorageKey}},{key:"start",value:function(){var t=this,i=this.file;if(!i){this._emitError(new Error("tus: no file or stream to upload provided"));return}if(![Kt,Yt,gt].includes(this.options.protocol)){this._emitError(new Error("tus: unsupported protocol ".concat(this.options.protocol)));return}if(!this.options.endpoint&&!this.options.uploadUrl&&!this.url){this._emitError(new Error("tus: neither an endpoint or an upload URL is provided"));return}var o=this.options.retryDelays;if(o!=null&&Object.prototype.toString.call(o)!=="[object Array]"){this._emitError(new Error("tus: the `retryDelays` option must either be an array or null"));return}if(this.options.parallelUploads>1)for(var s=0,n=["uploadUrl","uploadSize","uploadLengthDeferred"];s<n.length;s++){var a=n[s];if(this.options[a]){this._emitError(new Error("tus: cannot use the ".concat(a," option when parallelUploads is enabled")));return}}if(this.options.parallelUploadBoundaries){if(this.options.parallelUploads<=1){this._emitError(new Error("tus: cannot use the `parallelUploadBoundaries` option when `parallelUploads` is disabled"));return}if(this.options.parallelUploads!==this.options.parallelUploadBoundaries.length){this._emitError(new Error("tus: the `parallelUploadBoundaries` must have the same length as the value of `parallelUploads`"));return}}this.options.fingerprint(i,this.options).then(function(l){return t._fingerprint=l,t._source?t._source:t.options.fileReader.openFile(i,t.options.chunkSize)}).then(function(l){if(t._source=l,t.options.uploadLengthDeferred)t._size=null;else if(t.options.uploadSize!=null){if(t._size=Number(t.options.uploadSize),Number.isNaN(t._size)){t._emitError(new Error("tus: cannot convert `uploadSize` option into a number"));return}}else if(t._size=t._source.size,t._size==null){t._emitError(new Error("tus: cannot automatically derive upload's size from input. Specify it manually using the `uploadSize` option or use the `uploadLengthDeferred` option"));return}t.options.parallelUploads>1||t._parallelUploadUrls!=null?t._startParallelUpload():t._startSingleUpload()}).catch(function(l){t._emitError(l)})}},{key:"_startParallelUpload",value:function(){var t,i=this,o=this._size,s=0;this._parallelUploads=[];var n=this._parallelUploadUrls!=null?this._parallelUploadUrls.length:this.options.parallelUploads,a=(t=this.options.parallelUploadBoundaries)!==null&&t!==void 0?t:al(this._source.size,n);this._parallelUploadUrls&&a.forEach(function(d,p){d.uploadUrl=i._parallelUploadUrls[p]||null}),this._parallelUploadUrls=new Array(a.length);var l=a.map(function(d,p){var u=0;return i._source.slice(d.start,d.end).then(function(m){var g=m.value;return new Promise(function(v,$){var L=Ke(Ke({},i.options),{},{uploadUrl:d.uploadUrl||null,storeFingerprintForResuming:!1,removeFingerprintOnSuccess:!1,parallelUploads:1,parallelUploadBoundaries:null,metadata:i.options.metadataForPartialUploads,headers:Ke(Ke({},i.options.headers),{},{"Upload-Concat":"partial"}),onSuccess:v,onError:$,onProgress:function(w){s=s-u+w,u=w,i._emitProgress(s,o)},onUploadUrlAvailable:function(){i._parallelUploadUrls[p]=k.url,i._parallelUploadUrls.filter(function(w){return!!w}).length===a.length&&i._saveUploadInUrlStorage()}}),k=new r(g,L);k.start(),i._parallelUploads.push(k)})})}),c;Promise.all(l).then(function(){c=i._openRequest("POST",i.options.endpoint),c.setHeader("Upload-Concat","final;".concat(i._parallelUploadUrls.join(" ")));var d=vo(i.options.metadata);return d!==""&&c.setHeader("Upload-Metadata",d),i._sendRequest(c,null)}).then(function(d){if(!Je(d.getStatus(),200)){i._emitHttpError(c,d,"tus: unexpected response while creating upload");return}var p=d.getHeader("Location");if(p==null){i._emitHttpError(c,d,"tus: invalid or missing Location header");return}i.url=_o(i.options.endpoint,p),"Created upload at ".concat(i.url),i._emitSuccess(d)}).catch(function(d){i._emitError(d)})}},{key:"_startSingleUpload",value:function(){if(this._aborted=!1,this.url!=null){"Resuming upload from previous URL: ".concat(this.url),this._resumeUpload();return}if(this.options.uploadUrl!=null){"Resuming upload from provided URL: ".concat(this.options.uploadUrl),this.url=this.options.uploadUrl,this._resumeUpload();return}this._createUpload()}},{key:"abort",value:function(t){var i=this;if(this._parallelUploads!=null){var o=el(this._parallelUploads),s;try{for(o.s();!(s=o.n()).done;){var n=s.value;n.abort(t)}}catch(a){o.e(a)}finally{o.f()}}return this._req!==null&&this._req.abort(),this._aborted=!0,this._retryTimeout!=null&&(clearTimeout(this._retryTimeout),this._retryTimeout=null),!t||this.url==null?Promise.resolve():r.terminate(this.url,this.options).then(function(){return i._removeFromUrlStorage()})}},{key:"_emitHttpError",value:function(t,i,o,s){this._emitError(new ft(o,s,t,i))}},{key:"_emitError",value:function(t){var i=this;if(!this._aborted){if(this.options.retryDelays!=null){var o=this._offset!=null&&this._offset>this._offsetBeforeRetry;if(o&&(this._retryAttempt=0),wo(t,this._retryAttempt,this.options)){var s=this.options.retryDelays[this._retryAttempt++];this._offsetBeforeRetry=this._offset,this._retryTimeout=setTimeout(function(){i.start()},s);return}}if(typeof this.options.onError=="function")this.options.onError(t);else throw t}}},{key:"_emitSuccess",value:function(t){this.options.removeFingerprintOnSuccess&&this._removeFromUrlStorage(),typeof this.options.onSuccess=="function"&&this.options.onSuccess({lastResponse:t})}},{key:"_emitProgress",value:function(t,i){typeof this.options.onProgress=="function"&&this.options.onProgress(t,i)}},{key:"_emitChunkComplete",value:function(t,i,o){typeof this.options.onChunkComplete=="function"&&this.options.onChunkComplete(t,i,o)}},{key:"_createUpload",value:function(){var t=this;if(!this.options.endpoint){this._emitError(new Error("tus: unable to create upload because no endpoint is provided"));return}var i=this._openRequest("POST",this.options.endpoint);this.options.uploadLengthDeferred?i.setHeader("Upload-Defer-Length","1"):i.setHeader("Upload-Length","".concat(this._size));var o=vo(this.options.metadata);o!==""&&i.setHeader("Upload-Metadata",o);var s;this.options.uploadDataDuringCreation&&!this.options.uploadLengthDeferred?(this._offset=0,s=this._addChunkToRequest(i)):((this.options.protocol===Yt||this.options.protocol===gt)&&i.setHeader("Upload-Complete","?0"),s=this._sendRequest(i,null)),s.then(function(n){if(!Je(n.getStatus(),200)){t._emitHttpError(i,n,"tus: unexpected response while creating upload");return}var a=n.getHeader("Location");if(a==null){t._emitHttpError(i,n,"tus: invalid or missing Location header");return}if(t.url=_o(t.options.endpoint,a),"Created upload at ".concat(t.url),typeof t.options.onUploadUrlAvailable=="function"&&t.options.onUploadUrlAvailable(),t._size===0){t._emitSuccess(n),t._source.close();return}t._saveUploadInUrlStorage().then(function(){t.options.uploadDataDuringCreation?t._handleUploadResponse(i,n):(t._offset=0,t._performUpload())})}).catch(function(n){t._emitHttpError(i,null,"tus: failed to create upload",n)})}},{key:"_resumeUpload",value:function(){var t=this,i=this._openRequest("HEAD",this.url),o=this._sendRequest(i,null);o.then(function(s){var n=s.getStatus();if(!Je(n,200)){if(n===423){t._emitHttpError(i,s,"tus: upload is currently locked; retry later");return}if(Je(n,400)&&t._removeFromUrlStorage(),!t.options.endpoint){t._emitHttpError(i,s,"tus: unable to resume upload (new upload cannot be created without an endpoint)");return}t.url=null,t._createUpload();return}var a=Number.parseInt(s.getHeader("Upload-Offset"),10);if(Number.isNaN(a)){t._emitHttpError(i,s,"tus: invalid or missing offset value");return}var l=Number.parseInt(s.getHeader("Upload-Length"),10);if(Number.isNaN(l)&&!t.options.uploadLengthDeferred&&t.options.protocol===Kt){t._emitHttpError(i,s,"tus: invalid or missing length value");return}typeof t.options.onUploadUrlAvailable=="function"&&t.options.onUploadUrlAvailable(),t._saveUploadInUrlStorage().then(function(){if(a===l){t._emitProgress(l,l),t._emitSuccess(s);return}t._offset=a,t._performUpload()})}).catch(function(s){t._emitHttpError(i,null,"tus: failed to resume upload",s)})}},{key:"_performUpload",value:function(){var t=this;if(!this._aborted){var i;this.options.overridePatchMethod?(i=this._openRequest("POST",this.url),i.setHeader("X-HTTP-Method-Override","PATCH")):i=this._openRequest("PATCH",this.url),i.setHeader("Upload-Offset","".concat(this._offset));var o=this._addChunkToRequest(i);o.then(function(s){if(!Je(s.getStatus(),200)){t._emitHttpError(i,s,"tus: unexpected response while uploading chunk");return}t._handleUploadResponse(i,s)}).catch(function(s){t._aborted||t._emitHttpError(i,null,"tus: failed to upload chunk at offset ".concat(t._offset),s)})}}},{key:"_addChunkToRequest",value:function(t){var i=this,o=this._offset,s=this._offset+this.options.chunkSize;return t.setProgressHandler(function(n){i._emitProgress(o+n,i._size)}),this.options.protocol===Kt?t.setHeader("Content-Type","application/offset+octet-stream"):this.options.protocol===gt&&t.setHeader("Content-Type","application/partial-upload"),(s===Number.POSITIVE_INFINITY||s>this._size)&&!this.options.uploadLengthDeferred&&(s=this._size),this._source.slice(o,s).then(function(n){var a=n.value,l=n.done,c=a!=null&&a.size?a.size:0;i.options.uploadLengthDeferred&&l&&(i._size=i._offset+c,t.setHeader("Upload-Length","".concat(i._size)));var d=i._offset+c;return!i.options.uploadLengthDeferred&&l&&d!==i._size?Promise.reject(new Error("upload was configured with a size of ".concat(i._size," bytes, but the source is done after ").concat(d," bytes"))):a===null?i._sendRequest(t):((i.options.protocol===Yt||i.options.protocol===gt)&&t.setHeader("Upload-Complete",l?"?1":"?0"),i._emitProgress(i._offset,i._size),i._sendRequest(t,a))})}},{key:"_handleUploadResponse",value:function(t,i){var o=Number.parseInt(i.getHeader("Upload-Offset"),10);if(Number.isNaN(o)){this._emitHttpError(t,i,"tus: invalid or missing offset value");return}if(this._emitProgress(o,this._size),this._emitChunkComplete(o-this._offset,o,this._size),this._offset=o,o===this._size){this._emitSuccess(i),this._source.close();return}this._performUpload()}},{key:"_openRequest",value:function(t,i){var o=bo(t,i,this.options);return this._req=o,o}},{key:"_removeFromUrlStorage",value:function(){var t=this;this._urlStorageKey&&(this._urlStorage.removeUpload(this._urlStorageKey).catch(function(i){t._emitError(i)}),this._urlStorageKey=null)}},{key:"_saveUploadInUrlStorage",value:function(){var t=this;if(!this.options.storeFingerprintForResuming||!this._fingerprint||this._urlStorageKey!==null)return Promise.resolve();var i={size:this._size,metadata:this.options.metadata,creationTime:new Date().toString()};return this._parallelUploads?i.parallelUploadUrls=this._parallelUploadUrls:i.uploadUrl=this.url,this._urlStorage.addUpload(this._fingerprint,i).then(function(o){t._urlStorageKey=o})}},{key:"_sendRequest",value:function(t){var i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null;return yo(t,i,this.options)}}],[{key:"terminate",value:function(t){var i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},o=bo("DELETE",t,i);return yo(o,null,i).then(function(s){if(s.getStatus()!==204)throw new ft("tus: unexpected response while terminating upload",null,o,s)}).catch(function(s){if(s instanceof ft||(s=new ft("tus: failed to terminate upload",s,o,null)),!wo(s,0,i))throw s;var n=i.retryDelays[0],a=i.retryDelays.slice(1),l=Ke(Ke({},i),{},{retryDelays:a});return new Promise(function(c){return setTimeout(c,n)}).then(function(){return r.terminate(t,l)})})}}])})();function vo(r){return Object.entries(r).map(function(e){var t=Ss(e,2),i=t[0],o=t[1];return"".concat(i," ").concat(Na.encode(String(o)))}).join(",")}function Je(r,e){return r>=e&&r<e+100}function bo(r,e,t){var i=t.httpStack.createRequest(r,e);t.protocol===Yt?i.setHeader("Upload-Draft-Interop-Version","5"):t.protocol===gt?i.setHeader("Upload-Draft-Interop-Version","6"):i.setHeader("Tus-Resumable","1.0.0");for(var o=t.headers||{},s=0,n=Object.entries(o);s<n.length;s++){var a=Ss(n[s],2),l=a[0],c=a[1];i.setHeader(l,c)}if(t.addRequestId){var d=Ga();i.setHeader("X-Request-ID",d)}return i}function yo(r,e,t){return Fi.apply(this,arguments)}function Fi(){return Fi=Xa(Li().mark(function r(e,t,i){var o;return Li().wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(typeof i.onBeforeRequest!="function"){n.next=3;break}return n.next=3,i.onBeforeRequest(e);case 3:return n.next=5,e.send(t);case 5:if(o=n.sent,typeof i.onAfterResponse!="function"){n.next=9;break}return n.next=9,i.onAfterResponse(e,o);case 9:return n.abrupt("return",o);case 10:case"end":return n.stop()}},r)})),Fi.apply(this,arguments)}function nl(){var r=!0;return typeof navigator<"u"&&navigator.onLine===!1&&(r=!1),r}function wo(r,e,t){return t.retryDelays==null||e>=t.retryDelays.length||r.originalRequest==null?!1:t&&typeof t.onShouldRetry=="function"?t.onShouldRetry(r,e,t):Es(r)}function Es(r){var e=r.originalResponse?r.originalResponse.getStatus():0;return(!Je(e,400)||e===409||e===423)&&nl()}function _o(r,e){return new Wa(e,r).toString()}function al(r,e){for(var t=Math.floor(r/e),i=[],o=0;o<e;o++)i.push({start:t*o,end:t*(o+1)});return i[e-1].end=r,i}ti.defaultOptions=sl;var Ps=function(){return typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative"};function ll(r){return new Promise(function(e,t){var i=new XMLHttpRequest;i.responseType="blob",i.onload=function(){var o=i.response;e(o)},i.onerror=function(o){t(o)},i.open("GET",r),i.send()})}var cl=function(){return typeof window<"u"&&(typeof window.PhoneGap<"u"||typeof window.Cordova<"u"||typeof window.cordova<"u")};function dl(r){return new Promise(function(e,t){var i=new FileReader;i.onload=function(){var o=new Uint8Array(i.result);e({value:o})},i.onerror=function(o){t(o)},i.readAsArrayBuffer(r)})}function Pt(r){"@babel/helpers - typeof";return Pt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Pt(r)}function pl(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function ul(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,hl(i.key),i)}}function fl(r,e,t){return e&&ul(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function hl(r){var e=gl(r,"string");return Pt(e)=="symbol"?e:e+""}function gl(r,e){if(Pt(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Pt(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var ko=(function(){function r(e){pl(this,r),this._file=e,this.size=e.size}return fl(r,[{key:"slice",value:function(t,i){if(cl())return dl(this._file.slice(t,i));var o=this._file.slice(t,i),s=i>=this.size;return Promise.resolve({value:o,done:s})}},{key:"close",value:function(){}}])})();function Rt(r){"@babel/helpers - typeof";return Rt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Rt(r)}function ml(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function xl(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,bl(i.key),i)}}function vl(r,e,t){return e&&xl(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function bl(r){var e=yl(r,"string");return Rt(e)=="symbol"?e:e+""}function yl(r,e){if(Rt(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Rt(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}function So(r){return r===void 0?0:r.size!==void 0?r.size:r.length}function wl(r,e){if(r.concat)return r.concat(e);if(r instanceof Blob)return new Blob([r,e],{type:r.type});if(r.set){var t=new r.constructor(r.length+e.length);return t.set(r),t.set(e,r.length),t}throw new Error("Unknown data type")}var _l=(function(){function r(e){ml(this,r),this._buffer=void 0,this._bufferOffset=0,this._reader=e,this._done=!1}return vl(r,[{key:"slice",value:function(t,i){return t<this._bufferOffset?Promise.reject(new Error("Requested data is before the reader's current offset")):this._readUntilEnoughDataOrDone(t,i)}},{key:"_readUntilEnoughDataOrDone",value:function(t,i){var o=this,s=i<=this._bufferOffset+So(this._buffer);if(this._done||s){var n=this._getDataFromBuffer(t,i),a=n==null?this._done:!1;return Promise.resolve({value:n,done:a})}return this._reader.read().then(function(l){var c=l.value,d=l.done;return d?o._done=!0:o._buffer===void 0?o._buffer=c:o._buffer=wl(o._buffer,c),o._readUntilEnoughDataOrDone(t,i)})}},{key:"_getDataFromBuffer",value:function(t,i){t>this._bufferOffset&&(this._buffer=this._buffer.slice(t-this._bufferOffset),this._bufferOffset=t);var o=So(this._buffer)===0;return this._done&&o?null:this._buffer.slice(0,i-t)}},{key:"close",value:function(){this._reader.cancel&&this._reader.cancel()}}])})();function He(r){"@babel/helpers - typeof";return He=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},He(r)}function Ii(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */Ii=function(){return e};var r,e={},t=Object.prototype,i=t.hasOwnProperty,o=Object.defineProperty||function(b,h,x){b[h]=x.value},s=typeof Symbol=="function"?Symbol:{},n=s.iterator||"@@iterator",a=s.asyncIterator||"@@asyncIterator",l=s.toStringTag||"@@toStringTag";function c(b,h,x){return Object.defineProperty(b,h,{value:x,enumerable:!0,configurable:!0,writable:!0}),b[h]}try{c({},"")}catch{c=function(x,E,R){return x[E]=R}}function d(b,h,x,E){var R=h&&h.prototype instanceof L?h:L,C=Object.create(R.prototype),D=new W(E||[]);return o(C,"_invoke",{value:T(b,x,D)}),C}function p(b,h,x){try{return{type:"normal",arg:b.call(h,x)}}catch(E){return{type:"throw",arg:E}}}e.wrap=d;var u="suspendedStart",m="suspendedYield",g="executing",v="completed",$={};function L(){}function k(){}function _(){}var w={};c(w,n,function(){return this});var y=Object.getPrototypeOf,U=y&&y(y(xe([])));U&&U!==t&&i.call(U,n)&&(w=U);var P=_.prototype=L.prototype=Object.create(w);function z(b){["next","throw","return"].forEach(function(h){c(b,h,function(x){return this._invoke(h,x)})})}function F(b,h){function x(R,C,D,H){var q=p(b[R],b,C);if(q.type!=="throw"){var ee=q.arg,ie=ee.value;return ie&&He(ie)=="object"&&i.call(ie,"__await")?h.resolve(ie.__await).then(function(ae){x("next",ae,D,H)},function(ae){x("throw",ae,D,H)}):h.resolve(ie).then(function(ae){ee.value=ae,D(ee)},function(ae){return x("throw",ae,D,H)})}H(q.arg)}var E;o(this,"_invoke",{value:function(C,D){function H(){return new h(function(q,ee){x(C,D,q,ee)})}return E=E?E.then(H,H):H()}})}function T(b,h,x){var E=u;return function(R,C){if(E===g)throw Error("Generator is already running");if(E===v){if(R==="throw")throw C;return{value:r,done:!0}}for(x.method=R,x.arg=C;;){var D=x.delegate;if(D){var H=Z(D,x);if(H){if(H===$)continue;return H}}if(x.method==="next")x.sent=x._sent=x.arg;else if(x.method==="throw"){if(E===u)throw E=v,x.arg;x.dispatchException(x.arg)}else x.method==="return"&&x.abrupt("return",x.arg);E=g;var q=p(b,h,x);if(q.type==="normal"){if(E=x.done?v:m,q.arg===$)continue;return{value:q.arg,done:x.done}}q.type==="throw"&&(E=v,x.method="throw",x.arg=q.arg)}}}function Z(b,h){var x=h.method,E=b.iterator[x];if(E===r)return h.delegate=null,x==="throw"&&b.iterator.return&&(h.method="return",h.arg=r,Z(b,h),h.method==="throw")||x!=="return"&&(h.method="throw",h.arg=new TypeError("The iterator does not provide a '"+x+"' method")),$;var R=p(E,b.iterator,h.arg);if(R.type==="throw")return h.method="throw",h.arg=R.arg,h.delegate=null,$;var C=R.arg;return C?C.done?(h[b.resultName]=C.value,h.next=b.nextLoc,h.method!=="return"&&(h.method="next",h.arg=r),h.delegate=null,$):C:(h.method="throw",h.arg=new TypeError("iterator result is not an object"),h.delegate=null,$)}function ue(b){var h={tryLoc:b[0]};1 in b&&(h.catchLoc=b[1]),2 in b&&(h.finallyLoc=b[2],h.afterLoc=b[3]),this.tryEntries.push(h)}function A(b){var h=b.completion||{};h.type="normal",delete h.arg,b.completion=h}function W(b){this.tryEntries=[{tryLoc:"root"}],b.forEach(ue,this),this.reset(!0)}function xe(b){if(b||b===""){var h=b[n];if(h)return h.call(b);if(typeof b.next=="function")return b;if(!isNaN(b.length)){var x=-1,E=function R(){for(;++x<b.length;)if(i.call(b,x))return R.value=b[x],R.done=!1,R;return R.value=r,R.done=!0,R};return E.next=E}}throw new TypeError(He(b)+" is not iterable")}return k.prototype=_,o(P,"constructor",{value:_,configurable:!0}),o(_,"constructor",{value:k,configurable:!0}),k.displayName=c(_,l,"GeneratorFunction"),e.isGeneratorFunction=function(b){var h=typeof b=="function"&&b.constructor;return!!h&&(h===k||(h.displayName||h.name)==="GeneratorFunction")},e.mark=function(b){return Object.setPrototypeOf?Object.setPrototypeOf(b,_):(b.__proto__=_,c(b,l,"GeneratorFunction")),b.prototype=Object.create(P),b},e.awrap=function(b){return{__await:b}},z(F.prototype),c(F.prototype,a,function(){return this}),e.AsyncIterator=F,e.async=function(b,h,x,E,R){R===void 0&&(R=Promise);var C=new F(d(b,h,x,E),R);return e.isGeneratorFunction(h)?C:C.next().then(function(D){return D.done?D.value:C.next()})},z(P),c(P,l,"Generator"),c(P,n,function(){return this}),c(P,"toString",function(){return"[object Generator]"}),e.keys=function(b){var h=Object(b),x=[];for(var E in h)x.push(E);return x.reverse(),function R(){for(;x.length;){var C=x.pop();if(C in h)return R.value=C,R.done=!1,R}return R.done=!0,R}},e.values=xe,W.prototype={constructor:W,reset:function(h){if(this.prev=0,this.next=0,this.sent=this._sent=r,this.done=!1,this.delegate=null,this.method="next",this.arg=r,this.tryEntries.forEach(A),!h)for(var x in this)x.charAt(0)==="t"&&i.call(this,x)&&!isNaN(+x.slice(1))&&(this[x]=r)},stop:function(){this.done=!0;var h=this.tryEntries[0].completion;if(h.type==="throw")throw h.arg;return this.rval},dispatchException:function(h){if(this.done)throw h;var x=this;function E(ee,ie){return D.type="throw",D.arg=h,x.next=ee,ie&&(x.method="next",x.arg=r),!!ie}for(var R=this.tryEntries.length-1;R>=0;--R){var C=this.tryEntries[R],D=C.completion;if(C.tryLoc==="root")return E("end");if(C.tryLoc<=this.prev){var H=i.call(C,"catchLoc"),q=i.call(C,"finallyLoc");if(H&&q){if(this.prev<C.catchLoc)return E(C.catchLoc,!0);if(this.prev<C.finallyLoc)return E(C.finallyLoc)}else if(H){if(this.prev<C.catchLoc)return E(C.catchLoc,!0)}else{if(!q)throw Error("try statement without catch or finally");if(this.prev<C.finallyLoc)return E(C.finallyLoc)}}}},abrupt:function(h,x){for(var E=this.tryEntries.length-1;E>=0;--E){var R=this.tryEntries[E];if(R.tryLoc<=this.prev&&i.call(R,"finallyLoc")&&this.prev<R.finallyLoc){var C=R;break}}C&&(h==="break"||h==="continue")&&C.tryLoc<=x&&x<=C.finallyLoc&&(C=null);var D=C?C.completion:{};return D.type=h,D.arg=x,C?(this.method="next",this.next=C.finallyLoc,$):this.complete(D)},complete:function(h,x){if(h.type==="throw")throw h.arg;return h.type==="break"||h.type==="continue"?this.next=h.arg:h.type==="return"?(this.rval=this.arg=h.arg,this.method="return",this.next="end"):h.type==="normal"&&x&&(this.next=x),$},finish:function(h){for(var x=this.tryEntries.length-1;x>=0;--x){var E=this.tryEntries[x];if(E.finallyLoc===h)return this.complete(E.completion,E.afterLoc),A(E),$}},catch:function(h){for(var x=this.tryEntries.length-1;x>=0;--x){var E=this.tryEntries[x];if(E.tryLoc===h){var R=E.completion;if(R.type==="throw"){var C=R.arg;A(E)}return C}}throw Error("illegal catch attempt")},delegateYield:function(h,x,E){return this.delegate={iterator:xe(h),resultName:x,nextLoc:E},this.method==="next"&&(this.arg=r),$}},e}function $o(r,e,t,i,o,s,n){try{var a=r[s](n),l=a.value}catch(c){t(c);return}a.done?e(l):Promise.resolve(l).then(i,o)}function kl(r){return function(){var e=this,t=arguments;return new Promise(function(i,o){var s=r.apply(e,t);function n(l){$o(s,i,o,n,a,"next",l)}function a(l){$o(s,i,o,n,a,"throw",l)}n(void 0)})}}function Sl(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function $l(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,El(i.key),i)}}function Cl(r,e,t){return e&&$l(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function El(r){var e=Pl(r,"string");return He(e)=="symbol"?e:e+""}function Pl(r,e){if(He(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(He(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var Rl=(function(){function r(){Sl(this,r)}return Cl(r,[{key:"openFile",value:(function(){var e=kl(Ii().mark(function i(o,s){var n;return Ii().wrap(function(l){for(;;)switch(l.prev=l.next){case 0:if(!(Ps()&&o&&typeof o.uri<"u")){l.next=11;break}return l.prev=1,l.next=4,ll(o.uri);case 4:return n=l.sent,l.abrupt("return",new ko(n));case 8:throw l.prev=8,l.t0=l.catch(1),new Error("tus: cannot fetch `file.uri` as Blob, make sure the uri is correct and accessible. ".concat(l.t0));case 11:if(!(typeof o.slice=="function"&&typeof o.size<"u")){l.next=13;break}return l.abrupt("return",Promise.resolve(new ko(o)));case 13:if(typeof o.read!="function"){l.next=18;break}if(s=Number(s),Number.isFinite(s)){l.next=17;break}return l.abrupt("return",Promise.reject(new Error("cannot create source for stream without a finite value for the `chunkSize` option")));case 17:return l.abrupt("return",Promise.resolve(new _l(o,s)));case 18:return l.abrupt("return",Promise.reject(new Error("source object may only be an instance of File, Blob, or Reader in this environment")));case 19:case"end":return l.stop()}},i,null,[[1,8]])}));function t(i,o){return e.apply(this,arguments)}return t})()}])})();function Ul(r,e){return Ps()?Promise.resolve(Ol(r,e)):Promise.resolve(["tus-br",r.name,r.type,r.size,r.lastModified,e.endpoint].join("-"))}function Ol(r,e){var t=r.exif?Al(JSON.stringify(r.exif)):"noexif";return["tus-rn",r.name||"noname",r.size||"nosize",t,e.endpoint].join("/")}function Al(r){var e=0;if(r.length===0)return e;for(var t=0;t<r.length;t++){var i=r.charCodeAt(t);e=(e<<5)-e+i,e&=e}return e}function Ut(r){"@babel/helpers - typeof";return Ut=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ut(r)}function nr(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function Tl(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,Ll(i.key),i)}}function ar(r,e,t){return e&&Tl(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function Ll(r){var e=Fl(r,"string");return Ut(e)=="symbol"?e:e+""}function Fl(r,e){if(Ut(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Ut(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var Il=(function(){function r(){nr(this,r)}return ar(r,[{key:"createRequest",value:function(t,i){return new zl(t,i)}},{key:"getName",value:function(){return"XHRHttpStack"}}])})(),zl=(function(){function r(e,t){nr(this,r),this._xhr=new XMLHttpRequest,this._xhr.open(e,t,!0),this._method=e,this._url=t,this._headers={}}return ar(r,[{key:"getMethod",value:function(){return this._method}},{key:"getURL",value:function(){return this._url}},{key:"setHeader",value:function(t,i){this._xhr.setRequestHeader(t,i),this._headers[t]=i}},{key:"getHeader",value:function(t){return this._headers[t]}},{key:"setProgressHandler",value:function(t){"upload"in this._xhr&&(this._xhr.upload.onprogress=function(i){i.lengthComputable&&t(i.loaded)})}},{key:"send",value:function(){var t=this,i=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null;return new Promise(function(o,s){t._xhr.onload=function(){o(new Dl(t._xhr))},t._xhr.onerror=function(n){s(n)},t._xhr.send(i)})}},{key:"abort",value:function(){return this._xhr.abort(),Promise.resolve()}},{key:"getUnderlyingObject",value:function(){return this._xhr}}])})(),Dl=(function(){function r(e){nr(this,r),this._xhr=e}return ar(r,[{key:"getStatus",value:function(){return this._xhr.status}},{key:"getHeader",value:function(t){return this._xhr.getResponseHeader(t)}},{key:"getBody",value:function(){return this._xhr.responseText}},{key:"getUnderlyingObject",value:function(){return this._xhr}}])})();function Ot(r){"@babel/helpers - typeof";return Ot=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ot(r)}function jl(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function Ml(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,Nl(i.key),i)}}function Bl(r,e,t){return e&&Ml(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function Nl(r){var e=Hl(r,"string");return Ot(e)=="symbol"?e:e+""}function Hl(r,e){if(Ot(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Ot(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var zi=!1;try{zi="localStorage"in window;var _i="tusSupport",Co=localStorage.getItem(_i);localStorage.setItem(_i,Co),Co===null&&localStorage.removeItem(_i)}catch(r){if(r.code===r.SECURITY_ERR||r.code===r.QUOTA_EXCEEDED_ERR)zi=!1;else throw r}var ql=zi,Vl=(function(){function r(){jl(this,r)}return Bl(r,[{key:"findAllUploads",value:function(){var t=this._findEntries("tus::");return Promise.resolve(t)}},{key:"findUploadsByFingerprint",value:function(t){var i=this._findEntries("tus::".concat(t,"::"));return Promise.resolve(i)}},{key:"removeUpload",value:function(t){return localStorage.removeItem(t),Promise.resolve()}},{key:"addUpload",value:function(t,i){var o=Math.round(Math.random()*1e12),s="tus::".concat(t,"::").concat(o);return localStorage.setItem(s,JSON.stringify(i)),Promise.resolve(s)}},{key:"_findEntries",value:function(t){for(var i=[],o=0;o<localStorage.length;o++){var s=localStorage.key(o);if(s.indexOf(t)===0)try{var n=JSON.parse(localStorage.getItem(s));n.urlStorageKey=s,i.push(n)}catch{}}return i}}])})();function it(r){"@babel/helpers - typeof";return it=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},it(r)}function Kl(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function Yl(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,Us(i.key),i)}}function Wl(r,e,t){return t&&Yl(r,t),Object.defineProperty(r,"prototype",{writable:!1}),r}function Gl(r,e,t){return e=ii(e),Xl(r,Rs()?Reflect.construct(e,t||[],ii(r).constructor):e.apply(r,t))}function Xl(r,e){if(e&&(it(e)==="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return Jl(r)}function Jl(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function Rs(){try{var r=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(Rs=function(){return!!r})()}function ii(r){return ii=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},ii(r)}function Zl(r,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");r.prototype=Object.create(e&&e.prototype,{constructor:{value:r,writable:!0,configurable:!0}}),Object.defineProperty(r,"prototype",{writable:!1}),e&&Di(r,e)}function Di(r,e){return Di=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(i,o){return i.__proto__=o,i},Di(r,e)}function Eo(r,e){var t=Object.keys(r);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(r);e&&(i=i.filter(function(o){return Object.getOwnPropertyDescriptor(r,o).enumerable})),t.push.apply(t,i)}return t}function Ze(r){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?Eo(Object(t),!0).forEach(function(i){Ql(r,i,t[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(t)):Eo(Object(t)).forEach(function(i){Object.defineProperty(r,i,Object.getOwnPropertyDescriptor(t,i))})}return r}function Ql(r,e,t){return e=Us(e),e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}function Us(r){var e=ec(r,"string");return it(e)=="symbol"?e:e+""}function ec(r,e){if(it(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(it(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(r)}var Po=Ze(Ze({},ti.defaultOptions),{},{httpStack:new Il,fileReader:new Rl,urlStorage:ql?new Vl:new Oa,fingerprint:Ul}),tc=(function(r){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null,i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return Kl(this,e),i=Ze(Ze({},Po),i),Gl(this,e,[t,i])}return Zl(e,r),Wl(e,null,[{key:"terminate",value:function(i){var o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return o=Ze(Ze({},Po),o),ti.terminate(i,o)}}])})(ti);const ic=10*1024*1024,rc=5*1024*1024,oc="https://eu-on-24001.connector.filerobot.com/files",sc="https://eu-on-24001.connector.filerobot.com/json";function nc(r,e){if(!e||!r.file)return!1;const t=e.sizeThreshold??ic;return r.size>=t}function ac(r,e){const{tusConfig:t}=e,i=e.apiBase.replace(/\/+$/,""),o=t.endpoint||oc,s=t.jsonBase||sc,n=t.chunkSize??rc,a=t.resumable!==!1,l=t.parallelChunks??1,c=t.retryDelays??[0,1e3,3e3,5e3],d=i.split("/").pop()||"";let p=!1,u=!1,m=!1;const g={name:r.name,type:r.type,"filerobot-folder":e.folder};er(r.product)&&(g.product=JSON.stringify(tr(r.product)));const v=async()=>`tus-${r.id}-${o}`,$=new tc(r.file,{endpoint:o,chunkSize:n,retryDelays:c,parallelUploads:l,storeFingerprintForResuming:a,removeFingerprintOnSuccess:!0,headers:{},metadata:g,fingerprint:v,onBeforeRequest(y){const U=e.getAuthHeaders?e.getAuthHeaders():e.authHeaders;for(const[P,z]of Object.entries(U))y.setHeader(P,z);y.setHeader("X-Filerobot-Token",d)},onUploadUrlAvailable(){$.url&&e.onUploadUrlAvailable&&!m&&(m=!0,e.onUploadUrlAvailable($.url))},onProgress(y,U){!u&&!p&&e.onProgress(y,U)},onSuccess(){var P;if(u)return;_();const y=$.url||"",U=(P=y.match(/files\/([^/?]+)/))==null?void 0:P[1];U?cc(s,U,r.size).then(z=>{u||e.onComplete(Lt(z)?Qi(z,r):z)}).catch(z=>{u||e.onError(z)}):e.onComplete({status:"success",file:{uuid:"",name:r.name,extension:r.name.split(".").pop()||"",type:r.type,size:r.size,url:{public:y,cdn:y},meta:r.meta,tags:r.tags,info:{},created_at:new Date().toISOString(),modified_at:new Date().toISOString()}})},onError(y){u||(_(),lc(y)?e.onError(new Error("Network error during upload — check your connection or firewall settings")):e.onError(y instanceof Error?y:new Error(String(y))))},onShouldRetry(y,U,P){var F;const z=(F=y.originalResponse)==null?void 0:F.getStatus();return z===429?!0:!(z&&z>400&&z<500&&z!==409)}});let L=null,k=null;typeof window<"u"&&(L=()=>{var y;!p&&!u&&(p=!0,$.abort(!1),(y=e.onPause)==null||y.call(e))},k=()=>{var y;p&&!u&&(p=!1,$.start(),(y=e.onResume)==null||y.call(e))},window.addEventListener("offline",L),window.addEventListener("online",k));const _=()=>{L&&window.removeEventListener("offline",L),k&&window.removeEventListener("online",k)},w=()=>{try{$.start()}catch(y){_(),e.onError(y instanceof Error?y:new Error(String(y)))}};return a?$.findPreviousUploads().then(y=>{y.length>0&&!u&&$.resumeFromPreviousUpload(y[0]),u||w()}):w(),{abort(){u=!0,p=!1,_(),$.abort(!0)},pause(){!p&&!u&&(p=!0,$.abort(!1))},resume(){p&&!u&&(p=!1,$.start())},isPaused(){return p}}}function lc(r){var e;if(r instanceof ft){const t=(e=r.originalRequest)==null?void 0:e.getUnderlyingObject();return t&&typeof t.readyState=="number"&&typeof t.status=="number"?t.readyState!==0&&t.readyState!==4||t.status===0:r.originalResponse==null&&r.causingError!=null}return!1}async function cc(r,e,t){const i=`${r.replace(/\/+$/,"")}/${e}`,o=t>1e8?13e3:6e3,s=3;for(let n=0;n<=s;n++){n>0&&await new Promise(c=>setTimeout(c,o));const a=await fetch(i);if(a.status===404&&n<s)continue;if(!a.ok)throw new Error(`Failed to fetch file record (HTTP ${a.status})`);const l=await a.json();if(Lt(l))return l;if(l.file)return{status:"success",file:l.file};if(l.status==="success")return l;if(!(n<s))throw new Error(l.msg||"File record not available after upload")}throw new Error("File record not available after upload")}const Wt="_sfxRelativePath",Ro=8,dc=new Set(["node_modules","__MACOSX","$RECYCLE.BIN","System Volume Information"]);function pc(r){return r?r.startsWith(".")?!0:dc.has(r):!1}function lr(r,e){if(e){try{Object.defineProperty(r,Wt,{value:e,configurable:!0,enumerable:!1,writable:!1});return}catch{}try{Object.defineProperty(r,Wt,{value:e,configurable:!0,enumerable:!1,writable:!0})}catch{r[Wt]=e}}}function uc(r){const e=r[Wt];if(typeof e=="string"&&e)return e;const t=r.webkitRelativePath;if(typeof t=="string"&&t)return t;const i=r.relativePath;return typeof i=="string"?i:""}function fc(r){if(!r)return"";const e=r.replace(/^\/+/,"").replace(/\/+$/,""),t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function hc(r,e){const t=(r??"").replace(/\/+$/,""),i=(e??"").replace(/^\/+/,"").replace(/\/+$/,"");return i?t?`${t}/${i}`:i:r??""}async function Os(r){var n;const e=r.items;if(!(e&&e.length>0&&typeof e[0].webkitGetAsEntry=="function"))return{files:Array.from(r.files??[]),hadDirectories:!1};const i=[];let o=!1;for(const a of Array.from(e)){if(a.kind!=="file")continue;const l=(n=a.webkitGetAsEntry)==null?void 0:n.call(a);l&&(l.isDirectory&&(o=!0),i.push(l))}if(i.length===0)return{files:Array.from(r.files??[]),hadDirectories:!1};const s=[];return await As(i,"",s),{files:s,hadDirectories:o}}async function As(r,e,t){for(let i=0;i<r.length;i+=Ro){const o=r.slice(i,i+Ro);await Promise.all(o.map(s=>gc(s,e,t)))}}async function gc(r,e,t){try{if(r.isFile){const i=await mc(r);if(!i)return;const o=e?`${e}/${i.name}`:i.name;lr(i,o),t.push(i);return}if(r.isDirectory){if(pc(r.name))return;const i=e?`${e}/${r.name}`:r.name,o=await xc(r);await As(o,i,t)}}catch(i){console.warn("[sfx-uploader] folder traversal skipped an entry:",(r==null?void 0:r.name)??r,i)}}function mc(r){return new Promise(e=>{r.file(t=>e(t),()=>e(null))})}function xc(r){return new Promise(e=>{const t=r.createReader(),i=[],o=()=>{t.readEntries(s=>{if(s.length===0){e(i);return}i.push(...s),o()},s=>{console.warn("[sfx-uploader] directory read failed for",r==null?void 0:r.name,s),e(i)})};o()})}class vc{constructor(e,t){this.activeUploads=new Map,this.pausedUploads=new Map,this.retryTimers=new Map,this.unsubscribe=null,this.store=e,this.config=t}start(){this.unsubscribe||(this.unsubscribe=this.store.subscribe(()=>this.processQueue()),this.processQueue())}uploadAll(){const{files:e}=this.store.getState();let t=!1;for(const i of e.values())i.status==="idle"?(J(this.store,i.id,{status:"queued"}),t=!0):i.status==="queued"&&(t=!0);t&&(this.store.setState({isUploading:!0}),this.processQueue())}retryFile(e){const t=this.store.getState().files.get(e);!t||t.status!=="error"&&t.status!=="failed"||(J(this.store,e,{status:"queued",error:null,progress:0,bytesUploaded:0,speed:0}),this.processQueue())}retryAll(){const{files:e}=this.store.getState();for(const t of e.values())(t.status==="error"||t.status==="failed")&&J(this.store,t.id,{status:"queued",error:null,progress:0,bytesUploaded:0,speed:0});this.processQueue()}pauseFile(e){const t=this.activeUploads.get(e);t&&"pause"in t&&(t.pause(),this.activeUploads.delete(e),this.pausedUploads.set(e,t),J(this.store,e,{status:"paused"}),this.processQueue())}resumeFile(e){const t=this.pausedUploads.get(e);if(!t)return;const{concurrency:i}=this.store.getState().queueConfig;this.activeUploads.size<i?(this.pausedUploads.delete(e),t.resume(),this.activeUploads.set(e,t),J(this.store,e,{status:"uploading"})):J(this.store,e,{status:"queued"})}cancelFile(e){const t=this.store.getState().files.get(e);!t||!ji(t.status)||(this.abortPausedUpload(e),this.abortUpload(e),J(this.store,e,{status:"cancelled"}))}cancelAll(){const{files:e}=this.store.getState();for(const t of e.values())ji(t.status)&&(this.abortPausedUpload(t.id),this.abortUpload(t.id),J(this.store,t.id,{status:"cancelled"}));this.store.setState({isUploading:!1})}recompute(){this.updateTotalProgress(),this.checkAllComplete()}updateConfig(e){Object.assign(this.config,e)}destroy(){var e;for(const t of this.activeUploads.keys())this.abortUpload(t);for(const t of[...this.pausedUploads.keys()])this.abortPausedUpload(t);for(const t of this.retryTimers.values())clearTimeout(t);this.retryTimers.clear(),(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=null}processQueue(){const e=this.store.getState();if(e.isPaused)return;const{concurrency:t}=e.queueConfig,i=this.activeUploads.size,o=t-i;if(o<=0)return;const n=[...e.files.values()].filter(a=>a.status==="queued").sort((a,l)=>a.retryCount!==l.retryCount?l.retryCount-a.retryCount:a.addedAt-l.addedAt).slice(0,o);for(const a of n){const l=this.pausedUploads.get(a.id);l?(this.pausedUploads.delete(a.id),l.resume(),this.activeUploads.set(a.id,l),J(this.store,a.id,{status:"uploading"})):this.startUpload(a)}}startUpload(e){var u,m;const t=(m=(u=this.config).resolveUploadParams)==null?void 0:m.call(u,e),i=!!t&&Object.keys(t).length>0,o=!i&&!e.remoteInfo&&!e.remoteUrl&&nc(e,this.config.tusConfig);J(this.store,e.id,{status:"uploading",error:null,isTus:o});let s=0,n=Date.now(),a=0;const l=hc(this.store.getState().targetFolder,e.relativeFolder),c={apiBase:this.config.apiBase,authHeaders:this.config.authHeaders,folder:l,extraParams:i?t:void 0,onComplete:g=>this.handleComplete(e.id,g),onError:g=>this.handleError(e.id,g)},d=(g,v)=>{const $=Date.now(),L=($-n)/1e3;if(L>0){const _=(g-s)/L;a=a===0?_:.3*_+.7*a}s=g,n=$;const k=v>0?Math.min(g/v*100,100):0;J(this.store,e.id,{progress:k,bytesUploaded:g,speed:a}),this.updateTotalProgress()};let p;if(e.remoteInfo)p=ma(e,{...c,onProgress:d});else if(e.remoteUrl){if(!this.config.companionUrl){J(this.store,e.id,{status:"failed",error:"URL import requires connectors.companionUrl to be configured"}),this.checkAllComplete(),this.processQueue();return}p=xa(e,{...c,onProgress:d,companionUrl:this.config.companionUrl,onMeta:g=>{J(this.store,e.id,{size:g.size,type:g.type||e.type})}})}else if(o){const g=ac(e,{...c,onProgress:d,tusConfig:this.config.tusConfig,getAuthHeaders:()=>this.config.authHeaders,onUploadUrlAvailable:v=>{J(this.store,e.id,{tusUploadUrl:v})},onPause:()=>{this.activeUploads.delete(e.id),this.pausedUploads.set(e.id,g),J(this.store,e.id,{status:"paused"}),this.processQueue()},onResume:()=>{this.pausedUploads.delete(e.id),this.activeUploads.set(e.id,g),J(this.store,e.id,{status:"uploading"})}});p=g}else p=la(e,{...c,onProgress:d});this.activeUploads.set(e.id,p)}handleComplete(e,t){var d,p,u,m,g,v,$,L,k,_;this.activeUploads.delete(e);const i=this.store.getState().files.get(e),o=((d=i==null?void 0:i.previewUrl)==null?void 0:d.startsWith("blob:"))??!1,s=((u=(p=t.file)==null?void 0:p.url)==null?void 0:u.cdn)??((g=(m=t.file)==null?void 0:m.url)==null?void 0:g.cdn_permalink)??(($=(v=t.file)==null?void 0:v.url)==null?void 0:$.permalink)??null,n=s?((k=(L=this.config).transformPreviewUrl)==null?void 0:k.call(L,s))??s:null,a={status:"complete",progress:100,response:t,alreadyExisted:Lt(t)};i&&n&&i.type.startsWith("image/")&&!o&&(a.previewUrl=n);const l=(_=t.file)==null?void 0:_.size,c=typeof l=="number"?l:l==null?void 0:l.bytes;typeof c=="number"&&(a.size=c),J(this.store,e,a),this.updateTotalProgress(),this.checkAllComplete(),this.processQueue()}handleError(e,t){this.activeUploads.delete(e);const i=this.store.getState().files.get(e);if(!i)return;const{retryConfig:o}=this.store.getState().queueConfig,s=i.retryCount+1;if(s<=o.maxRetries){const n=Math.min(o.baseDelay*Math.pow(o.backoffFactor,i.retryCount),o.maxDelay);J(this.store,e,{status:"retrying",error:t.message,retryCount:s});const a=setTimeout(()=>{this.retryTimers.delete(e),J(this.store,e,{status:"queued"}),this.processQueue()},n);this.retryTimers.set(e,a)}else J(this.store,e,{status:"failed",error:t.message}),this.checkAllComplete(),this.processQueue()}abortPausedUpload(e){const t=this.pausedUploads.get(e);t&&(t.abort(),this.pausedUploads.delete(e))}abortUpload(e){var i;(i=this.activeUploads.get(e))==null||i.abort(),this.activeUploads.delete(e);const t=this.retryTimers.get(e);t&&(clearTimeout(t),this.retryTimers.delete(e))}updateTotalProgress(){const{files:e}=this.store.getState();let t=0,i=0,o=0,s=0,n=0;for(const a of e.values())a.status==="rejected"||a.status==="cancelled"||(n++,t+=a.size,i+=a.status==="complete"?a.size:Math.min(a.bytesUploaded,a.size),s+=a.status==="complete"?100:a.progress,a.status==="uploading"&&(o+=a.speed));this.store.setState({totalBytes:t,totalBytesUploaded:i,totalSpeed:o,totalProgress:n>0?Math.min(s/n,100):0})}checkAllComplete(){const{files:e}=this.store.getState();![...e.values()].some(i=>i.status==="queued"||i.status==="uploading"||i.status==="retrying"||i.status==="paused")&&this.store.getState().isUploading&&this.store.setState({isUploading:!1})}}function ji(r){return r==="queued"||r==="uploading"||r==="retrying"||r==="paused"}function cr(r){return`https://api.filerobot.com/${r}`}async function bc(r,e){const t=`${cr(r)}/key/${encodeURIComponent(e)}`,i=new AbortController,o=setTimeout(()=>i.abort(),3e4);try{const s=await fetch(t,{signal:i.signal});if(clearTimeout(o),!s.ok)throw new Error(`SASS key exchange failed (HTTP ${s.status})`);const n=await s.json();if(n.status==="error")throw new Error(`SASS key exchange failed: ${n.msg||"Unknown error"}`);return n.key}catch(s){throw clearTimeout(o),s instanceof DOMException&&s.name==="AbortError"?new Error("SASS key exchange timed out"):s}}function Mi(r,e){const t={};switch(r.mode){case"security-template":if(!e)throw new Error("[sfx-uploader] Cannot build auth headers for security-template mode: SASS key exchange has not been performed. Call resolveAuth() first or use sass-key mode with a pre-resolved key.");t["X-Filerobot-Key"]=e;break;case"sass-key":t["X-Filerobot-Key"]=r.sassKey;break}return r.airboxPuid&&(t["X-Filerobot-Airbox-Puid"]=r.airboxPuid),t}async function yc(r){const e=cr(r.container);if(r.mode==="security-template"){const t=await bc(r.container,r.securityTemplateId);return{apiBase:e,headers:Mi(r,t),sassKey:t}}return{apiBase:e,headers:Mi(r)}}const wc="https://ai.scaleflex.com",Uo=300,_c=.85,kc=3e4;function Oo(r){return r==="low"?.6:r==="high"?.85:.75}async function Sc(r,e){var o,s,n;if(r.file)return r.file;const t=r.previewUrl||((n=(s=(o=r.response)==null?void 0:o.file)==null?void 0:s.url)==null?void 0:n.cdn)||r.remoteUrl||"";if(!t)throw new Error("No image source for similarity check");const i=await fetch(t,{signal:e});if(!i.ok)throw new Error(`Failed to load image (HTTP ${i.status})`);return i.blob()}function $c(r){return`${(r||"image").replace(/\.[^./\\]*$/,"")||"image"}.jpg`}async function Cc(r){if(typeof createImageBitmap=="function")try{const e=await createImageBitmap(r);return{source:e,width:e.width,height:e.height,close:()=>e.close()}}catch{}return new Promise((e,t)=>{const i=new Image,o=URL.createObjectURL(r);i.onload=()=>{e({source:i,width:i.naturalWidth,height:i.naturalHeight,close:()=>URL.revokeObjectURL(o)})},i.onerror=()=>{URL.revokeObjectURL(o),t(new Error("Image decode failed"))},i.src=o})}async function Ec(r){const e=await Cc(r);try{const t=e.width>Uo?Uo/e.width:1,i=Math.max(1,Math.round(e.width*t)),o=Math.max(1,Math.round(e.height*t)),s=document.createElement("canvas");s.width=i,s.height=o;const n=s.getContext("2d");if(!n)throw new Error("Canvas 2D not supported");return n.drawImage(e.source,0,0,i,o),await new Promise((a,l)=>{s.toBlob(c=>c?a(c):l(new Error("Canvas toBlob failed")),"image/jpeg",_c)})}finally{e.close()}}async function Ao(r,e){var a,l;const t=new AbortController,i=setTimeout(()=>t.abort(),kc),o=()=>t.abort();(a=e.signal)==null||a.addEventListener("abort",o);const s=t.signal,n=()=>{if(s.aborted)throw new DOMException("Aborted","AbortError")};try{n();const c=await Sc(r,s);n();const d=await Ec(c);n();const u=`${(e.endpoint||wc).replace(/\/+$/,"")}/images/embedding/vectorize/image?threshold=${encodeURIComponent(String(e.threshold))}`,m=new FormData;m.append("file",d,$c(r.name));const g=await fetch(u,{method:"POST",headers:{"Filerobot-Token":e.container,"Filerobot-Key":e.sassKey},body:m,signal:s});if(!g.ok)throw new Error(`Similarity check failed (HTTP ${g.status})`);const v=await g.json();if(v.status==="error")throw new Error(`Similarity check failed: ${v.msg||"Unknown error"}`);return(v.similar_assets??[]).map(([$,L,k])=>({uuid:$,score:L,url:k}))}finally{clearTimeout(i),(l=e.signal)==null||l.removeEventListener("abort",o)}}const ri="sfx-uploader:last-upload:",Ts=1;function Pc(r){var s,n,a,l,c,d,p,u,m;const{file:e,previewUrl:t,...i}=r;let o=null;return r.status==="complete"&&(r.previewUrl&&!r.previewUrl.startsWith("blob:")?o=r.previewUrl:o=((a=(n=(s=r.response)==null?void 0:s.file)==null?void 0:n.url)==null?void 0:a.permalink)??((d=(c=(l=r.response)==null?void 0:l.file)==null?void 0:c.url)==null?void 0:d.cdn_permalink)??((m=(u=(p=r.response)==null?void 0:p.file)==null?void 0:u.url)==null?void 0:m.cdn)??null),{...i,previewUrl:o}}function Rc(r){try{const e=sessionStorage.getItem(ri+r);if(!e)return null;const t=JSON.parse(e);return(t==null?void 0:t.__schemaVersion)!==Ts?null:t}catch{return null}}function Uc(r,e){try{sessionStorage.setItem(ri+r,JSON.stringify(e))}catch{}}const ut={save(r,e){if(e.length===0){this.clear(r);return}const t={__schemaVersion:Ts,savedAt:Date.now(),files:e.map(Pc)};Uc(r,t)},load(r){const e=Rc(r);return e?e.files.map(t=>({...t,file:null,previewUrl:t.previewUrl??null})):null},exists(r){try{return sessionStorage.getItem(ri+r)!=null}catch{return!1}},clear(r){try{sessionStorage.removeItem(ri+r)}catch{}}},M={FILE_ADDED:"sfx-file-added",FILE_REMOVED:"sfx-file-removed",FILE_REJECTED:"sfx-file-rejected",UPLOAD_STARTED:"sfx-upload-started",UPLOAD_PROGRESS:"sfx-upload-progress",UPLOAD_COMPLETE:"sfx-upload-complete",UPLOAD_ERROR:"sfx-upload-error",UPLOAD_RETRY:"sfx-upload-retry",UPLOAD_PAUSED:"sfx-upload-paused",UPLOAD_RESUMED:"sfx-upload-resumed",ALL_COMPLETE:"sfx-all-complete",FOLDER_COMPLETE:"sfx-folder-complete",TOTAL_PROGRESS:"sfx-total-progress",BEFORE_UPLOAD:"sfx-before-upload",OPEN:"sfx-open",CLOSE:"sfx-close",CANCEL:"sfx-cancel",MINIMIZE:"sfx-minimize",RESTORE:"sfx-restore",PANEL_SHOWN:"sfx-panel-shown",COMPLETE_ACTION:"sfx-complete-action",FILE_PREVIEW:"sfx-file-preview",FILL_METADATA:"sfx-fill-metadata",METADATA_SCHEMA:"sfx-metadata-schema",FILE_LOCATE:"sfx-file-locate",FILE_COPY_CDN:"sfx-file-copy-cdn"};let Oc=0;function Ye(){return`file-${Date.now()}-${++Oc}`}function Fe(r){if(!Number.isFinite(r)||r<=0)return"0 B";const e=["B","KB","MB","GB"],t=Math.min(Math.floor(Math.log(r)/Math.log(1024)),e.length-1),i=r/Math.pow(1024,t);return`${t===0?i:i.toFixed(1)} ${e[t]}`}function ki(r){if(!isFinite(r)||r<=0)return"0s";const e=Math.round(r);if(e<60)return`${e}s`;const t=Math.floor(e/60);if(t>99){const o=Math.floor(t/60),s=t%60;return s>0?`${o}h ${s}m`:`${o}h`}const i=e%60;return i>0?`${t}m ${i}s`:`${t}m`}function fe(r){var t;const e=((t=r.name.split(".").pop())==null?void 0:t.toLowerCase())??"";return r.type.startsWith("image/")?"image":r.type.startsWith("video/")||["mp4","mov","avi","webm","mkv","flv","wmv"].includes(e)?"vid":r.type.startsWith("audio/")||["mp3","wav","ogg","flac","aac","m4a","wma"].includes(e)?"audio":r.type==="application/pdf"||e==="pdf"?"pdf":["xls","xlsx","csv","tsv","ods"].includes(e)?"sheet":["doc","docx","txt","rtf","odt","pages"].includes(e)?"doc":["ppt","pptx","key","odp"].includes(e)?"slide":["zip","rar","7z","tar","gz","bz2","xz","zst"].includes(e)?"zip":["js","ts","jsx","tsx","py","rb","go","rs","java","c","cpp","h","cs","php","swift","kt","sh","bash"].includes(e)?"code":["html","css","scss","xml","svg","json","yaml","yml","toml","md","mdx","ini","env","log"].includes(e)?"markup":["ttf","otf","woff","woff2","eot"].includes(e)?"font":["ai","psd","sketch","fig","xd","indd","eps"].includes(e)?"design":["exe","dmg","app","msi","deb","rpm","apk","ipa"].includes(e)?"binary":["sql","db","sqlite","mdb"].includes(e)?"data":"gen"}function Ac(r){const e=r.lastIndexOf(".");return e>=0?r.slice(e+1).toUpperCase():""}const Tc=new Set([".ds_store","thumbs.db","desktop.ini"]);function Si(r){const e=(r.split(/[\\/]/).pop()??r).toLowerCase();return e.startsWith(".ds_store")?!0:Tc.has(e)}const Lc="https://scaleflex.cloudimg.io/v7/assets/file-types/v3/",Ls={_default:"9a518a",png:"96cd9a",jpg:"06e819",jpg2:"f0eb7f",jpeg:"6a65e9",gif:"c3c2c3",bmp:"d2243a",webp:"fedd74",svg:"a15e46",tiff:"1f30c3",tif:"b383c9",heic:"84adfe",avif:"536b30",ico:"79063d",psd:"be6140",psb:"678646",ai:"84b254",dwg:"971fb3",mp4:"42f175",webm:"26a84a",avi:"d22ba8",mpeg:"ba93bb",ogv:"74d453","3gp":"f0d388","3g2":"04c652",swf:"3955e2",fla:"daf585",m3u8:"7d5e62",mp3:"66bbef",wav:"d7a7d5",aac:"07f3f9",oga:"a5c622",opus:"9548b1",weba:"4dcf70",mid:"3f0e29",midi:"9fedec",cda:"85b83b",pdf:"18c5f7",doc:"d1b47c",docx:"1eb6b0",txt:"307979",rtf:"978c5f",xls:"13b5f7",xlsx:"79d64a",ppt:"4ee29b",pptx:"8b1568",csv:"4add78",odt:"940781",ods:"9fbe9a",odp:"bf892d",dbf:"457bd4",vsd:"8a9ccb",abw:"313dc7",epub:"15263d",azw:"a018b1",ics:"909f63",ogx:"f694d2",zip:"84f98b",rar:"1d6423","7z":"e007e5",tar:"603aed",gz:"de13f7",bz:"0374ff",bz2:"e14294",arc:"942fad",jar:"149796",mpkg:"dea655",ttf:"d2e2c1",otf:"c904fd",woff:"4b8177",woff2:"b532d3",eot:"a54980",js:"524691",mjs:"d57921",ts:"9af3ae",css:"287863",html:"fa7a87",htm:"21323d",xhtml:"e6d6a9",xul:"6c9c71",json:"104c9e",jsonld:"f30c0f",xml:"7f7194",php:"503e36",sh:"3b820e",csh:"08c0cc",exe:"ccca53",iso:"064b8f",bin:"1e9618"};function Bi(r){const e=r==="_default"?"GENERIC":r.toUpperCase();return`${Lc}${e}.svg?vh=${Ls[r]}`}function Fs(r){const e=(r==null?void 0:r.toLowerCase().replaceAll(".",""))||"";return e in Ls?Bi(e):Bi("_default")}function Is(){return Bi("_default")}const Fc={jpg:"image/jpeg",jpeg:"image/jpeg",png:"image/png",gif:"image/gif",webp:"image/webp",svg:"image/svg+xml",bmp:"image/bmp",ico:"image/x-icon",heic:"image/heic",heif:"image/heif",mp4:"video/mp4",mov:"video/quicktime",avi:"video/x-msvideo",webm:"video/webm",pdf:"application/pdf",zip:"application/zip",doc:"application/msword",docx:"application/vnd.openxmlformats-officedocument.wordprocessingml.document"};function To(r){var t;const e=((t=r.split(".").pop())==null?void 0:t.toLowerCase())??"";return Fc[e]||""}function ke(r){return r==="image/heic"||r==="image/heif"}function Ic(r){return new Promise(e=>{const t=document.createElement("video");t.preload="metadata",t.muted=!0,t.playsInline=!0;const i=URL.createObjectURL(r);let o=!1;const s=()=>{o||(o=!0,e(null)),t.removeAttribute("src"),t.load(),URL.revokeObjectURL(i)};t.addEventListener("seeked",()=>{try{const n=document.createElement("canvas");n.width=t.videoWidth||320,n.height=t.videoHeight||240;const a=n.getContext("2d");if(a){a.drawImage(t,0,0,n.width,n.height),n.toBlob(l=>{o||(o=!0,e(l?URL.createObjectURL(l):null),t.removeAttribute("src"),t.load(),URL.revokeObjectURL(i))},"image/jpeg",.7);return}}catch{}s()},{once:!0}),t.addEventListener("error",()=>s(),{once:!0}),setTimeout(()=>s(),5e3),t.src=i,t.addEventListener("loadeddata",()=>{t.currentTime=.1},{once:!0})})}function zc(r){return typeof r=="string"&&r.startsWith("Maximum ")&&r.includes("files allowed")}function $i(r,e,t){var i,o;if(e.maxFileSize!=null&&r.size>0&&r.size>e.maxFileSize)return`File exceeds ${(e.maxFileSize/1048576).toFixed(1)} MB limit`;if(e.maxTotalFilesSize!=null&&r.size>0){let s=r.size;for(const n of t.values())n.status!=="rejected"&&n.status!=="cancelled"&&(s+=n.size);if(s>e.maxTotalFilesSize)return"Total file size limit exceeded"}if(e.maxNumberOfFiles!=null){let s=0;for(const n of t.values())n.status!=="rejected"&&n.status!=="cancelled"&&s++;if(s>=e.maxNumberOfFiles)return`Maximum ${e.maxNumberOfFiles} files allowed`}if(e.allowedFileTypes!=null){const s=e.allowedFileTypes,n="."+(((i=r.name.split(".").pop())==null?void 0:i.toLowerCase())??"");if(!s.some(l=>l.startsWith(".")?n===l.toLowerCase():l.endsWith("/*")?r.type.startsWith(l.slice(0,-1)):r.type===l))return"File type not allowed"}if(e.blockedFileTypes!=null){const s=e.blockedFileTypes,n="."+(((o=r.name.split(".").pop())==null?void 0:o.toLowerCase())??"");if(s.some(l=>l.startsWith(".")?n===l.toLowerCase():l.endsWith("/*")?r.type.startsWith(l.slice(0,-1)):r.type===l))return"File type is blocked"}return null}function Lo(r){return r.allowedFileTypes?r.allowedFileTypes.join(","):""}const Fo={"google-drive":{id:"google-drive",label:"Google Drive",fillIcon:!0,icon:"",brandStyle:{background:"transparent"},brandHtml:'<svg width="16" height="16" viewBox="0 0 87.3 78"><path d="M6.6 66.85l3.85 6.65c.8 1.4 1.95 2.5 3.3 3.3L27.5 53H0c0 1.55.4 3.1 1.2 4.5z" fill="#0066da"/><path d="M43.65 25L29.9 1.2C28.55 2 27.4 3.1 26.6 4.5L1.2 48.5C.4 49.9 0 51.45 0 53h27.5z" fill="#00ac47"/><path d="M73.55 76.8c1.35-.8 2.5-1.9 3.3-3.3l1.6-2.75 7.65-13.25c.8-1.4 1.2-2.95 1.2-4.5H59.8l5.65 10.85z" fill="#ea4335"/><path d="M43.65 25L57.4 1.2C56.05.4 54.5 0 52.9 0H34.4c-1.6 0-3.15.45-4.5 1.2z" fill="#00832d"/><path d="M59.8 53H27.5L13.75 76.8c1.35.8 2.9 1.2 4.5 1.2h50.8c1.6 0 3.15-.45 4.5-1.2z" fill="#2684fc"/><path d="M73.4 26.5l-12.7-22c-.8-1.4-1.95-2.5-3.3-3.3L43.65 25 59.8 53h27.45c0-1.55-.4-3.1-1.2-4.5z" fill="#ffba00"/></svg>'},dropbox:{id:"dropbox",label:"Dropbox",fillIcon:!0,icon:"",brandStyle:{background:"#0061ff"},brandHtml:'<svg width="11" height="11" viewBox="0 0 528 512" fill="white"><path d="M264.4 116.3l-132 84.3 132 84.3-132 84.3L0 284.1l132.3-84.3L0 116.3 132.3 32l132.1 84.3zm-132 284.5l132-84.3 132 84.3-132 84.4-132-84.4zm132-116.6l132.3-84.3-132.3-83.9 131.6-84.3L528 116.3l-132.3 84.1L528 284.7l-132.4 83.9-131.2-84.4z"/></svg>'},onedrive:{id:"onedrive",label:"OneDrive",fillIcon:!0,icon:"",brandStyle:{background:"#0078d4"},brandHtml:'<svg width="11" height="11" viewBox="0 0 24 24" fill="white"><path d="M10.5 13.5C10.5 11.57 12.07 10 14 10h6.5c.17 0 .34.01.5.02A6 6 0 009.01 11.6 4 4 0 0010.5 13.5zM12 14.5a5 5 0 00-5-5 5 5 0 00-5 5 3 3 0 003 3h9.5A3.5 3.5 0 0018 14c0-.18-.01-.35-.03-.52A5.48 5.48 0 0112 14.5z"/></svg>'},box:{id:"box",label:"Box",fillIcon:!0,icon:"",brandStyle:{background:"#0e50a0","font-size":"9px","font-weight":"800",color:"#fff"},brandHtml:"box"},instagram:{id:"instagram",label:"Instagram",fillIcon:!0,icon:"",brandStyle:{background:"linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)"},brandHtml:'<svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M12 2.16c2.94 0 3.29.01 4.45.06 1.07.05 1.8.22 2.43.46.66.25 1.21.6 1.77 1.16.55.55.9 1.1 1.16 1.77.25.64.41 1.37.46 2.43.05 1.16.06 1.51.06 4.45s-.01 3.29-.06 4.45c-.05 1.07-.22 1.8-.46 2.43a4.9 4.9 0 01-1.16 1.77c-.55.55-1.1.9-1.77 1.16-.64.25-1.37.41-2.43.46-1.16.05-1.51.06-4.45.06s-3.29-.01-4.45-.06c-1.07-.05-1.8-.22-2.43-.46a4.9 4.9 0 01-1.77-1.16 4.9 4.9 0 01-1.16-1.77c-.25-.64-.41-1.37-.46-2.43C2.17 15.29 2.16 14.94 2.16 12s.01-3.29.06-4.45c.05-1.07.22-1.8.46-2.43a4.9 4.9 0 011.16-1.77A4.9 4.9 0 015.61 2.2c.64-.25 1.37-.41 2.43-.46C9.21 2.17 9.56 2.16 12 2.16zM12 16a4 4 0 110-8 4 4 0 010 8zm6.4-9.85a1.44 1.44 0 100 2.88 1.44 1.44 0 000-2.88z"/></svg>'},facebook:{id:"facebook",label:"Facebook",fillIcon:!0,icon:"",brandStyle:{background:"#1877f2"},brandHtml:'<svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.41 0 12.07c0 6.02 4.39 11.02 10.12 11.93v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.95.93-1.95 1.89v2.26h3.33l-.53 3.49h-2.8v8.44C19.61 23.09 24 18.09 24 12.07z"/></svg>'},unsplash:{id:"unsplash",label:"Unsplash",fillIcon:!0,icon:"",brandStyle:{background:"#111"},brandHtml:'<svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M8.5 11.5v5h7v-5h5.5V21h-18v-9.5h5.5zm7-8v5h-7v-5h7z"/></svg>'}};function Dc(r){return r.filter(e=>e in Fo).map(e=>Fo[e])}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let oi=class extends li{constructor(e){if(super(e),this.it=S,e.type!==ai.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===S||e==null)return this._t=void 0,this.it=e;if(e===he)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};oi.directiveName="unsafeHTML",oi.resultType=1;const Io=Tt(oi);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ni extends oi{}Ni.directiveName="unsafeSVG",Ni.resultType=2;const $e=Tt(Ni);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jc=Tt(class extends li{constructor(r){var e;if(super(r),r.type!==ai.ATTRIBUTE||r.name!=="class"||((e=r.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var i,o;if(this.st===void 0){this.st=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!((i=this.nt)!=null&&i.has(s))&&this.st.add(s);return this.render(e)}const t=r.element.classList;for(const s of this.st)s in e||(t.remove(s),this.st.delete(s));for(const s in e){const n=!!e[s];n===this.st.has(s)||(o=this.nt)!=null&&o.has(s)||(n?(t.add(s),this.st.add(s)):(t.remove(s),this.st.delete(s)))}return he}});function De(r){return r.brandStyle?f`<span
    class=${jc({"brand-ico":!0,"brand-ico--transparent":r.brandStyle.background==="transparent"})}
    ${Q(r.brandStyle)}
  >${Io(r.brandHtml)}</span>`:Io(r.brandHtml)}var Mc=Object.defineProperty,zs=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Mc(e,t,o),o};const Bc='<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>',Nc='<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>',Hc='<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>',qc='<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>',mt=[{id:"device",labelKey:"myDevice",label:"My Device",icon:Bc,iconColor:"#2563eb"},{id:"url",labelKey:"urlLink",label:"URL link",icon:Nc,iconColor:"#16a34a"},{id:"camera",labelKey:"camera",label:"Camera",icon:Hc,iconColor:"#7c3aed"},{id:"screen-cast",labelKey:"screenCapture",label:"Screen capture",icon:qc,iconColor:"#ea580c"}],gr=class gr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.sources=mt}_handleClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}render(){return f`
  ...
  `;let At=gr;zs([O({attribute:!1})],At.prototype,"t");zs([O({type:Array})],At.prototype,"sources");const Hi={LANGUAGES:"FTYPE_LANGUAGES"};function zd(r,e){if(!r.regional_variants_group_uuid)return;const t=e==null?void 0:e.regionalFilters;return t&&r.regional_variants_group_uuid in t?t[r.regional_variants_group_uuid]:e==null?void 0:e.language}function Dd(r,e,t,i){if(!r.regional_variants_group_uuid||!e)return;const o=e.find(a=>a.uuid===r.regional_variants_group_uuid);if(!o)return;const s=(t==null?void 0:t[o.uuid])??i,n=o.variants.find(a=>a.api_value===s);if(n)return`${o.label}: ${n.label}`}function Vc(r,e){var i;const t={};for(const o of r??[]){if(!((i=o.variants)!=null&&i.length))continue;const s=o.type===Hi.LANGUAGES?Kc(o.variants,e):void 0;t[o.uuid]=s??o.variants[0].api_value}return t}function Kc(r,e){var n;if(!e)return;const t=e.toLowerCase(),i=t.split("-")[0];let o,s;for(const a of r){const l=(n=a.api_value)==null?void 0:n.toLowerCase();if(l){if(l===t)return a.api_value;!o&&l===i&&(o=a.api_value),!s&&l.split("-")[0]===i&&(s=a.api_value)}}return o??s}const Ds=new Set(["asset-attachments","attachments-assets","integer-list"]),Yc=new Set(["face_matcher"]);function jd(r){return Ds.has(r)}function Wc(r){return Ds.has(r.type)||Yc.has(r.ckey)}const rt="product.ref",ot="product.position",Gc="__product__",Xc=new Set([rt,ot]);function Jc(r){return Xc.has(r)}function Zc(r){return r===rt?"ref":r===ot?"position":null}function Qc(r){return[{key:rt,ckey:rt,uuid:"product-ref",title:r("productRefLabel","Product reference"),type:"text",placeholder:r("productRefPlaceholder","e.g. SKU-12345"),required:0,possible_values:[],regional_variants_group_uuid:null,permissions:[]},{key:ot,ckey:ot,uuid:"product-position",title:r("productPositionLabel","Position"),type:"numeric",placeholder:r("productPositionPlaceholder","0"),required:0,possible_values:[],regional_variants_group_uuid:null,permissions:[]}]}function ed(r){return{uuid:Gc,isRoot:!1,name:r("productFieldsLabel","Product"),fields:Qc(r)}}function td(r,e){const t=ed(e);let i=-1;for(let l=0;l<r.groups.length;l++)r.groups[l].isRoot&&(i=l);const o=i+1,s=[...r.groups.slice(0,o),t,...r.groups.slice(o)],n=s.flatMap(l=>l.fields),a=new Map(n.map(l=>[l.key,l]));return{...r,groups:s,fields:n,fieldsByKey:a}}function Md(r,e,t){var o;if((((o=t==null?void 0:t.requiredFields)==null?void 0:o.includes(r.ckey))||!!r.required)&&qi(e))return`${r.title} is required`;if(qi(e))return null;if(r.key===rt)return typeof e!="string"||na.test(e)?"Reference contains invalid characters":null;if(r.key===ot){const s=Number(e);return!Number.isFinite(s)||!Number.isInteger(s)?"Position must be an integer":null}switch(r.type){case"numeric":{const s=Number(e);if(!Number.isFinite(s))return"Must be a valid number";if(!Number.isInteger(s))return"Must be an integer";if(s<-1999999999||s>1999999999)return"Value out of range (±1,999,999,999)";break}case"decimal2":{const s=Number(e);if(!Number.isFinite(s))return"Must be a valid number";if(!/^\-?\d*\.?\d{0,2}$/.test(String(e)))return"Maximum 2 decimal places";if(s<-999999999999e-2||s>999999999999e-2)return"Value out of range (±9,999,999,999.99)";break}case"geopoint":{const s=e,n=s.latitude!==""&&s.latitude!=null,a=s.longitude!==""&&s.longitude!=null;if(n!==a)return"Both latitude and longitude are required";if(n&&a){const l=Number(s.latitude),c=Number(s.longitude);if(!Number.isFinite(l)||l<-90||l>90)return"Latitude must be between -90 and 90";if(!Number.isFinite(c)||c<-180||c>180)return"Longitude must be between -180 and 180"}break}case"attachment-uri":{try{const s=new URL(e);if(!["http:","https:"].includes(s.protocol))return"Only http and https URLs are allowed"}catch{return"Invalid URI"}break}}if(r.validation&&typeof e=="string")try{if(!new RegExp(r.validation).test(e))return"Value does not match expected format"}catch{}return null}function qi(r){return r==null?!0:Array.isArray(r)||typeof r=="string"?r.length===0:typeof r=="object"?!Object.values(r).some(e=>e!=null&&e!==""):!r}const id=new Set(["idle","queued","rejected"]);function dr(r){return!qi(r)}function js(r,e){var t;return Wc(r)?!1:(t=e==null?void 0:e.requiredFields)!=null&&t.includes(r.ckey)?!0:!!r.required}function pr(r){return[...r.values()].filter(e=>id.has(e.status))}function ur(r,e){return r.fields.filter(t=>js(t,e))}function Bd(r,e,t){const i=pr(r);if(i.length===0)return{};const o={};for(const s of ur(e,t)){const n=i.filter(a=>!dr(a.meta[s.key]));n.length>0&&(o[s.key]=n)}return o}function rd(r,e,t){const i=pr(r);if(i.length===0)return null;for(const o of ur(e,t))if(i.some(n=>!dr(n.meta[o.key])))return o.key;return null}function od(r,e,t){var o;const i=r.get(e.id);return i&&i.has(t)?i.get(t):(o=e.meta)==null?void 0:o[t]}function Nd(r,e,t,i){const o=new Set,s=pr(e);if(s.length===0)return o;for(const n of ur(t,i))s.some(l=>!dr(od(r,l,n.key)))&&o.add(n.key);return o}function Hd(r,e){const t={...r};for(const i of Object.keys(e)){const o=e[i];if(o==null||o==="")continue;const s=r[i];if(Array.isArray(o))if(Array.isArray(s)){const n=new Set(s.map(l=>JSON.stringify(l))),a=[...s];for(const l of o){const c=JSON.stringify(l);n.has(c)||(n.add(c),a.push(l))}t[i]=a}else t[i]=o;else t[i]=o}return t}function Ms(r){let e=r;for(;e;){if(e instanceof ShadowRoot){e=e.host;continue}if(e instanceof HTMLDialogElement&&e.open)return e;if(e instanceof Element&&e.shadowRoot){const t=e.shadowRoot.querySelector("dialog[open]");if(t instanceof HTMLDialogElement)return t}e=e.parentNode}return document.body}var sd=Object.defineProperty,de=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&sd(e,t,o),o};const zo=3,Vi=new CSSStyleSheet;Vi.replaceSync(`
...
`);var Pe;const ne=(Pe=class extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.compact=!1,this.externalDragOver=!1,this.accept="",this.multi=!0,this.directory=!1,this.sources=[],this.sourcesLayout="pills",this.mode="modal",this._resizeObserver=null,this._dragOver=!1,this._moreOpen=!1,this._visiblePills=zo,this._dragCounter=0,this._onDragEnter=e=>{e.preventDefault(),this._dragCounter++,this._dragCounter===1&&(this._dragOver=!0)},this._onDragOver=e=>{e.preventDefault()},this._onDragLeave=e=>{e.preventDefault(),this._dragCounter--,this._dragCounter<=0&&(this._dragCounter=0,this._dragOver=!1)},this._onDrop=e=>{e.preventDefault(),e.stopPropagation(),this._dragCounter=0,this._dragOver=!1;const t=e.dataTransfer;t&&Os(t).then(({files:i,hadDirectories:o})=>{i.length>0?this._emitFiles(i,o):o&&this.dispatchEvent(new CustomEvent("folder-empty",{bubbles:!0,composed:!0}))})},this._onClick=e=>{const t=this.shadowRoot.querySelector(".dz-content");if(t&&this._rippleEl){const i=t.getBoundingClientRect();this._rippleEl.style.left=`${e.clientX-i.left}px`,this._rippleEl.style.top=`${e.clientY-i.top}px`,this._rippleEl.classList.remove("go"),this._rippleEl.offsetWidth,this._rippleEl.classList.add("go")}this.browse()},this._onKeyDown=e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.browse())},this._onFileChange=e=>{const t=e.target,i=Array.from(t.files??[]);for(const o of i){const s=o.webkitRelativePath;s&&lr(o,s)}i.length>0&&this._emitFiles(i),t.value=""},this._onPaste=e=>{var o;if(!this.isConnected||this.offsetWidth===0)return;const t=(o=e.clipboardData)==null?void 0:o.items;if(!t)return;const i=[];for(const s of t)if(s.kind==="file"){const n=s.getAsFile();n&&i.push(n)}i.length>0&&(e.preventDefault(),this._emitFiles(i))},this._portalContainer=null,this._onDocClick=e=>{var t;this._moreOpen&&((t=this._portalContainer)!=null&&t.contains(e.target)||(this._moreOpen=!1,this._updateDropdownPortal()))},this._onDocKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._updateDropdownPortal())},this._resizeTimer=null,this._onScrollOrResize=()=>{this._moreOpen&&this._positionDropdown(),this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(()=>this._updateVisiblePills(),100)}}browse(e="files"){var t,i;if(e==="folder"&&this.directory&&this.multi){(t=this.folderInput)==null||t.click();return}(i=this.fileInput)==null||i.click()}_onSourceIconClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}_emitFiles(e,t=!1){this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:e,hadDirectories:t},bubbles:!0,composed:!0}))}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._updateDropdownPortal()}_updateDropdownPortal(){if(this._moreOpen){const e=this.sources.slice(this._visiblePills);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-more-dropdown",""),Ms(this).appendChild(this._portalContainer),this._injectDropdownStyles()),Ee(f`<div class="sfx-more-dropdown open">
  ...
  `;let Ki=mr;var ad=Object.defineProperty,G=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&ad(e,t,o),o};const Yi=new CSSStyleSheet;Yi.replaceSync(`
...
`);const xr=class xr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.files=[],this.showDropTile=!1,this.sources=[],this.accept="",this.multi=!0,this.directory=!1,this.mode="upload",this.showLocateButton=!1,this.showCopyCdnButton=!1,this.showCheckSimilar=!1,this.selectMode=!1,this.selectedIds=new Set,this.allSelected=!1,this.selectionFull=!1,this.maxSelection=0,this.previewOpen=!1,this.searchRunIds=[],this.searchActiveIds=new Set,this.searchResults=new Map,this._moreOpen=!1,this._dropTileMaxVisible=3,this._portalContainer=null,this._outsideClickHandler=e=>{var o;if((o=this._portalContainer)!=null&&o.contains(e.target))return;const t=this.renderRoot.querySelector(".drop-tile-more-wrap"),i=e.composedPath();t&&i.includes(t)||(this._moreOpen=!1,this._closePortal(),document.removeEventListener("click",this._outsideClickHandler,!0))},this._onScrollOrResize=()=>{this._moreOpen&&this._positionPortal()},this._onKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._closePortal(),this._removeGlobalListeners())},this._updateDropTileMaxVisible=()=>{const e=window.innerWidth<=768?1:3;e!==this._dropTileMaxVisible&&(this._dropTileMaxVisible=e)}}_onDropTileClick(){const e=this.renderRoot.querySelector("input[data-sfx-fl-files]");e==null||e.click()}_onDropTileFolderClick(e){e.stopPropagation();const t=this.renderRoot.querySelector("input[data-sfx-fl-folder]");t==null||t.click()}_onFileInput(e){const t=e.target,i=Array.from(t.files??[]);for(const o of i){const s=o.webkitRelativePath;s&&lr(o,s)}i.length>0&&this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:i},bubbles:!0,composed:!0})),t.value=""}_onSourceClick(e,t){if(e.stopPropagation(),t.id==="device"){const i=this.renderRoot.querySelector('input[type="file"]');i==null||i.click();return}this.dispatchEvent(new CustomEvent("source-click",{detail:{source:t},bubbles:!0,composed:!0}))}_addGlobalListeners(){requestAnimationFrame(()=>document.addEventListener("click",this._outsideClickHandler,!0)),document.addEventListener("keydown",this._onKeyDown),window.addEventListener("scroll",this._onScrollOrResize,!0),window.addEventListener("resize",this._onScrollOrResize)}_removeGlobalListeners(){document.removeEventListener("click",this._outsideClickHandler,!0),document.removeEventListener("keydown",this._onKeyDown),window.removeEventListener("scroll",this._onScrollOrResize,!0),window.removeEventListener("resize",this._onScrollOrResize)}updated(e){super.updated(e),e.has("t")&&this._moreOpen&&this._openPortal()}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._moreOpen?(this._openPortal(),this._addGlobalListeners()):(this._closePortal(),this._removeGlobalListeners())}_openPortal(){const e=this.sources.slice(this._dropTileMaxVisible);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-tile-dropdown",""),Ms(this).appendChild(this._portalContainer),this._injectTileDropdownStyles()),Ee(f`<div class="sfx-tile-dropdown">
  ...
  `;let K=xr;G([O({attribute:!1})],K.prototype,"t");G([O({attribute:!1})],K.prototype,"files");G([O({type:Boolean})],K.prototype,"showDropTile");G([O({attribute:!1})],K.prototype,"sources");G([O({type:String})],K.prototype,"accept");G([O({type:Boolean})],K.prototype,"multi");G([O({type:Boolean})],K.prototype,"directory");G([O({type:String})],K.prototype,"mode");G([O({type:Boolean})],K.prototype,"showLocateButton");G([O({type:Boolean})],K.prototype,"showCopyCdnButton");G([O({type:Boolean})],K.prototype,"showCheckSimilar");G([O({type:Boolean})],K.prototype,"selectMode");G([O({attribute:!1})],K.prototype,"selectedIds");G([O({type:Boolean})],K.prototype,"allSelected");G([O({type:Boolean})],K.prototype,"selectionFull");G([O({type:Number})],K.prototype,"maxSelection");G([O({type:Boolean})],K.prototype,"previewOpen");G([O({attribute:!1})],K.prototype,"searchRunIds");G([O({attribute:!1})],K.prototype,"searchActiveIds");G([O({attribute:!1})],K.prototype,"searchResults");G([I()],K.prototype,"_moreOpen");G([I()],K.prototype,"_dropTileMaxVisible");var ld=Object.defineProperty,te=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&ld(e,t,o),o};const vr=class vr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.mode="upload",this.showLocateButton=!1,this.showCopyCdnButton=!1,this.showCheckSimilar=!1,this.selectMode=!1,this.isSelected=!1,this.selectionActive=!1,this.selectionFull=!1,this.previewOpen=!1,this.similarStatus="",this.similarCount=-1,this.similarResults=[],this.reviewPick=!1,this._dims="",this._simPopover=!1,this._simPopLeft=0,this._simPopTop=0,this._simPopTimer=null,this._simHideTimer=null,this._copied=!1,this._copiedTimer=null,this._simPopoverShow=()=>{if(this.previewOpen||!this.similarResults.length||(this._simCancelHide(),this._simPopover))return;const e=this.getBoundingClientRect(),t=240,i=280;let o=e.right+12;o+t>window.innerWidth-8&&(o=e.left-t-12),this._simPopLeft=Math.max(8,o),this._simPopTop=Math.max(8,Math.min(e.top,window.innerHeight-i-8)),this._simPopTimer&&clearTimeout(this._simPopTimer),this._simPopTimer=window.setTimeout(()=>{this.style.zIndex="50",this._simPopover=!0},150)},this._simCancelHide=()=>{this._simHideTimer&&(clearTimeout(this._simHideTimer),this._simHideTimer=null)},this._simScheduleHide=()=>{this._simPopTimer&&(clearTimeout(this._simPopTimer),this._simPopTimer=null),this._simHideTimer&&clearTimeout(this._simHideTimer),this._simHideTimer=window.setTimeout(()=>this._simPopoverClose(),180)},this._simPopoverClose=()=>{this._simPopTimer&&(clearTimeout(this._simPopTimer),this._simPopTimer=null),this._simHideTimer&&(clearTimeout(this._simHideTimer),this._simHideTimer=null),this._simPopover&&(this._simPopover=!1),this.style.zIndex=""}}updated(e){var t,i,o,s,n;if(e.has("file")){if(this._dims="",(i=(t=this.file)==null?void 0:t.previewUrl)!=null&&i.startsWith("blob:")){const a=this.file.previewUrl,l=new Image;l.onload=()=>{var c;((c=this.file)==null?void 0:c.previewUrl)===a&&(this._dims=`${l.naturalWidth}×${l.naturalHeight}`)},l.src=a}else if((n=(s=(o=this.file)==null?void 0:o.response)==null?void 0:s.file)!=null&&n.info){const a=this.file.response.file.info;a.img_w&&a.img_h&&(this._dims=`${a.img_w}×${a.img_h}`)}}}disconnectedCallback(){super.disconnectedCallback(),this._simPopTimer!=null&&(clearTimeout(this._simPopTimer),this._simPopTimer=null),this._simHideTimer!=null&&(clearTimeout(this._simHideTimer),this._simHideTimer=null),this._copiedTimer!=null&&(clearTimeout(this._copiedTimer),this._copiedTimer=null)}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{fileId:this.file.id,...t},bubbles:!0,composed:!0}))}_remove(){this._emit("file-remove")}_retry(){this._emit("file-retry")}_pause(){this._emit("file-pause")}_resume(){this._emit("file-resume")}_rename(e){const t=e.target.value.trim();t&&this._emit("file-rename",{name:t})}_preview(e){e.stopPropagation(),this._emit("file-preview")}_checkSimilarSingle(e){e.stopPropagation(),this.file&&this._emit("check-similar-single",{file:this.file})}_toggleSimilar(e){e.stopPropagation(),!(this.selectionFull&&!this.isSelected)&&this._emit("similar-toggle")}_reviewSelect(){this._emit("similar-results-select",{fileId:this.file.id})}_openResults(e){e.stopPropagation(),this._simPopoverClose(),this._emit("similar-open-results")}_locate(e){e.stopPropagation(),this.file&&this._emit("file-locate",{file:this.file})}async _copyCdn(e){var i,o,s,n;e.stopPropagation();const t=(n=(s=(o=(i=this.file)==null?void 0:i.response)==null?void 0:o.file)==null?void 0:s.url)==null?void 0:n.cdn;if(t){try{await navigator.clipboard.writeText(t)}catch{return}this._emit("file-copy-cdn",{file:this.file,cdnUrl:t}),this._copied=!0,this._copiedTimer&&clearTimeout(this._copiedTimer),this._copiedTimer=window.setTimeout(()=>{this._copied=!1,this._copiedTimer=null},1400)}}render(){var L,k;const e=this.file;if(!e)return S;const t=fe(e),i=e.status==="complete",o=e.status==="uploading",s=e.status==="paused",n=e.status==="error"||e.status==="failed",a=e.status==="rejected",l=this.mode==="review",c=Ac(e.name),d=t==="image"&&!ke(e.type),p=this.selectMode&&d&&!l,u=this.similarCount>=0,m=p&&!u&&this.similarStatus==="",g=!l&&!i&&!o&&!s&&!n&&e.status!=="rejected"&&this.similarStatus!=="searching"&&!this.reviewPick,v=g,$=["tile",i?"done":"",o?"uploading":"",s?"paused":"",a?"rejected":"",l?"review":"",m?"selectable":"",m&&this.isSelected?"selected":"",this.selectionActive&&!d&&!l?"select-dimmed":"",v?"cs-overlay":"",this.similarStatus==="queued"?"sim-queued":"",this.reviewPick?"review-pick":"",this.reviewPick&&this.isSelected?"selected":""].filter(Boolean).join(" ");return f`
      ...
      >
          ...
          ${e.previewUrl?f`<img class="preview-img" src=${e.previewUrl} alt="" />`:f`
                ...
                <div class="type-icon">
                  <img
                    ...
                    src=${Fs(c)}
                    alt="${c?`${c} file`:"File"}"
                    @error=${_=>{const w=_.target,y=Is();!w.dataset.fallback&&w.src!==y&&(w.dataset.fallback="1",w.src=y)}}
                  />
                </div>
              `}
        ...
        <div class="info">
          ...
          <div class="meta">${c||""}${e.size?` · ${Fe(e.size)}`:""}${this._dims?` · ${this._dims}`:""}</div>
        </div>
      </div>
  ...
  `;let X=vr;te([O({attribute:!1})],X.prototype,"t");te([O({attribute:!1})],X.prototype,"file");te([O({type:String})],X.prototype,"mode");te([O({type:Boolean})],X.prototype,"showLocateButton");te([O({type:Boolean})],X.prototype,"showCopyCdnButton");te([O({type:Boolean})],X.prototype,"showCheckSimilar");te([O({type:Boolean})],X.prototype,"selectMode");te([O({type:Boolean})],X.prototype,"isSelected");te([O({type:Boolean})],X.prototype,"selectionActive");te([O({type:Boolean})],X.prototype,"selectionFull");te([O({type:Boolean})],X.prototype,"previewOpen");te([O({type:String})],X.prototype,"similarStatus");te([O({type:Number})],X.prototype,"similarCount");te([O({attribute:!1})],X.prototype,"similarResults");te([O({type:Boolean})],X.prototype,"reviewPick");te([I()],X.prototype,"_dims");te([I()],X.prototype,"_simPopover");te([I()],X.prototype,"_copied");const It=le`
  .btn,
  .btn-ghost,
  .btn-primary,
  .btn-sec,
...
`;var cd=Object.defineProperty,we=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&cd(e,t,o),o};const Do=7,dd=4,br=class br extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.fileCount=0,this.totalSize=0,this.thumbnails=[],this.primaryLabel="Done",this.failedFiles=[],this.alreadyExistedCount=0,this.showMinimize=!1,this._maxThumbs=Do,this._updateMaxThumbs=()=>{const e=window.innerWidth<=768?dd:Do;e!==this._maxThumbs&&(this._maxThumbs=e)}}connectedCallback(){super.connectedCallback(),this._updateMaxThumbs(),window.addEventListener("resize",this._updateMaxThumbs)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._updateMaxThumbs)}_uploadMore(){this.dispatchEvent(new CustomEvent("upload-more",{bubbles:!0,composed:!0}))}_reviewFiles(){this.dispatchEvent(new CustomEvent("review-files",{bubbles:!0,composed:!0}))}_primaryAction(){this.dispatchEvent(new CustomEvent("primary-action",{bubbles:!0,composed:!0}))}_retryFile(e){this.dispatchEvent(new CustomEvent("file-retry",{bubbles:!0,composed:!0,detail:{fileId:e}}))}_retryAll(){this.dispatchEvent(new CustomEvent("retry-all",{bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-uploader",{bubbles:!0,composed:!0}))}_minimize(){this.dispatchEvent(new CustomEvent("minimize-uploader",{bubbles:!0,composed:!0}))}render(){const e=this.thumbnails.slice(0,this._maxThumbs),t=this.thumbnails.length-this._maxThumbs,i=this.fileCount>0,o=this.failedFiles.length>0,s=o&&!i,n=i&&!o&&this.alreadyExistedCount>=this.fileCount,a=this.fileCount-this.alreadyExistedCount;return f`
  ...
  `];let ye=Sr;lt([O({attribute:!1})],ye.prototype,"t");lt([I()],ye.prototype,"_stream");lt([I()],ye.prototype,"_recording");lt([I()],ye.prototype,"_error");lt([I()],ye.prototype,"_recordedBlob");lt([I()],ye.prototype,"_previewUrl");var xd=Object.defineProperty,hr=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&xd(e,t,o),o};const $r=class $r extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.duration=6e3,this._toasts=[],this._nextId=0}show(e,t="error"){const i=++this._nextId;this._toasts=[...this._toasts,{id:i,message:e,type:t,leaving:!1}],setTimeout(()=>this._dismiss(i),this.duration)}_dismiss(e){const t=this._toasts.findIndex(o=>o.id===e);if(t===-1)return;const i=[...this._toasts];i[t]={...i[t],leaving:!0},this._toasts=i,setTimeout(()=>{this._toasts=this._toasts.filter(o=>o.id!==e)},200)}_iconForType(e){return e==="error"?f`<svg class="toast-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
  ...
  `;let st=$r;hr([O({attribute:!1})],st.prototype,"t");hr([O({type:Number})],st.prototype,"duration");hr([I()],st.prototype,"_toasts");customElements.define("sfx-toast",st);var vd=Object.defineProperty,N=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&vd(e,t,o),o};const jo=new Set(["unsplash"]),_e=10,bd=3,yd=["auto","mobile","tablet","desktop","hq","sample"],wd=["hls"],We={isTus:!1,tusUploadUrl:null,relativeFolder:""},Mo=new Set(["complete","failed","error","cancelled","rejected"]);var Y;const B=(Y=class extends oe{constructor(){super(),this.config=null,this._isOpen=!1,this._activeConnector=null,this._showUrlDialog=!1,this._showCameraDialog=!1,this._showScreenCastDialog=!1,this._similarSelectMode=!1,this._similarSelectedIds=new Set,this._similarRunIds=[],this._similarActiveIds=new Set,this._similarResults=new Map,this._previewPanelTab="details",this._similarDismissTimer=null,this._similarAbort=null,this._previewFileId=null,this._previewDims="—",this._fileInfoOpen=!0,this._splitPct=58,this._showSettings=!1,this._setResize=!0,this._setMaxW=2e3,this._setMaxH=2e3,this._setTranscode=!1,this._setResolution="auto",this._setResolutionOpen=!1,this._setProtocol="hls",this._setResumable=!1,this._isResizing=!1,this._splitRafId=0,this._previewDefaultApplied=!1,this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._fsZoom=1,this._fsPanX=0,this._fsPanY=0,this._fsDragging=!1,this._fsDragStartX=0,this._fsDragStartY=0,this._fsPanStartX=0,this._fsPanStartY=0,this._bodyDragOver=!1,this._isMinimized=!1,this._isPillExpanded=!1,this._metadataSchema=null,this._regionalFilters={},this._bulkMetadataOpen=!1,this._bulkMetadataInitialFieldKey=null,this._isReviewing=!1,this._reviewFiles=[],this._hasStoredReview=!1,this._metadataAutocomplete=null,this._taxonomyService=null,this._ultratagsService=null,this._onRegionalChange=e=>{const{groupUuid:t,value:i}=e.detail;t&&(this._regionalFilters={...this._regionalFilters,[t]:i})},this._videoBlobUrls=new Map,this._lastEta=0,this._engine=null,this._cachedSources=mt,this._cachedSourcesConfig=void 0,this._rejectedTimers=new Map,this._closeOnCompleteTimer=null,this._apiBase=null,this._authHeaders=null,this._authResolveId=0,this._prevStoreState=null,this._unsubStoreEvents=null,this._firedFolders=new Set,this._portalContainer=null,this._hostStyleObserver=null,this._onFileRename=e=>{this._onPreviewRename(e.detail.fileId,e.detail.name)},this._onPreviewMetadataBlur=e=>{const t=this._previewFileId;if(!t)return;const{key:i,value:o}=e.detail;if(Jc(i)){const a=Zc(i);if(!a)return;const l=o===""||o==null,c=a==="position"?{position:l?void 0:Number(o)}:{ref:l?void 0:String(o)};this.updateFileProduct(t,c);return}const s=this._store.getState().files.get(t);if(!s)return;const n=new Map(this._store.getState().files);n.set(t,{...s,meta:{...s.meta,[i]:o}}),this._store.setState({files:n})},this._onPreviewTaxonomyEntry=e=>{const t=this._previewFileId;t&&this.updateFileTaxonode(t,e.detail.key,e.detail.entry)},this._floatShownDispatched=!1,this._transformRemoteThumbnail=(e,t)=>{var o;const i=(o=this.config)==null?void 0:o.transformRemoteThumbnail;if(!i)return e;try{return i(e,t)||e}catch(s){return console.warn("[sfx-uploader] transformRemoteThumbnail threw:",s),e}},this._connectorThumbnailTransform=e=>{const t=this._activeConnector;return t?this._transformRemoteThumbnail(e,{source:"connector",providerId:t}):e},this._onFilesSelected=e=>{const{files:t,hadDirectories:i}=e.detail;if(t.length===0&&i){this._showEmptyFolderToast();return}this._processIncomingFiles(t)},this._onFolderEmpty=()=>{this._showEmptyFolderToast()},this._onDropTileSourceClick=e=>{e.stopPropagation(),this._handleSourceActivation(e.detail.source.id)},this._onSourceClick=async e=>{this._handleSourceActivation(e.detail.source)},this._handleSourceActivation=async e=>{var o,s;const t=this._mergedSources.find(n=>n.id===e);if(t!=null&&t.onActivate){try{t.onActivate(this)}catch(n){console.error(`[sfx-uploader] onActivate for custom source "${e}" threw:`,n)}return}if(e==="device"){const n=this.shadowRoot.querySelector("sfx-drop-zone");n==null||n.browse();return}if(e==="url"){this._showUrlDialog=!0;return}if(e==="camera"){this._showCameraDialog=!0;return}if(e==="screen-cast"){this._showScreenCastDialog=!0;return}if((((s=(o=this.config)==null?void 0:o.connectors)==null?void 0:s.providers)??[]).includes(e)){if(jo.has(e)){if(!customElements.get("sfx-search-provider-browser")){const{SfxSearchProviderBrowser:a}=await V(async()=>{const{SfxSearchProviderBrowser:l}=await import("./search-provider-browser-8yrfujNf.js");return{SfxSearchProviderBrowser:l}},[]);customElements.define("sfx-search-provider-browser",a)}}else if(!customElements.get("sfx-provider-browser")){const{SfxProviderBrowser:a}=await V(async()=>{const{SfxProviderBrowser:l}=await import("./provider-browser-wbzslyEl.js");return{SfxProviderBrowser:l}},[]);customElements.define("sfx-provider-browser",a)}this._activeConnector=e}},this._onUrlSubmit=e=>{var p,u,m;this._showUrlDialog=!1;const{url:t,name:i}=e.detail,o=(p=this.config)==null?void 0:p.callbacks,s=To(i),n=s.startsWith("image/");if(Si(i))return;const a=this._store.getState();if([...a.files.values()].some(g=>g.name===i&&g.status!=="rejected"&&g.status!=="cancelled"))return;const c=$i({name:i,size:0,type:s},a.restrictions,a.files);if(c){const g={id:Ye(),status:"rejected",file:null,remoteUrl:t,name:i,size:0,type:s,previewUrl:null,duration:null,progress:0,speed:0,bytesUploaded:0,error:c,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...We};Ve(this._store,g),this._dispatchPublic(M.FILE_REJECTED,{file:g,reason:c}),(u=o==null?void 0:o.onFileRejected)==null||u.call(o,g,c);return}const d={id:Ye(),status:"idle",file:null,remoteUrl:t,name:i,size:0,type:s,previewUrl:n?this._transformRemoteThumbnail(t,{source:"url-import"}):null,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...We};Ve(this._store,d),this._dispatchPublic(M.FILE_ADDED,{file:d}),(m=o==null?void 0:o.onFileAdded)==null||m.call(o,d),this._store.getState().queueConfig.autoProceed&&this.upload()},this._onUrlCancel=()=>{this._showUrlDialog=!1},this._onCameraCapture=e=>{this._showCameraDialog=!1,this._processIncomingFiles([e.detail.file])},this._onCameraCancel=()=>{this._showCameraDialog=!1},this._onScreenCastCapture=e=>{this._showScreenCastDialog=!1,this._processIncomingFiles([e.detail.file])},this._onScreenCastCancel=()=>{this._showScreenCastDialog=!1},this._onFileRemove=e=>{this._removeFile(e.detail.fileId)},this._onFilePreview=e=>{var i,o,s;const t=this._store.getState().files.get(e.detail.fileId);t&&(this._previewFileId=t.id,this._showSettings=!1,this._previewPanelTab="details",this._dispatchPublic(M.FILE_PREVIEW,{file:t}),(s=(o=(i=this.config)==null?void 0:i.callbacks)==null?void 0:o.onFilePreview)==null||s.call(o,t))},this._onFillMetadata=()=>{var t,i,o,s;const e=[...this._store.getState().files.values()].filter(n=>Y._MODIFIABLE_STATUSES.has(n.status));(t=this.config)!=null&&t.metadataConfig&&this._metadataSchema&&(this._bulkMetadataInitialFieldKey=this._firstMissingRequiredFieldKey(),this._bulkMetadataOpen=!0),this._dispatchPublic(M.FILL_METADATA,{files:e}),(s=(o=(i=this.config)==null?void 0:i.callbacks)==null?void 0:o.onFillMetadata)==null||s.call(o,e)},this._onCheckSimilarEnter=()=>{this._similarSelectedIds=new Set,this._similarSelectMode=!0},this._onCheckSimilarCancel=()=>{this._similarSelectMode=!1,this._similarSelectedIds=new Set},this._onSimilarToggle=e=>{const t=e.detail.fileId,i=new Set(this._similarSelectedIds);if(i.has(t))i.delete(t);else{if(i.size>=_e)return;i.add(t)}this._similarSelectedIds=i},this._onSimilarSelectAll=e=>{this._similarSelectedIds=e.detail.selected?new Set(this._similarUncheckedFiles().slice(0,_e).map(t=>t.id)):new Set},this._onCheckSimilarRun=()=>{const e=this._similarImageFiles().filter(t=>this._similarSelectedIds.has(t.id));e.length&&(this._runSimilarityCheck(e),this._similarSelectMode=!1,this._similarSelectedIds=new Set)},this._onCheckSimilarSingle=e=>{const t=e.detail.file;t&&this._checkSimilarSingleFile(t)},this._onSimilarSearchCancel=()=>{this._clearSimilarRun()},this._onSimilarOpenResults=e=>{this._previewFileId=e.detail.fileId,this._showSettings=!1,this._previewPanelTab="similar"},this._onRequireMetadata=()=>{const e=this._storeCtrl.state.t;this._showToast(e("fillRequiredFieldsFirst","Please fill required fields first."),"warning"),this._onFillMetadata()},this._onFileLocate=e=>{this._locateFile(e.detail.file)},this._onFileCopyCdn=e=>{var o,s,n;const t=e.detail.file,i=e.detail.cdnUrl;!t||!i||(this._dispatchPublic(M.FILE_COPY_CDN,{file:t,cdnUrl:i}),(n=(s=(o=this.config)==null?void 0:o.callbacks)==null?void 0:s.onFileCopyCdn)==null||n.call(s,t,i))},this._onBulkMetadataSaveBatch=e=>{const{changes:t}=e.detail;if(!t.length)return;const i=new Map(this._store.getState().files);for(const{fileId:o,meta:s}of t){const n=i.get(o);n&&i.set(o,{...n,meta:{...n.meta,...s}})}this._store.setState({files:i})},this._onBulkProductSaveBatch=e=>{const{changes:t}=e.detail;t.length&&this.updateFilesProduct(t)},this._onBulkTaxonomySaveBatch=e=>{const{changes:t}=e.detail;if(!t.length)return;const i=this._store.getState().files,o=new Map(i);for(const{fileId:s,taxonodes:n}of t){const a=i.get(s);if(!a||!Y._MODIFIABLE_STATUSES.has(a.status))continue;const l={...a.taxonodes??{}};for(const[c,d]of Object.entries(n))d==null?delete l[c]:l[c]=d;o.set(s,{...a,taxonodes:l})}this._store.setState({files:o})},this._onBulkMetadataClose=()=>{this._bulkMetadataOpen=!1,this._bulkMetadataInitialFieldKey=null},this._onFileRetry=e=>{var t;this._ensureEngine(),(t=this._engine)==null||t.retryFile(e.detail.fileId)},this._onFilePause=e=>{var t;(t=this._engine)==null||t.pauseFile(e.detail.fileId)},this._onFileResume=e=>{var t;(t=this._engine)==null||t.resumeFile(e.detail.fileId)},this._onRetryAll=()=>{var e;this._ensureEngine(),(e=this._engine)==null||e.retryAll()},this._onClearAll=()=>{var i,o,s;const e=(i=this.config)==null?void 0:i.callbacks;this._clearSimilarRun(),this._similarResults=new Map,this._previewPanelTab="details",this._similarSelectMode=!1,this._similarSelectedIds=new Set,this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),(o=this._engine)==null||o.cancelAll();const t=[...this._store.getState().files.values()];for(const n of t)n.previewUrl&&URL.revokeObjectURL(n.previewUrl),this._dispatchPublic(M.FILE_REMOVED,{file:n}),(s=e==null?void 0:e.onFileRemoved)==null||s.call(e,n);this._revokeVideoBlobUrls();for(const n of this._rejectedTimers.values())clearTimeout(n);this._rejectedTimers.clear(),this._dimCache.clear(),this._previewFileId=null,this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._lastEta=0,this._firedFolders.clear(),this._store.setState({files:new Map,isUploading:!1,totalProgress:0,totalSpeed:0,totalBytesUploaded:0,totalBytes:0})},this._onAddMore=()=>{var o;const e=this.shadowRoot.querySelector("sfx-drop-zone");if(e){e.browse();return}const t=this.shadowRoot.querySelector("sfx-file-list"),i=(o=t==null?void 0:t.shadowRoot)==null?void 0:o.querySelector('input[type="file"]');i==null||i.click()},this._onUploadStart=()=>{var e;if(this._phase==="complete"){((e=this.config)==null?void 0:e.clearOnComplete)!==!1&&this._onClearAll();return}this._hasUnfilledRequiredMetadata||this.upload()},this._onUploadMore=()=>{this._onClearAll()},this._onEnterReview=()=>{const e=[...this._store.getState().files.values()].filter(o=>o.status==="complete"||o.status==="failed"||o.status==="error");if(e.length>0){this._reviewFiles=[...e].reverse(),this._isReviewing=!0;return}const t=this._lastUploadId;if(t==null)return;const i=ut.load(t);!i||i.length===0||(this._reviewFiles=[...i].reverse(),this._isReviewing=!0)},this._onExitReview=()=>{this._isReviewing=!1,this._reviewFiles=[]},this._onClearReview=()=>{const e=this._lastUploadId;e!=null&&ut.clear(e),this._isReviewing=!1,this._reviewFiles=[],this._hasStoredReview=!1},this._onConnectorFilesSelected=e=>{var o,s,n,a;const t=(o=this.config)==null?void 0:o.callbacks,i=((s=this.config)==null?void 0:s.preserveFolderStructure)!==!1;for(const l of e.detail.files){if(Si(l.name))continue;const c=i?l.relativeFolder??"":"",d=this._store.getState();if([...d.files.values()].some(v=>v.name===l.name&&v.size===l.size&&v.relativeFolder===c&&v.status!=="rejected"&&v.status!=="cancelled"))continue;const u=l.thumbnail?this._transformRemoteThumbnail(l.thumbnail,{source:"connector",providerId:l.provider}):null,m=$i({name:l.name,size:l.size,type:l.mimeType},d.restrictions,d.files);if(m){const v={id:Ye(),status:"rejected",file:null,remoteUrl:null,name:l.name,size:l.size,type:l.mimeType,previewUrl:u,duration:null,progress:0,speed:0,bytesUploaded:0,error:m,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:l,...We,relativeFolder:c};Ve(this._store,v),this._dispatchPublic(M.FILE_REJECTED,{file:v,reason:m}),(n=t==null?void 0:t.onFileRejected)==null||n.call(t,v,m);continue}const g={id:Ye(),status:"idle",file:null,remoteUrl:null,name:l.name,size:l.size,type:l.mimeType,previewUrl:u,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:l,...We,relativeFolder:c};Ve(this._store,g),this._dispatchPublic(M.FILE_ADDED,{file:g}),(a=t==null?void 0:t.onFileAdded)==null||a.call(t,g)}this._activeConnector=null,this._store.getState().queueConfig.autoProceed&&this.upload()},this._onConnectorClose=()=>{this._activeConnector=null},this._onConnectorBackdropClick=e=>{e.target===e.currentTarget&&(this._activeConnector=null)},this._onPrimaryAction=()=>{var t,i,o,s,n;this._dispatchPublic(M.COMPLETE_ACTION,{}),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCompleteAction)==null||o.call(i),(((s=this.config)==null?void 0:s.mode)??"modal")==="modal"?this.close():((n=this.config)==null?void 0:n.clearOnComplete)!==!1&&this._onClearAll()},this._onInlineDismiss=()=>{var e,t,i;(i=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onCancel)==null||i.call(t),this._dispatchPublic(M.CANCEL,{})},this._onSuccessCardClose=()=>{var e,t,i,o;((e=this.config)==null?void 0:e.mode)==="inline"?(this._dispatchPublic(M.COMPLETE_ACTION,{}),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCompleteAction)==null||o.call(i),this._onClearAll()):this._onModalDismiss()},this._onModalDismiss=()=>{var e,t,i,o;this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll()),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{}),this.close()},this._onCancelUpload=()=>{var e,t,i,o;(e=this._engine)==null||e.cancelAll(),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{}),this._onClearAll()},this._onMinimize=()=>{var e,t,i;this._isMinimized||(this._isMinimized=!0,this._isPillExpanded=!0,(i=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onMinimize)==null||i.call(t),this._dispatchFloatGeometryEvent(M.MINIMIZE),this.requestUpdate())},this._onPillClick=()=>{this._isPillExpanded=!this._isPillExpanded,this.requestUpdate()},this._onPillExpand=()=>{var e,t,i;this._isMinimized&&(this._isMinimized=!1,this._isPillExpanded=!1,this._isOpen=!0,(i=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onRestore)==null||i.call(t),this._dispatchPublic(M.RESTORE,{mode:"modal"}),this.requestUpdate())},this._onPillDismiss=()=>{var e,t,i,o;this._isMinimized=!1,this._isPillExpanded=!1,this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll(),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{})),this.close()},this._onModalBackdropClick=e=>{e.target===e.currentTarget&&this._onModalDismiss()},this._bodyLeaveTimer=null,this._onBodyDragEnter=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!0},this._onBodyDragOver=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!0},this._onBodyDragLeave=e=>{e.preventDefault(),this._bodyLeaveTimer&&clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=setTimeout(()=>{this._bodyDragOver=!1,this._bodyLeaveTimer=null},80)},this._onBodyDrop=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!1;const t=e.dataTransfer;t&&Os(t).then(({files:i,hadDirectories:o})=>{if(i.length===0){o&&this._showEmptyFolderToast();return}this._onFilesSelected(new CustomEvent("files-selected",{detail:{files:i,hadDirectories:o}}))})},this._onKeyDown=e=>{var t,i;if(e.key==="Escape"){if(this._fullscreenPreviewUrl||this._fullscreenVideoFile){this._onFsClose();return}if(this._bulkMetadataOpen||this._isMinimized)return;const o=((t=this.config)==null?void 0:t.mode)??"modal",s=((i=this.config)==null?void 0:i.header)??(o==="modal"?"close":!0);(s==="close"||s==="back")&&(o==="modal"&&this._isOpen?this._onModalDismiss():o==="inline"&&this._onInlineDismiss())}},this._dimCache=new Map,this._onSplitPointerDown=e=>{var i;e.preventDefault(),this._isResizing=!0;const t=(i=this.shadowRoot)==null?void 0:i.querySelector(".preview-layout");t==null||t.classList.add("resizing"),e.target.setPointerCapture(e.pointerId)},this._onSplitPointerMove=e=>{if(!this._isResizing||this._splitRafId)return;const t=e.clientX;this._splitRafId=requestAnimationFrame(()=>{var n;this._splitRafId=0;const i=(n=this.shadowRoot)==null?void 0:n.querySelector(".preview-layout");if(!i)return;const o=i.getBoundingClientRect(),s=(t-o.left)/o.width*100;this._splitPct=Math.max(25,Math.min(75,s))})},this._onSplitPointerUp=()=>{var t;this._isResizing=!1,this._splitRafId&&(cancelAnimationFrame(this._splitRafId),this._splitRafId=0);const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".preview-layout");e==null||e.classList.remove("resizing")},this._onFsToggleZoom=e=>{e==null||e.stopPropagation();const t=Y._FS_ZOOM_LEVELS,i=t.indexOf(this._fsZoom),o=i===-1?1:(i+1)%t.length;this._fsZoom=t[o],this._fsZoom===1&&(this._fsPanX=0,this._fsPanY=0)},this._onFsOverlayClick=e=>{this._fsDragDidMove||this._onFsToggleZoom(e)},this._fsDragDidMove=!1,this._onFsPanStart=e=>{this._fsZoom<=1||(this._fsDragging=!0,this._fsDragDidMove=!1,this._fsDragStartX=e.clientX,this._fsDragStartY=e.clientY,this._fsPanStartX=this._fsPanX,this._fsPanStartY=this._fsPanY,e.preventDefault())},this._onFsPanMove=e=>{if(!this._fsDragging)return;const t=e.clientX-this._fsDragStartX,i=e.clientY-this._fsDragStartY;(Math.abs(t)>3||Math.abs(i)>3)&&(this._fsDragDidMove=!0),this._fsPanX=this._fsPanStartX+t,this._fsPanY=this._fsPanStartY+i,this.requestUpdate()},this._onFsPanEnd=()=>{this._fsDragging=!1,requestAnimationFrame(()=>{this._fsDragDidMove=!1})},this._onFsTouchStart=e=>{if(this._fsZoom<=1||e.touches.length!==1)return;const t=e.touches[0];this._fsDragging=!0,this._fsDragDidMove=!1,this._fsDragStartX=t.clientX,this._fsDragStartY=t.clientY,this._fsPanStartX=this._fsPanX,this._fsPanStartY=this._fsPanY},this._onFsTouchMove=e=>{if(!this._fsDragging||e.touches.length!==1)return;const t=e.touches[0],i=t.clientX-this._fsDragStartX,o=t.clientY-this._fsDragStartY;(Math.abs(i)>3||Math.abs(o)>3)&&(this._fsDragDidMove=!0),this._fsPanX=this._fsPanStartX+i,this._fsPanY=this._fsPanStartY+o,this.requestUpdate(),e.preventDefault()},this._onFsClose=e=>{e==null||e.stopPropagation(),this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._fsZoom=1,this._fsPanX=0,this._fsPanY=0},this._store=ia(),this._storeCtrl=new ra(this,this._store)}get _lastUploadId(){var i,o;const e=(i=this.config)==null?void 0:i.lastUploadReview;if(!e)return null;if(typeof e=="string")return e;const t=(o=this.config)==null?void 0:o.auth;return t?t.airboxPuid?`${t.container}:${t.airboxPuid}`:t.container:null}get _metadataDefaultLanguage(){var i,o;const e=(i=this._metadataSchema)==null?void 0:i.regionalVariantsGroups;if(!e)return;const t=e.find(s=>s.type===Hi.LANGUAGES);return((o=t==null?void 0:t.variants.find(Boolean))==null?void 0:o.api_value)||void 0}get _effectiveRegionalFilters(){var t,i,o,s;const e=((i=(t=this.config)==null?void 0:t.metadataConfig)==null?void 0:i.language)??((o=this.config)==null?void 0:o.locale)??void 0;return{...Vc((s=this._metadataSchema)==null?void 0:s.regionalVariantsGroups,e),...this._regionalFilters}}get _activeLanguage(){var o,s,n;const t=(((o=this._metadataSchema)==null?void 0:o.regionalVariantsGroups)??[]).find(a=>a.type===Hi.LANGUAGES),i=this._effectiveRegionalFilters;return(t?i[t.uuid]:void 0)??((n=(s=this.config)==null?void 0:s.metadataConfig)==null?void 0:n.language)}get _effectiveMetadataConfig(){var o;const e=(o=this.config)==null?void 0:o.metadataConfig;if(!e)return null;const t={...e.regionalFilters??{},...this._effectiveRegionalFilters},i=this._activeLanguage??e.language;return{...e,regionalFilters:t,language:i}}open(){var t,i,o,s,n,a,l,c,d;const e=this._isMinimized;if(this._isMinimized&&(this._isMinimized=!1,this._isPillExpanded=!1),this._isOpen){e&&((o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onRestore)==null||o.call(i),this._dispatchPublic(M.RESTORE,{mode:"modal"}),this.requestUpdate());return}this._isOpen=!0,(a=(n=(s=this.config)==null?void 0:s.callbacks)==null?void 0:n.onOpen)==null||a.call(n),this._dispatchPublic(M.OPEN,{}),e&&((d=(c=(l=this.config)==null?void 0:l.callbacks)==null?void 0:c.onRestore)==null||d.call(c),this._dispatchPublic(M.RESTORE,{mode:"modal"})),this.requestUpdate()}close(){this._isOpen&&(this._isOpen=!1,this._runCloseCleanup())}getStatus(){return this._phase}dismissPanel(){var e,t,i,o;this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll(),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{})),this._isMinimized=!1,this._isPillExpanded=!1,this._isOpen=!1,this._runCloseCleanup()}_runCloseCleanup(){var e,t,i,o;this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),((e=this.config)==null?void 0:e.clearOnClose)!==!1&&this._onClearAll(),this._previewFileId=null,this._bulkMetadataOpen=!1,this._bulkMetadataInitialFieldKey=null,(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onClose)==null||o.call(i),this._dispatchPublic(M.CLOSE,{}),this.requestUpdate()}upload(){var o,s,n,a,l,c,d,p,u,m;if(this._ensureEngine(),!this._engine){console.warn("[sfx-uploader] Cannot upload: auth not resolved yet");return}const e=[...this._store.getState().files.values()].filter(g=>g.status==="idle"||g.status==="queued");if((s=(o=this.config)==null?void 0:o.callbacks)!=null&&s.onBeforeUpload&&this.config.callbacks.onBeforeUpload(e)===!1)return;const t=new CustomEvent(M.BEFORE_UPLOAD,{bubbles:!0,composed:!0,cancelable:!0,detail:{files:e}});this.dispatchEvent(t)&&(this._dispatchPublic(M.UPLOAD_STARTED,{files:e}),(l=(a=(n=this.config)==null?void 0:n.callbacks)==null?void 0:a.onUploadStarted)==null||l.call(a,e),this._engine.uploadAll(),(c=this.config)!=null&&c.minimizeOnUpload&&((d=this.config)==null?void 0:d.mode)!=="inline"&&!this._isMinimized&&(this._isMinimized=!0,this._isPillExpanded=!0,(m=(u=(p=this.config)==null?void 0:p.callbacks)==null?void 0:u.onMinimize)==null||m.call(u),this._dispatchFloatGeometryEvent(M.MINIMIZE),this.requestUpdate()))}addFiles(e){this._processIncomingFiles(e)}resumeUpload(e){var t;if(e&&e.length>0){const i=this._store.getState().files,o=new Map(i);let s=!1;for(const n of e){const a=i.get(n.id);a&&(o.set(n.id,{...a,...n}),s=!0)}s&&this._store.setState({files:o})}this._ensureEngine(),(t=this._engine)==null||t.uploadAll()}cancelUpload(){var e;(e=this._engine)==null||e.cancelAll()}pauseFile(e){var t;(t=this._engine)==null||t.pauseFile(e)}resumeFile(e){var t;(t=this._engine)==null||t.resumeFile(e)}getFiles(){return[...this._store.getState().files.values()]}getFile(e){return this._store.getState().files.get(e)}updateFileMeta(e,t,i){const o=this._store.getState().files,s=o.get(e);if(!s||!Y._MODIFIABLE_STATUSES.has(s.status))return;const n=new Map(o);n.set(e,{...s,meta:t!=null?{...s.meta,...t}:s.meta,tags:i??s.tags}),this._store.setState({files:n})}updateFilesMeta(e){const t=this._store.getState().files,i=new Map(t);let o=!1;for(const{fileId:s,meta:n,tags:a}of e){const l=t.get(s);!l||!Y._MODIFIABLE_STATUSES.has(l.status)||(i.set(s,{...l,meta:n!=null?{...l.meta,...n}:l.meta,tags:a??l.tags}),o=!0)}o&&this._store.setState({files:i})}updateFileTaxonode(e,t,i){const o=this._store.getState().files,s=o.get(e);if(!s||!Y._MODIFIABLE_STATUSES.has(s.status))return;const n={...s.taxonodes??{}};i==null?delete n[t]:n[t]=i;const a=new Map(o);a.set(e,{...s,taxonodes:n}),this._store.setState({files:a})}updateFilesTaxonode(e,t,i){const o=this._store.getState().files,s=new Map(o);let n=!1;for(const a of e){const l=o.get(a);if(!l||!Y._MODIFIABLE_STATUSES.has(l.status))continue;const c={...l.taxonodes??{}};i==null?delete c[t]:c[t]=i,s.set(a,{...l,taxonodes:c}),n=!0}n&&this._store.setState({files:s})}updateFileProduct(e,t){const i=this._store.getState().files,o=i.get(e);if(!o||!Y._MODIFIABLE_STATUSES.has(o.status))return;const s=new Map(i);s.set(e,{...o,product:ro(o.product,t)}),this._store.setState({files:s})}updateFilesProduct(e){const t=this._store.getState().files,i=new Map(t);let o=!1;for(const{fileId:s,product:n}of e){const a=t.get(s);!a||!Y._MODIFIABLE_STATUSES.has(a.status)||(i.set(s,{...a,product:ro(a.product,n)}),o=!0)}o&&this._store.setState({files:i})}willUpdate(e){if(e.has("config")&&this.config){this._applyConfig(this.config);const t=this.config.uploadSettings;!(t!==!1&&(t==null||t.enabled!==!1))&&this._showSettings&&(this._showSettings=!1)}if(e.has("_previewFileId")&&this._previewFileId){const t=this._previewFileId,i=this._store.getState().files.get(t);i?this._getImageDimensions(i).then(o=>{this._previewFileId===t&&(this._previewDims=o?`${o.w} × ${o.h}`:"—")}):this._previewDims="—"}this._previewFileId?this._previewDefaultApplied||(this._splitPct=62.5,this._previewDefaultApplied=!0):this._previewDefaultApplied&&(this._previewDefaultApplied=!1)}updated(e){this._updateFloatingPortal()}_injectFloatStyles(){if(document.querySelector("style[data-sfx-upload-float-styles]"))return;const e=document.createElement("style");e.setAttribute("data-sfx-upload-float-styles",""),e.textContent=`
    ...
    `,document.head.appendChild(e)}_updateFloatingPortal(){const e=[...this._storeCtrl.state.files.values()];if(this._isMinimized&&e.length>0){this._injectFloatStyles();const t=!this._portalContainer;this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-upload-float",""),document.body.appendChild(this._portalContainer)),this._syncPortalOffsetVars(),Ee(this._renderFloatingPill(e),this._portalContainer),t&&!this._floatShownDispatched&&(this._floatShownDispatched=!0,requestAnimationFrame(()=>{this._dispatchPublic(M.PANEL_SHOWN,this._measureFloatGeometry())}))}else this._portalContainer&&(Ee(S,this._portalContainer),this._portalContainer.remove(),this._portalContainer=null,this._floatShownDispatched=!1)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onKeyDown),this._prevStoreState=this._store.getState(),this._unsubStoreEvents=this._store.subscribe(()=>this._onStoreChange());const e=this._lastUploadId;this._hasStoredReview=e!=null&&ut.exists(e),this._initI18n(typeof navigator<"u"?navigator.language:void 0),typeof MutationObserver<"u"&&(this._hostStyleObserver=new MutationObserver(()=>this._syncPortalOffsetVars()),this._hostStyleObserver.observe(this,{attributes:!0,attributeFilter:["style"]}))}async _initI18n(e){try{const{i18n:t,isNew:i}=await Nn(e||"en");i&&t.on("missingKey",(s,n,a,l,c,d)=>{const p=a.match(/_(?:zero|one|two|few|many|other)$/),u=p&&(d!=null&&d[`defaultValue${p[0]}`])?String(d[`defaultValue${p[0]}`]):l;Vn.handleMissingKey(a,u,n)});const o=(s,n,a)=>typeof n=="string"?t.t(s,n,a??{}):t.t(s,n??{});this._store.setState({t:o})}catch{}}disconnectedCallback(){var e,t,i,o,s;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._hostStyleObserver)==null||e.disconnect(),this._hostStyleObserver=null,(t=this._unsubStoreEvents)==null||t.call(this),this._unsubStoreEvents=null,this._prevStoreState=null,(i=this._portalContainer)==null||i.remove(),this._portalContainer=null,document.querySelector("[data-sfx-upload-float]")||(o=document.querySelector("style[data-sfx-upload-float-styles]"))==null||o.remove(),this._revokeVideoBlobUrls();for(const n of this._rejectedTimers.values())clearTimeout(n);this._rejectedTimers.clear(),this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),this._clearSimilarRun();for(const n of this._store.getState().files.values())n.previewUrl&&URL.revokeObjectURL(n.previewUrl);(s=this._engine)==null||s.destroy(),this._engine=null}_applyConfig(e){const t={};if(e.locale&&this._initI18n(e.locale),e.targetFolder&&(t.targetFolder=e.targetFolder),(e.restrictions||e.forceName!=null)&&(t.restrictions={...this._store.getState().restrictions,...e.restrictions},e.forceName!=null&&(t.restrictions.maxNumberOfFiles=1)),e.concurrency!=null){const s=this._store.getState().queueConfig;t.queueConfig={...s,concurrency:e.concurrency}}if(e.autoProceed!=null){const s=t.queueConfig??this._store.getState().queueConfig;t.queueConfig={...s,autoProceed:e.autoProceed}}Object.keys(t).length>0&&this._store.setState(t);const i=e.uploadSettings;if(i&&i.defaults){const s=i.defaults;s.resize!==void 0&&(this._setResize=s.resize),s.maxWidth!==void 0&&(this._setMaxW=s.maxWidth),s.maxHeight!==void 0&&(this._setMaxH=s.maxHeight),s.transcode!==void 0&&(this._setTranscode=s.transcode),s.resolution!==void 0&&(this._setResolution=s.resolution),s.protocol!==void 0&&(this._setProtocol=s.protocol),s.resumable!==void 0&&(this._setResumable=s.resumable)}const o=this._lastUploadId;this._hasStoredReview=o!=null&&ut.exists(o),this._resolveAuthAndEngine(e),(e.mode==="inline"||!e.mode)&&(this._isOpen=!0)}async _resolveAuthAndEngine(e){var o,s,n,a;const t=e.auth;if(t.mode==="sass-key"){this._apiBase=cr(t.container),this._authHeaders=Mi(t),this._ensureEngine(),(s=this._engine)==null||s.updateConfig({apiBase:this._apiBase,authHeaders:this._authHeaders,tusConfig:this._normalizeTusConfig(),companionUrl:(o=e.connectors)==null?void 0:o.companionUrl,resolveUploadParams:this._buildUploadParamsResolver()}),this._preloadMetadataSchema(e);return}const i=++this._authResolveId;try{const l=await yc(t);if(i!==this._authResolveId)return;this._apiBase=l.apiBase,this._authHeaders=l.headers,this._ensureEngine(),(a=this._engine)==null||a.updateConfig({apiBase:this._apiBase,authHeaders:this._authHeaders,tusConfig:this._normalizeTusConfig(),companionUrl:(n=e.connectors)==null?void 0:n.companionUrl,resolveUploadParams:this._buildUploadParamsResolver()}),this._preloadMetadataSchema(e)}catch(l){if(i!==this._authResolveId)return;console.error("[sfx-uploader] Auth resolution failed:",l),this._showToast(this._formatAuthError(l))}}_formatAuthError(e){var i,o;const t=e instanceof Error?e.message:String(e);return(o=(i=this.config)==null?void 0:i.auth)!=null&&o.container?t.includes("HTTP 404")?`Authentication failed: container "${this.config.auth.container}" not found. Check your container name.`:t.includes("HTTP 401")||t.includes("HTTP 403")?"Authentication failed: invalid security template ID. Check your credentials in the Auth panel.":t.includes("timed out")?"Authentication failed: request timed out. Check your network connection.":t.includes("Failed to fetch")||t.includes("NetworkError")?"Authentication failed: network error. Check your internet connection.":`Authentication failed: ${t}`:"Authentication failed: no container specified. Open the Auth panel and enter your credentials."}_showToast(e,t="error"){var o;const i=(o=this.shadowRoot)==null?void 0:o.querySelector("sfx-toast");i==null||i.show(e,t)}_normalizeTusConfig(){var a,l,c,d;const e=(a=this.config)==null?void 0:a.uploadSettings,t=!!e&&e.showResumableSwitcher===!0,i=(l=this.config)==null?void 0:l.tusConfig;let o=i===!0?{}:i||void 0;if(t){if(!this._setResumable)return;o||(o={})}if(!o)return;const s=(d=(c=this.config)==null?void 0:c.connectors)==null?void 0:d.companionUrl;if(!s)return o;const n=s.replace(/\/+$/,"");return{...o,endpoint:o.endpoint??`${n}/files`,jsonBase:o.jsonBase??`${n}/json`}}get _remainingSlots(){const e=this._storeCtrl.state.restrictions.maxNumberOfFiles;if(e==null)return null;let t=0;for(const i of this._storeCtrl.state.files.values())i.status!=="rejected"&&i.status!=="cancelled"&&t++;return Math.max(0,e-t)}get _allowMulti(){var t;if(((t=this.config)==null?void 0:t.forceName)!=null)return!1;const e=this._remainingSlots;return e===null||e>1}get _allowFolderUpload(){var e;return((e=this.config)==null?void 0:e.preserveFolderStructure)===!1?!1:this._allowMulti}_buildUploadParamsResolver(){const e=this.config;if(!e)return;const{forceName:t,getUploadParams:i}=e;return o=>{const s={},n=fe(o);if(this._setResize&&(n==="image"||n==="pdf")&&this._setMaxW>0&&this._setMaxH>0&&(s.resize=`${this._setMaxW},${this._setMaxH}`),this._setTranscode&&n==="vid"&&(s.postprocess="transcode",s["video-resolution"]=this._setResolution,s.video_protocols=this._setProtocol),t!=null){const l=typeof t=="function"?t():t;l&&(s.opt_force_name=l)}const a=i==null?void 0:i(o);return a&&Object.assign(s,a),Object.keys(s).length>0?s:void 0}}_ensureEngine(){var e,t;!this._engine&&this._apiBase&&this._authHeaders&&(this._engine=new vc(this._store,{apiBase:this._apiBase,authHeaders:this._authHeaders,tusConfig:this._normalizeTusConfig(),companionUrl:(t=(e=this.config)==null?void 0:e.connectors)==null?void 0:t.companionUrl,resolveUploadParams:this._buildUploadParamsResolver(),transformPreviewUrl:i=>this._transformRemoteThumbnail(i,{source:"cdn-complete"})}),this._engine.start())}async _preloadMetadataSchema(e){const t=e.metadataConfig;if(!(!t||!this._apiBase||!this._authHeaders))try{const{fetchMetadataSchema:i,createTagsAutocomplete:o,createTaxonomyService:s,createUltratagsService:n}=await V(async()=>{const{fetchMetadataSchema:c,createTagsAutocomplete:d,createTaxonomyService:p,createUltratagsService:u}=await import("./index-jNPLJlZs.js");return{fetchMetadataSchema:c,createTagsAutocomplete:d,createTaxonomyService:p,createUltratagsService:u}},[]),a=await i(this._apiBase,this._authHeaders,t.projectUuid,t);this._metadataAutocomplete=o(this._apiBase,this._authHeaders),this._taxonomyService=s(this._apiBase,this._authHeaders),this._ultratagsService=n(this._apiBase,this._authHeaders),this._metadataSchema=a.productsEnabled?td(a,this._storeCtrl.state.t):a;const l=this._metadataSchema.fields.filter(c=>js(c,t)).map(c=>c.key);this._dispatchPublic(M.METADATA_SCHEMA,{schema:this._metadataSchema,requiredFieldKeys:l})}catch(i){console.error("[sfx-uploader] Failed to load metadata schema:",i),this._showToast("Failed to load metadata schema","warning")}}_onPreviewRename(e,t){const i=t.trim();if(!i)return;const o=this._store.getState().files.get(e);if(!o||o.name===i)return;const s=new Map(this._store.getState().files);s.set(e,{...o,name:i}),this._store.setState({files:s})}_previewMeta(e){var t;return(t=this._metadataSchema)!=null&&t.productsEnabled?{...e.meta,[rt]:e.product.ref,[ot]:e.product.position}:e.meta}get _metadataEnforcing(){var t;const e=(t=this.config)==null?void 0:t.metadataConfig;return!e||!this._metadataSchema||e.enforceRequiredBeforeUpload===!1?!1:e.enforceRequiredBeforeUpload===!0||this._metadataSchema.forceFillingOnUpload||e.requiredFields&&e.requiredFields.length>0?!0:this._metadataSchema.fields.some(i=>!!i.required)}_firstMissingRequiredFieldKey(){var e;return!this._metadataEnforcing||!this._metadataSchema?null:rd(this._store.getState().files,this._metadataSchema,(e=this.config)==null?void 0:e.metadataConfig)}get _hasUnfilledRequiredMetadata(){return this._firstMissingRequiredFieldKey()!=null}_dispatchPublic(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}_measureFloatGeometry(){var o;const e=this._isPillExpanded?"card":"pill",t=(o=this._portalContainer)==null?void 0:o.querySelector(".upload-float");if(!t)return{width:0,height:0,mode:e};const i=t.getBoundingClientRect();return{width:i.width,height:i.height,mode:e}}_dispatchFloatGeometryEvent(e){this.updateComplete.then(()=>{requestAnimationFrame(()=>{this._dispatchPublic(e,this._measureFloatGeometry())})})}_syncPortalOffsetVars(){if(!this._portalContainer)return;const e=getComputedStyle(this),t=e.getPropertyValue("--sfx-up-float-offset-x").trim(),i=e.getPropertyValue("--sfx-up-float-offset-y").trim();t?this._portalContainer.style.setProperty("--sfx-up-float-offset-x",t):this._portalContainer.style.removeProperty("--sfx-up-float-offset-x"),i?this._portalContainer.style.setProperty("--sfx-up-float-offset-y",i):this._portalContainer.style.removeProperty("--sfx-up-float-offset-y")}_onStoreChange(){var o,s,n,a,l,c,d,p,u,m;const e=this._store.getState(),t=this._prevStoreState;if(this._prevStoreState=e,!t)return;e.isUploading&&!t.isUploading&&(this._lastEta=0,this._firedFolders.clear());const i=(o=this.config)==null?void 0:o.callbacks;for(const[g,v]of e.files){const $=t.files.get(g);if(!$){v.relativeFolder&&this._firedFolders.delete(v.relativeFolder);continue}if($.status!==v.status)switch(v.status){case"uploading":$.status==="paused"&&(this._dispatchPublic(M.UPLOAD_RESUMED,{file:v}),(s=i==null?void 0:i.onUploadResumed)==null||s.call(i,v));break;case"complete":v.response&&(this._dispatchPublic(M.UPLOAD_COMPLETE,{file:v,response:v.response}),(n=i==null?void 0:i.onUploadComplete)==null||n.call(i,v,v.response));break;case"error":case"failed":{const L=new Error(v.error??"Upload failed");this._dispatchPublic(M.UPLOAD_ERROR,{file:v,error:L}),(a=i==null?void 0:i.onUploadError)==null||a.call(i,v,L);break}case"retrying":this._dispatchPublic(M.UPLOAD_RETRY,{file:v,attempt:v.retryCount}),(l=i==null?void 0:i.onUploadRetry)==null||l.call(i,v,v.retryCount);break;case"paused":this._dispatchPublic(M.UPLOAD_PAUSED,{file:v}),(c=i==null?void 0:i.onUploadPaused)==null||c.call(i,v);break}v.status==="uploading"&&$.progress!==v.progress&&(this._dispatchPublic(M.UPLOAD_PROGRESS,{file:v,progress:v.progress,speed:v.speed}),(d=i==null?void 0:i.onUploadProgress)==null||d.call(i,v,v.progress,v.speed)),v.relativeFolder&&$.status!==v.status&&Mo.has(v.status)&&!this._firedFolders.has(v.relativeFolder)&&this._maybeDispatchFolderComplete(v.relativeFolder,e,i)}if(e.totalProgress!==t.totalProgress||e.totalSpeed!==t.totalSpeed){const g=e.totalSpeed>0?(e.totalBytes-e.totalBytesUploaded)/e.totalSpeed:e.isUploading?this._lastEta:0;e.totalSpeed>0&&(this._lastEta=g),this._dispatchPublic(M.TOTAL_PROGRESS,{percentage:e.totalProgress,speed:e.totalSpeed,eta:g}),(p=i==null?void 0:i.onTotalProgress)==null||p.call(i,e.totalProgress,e.totalSpeed,g)}if(t.isUploading&&!e.isUploading){const g=[...e.files.values()];if(!g.some($=>$.status==="cancelled")){const $=g.filter(w=>w.status==="complete"),L=g.filter(w=>w.status==="failed"||w.status==="error");if($.length===0&&L.length===0)return;const k=this._lastUploadId;if(k!=null){const w=[...$,...L];ut.save(k,w),this._hasStoredReview=w.length>0}this._dispatchPublic(M.ALL_COMPLETE,{successful:$,failed:L}),(u=i==null?void 0:i.onAllComplete)==null||u.call(i,$,L);const _=(m=this.config)==null?void 0:m.closeOnComplete;if(_!==!1&&_!=null){const w=typeof _=="number"?_:1500;this._closeOnCompleteTimer=setTimeout(()=>{var y,U,P;this._closeOnCompleteTimer=null,this._phase==="complete"&&(this._dispatchPublic(M.COMPLETE_ACTION,{}),(P=(U=(y=this.config)==null?void 0:y.callbacks)==null?void 0:U.onCompleteAction)==null||P.call(U),this.close())},w)}}}}_maybeDispatchFolderComplete(e,t,i){var a;const o=[...t.files.values()].filter(l=>l.relativeFolder===e);if(o.length===0||o.some(l=>!Mo.has(l.status)))return;const s=o.filter(l=>l.status==="complete"),n=o.filter(l=>l.status==="failed"||l.status==="error");s.length===0&&n.length===0||(this._firedFolders.add(e),this._dispatchPublic(M.FOLDER_COMPLETE,{folder:e,successful:s,failed:n}),(a=i==null?void 0:i.onFolderComplete)==null||a.call(i,e,s,n))}get _mergedSources(){var p;const e=(p=this.config)==null?void 0:p.connectors;if(e===this._cachedSourcesConfig)return this._cachedSources;if(this._cachedSourcesConfig=e,!e)return this._cachedSources=mt.filter(u=>u.id!=="url"),this._cachedSources;const t=e.providers.length>0?Dc(e.providers):[],i=e.customSources??[],o=e.coreSources?new Set(e.coreSources):null,s=o?mt.filter(u=>o.has(u.id)):mt,n=e.companionUrl?s:s.filter(u=>u.id!=="url"),a=n.filter(u=>u.id==="device"||u.id==="url"),l=n.filter(u=>u.id!=="device"&&u.id!=="url"),c=new Set,d=[];for(const u of[...a,...t,...l,...i])if(!c.has(u.id)){if(Y._RESERVED_IDS.has(u.id)&&u.onActivate){console.warn(`[sfx-uploader] Custom source id "${u.id}" conflicts with a built-in source and was skipped.`);continue}c.add(u.id),d.push(u)}return this._cachedSources=d,this._cachedSources}get _phase(){const e=this._storeCtrl.state,t=[...e.files.values()];if(t.length===0)return"empty";if(e.isUploading)return"uploading";const i=new Set(["complete","rejected","cancelled","failed"]);return t.every(o=>i.has(o.status))&&t.some(o=>o.status==="complete"||o.status==="failed")?"complete":"ready"}_processIncomingFiles(e){var n,a,l,c,d;const t=(n=this.config)==null?void 0:n.callbacks;this._isReviewing&&(this._isReviewing=!1,this._reviewFiles=[]);const i=((a=this.config)==null?void 0:a.preserveFolderStructure)!==!1;let o=0,s=!1;for(const p of e){if(Si(p.name))continue;if(s){o++;continue}const u=i?fc(uc(p)):"",m=this._store.getState();if([...m.files.values()].some(_=>_.name===p.name&&_.size===p.size&&_.relativeFolder===u&&_.status!=="rejected"&&_.status!=="cancelled"))continue;const v=p.type||To(p.name),$=$i({name:p.name,size:p.size,type:v},m.restrictions,m.files);if($){if(zc($)){s=!0,o++;continue}const _=v.startsWith("image/")&&!ke(v)?URL.createObjectURL(p):null,w={id:Ye(),status:"rejected",file:p,remoteUrl:null,name:p.name,size:p.size,type:v,previewUrl:_,duration:null,progress:0,speed:0,bytesUploaded:0,error:$,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...We,relativeFolder:u};Ve(this._store,w),this._dispatchPublic(M.FILE_REJECTED,{file:w,reason:$}),(l=t==null?void 0:t.onFileRejected)==null||l.call(t,w,$);const y=(c=this.config)==null?void 0:c.rejectedFileAutoRemoveDelay,U=y===!1||y===0||y===void 0?0:y;if(U>0){const P=w.id,z=setTimeout(()=>{this._rejectedTimers.delete(P);const F=this._store.getState().files.get(P);F&&F.status==="rejected"&&io(this._store,P)},U);this._rejectedTimers.set(P,z)}continue}let L=null;v.startsWith("image/")&&!ke(v)&&(L=URL.createObjectURL(p));const k={id:Ye(),status:"idle",file:p,remoteUrl:null,name:p.name,size:p.size,type:v,previewUrl:L,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...We,relativeFolder:u};if(Ve(this._store,k),this._dispatchPublic(M.FILE_ADDED,{file:k}),(d=t==null?void 0:t.onFileAdded)==null||d.call(t,k),p.type.startsWith("video/")){Ic(p).then(w=>{if(!w)return;const y=this._store.getState(),U=y.files.get(k.id);if(U){const P=new Map(y.files);P.set(k.id,{...U,previewUrl:w}),this._store.setState({files:P})}else URL.revokeObjectURL(w)});const _=document.createElement("video");_.preload="metadata",_.src=URL.createObjectURL(p),_.onerror=()=>{URL.revokeObjectURL(_.src)},_.onloadedmetadata=()=>{const w=_.duration;if(URL.revokeObjectURL(_.src),!isFinite(w))return;const y=this._store.getState(),U=y.files.get(k.id);if(U){const P=new Map(y.files);P.set(k.id,{...U,duration:w}),this._store.setState({files:P})}}}}if(o>0){const p=this._storeCtrl.state.t,u=this._store.getState().restrictions.maxNumberOfFiles??0;this._showToast(p("tooManyFilesSkipped",{count:o,max:u,defaultValue_one:"Skipped {{count}} file — limit is {{max}}",defaultValue_other:"Skipped {{count}} files — limit is {{max}}"}),"warning")}this._store.getState().queueConfig.autoProceed&&this.upload()}_showEmptyFolderToast(){const e=this._storeCtrl.state.t;this._showToast(e("emptyFolderDrop","The dropped folder is empty — no files were added"),"info")}_removeFile(e){var s,n,a,l,c;const t=this._store.getState().files.get(e);if(!t)return;const i={...t};if((this._fullscreenPreviewUrl&&this._fullscreenPreviewUrl===t.previewUrl||this._fullscreenVideoFile&&this._fullscreenVideoFile===t.file)&&(this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null),t.previewUrl&&URL.revokeObjectURL(t.previewUrl),t.file){const d=this._videoBlobUrls.get(t.file);d&&(URL.revokeObjectURL(d),this._videoBlobUrls.delete(t.file))}(t.status==="uploading"||t.status==="queued"||t.status==="retrying"||t.status==="paused")&&((s=this._engine)==null||s.cancelFile(e)),io(this._store,e),(n=this._engine)==null||n.recompute(),this._dimCache.delete(e);const o=this._rejectedTimers.get(e);if(o&&(clearTimeout(o),this._rejectedTimers.delete(e)),this._previewFileId===e){const d=[...this._store.getState().files.values()];this._previewFileId=d.length>0?d[0].id:null}this._purgeSimilarState(e),this._dispatchPublic(M.FILE_REMOVED,{file:i}),(c=(l=(a=this.config)==null?void 0:a.callbacks)==null?void 0:l.onFileRemoved)==null||c.call(l,i)}_similarImageFiles(){return[...this._store.getState().files.values()].filter(e=>fe(e)==="image"&&!ke(e.type))}_similarUncheckedFiles(){return this._similarImageFiles().filter(e=>!this._similarResults.has(e.id))}_similarityAuth(){var i,o,s;const e=(o=(i=this.config)==null?void 0:i.auth)==null?void 0:o.container,t=(s=this._authHeaders)==null?void 0:s["X-Filerobot-Key"];return!e||!t?null:{container:e,sassKey:t}}_similarMarkInactive(e){const t=new Set(this._similarActiveIds);t.delete(e),this._similarActiveIds=t}_similarSetResults(e,t){const i=new Map(this._similarResults);i.set(e,t),this._similarResults=i}_checkSimilarSingleFile(e){var s,n,a,l;if(this._similarActiveIds.has(e.id)||this._similarRunIds.includes(e.id))return;const t=this._similarityAuth();if(!t){console.error("[sfx-uploader] Similarity check requires resolved auth.");return}const i=Oo((n=(s=this.config)==null?void 0:s.similarityCheck)==null?void 0:n.confidence),o=(l=(a=this.config)==null?void 0:a.similarityCheck)==null?void 0:l.endpoint;this._similarActiveIds=new Set(this._similarActiveIds).add(e.id),Ao(e,{...t,threshold:i,endpoint:o}).then(c=>{this._similarMarkInactive(e.id),this._similarSetResults(e.id,c)}).catch(c=>{console.error("[sfx-uploader] Similarity check failed for",e.name,c),this._similarMarkInactive(e.id),this._similarSetResults(e.id,[])})}_runSimilarityCheck(e){var u,m,g,v;if(this._clearSimilarRun(),!e.length)return;const t=this._similarityAuth();if(!t){console.error("[sfx-uploader] Similarity check requires resolved auth.");return}this._similarRunIds=e.map($=>$.id);const i=Oo((m=(u=this.config)==null?void 0:u.similarityCheck)==null?void 0:m.confidence),o=(v=(g=this.config)==null?void 0:g.similarityCheck)==null?void 0:v.endpoint,s=new AbortController;this._similarAbort=s;const n=[...e];let a=0,l=0;const c=e.length,d=()=>{if(!s.signal.aborted){if(!this._previewFileId){const $=e.find(L=>{var k;return(((k=this._similarResults.get(L.id))==null?void 0:k.length)??0)>0});$&&(this._previewFileId=$.id,this._showSettings=!1,this._previewPanelTab="similar")}this._similarDismissTimer=window.setTimeout(()=>this._clearSimilarRun(),1500)}},p=()=>{if(!s.signal.aborted)for(;a<bd&&n.length>0;){const $=n.shift();a+=1,this._similarActiveIds=new Set(this._similarActiveIds).add($.id),Ao($,{...t,threshold:i,endpoint:o,signal:s.signal}).then(L=>{s.signal.aborted||(this._similarMarkInactive($.id),this._similarSetResults($.id,L))}).catch(L=>{s.signal.aborted||(console.error("[sfx-uploader] Similarity check failed for",$.name,L),this._similarMarkInactive($.id),this._similarSetResults($.id,[]))}).finally(()=>{s.signal.aborted||(a-=1,l+=1,l===c?d():p())})}};p()}_clearSimilarRun(){var e;(e=this._similarAbort)==null||e.abort(),this._similarAbort=null,this._similarDismissTimer!=null&&(clearTimeout(this._similarDismissTimer),this._similarDismissTimer=null),this._similarRunIds=[],this._similarActiveIds=new Set}_purgeSimilarState(e){if(this._similarRunIds.includes(e)&&(this._similarRunIds=this._similarRunIds.filter(t=>t!==e)),this._similarActiveIds.has(e)){const t=new Set(this._similarActiveIds);t.delete(e),this._similarActiveIds=t}if(this._similarResults.has(e)){const t=new Map(this._similarResults);t.delete(e),this._similarResults=t}if(this._similarSelectedIds.has(e)){const t=new Set(this._similarSelectedIds);t.delete(e),this._similarSelectedIds=t}}_openSimilarAsset(e){e&&window.open(e,"_blank","noopener,noreferrer")}_simAssetName(e){let t="";if(e.url){const i=e.url.split("?")[0].split("/").pop()||"";try{t=decodeURIComponent(i)}catch{t=i}}return t||e.uuid}_simAssetMeta(e){const t=this._simAssetName(e),i=t.lastIndexOf("."),o=i>0?t.slice(i+1).toUpperCase():"";return o&&o.length<=5?o:""}_locateFile(e){var s,n,a;if(!e)return;const t=ea(e,this.config??void 0),i=this.dispatchEvent(new CustomEvent(M.FILE_LOCATE,{bubbles:!0,composed:!0,cancelable:!0,detail:{file:e,url:t}})),o=(a=(n=(s=this.config)==null?void 0:s.callbacks)==null?void 0:n.onFileLocate)==null?void 0:a.call(n,e,t);this._onMinimize(),!(!i||o===!1)&&t&&window.location.assign(t)}render(){var o;const e=((o=this.config)==null?void 0:o.mode)??"modal",t=[...this._storeCtrl.state.files.values()],i=this._storeCtrl.state.t;return e==="modal"?f`
    ...
    `}_renderHeader(){var L,k,_,w,y,U;if(this._phase==="complete")return S;const e=this._storeCtrl.state.t,t=((L=this.config)==null?void 0:L.mode)??"modal";if(this._phase==="uploading"){const F=[...this._storeCtrl.state.files.values()].filter(ue=>ue.status!=="rejected"&&ue.status!=="cancelled"),T=F.length,Z=F.filter(ue=>ue.status==="complete").length;return f`
      ...
      `}if(t==="inline"&&((k=this.config)!=null&&k.inlineHeader))return S;const i=((_=this.config)==null?void 0:_.header)??(t==="modal"?"close":!0);if(i===!1)return S;const o=t==="modal"?this._onModalDismiss:this._onInlineDismiss,s=i==="back"?f`<button
          ...
          </button>`:S,v=(U=(y=this._metadataSchema)==null?void 0:y.regionalVariantsGroups)!=null&&U.length?f`<sfx-regional-settings
    ...
    `}_renderOverlayFiles(e,t){const i=[...e].reverse();return f`
      <div class="upload-overlay-files">
        ${Ri(i,o=>o.id,o=>{const s=o.status==="paused",n=o.status==="uploading",a=o.status==="queued",l=Math.round(o.progress??0),c=s?t("paused","Paused"):a?t("queued","Queued"):`${l}%`;return f`
    ...
    `}_renderFloatingPill(e){const t=this._storeCtrl.state,i=t.t,o=Math.round(t.totalProgress??0),s=this._phase==="complete",n=e.filter(d=>d.status==="complete").length,a=e.filter(d=>d.status==="failed").length,l=e.filter(d=>d.status==="complete"&&d.alreadyExisted).length,c=n>0&&a===0&&l>=n;return this._isPillExpanded===!1?f`
      ...
      <div class="upload-float">
        ...
        <div class="float-items">
          ${Ri([...e].reverse(),d=>d.id,d=>{var u,m,g;const p=d.status==="failed"||d.status==="error";return f`
                ...
                <div class="float-item-status">
                  ${d.status==="complete"?f`${(u=this.config)!=null&&u.showLocateButton&&((g=(m=d.response)==null?void 0:m.file)!=null&&g.uuid)?f`<button
                        ...
                        <button
                          ...
                          @click=${()=>{var v;this._ensureEngine(),(v=this._engine)==null||v.retryFile(d.id)}}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        <button
                          ...
                          @click=${()=>{var v;return(v=this._engine)==null?void 0:v.resumeFile(d.id)}}
                        >
                          <svg viewBox="0 0 24 24" fill="currentColor">
                            <polygon points="5,3 19,12 5,21" />
                          </svg>
                        ...
                        ${d.status==="uploading"&&d.isTus?f`<button
                              ...
                              @click=${()=>{var v;return(v=this._engine)==null?void 0:v.pauseFile(d.id)}}
                            >
                              <svg viewBox="0 0 24 24" fill="currentColor">
                                <rect x="6" y="4" width="4" height="16" rx="1" />
                                <rect x="14" y="4" width="4" height="16" rx="1" />
    ...
    `}_renderPreviewLayout(e){var v,$,L,k,_,w,y;if(e.length===0)return S;const t=this._storeCtrl.state.t,i=[...e].reverse(),o=i.find(U=>U.id===this._previewFileId)??i[0],s=((v=o.name.split(".").pop())==null?void 0:v.toUpperCase())||"";new Date(o.addedAt).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),this._store.getState().targetFolder;const n=i.reduce((U,P)=>U+(P.size||0),0),a=!!((L=($=this.config)==null?void 0:$.similarityCheck)!=null&&L.enabled),l=i.filter(U=>fe(U)==="image"&&!ke(U.type)&&!this._similarResults.has(U.id)).map(U=>U.id),c=Math.min(l.length,_e),d=c>0&&this._similarSelectedIds.size>=c,p=this._similarSelectedIds.size>=_e,u=this._similarResults.get(o.id),m=u!==void 0,g=m?this._previewPanelTab:"details";return f`
      ...
      <div class="preview-layout">
        <div class="file-grid-side" ${Q({flex:String(this._splitPct)})}>
          ...
          <sfx-file-list
            ...
            .accept=${Lo(this._storeCtrl.state.restrictions)}
                ...
                <div class="preview-media-area">
                  <div class="preview-doc-wrap ${fe(o)}">
                    <img
                      ...
                      src=${Fs(s)}
                      alt="${s?`${s} file`:"File"}"
                      @error=${U=>{const P=U.target,z=Is();!P.dataset.fallback&&P.src!==z&&(P.dataset.fallback="1",P.src=z)}}
                    />
                  </div>
                  <button
                    class="preview-nav prev"
    ...
    `}_navigatePreview(e,t){var s;const o=e.findIndex(n=>n.id===this._previewFileId)+t;if(o>=0&&o<e.length){const n=(s=this.shadowRoot)==null?void 0:s.querySelector(".preview-image[controls]");n&&(n.pause(),n.removeAttribute("src"),n.load()),this._previewFileId=e[o].id}}_renderBody(){var m,g,v,$,L,k,_,w,y,U,P,z,F;const e=this._storeCtrl.state,t=e.t,i=[...e.files.values()],o=i.filter(T=>T.status==="idle"||T.status==="queued"||T.status==="error"||T.status==="failed"),s=this._phase,n=Lo(e.restrictions),a=i.length>0,l=!!((g=(m=this.config)==null?void 0:m.similarityCheck)!=null&&g.enabled),c=i.filter(T=>fe(T)==="image"&&!ke(T.type)&&!this._similarResults.has(T.id)).map(T=>T.id),d=Math.min(c.length,_e),p=d>0&&this._similarSelectedIds.size>=d,u=this._similarSelectedIds.size>=_e;return f`
      ...
      >
        ...
        >
          ${((v=this.config)==null?void 0:v.mode)==="inline"&&(($=this.config)!=null&&$.inlineHeader)&&!this._previewFileId&&s!=="uploading"&&s!=="complete"&&!this._isReviewing?this._renderInlineHeader(this.config.inlineHeader):S}
          ${this._isReviewing?f`
              ...
              `:s==="uploading"?this._renderUploadOverlay(i):f`
                ${a?S:f`<sfx-drop-zone
                        ...
                        .accept=${n}
                        .sources=${this._mergedSources}
                        .sourcesLayout=${((y=this.config)==null?void 0:y.sourcesLayout)??"pills"}
        ...
        ${this._activeConnector&&((F=this.config)!=null&&F.connectors)?f`
              ...
              >
                <div class="connector-modal">
                  ${jo.has(this._activeConnector)?f`
  ...
  `,Y._FS_ZOOM_LEVELS=[1,2,3,4],Y._MODIFIABLE_STATUSES=new Set(["idle","queued","rejected"]),Y._RESERVED_IDS=new Set(["device","camera","url","screen-cast"]),Y);N([O({attribute:!1})],B.prototype,"config");N([I()],B.prototype,"_isOpen");N([I()],B.prototype,"_activeConnector");N([I()],B.prototype,"_showUrlDialog");N([I()],B.prototype,"_showCameraDialog");N([I()],B.prototype,"_showScreenCastDialog");N([I()],B.prototype,"_similarSelectMode");N([I()],B.prototype,"_similarSelectedIds");N([I()],B.prototype,"_similarRunIds");N([I()],B.prototype,"_similarActiveIds");N([I()],B.prototype,"_similarResults");N([I()],B.prototype,"_previewPanelTab");N([I()],B.prototype,"_previewFileId");N([I()],B.prototype,"_previewDims");N([I()],B.prototype,"_fileInfoOpen");N([I()],B.prototype,"_splitPct");N([I()],B.prototype,"_showSettings");N([I()],B.prototype,"_setResize");N([I()],B.prototype,"_setMaxW");N([I()],B.prototype,"_setMaxH");N([I()],B.prototype,"_setTranscode");N([I()],B.prototype,"_setResolution");N([I()],B.prototype,"_setResolutionOpen");N([I()],B.prototype,"_setProtocol");N([I()],B.prototype,"_setResumable");N([I()],B.prototype,"_fullscreenPreviewUrl");N([I()],B.prototype,"_fullscreenVideoFile");N([I()],B.prototype,"_fsZoom");N([I()],B.prototype,"_bodyDragOver");N([I()],B.prototype,"_isMinimized");N([I()],B.prototype,"_isPillExpanded");N([I()],B.prototype,"_metadataSchema");N([I()],B.prototype,"_regionalFilters");N([I()],B.prototype,"_bulkMetadataOpen");N([I()],B.prototype,"_bulkMetadataInitialFieldKey");N([I()],B.prototype,"_isReviewing");N([I()],B.prototype,"_reviewFiles");N([I()],B.prototype,"_hasStoredReview");let _d=B;const me=(r,e)=>{typeof customElements<"u"&&!customElements.get(r)&&customElements.define(r,e)};me("sfx-uploader",_d);me("sfx-drop-zone",nd);me("sfx-import-divider",Ki);me("sfx-source-pills",At);me("sfx-file-list",K);me("sfx-file-item",X);me("sfx-success-card",ge);me("sfx-actions-bar",se);me("sfx-url-dialog",qe);me("sfx-camera-dialog",Ue);me("sfx-screen-cast-dialog",ye);const kd=[{pattern:"/",load:()=>V(()=>import("./landing-CtD1pkYk.js"),[]).then(r=>r.default)},{pattern:"/docs/getting-started",load:()=>V(()=>import("./getting-started-BEsDf8Jc.js"),__vite__mapDeps([0,1])).then(r=>r.default)},{pattern:"/docs/configuration",load:()=>V(()=>import("./configuration-BGWWClla.js"),__vite__mapDeps([2,1])).then(r=>r.default)},{pattern:"/docs/api",load:()=>V(()=>import("./api-C3Pu2Ua4.js"),__vite__mapDeps([3,1])).then(r=>r.default)},{pattern:"/docs/theming",load:()=>V(()=>import("./theming-D5E2zXLD.js"),__vite__mapDeps([4,1])).then(r=>r.default)},{pattern:"/docs/types",load:()=>V(()=>import("./types-BP9Z4Qnu.js"),__vite__mapDeps([5,1])).then(r=>r.default)},{pattern:"/examples/basic",load:()=>V(()=>import("./basic-DRdJ4AJA.js"),__vite__mapDeps([6,7])).then(r=>r.default)},{pattern:"/examples/auto-upload",load:()=>V(()=>import("./auto-upload-CiliZVZI.js"),__vite__mapDeps([8,7])).then(r=>r.default)},{pattern:"/examples/restrictions",load:()=>V(()=>import("./restrictions-wuhig7br.js"),__vite__mapDeps([9,7,10])).then(r=>r.default)},{pattern:"/examples/target-folder",load:()=>V(()=>import("./target-folder-BwH6iHFN.js"),__vite__mapDeps([11,7])).then(r=>r.default)},{pattern:"/examples/concurrency",load:()=>V(()=>import("./concurrency-BB_hsemV.js"),__vite__mapDeps([12,7,10])).then(r=>r.default)},{pattern:"/examples/events",load:()=>V(()=>import("./events-DdY4JLtY.js"),__vite__mapDeps([13,7])).then(r=>r.default)},{pattern:"/examples/modal",load:()=>V(()=>import("./modal-xWTRHUI8.js"),__vite__mapDeps([14,7])).then(r=>r.default)},{pattern:"/examples/inline",load:()=>V(()=>import("./inline-BDU0OUw8.js"),__vite__mapDeps([15,7])).then(r=>r.default)},{pattern:"/examples/sources-layout",load:()=>V(()=>import("./sources-layout-D4djHW7l.js"),__vite__mapDeps([16,7])).then(r=>r.default)},{pattern:"/examples/core-sources",load:()=>V(()=>import("./core-sources-DF4yu3q8.js"),__vite__mapDeps([17,7])).then(r=>r.default)},{pattern:"/examples/header-button",load:()=>V(()=>import("./header-button-BQfh5fLd.js"),__vite__mapDeps([18,7])).then(r=>r.default)},{pattern:"/examples/minimize-to-background",load:()=>V(()=>import("./minimize-to-background-DMXP4flL.js"),__vite__mapDeps([19,7])).then(r=>r.default)},{pattern:"/examples/resumable-upload",load:()=>V(()=>import("./resumable-upload-SanqMedt.js"),__vite__mapDeps([20,7,10])).then(r=>r.default)},{pattern:"/examples/react-wrapper",load:()=>V(()=>import("./react-wrapper-DqFoKQCy.js"),__vite__mapDeps([21,1])).then(r=>r.default)},{pattern:"/examples/metadata",load:()=>V(()=>import("./metadata-CcDrL4EC.js"),__vite__mapDeps([22,7])).then(r=>r.default)},{pattern:"/examples/full-screen",load:()=>V(()=>import("./full-screen-D1SuGZyE.js"),[]).then(r=>r.default)},{pattern:"/examples/last-upload-review",load:()=>V(()=>import("./last-upload-review-CGnvtmfS.js"),[]).then(r=>r.default)},{pattern:"/examples/similar-check",load:()=>V(()=>import("./similar-check-xn7DwfGi.js"),__vite__mapDeps([23,7,10])).then(r=>r.default)},{pattern:"/examples/upload-settings",load:()=>V(()=>import("./upload-settings-BWQZDoyU.js"),__vite__mapDeps([24,7,10])).then(r=>r.default)}];let Ge=null,Bo=0;function Sd(r){const e=document.getElementById("content"),t=document.getElementById("sidebar"),i=document.getElementById("sidebar-docs"),o=document.getElementById("sidebar-examples"),s=document.querySelectorAll(".topbar-nav-link");async function n(){var k,_;const a=location.hash.slice(1)||"/",l=!a.startsWith("/");if(l&&Ge){(k=document.getElementById(a))==null||k.scrollIntoView({behavior:"smooth"});return}const c=l?"/":a,d=++Bo;Ge!=null&&Ge.destroy&&Ge.destroy();const p=kd.find(w=>w.pattern===c);if(!p){location.hash="#/";return}const u=c.startsWith("/docs/"),m=c.startsWith("/examples/"),g=u||m,v=c==="/";t.classList.toggle("hidden",!g),document.body.classList.toggle("has-sidebar",g),document.body.classList.toggle("is-home",v),i.classList.toggle("hidden",!u),o.classList.toggle("hidden",!m),t.querySelectorAll(".sidebar-link").forEach(w=>{w.classList.toggle("active",w.getAttribute("data-route")===c)});const $=u?"docs":m?"examples":"home";s.forEach(w=>{w.classList.toggle("active",w.getAttribute("data-section")===$)}),t.classList.remove("mobile-open"),l||window.scrollTo(0,0);const L=await p.load();d===Bo&&(Ge=L,e.innerHTML=L.render(),L.init&&L.init(r),l&&((_=document.getElementById(a))==null||_.scrollIntoView({behavior:"smooth"})))}window.addEventListener("hashchange",n),n()}const Bs="sfx-uploader-demo-auth",No={container:"",securityTemplateId:""};function Ns(){try{const r=localStorage.getItem(Bs);if(r)return{...No,...JSON.parse(r)}}catch{}return{...No}}function $d(r){localStorage.setItem(Bs,JSON.stringify(r))}function qd(r={}){const{container:e,securityTemplateId:t}=Ns();return{auth:{mode:"security-template",container:e,securityTemplateId:t},autoProceed:!1,connectors:{companionUrl:"https://eu-on-24001.connector.filerobot.com",providers:["google-drive","dropbox","box","onedrive"]},...r}}function Cd(){const r=document.getElementById("auth-btn"),e=document.getElementById("auth-popover"),t=document.getElementById("auth-container"),i=document.getElementById("auth-sec-template"),o=document.getElementById("auth-save"),s=Ns();t.value=s.container,i.value=s.securityTemplateId,r.addEventListener("click",n=>{n.stopPropagation(),e.classList.toggle("hidden")}),o.addEventListener("click",()=>{$d({container:t.value.trim(),securityTemplateId:i.value.trim()}),e.classList.add("hidden")}),document.addEventListener("click",n=>{!e.contains(n.target)&&!r.contains(n.target)&&e.classList.add("hidden")})}Cd();const Ed=document.getElementById("uploader");Sd(Ed);var qo;(qo=document.getElementById("sidebar-toggle"))==null||qo.addEventListener("click",()=>{var r;(r=document.getElementById("sidebar"))==null||r.classList.toggle("mobile-open")});export{S as A,Nd as B,jc as C,Zc as D,Fs as E,Is as F,Fe as G,Hd as H,Bd as I,dr as J,rt as P,le as a,qd as b,f as c,Ad as d,ir as e,Fd as f,Dc as g,da as h,oe as i,pa as j,De as k,Td as l,Q as m,O as n,js as o,zd as p,Wc as q,I as r,Ld as s,Dd as t,jd as u,Md as v,Ie as w,qi as x,Jc as y,ot as z};
