...
});`}]),[["sfx-file-added",e=>{var l;return o("sfx-file-added",{name:(l=e.detail.file)==null?void 0:l.name})}],["sfx-file-removed",e=>{var l;return o("sfx-file-removed",{name:(l=e.detail.file)==null?void 0:l.name})}],["sfx-file-rejected",e=>{var l;return o("sfx-file-rejected",{name:(l=e.detail.file)==null?void 0:l.name,reason:e.detail.reason})}],["sfx-upload-started",e=>{var l;return o("sfx-upload-started",{count:(l=e.detail.files)==null?void 0:l.length})}],["sfx-upload-progress",e=>{var l;return o("sfx-upload-progress",{name:(l=e.detail.file)==null?void 0:l.name,progress:e.detail.progress})}],["sfx-upload-complete",e=>{var l;return o("sfx-upload-complete",{name:(l=e.detail.file)==null?void 0:l.name})}],["sfx-upload-error",e=>{var l,a;return o("sfx-upload-error",{name:(l=e.detail.file)==null?void 0:l.name,error:(a=e.detail.error)==null?void 0:a.message})}],["sfx-all-complete",e=>{var l,a;return o("sfx-all-complete",{ok:(l=e.detail.successful)==null?void 0:l.length,failed:(a=e.detail.failed)==null?void 0:a.length})}],["sfx-open",()=>o("sfx-open")],["sfx-close",()=>o("sfx-close")],["sfx-cancel",()=>o("sfx-cancel")]].forEach(([e,l])=>{const a=l;n.addEventListener(e,a),d.push([e,a])}),document.getElementById("clear-log").addEventListener("click",()=>{s&&(s.innerHTML='<div><span class="log-time">--:--:--</span> Log cleared.</div>')}),document.getElementById("open-btn").addEventListener("click",()=>{o("open"),n.config=r({callbacks:{onFileAdded:e=>o("onFileAdded callback",{name:e.name}),onAllComplete:(e,l)=>o("onAllComplete callback",{ok:e.length,failed:l.length})}}),n.open()})},destroy(){const n=document.getElementById("uploader");n&&d.forEach(([t,e])=>n.removeEventListener(t,e)),d.length=0,s=null}};export{g as default};
