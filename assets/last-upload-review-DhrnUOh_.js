import{b as i}from"./index-BbE_0G_V.js";const s={render(){return`
    ...
    `},init(e){const t=document.getElementById("lur-uploader");t.config=i({mode:"inline",inlineHeader:{accent:"Airbox",title:"Q1 Marketing Assets",description:'Upload some files and then click "Review files" on the success card.'}})},destroy(){const e=document.getElementById("lur-uploader");e&&e.close()}};export{s as default};
