      ...
      <div class=${c} tabindex="0">
          ...
          ${e.previewUrl?g`<img class="preview-img" src=${e.previewUrl} alt="" />`:g`
                ...
                <div class="type-icon">
                  <img
                    ...
                    src=${ms(d)}
                    alt="${d?`${d} file`:"File"}"
                    @error=${b=>{const x=b.target,_=vs();!x.dataset.fallback&&x.src!==_&&(x.dataset.fallback="1",x.src=_)}}
                  />
                </div>
              `}
        ...
        <div class="info">
          <input class="name-input" type="text" .value=${e.name} title=${e.name}
            ...
            ?readonly=${l}
            @change=${l?S:this._rename} @click=${b=>b.stopPropagation()} />
          ...
          <div class="float-header-left">
            ...
            <div>
              ...
              <div class="float-subtitle">
                ${e("nOfNComplete","{{completed}} of {{total}} complete",{completed:x,total:b})}${this._lastEta>0?` · ${e("etaLeft","~{{eta}} left",{eta:hi(this._lastEta)})}`:""}
              </div>
            </div>
          </div>
        </div>
    ...
    `}_renderFloatingPill(e){const t=this._storeCtrl.state,i=t.t,o=Math.round(t.totalProgress??0),s=this._phase==="complete",n=e.filter(l=>l.status==="complete").length,a=e.filter(l=>l.status==="failed").length;return this._isPillExpanded===!1?g`
      ...
      <div class="upload-float">
        ...
        <div class="float-items">
          ${e.map(l=>{const d=l.status==="failed"||l.status==="error";return g`
                ...
                <div class="preview-media-area">
                  <div class="preview-doc-wrap ${hs(i)}">
                    <img
                      ...
                      src=${ms(o)}
                      alt="${o?`${o} file`:"File"}"
                      @error=${p=>{const u=p.target,b=vs();!u.dataset.fallback&&u.src!==b&&(u.dataset.fallback="1",u.src=b)}}
                    />
                  </div>
                  <button
                    class="preview-nav prev"
          ...
          ${this._isReviewing?g`
              ...
              `:s==="complete"?g`
                <sfx-success-card
                  ...
                  .showMinimize=${!!((u=this.config)!=null&&u.minimizeOnUpload)&&((b=this.config)==null?void 0:b.mode)!=="inline"}
