import{b as F}from"./index-DZDW7ul7.js";import{r as B}from"./code-block-C_3oxnLY.js";const R="sfx-uploader-demo-meta",A={projectUuid:"",enforceRequired:"auto",language:"",sessionToken:"",companyToken:"",projectToken:""};function D(){try{const t=localStorage.getItem(R);if(t)return{...A,...JSON.parse(t)}}catch{}return{...A}}function L(t){localStorage.setItem(R,JSON.stringify(t))}let l=null;function m(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function p(t,n){if(!l)return;const r=new Date().toLocaleTimeString(),d=document.createElement("div"),c=n?` <span class="log-data">${m(JSON.stringify(n,null,0))}</span>`:"";d.innerHTML=`<span class="log-time">${m(r)}</span> <span class="log-event">${m(t)}</span>${c}`,l.appendChild(d),l.scrollTop=l.scrollHeight}const x={render(){return`
    ...
    `},init(t){l=document.getElementById("event-log"),B("#code-container",[{label:"Basic",lang:"javascript",code:`
uploader.config = {
  auth: {
