import{b as R}from"./index-BCsEt58D.js";import{r as S}from"./code-block-Bk3NnwHF.js";const q="sfx-uploader-demo-meta",I={projectUuid:"",enforceRequired:"auto",sessionToken:"",companyToken:"",projectToken:""};function _(){try{const a=localStorage.getItem(q);if(a)return{...I,...JSON.parse(a)}}catch{}return{...I}}function A(a){localStorage.setItem(q,JSON.stringify(a))}let n=null;function x(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function c(a,l){if(!n)return;const r=new Date().toLocaleTimeString(),d=document.createElement("div"),p=l?` <span class="log-data">${x(JSON.stringify(l,null,0))}</span>`:"";d.innerHTML=`<span class="log-time">${x(r)}</span> <span class="log-event">${x(a)}</span>${p}`,n.appendChild(d),n.scrollTop=n.scrollHeight}const m={render(){return`
    ...
    `},init(a){n=document.getElementById("event-log"),S("#code-container",[{label:"Basic",lang:"javascript",code:`
uploader.config = {
  auth: {
...
};`}]);const l=[["sfx-file-added",e=>{var t;return c("file-added",{name:(t=e.detail.file)==null?void 0:t.name})}],["sfx-fill-metadata",e=>{var t;return c("fill-metadata",{files:(t=e.detail.files)==null?void 0:t.length})}],["sfx-metadata-schema",e=>{var o,s;const t=((o=e.detail.schema)==null?void 0:o.fields)??[];c("metadata-schema",{totalFields:t.length,requiredFieldKeys:e.detail.requiredFieldKeys??[],forceFillingOnUpload:(s=e.detail.schema)==null?void 0:s.forceFillingOnUpload})}],["sfx-upload-complete",e=>{var t,o,s;return c("upload-complete",{name:(t=e.detail.file)==null?void 0:t.name,meta:(s=(o=e.detail.response)==null?void 0:o.file)==null?void 0:s.meta})}],["sfx-all-complete",e=>{var t,o;return c("all-complete",{ok:(t=e.detail.successful)==null?void 0:t.length,failed:(o=e.detail.failed)==null?void 0:o.length})}]],r=[];l.forEach(([e,t])=>{const o=t;a.addEventListener(e,o),r.push([e,o])}),m._listeners=r,document.getElementById("clear-log").addEventListener("click",()=>{n&&(n.innerHTML='<div><span class="log-time">--:--:--</span> Log cleared.</div>')});const d=_(),p=document.getElementById("project-uuid"),i=document.getElementById("enforce-required-wrap"),T=i.querySelector(".meta-select-trigger"),M=i.querySelector(".meta-select-label"),h=i.querySelector(".meta-select-chevron"),b=i.querySelector(".meta-select-menu"),y=i.querySelectorAll(".meta-select-option"),v=document.getElementById("hub-session"),k=document.getElementById("hub-company"),w=document.getElementById("hub-project"),f=e=>{i.dataset.value=e,M.textContent=e,y.forEach(t=>{const o=t.dataset.value===e;t.style.color=o?"#2563eb":"#1e293b",t.style.background=o?"#eff6ff":"transparent",t.style.fontWeight=o?"500":"400"})};let u=!1;const g=()=>{u=!1,b.style.display="none",h.style.transform="rotate(0deg)"},C=()=>{u=!0,b.style.display="block",h.style.transform="rotate(180deg)"};T.addEventListener("click",e=>{e.stopPropagation(),u?g():C()}),y.forEach(e=>{e.addEventListener("mouseenter",()=>{e.dataset.value!==i.dataset.value&&(e.style.background="#f1f5f9")}),e.addEventListener("mouseleave",()=>{e.dataset.value!==i.dataset.value&&(e.style.background="transparent")}),e.addEventListener("click",()=>{f(e.dataset.value||"auto"),g()})}),document.addEventListener("click",e=>{i.contains(e.target)||g()}),d.projectUuid&&(p.value=d.projectUuid),d.enforceRequired?f(d.enforceRequired):f("auto"),d.sessionToken&&(v.value=d.sessionToken),d.companyToken&&(k.value=d.companyToken),d.projectToken&&(w.value=d.projectToken),document.getElementById("open-btn").addEventListener("click",()=>{const e=p.value.trim(),t=i.dataset.value||"auto",o=v.value.trim(),s=k.value.trim(),U=w.value.trim()||e;if(A({projectUuid:e,enforceRequired:t,sessionToken:o,companyToken:s,projectToken:U}),!e){alert("Please enter a project UUID");return}const E=t==="true"?!0:t==="auto"?"auto":!1,j=o&&s?{"x-session-token":o,"x-company-token":s,"x-project-token":U}:void 0;c("config",{projectUuid:e,enforce:E,hasHubHeaders:!!j}),a.config=R({metadataConfig:{projectUuid:e,enforceRequiredBeforeUpload:E,hubHeaders:j}}),a.open()})},destroy(){const a=document.getElementById("uploader"),l=m._listeners;a&&l&&l.forEach(([r,d])=>a.removeEventListener(r,d)),m._listeners=void 0,n=null}};export{m as default};
