import{i as w,a as x,A as f,c as a,n as c,r as h,w as g,j as Ve}from"./index-DvqKfEVw.js";function Fe(o,e){const t=(e==null?void 0:e.language)??"en",s=o.model??[],i=o.store??{},n=s.find(u=>u.applies_to==="FILES");let r=(n==null?void 0:n.groups)??[];if(Array.isArray(e==null?void 0:e.fields)){const u=new Set(e.fields);r=r.map(k=>({...k,fields:k.fields.filter(_=>u.has(_.ckey))})).filter(k=>k.fields.length>0)}r=r.map(u=>({...u,fields:u.fields.filter(k=>!k.hide)})).filter(u=>u.fields.length>0);const l=r.flatMap(u=>u.fields),d=new Map(l.map(u=>[u.key,u])),p=i.force_filling_metadata_on_upload===!0,b=i.regional_variants_groups??[];return{groups:r,fields:l,fieldsByKey:d,forceFillingOnUpload:p,regionalVariantsGroups:b,language:t}}const Me="https://hub.scaleflex.com/api",H=new Map,R=new Map;async function Et(o,e,t,s){const i=H.get(t);if(i)return i;const n=R.get(t);if(n)return n;if(s!=null&&s.rawMetadata){const l=Fe(s.rawMetadata,s);return H.set(t,l),l}const r=Je(e,t,s);R.set(t,r);try{const l=await r;return H.set(t,l),l}finally{R.delete(t)}}async function Je(o,e,t){var p,b,u;const i=`${(t==null?void 0:t.hubApiBase)??Me}/project/${encodeURIComponent(e)}`,n=(t==null?void 0:t.hubHeaders)??o,r=await fetch(i,{headers:n});if(!r.ok)throw new Error(`Failed to fetch metadata schema (HTTP ${r.status})`);const l=await r.json(),d=((b=(p=l.data)==null?void 0:p.project)==null?void 0:b.data)??((u=l.project)==null?void 0:u.data);if(!(d!=null&&d.metadata))throw new Error("No metadata in project response");return Fe(d.metadata,t)}function At(o){var e;o?(H.delete(o),(e=R.get(o))==null||e.catch(()=>{}),R.delete(o)):(H.clear(),R.clear())}function Te(o,e,t){let s=e;switch(o.regional_variants_group_uuid&&s!=null&&typeof s=="object"&&!Array.isArray(s)&&(s=s[t??"en"]),o.type){case"geopoint":return He(s);case"boolean":return s===!0?"true":s===!1?"false":"null";case"date":return s?new Date(s):null;case"decimal2":return s!=null?String(s):"";case"tags":return Array.isArray(s)?s.map(i=>typeof i=="string"?{value:i,label:i}:i):[];case"multi-select":return s||[];default:return s??""}}function Q(o,e,t,s){var n;let i;switch(o.type){case"geopoint":{const r=e;!r||r.latitude===""||r.latitude==null||r.longitude===""||r.longitude==null?i=null:i=`(${r.latitude},${r.longitude})`;break}case"boolean":e==="true"?i=!0:e==="false"?i=!1:i=null;break;case"date":{if(!e)i=null;else{const r=e instanceof Date?e:new Date(e),l=r.getFullYear(),d=String(r.getMonth()+1).padStart(2,"0"),p=String(r.getDate()).padStart(2,"0");i=`${l}-${d}-${p}`}break}case"tags":i=Array.isArray(e)?e.map(r=>(r==null?void 0:r.label)??""):[];break;case"select-one":i=e===""?null:e;break;case"numeric":{if(e===""||e==null){i=null;break}const r=Number(e);i=Number.isFinite(r)?Math.round(r):null;break}case"decimal2":{if(e===""||e==null){i=null;break}const r=Number(e);i=Number.isFinite(r)?r:null;break}default:i=e}if(o.regional_variants_group_uuid){const r=s??"en";return{...((n=t==null?void 0:t.meta)==null?void 0:n[o.key])??{},[r]:i}}return i}function He(o){if(typeof o=="string"){const e=/\(([^)]+)\)/.exec(o);if(e){const t=e[1].split(",");if(t.length===2)return{latitude:t[0].trim(),longitude:t[1].trim()}}}return{latitude:"",longitude:""}}function Be(o,e,t){var i;if((((i=t==null?void 0:t.requiredFields)==null?void 0:i.includes(o.ckey))||o.required===1)&&A(e))return`${o.title} is required`;if(A(e))return null;switch(o.type){case"numeric":{const n=Number(e);if(!Number.isFinite(n))return"Must be a valid number";if(!Number.isInteger(n))return"Must be an integer";if(n<-1999999999||n>1999999999)return"Value out of range (±1,999,999,999)";break}case"decimal2":{const n=Number(e);if(!Number.isFinite(n))return"Must be a valid number";if(!/^\-?\d*\.?\d{0,2}$/.test(String(e)))return"Maximum 2 decimal places";if(n<-999999999999e-2||n>999999999999e-2)return"Value out of range (±9,999,999,999.99)";break}case"geopoint":{const n=e,r=n.latitude!==""&&n.latitude!=null,l=n.longitude!==""&&n.longitude!=null;if(r!==l)return"Both latitude and longitude are required";if(r&&l){const d=Number(n.latitude),p=Number(n.longitude);if(!Number.isFinite(d)||d<-90||d>90)return"Latitude must be between -90 and 90";if(!Number.isFinite(p)||p<-180||p>180)return"Longitude must be between -180 and 180"}break}case"attachment-uri":{try{const n=new URL(e);if(!["http:","https:"].includes(n.protocol))return"Only http and https URLs are allowed"}catch{return"Invalid URI"}break}}if(o.validation&&typeof e=="string")try{if(!new RegExp(o.validation).test(e))return"Value does not match expected format"}catch{}return null}function A(o){return o==null?!0:Array.isArray(o)||typeof o=="string"?o.length===0:typeof o=="object"?!Object.values(o).some(e=>e!=null&&e!==""):!o}function Ue(o){return!A(o)}function Ot(o,e,t){const s=new Set(["idle","queued","rejected"]),i=[...o.values()].filter(d=>s.has(d.status));if(i.length===0)return{};const n=new Set((t==null?void 0:t.requiredFields)??[]),r=e.fields.filter(d=>d.required===1||n.has(d.ckey)),l={};for(const d of r){const p=i.filter(b=>!Ue(b.meta[d.key]));p.length>0&&(l[d.key]=p)}return l}function Dt(o,e){const t={...o};for(const s of Object.keys(e)){const i=e[s];if(i==null||i==="")continue;const n=o[s];if(Array.isArray(i))if(Array.isArray(n)){const r=new Set(n.map(d=>JSON.stringify(d))),l=[...n];for(const d of i){const p=JSON.stringify(d);r.has(p)||(r.add(p),l.push(d))}t[s]=l}else t[s]=i;else t[s]=i}return t}function zt(o,e){let t=null,s=null,i=!1;return{search(n,r,l){if(t&&clearTimeout(t),s&&s.abort(),i=!1,!r.trim()){l([]);return}t=setTimeout(async()=>{var d;s=new AbortController;try{const p=`${o}/v5/metadata/autocomplete?q=${encodeURIComponent(r.trim())}&meta_key=_${encodeURIComponent(n)}&limit=20`,b=await fetch(p,{headers:e,signal:s.signal});if(i)return;if(!b.ok){l([]);return}const u=await b.json();if(i)return;const k=((d=u.data)==null?void 0:d.tags)??u.tags??[];l(k.map(_=>({sid:_.sid||void 0,value:_.tag||_.value||_.label||"",label:_.tag||_.label||_.value||""})))}catch{i||l([])}},200)},cancel(){i=!0,t&&clearTimeout(t),s&&s.abort()}}}var Ye=Object.defineProperty,V=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&Ye(e,t,i),i};const pe=class pe extends w{constructor(){super(...arguments),this.schema=null,this.meta={},this.config=null,this.disabled=!1,this._collapsed=new Set}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_renderGroup(e){const t=!this._collapsed.has(e.uuid);return a`
      <div class="group">
  ...
  `;let C=pe;V([c({attribute:!1})],C.prototype,"schema");V([c({attribute:!1})],C.prototype,"meta");V([c({attribute:!1})],C.prototype,"config");V([c({attribute:!1})],C.prototype,"autocomplete");V([c({type:Boolean})],C.prototype,"disabled");V([h()],C.prototype,"_collapsed");customElements.define("sfx-metadata-form",C);const G=x`
...
`;var We=Object.defineProperty,M=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&We(e,t,i),i};const ue=class ue extends w{constructor(){super(...arguments),this.config=null,this.disabled=!1,this._error=null,this._dispatching=!1,this._handleChildBlur=e=>{this._dispatching||(e.stopPropagation(),this._onFieldBlur(e))}}get _isRequired(){var e,t;return(t=(e=this.config)==null?void 0:e.requiredFields)!=null&&t.includes(this.field.ckey)?!0:this.field.required===1}_onFieldBlur(e){var r;const{key:t,value:s}=e.detail,i=Be(this.field,s,this.config??void 0);if(i){this._error=i;return}this._error=null;const n=Q(this.field,s,void 0,(r=this.config)==null?void 0:r.language);this._dispatching=!0,this.dispatchEvent(new CustomEvent("field-blur",{detail:{key:t,value:n},bubbles:!0,composed:!0})),this._dispatching=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("field-blur",this._handleChildBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("field-blur",this._handleChildBlur)}_renderField(e,t){const s=this.disabled;switch(e.type){case"text":case"attachment-uri":return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`;case"textarea":return a`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-textarea-field>`;case"select-one":return a`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-select-field>`;case"multi-select":return a`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-multi-select-field>`;case"tags":return a`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${s}></sfx-meta-tags-field>`;case"boolean":return a`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return a`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-number-field>`;case"date":return a`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-date-field>`;case"geopoint":return a`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-geo-point-field>`;default:return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`}}render(){var s;const e=this.field;if(!e)return f;const t=Te(e,this.value,(s=this.config)==null?void 0:s.language);return a`
    ...
    `}};ue.styles=[Ge];let S=ue;M([c({attribute:!1})],S.prototype,"field");M([c({attribute:!1})],S.prototype,"value");M([c({attribute:!1})],S.prototype,"config");M([c({attribute:!1})],S.prototype,"autocomplete");M([c({type:Boolean})],S.prototype,"disabled");M([h()],S.prototype,"_error");customElements.define("sfx-metadata-field",S);var Ze=Object.defineProperty,le=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&Ze(e,t,i),i};class v extends w{constructor(){super(...arguments),this.value="",this.disabled=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{key:this.field.key,...t!==void 0?{value:t}:{}},bubbles:!0,composed:!0}))}}le([c({attribute:!1})],v.prototype,"field");le([c({attribute:!1})],v.prototype,"value");le([c({type:Boolean})],v.prototype,"disabled");const fe=class fe extends v{_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var e;return a`
      <input
        type="text"
        .value=${this.value??""}
      ...
      />
    `}};fe.styles=[G];let te=fe;customElements.define("sfx-meta-text-field",te);const he=class he extends v{firstUpdated(){const e=this.renderRoot.querySelector("textarea");e&&this._autoResize(e)}_autoResize(e){e.style.height="auto",e.style.height=`${Math.max(80,e.scrollHeight)}px`}_onInput(e){const t=e.target;this._autoResize(t),this._emit("field-change",t.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var e;return a`
      <textarea
        .value=${this.value??""}
        placeholder=${((e=this.field)==null?void 0:e.placeholder)??""}
        ?disabled=${this.disabled}
    ...
    `];let K=be;ce([h()],K.prototype,"_open");ce([h()],K.prototype,"_search");ce([h()],K.prototype,"_activeIndex");customElements.define("sfx-meta-multi-select-field",K);function P(o,e){var t,s;return((t=o.label)==null?void 0:t.trim().toLowerCase())===((s=e.label)==null?void 0:s.trim().toLowerCase())}function je(o){return o.trim().replace(/\s+/g," ")}function et(o){return je(o).replace(/\s/g,"-")}function Z(o){return{label:je(o),value:et(o)}}var tt=Object.defineProperty,J=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&tt(e,t,i),i};const ge=class ge extends v{constructor(){super(...arguments),this._query="",this._results=[],this._loading=!1,this._dropdownOpen=!1,this._activeIndex=-1,this._blurTimeout=null}get _tags(){return Array.isArray(this.value)?this.value:[]}disconnectedCallback(){var e;super.disconnectedCallback(),this._blurTimeout&&clearTimeout(this._blurTimeout),(e=this.autocomplete)==null||e.cancel()}_onInput(e){var s,i,n;const t=e.target.value;if(this._query=t,this._dropdownOpen=!0,this._activeIndex=-1,!t.trim()||!((s=this.field)!=null&&s.ckey)){this._results=[],this._loading=!1,(i=this.autocomplete)==null||i.cancel();return}this._loading=!0,(n=this.autocomplete)==null||n.search(this.field.ckey,t,r=>{this._results=r,this._loading=!1})}_addTag(e){if(this._tags.some(s=>P(s,e)))return;const t=[...this._tags,e];this.value=t,this._query="",this._results=[],this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-change",t),this.updateComplete.then(()=>{var s;(s=this.renderRoot.querySelector(".input"))==null||s.focus()})}_removeTag(e){const t=this._tags.filter(s=>!P(s,e));this.value=t,this._emit("field-change",t)}_onBlur(){this._blurTimeout&&clearTimeout(this._blurTimeout),this._blurTimeout=setTimeout(()=>{this._blurTimeout=null,this.renderRoot.querySelector(".dropdown:hover")||(this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-blur",this._tags))},150)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}get _itemCount(){return this._suggestions.length+(this._canCreate?1:0)}_onKeydown(e){if(e.key==="Escape"){this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-escape");return}if(e.key==="Backspace"&&!this._query&&this._tags.length){this._removeTag(this._tags[this._tags.length-1]);return}if(!this._dropdownOpen)return;const t=this._itemCount;if(this._activeIndex>=t&&(this._activeIndex=Math.max(t-1,-1)),!(t===0&&e.key!=="Enter"))switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,-1),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t-1,this._scrollActive();break;case"Enter":{e.preventDefault();const s=this._suggestions;this._activeIndex>=0&&this._activeIndex<s.length?this._addTag(s[this._activeIndex]):this._activeIndex===s.length&&this._canCreate?this._addTag(Z(this._query)):this._activeIndex===-1&&this._canCreate?this._addTag(Z(this._query)):this._activeIndex===-1&&s.length&&this._addTag(s[0]);break}}}get _suggestions(){var n;const e=this._query.toLowerCase().trim(),t=this._tags,s=(((n=this.field)==null?void 0:n.possible_values)??[]).map(r=>({value:r.api_value||r.internal_unique_value,label:r.label})).filter(r=>!t.some(l=>P(l,r))).filter(r=>!e||r.label.toLowerCase().includes(e)),i=this._results.filter(r=>!t.some(l=>P(l,r))&&!s.some(l=>P(l,r)));return[...s,...i]}get _canCreate(){const e=this._query.trim();if(!e||this._loading)return!1;const t=Z(e);return!this._tags.some(s=>P(s,t))&&!this._suggestions.some(s=>P(s,t))}render(){var i,n;const e=this._tags,t=this._suggestions,s=t.length;return a`
    ...
    `];let I=ge;J([c({attribute:!1})],I.prototype,"autocomplete");J([h()],I.prototype,"_query");J([h()],I.prototype,"_results");J([h()],I.prototype,"_loading");J([h()],I.prototype,"_dropdownOpen");J([h()],I.prototype,"_activeIndex");customElements.define("sfx-meta-tags-field",I);var it=Object.defineProperty,Re=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&it(e,t,i),i};const q=[{label:"True",value:"true"},{label:"False",value:"false"},{label:"None",value:"null"}],me=class me extends v{constructor(){super(...arguments),this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _currentLabel(){var t;const e=String(this.value??"null");return((t=q.find(s=>s.value===e))==null?void 0:t.label)??""}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_openDropdown(){this._open=!0;const e=String(this.value??"null");this._activeIndex=Math.max(q.findIndex(t=>t.value===e),0),document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".dropdown"))==null||t.focus()})}_closeAndSubmit(e=!1){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-blur",this.value),e&&this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".trigger"))==null||t.focus()})}_onOutsideClick(e){e.composedPath().includes(this)||this._closeAndSubmit()}_onSelect(e,t=!1){this.value=e.value,this._emit("field-change",e.value),this._closeAndSubmit(t)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){var t;if(e.key==="Escape"){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-escape"),(t=this.renderRoot.querySelector(".trigger"))==null||t.focus();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,q.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=q.length-1,this._scrollActive();break;case"Enter":case" ":this._activeIndex>=0&&this._activeIndex<q.length&&(e.preventDefault(),this._onSelect(q[this._activeIndex],!0));break}}render(){const e=String(this.value??"null");return a`
      <button class="trigger" ?disabled=${this.disabled}
        role="combobox" aria-expanded=${this._open} aria-haspopup="listbox"
        @click=${()=>!this._open&&this._openDropdown()}
        @keydown=${this._onKeydown}>
      ...
      `:f}
    `}};me.styles=[ae];let U=me;Re([h()],U.prototype,"_open");Re([h()],U.prototype,"_activeIndex");customElements.define("sfx-meta-boolean-field",U);const ve=class ve extends v{get _step(){var e;return((e=this.field)==null?void 0:e.type)==="decimal2"?"0.01":"1"}_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var e;return a`
      <input
        type="number"
        step=${this._step}
    ...
    `}};ve.styles=[G];let se=ve;customElements.define("sfx-meta-number-field",se);const _e=class _e extends v{get _dateStr(){const e=this.value;return e?e instanceof Date?e.toISOString().split("T")[0]:String(e):""}_onChange(e){const t=e.target.value;this._emit("field-change",t),this._emit("field-blur",t)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){return a`
      <input
        ...
        @keydown=${this._onKeydown}
      />
    `}};_e.styles=[G];let re=_e;customElements.define("sfx-meta-date-field",re);const ye=class ye extends v{get _geo(){const e=this.value;return{latitude:(e==null?void 0:e.latitude)??"",longitude:(e==null?void 0:e.longitude)??""}}_onInput(e,t){const s=t.target.value,i={...this._geo,[e]:s};this.value=i,this._emit("field-change",i)}_onBlur(e){const t=e.relatedTarget;t&&this.renderRoot.contains(t)||this._emit("field-blur",this._geo)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){const e=this._geo;return a`
      <div class="grid">
        <div>
    ...
    `];let ne=ye;customElements.define("sfx-meta-geo-point-field",ne);var st=Object.defineProperty,X=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&st(e,t,i),i};const we=class we extends w{constructor(){super(...arguments),this.disabled=!1}render(){const e=this.field,t=this.value,s=this.disabled;switch(e.type){case"text":case"attachment-uri":return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`;case"textarea":return a`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-textarea-field>`;case"select-one":return a`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-select-field>`;case"multi-select":return a`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-multi-select-field>`;case"tags":return a`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${s}></sfx-meta-tags-field>`;case"boolean":return a`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return a`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-number-field>`;case"date":return a`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-date-field>`;case"geopoint":return a`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-geo-point-field>`;default:return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${s}></sfx-meta-text-field>`}}};we.styles=x`
    :host { display: block; }
  `;let T=we;X([c({attribute:!1})],T.prototype,"field");X([c({attribute:!1})],T.prototype,"value");X([c({attribute:!1})],T.prototype,"autocomplete");X([c({type:Boolean})],T.prototype,"disabled");customElements.define("sfx-metadata-field-edit",T);var rt=Object.defineProperty,Ne=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&rt(e,t,i),i};const ke=class ke extends w{_formatValue(){var s,i;const e=this.value,t=(s=this.field)==null?void 0:s.type;switch(t){case"boolean":return e==="true"?"True":e==="false"?"False":"";case"date":return e?e instanceof Date?e.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"}):typeof e=="string"&&e.length>0?e:"":"";case"numeric":case"decimal2":{if(e==null||e==="")return"";const n=Number(e);return Number.isFinite(n)?n.toLocaleString(void 0,{maximumFractionDigits:t==="decimal2"?2:0}):String(e)}case"select-one":{if(e==null||e==="")return"";const n=(i=this.field.possible_values)==null?void 0:i.find(r=>r.internal_unique_value===e||r.api_value===e);return(n==null?void 0:n.label)??String(e)}case"multi-select":return!Array.isArray(e)||e.length===0?"":e.map(n=>{var l;const r=(l=this.field.possible_values)==null?void 0:l.find(d=>d.internal_unique_value===n||d.api_value===n);return(r==null?void 0:r.label)??String(n)}).join(", ");case"tags":return!Array.isArray(e)||e.length===0?"":e.map(n=>n.label||n.value).join(", ");case"geopoint":{const n=e;return!n||n.latitude===""||n.latitude==null||n.longitude===""||n.longitude==null?"":`(${n.latitude}, ${n.longitude})`}case"attachment-uri":return!e||typeof e=="string"&&e.length===0?"":String(e);case"text":case"textarea":default:return e==null||e===""?"":String(e)}}render(){var s;const e=this._formatValue(),t=e==="";return((s=this.field)==null?void 0:s.type)==="attachment-uri"&&!t?a`
        <div class="value">
  ...
  `;let Y=ke;Ne([c({attribute:!1})],Y.prototype,"field");Ne([c({attribute:!1})],Y.prototype,"value");customElements.define("sfx-metadata-field-view",Y);const Ae={key:"SET",label:"Set"},nt={key:"ADD",label:"Add"},ot={key:"DELETE",label:"Delete"},at=new Set(["multi-select","tags","integer-list"]);function lt(o){return at.has(o)?[Ae,nt,ot]:[Ae]}function Ke(o,e,t,s){switch(o){case"SET":return t;case"ADD":{const i=Array.isArray(e)?e:[],n=Array.isArray(t)?t:[];if(n.length===0)return i;if(s==="tags"){const d=new Set(i.map(b=>b)),p=[...i];for(const b of n){const u=typeof b=="string"?b:String(b);d.has(u)||(d.add(u),p.push(u))}return p}const r=new Set(i.map(d=>JSON.stringify(d))),l=[...i];for(const d of n){const p=JSON.stringify(d);r.has(p)||(r.add(p),l.push(d))}return l}case"DELETE":{const i=Array.isArray(e)?e:[],n=Array.isArray(t)?t:[];if(n.length===0)return i;if(s==="tags"){const l=new Set(n.map(d=>typeof d=="string"?d:String(d)));return i.filter(d=>!l.has(typeof d=="string"?d:String(d)))}const r=new Set(n.map(l=>JSON.stringify(l)));return i.filter(l=>!r.has(JSON.stringify(l)))}default:return t}}const dt=x`
  :host {
    display: block;
    font-family: var(--sfx-up-font, inherit);
    color: var(--sfx-up-text, #1e293b);
...
`;var xt=Object.defineProperty,E=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&xt(e,t,i),i};const $e=class $e extends w{constructor(){super(...arguments),this.files=[],this.config=null,this._activeFieldKey="",this._staged=new Map,this._selected=new Set,this._sortAsc=!0,this._pendingOp=null,this._originalFiles=new Map,this._onKeyDown=e=>{e.key!=="Escape"||e.composedPath().some(i=>i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement||i instanceof HTMLSelectElement)||this._confirmDiscardPending()&&this._emitClose()},this._onPendingChange=e=>{const{operation:t,value:s}=e.detail;A(s)?this._pendingOp=null:this._pendingOp={operation:t,value:s}},this._onFieldSelect=e=>{this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e.detail.fieldKey)},this._onBulkApply=e=>{var l;const t=this._activeField;if(!t)return;const{operation:s,value:i}=e.detail,n=(l=this.config)==null?void 0:l.language,r=[];for(const d of this._selected){const p=this._staged.get(d),b={meta:p?Object.fromEntries(p):{}},u=Q(t,i,b,n),k=p==null?void 0:p.get(t.key),_=Ke(s,k,u,t.type);r.push([d,t.key,_])}this._setStagedBulk(r)},this._onRowFieldChange=e=>{const t=this._activeField;t&&this._setStagedValue(e.detail.fileId,t.key,e.detail.value)},this._onRowToggle=e=>{const t=new Set(this._selected);t.has(e.detail.fileId)?t.delete(e.detail.fileId):t.add(e.detail.fileId),this._selected=t},this._onSelectAll=()=>{this._selected.size===this.files.length?this._selected=new Set:this._selected=new Set(this.files.map(e=>e.id))},this._onSortToggle=()=>{this._sortAsc=!this._sortAsc},this._onSave=()=>{if(!this._confirmDiscardPending())return;const e=[];for(const[t,s]of this._staged){const i=this._originalFiles.get(t);if(!i)continue;const n={};for(const[r,l]of s)JSON.stringify(l)!==JSON.stringify(i.meta[r])&&(n[r]=l);Object.keys(n).length>0&&e.push({fileId:t,meta:n})}this.dispatchEvent(new CustomEvent("metadata-save-batch",{detail:{changes:e},bubbles:!0,composed:!0})),this._emitClose()},this._onCancel=()=>{this._confirmDiscardPending()&&this._emitClose()},this._onClose=()=>{this._confirmDiscardPending()&&this._emitClose()}}connectedCallback(){super.connectedCallback(),this._initStaged(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown)}_initStaged(){var i,n;const e=new Map,t=new Set,s=new Map;for(const r of this.files){const l=new Map;if(r.meta)for(const[d,p]of Object.entries(r.meta))l.set(d,p);e.set(r.id,l),t.add(r.id),s.set(r.id,r)}this._staged=e,this._selected=t,this._originalFiles=s,((n=(i=this.schema)==null?void 0:i.fields)==null?void 0:n.length)>0&&(this._activeFieldKey=this.schema.fields[0].key)}_setStagedValue(e,t,s){const i=new Map(this._staged),n=new Map(i.get(e)??new Map);n.set(t,s),i.set(e,n),this._staged=i}_setStagedBulk(e){const t=new Map(this._staged);for(const[s,i,n]of e){const r=new Map(t.get(s)??new Map);r.set(i,n),t.set(s,r)}this._staged=t}get _activeField(){var e,t;return(t=(e=this.schema)==null?void 0:e.fieldsByKey)==null?void 0:t.get(this._activeFieldKey)}get _filledFields(){var t,s;const e=new Set;for(const i of((t=this.schema)==null?void 0:t.fields)??[])for(const[n,r]of this._staged){const l=r.get(i.key),d=(s=this._originalFiles.get(n))==null?void 0:s.meta[i.key];if(l!==void 0&&!A(l)&&JSON.stringify(l)!==JSON.stringify(d)){e.add(i.key);break}}return e}get _hasPendingValue(){return this._pendingOp!=null&&!A(this._pendingOp.value)}_confirmDiscardPending(){return this._hasPendingValue?confirm("You have unapplied bulk changes. Discard them?"):!0}_emitClose(){this.dispatchEvent(new CustomEvent("metadata-close",{bubbles:!0,composed:!0}))}get _sortedFiles(){const e=[...this.files];return e.sort((t,s)=>{const i=t.name.localeCompare(s.name)||t.id.localeCompare(s.id);return this._sortAsc?i:-i}),e}render(){var n,r;if(!((r=(n=this.schema)==null?void 0:n.fields)!=null&&r.length))return a`
    ...
    `}};$e.styles=[dt];let m=$e;E([c({attribute:!1})],m.prototype,"schema");E([c({attribute:!1})],m.prototype,"files");E([c({attribute:!1})],m.prototype,"config");E([c({attribute:!1})],m.prototype,"autocomplete");E([h()],m.prototype,"_activeFieldKey");E([h()],m.prototype,"_staged");E([h()],m.prototype,"_selected");E([h()],m.prototype,"_sortAsc");E([h()],m.prototype,"_pendingOp");customElements.define("sfx-bulk-metadata-modal",m);const Oe={text:a`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  </svg>`,numeric:a`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
    ${g`<line x1="6" y1="2" x2="4.5" y2="14"/><line x1="11.5" y1="2" x2="10" y2="14"/><line x1="3" y1="6" x2="13" y2="6"/><line x1="3" y1="10" x2="13" y2="10"/>`}
  </svg>`,decimal2:a`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
  ...
  </svg>`,tags:a`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  </svg>`};function bt(o){return Oe[o]??Oe.text}var gt=Object.defineProperty,W=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&gt(e,t,i),i};const Ce=class Ce extends w{constructor(){super(...arguments),this.activeFieldKey="",this.filledFields=new Set,this.config=null,this._collapsed=new Set}_isRequired(e){var t,s;return(s=(t=this.config)==null?void 0:t.requiredFields)!=null&&s.includes(e.ckey)?!0:e.required===1}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_onFieldClick(e){this.dispatchEvent(new CustomEvent("field-select",{detail:{fieldKey:e},bubbles:!0,composed:!0}))}render(){return this.schema?a`
      ${this.schema.groups.map(e=>{const t=!this._collapsed.has(e.uuid);return a`
          <button
            class="group-label"
            @click=${()=>this._toggleGroup(e.uuid)}
            aria-expanded=${t}
    ...
    `}},F.styles=[pt],F);L([c({attribute:!1})],D.prototype,"field");L([c({attribute:!1})],D.prototype,"autocomplete");L([c({attribute:!1})],D.prototype,"config");L([c({type:Number})],D.prototype,"selectedCount");L([h()],D.prototype,"_operation");L([h()],D.prototype,"_value");L([h()],D.prototype,"_opDropdownOpen");let vt=D;customElements.define("sfx-bulk-meta-op-bar",vt);var _t=Object.defineProperty,j=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&_t(e,t,i),i};const Se=class Se extends w{constructor(){super(...arguments),this.files=[],this.staged=new Map,this.selected=new Set,this.config=null,this.pendingOp=null}_getEffectiveValue(e){var t;return((t=this.staged.get(e.id))==null?void 0:t.get(this.field.key))??e.meta[this.field.key]}render(){return a`
      ${this.files.map(e=>a`
          <sfx-bulk-meta-row
            .file=${e}
            .field=${this.field}
          ...
          ></sfx-bulk-meta-row>
        `)}
    `}};Se.styles=[ht];let $=Se;j([c({attribute:!1})],$.prototype,"files");j([c({attribute:!1})],$.prototype,"field");j([c({attribute:!1})],$.prototype,"staged");j([c({attribute:!1})],$.prototype,"selected");j([c({attribute:!1})],$.prototype,"config");j([c({attribute:!1})],$.prototype,"autocomplete");j([c({attribute:!1})],$.prototype,"pendingOp");customElements.define("sfx-bulk-meta-table",$);const yt=new Set(["multi-select","tags","integer-list"]);function De(o,e,t){return!e.regional_variants_group_uuid||o==null||typeof o!="object"||Array.isArray(o)?o:o[t??"en"]}function ze(o){return Array.isArray(o)?o:[]}function Pe(o){return!!(o==null||o===""||Array.isArray(o)&&o.length===0)}function oe(o,e){var s;const t=(s=o.possible_values)==null?void 0:s.find(i=>i.internal_unique_value===e||i.api_value===e);return(t==null?void 0:t.label)??String(e)}function qe(o,e){if(e==null||e==="")return"";switch(o.type){case"boolean":return e===!0?"True":e===!1?"False":"None";case"date":{if(typeof e!="string"||e.length===0)return"";try{return new Date(e+"T00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return e}}case"numeric":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:0}):String(e)}case"decimal2":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:2}):String(e)}case"select-one":return oe(o,String(e));case"geopoint":{if(typeof e=="string"){const t=e.match(/^\((.+),(.+)\)$/);if(t)return`(${t[1].trim()}, ${t[2].trim()})`}return String(e)}default:return String(e)}}function wt(o,e){const t=o.map(l=>typeof l=="string"?l:String(l)),s=e.map(l=>typeof l=="string"?l:String(l)),i=new Set(t),n=new Set(s),r=[];for(const l of s)r.push({label:l,state:i.has(l)?"kept":"added"});for(const l of t)n.has(l)||r.push({label:l,state:"removed"});return r}function kt(o,e,t){const s=new Set(o.map(r=>JSON.stringify(r))),i=new Set(e.map(r=>JSON.stringify(r))),n=[];for(const r of e){const l=JSON.stringify(r),d=typeof r=="string"?oe(t,r):String(r);n.push({label:d,state:s.has(l)?"kept":"added"})}for(const r of o){const l=JSON.stringify(r);if(!i.has(l)){const d=typeof r=="string"?oe(t,r):String(r);n.push({label:d,state:"removed"})}}return n}function $t(o,e,t,s){const i=s==null?void 0:s.language,n=De(e,o,i),r=De(t,o,i);if(yt.has(o.type)){const l=ze(n),d=ze(r);return o.type==="tags"?{kind:"array",items:wt(l,d)}:{kind:"array",items:kt(l,d,o)}}return{kind:"scalar",oldDisplay:qe(o,n),newDisplay:qe(o,r),oldEmpty:Pe(n),newEmpty:Pe(r)}}var Ct=Object.defineProperty,ee=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&Ct(e,t,i),i};const Ie=class Ie extends w{constructor(){super(...arguments),this.config=null}_renderArrayDiff(e){return a`
      <div class="diff-wrap" aria-label="Bulk operation preview">
        ${e.items.length===0?a`<span class="diff-chip diff-chip--kept" style="opacity:0.5">\u2014</span>`:e.items.map(t=>a`
                <span
    ...
    `}render(){if(!this.field)return f;const e=$t(this.field,this.oldValue,this.newValue,this.config);return e.kind==="array"?this._renderArrayDiff(e):this._renderScalarDiff(e)}};Ie.styles=[ft];let B=Ie;ee([c({attribute:!1})],B.prototype,"field");ee([c({attribute:!1})],B.prototype,"oldValue");ee([c({attribute:!1})],B.prototype,"newValue");ee([c({attribute:!1})],B.prototype,"config");customElements.define("sfx-bulk-meta-diff-view",B);var St=Object.defineProperty,z=(o,e,t,s)=>{for(var i=void 0,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=r(e,t,i)||i);return i&&St(e,t,i),i};const Ee=class Ee extends w{constructor(){super(...arguments),this.selected=!1,this.config=null,this.pendingOp=null,this._error=null,this._onFieldBlur=e=>{var r;e.stopPropagation();const{value:t}=e.detail,s=Be(this.field,t,this.config??void 0);if(s){this._error=s;return}this._error=null;const i={meta:{...this.file.meta,[this.field.key]:this.value}},n=Q(this.field,t,i,(r=this.config)==null?void 0:r.language);JSON.stringify(n)!==JSON.stringify(this.value)&&this.dispatchEvent(new CustomEvent("row-field-change",{detail:{fileId:this.file.id,value:n},bubbles:!0,composed:!0}))}}willUpdate(e){e.has("field")&&(this._error=null)}_onCheckboxChange(){this.dispatchEvent(new CustomEvent("row-toggle",{detail:{fileId:this.file.id},bubbles:!0,composed:!0}))}_getExtension(e){const t=e.lastIndexOf(".");return t>0?e.slice(t+1).toUpperCase():"?"}_computePreview(){var l;if(!this.pendingOp)return null;const{operation:e,value:t}=this.pendingOp,s=(l=this.config)==null?void 0:l.language,i={meta:{...this.file.meta,[this.field.key]:this.value}},n=Q(this.field,t,i,s),r=Ke(e,this.value,n,this.field.type);return JSON.stringify(r)===JSON.stringify(this.value)?null:r}render(){var i;const e=this.file,t=this._computePreview(),s=t!==null;return a`
    ...
    `}};Ee.styles=[ut];let y=Ee;z([c({attribute:!1})],y.prototype,"file");z([c({attribute:!1})],y.prototype,"field");z([c({attribute:!1})],y.prototype,"value");z([c({type:Boolean})],y.prototype,"selected");z([c({attribute:!1})],y.prototype,"config");z([c({attribute:!1})],y.prototype,"autocomplete");z([c({attribute:!1})],y.prototype,"pendingOp");z([h()],y.prototype,"_error");customElements.define("sfx-bulk-meta-row",y);export{m as SfxBulkMetadataModal,At as clearSchemaCache,zt as createTagsAutocomplete,Dt as deepMergeMeta,Et as fetchMetadataSchema,Ot as getFilesWithMissingRequired,Ue as isAssetHasMetadataValue,A as isEmpty,Te as mapValueFromBackend,Q as mapValueToBackend,Fe as parseMetadataSchema,Be as validateField};
