import{i as w,a as g,A as x,c as a,n as p,r as h,o as Me,v as Ye,p as ee,w as v,q as it,t as B,u as Fe,P as st,x as rt,y as ot,z as He,B as Ke,C as nt,D as at,E as lt}from"./index-C9EefZhW.js";import{F as Gt,G as Wt,H as Xt}from"./index-C9EefZhW.js";function Je(n,e,t=!1){const i=(e==null?void 0:e.language)??"en",s=n.model??[],o=n.store??{},r=s.find(f=>f.applies_to==="FILES");let l=(r==null?void 0:r.groups)??[];if(Array.isArray(e==null?void 0:e.fields)){const f=new Set(e.fields);l=l.map(m=>({...m,fields:m.fields.filter(Q=>f.has(Q.ckey))})).filter(m=>m.fields.length>0)}l=l.map(f=>({...f,fields:f.fields.filter(m=>!m.hide)})).filter(f=>f.fields.length>0);const d=l.flatMap(f=>f.fields),c=new Map(d.map(f=>[f.key,f])),u=o.force_filling_metadata_on_upload===!0,b=o.regional_variants_groups??[];return{groups:l,fields:d,fieldsByKey:c,forceFillingOnUpload:u,regionalVariantsGroups:b,language:i,productsEnabled:t}}const dt="https://hub.scaleflex.com/api",J=new Map,j=new Map;async function Mt(n,e,t,i){const s=J.get(t);if(s)return s;const o=j.get(t);if(o)return o;if(i!=null&&i.rawMetadata){const l=Je(i.rawMetadata,i,i.productsEnabled===!0);return J.set(t,l),l}const r=pt(e,t,i);j.set(t,r);try{const l=await r;return J.set(t,l),l}finally{j.delete(t)}}async function pt(n,e,t){var u,b,f,m,Q;const s=`${(t==null?void 0:t.hubApiBase)??dt}/project/${encodeURIComponent(e)}`,o=(t==null?void 0:t.hubHeaders)??n,r=await fetch(s,{headers:o});if(!r.ok)throw new Error(`Failed to fetch metadata schema (HTTP ${r.status})`);const l=await r.json(),d=((b=(u=l.data)==null?void 0:u.project)==null?void 0:b.data)??((f=l.project)==null?void 0:f.data);if(!(d!=null&&d.metadata))throw new Error("No metadata in project response");const c=(t==null?void 0:t.productsEnabled)??((Q=(m=d==null?void 0:d.airstore)==null?void 0:m.ui)==null?void 0:Q.products_enabled)===!0;return Je(d.metadata,t,c)}function Yt(n){var e;n?(J.delete(n),(e=j.get(n))==null||e.catch(()=>{}),j.delete(n)):(J.clear(),j.clear())}function Ue(n,e,t){let i=e;switch(n.regional_variants_group_uuid&&i!=null&&typeof i=="object"&&!Array.isArray(i)&&(i=i[t??"en"]),n.type){case"geopoint":return ct(i);case"boolean":return i===!0?"true":i===!1?"false":"null";case"date":return i?new Date(i):null;case"decimal2":return i!=null?String(i):"";case"tags":return Array.isArray(i)?i.map(s=>typeof s=="string"?{value:s,label:s}:s):[];case"multi-select":return i||[];default:return i??""}}function fe(n,e,t,i){var o;let s;switch(n.type){case"geopoint":{const r=e;!r||r.latitude===""||r.latitude==null||r.longitude===""||r.longitude==null?s=null:s=`(${r.latitude},${r.longitude})`;break}case"boolean":e==="true"?s=!0:e==="false"?s=!1:s=null;break;case"date":{if(!e)s=null;else{const r=e instanceof Date?e:new Date(e),l=r.getFullYear(),d=String(r.getMonth()+1).padStart(2,"0"),c=String(r.getDate()).padStart(2,"0");s=`${l}-${d}-${c}`}break}case"tags":s=Array.isArray(e)?e.map(r=>(r==null?void 0:r.label)??""):[];break;case"select-one":s=e===""?null:e;break;case"numeric":{if(e===""||e==null){s=null;break}const r=Number(e);s=Number.isFinite(r)?Math.round(r):null;break}case"decimal2":{if(e===""||e==null){s=null;break}const r=Number(e);s=Number.isFinite(r)?r:null;break}default:s=e}if(n.regional_variants_group_uuid){const r=i??"en";return{...((o=t==null?void 0:t.meta)==null?void 0:o[n.key])??{},[r]:s}}return s}function ct(n){if(typeof n=="string"){const e=/\(([^)]+)\)/.exec(n);if(e){const t=e[1].split(",");if(t.length===2)return{latitude:t[0].trim(),longitude:t[1].trim()}}}return{latitude:"",longitude:""}}function Ht(n,e){let t=null,i=null,s=!1;return{search(o,r,l){if(t&&clearTimeout(t),i&&i.abort(),s=!1,!r.trim()){l([]);return}t=setTimeout(async()=>{var d;i=new AbortController;try{const c=`${n}/v5/metadata/autocomplete?q=${encodeURIComponent(r.trim())}&meta_key=_${encodeURIComponent(o)}&limit=20`,u=await fetch(c,{headers:e,signal:i.signal});if(s)return;if(!u.ok){l([]);return}const b=await u.json();if(s)return;const f=((d=b.data)==null?void 0:d.tags)??b.tags??[];l(f.map(m=>({sid:m.sid||void 0,value:m.tag||m.value||m.label||"",label:m.tag||m.label||m.value||""})))}catch{s||l([])}},200)},cancel(){s=!0,t&&clearTimeout(t),i&&i.abort()}}}var ut=Object.defineProperty,M=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&ut(e,t,s),s};const ge=class ge extends w{constructor(){super(...arguments),this.schema=null,this.meta={},this.config=null,this.disabled=!1,this._collapsed=new Set}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_renderGroup(e){const t=!this._collapsed.has(e.uuid);return a`
      <div class="group">
  ...
  `;let A=ge;M([p({attribute:!1})],A.prototype,"schema");M([p({attribute:!1})],A.prototype,"meta");M([p({attribute:!1})],A.prototype,"config");M([p({attribute:!1})],A.prototype,"autocomplete");M([p({type:Boolean})],A.prototype,"disabled");M([h()],A.prototype,"_collapsed");customElements.define("sfx-metadata-form",A);const X=g`
...
`;var ht=Object.defineProperty,Y=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&ht(e,t,s),s};const ve=class ve extends w{constructor(){super(...arguments),this.config=null,this.disabled=!1,this._error=null,this._dispatching=!1,this._handleChildBlur=e=>{this._dispatching||(e.stopPropagation(),this._onFieldBlur(e))}}get _isRequired(){return Me(this.field,this.config??void 0)}_onFieldBlur(e){var r;const{key:t,value:i}=e.detail,s=Ye(this.field,i,this.config??void 0);if(s){this._error=s;return}this._error=null;const o=fe(this.field,i,void 0,(r=this.config)==null?void 0:r.language);this._dispatching=!0,this.dispatchEvent(new CustomEvent("field-blur",{detail:{key:t,value:o},bubbles:!0,composed:!0})),this._dispatching=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("field-blur",this._handleChildBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("field-blur",this._handleChildBlur)}_renderField(e,t){const i=this.disabled;if(ee(e))return a`<sfx-meta-unsupported-field></sfx-meta-unsupported-field>`;switch(e.type){case"text":case"attachment-uri":return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`;case"textarea":return a`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-textarea-field>`;case"select-one":return a`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-select-field>`;case"multi-select":return a`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-multi-select-field>`;case"tags":return a`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${i}></sfx-meta-tags-field>`;case"boolean":return a`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return a`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-number-field>`;case"date":return a`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-date-field>`;case"geopoint":return a`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-geo-point-field>`;default:return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`}}render(){var o;const e=this.field;if(!e)return x;const t=Ue(e,this.value,(o=this.config)==null?void 0:o.language),s=e.type==="textarea"?"field-row field-row--top":"field-row";return a`
    ...
    `}};ve.styles=[ft];let I=ve;Y([p({attribute:!1})],I.prototype,"field");Y([p({attribute:!1})],I.prototype,"value");Y([p({attribute:!1})],I.prototype,"config");Y([p({attribute:!1})],I.prototype,"autocomplete");Y([p({type:Boolean})],I.prototype,"disabled");Y([h()],I.prototype,"_error");customElements.define("sfx-metadata-field",I);var xt=Object.defineProperty,xe=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&xt(e,t,s),s};class k extends w{constructor(){super(...arguments),this.value="",this.disabled=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{key:this.field.key,...t!==void 0?{value:t}:{}},bubbles:!0,composed:!0}))}}xe([p({attribute:!1})],k.prototype,"field");xe([p({attribute:!1})],k.prototype,"value");xe([p({type:Boolean})],k.prototype,"disabled");const ye=class ye extends k{_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var i,s;const e=((i=this.field)==null?void 0:i.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return a`
      <input
        type="text"
        .value=${this.value??""}
      ...
      />
    `}};ye.styles=[X];let oe=ye;customElements.define("sfx-meta-text-field",oe);const _e=class _e extends k{firstUpdated(){const e=this.renderRoot.querySelector("textarea");e&&this._autoResize(e)}_autoResize(e){e.style.height="auto",e.style.height=`${Math.max(80,e.scrollHeight)}px`}_onInput(e){const t=e.target;this._autoResize(t),this._emit("field-change",t.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var i,s;const e=((i=this.field)==null?void 0:i.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return a`
      <textarea
        .value=${this.value??""}
        placeholder=${((s=this.field)==null?void 0:s.placeholder)||t}
        ?disabled=${this.disabled}
    ...
    `];let V=ke;me([h()],V.prototype,"_open");me([h()],V.prototype,"_search");me([h()],V.prototype,"_activeIndex");customElements.define("sfx-meta-multi-select-field",V);function T(n,e){var t,i;return((t=n.label)==null?void 0:t.trim().toLowerCase())===((i=e.label)==null?void 0:i.trim().toLowerCase())}function We(n){return n.trim().replace(/\s+/g," ")}function gt(n){return We(n).replace(/\s/g,"-")}function Z(n){return{label:We(n),value:gt(n)}}var vt=Object.defineProperty,H=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&vt(e,t,s),s};const $e=class $e extends k{constructor(){super(...arguments),this._query="",this._results=[],this._loading=!1,this._dropdownOpen=!1,this._activeIndex=-1,this._blurTimeout=null}get _tags(){return Array.isArray(this.value)?this.value:[]}disconnectedCallback(){var e;super.disconnectedCallback(),this._blurTimeout&&clearTimeout(this._blurTimeout),(e=this.autocomplete)==null||e.cancel()}_onInput(e){var i,s,o;const t=e.target.value;if(this._query=t,this._dropdownOpen=!0,this._activeIndex=-1,!t.trim()||!((i=this.field)!=null&&i.ckey)){this._results=[],this._loading=!1,(s=this.autocomplete)==null||s.cancel();return}this._loading=!0,(o=this.autocomplete)==null||o.search(this.field.ckey,t,r=>{this._results=r,this._loading=!1})}_addTag(e){if(this._tags.some(i=>T(i,e)))return;const t=[...this._tags,e];this.value=t,this._query="",this._results=[],this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-change",t),this.updateComplete.then(()=>{var i;(i=this.renderRoot.querySelector(".input"))==null||i.focus()})}_removeTag(e){const t=this._tags.filter(i=>!T(i,e));this.value=t,this._emit("field-change",t)}_onBlur(){this._blurTimeout&&clearTimeout(this._blurTimeout),this._blurTimeout=setTimeout(()=>{this._blurTimeout=null,this.renderRoot.querySelector(".dropdown:hover")||(this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-blur",this._tags))},150)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}get _itemCount(){return this._suggestions.length+(this._canCreate?1:0)}_onKeydown(e){if(e.key==="Escape"){this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-escape");return}if(e.key==="Backspace"&&!this._query&&this._tags.length){this._removeTag(this._tags[this._tags.length-1]);return}if(!this._dropdownOpen)return;const t=this._itemCount;if(this._activeIndex>=t&&(this._activeIndex=Math.max(t-1,-1)),!(t===0&&e.key!=="Enter"))switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,-1),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t-1,this._scrollActive();break;case"Enter":{e.preventDefault();const i=this._suggestions;this._activeIndex>=0&&this._activeIndex<i.length?this._addTag(i[this._activeIndex]):this._activeIndex===i.length&&this._canCreate?this._addTag(Z(this._query)):this._activeIndex===-1&&this._canCreate?this._addTag(Z(this._query)):this._activeIndex===-1&&i.length&&this._addTag(i[0]);break}}}get _suggestions(){var o;const e=this._query.toLowerCase().trim(),t=this._tags,i=(((o=this.field)==null?void 0:o.possible_values)??[]).map(r=>({value:r.api_value||r.internal_unique_value,label:r.label})).filter(r=>!t.some(l=>T(l,r))).filter(r=>!e||r.label.toLowerCase().includes(e)),s=this._results.filter(r=>!t.some(l=>T(l,r))&&!i.some(l=>T(l,r)));return[...i,...s]}get _canCreate(){const e=this._query.trim();if(!e||this._loading)return!1;const t=Z(e);return!this._tags.some(i=>T(i,t))&&!this._suggestions.some(i=>T(i,t))}render(){var s,o;const e=this._tags,t=this._suggestions,i=t.length;return a`
        ...
        <div class="dropdown" role="listbox">
          ...
          ${this._canCreate?a`
            <div class="option create ${i===this._activeIndex?"active":""}"
              @mousedown=${r=>{r.preventDefault(),this._addTag(Z(this._query))}}
    ...
    `];let O=$e;H([p({attribute:!1})],O.prototype,"autocomplete");H([h()],O.prototype,"_query");H([h()],O.prototype,"_results");H([h()],O.prototype,"_loading");H([h()],O.prototype,"_dropdownOpen");H([h()],O.prototype,"_activeIndex");customElements.define("sfx-meta-tags-field",O);var yt=Object.defineProperty,Xe=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&yt(e,t,s),s};const R=[{label:"True",value:"true"},{label:"False",value:"false"}],Ce=class Ce extends k{constructor(){super(...arguments),this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _currentLabel(){var t;if(this.value==null)return"";const e=String(this.value);return((t=R.find(i=>i.value===e))==null?void 0:t.label)??""}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_openDropdown(){this._open=!0;const e=this.value==null?"":String(this.value);this._activeIndex=Math.max(R.findIndex(t=>t.value===e),0),document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".dropdown"))==null||t.focus()})}_closeAndSubmit(e=!1){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-blur",this.value),e&&this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".trigger"))==null||t.focus()})}_onOutsideClick(e){e.composedPath().includes(this)||this._closeAndSubmit()}_onSelect(e,t=!1){this.value=e.value,this._emit("field-change",e.value),this._closeAndSubmit(t)}_clear(e){e.stopPropagation(),this.value=null,this._emit("field-change",null),this._emit("field-blur",null)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){var t;if(e.key==="Escape"){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-escape"),(t=this.renderRoot.querySelector(".trigger"))==null||t.focus();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,R.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=R.length-1,this._scrollActive();break;case"Enter":case" ":this._activeIndex>=0&&this._activeIndex<R.length&&(e.preventDefault(),this._onSelect(R[this._activeIndex],!0));break}}render(){var s,o;const e=this.value==null?"":String(this.value),t=((s=this.field)==null?void 0:s.title)??"",i=t?`Select ${t.toLowerCase()}`:"Select an option";return a`
      <button class="trigger" ?disabled=${this.disabled}
        role="combobox" aria-expanded=${this._open} aria-haspopup="listbox"
        @click=${()=>this._open?this._closeAndSubmit(!0):this._openDropdown()}
        @keydown=${this._onKeydown}>
    ...
    `];let le=Ee;customElements.define("sfx-meta-date-field",le);const Ae=class Ae extends k{get _geo(){const e=this.value;return{latitude:(e==null?void 0:e.latitude)??"",longitude:(e==null?void 0:e.longitude)??""}}_onInput(e,t){const i=t.target.value,s={...this._geo,[e]:i};this.value=s,this._emit("field-change",s)}_onBlur(e){const t=e.relatedTarget;t&&this.renderRoot.contains(t)||this._emit("field-blur",this._geo)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){const e=this._geo;return a`
      <div class="grid">
        <div>
    ...
    `];let de=Ae;customElements.define("sfx-meta-geo-point-field",de);const G="This field is not supported during upload. You can edit it later in the asset library.",Qe=a`
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ${v`<rect x="3" y="7" width="10" height="7" rx="1.5"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/>`}
  </svg>
`,Ie=class Ie extends w{render(){return a`
      <div
        class="unsupported"
        title=${G}
        aria-label=${G}
  ...
  `;let pe=Ie;customElements.define("sfx-meta-unsupported-field",pe);var _t=Object.defineProperty,te=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&_t(e,t,s),s};const Oe=class Oe extends w{constructor(){super(...arguments),this.disabled=!1}render(){const e=this.field,t=this.value,i=this.disabled;if(ee(e))return a`<sfx-meta-unsupported-field></sfx-meta-unsupported-field>`;switch(e.type){case"text":case"attachment-uri":return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`;case"textarea":return a`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-textarea-field>`;case"select-one":return a`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-select-field>`;case"multi-select":return a`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-multi-select-field>`;case"tags":return a`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${i}></sfx-meta-tags-field>`;case"boolean":return a`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return a`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-number-field>`;case"date":return a`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-date-field>`;case"geopoint":return a`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-geo-point-field>`;default:return a`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`}}};Oe.styles=g`
    :host { display: block; }
  `;let q=Oe;te([p({attribute:!1})],q.prototype,"field");te([p({attribute:!1})],q.prototype,"value");te([p({attribute:!1})],q.prototype,"autocomplete");te([p({type:Boolean})],q.prototype,"disabled");customElements.define("sfx-metadata-field-edit",q);var wt=Object.defineProperty,Ze=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&wt(e,t,s),s};const ze=class ze extends w{_formatValue(){var i,s;const e=this.value,t=(i=this.field)==null?void 0:i.type;switch(t){case"boolean":return e==="true"?"True":e==="false"?"False":"";case"date":return e?e instanceof Date?e.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"}):typeof e=="string"&&e.length>0?e:"":"";case"numeric":case"decimal2":{if(e==null||e==="")return"";const o=Number(e);return Number.isFinite(o)?o.toLocaleString(void 0,{maximumFractionDigits:t==="decimal2"?2:0}):String(e)}case"select-one":{if(e==null||e==="")return"";const o=(s=this.field.possible_values)==null?void 0:s.find(r=>r.internal_unique_value===e||r.api_value===e);return(o==null?void 0:o.label)??String(e)}case"multi-select":return!Array.isArray(e)||e.length===0?"":e.map(o=>{var l;const r=(l=this.field.possible_values)==null?void 0:l.find(d=>d.internal_unique_value===o||d.api_value===o);return(r==null?void 0:r.label)??String(o)}).join(", ");case"tags":return!Array.isArray(e)||e.length===0?"":e.map(o=>o.label||o.value).join(", ");case"geopoint":{const o=e;return!o||o.latitude===""||o.latitude==null||o.longitude===""||o.longitude==null?"":`(${o.latitude}, ${o.longitude})`}case"attachment-uri":return!e||typeof e=="string"&&e.length===0?"":String(e);case"text":case"textarea":default:return e==null||e===""?"":String(e)}}render(){var i;if(this.field&&ee(this.field))return a`
        <div class="value empty" title=${G}>
          Not editable during upload
        </div>
      `;const e=this._formatValue(),t=e==="";return((i=this.field)==null?void 0:i.type)==="attachment-uri"&&!t?a`
        <div class="value">
  ...
  `;let W=ze;Ze([p({attribute:!1})],W.prototype,"field");Ze([p({attribute:!1})],W.prototype,"value");customElements.define("sfx-metadata-field-view",W);const ie=new Set(["multi-select","tags"]),se=new Set(["text","textarea","attachment-uri"]);function kt(n){return it(n)?[]:ie.has(n)?[{key:"SET",label:"Set"},{key:"ADD",label:"Add to"},{key:"DELETE",label:"Remove from"}]:se.has(n)?[{key:"SET",label:"Set"},{key:"ADD",label:"Append"},{key:"DELETE",label:"Remove"}]:[{key:"SET",label:"Set"},{key:"DELETE",label:"Clear"}]}function ce(n,e){return n==="DELETE"?ie.has(e)||se.has(e):!0}function $t(n,e,t,i){const s=ie.has(i),o=se.has(i);switch(n){case"SET":return t;case"ADD":{if(s){const r=Array.isArray(e)?e:[],l=Array.isArray(t)?t:[];if(l.length===0)return r;if(i==="tags"){const u=new Set(r.map(f=>f)),b=[...r];for(const f of l){const m=typeof f=="string"?f:String(f);u.has(m)||(u.add(m),b.push(m))}return b}const d=new Set(r.map(u=>JSON.stringify(u))),c=[...r];for(const u of l){const b=JSON.stringify(u);d.has(b)||(d.add(b),c.push(u))}return c}if(o){const r=typeof t=="string"?t:"";if(!r)return e??"";const l=typeof e=="string"?e:"";return l?`${l} ${r}`:r}return t}case"DELETE":{if(s){const r=Array.isArray(e)?e:[],l=Array.isArray(t)?t:[];if(l.length===0)return r;if(i==="tags"){const c=new Set(l.map(u=>typeof u=="string"?u:String(u)));return r.filter(u=>!c.has(typeof u=="string"?u:String(u)))}const d=new Set(l.map(c=>JSON.stringify(c)));return r.filter(c=>!d.has(JSON.stringify(c)))}if(o){const r=typeof t=="string"?t:"";return r?(typeof e=="string"?e:"").replaceAll(r,"").replace(/\s{2,}/g," ").trim():""}return i==="geopoint"?{latitude:"",longitude:""}:null}default:return t}}function et(n,e,t,i,s){const o=s??"en",r=!!n.regional_variants_group_uuid,l={meta:{[n.key]:e}},d=fe(n,t,l,s),c=m=>r&&m!==null&&typeof m=="object"&&!Array.isArray(m),u=c(e)?e[o]:e,b=c(d)?d[o]:d,f=$t(i,u,b,n.type);return r?{...c(e)?e:{},[o]:f}:f}const tt=g`
  .fm-checkbox {
...
`;var zt=Object.defineProperty,_=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&zt(e,t,s),s};const De=class De extends w{constructor(){super(...arguments),this.files=[],this.config=null,this.initialFieldKey=null,this._activeFieldKey="",this._staged=new Map,this._selected=new Set,this._sortAsc=!0,this._pendingOp=null,this._confirmVisible=!1,this._missingRequiredFieldKey=null,this._missingRequiredKeys=new Set,this._confirmResolve=null,this._originalFiles=new Map,this._onKeyDown=async e=>{if(e.key!=="Escape")return;if(this._confirmVisible){e.stopPropagation(),this._onConfirmCancel();return}e.composedPath().some(s=>s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement)||await this._confirmDiscardPending()&&this._emitClose()},this._onConfirmOk=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!0),this._confirmResolve=null},this._onConfirmCancel=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null},this._onConfirmKeydown=e=>{var l,d;if(e.key!=="Tab")return;const t=(l=this.shadowRoot)==null?void 0:l.querySelector(".fm-confirm");if(!t)return;const i=t.querySelectorAll("button");if(i.length===0)return;const s=i[0],o=i[i.length-1],r=(d=this.shadowRoot)==null?void 0:d.activeElement;e.shiftKey&&r===s?(e.preventDefault(),o.focus()):!e.shiftKey&&r===o&&(e.preventDefault(),s.focus())},this._onPendingChange=e=>{const{operation:t,value:i}=e.detail,s=this._activeField;B(i)&&(!s||ce(t,s.type))?this._pendingOp=null:this._pendingOp={operation:t,value:i}},this._onFieldSelect=async e=>{await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e.detail.fieldKey)},this._onJumpToNextRequired=async()=>{const e=this._missingRequiredFieldKey;e&&this._activeFieldKey!==e&&await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e)},this._onBulkApply=e=>{var l;const t=this._activeField;if(!t)return;const{operation:i,value:s}=e.detail,o=(l=this.config)==null?void 0:l.language,r=[];for(const d of this._selected){const c=this._staged.get(d),u=c!=null&&c.has(t.key)?c.get(t.key):this._originalValue(d,t.key)??null,b=et(t,u,s,i,o);r.push([d,t.key,b])}this._setStagedBulk(r)},this._onRowFieldChange=e=>{const t=this._activeField;t&&this._setStagedValue(e.detail.fileId,t.key,e.detail.value)},this._onRowToggle=e=>{const t=new Set(this._selected);t.has(e.detail.fileId)?t.delete(e.detail.fileId):t.add(e.detail.fileId),this._selected=t},this._onSelectAll=()=>{this._selected.size===this.files.length?this._selected=new Set:this._selected=new Set(this.files.map(e=>e.id))},this._onSortToggle=()=>{this._sortAsc=!this._sortAsc},this._onSave=async()=>{if(this._missingRequiredFieldKey!=null||!await this._confirmDiscardPending())return;const e=[],t=[];for(const[i,s]of this._staged){if(!this._originalFiles.get(i))continue;const r={},l={};for(const[d,c]of s){const u=this._originalValue(i,d);if(JSON.stringify(c)!==JSON.stringify(u))if(Fe(d)){const b=Ke(d);if(!b)continue;const f=c===""||c==null;b==="position"?l.position=f?void 0:Number(c):l.ref=f?void 0:String(c)}else r[d]=c}Object.keys(r).length>0&&e.push({fileId:i,meta:r}),Object.keys(l).length>0&&t.push({fileId:i,product:l})}this.dispatchEvent(new CustomEvent("metadata-save-batch",{detail:{changes:e},bubbles:!0,composed:!0})),t.length>0&&this.dispatchEvent(new CustomEvent("product-save-batch",{detail:{changes:t},bubbles:!0,composed:!0})),this._emitClose()},this._onCancel=async()=>{await this._confirmDiscardPending()&&this._emitClose()},this._onClose=async()=>{await this._confirmDiscardPending()&&this._emitClose()}}connectedCallback(){super.connectedCallback(),this._initStaged(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null}_initStaged(){var r,l;const e=new Map,t=new Set,i=new Map,s=((r=this.schema)==null?void 0:r.productsEnabled)===!0;for(const d of this.files){const c=new Map;if(d.meta)for(const[u,b]of Object.entries(d.meta))c.set(u,b);if(s){const u=d.product;u.ref!==void 0&&c.set(st,u.ref),u.position!==void 0&&c.set(rt,u.position)}e.set(d.id,c),t.add(d.id),i.set(d.id,d)}this._staged=e,this._selected=t,this._originalFiles=i;const o=this.initialFieldKey;o&&((l=this.schema)!=null&&l.fieldsByKey.has(o))?this._activeFieldKey=o:this.schema&&this.schema.fields.length>0&&(this._activeFieldKey=this.schema.fields[0].key)}_setStagedValue(e,t,i){const s=new Map(this._staged),o=new Map(s.get(e)??new Map);o.set(t,i),s.set(e,o),this._staged=s}_setStagedBulk(e){const t=new Map(this._staged);for(const[i,s,o]of e){const r=new Map(t.get(i)??new Map);r.set(s,o),t.set(i,r)}this._staged=t}get _activeField(){var e,t;return(t=(e=this.schema)==null?void 0:e.fieldsByKey)==null?void 0:t.get(this._activeFieldKey)}_originalValue(e,t){var s,o;const i=this._originalFiles.get(e);if(i){if(Fe(t)){const r=Ke(t);return r?(s=i.product)==null?void 0:s[r]:void 0}return(o=i.meta)==null?void 0:o[t]}}_refreshMissingRequired(){const e=this.schema?ot(this._staged,this._originalFiles,this.schema,this.config??void 0):new Set;let t=null;if(this.schema&&e.size>0){for(const o of this.schema.fields)if(e.has(o.key)){t=o.key;break}}t!==this._missingRequiredFieldKey&&(this._missingRequiredFieldKey=t);const i=this._missingRequiredKeys;let s=i.size!==e.size;if(!s){for(const o of e)if(!i.has(o)){s=!0;break}}s&&(this._missingRequiredKeys=e)}get _filledFields(){var t;const e=new Set;for(const i of((t=this.schema)==null?void 0:t.fields)??[])for(const[s,o]of this._staged){const r=o.get(i.key),l=this._originalValue(s,i.key);if(r!==void 0&&!B(r)&&JSON.stringify(r)!==JSON.stringify(l)){e.add(i.key);break}}return e}get _hasPendingValue(){return this._pendingOp!=null&&!B(this._pendingOp.value)}_confirmDiscardPending(){return this._hasPendingValue?new Promise(e=>{this._confirmResolve=e,this._confirmVisible=!0}):Promise.resolve(!0)}willUpdate(e){(e.has("_staged")||e.has("schema")||e.has("config"))&&this._refreshMissingRequired()}updated(e){var t;(t=super.updated)==null||t.call(this,e),e.has("_confirmVisible")&&this._confirmVisible&&requestAnimationFrame(()=>{var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector(".fm-confirm .btn-ghost");i==null||i.focus()})}_emitClose(){this.dispatchEvent(new CustomEvent("metadata-close",{bubbles:!0,composed:!0}))}get _sortedFiles(){const e=[...this.files];return e.sort((t,i)=>{const s=t.name.localeCompare(i.name)||t.id.localeCompare(i.id);return this._sortAsc?s:-s}),e}render(){var c,u,b;if(!((u=(c=this.schema)==null?void 0:c.fields)!=null&&u.length))return a`
      ...
      `;const e=this._activeField,t=this._sortedFiles,i=this._selected.size===this.files.length&&this.files.length>0,s=this._selected.size>0&&!i,o=this._missingRequiredFieldKey,r=o?((b=this.schema.fieldsByKey.get(o))==null?void 0:b.title)||o:"",l=o!=null&&this._activeFieldKey===o,d=o!=null&&!l;return a`
      <div class="fm-overlay" @click=${this._onClose}>
        <div class="fm-modal" @click=${f=>f.stopPropagation()}>
          <!-- Top bar -->
          <div class="fm-topbar">
          ...
          <div class="fm-footer">
            ...
            <button
              class=${He({"btn-primary":!0,"btn-primary--next":d})}
    ...
    `}};De.styles=[Ct];let y=De;_([p({attribute:!1})],y.prototype,"schema");_([p({attribute:!1})],y.prototype,"files");_([p({attribute:!1})],y.prototype,"config");_([p({attribute:!1})],y.prototype,"autocomplete");_([p({attribute:!1})],y.prototype,"initialFieldKey");_([h()],y.prototype,"_activeFieldKey");_([h()],y.prototype,"_staged");_([h()],y.prototype,"_selected");_([h()],y.prototype,"_sortAsc");_([h()],y.prototype,"_pendingOp");_([h()],y.prototype,"_confirmVisible");_([h()],y.prototype,"_missingRequiredFieldKey");_([h()],y.prototype,"_missingRequiredKeys");customElements.define("sfx-bulk-metadata-modal",y);const Le={text:a`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  </svg>`};function Dt(n){return Le[n]??Le.text}var Tt=Object.defineProperty,F=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&Tt(e,t,s),s};const Te=class Te extends w{constructor(){super(...arguments),this.activeFieldKey="",this.filledFields=new Set,this.missingRequiredKeys=new Set,this.config=null,this._collapsed=new Set,this._isNarrow=!1,this._resizeTimer=null,this._onResize=()=>{this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(this._updateNarrow,100)},this._updateNarrow=()=>{this._resizeTimer=null;const e=window.innerWidth<=768;e!==this._isNarrow&&(this._isNarrow=e)}}connectedCallback(){super.connectedCallback(),this._updateNarrow(),window.addEventListener("resize",this._onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._onResize),this._resizeTimer&&(clearTimeout(this._resizeTimer),this._resizeTimer=null)}_isRequired(e){return Me(e,this.config??void 0)}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_onFieldClick(e){this.dispatchEvent(new CustomEvent("field-select",{detail:{fieldKey:e},bubbles:!0,composed:!0}))}updated(e){var i,s;if((i=super.updated)==null||i.call(this,e),!e.has("activeFieldKey")||!this.activeFieldKey)return;const t=(s=this.renderRoot)==null?void 0:s.querySelector(".field-item.active");t==null||t.scrollIntoView({block:"nearest"})}render(){return this.schema?a`
    ...
    `:x}};Te.styles=[St];let C=Te;F([p({attribute:!1})],C.prototype,"schema");F([p({attribute:!1})],C.prototype,"activeFieldKey");F([p({attribute:!1})],C.prototype,"filledFields");F([p({attribute:!1})],C.prototype,"missingRequiredKeys");F([p({attribute:!1})],C.prototype,"config");F([h()],C.prototype,"_collapsed");F([h()],C.prototype,"_isNarrow");customElements.define("sfx-bulk-meta-sidebar",C);var Rt=Object.defineProperty,K=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&Rt(e,t,s),s},E;const z=(E=class extends w{constructor(){super(...arguments),this.config=null,this.selectedCount=0,this._operation="SET",this._value=void 0,this._opDropdownOpen=!1,this._availableOps=[],this._onOpDropdownClose=e=>{if(!this._opDropdownOpen)return;const t=this.renderRoot.querySelector(".op-dropdown-wrap");if(!t)return;e.composedPath().includes(t)||(this._opDropdownOpen=!1)},this._onFieldBlur=e=>{e.stopPropagation(),this._value=e.detail.value,this._emitPendingChange()},this._onFieldChange=e=>{e.stopPropagation(),this._value=e.detail.value,this._emitPendingChange()},this._onFieldEscape=e=>{e.stopPropagation()},this._onValueKeydown=e=>{var o;if(e.key!=="Enter")return;const t=(o=this.field)==null?void 0:o.type;if(!t||!E._ENTER_APPLY_TYPES.has(t))return;const i=e.composedPath().find(r=>r instanceof HTMLElement);if((i==null?void 0:i.tagName)==="TEXTAREA")return;e.preventDefault();const s=e.composedPath().find(r=>r instanceof HTMLInputElement);s&&s.value!==void 0&&(this._value=s.value),this._onApply()}}static _emptyValueForType(e){switch(e){case"multi-select":case"tags":return[];case"boolean":return"null";case"geopoint":return{latitude:"",longitude:""};case"asset-attachments":case"attachments-assets":case"integer-list":case"ultratags":case"taxonomy-node":return null;default:return""}}get _effectiveValue(){var e;return this._value??E._emptyValueForType((e=this.field)==null?void 0:e.type)}willUpdate(e){e.has("field")&&this.field&&(this._availableOps=kt(this.field.type),this._operation="SET",this._value=void 0,this._emitPendingChange())}_onOpSelect(e){this._operation=e,this._opDropdownOpen=!1,this._emitPendingChange()}_onOpToggle(){this._opDropdownOpen=!this._opDropdownOpen}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onOpDropdownClose,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onOpDropdownClose,!0)}_emitPendingChange(){this.dispatchEvent(new CustomEvent("pending-change",{detail:{operation:this._operation,value:this._value},bubbles:!0,composed:!0}))}_onApply(){var e;this._isApplyDisabled||(this.dispatchEvent(new CustomEvent("bulk-apply",{detail:{operation:this._operation,value:this._value},bubbles:!0,composed:!0})),this._value=void 0,this._operation==="DELETE"&&!ce(this._operation,(e=this.field)==null?void 0:e.type)&&(this._operation="SET"),this._emitPendingChange())}get _isApplyDisabled(){var e,t;return this.selectedCount===0?!0:this._operation==="DELETE"?ie.has((e=this.field)==null?void 0:e.type)?B(this._value):se.has((t=this.field)==null?void 0:t.type)?B(this._value):!1:B(this._value)}render(){if(!this.field)return x;if(ee(this.field))return a`
      ...
      `;const e=this._availableOps.length>1,t=this._availableOps.find(i=>i.key===this._operation);return a`
      <div class="op-bar">
    ...
    `}},E.styles=[Et],E._ENTER_APPLY_TYPES=new Set(["text","numeric","decimal2","date","geopoint","attachment-uri"]),E);K([p({attribute:!1})],z.prototype,"field");K([p({attribute:!1})],z.prototype,"autocomplete");K([p({attribute:!1})],z.prototype,"config");K([p({type:Number})],z.prototype,"selectedCount");K([h()],z.prototype,"_operation");K([h()],z.prototype,"_value");K([h()],z.prototype,"_opDropdownOpen");let qt=z;customElements.define("sfx-bulk-meta-op-bar",qt);var Pt=Object.defineProperty,L=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&Pt(e,t,s),s};const Re=class Re extends w{constructor(){super(...arguments),this.files=[],this.staged=new Map,this.selected=new Set,this.pendingOp=null,this.config=null}_getEffectiveValue(e){const t=this.staged.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key):e.meta[this.field.key]}render(){return a`
      ${this.files.map(e=>a`
          <sfx-bulk-meta-row
            .file=${e}
            .field=${this.field}
          ...
          ></sfx-bulk-meta-row>
        `)}
    `}};Re.styles=[Ot];let S=Re;L([p({attribute:!1})],S.prototype,"files");L([p({attribute:!1})],S.prototype,"field");L([p({attribute:!1})],S.prototype,"staged");L([p({attribute:!1})],S.prototype,"selected");L([p({attribute:!1})],S.prototype,"pendingOp");L([p({attribute:!1})],S.prototype,"config");L([p({attribute:!1})],S.prototype,"autocomplete");customElements.define("sfx-bulk-meta-table",S);var Ft=Object.defineProperty,D=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&Ft(e,t,s),s};const qe=class qe extends w{constructor(){super(...arguments),this.selected=!1,this.pendingOp=null,this.config=null,this._error=null,this._onFieldBlur=e=>{var r;e.stopPropagation();const{value:t}=e.detail,i=Ye(this.field,t,this.config??void 0);if(i){this._error=i;return}this._error=null;const s={meta:{...this.file.meta,[this.field.key]:this.value}},o=fe(this.field,t,s,(r=this.config)==null?void 0:r.language);JSON.stringify(o)!==JSON.stringify(this.value)&&this.dispatchEvent(new CustomEvent("row-field-change",{detail:{fileId:this.file.id,value:o},bubbles:!0,composed:!0}))}}willUpdate(e){e.has("field")&&(this._error=null)}_onCheckboxChange(){this.dispatchEvent(new CustomEvent("row-toggle",{detail:{fileId:this.file.id},bubbles:!0,composed:!0}))}_computePreviewValue(){var t;const e=this.pendingOp;return!e||!this.field?this.value:et(this.field,this.value,e.value,e.operation,(t=this.config)==null?void 0:t.language)}_getExtension(e){const t=e.lastIndexOf(".");return t>0?e.slice(t+1).toUpperCase():"?"}render(){var t;const e=this.file;return a`
      <div class="row">
        <div class="row-check">
          <input
            type="checkbox"
        ...
        ${e.previewUrl?a`<img class="row-thumb" src=${e.previewUrl} alt="" />`:a`<img class="row-thumb row-thumb-fallback"
              ...
              @error=${i=>{const s=i.target,o=at();!s.dataset.fallback&&s.src!==o&&(s.dataset.fallback="1",s.src=o)}}
            />`}
    ...
    `}};qe.styles=[At];let $=qe;D([p({attribute:!1})],$.prototype,"file");D([p({attribute:!1})],$.prototype,"field");D([p({attribute:!1})],$.prototype,"value");D([p({type:Boolean})],$.prototype,"selected");D([p({attribute:!1})],$.prototype,"pendingOp");D([p({attribute:!1})],$.prototype,"config");D([p({attribute:!1})],$.prototype,"autocomplete");D([h()],$.prototype,"_error");customElements.define("sfx-bulk-meta-row",$);const Kt=new Set(["multi-select","tags"]);function Be(n,e,t){return!e.regional_variants_group_uuid||n==null||typeof n!="object"||Array.isArray(n)?n:n[t??"en"]}function je(n){return Array.isArray(n)?n:[]}function Ne(n){return n==null||n===""||Array.isArray(n)&&n.length===0?!0:typeof n=="object"&&!Array.isArray(n)?!Object.values(n).some(e=>e!=null&&e!==""):!1}function ue(n,e){var i;const t=(i=n.possible_values)==null?void 0:i.find(s=>s.internal_unique_value===e||s.api_value===e);return(t==null?void 0:t.label)??String(e)}function Ve(n,e){if(e==null||e==="")return"";switch(n.type){case"boolean":return e===!0?"True":e===!1?"False":"None";case"date":{if(typeof e!="string"||e.length===0)return"";try{return new Date(e+"T00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return e}}case"numeric":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:0}):String(e)}case"decimal2":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:2}):String(e)}case"select-one":return ue(n,String(e));case"geopoint":{if(typeof e=="object"&&e!==null&&!Array.isArray(e)){const t=e;return!t.latitude&&!t.longitude?"":`(${t.latitude??""}, ${t.longitude??""})`}if(typeof e=="string"){const t=e.match(/^\((.+),(.+)\)$/);if(t)return`(${t[1].trim()}, ${t[2].trim()})`}return String(e)}default:return String(e)}}function Lt(n,e){const t=n.map(l=>typeof l=="string"?l:String(l)),i=e.map(l=>typeof l=="string"?l:String(l)),s=new Set(t),o=new Set(i),r=[];for(const l of i)r.push({label:l,state:s.has(l)?"kept":"added"});for(const l of t)o.has(l)||r.push({label:l,state:"removed"});return r}function Bt(n,e,t){const i=new Set(n.map(r=>JSON.stringify(r))),s=new Set(e.map(r=>JSON.stringify(r))),o=[];for(const r of e){const l=JSON.stringify(r),d=typeof r=="string"?ue(t,r):String(r);o.push({label:d,state:i.has(l)?"kept":"added"})}for(const r of n){const l=JSON.stringify(r);if(!s.has(l)){const d=typeof r=="string"?ue(t,r):String(r);o.push({label:d,state:"removed"})}}return o}function jt(n,e,t,i){const s=i==null?void 0:i.language,o=Be(e,n,s),r=Be(t,n,s);if(Kt.has(n.type)){const l=je(o),d=je(r);return n.type==="tags"?{kind:"array",items:Lt(l,d)}:{kind:"array",items:Bt(l,d,n)}}return{kind:"scalar",oldDisplay:Ve(n,o),newDisplay:Ve(n,r),oldEmpty:Ne(o),newEmpty:Ne(r)}}var Nt=Object.defineProperty,re=(n,e,t,i)=>{for(var s=void 0,o=n.length-1,r;o>=0;o--)(r=n[o])&&(s=r(e,t,s)||s);return s&&Nt(e,t,s),s};const Pe=class Pe extends w{constructor(){super(...arguments),this.config=null}_renderArrayDiff(e){return a`
    ...
    `}render(){if(!this.field)return x;const e=jt(this.field,this.oldValue,this.newValue,this.config);return e.kind==="array"?this._renderArrayDiff(e):this._renderScalarDiff(e)}};Pe.styles=[It];let P=Pe;re([p({attribute:!1})],P.prototype,"field");re([p({attribute:!1})],P.prototype,"oldValue");re([p({attribute:!1})],P.prototype,"newValue");re([p({attribute:!1})],P.prototype,"config");customElements.define("sfx-bulk-meta-diff-view",P);export{y as SfxBulkMetadataModal,Yt as clearSchemaCache,Ht as createTagsAutocomplete,Gt as deepMergeMeta,Mt as fetchMetadataSchema,Wt as getFilesWithMissingRequired,Xt as isAssetHasMetadataValue,B as isEmpty,Ue as mapValueFromBackend,fe as mapValueToBackend,Je as parseMetadataSchema,Ye as validateField};
