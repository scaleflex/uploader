const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/getting-started-BEsDf8Jc.js","assets/doc-utils-XkOyWBCy.js","assets/configuration-JAe1IJge.js","assets/api-C69HtrIu.js","assets/theming-D5E2zXLD.js","assets/types-BP9Z4Qnu.js","assets/basic-9VH_V7UN.js","assets/code-block-Bk3NnwHF.js","assets/auto-upload-BQTllLxZ.js","assets/restrictions-BV2C7rbT.js","assets/custom-select-CZ_fVHDR.js","assets/target-folder-Bv3qwP6x.js","assets/concurrency-DXPUa_a4.js","assets/events-BSubiJrG.js","assets/modal-D5dtgB5U.js","assets/inline-TniNusrC.js","assets/sources-layout-CouHEGvt.js","assets/core-sources-BDFhN8aT.js","assets/header-button-BbjpMnaf.js","assets/minimize-to-background-PvdXbWRV.js","assets/resumable-upload-D7GmU0K9.js","assets/react-wrapper-DqFoKQCy.js","assets/metadata-DmJcQo04.js","assets/similar-check-KQ0w14Oa.js","assets/upload-settings-BT-BDqql.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const Ts="modulepreload",As=function(r){return"/uploader/"+r},_r={},V=function(e,t,i){let o=Promise.resolve();if(t&&t.length>0){let n=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));o=n(t.map(c=>{if(c=As(c),c in _r)return;_r[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":Ts,d||(u.as="script"),u.crossOrigin="",u.href=c,l&&u.setAttribute("nonce",l),document.head.appendChild(u),d)return new Promise((b,x)=>{u.addEventListener("load",b),u.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(n){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=n,window.dispatchEvent(a),!a.defaultPrevented)throw n}return o.then(n=>{for(const a of n||[])a.status==="rejected"&&s(a.reason);return e().catch(s)})};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bt=globalThis,Ni=Bt.ShadowRoot&&(Bt.ShadyCSS===void 0||Bt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Hi=Symbol(),kr=new WeakMap;let Lo=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==Hi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ni&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=kr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&kr.set(t,e))}return e}toString(){return this.cssText}};const Ls=r=>new Lo(typeof r=="string"?r:r+"",void 0,Hi),le=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,o,s)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+r[s+1],r[0]);return new Lo(t,r,Hi)},Fs=(r,e)=>{if(Ni)r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const i=document.createElement("style"),o=Bt.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,r.appendChild(i)}},Sr=Ni?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Ls(t)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Is,defineProperty:zs,getOwnPropertyDescriptor:js,getOwnPropertyNames:Ds,getOwnPropertySymbols:Ms,getPrototypeOf:Bs}=Object,Ee=globalThis,$r=Ee.trustedTypes,Ns=$r?$r.emptyScript:"",ai=Ee.reactiveElementPolyfillSupport,ht=(r,e)=>r,Kt={toAttribute(r,e){switch(e){case Boolean:r=r?Ns:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},qi=(r,e)=>!Is(r,e),Cr={attribute:!0,type:String,converter:Kt,reflect:!1,useDefault:!1,hasChanged:qi};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),Ee.litPropertyMetadata??(Ee.litPropertyMetadata=new WeakMap);let Ge=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Cr){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),o=this.getPropertyDescriptor(e,i,t);o!==void 0&&zs(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){const{get:o,set:s}=js(this.prototype,e)??{get(){return this[t]},set(n){this[t]=n}};return{get:o,set(n){const a=o==null?void 0:o.call(this);s==null||s.call(this,n),this.requestUpdate(e,a,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Cr}static _$Ei(){if(this.hasOwnProperty(ht("elementProperties")))return;const e=Bs(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ht("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ht("properties"))){const t=this.properties,i=[...Ds(t),...Ms(t)];for(const o of i)this.createProperty(o,t[o])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[i,o]of t)this.elementProperties.set(i,o)}this._$Eh=new Map;for(const[t,i]of this.elementProperties){const o=this._$Eu(t,i);o!==void 0&&this._$Eh.set(o,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Sr(o))}else e!==void 0&&t.push(Sr(e));return t}static _$Eu(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Fs(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var i;return(i=t.hostConnected)==null?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var i;return(i=t.hostDisconnected)==null?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){var s;const i=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,i);if(o!==void 0&&i.reflect===!0){const n=(((s=i.converter)==null?void 0:s.toAttribute)!==void 0?i.converter:Kt).toAttribute(t,i.type);this._$Em=e,n==null?this.removeAttribute(o):this.setAttribute(o,n),this._$Em=null}}_$AK(e,t){var s,n;const i=this.constructor,o=i._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const a=i.getPropertyOptions(o),l=typeof a.converter=="function"?{fromAttribute:a.converter}:((s=a.converter)==null?void 0:s.fromAttribute)!==void 0?a.converter:Kt;this._$Em=o;const c=l.fromAttribute(t,a.type);this[o]=c??((n=this._$Ej)==null?void 0:n.get(o))??c,this._$Em=null}}requestUpdate(e,t,i,o=!1,s){var n;if(e!==void 0){const a=this.constructor;if(o===!1&&(s=this[e]),i??(i=a.getPropertyOptions(e)),!((i.hasChanged??qi)(s,t)||i.useDefault&&i.reflect&&s===((n=this._$Ej)==null?void 0:n.get(e))&&!this.hasAttribute(a._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:o,wrapped:s},n){i&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,n??t??this[e]),s!==!0||n!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),o===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var i;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[s,n]of this._$Ep)this[s]=n;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[s,n]of o){const{wrapped:a}=n,l=this[s];a!==!0||this._$AL.has(s)||l===void 0||this.C(s,void 0,n,l)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(i=this._$EO)==null||i.forEach(o=>{var s;return(s=o.hostUpdate)==null?void 0:s.call(o)}),this.update(t)):this._$EM()}catch(o){throw e=!1,this._$EM(),o}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(i=>{var o;return(o=i.hostUpdated)==null?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};Ge.elementStyles=[],Ge.shadowRootOptions={mode:"open"},Ge[ht("elementProperties")]=new Map,Ge[ht("finalized")]=new Map,ai==null||ai({ReactiveElement:Ge}),(Ee.reactiveElementVersions??(Ee.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt=globalThis,Er=r=>r,Yt=gt.trustedTypes,Pr=Yt?Yt.createPolicy("lit-html",{createHTML:r=>r}):void 0,Fo="$lit$",$e=`lit$${Math.random().toFixed(9).slice(2)}$`,Io="?"+$e,Hs=`<${Io}>`,Me=document,vt=()=>Me.createComment(""),bt=r=>r===null||typeof r!="object"&&typeof r!="function",Vi=Array.isArray,qs=r=>Vi(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",li=`[ 	
\f\r]`,at=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ur=/-->/g,Rr=/>/g,Ae=RegExp(`>|${li}(?:([^\\s"'>=/]+)(${li}*=${li}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Or=/'/g,Tr=/"/g,zo=/^(?:script|style|textarea|title)$/i,jo=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),f=jo(1),Fe=jo(2),he=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),Ar=new WeakMap,Ie=Me.createTreeWalker(Me,129);function Do(r,e){if(!Vi(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Pr!==void 0?Pr.createHTML(e):e}const Vs=(r,e)=>{const t=r.length-1,i=[];let o,s=e===2?"<svg>":e===3?"<math>":"",n=at;for(let a=0;a<t;a++){const l=r[a];let c,d,p=-1,u=0;for(;u<l.length&&(n.lastIndex=u,d=n.exec(l),d!==null);)u=n.lastIndex,n===at?d[1]==="!--"?n=Ur:d[1]!==void 0?n=Rr:d[2]!==void 0?(zo.test(d[2])&&(o=RegExp("</"+d[2],"g")),n=Ae):d[3]!==void 0&&(n=Ae):n===Ae?d[0]===">"?(n=o??at,p=-1):d[1]===void 0?p=-2:(p=n.lastIndex-d[2].length,c=d[1],n=d[3]===void 0?Ae:d[3]==='"'?Tr:Or):n===Tr||n===Or?n=Ae:n===Ur||n===Rr?n=at:(n=Ae,o=void 0);const b=n===Ae&&r[a+1].startsWith("/>")?" ":"";s+=n===at?l+Hs:p>=0?(i.push(c),l.slice(0,p)+Fo+l.slice(p)+$e+b):l+$e+(p===-2?a:b)}return[Do(r,s+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class yt{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,n=0;const a=e.length-1,l=this.parts,[c,d]=Vs(e,t);if(this.el=yt.createElement(c,i),Ie.currentNode=this.el.content,t===2||t===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(o=Ie.nextNode())!==null&&l.length<a;){if(o.nodeType===1){if(o.hasAttributes())for(const p of o.getAttributeNames())if(p.endsWith(Fo)){const u=d[n++],b=o.getAttribute(p).split($e),x=/([.?@])?(.*)/.exec(u);l.push({type:1,index:s,name:x[2],strings:b,ctor:x[1]==="."?Ys:x[1]==="?"?Ws:x[1]==="@"?Gs:ii}),o.removeAttribute(p)}else p.startsWith($e)&&(l.push({type:6,index:s}),o.removeAttribute(p));if(zo.test(o.tagName)){const p=o.textContent.split($e),u=p.length-1;if(u>0){o.textContent=Yt?Yt.emptyScript:"";for(let b=0;b<u;b++)o.append(p[b],vt()),Ie.nextNode(),l.push({type:2,index:++s});o.append(p[u],vt())}}}else if(o.nodeType===8)if(o.data===Io)l.push({type:2,index:s});else{let p=-1;for(;(p=o.data.indexOf($e,p+1))!==-1;)l.push({type:7,index:s}),p+=$e.length-1}s++}}static createElement(e,t){const i=Me.createElement("template");return i.innerHTML=e,i}}function et(r,e,t=r,i){var n,a;if(e===he)return e;let o=i!==void 0?(n=t._$Co)==null?void 0:n[i]:t._$Cl;const s=bt(e)?void 0:e._$litDirective$;return(o==null?void 0:o.constructor)!==s&&((a=o==null?void 0:o._$AO)==null||a.call(o,!1),s===void 0?o=void 0:(o=new s(r),o._$AT(r,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=o:t._$Cl=o),o!==void 0&&(e=et(r,o._$AS(r,e.values),o,i)),e}class Ks{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,o=((e==null?void 0:e.creationScope)??Me).importNode(t,!0);Ie.currentNode=o;let s=Ie.nextNode(),n=0,a=0,l=i[0];for(;l!==void 0;){if(n===l.index){let c;l.type===2?c=new Rt(s,s.nextSibling,this,e):l.type===1?c=new l.ctor(s,l.name,l.strings,this,e):l.type===6&&(c=new Xs(s,this,e)),this._$AV.push(c),l=i[++a]}n!==(l==null?void 0:l.index)&&(s=Ie.nextNode(),n++)}return Ie.currentNode=Me,o}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Rt{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,o){this.type=2,this._$AH=S,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=et(this,e,t),bt(e)?e===S||e==null||e===""?(this._$AH!==S&&this._$AR(),this._$AH=S):e!==this._$AH&&e!==he&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):qs(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==S&&bt(this._$AH)?this._$AA.nextSibling.data=e:this.T(Me.createTextNode(e)),this._$AH=e}$(e){var s;const{values:t,_$litType$:i}=e,o=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=yt.createElement(Do(i.h,i.h[0]),this.options)),i);if(((s=this._$AH)==null?void 0:s._$AD)===o)this._$AH.p(t);else{const n=new Ks(o,this),a=n.u(this.options);n.p(t),this.T(a),this._$AH=n}}_$AC(e){let t=Ar.get(e.strings);return t===void 0&&Ar.set(e.strings,t=new yt(e)),t}k(e){Vi(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new Rt(this.O(vt()),this.O(vt()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e!==this._$AB;){const o=Er(e).nextSibling;Er(e).remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class ii{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,o,s){this.type=1,this._$AH=S,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=S}_$AI(e,t=this,i,o){const s=this.strings;let n=!1;if(s===void 0)e=et(this,e,t,0),n=!bt(e)||e!==this._$AH&&e!==he,n&&(this._$AH=e);else{const a=e;let l,c;for(e=s[0],l=0;l<s.length-1;l++)c=et(this,a[i+l],t,l),c===he&&(c=this._$AH[l]),n||(n=!bt(c)||c!==this._$AH[l]),c===S?e=S:e!==S&&(e+=(c??"")+s[l+1]),this._$AH[l]=c}n&&!o&&this.j(e)}j(e){e===S?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ys extends ii{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===S?void 0:e}}class Ws extends ii{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==S)}}class Gs extends ii{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){if((e=et(this,e,t,0)??S)===he)return;const i=this._$AH,o=e===S&&i!==S||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==S&&(i===S||o);o&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class Xs{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){et(this,e)}}const ci=gt.litHtmlPolyfillSupport;ci==null||ci(yt,Rt),(gt.litHtmlVersions??(gt.litHtmlVersions=[])).push("3.3.2");const Pe=(r,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let o=i._$litPart$;if(o===void 0){const s=(t==null?void 0:t.renderBefore)??null;i._$litPart$=o=new Rt(e.insertBefore(vt(),s),s,void 0,t??{})}return o._$AI(r),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const je=globalThis;let oe=class extends Ge{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Pe(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return he}};var To;oe._$litElement$=!0,oe.finalized=!0,(To=je.litElementHydrateSupport)==null||To.call(je,{LitElement:oe});const di=je.litElementPolyfillSupport;di==null||di({LitElement:oe});(je.litElementVersions??(je.litElementVersions=[])).push("4.2.2");const D=r=>typeof r=="string",lt=()=>{let r,e;const t=new Promise((i,o)=>{r=i,e=o});return t.resolve=r,t.reject=e,t},Lr=r=>r==null?"":String(r),Js=(r,e,t)=>{r.forEach(i=>{e[i]&&(t[i]=e[i])})},Zs=/###/g,Fr=r=>r&&r.includes("###")?r.replace(Zs,"."):r,Ir=r=>!r||D(r),mt=(r,e,t)=>{const i=D(e)?e.split("."):e;let o=0;for(;o<i.length-1;){if(Ir(r))return{};const s=Fr(i[o]);!r[s]&&t&&(r[s]=new t),Object.prototype.hasOwnProperty.call(r,s)?r=r[s]:r={},++o}return Ir(r)?{}:{obj:r,k:Fr(i[o])}},zr=(r,e,t)=>{const{obj:i,k:o}=mt(r,e,Object);if(i!==void 0||e.length===1){i[o]=t;return}let s=e[e.length-1],n=e.slice(0,e.length-1),a=mt(r,n,Object);for(;a.obj===void 0&&n.length;)s=`${n[n.length-1]}.${s}`,n=n.slice(0,n.length-1),a=mt(r,n,Object),a!=null&&a.obj&&typeof a.obj[`${a.k}.${s}`]<"u"&&(a.obj=void 0);a.obj[`${a.k}.${s}`]=t},Qs=(r,e,t,i)=>{const{obj:o,k:s}=mt(r,e,Object);o[s]=o[s]||[],o[s].push(t)},Wt=(r,e)=>{const{obj:t,k:i}=mt(r,e);if(t&&Object.prototype.hasOwnProperty.call(t,i))return t[i]},en=(r,e,t)=>{const i=Wt(r,t);return i!==void 0?i:Wt(e,t)},Mo=(r,e,t)=>{for(const i in e)i!=="__proto__"&&i!=="constructor"&&(i in r?D(r[i])||r[i]instanceof String||D(e[i])||e[i]instanceof String?t&&(r[i]=e[i]):Mo(r[i],e[i],t):r[i]=e[i]);return r},ve=r=>r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&"),tn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"},rn=r=>D(r)?r.replace(/[&<>"'\/]/g,e=>tn[e]):r;class on{constructor(e){this.capacity=e,this.regExpMap=new Map,this.regExpQueue=[]}getRegExp(e){const t=this.regExpMap.get(e);if(t!==void 0)return t;const i=new RegExp(e);return this.regExpQueue.length===this.capacity&&this.regExpMap.delete(this.regExpQueue.shift()),this.regExpMap.set(e,i),this.regExpQueue.push(e),i}}const sn=[" ",",","?","!",";"],nn=new on(20),an=(r,e,t)=>{e=e||"",t=t||"";const i=sn.filter(n=>!e.includes(n)&&!t.includes(n));if(i.length===0)return!0;const o=nn.getRegExp(`(${i.map(n=>n==="?"?"\\?":n).join("|")})`);let s=!o.test(r);if(!s){const n=r.indexOf(t);n>0&&!o.test(r.substring(0,n))&&(s=!0)}return s},wi=(r,e,t=".")=>{if(!r)return;if(r[e])return Object.prototype.hasOwnProperty.call(r,e)?r[e]:void 0;const i=e.split(t);let o=r;for(let s=0;s<i.length;){if(!o||typeof o!="object")return;let n,a="";for(let l=s;l<i.length;++l)if(l!==s&&(a+=t),a+=i[l],n=o[a],n!==void 0){if(["string","number","boolean"].includes(typeof n)&&l<i.length-1)continue;s+=l-s+1;break}o=n}return o},wt=r=>r==null?void 0:r.replace(/_/g,"-"),ln={type:"logger",log(r){this.output("log",r)},warn(r){this.output("warn",r)},error(r){this.output("error",r)},output(r,e){var t,i;(i=(t=console==null?void 0:console[r])==null?void 0:t.apply)==null||i.call(t,console,e)}};class Gt{constructor(e,t={}){this.init(e,t)}init(e,t={}){this.prefix=t.prefix||"i18next:",this.logger=e||ln,this.options=t,this.debug=t.debug}log(...e){return this.forward(e,"log","",!0)}warn(...e){return this.forward(e,"warn","",!0)}error(...e){return this.forward(e,"error","")}deprecate(...e){return this.forward(e,"warn","WARNING DEPRECATED: ",!0)}forward(e,t,i,o){return o&&!this.debug?null:(e=e.map(s=>D(s)?s.replace(/[\r\n\x00-\x1F\x7F]/g," "):s),D(e[0])&&(e[0]=`${i}${this.prefix} ${e[0]}`),this.logger[t](e))}create(e){return new Gt(this.logger,{prefix:`${this.prefix}:${e}:`,...this.options})}clone(e){return e=e||this.options,e.prefix=e.prefix||this.prefix,new Gt(this.logger,e)}}var xe=new Gt;class ri{constructor(){this.observers={}}on(e,t){return e.split(" ").forEach(i=>{this.observers[i]||(this.observers[i]=new Map);const o=this.observers[i].get(t)||0;this.observers[i].set(t,o+1)}),this}off(e,t){if(this.observers[e]){if(!t){delete this.observers[e];return}this.observers[e].delete(t)}}once(e,t){const i=(...o)=>{t(...o),this.off(e,i)};return this.on(e,i),this}emit(e,...t){this.observers[e]&&Array.from(this.observers[e].entries()).forEach(([o,s])=>{for(let n=0;n<s;n++)o(...t)}),this.observers["*"]&&Array.from(this.observers["*"].entries()).forEach(([o,s])=>{for(let n=0;n<s;n++)o(e,...t)})}}class jr extends ri{constructor(e,t={ns:["translation"],defaultNS:"translation"}){super(),this.data=e||{},this.options=t,this.options.keySeparator===void 0&&(this.options.keySeparator="."),this.options.ignoreJSONStructure===void 0&&(this.options.ignoreJSONStructure=!0)}addNamespaces(e){this.options.ns.includes(e)||this.options.ns.push(e)}removeNamespaces(e){const t=this.options.ns.indexOf(e);t>-1&&this.options.ns.splice(t,1)}getResource(e,t,i,o={}){var c,d;const s=o.keySeparator!==void 0?o.keySeparator:this.options.keySeparator,n=o.ignoreJSONStructure!==void 0?o.ignoreJSONStructure:this.options.ignoreJSONStructure;let a;e.includes(".")?a=e.split("."):(a=[e,t],i&&(Array.isArray(i)?a.push(...i):D(i)&&s?a.push(...i.split(s)):a.push(i)));const l=Wt(this.data,a);return!l&&!t&&!i&&e.includes(".")&&(e=a[0],t=a[1],i=a.slice(2).join(".")),l||!n||!D(i)?l:wi((d=(c=this.data)==null?void 0:c[e])==null?void 0:d[t],i,s)}addResource(e,t,i,o,s={silent:!1}){const n=s.keySeparator!==void 0?s.keySeparator:this.options.keySeparator;let a=[e,t];i&&(a=a.concat(n?i.split(n):i)),e.includes(".")&&(a=e.split("."),o=t,t=a[1]),this.addNamespaces(t),zr(this.data,a,o),s.silent||this.emit("added",e,t,i,o)}addResources(e,t,i,o={silent:!1}){for(const s in i)(D(i[s])||Array.isArray(i[s]))&&this.addResource(e,t,s,i[s],{silent:!0});o.silent||this.emit("added",e,t,i)}addResourceBundle(e,t,i,o,s,n={silent:!1,skipCopy:!1}){let a=[e,t];e.includes(".")&&(a=e.split("."),o=i,i=t,t=a[1]),this.addNamespaces(t);let l=Wt(this.data,a)||{};n.skipCopy||(i=JSON.parse(JSON.stringify(i))),o?Mo(l,i,s):l={...l,...i},zr(this.data,a,l),n.silent||this.emit("added",e,t,i)}removeResourceBundle(e,t){this.hasResourceBundle(e,t)&&delete this.data[e][t],this.removeNamespaces(t),this.emit("removed",e,t)}hasResourceBundle(e,t){return this.getResource(e,t)!==void 0}getResourceBundle(e,t){return t||(t=this.options.defaultNS),this.getResource(e,t)}getDataByLanguage(e){return this.data[e]}hasLanguageSomeTranslations(e){const t=this.getDataByLanguage(e);return!!(t&&Object.keys(t)||[]).find(o=>t[o]&&Object.keys(t[o]).length>0)}toJSON(){return this.data}}var Bo={processors:{},addPostProcessor(r){this.processors[r.name]=r},handle(r,e,t,i,o){return r.forEach(s=>{var n;e=((n=this.processors[s])==null?void 0:n.process(e,t,i,o))??e}),e}};const No=Symbol("i18next/PATH_KEY");function cn(){const r=[],e=Object.create(null);let t;return e.get=(i,o)=>{var s;return(s=t==null?void 0:t.revoke)==null||s.call(t),o===No?r:(r.push(o),t=Proxy.revocable(i,e),t.proxy)},Proxy.revocable(Object.create(null),e).proxy}function Ze(r,e){const{[No]:t}=r(cn()),i=(e==null?void 0:e.keySeparator)??".",o=(e==null?void 0:e.nsSeparator)??":",s=(e==null?void 0:e.enableSelector)==="strict";if(t.length>1&&o){const n=e==null?void 0:e.ns,a=s?Array.isArray(n)?n:n?[n]:null:Array.isArray(n)?n:null;if(a&&(s?a:a.length>1?a.slice(1):[]).includes(t[0]))return`${t[0]}${o}${t.slice(1).join(i)}`}return t.join(i)}const pi=r=>!D(r)&&typeof r!="boolean"&&typeof r!="number";class Xt extends ri{constructor(e,t={}){super(),Js(["resourceStore","languageUtils","pluralResolver","interpolator","backendConnector","i18nFormat","utils"],e,this),this.options=t,this.options.keySeparator===void 0&&(this.options.keySeparator="."),this.logger=xe.create("translator"),this.checkedLoadedFor={}}changeLanguage(e){e&&(this.language=e)}exists(e,t={interpolation:{}}){const i={...t};if(e==null)return!1;const o=this.resolve(e,i);if((o==null?void 0:o.res)===void 0)return!1;const s=pi(o.res);return!(i.returnObjects===!1&&s)}extractFromKey(e,t){let i=t.nsSeparator!==void 0?t.nsSeparator:this.options.nsSeparator;i===void 0&&(i=":");const o=t.keySeparator!==void 0?t.keySeparator:this.options.keySeparator;let s=t.ns||this.options.defaultNS||[];const n=i&&e.includes(i),a=!this.options.userDefinedKeySeparator&&!t.keySeparator&&!this.options.userDefinedNsSeparator&&!t.nsSeparator&&!an(e,i,o);if(n&&!a){const l=e.match(this.interpolator.nestingRegexp);if(l&&l.length>0)return{key:e,namespaces:D(s)?[s]:s};const c=e.split(i);(i!==o||i===o&&this.options.ns.includes(c[0]))&&(s=c.shift()),e=c.join(o)}return{key:e,namespaces:D(s)?[s]:s}}translate(e,t,i){let o=typeof t=="object"?{...t}:t;if(typeof o!="object"&&this.options.overloadTranslationOptionHandler&&(o=this.options.overloadTranslationOptionHandler(arguments)),typeof o=="object"&&(o={...o}),o||(o={}),e==null)return"";typeof e=="function"&&(e=Ze(e,{...this.options,...o})),Array.isArray(e)||(e=[String(e)]),e=e.map(T=>typeof T=="function"?Ze(T,{...this.options,...o}):String(T));const s=o.returnDetails!==void 0?o.returnDetails:this.options.returnDetails,n=o.keySeparator!==void 0?o.keySeparator:this.options.keySeparator,{key:a,namespaces:l}=this.extractFromKey(e[e.length-1],o),c=l[l.length-1];let d=o.nsSeparator!==void 0?o.nsSeparator:this.options.nsSeparator;d===void 0&&(d=":");const p=o.lng||this.language,u=o.appendNamespaceToCIMode||this.options.appendNamespaceToCIMode;if((p==null?void 0:p.toLowerCase())==="cimode")return u?s?{res:`${c}${d}${a}`,usedKey:a,exactUsedKey:a,usedLng:p,usedNS:c,usedParams:this.getUsedParamsDetails(o)}:`${c}${d}${a}`:s?{res:a,usedKey:a,exactUsedKey:a,usedLng:p,usedNS:c,usedParams:this.getUsedParamsDetails(o)}:a;const b=this.resolve(e,o);let x=b==null?void 0:b.res;const _=(b==null?void 0:b.usedKey)||a,E=(b==null?void 0:b.exactUsedKey)||a,F=["[object Number]","[object Function]","[object RegExp]"],k=o.joinArrays!==void 0?o.joinArrays:this.options.joinArrays,w=!this.i18nFormat||this.i18nFormat.handleAsObject,y=o.count!==void 0&&!D(o.count),m=Xt.hasDefaultValue(o),R=y?this.pluralResolver.getSuffix(p,o.count,o):"",U=o.ordinal&&y?this.pluralResolver.getSuffix(p,o.count,{ordinal:!1}):"",z=y&&!o.ordinal&&o.count===0,L=z&&o[`defaultValue${this.options.pluralSeparator}zero`]||o[`defaultValue${R}`]||o[`defaultValue${U}`]||o.defaultValue;let A=x;w&&!x&&m&&(A=L);const G=pi(A),we=Object.prototype.toString.apply(A);if(w&&A&&G&&!F.includes(we)&&!(D(k)&&Array.isArray(A))){if(!o.returnObjects&&!this.options.returnObjects){this.options.returnedObjectHandler||this.logger.warn("accessing an object - but returnObjects options is not enabled!");const T=this.options.returnedObjectHandler?this.options.returnedObjectHandler(_,A,{...o,ns:l}):`key '${a} (${this.language})' returned an object instead of string.`;return s?(b.res=T,b.usedParams=this.getUsedParamsDetails(o),b):T}if(n){const T=Array.isArray(A),W=T?[]:{},me=T?E:_;for(const v in A)if(Object.prototype.hasOwnProperty.call(A,v)){const h=`${me}${n}${v}`;m&&!x?W[v]=this.translate(h,{...o,defaultValue:pi(L)?L[v]:void 0,joinArrays:!1,ns:l}):W[v]=this.translate(h,{...o,joinArrays:!1,ns:l}),W[v]===h&&(W[v]=A[v])}x=W}}else if(w&&D(k)&&Array.isArray(x))x=x.join(k),x&&(x=this.extendTranslation(x,e,o,i));else{let T=!1,W=!1;!this.isValidLookup(x)&&m&&(T=!0,x=L),this.isValidLookup(x)||(W=!0,x=a);const v=(o.missingKeyNoValueFallbackToKey||this.options.missingKeyNoValueFallbackToKey)&&W?void 0:x,h=m&&L!==x&&this.options.updateMissing;if(W||T||h){if(this.logger.log(h?"updateKey":"missingKey",p,c,y&&!h?`${a}${this.pluralResolver.getSuffix(p,o.count,o)}`:a,h?L:x),n){const $=this.resolve(a,{...o,keySeparator:!1});$&&$.res&&this.logger.warn("Seems the loaded translations were in flat JSON format instead of nested. Either set keySeparator: false on init or make sure your translations are published in nested format.")}let g=[];const C=this.languageUtils.getFallbackCodes(this.options.fallbackLng,o.lng||this.language);if(this.options.saveMissingTo==="fallback"&&C&&C[0])for(let $=0;$<C.length;$++)g.push(C[$]);else this.options.saveMissingTo==="all"?g=this.languageUtils.toResolveHierarchy(o.lng||this.language):g.push(o.lng||this.language);const P=($,j,H)=>{var ee;const q=m&&H!==x?H:v;this.options.missingKeyHandler?this.options.missingKeyHandler($,c,j,q,h,o):(ee=this.backendConnector)!=null&&ee.saveMissing&&this.backendConnector.saveMissing($,c,j,q,h,o),this.emit("missingKey",$,c,j,x)};this.options.saveMissing&&(this.options.saveMissingPlurals&&y?g.forEach($=>{const j=this.pluralResolver.getSuffixes($,o);z&&o[`defaultValue${this.options.pluralSeparator}zero`]&&!j.includes(`${this.options.pluralSeparator}zero`)&&j.push(`${this.options.pluralSeparator}zero`),j.forEach(H=>{P([$],a+H,o[`defaultValue${H}`]||L)})}):P(g,a,L))}x=this.extendTranslation(x,e,o,b,i),W&&x===a&&this.options.appendNamespaceToMissingKey&&(x=`${c}${d}${a}`),(W||T)&&this.options.parseMissingKeyHandler&&(x=this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey?`${c}${d}${a}`:a,T?x:void 0,o))}return s?(b.res=x,b.usedParams=this.getUsedParamsDetails(o),b):x}extendTranslation(e,t,i,o,s){var l,c;if((l=this.i18nFormat)!=null&&l.parse)e=this.i18nFormat.parse(e,{...this.options.interpolation.defaultVariables,...i},i.lng||this.language||o.usedLng,o.usedNS,o.usedKey,{resolved:o});else if(!i.skipInterpolation){i.interpolation&&this.interpolator.init({...i,interpolation:{...this.options.interpolation,...i.interpolation}});const d=D(e)&&(((c=i==null?void 0:i.interpolation)==null?void 0:c.skipOnVariables)!==void 0?i.interpolation.skipOnVariables:this.options.interpolation.skipOnVariables);let p;if(d){const b=e.match(this.interpolator.nestingRegexp);p=b&&b.length}let u=i.replace&&!D(i.replace)?i.replace:i;if(this.options.interpolation.defaultVariables&&(u={...this.options.interpolation.defaultVariables,...u}),e=this.interpolator.interpolate(e,u,i.lng||this.language||o.usedLng,i),d){const b=e.match(this.interpolator.nestingRegexp),x=b&&b.length;p<x&&(i.nest=!1)}!i.lng&&o&&o.res&&(i.lng=this.language||o.usedLng),i.nest!==!1&&(e=this.interpolator.nest(e,(...b)=>(s==null?void 0:s[0])===b[0]&&!i.context?(this.logger.warn(`It seems you are nesting recursively key: ${b[0]} in key: ${t[0]}`),null):this.translate(...b,t),i)),i.interpolation&&this.interpolator.reset()}const n=i.postProcess||this.options.postProcess,a=D(n)?[n]:n;return e!=null&&(a!=null&&a.length)&&i.applyPostProcessor!==!1&&(e=Bo.handle(a,e,t,this.options&&this.options.postProcessPassResolved?{i18nResolved:{...o,usedParams:this.getUsedParamsDetails(i)},...i}:i,this)),e}resolve(e,t={}){let i,o,s,n,a;return D(e)&&(e=[e]),Array.isArray(e)&&(e=e.map(l=>typeof l=="function"?Ze(l,{...this.options,...t}):l)),e.forEach(l=>{if(this.isValidLookup(i))return;const c=this.extractFromKey(l,t),d=c.key;o=d;let p=c.namespaces;this.options.fallbackNS&&(p=p.concat(this.options.fallbackNS));const u=t.count!==void 0&&!D(t.count),b=u&&!t.ordinal&&t.count===0,x=t.context!==void 0&&(D(t.context)||typeof t.context=="number")&&t.context!=="",_=t.lngs?t.lngs:this.languageUtils.toResolveHierarchy(t.lng||this.language,t.fallbackLng);p.forEach(E=>{var F,k;this.isValidLookup(i)||(a=E,!this.checkedLoadedFor[`${_[0]}-${E}`]&&((F=this.utils)!=null&&F.hasLoadedNamespace)&&!((k=this.utils)!=null&&k.hasLoadedNamespace(a))&&(this.checkedLoadedFor[`${_[0]}-${E}`]=!0,this.logger.warn(`key "${o}" for languages "${_.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`,"This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")),_.forEach(w=>{var R;if(this.isValidLookup(i))return;n=w;const y=[d];if((R=this.i18nFormat)!=null&&R.addLookupKeys)this.i18nFormat.addLookupKeys(y,d,w,E,t);else{let U;u&&(U=this.pluralResolver.getSuffix(w,t.count,t));const z=`${this.options.pluralSeparator}zero`,L=`${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;if(u&&(t.ordinal&&U.startsWith(L)&&y.push(d+U.replace(L,this.options.pluralSeparator)),y.push(d+U),b&&y.push(d+z)),x){const A=`${d}${this.options.contextSeparator||"_"}${t.context}`;y.push(A),u&&(t.ordinal&&U.startsWith(L)&&y.push(A+U.replace(L,this.options.pluralSeparator)),y.push(A+U),b&&y.push(A+z))}}let m;for(;m=y.pop();)this.isValidLookup(i)||(s=m,i=this.getResource(w,E,m,t))}))})}),{res:i,usedKey:o,exactUsedKey:s,usedLng:n,usedNS:a}}isValidLookup(e){return e!==void 0&&!(!this.options.returnNull&&e===null)&&!(!this.options.returnEmptyString&&e==="")}getResource(e,t,i,o={}){var s;return(s=this.i18nFormat)!=null&&s.getResource?this.i18nFormat.getResource(e,t,i,o):this.resourceStore.getResource(e,t,i,o)}getUsedParamsDetails(e={}){const t=["defaultValue","ordinal","context","replace","lng","lngs","fallbackLng","ns","keySeparator","nsSeparator","returnObjects","returnDetails","joinArrays","postProcess","interpolation"],i=e.replace&&!D(e.replace);let o=i?e.replace:e;if(i&&typeof e.count<"u"&&(o.count=e.count),this.options.interpolation.defaultVariables&&(o={...this.options.interpolation.defaultVariables,...o}),!i){o={...o};for(const s of t)delete o[s]}return o}static hasDefaultValue(e){const t="defaultValue";for(const i in e)if(Object.prototype.hasOwnProperty.call(e,i)&&i.startsWith(t)&&e[i]!==void 0)return!0;return!1}}class Dr{constructor(e){this.options=e,this.supportedLngs=this.options.supportedLngs||!1,this.logger=xe.create("languageUtils")}getScriptPartFromCode(e){if(e=wt(e),!e||!e.includes("-"))return null;const t=e.split("-");return t.length===2||(t.pop(),t[t.length-1].toLowerCase()==="x")?null:this.formatLanguageCode(t.join("-"))}getLanguagePartFromCode(e){if(e=wt(e),!e||!e.includes("-"))return e;const t=e.split("-");return this.formatLanguageCode(t[0])}formatLanguageCode(e){if(D(e)&&e.includes("-")){let t;try{t=Intl.getCanonicalLocales(e)[0]}catch{}return t&&this.options.lowerCaseLng&&(t=t.toLowerCase()),t||(this.options.lowerCaseLng?e.toLowerCase():e)}return this.options.cleanCode||this.options.lowerCaseLng?e.toLowerCase():e}isSupportedCode(e){return(this.options.load==="languageOnly"||this.options.nonExplicitSupportedLngs)&&(e=this.getLanguagePartFromCode(e)),!this.supportedLngs||!this.supportedLngs.length||this.supportedLngs.includes(e)}getBestMatchFromCodes(e){if(!e)return null;let t;return e.forEach(i=>{if(t)return;const o=this.formatLanguageCode(i);(!this.options.supportedLngs||this.isSupportedCode(o))&&(t=o)}),!t&&this.options.supportedLngs&&e.forEach(i=>{if(t)return;const o=this.getScriptPartFromCode(i);if(this.isSupportedCode(o))return t=o;const s=this.getLanguagePartFromCode(i);if(this.isSupportedCode(s))return t=s;t=this.options.supportedLngs.find(n=>n===s?!0:!n.includes("-")&&!s.includes("-")?!1:!!(n.includes("-")&&!s.includes("-")&&n.slice(0,n.indexOf("-"))===s||n.startsWith(s)&&s.length>1))}),t||(t=this.getFallbackCodes(this.options.fallbackLng)[0]),t}getFallbackCodes(e,t){if(!e)return[];if(typeof e=="function"&&(e=e(t)),D(e)&&(e=[e]),Array.isArray(e))return e;if(!t)return e.default||[];let i=e[t];return i||(i=e[this.getScriptPartFromCode(t)]),i||(i=e[this.formatLanguageCode(t)]),i||(i=e[this.getLanguagePartFromCode(t)]),i||(i=e.default),i||[]}toResolveHierarchy(e,t){const i=this.getFallbackCodes((t===!1?[]:t)||this.options.fallbackLng||[],e),o=[],s=n=>{n&&(this.isSupportedCode(n)?o.push(n):this.logger.warn(`rejecting language code not found in supportedLngs: ${n}`))};return D(e)&&(e.includes("-")||e.includes("_"))?(this.options.load!=="languageOnly"&&s(this.formatLanguageCode(e)),this.options.load!=="languageOnly"&&this.options.load!=="currentOnly"&&s(this.getScriptPartFromCode(e)),this.options.load!=="currentOnly"&&s(this.getLanguagePartFromCode(e))):D(e)&&s(this.formatLanguageCode(e)),i.forEach(n=>{o.includes(n)||s(this.formatLanguageCode(n))}),o}}const Mr={zero:0,one:1,two:2,few:3,many:4,other:5},Br={select:r=>r===1?"one":"other",resolvedOptions:()=>({pluralCategories:["one","other"]})};class dn{constructor(e,t={}){this.languageUtils=e,this.options=t,this.logger=xe.create("pluralResolver"),this.pluralRulesCache={}}clearCache(){this.pluralRulesCache={}}getRule(e,t={}){const i=wt(e==="dev"?"en":e),o=t.ordinal?"ordinal":"cardinal",s=JSON.stringify({cleanedCode:i,type:o});if(s in this.pluralRulesCache)return this.pluralRulesCache[s];let n;try{n=new Intl.PluralRules(i,{type:o})}catch{if(typeof Intl>"u")return this.logger.error("No Intl support, please use an Intl polyfill!"),Br;if(!e.match(/-|_/))return Br;const l=this.languageUtils.getLanguagePartFromCode(e);n=this.getRule(l,t)}return this.pluralRulesCache[s]=n,n}needsPlural(e,t={}){let i=this.getRule(e,t);return i||(i=this.getRule("dev",t)),(i==null?void 0:i.resolvedOptions().pluralCategories.length)>1}getPluralFormsOfKey(e,t,i={}){return this.getSuffixes(e,i).map(o=>`${t}${o}`)}getSuffixes(e,t={}){let i=this.getRule(e,t);return i||(i=this.getRule("dev",t)),i?i.resolvedOptions().pluralCategories.sort((o,s)=>Mr[o]-Mr[s]).map(o=>`${this.options.prepend}${t.ordinal?`ordinal${this.options.prepend}`:""}${o}`):[]}getSuffix(e,t,i={}){const o=this.getRule(e,i);return o?`${this.options.prepend}${i.ordinal?`ordinal${this.options.prepend}`:""}${o.select(t)}`:(this.logger.warn(`no plural rule found for: ${e}`),this.getSuffix("dev",t,i))}}const Nr=(r,e,t,i=".",o=!0)=>{let s=en(r,e,t);return!s&&o&&D(t)&&(s=wi(r,t,i),s===void 0&&(s=wi(e,t,i))),s},ui=r=>r.replace(/\$/g,"$$$$");class Hr{constructor(e={}){var t;this.logger=xe.create("interpolator"),this.options=e,this.format=((t=e==null?void 0:e.interpolation)==null?void 0:t.format)||(i=>i),this.init(e)}init(e={}){e.interpolation||(e.interpolation={escapeValue:!0});const{escape:t,escapeValue:i,useRawValueToEscape:o,prefix:s,prefixEscaped:n,suffix:a,suffixEscaped:l,formatSeparator:c,unescapeSuffix:d,unescapePrefix:p,nestingPrefix:u,nestingPrefixEscaped:b,nestingSuffix:x,nestingSuffixEscaped:_,nestingOptionsSeparator:E,maxReplaces:F,alwaysFormat:k}=e.interpolation;this.escape=t!==void 0?t:rn,this.escapeValue=i!==void 0?i:!0,this.useRawValueToEscape=o!==void 0?o:!1,this.prefix=s?ve(s):n||"{{",this.suffix=a?ve(a):l||"}}",this.formatSeparator=c||",",this.unescapePrefix=d?"":p?ve(p):"-",this.unescapeSuffix=this.unescapePrefix?"":d?ve(d):"",this.nestingPrefix=u?ve(u):b||ve("$t("),this.nestingSuffix=x?ve(x):_||ve(")"),this.nestingOptionsSeparator=E||",",this.maxReplaces=F||1e3,this.alwaysFormat=k!==void 0?k:!1,this.resetRegExp()}reset(){this.options&&this.init(this.options)}resetRegExp(){const e=(t,i)=>(t==null?void 0:t.source)===i?(t.lastIndex=0,t):new RegExp(i,"g");this.regexp=e(this.regexp,`${this.prefix}(.+?)${this.suffix}`),this.regexpUnescape=e(this.regexpUnescape,`${this.prefix}${this.unescapePrefix}(.+?)${this.unescapeSuffix}${this.suffix}`),this.nestingRegexp=e(this.nestingRegexp,`${this.nestingPrefix}((?:[^()"']+|"[^"]*"|'[^']*'|\\((?:[^()]|"[^"]*"|'[^']*')*\\))*?)${this.nestingSuffix}`)}interpolate(e,t,i,o){var b;let s,n,a;const l=this.options&&this.options.interpolation&&this.options.interpolation.defaultVariables||{},c=x=>{if(!x.includes(this.formatSeparator)){const k=Nr(t,l,x,this.options.keySeparator,this.options.ignoreJSONStructure);return this.alwaysFormat?this.format(k,void 0,i,{...o,...t,interpolationkey:x}):k}const _=x.split(this.formatSeparator),E=_.shift().trim(),F=_.join(this.formatSeparator).trim();return this.format(Nr(t,l,E,this.options.keySeparator,this.options.ignoreJSONStructure),F,i,{...o,...t,interpolationkey:E})};this.resetRegExp(),!this.escapeValue&&typeof e=="string"&&/\$t\([^)]*\{[^}]*\{\{/.test(e)&&this.logger.warn("nesting options string contains interpolated variables with escapeValue: false — if any of those values are attacker-controlled they can inject additional nesting options (e.g. redirect lng/ns). Sanitise untrusted input before passing it to t(), or keep escapeValue: true.");const d=(o==null?void 0:o.missingInterpolationHandler)||this.options.missingInterpolationHandler,p=((b=o==null?void 0:o.interpolation)==null?void 0:b.skipOnVariables)!==void 0?o.interpolation.skipOnVariables:this.options.interpolation.skipOnVariables;return[{regex:this.regexpUnescape,safeValue:x=>ui(x)},{regex:this.regexp,safeValue:x=>this.escapeValue?ui(this.escape(x)):ui(x)}].forEach(x=>{for(a=0;s=x.regex.exec(e);){const _=s[1].trim();if(n=c(_),n===void 0)if(typeof d=="function"){const F=d(e,s,o);n=D(F)?F:""}else if(o&&Object.prototype.hasOwnProperty.call(o,_))n="";else if(p){n=s[0];continue}else this.logger.warn(`missed to pass in variable ${_} for interpolating ${e}`),n="";else!D(n)&&!this.useRawValueToEscape&&(n=Lr(n));const E=x.safeValue(n);if(e=e.replace(s[0],E),p?(x.regex.lastIndex+=n.length,x.regex.lastIndex-=s[0].length):x.regex.lastIndex=0,a++,a>=this.maxReplaces)break}}),e}nest(e,t,i={}){let o,s,n;const a=(l,c)=>{const d=this.nestingOptionsSeparator;if(!l.includes(d))return l;const p=l.split(new RegExp(`${ve(d)}[ ]*{`));let u=`{${p[1]}`;l=p[0],u=this.interpolate(u,n);const b=u.match(/'/g),x=u.match(/"/g);(((b==null?void 0:b.length)??0)%2===0&&!x||((x==null?void 0:x.length)??0)%2!==0)&&(u=u.replace(/'/g,'"'));try{n=JSON.parse(u),c&&(n={...c,...n})}catch(_){return this.logger.warn(`failed parsing options string in nesting for key ${l}`,_),`${l}${d}${u}`}return n.defaultValue&&n.defaultValue.includes(this.prefix)&&delete n.defaultValue,l};for(;o=this.nestingRegexp.exec(e);){let l=[];n={...i},n=n.replace&&!D(n.replace)?n.replace:n,n.applyPostProcessor=!1,delete n.defaultValue;const c=/{.*}/.test(o[1])?o[1].lastIndexOf("}")+1:o[1].indexOf(this.formatSeparator);if(c!==-1&&(l=o[1].slice(c).split(this.formatSeparator).map(d=>d.trim()).filter(Boolean),o[1]=o[1].slice(0,c)),s=t(a.call(this,o[1].trim(),n),n),s&&o[0]===e&&!D(s))return s;D(s)||(s=Lr(s)),s||(this.logger.warn(`missed to resolve ${o[1]} for nesting ${e}`),s=""),l.length&&(s=l.reduce((d,p)=>this.format(d,p,i.lng,{...i,interpolationkey:o[1].trim()}),s.trim())),e=e.replace(o[0],s),this.regexp.lastIndex=0}return e}}const pn=r=>{let e=r.toLowerCase().trim();const t={};if(r.includes("(")){const i=r.split("(");e=i[0].toLowerCase().trim();const o=i[1].slice(0,-1);e==="currency"&&!o.includes(":")?t.currency||(t.currency=o.trim()):e==="relativetime"&&!o.includes(":")?t.range||(t.range=o.trim()):o.split(";").forEach(n=>{if(n){const[a,...l]=n.split(":"),c=l.join(":").trim().replace(/^'+|'+$/g,""),d=a.trim();t[d]||(t[d]=c),c==="false"&&(t[d]=!1),c==="true"&&(t[d]=!0),isNaN(c)||(t[d]=parseInt(c,10))}})}return{formatName:e,formatOptions:t}},qr=r=>{const e={};return(t,i,o)=>{let s=o;o&&o.interpolationkey&&o.formatParams&&o.formatParams[o.interpolationkey]&&o[o.interpolationkey]&&(s={...s,[o.interpolationkey]:void 0});const n=i+JSON.stringify(s);let a=e[n];return a||(a=r(wt(i),o),e[n]=a),a(t)}},un=r=>(e,t,i)=>r(wt(t),i)(e);class fn{constructor(e={}){this.logger=xe.create("formatter"),this.options=e,this.init(e)}init(e,t={interpolation:{}}){this.formatSeparator=t.interpolation.formatSeparator||",";const i=t.cacheInBuiltFormats?qr:un;this.formats={number:i((o,s)=>{const n=new Intl.NumberFormat(o,{...s});return a=>n.format(a)}),currency:i((o,s)=>{const n=new Intl.NumberFormat(o,{...s,style:"currency"});return a=>n.format(a)}),datetime:i((o,s)=>{const n=new Intl.DateTimeFormat(o,{...s});return a=>n.format(a)}),relativetime:i((o,s)=>{const n=new Intl.RelativeTimeFormat(o,{...s});return a=>n.format(a,s.range||"day")}),list:i((o,s)=>{const n=new Intl.ListFormat(o,{...s});return a=>n.format(a)})}}add(e,t){this.formats[e.toLowerCase().trim()]=t}addCached(e,t){this.formats[e.toLowerCase().trim()]=qr(t)}format(e,t,i,o={}){if(!t||e==null)return e;const s=t.split(this.formatSeparator);if(s.length>1&&s[0].indexOf("(")>1&&!s[0].includes(")")&&s.find(a=>a.includes(")"))){const a=s.findIndex(l=>l.includes(")"));s[0]=[s[0],...s.splice(1,a)].join(this.formatSeparator)}return s.reduce((a,l)=>{var p;const{formatName:c,formatOptions:d}=pn(l);if(this.formats[c]){let u=a;try{const b=((p=o==null?void 0:o.formatParams)==null?void 0:p[o.interpolationkey])||{},x=b.locale||b.lng||o.locale||o.lng||i;u=this.formats[c](a,x,{...d,...o,...b})}catch(b){this.logger.warn(b)}return u}else this.logger.warn(`there was no format function for ${c}`);return a},e)}}const hn=(r,e)=>{r.pending[e]!==void 0&&(delete r.pending[e],r.pendingCount--)};class gn extends ri{constructor(e,t,i,o={}){var s,n;super(),this.backend=e,this.store=t,this.services=i,this.languageUtils=i.languageUtils,this.options=o,this.logger=xe.create("backendConnector"),this.waitingReads=[],this.maxParallelReads=o.maxParallelReads||10,this.readingCalls=0,this.maxRetries=o.maxRetries>=0?o.maxRetries:5,this.retryTimeout=o.retryTimeout>=1?o.retryTimeout:350,this.state={},this.queue=[],(n=(s=this.backend)==null?void 0:s.init)==null||n.call(s,i,o.backend,o)}queueLoad(e,t,i,o){const s={},n={},a={},l={};return e.forEach(c=>{let d=!0;t.forEach(p=>{const u=`${c}|${p}`;!i.reload&&this.store.hasResourceBundle(c,p)?this.state[u]=2:this.state[u]<0||(this.state[u]===1?n[u]===void 0&&(n[u]=!0):(this.state[u]=1,d=!1,n[u]===void 0&&(n[u]=!0),s[u]===void 0&&(s[u]=!0),l[p]===void 0&&(l[p]=!0)))}),d||(a[c]=!0)}),(Object.keys(s).length||Object.keys(n).length)&&this.queue.push({pending:n,pendingCount:Object.keys(n).length,loaded:{},errors:[],callback:o}),{toLoad:Object.keys(s),pending:Object.keys(n),toLoadLanguages:Object.keys(a),toLoadNamespaces:Object.keys(l)}}loaded(e,t,i){const o=e.split("|"),s=o[0],n=o[1];t&&this.emit("failedLoading",s,n,t),!t&&i&&this.store.addResourceBundle(s,n,i,void 0,void 0,{skipCopy:!0}),this.state[e]=t?-1:2,t&&i&&(this.state[e]=0);const a={};this.queue.forEach(l=>{Qs(l.loaded,[s],n),hn(l,e),t&&l.errors.push(t),l.pendingCount===0&&!l.done&&(Object.keys(l.loaded).forEach(c=>{a[c]||(a[c]={});const d=l.loaded[c];d.length&&d.forEach(p=>{a[c][p]===void 0&&(a[c][p]=!0)})}),l.done=!0,l.errors.length?l.callback(l.errors):l.callback())}),this.emit("loaded",a),this.queue=this.queue.filter(l=>!l.done)}read(e,t,i,o=0,s=this.retryTimeout,n){if(!e.length)return n(null,{});if(this.readingCalls>=this.maxParallelReads){this.waitingReads.push({lng:e,ns:t,fcName:i,tried:o,wait:s,callback:n});return}this.readingCalls++;const a=(c,d)=>{if(this.readingCalls--,this.waitingReads.length>0){const p=this.waitingReads.shift();this.read(p.lng,p.ns,p.fcName,p.tried,p.wait,p.callback)}if(c&&d&&o<this.maxRetries){setTimeout(()=>{this.read(e,t,i,o+1,s*2,n)},s);return}n(c,d)},l=this.backend[i].bind(this.backend);if(l.length===2){try{const c=l(e,t);c&&typeof c.then=="function"?c.then(d=>a(null,d)).catch(a):a(null,c)}catch(c){a(c)}return}return l(e,t,a)}prepareLoading(e,t,i={},o){if(!this.backend)return this.logger.warn("No backend was added via i18next.use. Will not load resources."),o&&o();D(e)&&(e=this.languageUtils.toResolveHierarchy(e)),D(t)&&(t=[t]);const s=this.queueLoad(e,t,i,o);if(!s.toLoad.length)return s.pending.length||o(),null;s.toLoad.forEach(n=>{this.loadOne(n)})}load(e,t,i){this.prepareLoading(e,t,{},i)}reload(e,t,i){this.prepareLoading(e,t,{reload:!0},i)}loadOne(e,t=""){const i=e.split("|"),o=i[0],s=i[1];this.read(o,s,"read",void 0,void 0,(n,a)=>{n&&this.logger.warn(`${t}loading namespace ${s} for language ${o} failed`,n),!n&&a&&this.logger.log(`${t}loaded namespace ${s} for language ${o}`,a),this.loaded(e,n,a)})}saveMissing(e,t,i,o,s,n={},a=()=>{}){var l,c,d,p,u;if((c=(l=this.services)==null?void 0:l.utils)!=null&&c.hasLoadedNamespace&&!((p=(d=this.services)==null?void 0:d.utils)!=null&&p.hasLoadedNamespace(t))){this.logger.warn(`did not save key "${i}" as the namespace "${t}" was not yet loaded`,"This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!");return}if(!(i==null||i==="")){if((u=this.backend)!=null&&u.create){const b={...n,isUpdate:s},x=this.backend.create.bind(this.backend);if(x.length<6)try{let _;x.length===5?_=x(e,t,i,o,b):_=x(e,t,i,o),_&&typeof _.then=="function"?_.then(E=>a(null,E)).catch(a):a(null,_)}catch(_){a(_)}else x(e,t,i,o,a,b)}!e||!e[0]||this.store.addResource(e[0],t,i,o)}}}const fi=()=>({debug:!1,initAsync:!0,ns:["translation"],defaultNS:["translation"],fallbackLng:["dev"],fallbackNS:!1,supportedLngs:!1,nonExplicitSupportedLngs:!1,load:"all",preload:!1,keySeparator:".",nsSeparator:":",pluralSeparator:"_",contextSeparator:"_",enableSelector:!1,partialBundledLanguages:!1,saveMissing:!1,updateMissing:!1,saveMissingTo:"fallback",saveMissingPlurals:!0,missingKeyHandler:!1,missingInterpolationHandler:!1,postProcess:!1,postProcessPassResolved:!1,returnNull:!1,returnEmptyString:!0,returnObjects:!1,joinArrays:!1,returnedObjectHandler:!1,parseMissingKeyHandler:!1,appendNamespaceToMissingKey:!1,appendNamespaceToCIMode:!1,overloadTranslationOptionHandler:r=>{let e={};if(typeof r[1]=="object"&&(e=r[1]),D(r[1])&&(e.defaultValue=r[1]),D(r[2])&&(e.tDescription=r[2]),typeof r[2]=="object"||typeof r[3]=="object"){const t=r[3]||r[2];Object.keys(t).forEach(i=>{e[i]=t[i]})}return e},interpolation:{escapeValue:!0,prefix:"{{",suffix:"}}",formatSeparator:",",unescapePrefix:"-",nestingPrefix:"$t(",nestingSuffix:")",nestingOptionsSeparator:",",maxReplaces:1e3,skipOnVariables:!0},cacheInBuiltFormats:!0}),Vr=r=>(D(r.ns)&&(r.ns=[r.ns]),D(r.fallbackLng)&&(r.fallbackLng=[r.fallbackLng]),D(r.fallbackNS)&&(r.fallbackNS=[r.fallbackNS]),r.supportedLngs&&!r.supportedLngs.includes("cimode")&&(r.supportedLngs=r.supportedLngs.concat(["cimode"])),r),zt=()=>{},mn=r=>{Object.getOwnPropertyNames(Object.getPrototypeOf(r)).forEach(t=>{typeof r[t]=="function"&&(r[t]=r[t].bind(r))})};class xt extends ri{constructor(e={},t){if(super(),this.options=Vr(e),this.services={},this.logger=xe,this.modules={external:[]},mn(this),t&&!this.isInitialized&&!e.isClone){if(!this.options.initAsync)return this.init(e,t),this;setTimeout(()=>{this.init(e,t)},0)}}init(e={},t){this.isInitializing=!0,typeof e=="function"&&(t=e,e={}),e.defaultNS==null&&e.ns&&(D(e.ns)?e.defaultNS=e.ns:e.ns.includes("translation")||(e.defaultNS=e.ns[0]));const i=fi();this.options={...i,...this.options,...Vr(e)},this.options.interpolation={...i.interpolation,...this.options.interpolation},e.keySeparator!==void 0&&(this.options.userDefinedKeySeparator=e.keySeparator),e.nsSeparator!==void 0&&(this.options.userDefinedNsSeparator=e.nsSeparator),typeof this.options.overloadTranslationOptionHandler!="function"&&(this.options.overloadTranslationOptionHandler=i.overloadTranslationOptionHandler);const o=c=>c?typeof c=="function"?new c:c:null;if(!this.options.isClone){this.modules.logger?xe.init(o(this.modules.logger),this.options):xe.init(null,this.options);let c;this.modules.formatter?c=this.modules.formatter:c=fn;const d=new Dr(this.options);this.store=new jr(this.options.resources,this.options);const p=this.services;p.logger=xe,p.resourceStore=this.store,p.languageUtils=d,p.pluralResolver=new dn(d,{prepend:this.options.pluralSeparator}),c&&(p.formatter=o(c),p.formatter.init&&p.formatter.init(p,this.options),this.options.interpolation.format=p.formatter.format.bind(p.formatter)),p.interpolator=new Hr(this.options),p.utils={hasLoadedNamespace:this.hasLoadedNamespace.bind(this)},p.backendConnector=new gn(o(this.modules.backend),p.resourceStore,p,this.options),p.backendConnector.on("*",(u,...b)=>{this.emit(u,...b)}),this.modules.languageDetector&&(p.languageDetector=o(this.modules.languageDetector),p.languageDetector.init&&p.languageDetector.init(p,this.options.detection,this.options)),this.modules.i18nFormat&&(p.i18nFormat=o(this.modules.i18nFormat),p.i18nFormat.init&&p.i18nFormat.init(this)),this.translator=new Xt(this.services,this.options),this.translator.on("*",(u,...b)=>{this.emit(u,...b)}),this.modules.external.forEach(u=>{u.init&&u.init(this)})}if(this.format=this.options.interpolation.format,t||(t=zt),this.options.fallbackLng&&!this.services.languageDetector&&!this.options.lng){const c=this.services.languageUtils.getFallbackCodes(this.options.fallbackLng);c.length>0&&c[0]!=="dev"&&(this.options.lng=c[0])}!this.services.languageDetector&&!this.options.lng&&this.logger.warn("init: no languageDetector is used and no lng is defined"),["getResource","hasResourceBundle","getResourceBundle","getDataByLanguage"].forEach(c=>{this[c]=(...d)=>this.store[c](...d)}),["addResource","addResources","addResourceBundle","removeResourceBundle"].forEach(c=>{this[c]=(...d)=>(this.store[c](...d),this)});const a=lt(),l=()=>{const c=(d,p)=>{this.isInitializing=!1,this.isInitialized&&!this.initializedStoreOnce&&this.logger.warn("init: i18next is already initialized. You should call init just once!"),this.isInitialized=!0,this.options.isClone||this.logger.log("initialized",this.options),this.emit("initialized",this.options),a.resolve(p),t(d,p)};if((this.languages||this.isLanguageChangingTo)&&!this.isInitialized)return c(null,this.t.bind(this));this.changeLanguage(this.options.lng,c)};return this.options.resources||!this.options.initAsync?l():setTimeout(l,0),a}loadResources(e,t=zt){var s,n;let i=t;const o=D(e)?e:this.language;if(typeof e=="function"&&(i=e),!this.options.resources||this.options.partialBundledLanguages){if((o==null?void 0:o.toLowerCase())==="cimode"&&(!this.options.preload||this.options.preload.length===0))return i();const a=[],l=c=>{if(!c||c==="cimode")return;this.services.languageUtils.toResolveHierarchy(c).forEach(p=>{p!=="cimode"&&(a.includes(p)||a.push(p))})};o?l(o):this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach(d=>l(d)),(n=(s=this.options.preload)==null?void 0:s.forEach)==null||n.call(s,c=>l(c)),this.services.backendConnector.load(a,this.options.ns,c=>{!c&&!this.resolvedLanguage&&this.language&&this.setResolvedLanguage(this.language),i(c)})}else i(null)}reloadResources(e,t,i){const o=lt();return typeof e=="function"&&(i=e,e=void 0),typeof t=="function"&&(i=t,t=void 0),e||(e=this.languages),t||(t=this.options.ns),i||(i=zt),this.services.backendConnector.reload(e,t,s=>{o.resolve(),i(s)}),o}use(e){if(!e)throw new Error("You are passing an undefined module! Please check the object you are passing to i18next.use()");if(!e.type)throw new Error("You are passing a wrong module! Please check the object you are passing to i18next.use()");return e.type==="backend"&&(this.modules.backend=e),(e.type==="logger"||e.log&&e.warn&&e.error)&&(this.modules.logger=e),e.type==="languageDetector"&&(this.modules.languageDetector=e),e.type==="i18nFormat"&&(this.modules.i18nFormat=e),e.type==="postProcessor"&&Bo.addPostProcessor(e),e.type==="formatter"&&(this.modules.formatter=e),e.type==="3rdParty"&&this.modules.external.push(e),this}setResolvedLanguage(e){if(!(!e||!this.languages)&&!["cimode","dev"].includes(e)){for(let t=0;t<this.languages.length;t++){const i=this.languages[t];if(!["cimode","dev"].includes(i)&&this.store.hasLanguageSomeTranslations(i)){this.resolvedLanguage=i;break}}!this.resolvedLanguage&&!this.languages.includes(e)&&this.store.hasLanguageSomeTranslations(e)&&(this.resolvedLanguage=e,this.languages.unshift(e))}}changeLanguage(e,t){this.isLanguageChangingTo=e;const i=lt();this.emit("languageChanging",e);const o=a=>{this.language=a,this.languages=this.services.languageUtils.toResolveHierarchy(a),this.resolvedLanguage=void 0,this.setResolvedLanguage(a)},s=(a,l)=>{l?this.isLanguageChangingTo===e&&(o(l),this.translator.changeLanguage(l),this.isLanguageChangingTo=void 0,this.emit("languageChanged",l),this.logger.log("languageChanged",l)):this.isLanguageChangingTo=void 0,i.resolve((...c)=>this.t(...c)),t&&t(a,(...c)=>this.t(...c))},n=a=>{var d,p;!e&&!a&&this.services.languageDetector&&(a=[]);const l=D(a)?a:a&&a[0],c=this.store.hasLanguageSomeTranslations(l)?l:this.services.languageUtils.getBestMatchFromCodes(D(a)?[a]:a);c&&(this.language||o(c),this.translator.language||this.translator.changeLanguage(c),(p=(d=this.services.languageDetector)==null?void 0:d.cacheUserLanguage)==null||p.call(d,c)),this.loadResources(c,u=>{s(u,c)})};return!e&&this.services.languageDetector&&!this.services.languageDetector.async?n(this.services.languageDetector.detect()):!e&&this.services.languageDetector&&this.services.languageDetector.async?this.services.languageDetector.detect.length===0?this.services.languageDetector.detect().then(n):this.services.languageDetector.detect(n):n(e),i}getFixedT(e,t,i,o){const s=o==null?void 0:o.scopeNs,n=(a,l,...c)=>{let d;typeof l!="object"?d=this.options.overloadTranslationOptionHandler([a,l].concat(c)):d={...l},d.lng=d.lng||n.lng,d.lngs=d.lngs||n.lngs;const p=d.ns!==void 0&&d.ns!==null;d.ns=d.ns||n.ns,d.keyPrefix!==""&&(d.keyPrefix=d.keyPrefix||i||n.keyPrefix);const u={...this.options,...d};Array.isArray(s)&&!p&&(u.ns=s),typeof d.keyPrefix=="function"&&(d.keyPrefix=Ze(d.keyPrefix,u));const b=this.options.keySeparator||".";let x;return d.keyPrefix&&Array.isArray(a)?x=a.map(_=>(typeof _=="function"&&(_=Ze(_,u)),`${d.keyPrefix}${b}${_}`)):(typeof a=="function"&&(a=Ze(a,u)),x=d.keyPrefix?`${d.keyPrefix}${b}${a}`:a),this.t(x,d)};return D(e)?n.lng=e:n.lngs=e,n.ns=t,n.keyPrefix=i,n}t(...e){var t;return(t=this.translator)==null?void 0:t.translate(...e)}exists(...e){var t;return(t=this.translator)==null?void 0:t.exists(...e)}setDefaultNamespace(e){this.options.defaultNS=e}hasLoadedNamespace(e,t={}){if(!this.isInitialized)return this.logger.warn("hasLoadedNamespace: i18next was not initialized",this.languages),!1;if(!this.languages||!this.languages.length)return this.logger.warn("hasLoadedNamespace: i18n.languages were undefined or empty",this.languages),!1;const i=t.lng||this.resolvedLanguage||this.languages[0],o=this.options?this.options.fallbackLng:!1,s=this.languages[this.languages.length-1];if(i.toLowerCase()==="cimode")return!0;const n=(a,l)=>{const c=this.services.backendConnector.state[`${a}|${l}`];return c===-1||c===0||c===2};if(t.precheck){const a=t.precheck(this,n);if(a!==void 0)return a}return!!(this.hasResourceBundle(i,e)||!this.services.backendConnector.backend||this.options.resources&&!this.options.partialBundledLanguages||n(i,e)&&(!o||n(s,e)))}loadNamespaces(e,t){const i=lt();return this.options.ns?(D(e)&&(e=[e]),e.forEach(o=>{this.options.ns.includes(o)||this.options.ns.push(o)}),this.loadResources(o=>{i.resolve(),t&&t(o)}),i):(t&&t(),Promise.resolve())}loadLanguages(e,t){const i=lt();D(e)&&(e=[e]);const o=this.options.preload||[],s=e.filter(n=>!o.includes(n)&&this.services.languageUtils.isSupportedCode(n));return s.length?(this.options.preload=o.concat(s),this.loadResources(n=>{i.resolve(),t&&t(n)}),i):(t&&t(),Promise.resolve())}dir(e){var o,s;if(e||(e=this.resolvedLanguage||(((o=this.languages)==null?void 0:o.length)>0?this.languages[0]:this.language)),!e)return"rtl";try{const n=new Intl.Locale(e);if(n&&n.getTextInfo){const a=n.getTextInfo();if(a&&a.direction)return a.direction}}catch{}const t=["ar","shu","sqr","ssh","xaa","yhd","yud","aao","abh","abv","acm","acq","acw","acx","acy","adf","ads","aeb","aec","afb","ajp","apc","apd","arb","arq","ars","ary","arz","auz","avl","ayh","ayl","ayn","ayp","bbz","pga","he","iw","ps","pbt","pbu","pst","prp","prd","ug","ur","ydd","yds","yih","ji","yi","hbo","men","xmn","fa","jpr","peo","pes","prs","dv","sam","ckb"],i=((s=this.services)==null?void 0:s.languageUtils)||new Dr(fi());return e.toLowerCase().indexOf("-latn")>1?"ltr":t.includes(i.getLanguagePartFromCode(e))||e.toLowerCase().indexOf("-arab")>1?"rtl":"ltr"}static createInstance(e={},t){const i=new xt(e,t);return i.createInstance=xt.createInstance,i}cloneInstance(e={},t=zt){const i=e.forkResourceStore;i&&delete e.forkResourceStore;const o={...this.options,...e,isClone:!0},s=new xt(o);if((e.debug!==void 0||e.prefix!==void 0)&&(s.logger=s.logger.clone(e)),["store","services","language"].forEach(a=>{s[a]=this[a]}),s.services={...this.services},s.services.utils={hasLoadedNamespace:s.hasLoadedNamespace.bind(s)},i){const a=Object.keys(this.store.data).reduce((l,c)=>(l[c]={...this.store.data[c]},l[c]=Object.keys(l[c]).reduce((d,p)=>(d[p]={...l[c][p]},d),l[c]),l),{});s.store=new jr(a,o),s.services.resourceStore=s.store}if(e.interpolation){const l={...fi().interpolation,...this.options.interpolation,...e.interpolation},c={...o,interpolation:l};s.services.interpolator=new Hr(c)}return s.translator=new Xt(s.services,o),s.translator.on("*",(a,...l)=>{s.emit(a,...l)}),s.init(o,t),s.translator.options=o,s.translator.backendConnector.services.utils={hasLoadedNamespace:s.hasLoadedNamespace.bind(s)},s}toJSON(){return{options:this.options,store:this.store,language:this.language,languages:this.languages,resolvedLanguage:this.resolvedLanguage}}}const ce=xt.createInstance();ce.createInstance;ce.dir;ce.init;ce.loadResources;ce.reloadResources;ce.use;ce.changeLanguage;ce.getFixedT;ce.t;ce.exists;ce.setDefaultNamespace;ce.hasLoadedNamespace;ce.loadNamespaces;ce.loadLanguages;const Ho=["__proto__","constructor","prototype"];function qo(r){return!(typeof r!="string"||r.length===0||r.length>128||Ho.indexOf(r)>-1||r.indexOf("..")>-1||r.indexOf("\\")>-1||/[?#%\s@]/.test(r)||/[\x00-\x1F\x7F]/.test(r))}function Vo(r){return!(!qo(r)||r.indexOf("/")>-1)}function xn(r){return qo(r)}const vn={lng:Vo,ns:xn};function jt(r){return typeof r!="string"?r:r.replace(/[\r\n\x00-\x1F\x7F]/g," ")}function bn(r){if(typeof r!="string"||r.length===0)return r;try{const e=new URL(r);return e.username||e.password?(e.username="",e.password="",e.toString()):r}catch{return r.replace(/(\/\/)[^/@\s]+@/g,"$1")}}function Ko(){return typeof XMLHttpRequest=="function"||typeof XMLHttpRequest=="object"}function yn(r){return!!r&&typeof r.then=="function"}function wn(r){return yn(r)?r:Promise.resolve(r)}const _n=/\{\{(.+?)\}\}/g;function Kr(r,e){let t=!1;const i=r.replace(_n,(o,s)=>{const n=s.trim();if(Ho.indexOf(n)>-1)return o;const a=e[n];if(a==null)return o;const l=vn[n]||Vo,c=String(a).split("+");for(const d of c)if(!l(d))return t=!0,o;return c.join("+")});return t?null:i}const De=typeof globalThis<"u"?globalThis:typeof global<"u"?global:typeof window<"u"?window:void 0;let Jt;typeof fetch=="function"?Jt=fetch:De&&typeof De.fetch=="function"&&(Jt=De.fetch);const Yr=Ko()&&De?De.XMLHttpRequest:void 0,kn=typeof ActiveXObject=="function"&&De?De.ActiveXObject:void 0,Yo=["__proto__","constructor","prototype"],_i=(r,e)=>{if(e&&typeof e=="object"){let t="";for(const i of Object.keys(e))Yo.indexOf(i)>-1||(t+="&"+encodeURIComponent(i)+"="+encodeURIComponent(e[i]));if(!t)return r;r=r+(r.indexOf("?")!==-1?"&":"?")+t.slice(1)}return r},Wr=(r,e,t,i)=>{const o=s=>{if(!s.ok)return t(s.statusText||"Error",{status:s.status});s.text().then(n=>{t(null,{status:s.status,data:n})}).catch(t)};if(i){const s=i(r,e);if(s instanceof Promise){s.then(o).catch(t);return}}typeof fetch=="function"?fetch(r,e).then(o).catch(t):Jt(r,e).then(o).catch(t)},Sn=(r,e,t,i)=>{r.queryStringParams&&(e=_i(e,r.queryStringParams));const o={...typeof r.customHeaders=="function"?r.customHeaders():r.customHeaders};typeof window>"u"&&typeof global<"u"&&typeof global.process<"u"&&global.process.versions&&global.process.versions.node&&(o["User-Agent"]=`i18next-http-backend (node/${global.process.version}; ${global.process.platform} ${global.process.arch})`),t&&(o["Content-Type"]="application/json");const s=typeof r.requestOptions=="function"?r.requestOptions(t):r.requestOptions,n={method:t?"POST":"GET",body:t?r.stringify(t):void 0,headers:o,...r._omitFetchOptions?{}:s},a=typeof r.alternateFetch=="function"&&r.alternateFetch.length>=1?r.alternateFetch:void 0;try{Wr(e,n,i,a)}catch(l){if(!s||Object.keys(s).length===0||!l.message||l.message.indexOf("not implemented")<0)return i(l);try{Object.keys(s).forEach(c=>{delete n[c]}),Wr(e,n,i,a),r._omitFetchOptions=!0}catch(c){i(c)}}},$n=(r,e,t,i)=>{t&&typeof t=="object"&&(t=_i("",t).slice(1)),r.queryStringParams&&(e=_i(e,r.queryStringParams));try{const o=Yr?new Yr:new kn("MSXML2.XMLHTTP.3.0");o.open(t?"POST":"GET",e,1),r.crossDomain||o.setRequestHeader("X-Requested-With","XMLHttpRequest"),o.withCredentials=!!r.withCredentials,t&&o.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),o.overrideMimeType&&o.overrideMimeType("application/json");let s=r.customHeaders;if(s=typeof s=="function"?s():s,s)for(const n of Object.keys(s))Yo.indexOf(n)>-1||o.setRequestHeader(n,s[n]);o.onreadystatechange=()=>{o.readyState>3&&i(o.status>=400?o.statusText:null,{status:o.status,data:o.responseText})},o.send(t)}catch(o){console&&console.log(o)}},Cn=(r,e,t,i)=>{if(typeof t=="function"&&(i=t,t=void 0),i=i||(()=>{}),Jt&&e.indexOf("file:")!==0)return Sn(r,e,t,i);if(Ko()||typeof ActiveXObject=="function")return $n(r,e,t,i);i(new Error("No fetch and no xhr implementation found!"))},En=()=>({loadPath:"/locales/{{lng}}/{{ns}}.json",addPath:"/locales/add/{{lng}}/{{ns}}",parse:r=>JSON.parse(r),stringify:JSON.stringify,parsePayload:(r,e,t)=>({[e]:t||""}),parseLoadPayload:(r,e)=>{},request:Cn,reloadInterval:typeof window<"u"?!1:3600*1e3,customHeaders:{},queryStringParams:{},crossDomain:!1,withCredentials:!1,overrideMimeType:!1,requestOptions:{mode:"cors",credentials:"same-origin",cache:"default"}});var Wo=class{constructor(r,e={},t={}){this.services=r,this.options=e,this.allOptions=t,this.type="backend",this.init(r,e,t)}init(r,e={},t={}){if(this.services=r,this.options={...En(),...this.options||{},...e},this.allOptions=t,this.services&&this.options.reloadInterval){const i=setInterval(()=>this.reload(),this.options.reloadInterval);typeof i=="object"&&typeof i.unref=="function"&&i.unref()}}readMulti(r,e,t){this._readAny(r,r,e,e,t)}read(r,e,t){this._readAny([r],r,[e],e,t)}_readAny(r,e,t,i,o){let s=this.options.loadPath;typeof this.options.loadPath=="function"&&(s=this.options.loadPath(r,t)),s=wn(s),s.then(n=>{if(!n)return o(null,{});const a=Kr(n,{lng:r.join("+"),ns:t.join("+")});if(a==null){const l=r.map(jt).join(", "),c=t.map(jt).join(", ");return o(new Error("i18next-http-backend: unsafe lng/ns value — refusing to build request URL for languages=["+l+"] namespaces=["+c+"]"),!1)}this.loadUrl(a,o,e,i)})}loadUrl(r,e,t,i){const o=typeof t=="string"?[t]:t,s=typeof i=="string"?[i]:i,n=this.options.parseLoadPayload(o,s),a=jt(bn(r));this.options.request(this.options,r,n,(l,c)=>{if(c&&(c.status>=500&&c.status<600||!c.status))return e("failed loading "+a+"; status code: "+c.status,!0);if(c&&c.status>=400&&c.status<500)return e("failed loading "+a+"; status code: "+c.status,!1);if(!c&&l&&l.message){const u=l.message.toLowerCase();if(["failed","fetch","network","load"].find(b=>u.indexOf(b)>-1))return e("failed loading "+a+": "+jt(l.message),!0)}if(l)return e(l,!1);let d,p;try{typeof c.data=="string"?d=this.options.parse(c.data,t,i):d=c.data}catch{p="failed parsing "+a+" to json"}if(p)return e(p,!1);e(null,d)})}create(r,e,t,i,o){if(!this.options.addPath)return;typeof r=="string"&&(r=[r]);const s=this.options.parsePayload(e,t,i);let n=0;const a=[],l=[];r.forEach(c=>{let d=this.options.addPath;typeof this.options.addPath=="function"&&(d=this.options.addPath(c,e));const p=Kr(d,{lng:c,ns:e});if(p==null){n+=1,o&&n===r.length&&o(a,l);return}this.options.request(this.options,p,s,(u,b)=>{n+=1,a.push(u),l.push(b),n===r.length&&typeof o=="function"&&o(a,l)})})}reload(){const{backendConnector:r,languageUtils:e,logger:t}=this.services,i=r.language;if(i&&i.toLowerCase()==="cimode")return;const o=[],s=n=>{e.toResolveHierarchy(n).forEach(a=>{o.indexOf(a)<0&&o.push(a)})};s(i),this.allOptions.preload&&this.allOptions.preload.forEach(n=>s(n)),o.forEach(n=>{this.allOptions.ns.forEach(a=>{r.read(n,a,"read",null,null,(l,c)=>{l&&t.warn(`loading namespace ${a} for language ${n} failed`,l),!l&&c&&t.log(`loaded namespace ${a} for language ${n}`,c),r.loaded(`${n}|${a}`,l,c)})})})}};Wo.type="backend";const Go="f7b2366e-fcb6-4f1a-8f23-8de48422989a",Pn="https://i18n-fastly.ultrafast.io",Un="https://neo.wordplex.io",ki="uploader";let Le=null;async function Rn(r="en"){return Le?(Le.language!==r&&await Le.changeLanguage(r),{i18n:Le,isNew:!1}):(Le=ce.createInstance(),await Le.use(Wo).init({lng:r,fallbackLng:"en",ns:[ki],defaultNS:ki,saveMissing:!0,missingKeyNoValueFallbackToKey:!1,backend:{addPath:"",loadPath:`${Pn}/api/export/grid/f2/${Go}?langs={{lng}}&separator=+&response_format=i18next_multi`,parse(e,t){var s;const i=JSON.parse(e),o=Array.isArray(t)?t[0]:t;return o&&((s=i[o])!=null&&s.__without_namespace)?i[o].__without_namespace:i}}}),{i18n:Le,isNew:!0})}const On="sfxUploaderTranslationsMissingKeysEnabled";class Tn{constructor(){this.enabled=!1,this._missingKeys={},this._timer=null,this.debounceDelay=2e3,this.enabled=typeof localStorage<"u"&&localStorage.getItem(On)==="true",this.enabled&&console.log("%c[uploader] TranslationMissingKeysHelper enabled","font-weight:600;"),this._missingKeys=new Proxy(this._missingKeys,{set:(e,t,i,o)=>(this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>this._renderCurl(),this.debounceDelay),Reflect.set(e,t,i,o))})}handleMissingKey(e,t="",i=ki){if(!this.enabled)return;const o=`${i}:${e}`;this._missingKeys[o]={value:t,ns:i}}_renderCurl(){console.group("[uploader] Missing translation keys"),console.log("%cMissing keys:","font-weight:600;font-size:200%;"),console.table({...this._missingKeys}),console.log("%ccURL (check carefully data before send):","font-weight:600;font-size:150%;"),console.log(`
curl '${Un}/api/import/request-translations' \\
  --data-raw '{"grid_uuid":"${Go}","translations_requests":${JSON.stringify(Object.entries(this._missingKeys).map(([e,{value:t,ns:i}])=>({key:i&&e.startsWith(`${i}:`)?e.slice(i.length+1):e,lang:"en",default:t}))).replaceAll("'","'\\''")}}'
    `),console.groupEnd()}}const An=new Tn;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ln={attribute:!0,type:String,converter:Kt,reflect:!1,hasChanged:qi},Fn=(r=Ln,e,t)=>{const{kind:i,metadata:o}=t;let s=globalThis.litPropertyMetadata.get(o);if(s===void 0&&globalThis.litPropertyMetadata.set(o,s=new Map),i==="setter"&&((r=Object.create(r)).wrapped=!0),s.set(t.name,r),i==="accessor"){const{name:n}=t;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(n,l,r,!0,a)},init(a){return a!==void 0&&this.C(n,void 0,r,a),a}}}if(i==="setter"){const{name:n}=t;return function(a){const l=this[n];e.call(this,a),this.requestUpdate(n,l,r,!0,a)}}throw Error("Unsupported decorator location: "+i)};function O(r){return(e,t)=>typeof t=="object"?Fn(r,e,t):((i,o,s)=>{const n=o.hasOwnProperty(s);return o.constructor.createProperty(s,i),n?Object.getOwnPropertyDescriptor(o,s):void 0})(r,e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const In=(r,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(r,e,t),t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ki(r,e){return(t,i,o)=>{const s=n=>{var a;return((a=n.renderRoot)==null?void 0:a.querySelector(r))??null};return In(t,i,{get(){return s(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Yi={ATTRIBUTE:1,CHILD:2,ELEMENT:6},oi=r=>(...e)=>({_$litDirective$:r,values:e});class Wi{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const hi=r=>r.includes("-")?r:r.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`);class zn extends Wi{constructor(e){if(super(e),this._appliedProps=new Set,e.type!==Yi.ELEMENT)throw new Error("cspStyle must be used as an element directive: <el ${cspStyle({...})}>")}render(e){return he}update(e,[t]){if(t===this._lastStyles)return he;this._lastStyles=t;const{style:i}=e.element,o=t??{};for(const s of this._appliedProps)(!(s in o)||o[s]==null||o[s]==="")&&(i.removeProperty(hi(s)),this._appliedProps.delete(s));for(const[s,n]of Object.entries(o))n!=null&&n!==""?(i.setProperty(hi(s),n),this._appliedProps.add(s)):this._appliedProps.has(s)&&(i.removeProperty(hi(s)),this._appliedProps.delete(s));return he}}const Q=oi(zn);function jn(r,e){var n,a,l;const t=(n=e==null?void 0:e.getLocateUrl)==null?void 0:n.call(e,r);if(t)return t;const i=(e==null?void 0:e.adminUrl)??(typeof window<"u"?window.location.origin:void 0);if(!i)return null;const o=(l=(a=r.response)==null?void 0:a.file)==null?void 0:l.uuid;return o?`${i.replace(/\/+$/,"")}/library?lf=${encodeURIComponent(btoa(o))}`:null}class Dn{constructor(e){this.listeners=new Set,this._notifying=!1,this._pendingState=null,this.state=e}getState(){return this.state}setState(e){if(this._notifying){this._pendingState={...this._pendingState||{},...e};return}const t=this.state;this.state={...t,...e},this._notifying=!0;try{this.listeners.forEach(i=>i(this.state,t))}finally{this._notifying=!1}if(this._pendingState){const i=this._pendingState;this._pendingState=null,this.setState(i)}}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}destroy(){this.listeners.clear()}}function Z(r,e,t){const i=r.getState().files,o=i.get(e);if(!o)return;const s=new Map(i);s.set(e,{...o,...t}),r.setState({files:s})}function qe(r,e){const t=new Map(r.getState().files);t.set(e.id,e),r.setState({files:t})}function Gr(r,e){const t=r.getState().files;if(!t.has(e))return;const i=new Map(t);i.delete(e),r.setState({files:i})}function Mn(){return new Dn({files:new Map,queueConfig:{concurrency:3,autoProceed:!1,retryConfig:{maxRetries:0,baseDelay:1e3,maxDelay:3e4,backoffFactor:2}},isPaused:!1,restrictions:{maxFileSize:null,maxTotalFilesSize:null,maxNumberOfFiles:null,minNumberOfFiles:null,allowedFileTypes:null,blockedFileTypes:null},targetFolder:"/",totalProgress:0,totalSpeed:0,totalBytesUploaded:0,totalBytes:0,isUploading:!1,t:(r,e,t)=>{const i=(o,s)=>o.replace(/\{\{(\w+)\}\}/g,(n,a)=>String(s[a]??""));if(typeof e=="string")return i(e,t??{});if(typeof e=="object"&&e!==null){const o=e,s=o.count;if(s!==void 0){const n=String((s===1?o.defaultValue_one:o.defaultValue_other)??o.defaultValue??r);return i(n,o)}return i(String(o.defaultValue??r),o)}return r}})}class Bn{constructor(e,t){this.host=e,this.store=t,e.addController(this)}get state(){return this.store.getState()}setState(e){this.store.setState(e)}hostConnected(){this.unsubscribe=this.store.subscribe(()=>{this.host.requestUpdate()})}hostDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this)}}const Nn="SAME_ASSET_EXISTS_SKIP_UPLOAD";function Ot(r){return(r==null?void 0:r.code)===Nn}function Gi(r,e){return{...r,status:"success",file:r.file??{uuid:r.existing_file_uuid??"",name:e.name,extension:e.name.split(".").pop()??"",type:e.type,size:e.size,url:{public:"",cdn:""},meta:{},tags:[],info:{},created_at:"",modified_at:""}}}const Hn=/[!#$%^&*()=+{}\[\];"<>\\,\/?~\t\n\r\s`]/;function Xi(r){return r?r.ref!=null&&r.ref!==""||r.position!=null:!1}function Ji(r){const e={};return(r==null?void 0:r.ref)!=null&&r.ref!==""&&(e.ref=r.ref),(r==null?void 0:r.position)!=null&&(e.position=r.position),e}function Xr(r,e){const t={...r??{}};for(const i of Object.keys(e)){const o=e[i];o===void 0?delete t[i]:t[i]=o}return t}function qn(r,e,t){let o=`${r.replace(/\/+$/,"")}/v4/files?folder=${encodeURIComponent(e)}`;if(t)for(const[s,n]of Object.entries(t))n!=null&&(o+=`&${encodeURIComponent(s)}=${encodeURIComponent(n)}`);return o}function Vn(r,e){const t=new XMLHttpRequest;let i=!1;const o=qn(e.apiBase,e.folder,e.extraParams);t.open("POST",o);for(const[n,a]of Object.entries(e.authHeaders))t.setRequestHeader(n,a);t.upload.addEventListener("progress",n=>{n.lengthComputable&&!i&&e.onProgress(n.loaded,n.total)}),t.addEventListener("load",()=>{if(i)return;let n;try{n=JSON.parse(t.responseText)}catch{e.onError(new Error(`Invalid JSON response (HTTP ${t.status})`));return}t.status>=200&&t.status<300&&n.status==="success"?e.onComplete(n):Ot(n)?e.onComplete(Gi(n,r)):e.onError(new Error(n.hint||n.msg||`Upload failed (HTTP ${t.status})`))}),t.addEventListener("error",()=>{i||e.onError(new Error("Network error — check your connection"))});const s=new FormData;if(r.file){const n={name:r.name,type:r.type};s.append("info[files[]]",JSON.stringify(n)),Object.keys(r.meta).length>0&&s.append("meta[files[]]",JSON.stringify(r.meta)),r.tags.length>0&&s.append("tags[files[]]",JSON.stringify(r.tags)),Xi(r.product)&&s.append("product[files[]]",JSON.stringify(Ji(r.product))),s.append("files[]",r.file,r.name)}return t.send(s),{abort(){i=!0,t.abort()}}}function si(r){return{Accept:"application/json","Content-Type":"application/json","uppy-auth-token":r}}function Te(r){return r.replace(/\/+$/,"")}const Kn={"google-drive":"drive",dropbox:"dropbox",onedrive:"onedrive",box:"box",instagram:"instagram",facebook:"facebook",unsplash:"unsplash"};function Tt(r){return Kn[r]??r}function nd(r,e){const t=Te(r),i=btoa(JSON.stringify({origin:window.location.origin})),o=Tt(e);return`${t}/${o}/connect?state=${encodeURIComponent(i)}`}async function Yn(r,e,t,i="",o){const s=Te(r),n=i?`/${i}`:"",a=Tt(e),l=await fetch(`${s}/${a}/list${n}`,{method:"GET",headers:si(t),credentials:"same-origin",signal:o});if(l.status===401)throw new Zi;if(!l.ok){const c=await l.json().catch(()=>null);throw new Error((c==null?void 0:c.message)||`Companion list failed (HTTP ${l.status})`)}return l.json()}async function Wn(r,e,t,i){const o=Te(r),s=await fetch(`${o}/${t}`,{method:"GET",headers:si(e),credentials:"same-origin",signal:i});if(s.status===401)throw new Zi;if(!s.ok){const n=await s.json().catch(()=>null);throw new Error((n==null?void 0:n.message)||`Companion list failed (HTTP ${s.status})`)}return s.json()}async function ad(r,e,t,i,o,s){const n=[];async function a(l,c){let d=null,p=!0;do{if(s!=null&&s.aborted)throw new DOMException("Aborted","AbortError");const u=p?await Yn(r,e,t,l,s):await Wn(r,t,d,s);p=!1,d=u.nextPagePath;for(const b of u.items){if(s!=null&&s.aborted)throw new DOMException("Aborted","AbortError");if(b.isFolder){const x=c?`${c}/${b.name}`:b.name;await a(b.requestPath,x)}else n.push({...b,relativeFolder:c})}}while(d)}return await a(i,o),n}async function ld(r,e,t,i){const o=Te(r),s=Tt(e),n=i?`q=${encodeURIComponent(t)}&${i}`:`q=${encodeURIComponent(t)}`,a=await fetch(`${o}/search/${s}/list?${n}`,{method:"GET",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin"});if(!a.ok){const l=await a.json().catch(()=>null);throw new Error((l==null?void 0:l.message)||`Search failed (HTTP ${a.status})`)}return a.json()}async function Gn(r,e,t,i,o,s=!1){const n=Te(r),a=Tt(e),l=s?`${n}/search/${a}/get/${i}`:`${n}/${a}/get/${i}`,c=s?{Accept:"application/json","Content-Type":"application/json"}:si(t),d=await fetch(l,{method:"POST",headers:c,credentials:"same-origin",body:JSON.stringify({...o,httpMethod:o.httpMethod??"POST",useFormData:o.useFormData??!0,fieldname:o.fieldname??"files[]"})});if(d.status===401)throw new Zi;if(!d.ok){const p=await d.json().catch(()=>null);throw new Error((p==null?void 0:p.message)||`Companion upload failed (HTTP ${d.status})`)}return d.json()}async function Xn(r,e,t){const i=Te(r),o=await fetch(`${i}/url/meta`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin",body:JSON.stringify({url:e}),signal:t});if(!o.ok){const s=await o.json().catch(()=>null);throw new Error((s==null?void 0:s.message)||`Could not fetch URL metadata (HTTP ${o.status})`)}return o.json()}async function Jn(r,e,t,i){const o=Te(r),s=await fetch(`${o}/url/get`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},credentials:"same-origin",body:JSON.stringify({url:e,...t,httpMethod:"POST",useFormData:!0,fieldname:"files[]"}),signal:i});if(!s.ok){const n=await s.json().catch(()=>null);throw new Error((n==null?void 0:n.message)||`Companion URL upload failed (HTTP ${s.status})`)}return s.json()}async function cd(r,e,t){const i=Te(r),o=Tt(e),s=await fetch(`${i}/${o}/logout`,{method:"GET",headers:si(t),credentials:"same-origin"});return s.ok?s.json():{ok:!1,revoked:!1}}function Zn(r){var o;const t=((o=/^(?:https?:\/\/|\/\/)?(?:[^@\n]+@)?(?:www\.)?([^\n]+)/i.exec(r))==null?void 0:o[1])??r;return`${/^https:\/\//i.test(r)?"wss":"ws"}://${t}`}class Zi extends Error{constructor(){super("Authentication expired"),this.name="AuthExpiredError"}}function Xo(r,e,t){let o=`${r.replace(/\/+$/,"")}/v4/files?folder=${encodeURIComponent(e)}`;if(t)for(const[s,n]of Object.entries(t))n!=null&&(o+=`&${encodeURIComponent(s)}=${encodeURIComponent(n)}`);return o}function Jo(r,e){const t={name:r.name,type:r.type,"filerobot-folder":e};return r.meta&&Object.keys(r.meta).length>0&&(t.meta=JSON.stringify(r.meta)),r.tags&&r.tags.length>0&&(t.tags=JSON.stringify(r.tags)),Xi(r.product)&&(t.product=JSON.stringify(Ji(r.product))),t}function Zo(r){const t=`${Zn(r.companionUrl)}/api/${r.token}`;let i;try{i=new WebSocket(t)}catch{return r.onError(new Error("Failed to connect to upload progress channel")),null}let o=!1;const s=()=>{o=!0,i.onmessage=null,i.onerror=null,i.onclose=null};return i.onmessage=n=>{var a,l,c;if(!o)try{const d=JSON.parse(n.data);switch(d.action){case"progress":{const p=d.payload,u=p.bytesUploaded??0,b=p.bytesTotal??(r.expectedSize||1);r.onProgress(u,b);break}case"success":{const p=d.payload;if(s(),i.close(),(a=p.response)!=null&&a.responseText)try{const u=JSON.parse(p.response.responseText);if(u.status==="success"){r.onComplete(u);return}if(Ot(u)){r.onComplete(Gi(u,r.uploadFile));return}r.onError(new Error(u.msg||"Upload failed"));return}catch{}r.onError(new Error("Upload completed but no valid response received"));break}case"error":{const p=d.payload;s(),i.close();let u=((l=p.error)==null?void 0:l.message)||"Upload failed";if((c=p.response)!=null&&c.responseText)try{const b=JSON.parse(p.response.responseText);u=b.hint||b.msg||b.message||u}catch{}r.onError(new Error(u));break}}}catch{}},i.onerror=()=>{o||(s(),r.onError(new Error("Upload progress connection failed")))},i.onclose=()=>{o||(s(),r.onError(new Error("Upload progress connection closed unexpectedly")))},i}function Qo(r){if(r){r.onmessage=null,r.onerror=null,r.onclose=null;try{r.send(JSON.stringify({action:"cancel",payload:{}}))}catch{}r.close()}}function Qn(r,e){const t=r.remoteInfo;if(!t)return e.onError(new Error("remoteInfo is required for companion upload")),{abort(){}};let i=!1,o=null;const s=Xo(e.apiBase,e.folder,e.extraParams),n=Jo(r,e.folder),a=!t.token;return Gn(t.companionUrl,t.provider,t.token,t.requestPath,{fileId:t.fileId,endpoint:s,headers:e.authHeaders,size:t.size,metadata:n},a).then(l=>{i||(o=Zo({companionUrl:t.companionUrl,token:l.token,uploadFile:r,expectedSize:t.size,onProgress:(c,d)=>{i||e.onProgress(c,d)},onComplete:c=>{i||e.onComplete(c)},onError:c=>{i||e.onError(c)}}))}).catch(l=>{i||e.onError(l instanceof Error?l:new Error(String(l)))}),{abort(){i=!0,Qo(o),o=null}}}function ea(r,e){const t=r.remoteUrl;if(!t)return e.onError(new Error("Remote URL is required for URL upload")),{abort(){}};let i=!1,o=null;const s=new AbortController,n=Xo(e.apiBase,e.folder,e.extraParams);return Xn(e.companionUrl,t,s.signal).then(a=>{var c;if(i)return null;(c=e.onMeta)==null||c.call(e,{name:a.name,type:a.type,size:a.size});const l=Jo(r,e.folder);return a.name&&(l.name=a.name),a.type&&(l.type=a.type),Jn(e.companionUrl,t,{fileId:r.id,endpoint:n,headers:e.authHeaders,size:a.size,metadata:l},s.signal).then(d=>({result:d,size:a.size}))}).then(a=>{i||!a||(o=Zo({companionUrl:e.companionUrl,token:a.result.token,uploadFile:r,expectedSize:a.size,onProgress:(l,c)=>{i||e.onProgress(l,c)},onComplete:l=>{i||e.onComplete(l)},onError:l=>{i||e.onError(l)}}))}).catch(a=>{i||a&&a.name==="AbortError"||e.onError(a instanceof Error?a:new Error(String(a)))}),{abort(){i=!0,s.abort(),Qo(o),o=null}}}function Si(r){"@babel/helpers - typeof";return Si=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Si(r)}function ta(r,e,t){return Object.defineProperty(r,"prototype",{writable:!1}),r}function ia(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function ra(r,e,t){return e=kt(e),oa(r,Qi()?Reflect.construct(e,t||[],kt(r).constructor):e.apply(r,t))}function oa(r,e){if(e&&(Si(e)==="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return sa(r)}function sa(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function na(r,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");r.prototype=Object.create(e&&e.prototype,{constructor:{value:r,writable:!0,configurable:!0}}),Object.defineProperty(r,"prototype",{writable:!1}),e&&_t(r,e)}function $i(r){var e=typeof Map=="function"?new Map:void 0;return $i=function(i){if(i===null||!la(i))return i;if(typeof i!="function")throw new TypeError("Super expression must either be null or a function");if(typeof e<"u"){if(e.has(i))return e.get(i);e.set(i,o)}function o(){return aa(i,arguments,kt(this).constructor)}return o.prototype=Object.create(i.prototype,{constructor:{value:o,enumerable:!1,writable:!0,configurable:!0}}),_t(o,i)},$i(r)}function aa(r,e,t){if(Qi())return Reflect.construct.apply(null,arguments);var i=[null];i.push.apply(i,e);var o=new(r.bind.apply(r,i));return t&&_t(o,t.prototype),o}function Qi(){try{var r=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(Qi=function(){return!!r})()}function la(r){try{return Function.toString.call(r).indexOf("[native code]")!==-1}catch{return typeof r=="function"}}function _t(r,e){return _t=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(i,o){return i.__proto__=o,i},_t(r,e)}function kt(r){return kt=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},kt(r)}var dt=(function(r){function e(t){var i,o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null,s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:null,n=arguments.length>3&&arguments[3]!==void 0?arguments[3]:null;if(ia(this,e),i=ra(this,e,[t]),i.originalRequest=s,i.originalResponse=n,i.causingError=o,o!=null&&(t+=", caused by ".concat(o.toString())),s!=null){var a=s.getHeader("X-Request-ID")||"n/a",l=s.getMethod(),c=s.getURL(),d=n?n.getStatus():"n/a",p=n?n.getBody()||"":"n/a";t+=", originated from request (method: ".concat(l,", url: ").concat(c,", response code: ").concat(d,", response text: ").concat(p,", request id: ").concat(a,")")}return i.message=t,i}return na(e,r),ta(e)})($i(Error));function St(r){"@babel/helpers - typeof";return St=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},St(r)}function ca(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function da(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,ua(i.key),i)}}function pa(r,e,t){return e&&da(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function ua(r){var e=fa(r,"string");return St(e)=="symbol"?e:e+""}function fa(r,e){if(St(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(St(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var ha=(function(){function r(){ca(this,r)}return pa(r,[{key:"listAllUploads",value:function(){return Promise.resolve([])}},{key:"findUploadsByFingerprint",value:function(t){return Promise.resolve([])}},{key:"removeUpload",value:function(t){return Promise.resolve()}},{key:"addUpload",value:function(t,i){return Promise.resolve(null)}}])})();const es="3.7.8",ga=es,st=typeof Buffer=="function",Jr=typeof TextDecoder=="function"?new TextDecoder:void 0,Zr=typeof TextEncoder=="function"?new TextEncoder:void 0,ma="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",pt=Array.prototype.slice.call(ma),Dt=(r=>{let e={};return r.forEach((t,i)=>e[t]=i),e})(pt),xa=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,re=String.fromCharCode.bind(String),Qr=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):r=>new Uint8Array(Array.prototype.slice.call(r,0)),ts=r=>r.replace(/=/g,"").replace(/[+\/]/g,e=>e=="+"?"-":"_"),is=r=>r.replace(/[^A-Za-z0-9\+\/]/g,""),rs=r=>{let e,t,i,o,s="";const n=r.length%3;for(let a=0;a<r.length;){if((t=r.charCodeAt(a++))>255||(i=r.charCodeAt(a++))>255||(o=r.charCodeAt(a++))>255)throw new TypeError("invalid character found");e=t<<16|i<<8|o,s+=pt[e>>18&63]+pt[e>>12&63]+pt[e>>6&63]+pt[e&63]}return n?s.slice(0,n-3)+"===".substring(n):s},er=typeof btoa=="function"?r=>btoa(r):st?r=>Buffer.from(r,"binary").toString("base64"):rs,Ci=st?r=>Buffer.from(r).toString("base64"):r=>{let t=[];for(let i=0,o=r.length;i<o;i+=4096)t.push(re.apply(null,r.subarray(i,i+4096)));return er(t.join(""))},Nt=(r,e=!1)=>e?ts(Ci(r)):Ci(r),va=r=>{if(r.length<2){var e=r.charCodeAt(0);return e<128?r:e<2048?re(192|e>>>6)+re(128|e&63):re(224|e>>>12&15)+re(128|e>>>6&63)+re(128|e&63)}else{var e=65536+(r.charCodeAt(0)-55296)*1024+(r.charCodeAt(1)-56320);return re(240|e>>>18&7)+re(128|e>>>12&63)+re(128|e>>>6&63)+re(128|e&63)}},ba=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,os=r=>r.replace(ba,va),eo=st?r=>Buffer.from(r,"utf8").toString("base64"):Zr?r=>Ci(Zr.encode(r)):r=>er(os(r)),Qe=(r,e=!1)=>e?ts(eo(r)):eo(r),to=r=>Qe(r,!0),ya=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,wa=r=>{switch(r.length){case 4:var e=(7&r.charCodeAt(0))<<18|(63&r.charCodeAt(1))<<12|(63&r.charCodeAt(2))<<6|63&r.charCodeAt(3),t=e-65536;return re((t>>>10)+55296)+re((t&1023)+56320);case 3:return re((15&r.charCodeAt(0))<<12|(63&r.charCodeAt(1))<<6|63&r.charCodeAt(2));default:return re((31&r.charCodeAt(0))<<6|63&r.charCodeAt(1))}},ss=r=>r.replace(ya,wa),ns=r=>{if(r=r.replace(/\s+/g,""),!xa.test(r))throw new TypeError("malformed base64.");r+="==".slice(2-(r.length&3));let e,t,i,o=[];for(let s=0;s<r.length;)e=Dt[r.charAt(s++)]<<18|Dt[r.charAt(s++)]<<12|(t=Dt[r.charAt(s++)])<<6|(i=Dt[r.charAt(s++)]),t===64?o.push(re(e>>16&255)):i===64?o.push(re(e>>16&255,e>>8&255)):o.push(re(e>>16&255,e>>8&255,e&255));return o.join("")},tr=typeof atob=="function"?r=>atob(is(r)):st?r=>Buffer.from(r,"base64").toString("binary"):ns,as=st?r=>Qr(Buffer.from(r,"base64")):r=>Qr(tr(r).split("").map(e=>e.charCodeAt(0))),ls=r=>as(cs(r)),_a=st?r=>Buffer.from(r,"base64").toString("utf8"):Jr?r=>Jr.decode(as(r)):r=>ss(tr(r)),cs=r=>is(r.replace(/[-_]/g,e=>e=="-"?"+":"/")),Ei=r=>_a(cs(r)),ka=r=>{if(typeof r!="string")return!1;const e=r.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(e)||!/[^\s0-9a-zA-Z\-_]/.test(e)},ds=r=>({value:r,enumerable:!1,writable:!0,configurable:!0}),ps=function(){const r=(e,t)=>Object.defineProperty(String.prototype,e,ds(t));r("fromBase64",function(){return Ei(this)}),r("toBase64",function(e){return Qe(this,e)}),r("toBase64URI",function(){return Qe(this,!0)}),r("toBase64URL",function(){return Qe(this,!0)}),r("toUint8Array",function(){return ls(this)})},us=function(){const r=(e,t)=>Object.defineProperty(Uint8Array.prototype,e,ds(t));r("toBase64",function(e){return Nt(this,e)}),r("toBase64URI",function(){return Nt(this,!0)}),r("toBase64URL",function(){return Nt(this,!0)})},Sa=()=>{ps(),us()},$a={version:es,VERSION:ga,atob:tr,atobPolyfill:ns,btoa:er,btoaPolyfill:rs,fromBase64:Ei,toBase64:Qe,encode:Qe,encodeURI:to,encodeURL:to,utob:os,btou:ss,decode:Ei,isValid:ka,fromUint8Array:Nt,toUint8Array:ls,extendString:ps,extendUint8Array:us,extendBuiltins:Sa};var io=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ca(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var gi,ro;function Ea(){return ro||(ro=1,gi=function(e,t){if(t=t.split(":")[0],e=+e,!e)return!1;switch(t){case"http":case"ws":return e!==80;case"https":case"wss":return e!==443;case"ftp":return e!==21;case"gopher":return e!==70;case"file":return!1}return e!==0}),gi}var Mt={},oo;function Pa(){if(oo)return Mt;oo=1;var r=Object.prototype.hasOwnProperty,e;function t(n){try{return decodeURIComponent(n.replace(/\+/g," "))}catch{return null}}function i(n){try{return encodeURIComponent(n)}catch{return null}}function o(n){for(var a=/([^=?#&]+)=?([^&]*)/g,l={},c;c=a.exec(n);){var d=t(c[1]),p=t(c[2]);d===null||p===null||d in l||(l[d]=p)}return l}function s(n,a){a=a||"";var l=[],c,d;typeof a!="string"&&(a="?");for(d in n)if(r.call(n,d)){if(c=n[d],!c&&(c===null||c===e||isNaN(c))&&(c=""),d=i(d),c=i(c),d===null||c===null)continue;l.push(d+"="+c)}return l.length?a+l.join("&"):""}return Mt.stringify=s,Mt.parse=o,Mt}var mi,so;function Ua(){if(so)return mi;so=1;var r=Ea(),e=Pa(),t=/^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/,i=/[\n\r\t]/g,o=/^[A-Za-z][A-Za-z0-9+-.]*:\/\//,s=/:\d+$/,n=/^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,a=/^[a-zA-Z]:/;function l(k){return(k||"").toString().replace(t,"")}var c=[["#","hash"],["?","query"],function(w,y){return u(y.protocol)?w.replace(/\\/g,"/"):w},["/","pathname"],["@","auth",1],[NaN,"host",void 0,1,1],[/:(\d*)$/,"port",void 0,1],[NaN,"hostname",void 0,1,1]],d={hash:1,query:1};function p(k){var w;typeof window<"u"?w=window:typeof io<"u"?w=io:typeof self<"u"?w=self:w={};var y=w.location||{};k=k||y;var m={},R=typeof k,U;if(k.protocol==="blob:")m=new _(unescape(k.pathname),{});else if(R==="string"){m=new _(k,{});for(U in d)delete m[U]}else if(R==="object"){for(U in k)U in d||(m[U]=k[U]);m.slashes===void 0&&(m.slashes=o.test(k.href))}return m}function u(k){return k==="file:"||k==="ftp:"||k==="http:"||k==="https:"||k==="ws:"||k==="wss:"}function b(k,w){k=l(k),k=k.replace(i,""),w=w||{};var y=n.exec(k),m=y[1]?y[1].toLowerCase():"",R=!!y[2],U=!!y[3],z=0,L;return R?U?(L=y[2]+y[3]+y[4],z=y[2].length+y[3].length):(L=y[2]+y[4],z=y[2].length):U?(L=y[3]+y[4],z=y[3].length):L=y[4],m==="file:"?z>=2&&(L=L.slice(2)):u(m)?L=y[4]:m?R&&(L=L.slice(2)):z>=2&&u(w.protocol)&&(L=y[4]),{protocol:m,slashes:R||u(m),slashesCount:z,rest:L}}function x(k,w){if(k==="")return w;for(var y=(w||"/").split("/").slice(0,-1).concat(k.split("/")),m=y.length,R=y[m-1],U=!1,z=0;m--;)y[m]==="."?y.splice(m,1):y[m]===".."?(y.splice(m,1),z++):z&&(m===0&&(U=!0),y.splice(m,1),z--);return U&&y.unshift(""),(R==="."||R==="..")&&y.push(""),y.join("/")}function _(k,w,y){if(k=l(k),k=k.replace(i,""),!(this instanceof _))return new _(k,w,y);var m,R,U,z,L,A,G=c.slice(),we=typeof w,T=this,W=0;for(we!=="object"&&we!=="string"&&(y=w,w=null),y&&typeof y!="function"&&(y=e.parse),w=p(w),R=b(k||"",w),m=!R.protocol&&!R.slashes,T.slashes=R.slashes||m&&w.slashes,T.protocol=R.protocol||w.protocol||"",k=R.rest,(R.protocol==="file:"&&(R.slashesCount!==2||a.test(k))||!R.slashes&&(R.protocol||R.slashesCount<2||!u(T.protocol)))&&(G[3]=[/(.*)/,"pathname"]);W<G.length;W++){if(z=G[W],typeof z=="function"){k=z(k,T);continue}U=z[0],A=z[1],U!==U?T[A]=k:typeof U=="string"?(L=U==="@"?k.lastIndexOf(U):k.indexOf(U),~L&&(typeof z[2]=="number"?(T[A]=k.slice(0,L),k=k.slice(L+z[2])):(T[A]=k.slice(L),k=k.slice(0,L)))):(L=U.exec(k))&&(T[A]=L[1],k=k.slice(0,L.index)),T[A]=T[A]||m&&z[3]&&w[A]||"",z[4]&&(T[A]=T[A].toLowerCase())}y&&(T.query=y(T.query)),m&&w.slashes&&T.pathname.charAt(0)!=="/"&&(T.pathname!==""||w.pathname!=="")&&(T.pathname=x(T.pathname,w.pathname)),T.pathname.charAt(0)!=="/"&&u(T.protocol)&&(T.pathname="/"+T.pathname),r(T.port,T.protocol)||(T.host=T.hostname,T.port=""),T.username=T.password="",T.auth&&(L=T.auth.indexOf(":"),~L?(T.username=T.auth.slice(0,L),T.username=encodeURIComponent(decodeURIComponent(T.username)),T.password=T.auth.slice(L+1),T.password=encodeURIComponent(decodeURIComponent(T.password))):T.username=encodeURIComponent(decodeURIComponent(T.auth)),T.auth=T.password?T.username+":"+T.password:T.username),T.origin=T.protocol!=="file:"&&u(T.protocol)&&T.host?T.protocol+"//"+T.host:"null",T.href=T.toString()}function E(k,w,y){var m=this;switch(k){case"query":typeof w=="string"&&w.length&&(w=(y||e.parse)(w)),m[k]=w;break;case"port":m[k]=w,r(w,m.protocol)?w&&(m.host=m.hostname+":"+w):(m.host=m.hostname,m[k]="");break;case"hostname":m[k]=w,m.port&&(w+=":"+m.port),m.host=w;break;case"host":m[k]=w,s.test(w)?(w=w.split(":"),m.port=w.pop(),m.hostname=w.join(":")):(m.hostname=w,m.port="");break;case"protocol":m.protocol=w.toLowerCase(),m.slashes=!y;break;case"pathname":case"hash":if(w){var R=k==="pathname"?"/":"#";m[k]=w.charAt(0)!==R?R+w:w}else m[k]=w;break;case"username":case"password":m[k]=encodeURIComponent(w);break;case"auth":var U=w.indexOf(":");~U?(m.username=w.slice(0,U),m.username=encodeURIComponent(decodeURIComponent(m.username)),m.password=w.slice(U+1),m.password=encodeURIComponent(decodeURIComponent(m.password))):m.username=encodeURIComponent(decodeURIComponent(w))}for(var z=0;z<c.length;z++){var L=c[z];L[4]&&(m[L[1]]=m[L[1]].toLowerCase())}return m.auth=m.password?m.username+":"+m.password:m.username,m.origin=m.protocol!=="file:"&&u(m.protocol)&&m.host?m.protocol+"//"+m.host:"null",m.href=m.toString(),m}function F(k){(!k||typeof k!="function")&&(k=e.stringify);var w,y=this,m=y.host,R=y.protocol;R&&R.charAt(R.length-1)!==":"&&(R+=":");var U=R+(y.protocol&&y.slashes||u(y.protocol)?"//":"");return y.username?(U+=y.username,y.password&&(U+=":"+y.password),U+="@"):y.password?(U+=":"+y.password,U+="@"):y.protocol!=="file:"&&u(y.protocol)&&!m&&y.pathname!=="/"&&(U+="@"),(m[m.length-1]===":"||s.test(y.hostname)&&!y.port)&&(m+=":"),U+=m+y.pathname,w=typeof y.query=="object"?k(y.query):y.query,w&&(U+=w.charAt(0)!=="?"?"?"+w:w),y.hash&&(U+=y.hash),U}return _.prototype={set:E,toString:F},_.extractProtocol=b,_.location=p,_.trimLeft=l,_.qs=e,mi=_,mi}var Ra=Ua();const Oa=Ca(Ra);function Ta(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(r){var e=Math.random()*16|0,t=r==="x"?e:e&3|8;return t.toString(16)})}function Pi(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */Pi=function(){return e};var r,e={},t=Object.prototype,i=t.hasOwnProperty,o=Object.defineProperty||function(v,h,g){v[h]=g.value},s=typeof Symbol=="function"?Symbol:{},n=s.iterator||"@@iterator",a=s.asyncIterator||"@@asyncIterator",l=s.toStringTag||"@@toStringTag";function c(v,h,g){return Object.defineProperty(v,h,{value:g,enumerable:!0,configurable:!0,writable:!0}),v[h]}try{c({},"")}catch{c=function(g,C,P){return g[C]=P}}function d(v,h,g,C){var P=h&&h.prototype instanceof F?h:F,$=Object.create(P.prototype),j=new W(C||[]);return o($,"_invoke",{value:A(v,g,j)}),$}function p(v,h,g){try{return{type:"normal",arg:v.call(h,g)}}catch(C){return{type:"throw",arg:C}}}e.wrap=d;var u="suspendedStart",b="suspendedYield",x="executing",_="completed",E={};function F(){}function k(){}function w(){}var y={};c(y,n,function(){return this});var m=Object.getPrototypeOf,R=m&&m(m(me([])));R&&R!==t&&i.call(R,n)&&(y=R);var U=w.prototype=F.prototype=Object.create(y);function z(v){["next","throw","return"].forEach(function(h){c(v,h,function(g){return this._invoke(h,g)})})}function L(v,h){function g(P,$,j,H){var q=p(v[P],v,$);if(q.type!=="throw"){var ee=q.arg,ie=ee.value;return ie&&Be(ie)=="object"&&i.call(ie,"__await")?h.resolve(ie.__await).then(function(ae){g("next",ae,j,H)},function(ae){g("throw",ae,j,H)}):h.resolve(ie).then(function(ae){ee.value=ae,j(ee)},function(ae){return g("throw",ae,j,H)})}H(q.arg)}var C;o(this,"_invoke",{value:function($,j){function H(){return new h(function(q,ee){g($,j,q,ee)})}return C=C?C.then(H,H):H()}})}function A(v,h,g){var C=u;return function(P,$){if(C===x)throw Error("Generator is already running");if(C===_){if(P==="throw")throw $;return{value:r,done:!0}}for(g.method=P,g.arg=$;;){var j=g.delegate;if(j){var H=G(j,g);if(H){if(H===E)continue;return H}}if(g.method==="next")g.sent=g._sent=g.arg;else if(g.method==="throw"){if(C===u)throw C=_,g.arg;g.dispatchException(g.arg)}else g.method==="return"&&g.abrupt("return",g.arg);C=x;var q=p(v,h,g);if(q.type==="normal"){if(C=g.done?_:b,q.arg===E)continue;return{value:q.arg,done:g.done}}q.type==="throw"&&(C=_,g.method="throw",g.arg=q.arg)}}}function G(v,h){var g=h.method,C=v.iterator[g];if(C===r)return h.delegate=null,g==="throw"&&v.iterator.return&&(h.method="return",h.arg=r,G(v,h),h.method==="throw")||g!=="return"&&(h.method="throw",h.arg=new TypeError("The iterator does not provide a '"+g+"' method")),E;var P=p(C,v.iterator,h.arg);if(P.type==="throw")return h.method="throw",h.arg=P.arg,h.delegate=null,E;var $=P.arg;return $?$.done?(h[v.resultName]=$.value,h.next=v.nextLoc,h.method!=="return"&&(h.method="next",h.arg=r),h.delegate=null,E):$:(h.method="throw",h.arg=new TypeError("iterator result is not an object"),h.delegate=null,E)}function we(v){var h={tryLoc:v[0]};1 in v&&(h.catchLoc=v[1]),2 in v&&(h.finallyLoc=v[2],h.afterLoc=v[3]),this.tryEntries.push(h)}function T(v){var h=v.completion||{};h.type="normal",delete h.arg,v.completion=h}function W(v){this.tryEntries=[{tryLoc:"root"}],v.forEach(we,this),this.reset(!0)}function me(v){if(v||v===""){var h=v[n];if(h)return h.call(v);if(typeof v.next=="function")return v;if(!isNaN(v.length)){var g=-1,C=function P(){for(;++g<v.length;)if(i.call(v,g))return P.value=v[g],P.done=!1,P;return P.value=r,P.done=!0,P};return C.next=C}}throw new TypeError(Be(v)+" is not iterable")}return k.prototype=w,o(U,"constructor",{value:w,configurable:!0}),o(w,"constructor",{value:k,configurable:!0}),k.displayName=c(w,l,"GeneratorFunction"),e.isGeneratorFunction=function(v){var h=typeof v=="function"&&v.constructor;return!!h&&(h===k||(h.displayName||h.name)==="GeneratorFunction")},e.mark=function(v){return Object.setPrototypeOf?Object.setPrototypeOf(v,w):(v.__proto__=w,c(v,l,"GeneratorFunction")),v.prototype=Object.create(U),v},e.awrap=function(v){return{__await:v}},z(L.prototype),c(L.prototype,a,function(){return this}),e.AsyncIterator=L,e.async=function(v,h,g,C,P){P===void 0&&(P=Promise);var $=new L(d(v,h,g,C),P);return e.isGeneratorFunction(h)?$:$.next().then(function(j){return j.done?j.value:$.next()})},z(U),c(U,l,"Generator"),c(U,n,function(){return this}),c(U,"toString",function(){return"[object Generator]"}),e.keys=function(v){var h=Object(v),g=[];for(var C in h)g.push(C);return g.reverse(),function P(){for(;g.length;){var $=g.pop();if($ in h)return P.value=$,P.done=!1,P}return P.done=!0,P}},e.values=me,W.prototype={constructor:W,reset:function(h){if(this.prev=0,this.next=0,this.sent=this._sent=r,this.done=!1,this.delegate=null,this.method="next",this.arg=r,this.tryEntries.forEach(T),!h)for(var g in this)g.charAt(0)==="t"&&i.call(this,g)&&!isNaN(+g.slice(1))&&(this[g]=r)},stop:function(){this.done=!0;var h=this.tryEntries[0].completion;if(h.type==="throw")throw h.arg;return this.rval},dispatchException:function(h){if(this.done)throw h;var g=this;function C(ee,ie){return j.type="throw",j.arg=h,g.next=ee,ie&&(g.method="next",g.arg=r),!!ie}for(var P=this.tryEntries.length-1;P>=0;--P){var $=this.tryEntries[P],j=$.completion;if($.tryLoc==="root")return C("end");if($.tryLoc<=this.prev){var H=i.call($,"catchLoc"),q=i.call($,"finallyLoc");if(H&&q){if(this.prev<$.catchLoc)return C($.catchLoc,!0);if(this.prev<$.finallyLoc)return C($.finallyLoc)}else if(H){if(this.prev<$.catchLoc)return C($.catchLoc,!0)}else{if(!q)throw Error("try statement without catch or finally");if(this.prev<$.finallyLoc)return C($.finallyLoc)}}}},abrupt:function(h,g){for(var C=this.tryEntries.length-1;C>=0;--C){var P=this.tryEntries[C];if(P.tryLoc<=this.prev&&i.call(P,"finallyLoc")&&this.prev<P.finallyLoc){var $=P;break}}$&&(h==="break"||h==="continue")&&$.tryLoc<=g&&g<=$.finallyLoc&&($=null);var j=$?$.completion:{};return j.type=h,j.arg=g,$?(this.method="next",this.next=$.finallyLoc,E):this.complete(j)},complete:function(h,g){if(h.type==="throw")throw h.arg;return h.type==="break"||h.type==="continue"?this.next=h.arg:h.type==="return"?(this.rval=this.arg=h.arg,this.method="return",this.next="end"):h.type==="normal"&&g&&(this.next=g),E},finish:function(h){for(var g=this.tryEntries.length-1;g>=0;--g){var C=this.tryEntries[g];if(C.finallyLoc===h)return this.complete(C.completion,C.afterLoc),T(C),E}},catch:function(h){for(var g=this.tryEntries.length-1;g>=0;--g){var C=this.tryEntries[g];if(C.tryLoc===h){var P=C.completion;if(P.type==="throw"){var $=P.arg;T(C)}return $}}throw Error("illegal catch attempt")},delegateYield:function(h,g,C){return this.delegate={iterator:me(h),resultName:g,nextLoc:C},this.method==="next"&&(this.arg=r),E}},e}function no(r,e,t,i,o,s,n){try{var a=r[s](n),l=a.value}catch(c){t(c);return}a.done?e(l):Promise.resolve(l).then(i,o)}function Aa(r){return function(){var e=this,t=arguments;return new Promise(function(i,o){var s=r.apply(e,t);function n(l){no(s,i,o,n,a,"next",l)}function a(l){no(s,i,o,n,a,"throw",l)}n(void 0)})}}function fs(r,e){return Ia(r)||Fa(r,e)||hs(r,e)||La()}function La(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Fa(r,e){var t=r==null?null:typeof Symbol<"u"&&r[Symbol.iterator]||r["@@iterator"];if(t!=null){var i,o,s,n,a=[],l=!0,c=!1;try{if(s=(t=t.call(r)).next,e!==0)for(;!(l=(i=s.call(t)).done)&&(a.push(i.value),a.length!==e);l=!0);}catch(d){c=!0,o=d}finally{try{if(!l&&t.return!=null&&(n=t.return(),Object(n)!==n))return}finally{if(c)throw o}}return a}}function Ia(r){if(Array.isArray(r))return r}function Be(r){"@babel/helpers - typeof";return Be=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Be(r)}function za(r,e){var t=typeof Symbol<"u"&&r[Symbol.iterator]||r["@@iterator"];if(!t){if(Array.isArray(r)||(t=hs(r))||e){t&&(r=t);var i=0,o=function(){};return{s:o,n:function(){return i>=r.length?{done:!0}:{done:!1,value:r[i++]}},e:function(c){throw c},f:o}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var s=!0,n=!1,a;return{s:function(){t=t.call(r)},n:function(){var c=t.next();return s=c.done,c},e:function(c){n=!0,a=c},f:function(){try{!s&&t.return!=null&&t.return()}finally{if(n)throw a}}}}function hs(r,e){if(r){if(typeof r=="string")return ao(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return ao(r,e)}}function ao(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function lo(r,e){var t=Object.keys(r);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(r);e&&(i=i.filter(function(o){return Object.getOwnPropertyDescriptor(r,o).enumerable})),t.push.apply(t,i)}return t}function Ve(r){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?lo(Object(t),!0).forEach(function(i){ja(r,i,t[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(t)):lo(Object(t)).forEach(function(i){Object.defineProperty(r,i,Object.getOwnPropertyDescriptor(t,i))})}return r}function ja(r,e,t){return e=gs(e),e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}function Da(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function co(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,gs(i.key),i)}}function Ma(r,e,t){return e&&co(r.prototype,e),t&&co(r,t),Object.defineProperty(r,"prototype",{writable:!1}),r}function gs(r){var e=Ba(r,"string");return Be(e)=="symbol"?e:e+""}function Ba(r,e){if(Be(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Be(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var Ht="tus-v1",qt="ietf-draft-03",ut="ietf-draft-05",Na={endpoint:null,uploadUrl:null,metadata:{},metadataForPartialUploads:{},fingerprint:null,uploadSize:null,onProgress:null,onChunkComplete:null,onSuccess:null,onError:null,onUploadUrlAvailable:null,overridePatchMethod:!1,headers:{},addRequestId:!1,onBeforeRequest:null,onAfterResponse:null,onShouldRetry:ms,chunkSize:Number.POSITIVE_INFINITY,retryDelays:[0,1e3,3e3,5e3],parallelUploads:1,parallelUploadBoundaries:null,storeFingerprintForResuming:!0,removeFingerprintOnSuccess:!1,uploadLengthDeferred:!1,uploadDataDuringCreation:!1,urlStorage:null,fileReader:null,httpStack:null,protocol:Ht},Zt=(function(){function r(e,t){Da(this,r),"resume"in t&&console.log("tus: The `resume` option has been removed in tus-js-client v2. Please use the URL storage API instead."),this.options=t,this.options.chunkSize=Number(this.options.chunkSize),this._urlStorage=this.options.urlStorage,this.file=e,this.url=null,this._req=null,this._fingerprint=null,this._urlStorageKey=null,this._offset=null,this._aborted=!1,this._size=null,this._source=null,this._retryAttempt=0,this._retryTimeout=null,this._offsetBeforeRetry=0,this._parallelUploads=null,this._parallelUploadUrls=null}return Ma(r,[{key:"findPreviousUploads",value:function(){var t=this;return this.options.fingerprint(this.file,this.options).then(function(i){return t._urlStorage.findUploadsByFingerprint(i)})}},{key:"resumeFromPreviousUpload",value:function(t){this.url=t.uploadUrl||null,this._parallelUploadUrls=t.parallelUploadUrls||null,this._urlStorageKey=t.urlStorageKey}},{key:"start",value:function(){var t=this,i=this.file;if(!i){this._emitError(new Error("tus: no file or stream to upload provided"));return}if(![Ht,qt,ut].includes(this.options.protocol)){this._emitError(new Error("tus: unsupported protocol ".concat(this.options.protocol)));return}if(!this.options.endpoint&&!this.options.uploadUrl&&!this.url){this._emitError(new Error("tus: neither an endpoint or an upload URL is provided"));return}var o=this.options.retryDelays;if(o!=null&&Object.prototype.toString.call(o)!=="[object Array]"){this._emitError(new Error("tus: the `retryDelays` option must either be an array or null"));return}if(this.options.parallelUploads>1)for(var s=0,n=["uploadUrl","uploadSize","uploadLengthDeferred"];s<n.length;s++){var a=n[s];if(this.options[a]){this._emitError(new Error("tus: cannot use the ".concat(a," option when parallelUploads is enabled")));return}}if(this.options.parallelUploadBoundaries){if(this.options.parallelUploads<=1){this._emitError(new Error("tus: cannot use the `parallelUploadBoundaries` option when `parallelUploads` is disabled"));return}if(this.options.parallelUploads!==this.options.parallelUploadBoundaries.length){this._emitError(new Error("tus: the `parallelUploadBoundaries` must have the same length as the value of `parallelUploads`"));return}}this.options.fingerprint(i,this.options).then(function(l){return t._fingerprint=l,t._source?t._source:t.options.fileReader.openFile(i,t.options.chunkSize)}).then(function(l){if(t._source=l,t.options.uploadLengthDeferred)t._size=null;else if(t.options.uploadSize!=null){if(t._size=Number(t.options.uploadSize),Number.isNaN(t._size)){t._emitError(new Error("tus: cannot convert `uploadSize` option into a number"));return}}else if(t._size=t._source.size,t._size==null){t._emitError(new Error("tus: cannot automatically derive upload's size from input. Specify it manually using the `uploadSize` option or use the `uploadLengthDeferred` option"));return}t.options.parallelUploads>1||t._parallelUploadUrls!=null?t._startParallelUpload():t._startSingleUpload()}).catch(function(l){t._emitError(l)})}},{key:"_startParallelUpload",value:function(){var t,i=this,o=this._size,s=0;this._parallelUploads=[];var n=this._parallelUploadUrls!=null?this._parallelUploadUrls.length:this.options.parallelUploads,a=(t=this.options.parallelUploadBoundaries)!==null&&t!==void 0?t:qa(this._source.size,n);this._parallelUploadUrls&&a.forEach(function(d,p){d.uploadUrl=i._parallelUploadUrls[p]||null}),this._parallelUploadUrls=new Array(a.length);var l=a.map(function(d,p){var u=0;return i._source.slice(d.start,d.end).then(function(b){var x=b.value;return new Promise(function(_,E){var F=Ve(Ve({},i.options),{},{uploadUrl:d.uploadUrl||null,storeFingerprintForResuming:!1,removeFingerprintOnSuccess:!1,parallelUploads:1,parallelUploadBoundaries:null,metadata:i.options.metadataForPartialUploads,headers:Ve(Ve({},i.options.headers),{},{"Upload-Concat":"partial"}),onSuccess:_,onError:E,onProgress:function(y){s=s-u+y,u=y,i._emitProgress(s,o)},onUploadUrlAvailable:function(){i._parallelUploadUrls[p]=k.url,i._parallelUploadUrls.filter(function(y){return!!y}).length===a.length&&i._saveUploadInUrlStorage()}}),k=new r(x,F);k.start(),i._parallelUploads.push(k)})})}),c;Promise.all(l).then(function(){c=i._openRequest("POST",i.options.endpoint),c.setHeader("Upload-Concat","final;".concat(i._parallelUploadUrls.join(" ")));var d=po(i.options.metadata);return d!==""&&c.setHeader("Upload-Metadata",d),i._sendRequest(c,null)}).then(function(d){if(!Xe(d.getStatus(),200)){i._emitHttpError(c,d,"tus: unexpected response while creating upload");return}var p=d.getHeader("Location");if(p==null){i._emitHttpError(c,d,"tus: invalid or missing Location header");return}i.url=go(i.options.endpoint,p),"Created upload at ".concat(i.url),i._emitSuccess(d)}).catch(function(d){i._emitError(d)})}},{key:"_startSingleUpload",value:function(){if(this._aborted=!1,this.url!=null){"Resuming upload from previous URL: ".concat(this.url),this._resumeUpload();return}if(this.options.uploadUrl!=null){"Resuming upload from provided URL: ".concat(this.options.uploadUrl),this.url=this.options.uploadUrl,this._resumeUpload();return}this._createUpload()}},{key:"abort",value:function(t){var i=this;if(this._parallelUploads!=null){var o=za(this._parallelUploads),s;try{for(o.s();!(s=o.n()).done;){var n=s.value;n.abort(t)}}catch(a){o.e(a)}finally{o.f()}}return this._req!==null&&this._req.abort(),this._aborted=!0,this._retryTimeout!=null&&(clearTimeout(this._retryTimeout),this._retryTimeout=null),!t||this.url==null?Promise.resolve():r.terminate(this.url,this.options).then(function(){return i._removeFromUrlStorage()})}},{key:"_emitHttpError",value:function(t,i,o,s){this._emitError(new dt(o,s,t,i))}},{key:"_emitError",value:function(t){var i=this;if(!this._aborted){if(this.options.retryDelays!=null){var o=this._offset!=null&&this._offset>this._offsetBeforeRetry;if(o&&(this._retryAttempt=0),ho(t,this._retryAttempt,this.options)){var s=this.options.retryDelays[this._retryAttempt++];this._offsetBeforeRetry=this._offset,this._retryTimeout=setTimeout(function(){i.start()},s);return}}if(typeof this.options.onError=="function")this.options.onError(t);else throw t}}},{key:"_emitSuccess",value:function(t){this.options.removeFingerprintOnSuccess&&this._removeFromUrlStorage(),typeof this.options.onSuccess=="function"&&this.options.onSuccess({lastResponse:t})}},{key:"_emitProgress",value:function(t,i){typeof this.options.onProgress=="function"&&this.options.onProgress(t,i)}},{key:"_emitChunkComplete",value:function(t,i,o){typeof this.options.onChunkComplete=="function"&&this.options.onChunkComplete(t,i,o)}},{key:"_createUpload",value:function(){var t=this;if(!this.options.endpoint){this._emitError(new Error("tus: unable to create upload because no endpoint is provided"));return}var i=this._openRequest("POST",this.options.endpoint);this.options.uploadLengthDeferred?i.setHeader("Upload-Defer-Length","1"):i.setHeader("Upload-Length","".concat(this._size));var o=po(this.options.metadata);o!==""&&i.setHeader("Upload-Metadata",o);var s;this.options.uploadDataDuringCreation&&!this.options.uploadLengthDeferred?(this._offset=0,s=this._addChunkToRequest(i)):((this.options.protocol===qt||this.options.protocol===ut)&&i.setHeader("Upload-Complete","?0"),s=this._sendRequest(i,null)),s.then(function(n){if(!Xe(n.getStatus(),200)){t._emitHttpError(i,n,"tus: unexpected response while creating upload");return}var a=n.getHeader("Location");if(a==null){t._emitHttpError(i,n,"tus: invalid or missing Location header");return}if(t.url=go(t.options.endpoint,a),"Created upload at ".concat(t.url),typeof t.options.onUploadUrlAvailable=="function"&&t.options.onUploadUrlAvailable(),t._size===0){t._emitSuccess(n),t._source.close();return}t._saveUploadInUrlStorage().then(function(){t.options.uploadDataDuringCreation?t._handleUploadResponse(i,n):(t._offset=0,t._performUpload())})}).catch(function(n){t._emitHttpError(i,null,"tus: failed to create upload",n)})}},{key:"_resumeUpload",value:function(){var t=this,i=this._openRequest("HEAD",this.url),o=this._sendRequest(i,null);o.then(function(s){var n=s.getStatus();if(!Xe(n,200)){if(n===423){t._emitHttpError(i,s,"tus: upload is currently locked; retry later");return}if(Xe(n,400)&&t._removeFromUrlStorage(),!t.options.endpoint){t._emitHttpError(i,s,"tus: unable to resume upload (new upload cannot be created without an endpoint)");return}t.url=null,t._createUpload();return}var a=Number.parseInt(s.getHeader("Upload-Offset"),10);if(Number.isNaN(a)){t._emitHttpError(i,s,"tus: invalid or missing offset value");return}var l=Number.parseInt(s.getHeader("Upload-Length"),10);if(Number.isNaN(l)&&!t.options.uploadLengthDeferred&&t.options.protocol===Ht){t._emitHttpError(i,s,"tus: invalid or missing length value");return}typeof t.options.onUploadUrlAvailable=="function"&&t.options.onUploadUrlAvailable(),t._saveUploadInUrlStorage().then(function(){if(a===l){t._emitProgress(l,l),t._emitSuccess(s);return}t._offset=a,t._performUpload()})}).catch(function(s){t._emitHttpError(i,null,"tus: failed to resume upload",s)})}},{key:"_performUpload",value:function(){var t=this;if(!this._aborted){var i;this.options.overridePatchMethod?(i=this._openRequest("POST",this.url),i.setHeader("X-HTTP-Method-Override","PATCH")):i=this._openRequest("PATCH",this.url),i.setHeader("Upload-Offset","".concat(this._offset));var o=this._addChunkToRequest(i);o.then(function(s){if(!Xe(s.getStatus(),200)){t._emitHttpError(i,s,"tus: unexpected response while uploading chunk");return}t._handleUploadResponse(i,s)}).catch(function(s){t._aborted||t._emitHttpError(i,null,"tus: failed to upload chunk at offset ".concat(t._offset),s)})}}},{key:"_addChunkToRequest",value:function(t){var i=this,o=this._offset,s=this._offset+this.options.chunkSize;return t.setProgressHandler(function(n){i._emitProgress(o+n,i._size)}),this.options.protocol===Ht?t.setHeader("Content-Type","application/offset+octet-stream"):this.options.protocol===ut&&t.setHeader("Content-Type","application/partial-upload"),(s===Number.POSITIVE_INFINITY||s>this._size)&&!this.options.uploadLengthDeferred&&(s=this._size),this._source.slice(o,s).then(function(n){var a=n.value,l=n.done,c=a!=null&&a.size?a.size:0;i.options.uploadLengthDeferred&&l&&(i._size=i._offset+c,t.setHeader("Upload-Length","".concat(i._size)));var d=i._offset+c;return!i.options.uploadLengthDeferred&&l&&d!==i._size?Promise.reject(new Error("upload was configured with a size of ".concat(i._size," bytes, but the source is done after ").concat(d," bytes"))):a===null?i._sendRequest(t):((i.options.protocol===qt||i.options.protocol===ut)&&t.setHeader("Upload-Complete",l?"?1":"?0"),i._emitProgress(i._offset,i._size),i._sendRequest(t,a))})}},{key:"_handleUploadResponse",value:function(t,i){var o=Number.parseInt(i.getHeader("Upload-Offset"),10);if(Number.isNaN(o)){this._emitHttpError(t,i,"tus: invalid or missing offset value");return}if(this._emitProgress(o,this._size),this._emitChunkComplete(o-this._offset,o,this._size),this._offset=o,o===this._size){this._emitSuccess(i),this._source.close();return}this._performUpload()}},{key:"_openRequest",value:function(t,i){var o=uo(t,i,this.options);return this._req=o,o}},{key:"_removeFromUrlStorage",value:function(){var t=this;this._urlStorageKey&&(this._urlStorage.removeUpload(this._urlStorageKey).catch(function(i){t._emitError(i)}),this._urlStorageKey=null)}},{key:"_saveUploadInUrlStorage",value:function(){var t=this;if(!this.options.storeFingerprintForResuming||!this._fingerprint||this._urlStorageKey!==null)return Promise.resolve();var i={size:this._size,metadata:this.options.metadata,creationTime:new Date().toString()};return this._parallelUploads?i.parallelUploadUrls=this._parallelUploadUrls:i.uploadUrl=this.url,this._urlStorage.addUpload(this._fingerprint,i).then(function(o){t._urlStorageKey=o})}},{key:"_sendRequest",value:function(t){var i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null;return fo(t,i,this.options)}}],[{key:"terminate",value:function(t){var i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},o=uo("DELETE",t,i);return fo(o,null,i).then(function(s){if(s.getStatus()!==204)throw new dt("tus: unexpected response while terminating upload",null,o,s)}).catch(function(s){if(s instanceof dt||(s=new dt("tus: failed to terminate upload",s,o,null)),!ho(s,0,i))throw s;var n=i.retryDelays[0],a=i.retryDelays.slice(1),l=Ve(Ve({},i),{},{retryDelays:a});return new Promise(function(c){return setTimeout(c,n)}).then(function(){return r.terminate(t,l)})})}}])})();function po(r){return Object.entries(r).map(function(e){var t=fs(e,2),i=t[0],o=t[1];return"".concat(i," ").concat($a.encode(String(o)))}).join(",")}function Xe(r,e){return r>=e&&r<e+100}function uo(r,e,t){var i=t.httpStack.createRequest(r,e);t.protocol===qt?i.setHeader("Upload-Draft-Interop-Version","5"):t.protocol===ut?i.setHeader("Upload-Draft-Interop-Version","6"):i.setHeader("Tus-Resumable","1.0.0");for(var o=t.headers||{},s=0,n=Object.entries(o);s<n.length;s++){var a=fs(n[s],2),l=a[0],c=a[1];i.setHeader(l,c)}if(t.addRequestId){var d=Ta();i.setHeader("X-Request-ID",d)}return i}function fo(r,e,t){return Ui.apply(this,arguments)}function Ui(){return Ui=Aa(Pi().mark(function r(e,t,i){var o;return Pi().wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(typeof i.onBeforeRequest!="function"){n.next=3;break}return n.next=3,i.onBeforeRequest(e);case 3:return n.next=5,e.send(t);case 5:if(o=n.sent,typeof i.onAfterResponse!="function"){n.next=9;break}return n.next=9,i.onAfterResponse(e,o);case 9:return n.abrupt("return",o);case 10:case"end":return n.stop()}},r)})),Ui.apply(this,arguments)}function Ha(){var r=!0;return typeof navigator<"u"&&navigator.onLine===!1&&(r=!1),r}function ho(r,e,t){return t.retryDelays==null||e>=t.retryDelays.length||r.originalRequest==null?!1:t&&typeof t.onShouldRetry=="function"?t.onShouldRetry(r,e,t):ms(r)}function ms(r){var e=r.originalResponse?r.originalResponse.getStatus():0;return(!Xe(e,400)||e===409||e===423)&&Ha()}function go(r,e){return new Oa(e,r).toString()}function qa(r,e){for(var t=Math.floor(r/e),i=[],o=0;o<e;o++)i.push({start:t*o,end:t*(o+1)});return i[e-1].end=r,i}Zt.defaultOptions=Na;var xs=function(){return typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative"};function Va(r){return new Promise(function(e,t){var i=new XMLHttpRequest;i.responseType="blob",i.onload=function(){var o=i.response;e(o)},i.onerror=function(o){t(o)},i.open("GET",r),i.send()})}var Ka=function(){return typeof window<"u"&&(typeof window.PhoneGap<"u"||typeof window.Cordova<"u"||typeof window.cordova<"u")};function Ya(r){return new Promise(function(e,t){var i=new FileReader;i.onload=function(){var o=new Uint8Array(i.result);e({value:o})},i.onerror=function(o){t(o)},i.readAsArrayBuffer(r)})}function $t(r){"@babel/helpers - typeof";return $t=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},$t(r)}function Wa(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function Ga(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,Ja(i.key),i)}}function Xa(r,e,t){return e&&Ga(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function Ja(r){var e=Za(r,"string");return $t(e)=="symbol"?e:e+""}function Za(r,e){if($t(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if($t(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var mo=(function(){function r(e){Wa(this,r),this._file=e,this.size=e.size}return Xa(r,[{key:"slice",value:function(t,i){if(Ka())return Ya(this._file.slice(t,i));var o=this._file.slice(t,i),s=i>=this.size;return Promise.resolve({value:o,done:s})}},{key:"close",value:function(){}}])})();function Ct(r){"@babel/helpers - typeof";return Ct=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ct(r)}function Qa(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function el(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,il(i.key),i)}}function tl(r,e,t){return e&&el(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function il(r){var e=rl(r,"string");return Ct(e)=="symbol"?e:e+""}function rl(r,e){if(Ct(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Ct(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}function xo(r){return r===void 0?0:r.size!==void 0?r.size:r.length}function ol(r,e){if(r.concat)return r.concat(e);if(r instanceof Blob)return new Blob([r,e],{type:r.type});if(r.set){var t=new r.constructor(r.length+e.length);return t.set(r),t.set(e,r.length),t}throw new Error("Unknown data type")}var sl=(function(){function r(e){Qa(this,r),this._buffer=void 0,this._bufferOffset=0,this._reader=e,this._done=!1}return tl(r,[{key:"slice",value:function(t,i){return t<this._bufferOffset?Promise.reject(new Error("Requested data is before the reader's current offset")):this._readUntilEnoughDataOrDone(t,i)}},{key:"_readUntilEnoughDataOrDone",value:function(t,i){var o=this,s=i<=this._bufferOffset+xo(this._buffer);if(this._done||s){var n=this._getDataFromBuffer(t,i),a=n==null?this._done:!1;return Promise.resolve({value:n,done:a})}return this._reader.read().then(function(l){var c=l.value,d=l.done;return d?o._done=!0:o._buffer===void 0?o._buffer=c:o._buffer=ol(o._buffer,c),o._readUntilEnoughDataOrDone(t,i)})}},{key:"_getDataFromBuffer",value:function(t,i){t>this._bufferOffset&&(this._buffer=this._buffer.slice(t-this._bufferOffset),this._bufferOffset=t);var o=xo(this._buffer)===0;return this._done&&o?null:this._buffer.slice(0,i-t)}},{key:"close",value:function(){this._reader.cancel&&this._reader.cancel()}}])})();function Ne(r){"@babel/helpers - typeof";return Ne=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ne(r)}function Ri(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */Ri=function(){return e};var r,e={},t=Object.prototype,i=t.hasOwnProperty,o=Object.defineProperty||function(v,h,g){v[h]=g.value},s=typeof Symbol=="function"?Symbol:{},n=s.iterator||"@@iterator",a=s.asyncIterator||"@@asyncIterator",l=s.toStringTag||"@@toStringTag";function c(v,h,g){return Object.defineProperty(v,h,{value:g,enumerable:!0,configurable:!0,writable:!0}),v[h]}try{c({},"")}catch{c=function(g,C,P){return g[C]=P}}function d(v,h,g,C){var P=h&&h.prototype instanceof F?h:F,$=Object.create(P.prototype),j=new W(C||[]);return o($,"_invoke",{value:A(v,g,j)}),$}function p(v,h,g){try{return{type:"normal",arg:v.call(h,g)}}catch(C){return{type:"throw",arg:C}}}e.wrap=d;var u="suspendedStart",b="suspendedYield",x="executing",_="completed",E={};function F(){}function k(){}function w(){}var y={};c(y,n,function(){return this});var m=Object.getPrototypeOf,R=m&&m(m(me([])));R&&R!==t&&i.call(R,n)&&(y=R);var U=w.prototype=F.prototype=Object.create(y);function z(v){["next","throw","return"].forEach(function(h){c(v,h,function(g){return this._invoke(h,g)})})}function L(v,h){function g(P,$,j,H){var q=p(v[P],v,$);if(q.type!=="throw"){var ee=q.arg,ie=ee.value;return ie&&Ne(ie)=="object"&&i.call(ie,"__await")?h.resolve(ie.__await).then(function(ae){g("next",ae,j,H)},function(ae){g("throw",ae,j,H)}):h.resolve(ie).then(function(ae){ee.value=ae,j(ee)},function(ae){return g("throw",ae,j,H)})}H(q.arg)}var C;o(this,"_invoke",{value:function($,j){function H(){return new h(function(q,ee){g($,j,q,ee)})}return C=C?C.then(H,H):H()}})}function A(v,h,g){var C=u;return function(P,$){if(C===x)throw Error("Generator is already running");if(C===_){if(P==="throw")throw $;return{value:r,done:!0}}for(g.method=P,g.arg=$;;){var j=g.delegate;if(j){var H=G(j,g);if(H){if(H===E)continue;return H}}if(g.method==="next")g.sent=g._sent=g.arg;else if(g.method==="throw"){if(C===u)throw C=_,g.arg;g.dispatchException(g.arg)}else g.method==="return"&&g.abrupt("return",g.arg);C=x;var q=p(v,h,g);if(q.type==="normal"){if(C=g.done?_:b,q.arg===E)continue;return{value:q.arg,done:g.done}}q.type==="throw"&&(C=_,g.method="throw",g.arg=q.arg)}}}function G(v,h){var g=h.method,C=v.iterator[g];if(C===r)return h.delegate=null,g==="throw"&&v.iterator.return&&(h.method="return",h.arg=r,G(v,h),h.method==="throw")||g!=="return"&&(h.method="throw",h.arg=new TypeError("The iterator does not provide a '"+g+"' method")),E;var P=p(C,v.iterator,h.arg);if(P.type==="throw")return h.method="throw",h.arg=P.arg,h.delegate=null,E;var $=P.arg;return $?$.done?(h[v.resultName]=$.value,h.next=v.nextLoc,h.method!=="return"&&(h.method="next",h.arg=r),h.delegate=null,E):$:(h.method="throw",h.arg=new TypeError("iterator result is not an object"),h.delegate=null,E)}function we(v){var h={tryLoc:v[0]};1 in v&&(h.catchLoc=v[1]),2 in v&&(h.finallyLoc=v[2],h.afterLoc=v[3]),this.tryEntries.push(h)}function T(v){var h=v.completion||{};h.type="normal",delete h.arg,v.completion=h}function W(v){this.tryEntries=[{tryLoc:"root"}],v.forEach(we,this),this.reset(!0)}function me(v){if(v||v===""){var h=v[n];if(h)return h.call(v);if(typeof v.next=="function")return v;if(!isNaN(v.length)){var g=-1,C=function P(){for(;++g<v.length;)if(i.call(v,g))return P.value=v[g],P.done=!1,P;return P.value=r,P.done=!0,P};return C.next=C}}throw new TypeError(Ne(v)+" is not iterable")}return k.prototype=w,o(U,"constructor",{value:w,configurable:!0}),o(w,"constructor",{value:k,configurable:!0}),k.displayName=c(w,l,"GeneratorFunction"),e.isGeneratorFunction=function(v){var h=typeof v=="function"&&v.constructor;return!!h&&(h===k||(h.displayName||h.name)==="GeneratorFunction")},e.mark=function(v){return Object.setPrototypeOf?Object.setPrototypeOf(v,w):(v.__proto__=w,c(v,l,"GeneratorFunction")),v.prototype=Object.create(U),v},e.awrap=function(v){return{__await:v}},z(L.prototype),c(L.prototype,a,function(){return this}),e.AsyncIterator=L,e.async=function(v,h,g,C,P){P===void 0&&(P=Promise);var $=new L(d(v,h,g,C),P);return e.isGeneratorFunction(h)?$:$.next().then(function(j){return j.done?j.value:$.next()})},z(U),c(U,l,"Generator"),c(U,n,function(){return this}),c(U,"toString",function(){return"[object Generator]"}),e.keys=function(v){var h=Object(v),g=[];for(var C in h)g.push(C);return g.reverse(),function P(){for(;g.length;){var $=g.pop();if($ in h)return P.value=$,P.done=!1,P}return P.done=!0,P}},e.values=me,W.prototype={constructor:W,reset:function(h){if(this.prev=0,this.next=0,this.sent=this._sent=r,this.done=!1,this.delegate=null,this.method="next",this.arg=r,this.tryEntries.forEach(T),!h)for(var g in this)g.charAt(0)==="t"&&i.call(this,g)&&!isNaN(+g.slice(1))&&(this[g]=r)},stop:function(){this.done=!0;var h=this.tryEntries[0].completion;if(h.type==="throw")throw h.arg;return this.rval},dispatchException:function(h){if(this.done)throw h;var g=this;function C(ee,ie){return j.type="throw",j.arg=h,g.next=ee,ie&&(g.method="next",g.arg=r),!!ie}for(var P=this.tryEntries.length-1;P>=0;--P){var $=this.tryEntries[P],j=$.completion;if($.tryLoc==="root")return C("end");if($.tryLoc<=this.prev){var H=i.call($,"catchLoc"),q=i.call($,"finallyLoc");if(H&&q){if(this.prev<$.catchLoc)return C($.catchLoc,!0);if(this.prev<$.finallyLoc)return C($.finallyLoc)}else if(H){if(this.prev<$.catchLoc)return C($.catchLoc,!0)}else{if(!q)throw Error("try statement without catch or finally");if(this.prev<$.finallyLoc)return C($.finallyLoc)}}}},abrupt:function(h,g){for(var C=this.tryEntries.length-1;C>=0;--C){var P=this.tryEntries[C];if(P.tryLoc<=this.prev&&i.call(P,"finallyLoc")&&this.prev<P.finallyLoc){var $=P;break}}$&&(h==="break"||h==="continue")&&$.tryLoc<=g&&g<=$.finallyLoc&&($=null);var j=$?$.completion:{};return j.type=h,j.arg=g,$?(this.method="next",this.next=$.finallyLoc,E):this.complete(j)},complete:function(h,g){if(h.type==="throw")throw h.arg;return h.type==="break"||h.type==="continue"?this.next=h.arg:h.type==="return"?(this.rval=this.arg=h.arg,this.method="return",this.next="end"):h.type==="normal"&&g&&(this.next=g),E},finish:function(h){for(var g=this.tryEntries.length-1;g>=0;--g){var C=this.tryEntries[g];if(C.finallyLoc===h)return this.complete(C.completion,C.afterLoc),T(C),E}},catch:function(h){for(var g=this.tryEntries.length-1;g>=0;--g){var C=this.tryEntries[g];if(C.tryLoc===h){var P=C.completion;if(P.type==="throw"){var $=P.arg;T(C)}return $}}throw Error("illegal catch attempt")},delegateYield:function(h,g,C){return this.delegate={iterator:me(h),resultName:g,nextLoc:C},this.method==="next"&&(this.arg=r),E}},e}function vo(r,e,t,i,o,s,n){try{var a=r[s](n),l=a.value}catch(c){t(c);return}a.done?e(l):Promise.resolve(l).then(i,o)}function nl(r){return function(){var e=this,t=arguments;return new Promise(function(i,o){var s=r.apply(e,t);function n(l){vo(s,i,o,n,a,"next",l)}function a(l){vo(s,i,o,n,a,"throw",l)}n(void 0)})}}function al(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function ll(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,dl(i.key),i)}}function cl(r,e,t){return e&&ll(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function dl(r){var e=pl(r,"string");return Ne(e)=="symbol"?e:e+""}function pl(r,e){if(Ne(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Ne(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var ul=(function(){function r(){al(this,r)}return cl(r,[{key:"openFile",value:(function(){var e=nl(Ri().mark(function i(o,s){var n;return Ri().wrap(function(l){for(;;)switch(l.prev=l.next){case 0:if(!(xs()&&o&&typeof o.uri<"u")){l.next=11;break}return l.prev=1,l.next=4,Va(o.uri);case 4:return n=l.sent,l.abrupt("return",new mo(n));case 8:throw l.prev=8,l.t0=l.catch(1),new Error("tus: cannot fetch `file.uri` as Blob, make sure the uri is correct and accessible. ".concat(l.t0));case 11:if(!(typeof o.slice=="function"&&typeof o.size<"u")){l.next=13;break}return l.abrupt("return",Promise.resolve(new mo(o)));case 13:if(typeof o.read!="function"){l.next=18;break}if(s=Number(s),Number.isFinite(s)){l.next=17;break}return l.abrupt("return",Promise.reject(new Error("cannot create source for stream without a finite value for the `chunkSize` option")));case 17:return l.abrupt("return",Promise.resolve(new sl(o,s)));case 18:return l.abrupt("return",Promise.reject(new Error("source object may only be an instance of File, Blob, or Reader in this environment")));case 19:case"end":return l.stop()}},i,null,[[1,8]])}));function t(i,o){return e.apply(this,arguments)}return t})()}])})();function fl(r,e){return xs()?Promise.resolve(hl(r,e)):Promise.resolve(["tus-br",r.name,r.type,r.size,r.lastModified,e.endpoint].join("-"))}function hl(r,e){var t=r.exif?gl(JSON.stringify(r.exif)):"noexif";return["tus-rn",r.name||"noname",r.size||"nosize",t,e.endpoint].join("/")}function gl(r){var e=0;if(r.length===0)return e;for(var t=0;t<r.length;t++){var i=r.charCodeAt(t);e=(e<<5)-e+i,e&=e}return e}function Et(r){"@babel/helpers - typeof";return Et=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Et(r)}function ir(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function ml(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,xl(i.key),i)}}function rr(r,e,t){return e&&ml(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function xl(r){var e=vl(r,"string");return Et(e)=="symbol"?e:e+""}function vl(r,e){if(Et(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Et(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var bl=(function(){function r(){ir(this,r)}return rr(r,[{key:"createRequest",value:function(t,i){return new yl(t,i)}},{key:"getName",value:function(){return"XHRHttpStack"}}])})(),yl=(function(){function r(e,t){ir(this,r),this._xhr=new XMLHttpRequest,this._xhr.open(e,t,!0),this._method=e,this._url=t,this._headers={}}return rr(r,[{key:"getMethod",value:function(){return this._method}},{key:"getURL",value:function(){return this._url}},{key:"setHeader",value:function(t,i){this._xhr.setRequestHeader(t,i),this._headers[t]=i}},{key:"getHeader",value:function(t){return this._headers[t]}},{key:"setProgressHandler",value:function(t){"upload"in this._xhr&&(this._xhr.upload.onprogress=function(i){i.lengthComputable&&t(i.loaded)})}},{key:"send",value:function(){var t=this,i=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null;return new Promise(function(o,s){t._xhr.onload=function(){o(new wl(t._xhr))},t._xhr.onerror=function(n){s(n)},t._xhr.send(i)})}},{key:"abort",value:function(){return this._xhr.abort(),Promise.resolve()}},{key:"getUnderlyingObject",value:function(){return this._xhr}}])})(),wl=(function(){function r(e){ir(this,r),this._xhr=e}return rr(r,[{key:"getStatus",value:function(){return this._xhr.status}},{key:"getHeader",value:function(t){return this._xhr.getResponseHeader(t)}},{key:"getBody",value:function(){return this._xhr.responseText}},{key:"getUnderlyingObject",value:function(){return this._xhr}}])})();function Pt(r){"@babel/helpers - typeof";return Pt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Pt(r)}function _l(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function kl(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,$l(i.key),i)}}function Sl(r,e,t){return e&&kl(r.prototype,e),Object.defineProperty(r,"prototype",{writable:!1}),r}function $l(r){var e=Cl(r,"string");return Pt(e)=="symbol"?e:e+""}function Cl(r,e){if(Pt(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(Pt(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(r)}var Oi=!1;try{Oi="localStorage"in window;var xi="tusSupport",bo=localStorage.getItem(xi);localStorage.setItem(xi,bo),bo===null&&localStorage.removeItem(xi)}catch(r){if(r.code===r.SECURITY_ERR||r.code===r.QUOTA_EXCEEDED_ERR)Oi=!1;else throw r}var El=Oi,Pl=(function(){function r(){_l(this,r)}return Sl(r,[{key:"findAllUploads",value:function(){var t=this._findEntries("tus::");return Promise.resolve(t)}},{key:"findUploadsByFingerprint",value:function(t){var i=this._findEntries("tus::".concat(t,"::"));return Promise.resolve(i)}},{key:"removeUpload",value:function(t){return localStorage.removeItem(t),Promise.resolve()}},{key:"addUpload",value:function(t,i){var o=Math.round(Math.random()*1e12),s="tus::".concat(t,"::").concat(o);return localStorage.setItem(s,JSON.stringify(i)),Promise.resolve(s)}},{key:"_findEntries",value:function(t){for(var i=[],o=0;o<localStorage.length;o++){var s=localStorage.key(o);if(s.indexOf(t)===0)try{var n=JSON.parse(localStorage.getItem(s));n.urlStorageKey=s,i.push(n)}catch{}}return i}}])})();function tt(r){"@babel/helpers - typeof";return tt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},tt(r)}function Ul(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function Rl(r,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(r,bs(i.key),i)}}function Ol(r,e,t){return t&&Rl(r,t),Object.defineProperty(r,"prototype",{writable:!1}),r}function Tl(r,e,t){return e=Qt(e),Al(r,vs()?Reflect.construct(e,t||[],Qt(r).constructor):e.apply(r,t))}function Al(r,e){if(e&&(tt(e)==="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return Ll(r)}function Ll(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function vs(){try{var r=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(vs=function(){return!!r})()}function Qt(r){return Qt=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},Qt(r)}function Fl(r,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");r.prototype=Object.create(e&&e.prototype,{constructor:{value:r,writable:!0,configurable:!0}}),Object.defineProperty(r,"prototype",{writable:!1}),e&&Ti(r,e)}function Ti(r,e){return Ti=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(i,o){return i.__proto__=o,i},Ti(r,e)}function yo(r,e){var t=Object.keys(r);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(r);e&&(i=i.filter(function(o){return Object.getOwnPropertyDescriptor(r,o).enumerable})),t.push.apply(t,i)}return t}function Je(r){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?yo(Object(t),!0).forEach(function(i){Il(r,i,t[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(t)):yo(Object(t)).forEach(function(i){Object.defineProperty(r,i,Object.getOwnPropertyDescriptor(t,i))})}return r}function Il(r,e,t){return e=bs(e),e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}function bs(r){var e=zl(r,"string");return tt(e)=="symbol"?e:e+""}function zl(r,e){if(tt(r)!="object"||!r)return r;var t=r[Symbol.toPrimitive];if(t!==void 0){var i=t.call(r,e);if(tt(i)!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(r)}var wo=Je(Je({},Zt.defaultOptions),{},{httpStack:new bl,fileReader:new ul,urlStorage:El?new Pl:new ha,fingerprint:fl}),jl=(function(r){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null,i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return Ul(this,e),i=Je(Je({},wo),i),Tl(this,e,[t,i])}return Fl(e,r),Ol(e,null,[{key:"terminate",value:function(i){var o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return o=Je(Je({},wo),o),Zt.terminate(i,o)}}])})(Zt);const Dl=10*1024*1024,Ml=5*1024*1024,Bl="https://eu-on-24001.connector.filerobot.com/files",Nl="https://eu-on-24001.connector.filerobot.com/json";function Hl(r,e){if(!e||!r.file)return!1;const t=e.sizeThreshold??Dl;return r.size>=t}function ql(r,e){const{tusConfig:t}=e,i=e.apiBase.replace(/\/+$/,""),o=t.endpoint||Bl,s=t.jsonBase||Nl,n=t.chunkSize??Ml,a=t.resumable!==!1,l=t.parallelChunks??1,c=t.retryDelays??[0,1e3,3e3,5e3],d=i.split("/").pop()||"";let p=!1,u=!1,b=!1;const x={name:r.name,type:r.type,"filerobot-folder":e.folder};Xi(r.product)&&(x.product=JSON.stringify(Ji(r.product)));const _=async()=>`tus-${r.id}-${o}`,E=new jl(r.file,{endpoint:o,chunkSize:n,retryDelays:c,parallelUploads:l,storeFingerprintForResuming:a,removeFingerprintOnSuccess:!0,headers:{},metadata:x,fingerprint:_,onBeforeRequest(m){const R=e.getAuthHeaders?e.getAuthHeaders():e.authHeaders;for(const[U,z]of Object.entries(R))m.setHeader(U,z);m.setHeader("X-Filerobot-Token",d)},onUploadUrlAvailable(){E.url&&e.onUploadUrlAvailable&&!b&&(b=!0,e.onUploadUrlAvailable(E.url))},onProgress(m,R){!u&&!p&&e.onProgress(m,R)},onSuccess(){var U;if(u)return;w();const m=E.url||"",R=(U=m.match(/files\/([^/?]+)/))==null?void 0:U[1];R?Kl(s,R,r.size).then(z=>{u||e.onComplete(Ot(z)?Gi(z,r):z)}).catch(z=>{u||e.onError(z)}):e.onComplete({status:"success",file:{uuid:"",name:r.name,extension:r.name.split(".").pop()||"",type:r.type,size:r.size,url:{public:m,cdn:m},meta:r.meta,tags:r.tags,info:{},created_at:new Date().toISOString(),modified_at:new Date().toISOString()}})},onError(m){u||(w(),Vl(m)?e.onError(new Error("Network error during upload — check your connection or firewall settings")):e.onError(m instanceof Error?m:new Error(String(m))))},onShouldRetry(m,R,U){var L;const z=(L=m.originalResponse)==null?void 0:L.getStatus();return z===429?!0:!(z&&z>400&&z<500&&z!==409)}});let F=null,k=null;typeof window<"u"&&(F=()=>{var m;!p&&!u&&(p=!0,E.abort(!1),(m=e.onPause)==null||m.call(e))},k=()=>{var m;p&&!u&&(p=!1,E.start(),(m=e.onResume)==null||m.call(e))},window.addEventListener("offline",F),window.addEventListener("online",k));const w=()=>{F&&window.removeEventListener("offline",F),k&&window.removeEventListener("online",k)},y=()=>{try{E.start()}catch(m){w(),e.onError(m instanceof Error?m:new Error(String(m)))}};return a?E.findPreviousUploads().then(m=>{m.length>0&&!u&&E.resumeFromPreviousUpload(m[0]),u||y()}):y(),{abort(){u=!0,p=!1,w(),E.abort(!0)},pause(){!p&&!u&&(p=!0,E.abort(!1))},resume(){p&&!u&&(p=!1,E.start())},isPaused(){return p}}}function Vl(r){var e;if(r instanceof dt){const t=(e=r.originalRequest)==null?void 0:e.getUnderlyingObject();return t&&typeof t.readyState=="number"&&typeof t.status=="number"?t.readyState!==0&&t.readyState!==4||t.status===0:r.originalResponse==null&&r.causingError!=null}return!1}async function Kl(r,e,t){const i=`${r.replace(/\/+$/,"")}/${e}`,o=t>1e8?13e3:6e3,s=3;for(let n=0;n<=s;n++){n>0&&await new Promise(c=>setTimeout(c,o));const a=await fetch(i);if(a.status===404&&n<s)continue;if(!a.ok)throw new Error(`Failed to fetch file record (HTTP ${a.status})`);const l=await a.json();if(Ot(l))return l;if(l.file)return{status:"success",file:l.file};if(l.status==="success")return l;if(!(n<s))throw new Error(l.msg||"File record not available after upload")}throw new Error("File record not available after upload")}const Vt="_sfxRelativePath",_o=8,Yl=new Set(["node_modules","__MACOSX","$RECYCLE.BIN","System Volume Information"]);function Wl(r){return r?r.startsWith(".")?!0:Yl.has(r):!1}function or(r,e){if(e){try{Object.defineProperty(r,Vt,{value:e,configurable:!0,enumerable:!1,writable:!1});return}catch{}try{Object.defineProperty(r,Vt,{value:e,configurable:!0,enumerable:!1,writable:!0})}catch{r[Vt]=e}}}function Gl(r){const e=r[Vt];if(typeof e=="string"&&e)return e;const t=r.webkitRelativePath;return typeof t=="string"?t:""}function Xl(r){if(!r)return"";const e=r.replace(/^\/+/,"").replace(/\/+$/,""),t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function Jl(r,e){const t=(r??"").replace(/\/+$/,""),i=(e??"").replace(/^\/+/,"").replace(/\/+$/,"");return i?t?`${t}/${i}`:i:r??""}async function ys(r){var n;const e=r.items;if(!(e&&e.length>0&&typeof e[0].webkitGetAsEntry=="function"))return{files:Array.from(r.files??[]),hadDirectories:!1};const i=[];let o=!1;for(const a of Array.from(e)){if(a.kind!=="file")continue;const l=(n=a.webkitGetAsEntry)==null?void 0:n.call(a);l&&(l.isDirectory&&(o=!0),i.push(l))}if(i.length===0)return{files:Array.from(r.files??[]),hadDirectories:!1};const s=[];return await ws(i,"",s),{files:s,hadDirectories:o}}async function ws(r,e,t){for(let i=0;i<r.length;i+=_o){const o=r.slice(i,i+_o);await Promise.all(o.map(s=>Zl(s,e,t)))}}async function Zl(r,e,t){try{if(r.isFile){const i=await Ql(r);if(!i)return;const o=e?`${e}/${i.name}`:i.name;or(i,o),t.push(i);return}if(r.isDirectory){if(Wl(r.name))return;const i=e?`${e}/${r.name}`:r.name,o=await ec(r);await ws(o,i,t)}}catch(i){console.warn("[sfx-uploader] folder traversal skipped an entry:",(r==null?void 0:r.name)??r,i)}}function Ql(r){return new Promise(e=>{r.file(t=>e(t),()=>e(null))})}function ec(r){return new Promise(e=>{const t=r.createReader(),i=[],o=()=>{t.readEntries(s=>{if(s.length===0){e(i);return}i.push(...s),o()},s=>{console.warn("[sfx-uploader] directory read failed for",r==null?void 0:r.name,s),e(i)})};o()})}class tc{constructor(e,t){this.activeUploads=new Map,this.pausedUploads=new Map,this.retryTimers=new Map,this.unsubscribe=null,this.store=e,this.config=t}start(){this.unsubscribe||(this.unsubscribe=this.store.subscribe(()=>this.processQueue()),this.processQueue())}uploadAll(){const{files:e}=this.store.getState();let t=!1;for(const i of e.values())i.status==="idle"?(Z(this.store,i.id,{status:"queued"}),t=!0):i.status==="queued"&&(t=!0);t&&(this.store.setState({isUploading:!0}),this.processQueue())}retryFile(e){const t=this.store.getState().files.get(e);!t||t.status!=="error"&&t.status!=="failed"||(Z(this.store,e,{status:"queued",error:null,progress:0,bytesUploaded:0,speed:0}),this.processQueue())}retryAll(){const{files:e}=this.store.getState();for(const t of e.values())(t.status==="error"||t.status==="failed")&&Z(this.store,t.id,{status:"queued",error:null,progress:0,bytesUploaded:0,speed:0});this.processQueue()}pauseFile(e){const t=this.activeUploads.get(e);t&&"pause"in t&&(t.pause(),this.activeUploads.delete(e),this.pausedUploads.set(e,t),Z(this.store,e,{status:"paused"}),this.processQueue())}resumeFile(e){const t=this.pausedUploads.get(e);if(!t)return;const{concurrency:i}=this.store.getState().queueConfig;this.activeUploads.size<i?(this.pausedUploads.delete(e),t.resume(),this.activeUploads.set(e,t),Z(this.store,e,{status:"uploading"})):Z(this.store,e,{status:"queued"})}cancelFile(e){const t=this.store.getState().files.get(e);!t||!Ai(t.status)||(this.abortPausedUpload(e),this.abortUpload(e),Z(this.store,e,{status:"cancelled"}))}cancelAll(){const{files:e}=this.store.getState();for(const t of e.values())Ai(t.status)&&(this.abortPausedUpload(t.id),this.abortUpload(t.id),Z(this.store,t.id,{status:"cancelled"}));this.store.setState({isUploading:!1})}recompute(){this.updateTotalProgress(),this.checkAllComplete()}updateConfig(e){Object.assign(this.config,e)}destroy(){var e;for(const t of this.activeUploads.keys())this.abortUpload(t);for(const t of[...this.pausedUploads.keys()])this.abortPausedUpload(t);for(const t of this.retryTimers.values())clearTimeout(t);this.retryTimers.clear(),(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=null}processQueue(){const e=this.store.getState();if(e.isPaused)return;const{concurrency:t}=e.queueConfig,i=this.activeUploads.size,o=t-i;if(o<=0)return;const n=[...e.files.values()].filter(a=>a.status==="queued").sort((a,l)=>a.retryCount!==l.retryCount?l.retryCount-a.retryCount:a.addedAt-l.addedAt).slice(0,o);for(const a of n){const l=this.pausedUploads.get(a.id);l?(this.pausedUploads.delete(a.id),l.resume(),this.activeUploads.set(a.id,l),Z(this.store,a.id,{status:"uploading"})):this.startUpload(a)}}startUpload(e){var u,b;const t=(b=(u=this.config).resolveUploadParams)==null?void 0:b.call(u,e),i=!!t&&Object.keys(t).length>0,o=!i&&!e.remoteInfo&&!e.remoteUrl&&Hl(e,this.config.tusConfig);Z(this.store,e.id,{status:"uploading",error:null,isTus:o});let s=0,n=Date.now(),a=0;const l=Jl(this.store.getState().targetFolder,e.relativeFolder),c={apiBase:this.config.apiBase,authHeaders:this.config.authHeaders,folder:l,extraParams:i?t:void 0,onComplete:x=>this.handleComplete(e.id,x),onError:x=>this.handleError(e.id,x)},d=(x,_)=>{const E=Date.now(),F=(E-n)/1e3;if(F>0){const w=(x-s)/F;a=a===0?w:.3*w+.7*a}s=x,n=E;const k=_>0?Math.min(x/_*100,100):0;Z(this.store,e.id,{progress:k,bytesUploaded:x,speed:a}),this.updateTotalProgress()};let p;if(e.remoteInfo)p=Qn(e,{...c,onProgress:d});else if(e.remoteUrl){if(!this.config.companionUrl){Z(this.store,e.id,{status:"failed",error:"URL import requires connectors.companionUrl to be configured"}),this.checkAllComplete(),this.processQueue();return}p=ea(e,{...c,onProgress:d,companionUrl:this.config.companionUrl,onMeta:x=>{Z(this.store,e.id,{size:x.size,type:x.type||e.type})}})}else if(o){const x=ql(e,{...c,onProgress:d,tusConfig:this.config.tusConfig,getAuthHeaders:()=>this.config.authHeaders,onUploadUrlAvailable:_=>{Z(this.store,e.id,{tusUploadUrl:_})},onPause:()=>{this.activeUploads.delete(e.id),this.pausedUploads.set(e.id,x),Z(this.store,e.id,{status:"paused"}),this.processQueue()},onResume:()=>{this.pausedUploads.delete(e.id),this.activeUploads.set(e.id,x),Z(this.store,e.id,{status:"uploading"})}});p=x}else p=Vn(e,{...c,onProgress:d});this.activeUploads.set(e.id,p)}handleComplete(e,t){var d,p,u,b,x,_,E,F,k,w;this.activeUploads.delete(e);const i=this.store.getState().files.get(e),o=((d=i==null?void 0:i.previewUrl)==null?void 0:d.startsWith("blob:"))??!1,s=((u=(p=t.file)==null?void 0:p.url)==null?void 0:u.cdn)??((x=(b=t.file)==null?void 0:b.url)==null?void 0:x.cdn_permalink)??((E=(_=t.file)==null?void 0:_.url)==null?void 0:E.permalink)??null,n=s?((k=(F=this.config).transformPreviewUrl)==null?void 0:k.call(F,s))??s:null,a={status:"complete",progress:100,response:t,alreadyExisted:Ot(t)};i&&n&&i.type.startsWith("image/")&&!o&&(a.previewUrl=n);const l=(w=t.file)==null?void 0:w.size,c=typeof l=="number"?l:l==null?void 0:l.bytes;typeof c=="number"&&(a.size=c),Z(this.store,e,a),this.updateTotalProgress(),this.checkAllComplete(),this.processQueue()}handleError(e,t){this.activeUploads.delete(e);const i=this.store.getState().files.get(e);if(!i)return;const{retryConfig:o}=this.store.getState().queueConfig,s=i.retryCount+1;if(s<=o.maxRetries){const n=Math.min(o.baseDelay*Math.pow(o.backoffFactor,i.retryCount),o.maxDelay);Z(this.store,e,{status:"retrying",error:t.message,retryCount:s});const a=setTimeout(()=>{this.retryTimers.delete(e),Z(this.store,e,{status:"queued"}),this.processQueue()},n);this.retryTimers.set(e,a)}else Z(this.store,e,{status:"failed",error:t.message}),this.checkAllComplete(),this.processQueue()}abortPausedUpload(e){const t=this.pausedUploads.get(e);t&&(t.abort(),this.pausedUploads.delete(e))}abortUpload(e){var i;(i=this.activeUploads.get(e))==null||i.abort(),this.activeUploads.delete(e);const t=this.retryTimers.get(e);t&&(clearTimeout(t),this.retryTimers.delete(e))}updateTotalProgress(){const{files:e}=this.store.getState();let t=0,i=0,o=0;for(const s of e.values())(s.status==="queued"||s.status==="uploading"||s.status==="paused"||s.status==="retrying"||s.status==="complete"||s.status==="failed")&&(t+=s.size,i+=s.status==="complete"?s.size:s.bytesUploaded),s.status==="uploading"&&(o+=s.speed);this.store.setState({totalBytes:t,totalBytesUploaded:i,totalSpeed:o,totalProgress:t>0?Math.min(i/t*100,100):0})}checkAllComplete(){const{files:e}=this.store.getState();![...e.values()].some(i=>i.status==="queued"||i.status==="uploading"||i.status==="retrying"||i.status==="paused")&&this.store.getState().isUploading&&this.store.setState({isUploading:!1})}}function Ai(r){return r==="queued"||r==="uploading"||r==="retrying"||r==="paused"}function sr(r){return`https://api.filerobot.com/${r}`}async function ic(r,e){const t=`${sr(r)}/key/${encodeURIComponent(e)}`,i=new AbortController,o=setTimeout(()=>i.abort(),3e4);try{const s=await fetch(t,{signal:i.signal});if(clearTimeout(o),!s.ok)throw new Error(`SASS key exchange failed (HTTP ${s.status})`);const n=await s.json();if(n.status==="error")throw new Error(`SASS key exchange failed: ${n.msg||"Unknown error"}`);return n.key}catch(s){throw clearTimeout(o),s instanceof DOMException&&s.name==="AbortError"?new Error("SASS key exchange timed out"):s}}function Li(r,e){const t={};switch(r.mode){case"security-template":if(!e)throw new Error("[sfx-uploader] Cannot build auth headers for security-template mode: SASS key exchange has not been performed. Call resolveAuth() first or use sass-key mode with a pre-resolved key.");t["X-Filerobot-Key"]=e;break;case"sass-key":t["X-Filerobot-Key"]=r.sassKey;break}return r.airboxPuid&&(t["X-Filerobot-Airbox-Puid"]=r.airboxPuid),t}async function rc(r){const e=sr(r.container);if(r.mode==="security-template"){const t=await ic(r.container,r.securityTemplateId);return{apiBase:e,headers:Li(r,t),sassKey:t}}return{apiBase:e,headers:Li(r)}}const ei="sfx-uploader:last-upload:",_s=1;function oc(r){var s,n,a,l,c,d,p,u,b;const{file:e,previewUrl:t,...i}=r;let o=null;return r.status==="complete"&&(r.previewUrl&&!r.previewUrl.startsWith("blob:")?o=r.previewUrl:o=((a=(n=(s=r.response)==null?void 0:s.file)==null?void 0:n.url)==null?void 0:a.permalink)??((d=(c=(l=r.response)==null?void 0:l.file)==null?void 0:c.url)==null?void 0:d.cdn_permalink)??((b=(u=(p=r.response)==null?void 0:p.file)==null?void 0:u.url)==null?void 0:b.cdn)??null),{...i,previewUrl:o}}function sc(r){try{const e=sessionStorage.getItem(ei+r);if(!e)return null;const t=JSON.parse(e);return(t==null?void 0:t.__schemaVersion)!==_s?null:t}catch{return null}}function nc(r,e){try{sessionStorage.setItem(ei+r,JSON.stringify(e))}catch{}}const ct={save(r,e){if(e.length===0){this.clear(r);return}const t={__schemaVersion:_s,savedAt:Date.now(),files:e.map(oc)};nc(r,t)},load(r){const e=sc(r);return e?e.files.map(t=>({...t,file:null,previewUrl:t.previewUrl??null})):null},exists(r){try{return sessionStorage.getItem(ei+r)!=null}catch{return!1}},clear(r){try{sessionStorage.removeItem(ei+r)}catch{}}},M={FILE_ADDED:"sfx-file-added",FILE_REMOVED:"sfx-file-removed",FILE_REJECTED:"sfx-file-rejected",UPLOAD_STARTED:"sfx-upload-started",UPLOAD_PROGRESS:"sfx-upload-progress",UPLOAD_COMPLETE:"sfx-upload-complete",UPLOAD_ERROR:"sfx-upload-error",UPLOAD_RETRY:"sfx-upload-retry",UPLOAD_PAUSED:"sfx-upload-paused",UPLOAD_RESUMED:"sfx-upload-resumed",ALL_COMPLETE:"sfx-all-complete",TOTAL_PROGRESS:"sfx-total-progress",BEFORE_UPLOAD:"sfx-before-upload",OPEN:"sfx-open",CLOSE:"sfx-close",CANCEL:"sfx-cancel",MINIMIZE:"sfx-minimize",RESTORE:"sfx-restore",PANEL_SHOWN:"sfx-panel-shown",COMPLETE_ACTION:"sfx-complete-action",FILE_PREVIEW:"sfx-file-preview",FILL_METADATA:"sfx-fill-metadata",METADATA_SCHEMA:"sfx-metadata-schema",FILE_LOCATE:"sfx-file-locate",FILE_COPY_CDN:"sfx-file-copy-cdn"};let ac=0;function Ke(){return`file-${Date.now()}-${++ac}`}function Se(r){if(!Number.isFinite(r)||r<=0)return"0 B";const e=["B","KB","MB","GB"],t=Math.min(Math.floor(Math.log(r)/Math.log(1024)),e.length-1),i=r/Math.pow(1024,t);return`${t===0?i:i.toFixed(1)} ${e[t]}`}function vi(r){if(!isFinite(r)||r<=0)return"0s";const e=Math.round(r);if(e<60)return`${e}s`;const t=Math.floor(e/60);if(t>99){const o=Math.floor(t/60),s=t%60;return s>0?`${o}h ${s}m`:`${o}h`}const i=e%60;return i>0?`${t}m ${i}s`:`${t}m`}function ue(r){var t;const e=((t=r.name.split(".").pop())==null?void 0:t.toLowerCase())??"";return r.type.startsWith("image/")?"image":r.type.startsWith("video/")||["mp4","mov","avi","webm","mkv","flv","wmv"].includes(e)?"vid":r.type.startsWith("audio/")||["mp3","wav","ogg","flac","aac","m4a","wma"].includes(e)?"audio":r.type==="application/pdf"||e==="pdf"?"pdf":["xls","xlsx","csv","tsv","ods"].includes(e)?"sheet":["doc","docx","txt","rtf","odt","pages"].includes(e)?"doc":["ppt","pptx","key","odp"].includes(e)?"slide":["zip","rar","7z","tar","gz","bz2","xz","zst"].includes(e)?"zip":["js","ts","jsx","tsx","py","rb","go","rs","java","c","cpp","h","cs","php","swift","kt","sh","bash"].includes(e)?"code":["html","css","scss","xml","svg","json","yaml","yml","toml","md","mdx","ini","env","log"].includes(e)?"markup":["ttf","otf","woff","woff2","eot"].includes(e)?"font":["ai","psd","sketch","fig","xd","indd","eps"].includes(e)?"design":["exe","dmg","app","msi","deb","rpm","apk","ipa"].includes(e)?"binary":["sql","db","sqlite","mdb"].includes(e)?"data":"gen"}function lc(r){const e=r.lastIndexOf(".");return e>=0?r.slice(e+1).toUpperCase():""}const cc=new Set([".ds_store","thumbs.db","desktop.ini"]);function bi(r){const e=(r.split(/[\\/]/).pop()??r).toLowerCase();return e.startsWith(".ds_store")?!0:cc.has(e)}const dc="https://scaleflex.cloudimg.io/v7/assets/file-types/v3/",ks={_default:"9a518a",png:"96cd9a",jpg:"06e819",jpg2:"f0eb7f",jpeg:"6a65e9",gif:"c3c2c3",bmp:"d2243a",webp:"fedd74",svg:"a15e46",tiff:"1f30c3",tif:"b383c9",heic:"84adfe",avif:"536b30",ico:"79063d",psd:"be6140",psb:"678646",ai:"84b254",dwg:"971fb3",mp4:"42f175",webm:"26a84a",avi:"d22ba8",mpeg:"ba93bb",ogv:"74d453","3gp":"f0d388","3g2":"04c652",swf:"3955e2",fla:"daf585",m3u8:"7d5e62",mp3:"66bbef",wav:"d7a7d5",aac:"07f3f9",oga:"a5c622",opus:"9548b1",weba:"4dcf70",mid:"3f0e29",midi:"9fedec",cda:"85b83b",pdf:"18c5f7",doc:"d1b47c",docx:"1eb6b0",txt:"307979",rtf:"978c5f",xls:"13b5f7",xlsx:"79d64a",ppt:"4ee29b",pptx:"8b1568",csv:"4add78",odt:"940781",ods:"9fbe9a",odp:"bf892d",dbf:"457bd4",vsd:"8a9ccb",abw:"313dc7",epub:"15263d",azw:"a018b1",ics:"909f63",ogx:"f694d2",zip:"84f98b",rar:"1d6423","7z":"e007e5",tar:"603aed",gz:"de13f7",bz:"0374ff",bz2:"e14294",arc:"942fad",jar:"149796",mpkg:"dea655",ttf:"d2e2c1",otf:"c904fd",woff:"4b8177",woff2:"b532d3",eot:"a54980",js:"524691",mjs:"d57921",ts:"9af3ae",css:"287863",html:"fa7a87",htm:"21323d",xhtml:"e6d6a9",xul:"6c9c71",json:"104c9e",jsonld:"f30c0f",xml:"7f7194",php:"503e36",sh:"3b820e",csh:"08c0cc",exe:"ccca53",iso:"064b8f",bin:"1e9618"};function Fi(r){const e=r==="_default"?"GENERIC":r.toUpperCase();return`${dc}${e}.svg?vh=${ks[r]}`}function Ss(r){const e=(r==null?void 0:r.toLowerCase().replaceAll(".",""))||"";return e in ks?Fi(e):Fi("_default")}function $s(){return Fi("_default")}const pc={jpg:"image/jpeg",jpeg:"image/jpeg",png:"image/png",gif:"image/gif",webp:"image/webp",svg:"image/svg+xml",bmp:"image/bmp",ico:"image/x-icon",heic:"image/heic",heif:"image/heif",mp4:"video/mp4",mov:"video/quicktime",avi:"video/x-msvideo",webm:"video/webm",pdf:"application/pdf",zip:"application/zip",doc:"application/msword",docx:"application/vnd.openxmlformats-officedocument.wordprocessingml.document"};function ko(r){var t;const e=((t=r.split(".").pop())==null?void 0:t.toLowerCase())??"";return pc[e]||""}function ke(r){return r==="image/heic"||r==="image/heif"}function uc(r){return new Promise(e=>{const t=document.createElement("video");t.preload="metadata",t.muted=!0,t.playsInline=!0;const i=URL.createObjectURL(r);let o=!1;const s=()=>{o||(o=!0,e(null)),t.removeAttribute("src"),t.load(),URL.revokeObjectURL(i)};t.addEventListener("seeked",()=>{try{const n=document.createElement("canvas");n.width=t.videoWidth||320,n.height=t.videoHeight||240;const a=n.getContext("2d");if(a){a.drawImage(t,0,0,n.width,n.height),n.toBlob(l=>{o||(o=!0,e(l?URL.createObjectURL(l):null),t.removeAttribute("src"),t.load(),URL.revokeObjectURL(i))},"image/jpeg",.7);return}}catch{}s()},{once:!0}),t.addEventListener("error",()=>s(),{once:!0}),setTimeout(()=>s(),5e3),t.src=i,t.addEventListener("loadeddata",()=>{t.currentTime=.1},{once:!0})})}function fc(r){return typeof r=="string"&&r.startsWith("Maximum ")&&r.includes("files allowed")}function yi(r,e,t){var i,o;if(e.maxFileSize!=null&&r.size>0&&r.size>e.maxFileSize)return`File exceeds ${(e.maxFileSize/1048576).toFixed(1)} MB limit`;if(e.maxTotalFilesSize!=null&&r.size>0){let s=r.size;for(const n of t.values())n.status!=="rejected"&&n.status!=="cancelled"&&(s+=n.size);if(s>e.maxTotalFilesSize)return"Total file size limit exceeded"}if(e.maxNumberOfFiles!=null){let s=0;for(const n of t.values())n.status!=="rejected"&&n.status!=="cancelled"&&s++;if(s>=e.maxNumberOfFiles)return`Maximum ${e.maxNumberOfFiles} files allowed`}if(e.allowedFileTypes!=null){const s=e.allowedFileTypes,n="."+(((i=r.name.split(".").pop())==null?void 0:i.toLowerCase())??"");if(!s.some(l=>l.startsWith(".")?n===l.toLowerCase():l.endsWith("/*")?r.type.startsWith(l.slice(0,-1)):r.type===l))return"File type not allowed"}if(e.blockedFileTypes!=null){const s=e.blockedFileTypes,n="."+(((o=r.name.split(".").pop())==null?void 0:o.toLowerCase())??"");if(s.some(l=>l.startsWith(".")?n===l.toLowerCase():l.endsWith("/*")?r.type.startsWith(l.slice(0,-1)):r.type===l))return"File type is blocked"}return null}function So(r){return r.allowedFileTypes?r.allowedFileTypes.join(","):""}const $o={"google-drive":{id:"google-drive",label:"Google Drive",fillIcon:!0,icon:"",brandStyle:{background:"transparent"},brandHtml:'<svg width="16" height="16" viewBox="0 0 87.3 78"><path d="M6.6 66.85l3.85 6.65c.8 1.4 1.95 2.5 3.3 3.3L27.5 53H0c0 1.55.4 3.1 1.2 4.5z" fill="#0066da"/><path d="M43.65 25L29.9 1.2C28.55 2 27.4 3.1 26.6 4.5L1.2 48.5C.4 49.9 0 51.45 0 53h27.5z" fill="#00ac47"/><path d="M73.55 76.8c1.35-.8 2.5-1.9 3.3-3.3l1.6-2.75 7.65-13.25c.8-1.4 1.2-2.95 1.2-4.5H59.8l5.65 10.85z" fill="#ea4335"/><path d="M43.65 25L57.4 1.2C56.05.4 54.5 0 52.9 0H34.4c-1.6 0-3.15.45-4.5 1.2z" fill="#00832d"/><path d="M59.8 53H27.5L13.75 76.8c1.35.8 2.9 1.2 4.5 1.2h50.8c1.6 0 3.15-.45 4.5-1.2z" fill="#2684fc"/><path d="M73.4 26.5l-12.7-22c-.8-1.4-1.95-2.5-3.3-3.3L43.65 25 59.8 53h27.45c0-1.55-.4-3.1-1.2-4.5z" fill="#ffba00"/></svg>'},dropbox:{id:"dropbox",label:"Dropbox",fillIcon:!0,icon:"",brandStyle:{background:"#0061ff"},brandHtml:'<svg width="11" height="11" viewBox="0 0 528 512" fill="white"><path d="M264.4 116.3l-132 84.3 132 84.3-132 84.3L0 284.1l132.3-84.3L0 116.3 132.3 32l132.1 84.3zm-132 284.5l132-84.3 132 84.3-132 84.4-132-84.4zm132-116.6l132.3-84.3-132.3-83.9 131.6-84.3L528 116.3l-132.3 84.1L528 284.7l-132.4 83.9-131.2-84.4z"/></svg>'},onedrive:{id:"onedrive",label:"OneDrive",fillIcon:!0,icon:"",brandStyle:{background:"#0078d4"},brandHtml:'<svg width="11" height="11" viewBox="0 0 24 24" fill="white"><path d="M10.5 13.5C10.5 11.57 12.07 10 14 10h6.5c.17 0 .34.01.5.02A6 6 0 009.01 11.6 4 4 0 0010.5 13.5zM12 14.5a5 5 0 00-5-5 5 5 0 00-5 5 3 3 0 003 3h9.5A3.5 3.5 0 0018 14c0-.18-.01-.35-.03-.52A5.48 5.48 0 0112 14.5z"/></svg>'},box:{id:"box",label:"Box",fillIcon:!0,icon:"",brandStyle:{background:"#0e50a0","font-size":"9px","font-weight":"800",color:"#fff"},brandHtml:"box"},instagram:{id:"instagram",label:"Instagram",fillIcon:!0,icon:"",brandStyle:{background:"linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)"},brandHtml:'<svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M12 2.16c2.94 0 3.29.01 4.45.06 1.07.05 1.8.22 2.43.46.66.25 1.21.6 1.77 1.16.55.55.9 1.1 1.16 1.77.25.64.41 1.37.46 2.43.05 1.16.06 1.51.06 4.45s-.01 3.29-.06 4.45c-.05 1.07-.22 1.8-.46 2.43a4.9 4.9 0 01-1.16 1.77c-.55.55-1.1.9-1.77 1.16-.64.25-1.37.41-2.43.46-1.16.05-1.51.06-4.45.06s-3.29-.01-4.45-.06c-1.07-.05-1.8-.22-2.43-.46a4.9 4.9 0 01-1.77-1.16 4.9 4.9 0 01-1.16-1.77c-.25-.64-.41-1.37-.46-2.43C2.17 15.29 2.16 14.94 2.16 12s.01-3.29.06-4.45c.05-1.07.22-1.8.46-2.43a4.9 4.9 0 011.16-1.77A4.9 4.9 0 015.61 2.2c.64-.25 1.37-.41 2.43-.46C9.21 2.17 9.56 2.16 12 2.16zM12 16a4 4 0 110-8 4 4 0 010 8zm6.4-9.85a1.44 1.44 0 100 2.88 1.44 1.44 0 000-2.88z"/></svg>'},facebook:{id:"facebook",label:"Facebook",fillIcon:!0,icon:"",brandStyle:{background:"#1877f2"},brandHtml:'<svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.41 0 12.07c0 6.02 4.39 11.02 10.12 11.93v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.95.93-1.95 1.89v2.26h3.33l-.53 3.49h-2.8v8.44C19.61 23.09 24 18.09 24 12.07z"/></svg>'},unsplash:{id:"unsplash",label:"Unsplash",fillIcon:!0,icon:"",brandStyle:{background:"#111"},brandHtml:'<svg width="12" height="12" viewBox="0 0 24 24" fill="white"><path d="M8.5 11.5v5h7v-5h5.5V21h-18v-9.5h5.5zm7-8v5h-7v-5h7z"/></svg>'}};function hc(r){return r.filter(e=>e in $o).map(e=>$o[e])}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ti=class extends Wi{constructor(e){if(super(e),this.it=S,e.type!==Yi.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===S||e==null)return this._t=void 0,this.it=e;if(e===he)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ti.directiveName="unsafeHTML",ti.resultType=1;const Co=oi(ti);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ii extends ti{}Ii.directiveName="unsafeSVG",Ii.resultType=2;const Ce=oi(Ii);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gc=oi(class extends Wi{constructor(r){var e;if(super(r),r.type!==Yi.ATTRIBUTE||r.name!=="class"||((e=r.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var i,o;if(this.st===void 0){this.st=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!((i=this.nt)!=null&&i.has(s))&&this.st.add(s);return this.render(e)}const t=r.element.classList;for(const s of this.st)s in e||(t.remove(s),this.st.delete(s));for(const s in e){const n=!!e[s];n===this.st.has(s)||(o=this.nt)!=null&&o.has(s)||(n?(t.add(s),this.st.add(s)):(t.remove(s),this.st.delete(s)))}return he}});function ze(r){return r.brandStyle?f`<span
    class=${gc({"brand-ico":!0,"brand-ico--transparent":r.brandStyle.background==="transparent"})}
    ${Q(r.brandStyle)}
  >${Co(r.brandHtml)}</span>`:Co(r.brandHtml)}var mc=Object.defineProperty,Cs=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&mc(e,t,o),o};const xc='<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>',vc='<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>',bc='<path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/>',yc='<rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="1"/><path d="M7 21l5-5 5 5"/>',ft=[{id:"device",labelKey:"myDevice",label:"My Device",icon:xc,iconColor:"#2563eb"},{id:"url",labelKey:"urlLink",label:"URL link",icon:vc,iconColor:"#16a34a"},{id:"camera",labelKey:"camera",label:"Camera",icon:bc,iconColor:"#7c3aed"},{id:"screen-cast",labelKey:"screenCapture",label:"Screen capture",icon:yc,iconColor:"#ea580c"}],pr=class pr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.sources=ft}_handleClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}render(){return f`
      ${this.sources.map(e=>f`
          <button @click=${()=>this._handleClick(e)}>
            ${e.brandHtml?ze(e):Fe`<svg viewBox="0 0 24 24" class=${e.fillIcon?"fill-icon":""}>${Ce(e.icon)}</svg>`}
  ...
  `;let Ut=pr;Cs([O({attribute:!1})],Ut.prototype,"t");Cs([O({type:Array})],Ut.prototype,"sources");const zi={LANGUAGES:"FTYPE_LANGUAGES"};function pd(r,e){if(!r.regional_variants_group_uuid)return;const t=e==null?void 0:e.regionalFilters;return t&&r.regional_variants_group_uuid in t?t[r.regional_variants_group_uuid]:e==null?void 0:e.language}function ud(r,e,t,i){if(!r.regional_variants_group_uuid||!e)return;const o=e.find(a=>a.uuid===r.regional_variants_group_uuid);if(!o)return;const s=(t==null?void 0:t[o.uuid])??i,n=o.variants.find(a=>a.api_value===s);if(n)return`${o.label}: ${n.label}`}function wc(r,e){var i;const t={};for(const o of r??[]){if(!((i=o.variants)!=null&&i.length))continue;const s=o.type===zi.LANGUAGES?_c(o.variants,e):void 0;t[o.uuid]=s??o.variants[0].api_value}return t}function _c(r,e){var n;if(!e)return;const t=e.toLowerCase(),i=t.split("-")[0];let o,s;for(const a of r){const l=(n=a.api_value)==null?void 0:n.toLowerCase();if(l){if(l===t)return a.api_value;!o&&l===i&&(o=a.api_value),!s&&l.split("-")[0]===i&&(s=a.api_value)}}return o??s}const Es=new Set(["asset-attachments","attachments-assets","integer-list"]),kc=new Set(["face_matcher"]);function fd(r){return Es.has(r)}function Sc(r){return Es.has(r.type)||kc.has(r.ckey)}const it="product.ref",rt="product.position",$c="__product__",Cc=new Set([it,rt]);function Ec(r){return Cc.has(r)}function Pc(r){return r===it?"ref":r===rt?"position":null}function Uc(r){return[{key:it,ckey:it,uuid:"product-ref",title:r("productRefLabel","Product reference"),type:"text",placeholder:r("productRefPlaceholder","e.g. SKU-12345"),required:0,possible_values:[],regional_variants_group_uuid:null,permissions:[]},{key:rt,ckey:rt,uuid:"product-position",title:r("productPositionLabel","Position"),type:"numeric",placeholder:r("productPositionPlaceholder","0"),required:0,possible_values:[],regional_variants_group_uuid:null,permissions:[]}]}function Rc(r){return{uuid:$c,isRoot:!1,name:r("productFieldsLabel","Product"),fields:Uc(r)}}function Oc(r,e){const t=Rc(e);let i=-1;for(let l=0;l<r.groups.length;l++)r.groups[l].isRoot&&(i=l);const o=i+1,s=[...r.groups.slice(0,o),t,...r.groups.slice(o)],n=s.flatMap(l=>l.fields),a=new Map(n.map(l=>[l.key,l]));return{...r,groups:s,fields:n,fieldsByKey:a}}function hd(r,e,t){var o;if((((o=t==null?void 0:t.requiredFields)==null?void 0:o.includes(r.ckey))||!!r.required)&&ji(e))return`${r.title} is required`;if(ji(e))return null;if(r.key===it)return typeof e!="string"||Hn.test(e)?"Reference contains invalid characters":null;if(r.key===rt){const s=Number(e);return!Number.isFinite(s)||!Number.isInteger(s)?"Position must be an integer":null}switch(r.type){case"numeric":{const s=Number(e);if(!Number.isFinite(s))return"Must be a valid number";if(!Number.isInteger(s))return"Must be an integer";if(s<-1999999999||s>1999999999)return"Value out of range (±1,999,999,999)";break}case"decimal2":{const s=Number(e);if(!Number.isFinite(s))return"Must be a valid number";if(!/^\-?\d*\.?\d{0,2}$/.test(String(e)))return"Maximum 2 decimal places";if(s<-999999999999e-2||s>999999999999e-2)return"Value out of range (±9,999,999,999.99)";break}case"geopoint":{const s=e,n=s.latitude!==""&&s.latitude!=null,a=s.longitude!==""&&s.longitude!=null;if(n!==a)return"Both latitude and longitude are required";if(n&&a){const l=Number(s.latitude),c=Number(s.longitude);if(!Number.isFinite(l)||l<-90||l>90)return"Latitude must be between -90 and 90";if(!Number.isFinite(c)||c<-180||c>180)return"Longitude must be between -180 and 180"}break}case"attachment-uri":{try{const s=new URL(e);if(!["http:","https:"].includes(s.protocol))return"Only http and https URLs are allowed"}catch{return"Invalid URI"}break}}if(r.validation&&typeof e=="string")try{if(!new RegExp(r.validation).test(e))return"Value does not match expected format"}catch{}return null}function ji(r){return r==null?!0:Array.isArray(r)||typeof r=="string"?r.length===0:typeof r=="object"?!Object.values(r).some(e=>e!=null&&e!==""):!r}const Tc=new Set(["idle","queued","rejected"]);function nr(r){return!ji(r)}function Ps(r,e){var t;return Sc(r)?!1:(t=e==null?void 0:e.requiredFields)!=null&&t.includes(r.ckey)?!0:!!r.required}function ar(r){return[...r.values()].filter(e=>Tc.has(e.status))}function lr(r,e){return r.fields.filter(t=>Ps(t,e))}function gd(r,e,t){const i=ar(r);if(i.length===0)return{};const o={};for(const s of lr(e,t)){const n=i.filter(a=>!nr(a.meta[s.key]));n.length>0&&(o[s.key]=n)}return o}function Ac(r,e,t){const i=ar(r);if(i.length===0)return null;for(const o of lr(e,t))if(i.some(n=>!nr(n.meta[o.key])))return o.key;return null}function Lc(r,e,t){var o;const i=r.get(e.id);return i&&i.has(t)?i.get(t):(o=e.meta)==null?void 0:o[t]}function md(r,e,t,i){const o=new Set,s=ar(e);if(s.length===0)return o;for(const n of lr(t,i))s.some(l=>!nr(Lc(r,l,n.key)))&&o.add(n.key);return o}function xd(r,e){const t={...r};for(const i of Object.keys(e)){const o=e[i];if(o==null||o==="")continue;const s=r[i];if(Array.isArray(o))if(Array.isArray(s)){const n=new Set(s.map(l=>JSON.stringify(l))),a=[...s];for(const l of o){const c=JSON.stringify(l);n.has(c)||(n.add(c),a.push(l))}t[i]=a}else t[i]=o;else t[i]=o}return t}function Us(r){let e=r;for(;e;){if(e instanceof ShadowRoot){e=e.host;continue}if(e instanceof HTMLDialogElement&&e.open)return e;if(e instanceof Element&&e.shadowRoot){const t=e.shadowRoot.querySelector("dialog[open]");if(t instanceof HTMLDialogElement)return t}e=e.parentNode}return document.body}var Fc=Object.defineProperty,de=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Fc(e,t,o),o};const Eo=3,Di=new CSSStyleSheet;Di.replaceSync(`
...
`);var Ue;const ne=(Ue=class extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.compact=!1,this.externalDragOver=!1,this.accept="",this.multi=!0,this.directory=!1,this.sources=[],this.sourcesLayout="pills",this.mode="modal",this._resizeObserver=null,this._dragOver=!1,this._moreOpen=!1,this._visiblePills=Eo,this._dragCounter=0,this._onDragEnter=e=>{e.preventDefault(),this._dragCounter++,this._dragCounter===1&&(this._dragOver=!0)},this._onDragOver=e=>{e.preventDefault()},this._onDragLeave=e=>{e.preventDefault(),this._dragCounter--,this._dragCounter<=0&&(this._dragCounter=0,this._dragOver=!1)},this._onDrop=e=>{e.preventDefault(),e.stopPropagation(),this._dragCounter=0,this._dragOver=!1;const t=e.dataTransfer;t&&ys(t).then(({files:i,hadDirectories:o})=>{i.length>0?this._emitFiles(i,o):o&&this.dispatchEvent(new CustomEvent("folder-empty",{bubbles:!0,composed:!0}))})},this._onClick=e=>{const t=this.shadowRoot.querySelector(".dz-content");if(t&&this._rippleEl){const i=t.getBoundingClientRect();this._rippleEl.style.left=`${e.clientX-i.left}px`,this._rippleEl.style.top=`${e.clientY-i.top}px`,this._rippleEl.classList.remove("go"),this._rippleEl.offsetWidth,this._rippleEl.classList.add("go")}this.browse()},this._onKeyDown=e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.browse())},this._onFileChange=e=>{const t=e.target,i=Array.from(t.files??[]);for(const o of i){const s=o.webkitRelativePath;s&&or(o,s)}i.length>0&&this._emitFiles(i),t.value=""},this._onPaste=e=>{var o;if(!this.isConnected||this.offsetWidth===0)return;const t=(o=e.clipboardData)==null?void 0:o.items;if(!t)return;const i=[];for(const s of t)if(s.kind==="file"){const n=s.getAsFile();n&&i.push(n)}i.length>0&&(e.preventDefault(),this._emitFiles(i))},this._portalContainer=null,this._onDocClick=e=>{var t;this._moreOpen&&((t=this._portalContainer)!=null&&t.contains(e.target)||(this._moreOpen=!1,this._updateDropdownPortal()))},this._onDocKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._updateDropdownPortal())},this._resizeTimer=null,this._onScrollOrResize=()=>{this._moreOpen&&this._positionDropdown(),this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(()=>this._updateVisiblePills(),100)}}browse(e="files"){var t,i;if(e==="folder"&&this.directory&&this.multi){(t=this.folderInput)==null||t.click();return}(i=this.fileInput)==null||i.click()}_onSourceIconClick(e){this.dispatchEvent(new CustomEvent("source-click",{detail:{source:e.id},bubbles:!0,composed:!0}))}_emitFiles(e,t=!1){this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:e,hadDirectories:t},bubbles:!0,composed:!0}))}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._updateDropdownPortal()}_updateDropdownPortal(){if(this._moreOpen){const e=this.sources.slice(this._visiblePills);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-more-dropdown",""),Us(this).appendChild(this._portalContainer),this._injectDropdownStyles()),Pe(f`<div class="sfx-more-dropdown open">
    ...
    `}_renderCard(e){return f`
      <button
        ...
        @click=${t=>{t.stopPropagation(),this._onSourceIconClick(e)}}
      >
        ${e.brandHtml?f`<span class="card-ico">${ze(e)}</span>`:f`<span
              class="card-ico"
              ${Q(e.iconColor?{color:e.iconColor}:null)}
            >
              ${Fe`<svg viewBox="0 0 24 24" class=${e.fillIcon?"fill-icon":""}>${Ce(e.icon)}</svg>`}
    ...
    `}render(){const e=["drop-zone",this._dragOver||this.externalDragOver?"drag-over":"",this.compact?"compact":""].filter(Boolean).join(" "),t=this.sources.slice(0,this._visiblePills),i=this.sources.slice(this._visiblePills);return f`
      ...
      >
        ...
        >
          ...
          ${!this.compact&&this.directory&&this.multi?f`<div class="folder-pick">
          ...
          ${this.compact?S:f`<div class="subtitle">${this.t("dropFilesAnywhere","Drop files anywhere on this page")}</div>`}
          ...
          ${this.compact&&this.sources.length>0?f`
                <div class="sources-row">
                  ${this.sources.map(o=>f`
                      ...
                      >
                        ${o.brandHtml?ze(o):Fe`<svg viewBox="0 0 24 24" class=${o.fillIcon?"fill-icon":""}>${Ce(o.icon)}</svg>`}
                      </button>
                    `)}
                </div>
              `:S}
  ...
  `,Ue._WIDE_THRESHOLD_PX=1200,Ue);de([O({attribute:!1})],ne.prototype,"t");de([O({type:Boolean,reflect:!0})],ne.prototype,"compact");de([O({type:Boolean,attribute:"external-drag-over"})],ne.prototype,"externalDragOver");de([O({type:String})],ne.prototype,"accept");de([O({type:Boolean})],ne.prototype,"multi");de([O({type:Boolean})],ne.prototype,"directory");de([O({type:Array})],ne.prototype,"sources");de([O({type:String,attribute:"sources-layout"})],ne.prototype,"sourcesLayout");de([O({type:String,reflect:!0})],ne.prototype,"mode");de([I()],ne.prototype,"_dragOver");de([I()],ne.prototype,"_moreOpen");de([I()],ne.prototype,"_visiblePills");de([Ki(".ripple")],ne.prototype,"_rippleEl");de([Ki("input[data-sfx-dz-files]")],ne.prototype,"fileInput");de([Ki("input[data-sfx-dz-folder]")],ne.prototype,"folderInput");let Ic=ne;const ur=class ur extends oe{render(){return f`
      <div class="line"></div>
  ...
  `;let Mi=ur;var zc=Object.defineProperty,X=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&zc(e,t,o),o};const Bi=new CSSStyleSheet;Bi.replaceSync(`
...
`);const fr=class fr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.files=[],this.showDropTile=!1,this.sources=[],this.accept="",this.multi=!0,this.directory=!1,this.mode="upload",this.showLocateButton=!1,this.showCopyCdnButton=!1,this.showCheckSimilar=!1,this.selectMode=!1,this.selectedIds=new Set,this.allSelected=!1,this.selectionFull=!1,this.maxSelection=0,this.previewOpen=!1,this.searchRunIds=[],this.searchActiveIds=new Set,this.searchResults=new Map,this._moreOpen=!1,this._dropTileMaxVisible=3,this._portalContainer=null,this._outsideClickHandler=e=>{var o;if((o=this._portalContainer)!=null&&o.contains(e.target))return;const t=this.renderRoot.querySelector(".drop-tile-more-wrap"),i=e.composedPath();t&&i.includes(t)||(this._moreOpen=!1,this._closePortal(),document.removeEventListener("click",this._outsideClickHandler,!0))},this._onScrollOrResize=()=>{this._moreOpen&&this._positionPortal()},this._onKeyDown=e=>{e.key==="Escape"&&this._moreOpen&&(this._moreOpen=!1,this._closePortal(),this._removeGlobalListeners())},this._updateDropTileMaxVisible=()=>{const e=window.innerWidth<=768?1:3;e!==this._dropTileMaxVisible&&(this._dropTileMaxVisible=e)}}_onDropTileClick(){const e=this.renderRoot.querySelector("input[data-sfx-fl-files]");e==null||e.click()}_onDropTileFolderClick(e){e.stopPropagation();const t=this.renderRoot.querySelector("input[data-sfx-fl-folder]");t==null||t.click()}_onFileInput(e){const t=e.target,i=Array.from(t.files??[]);for(const o of i){const s=o.webkitRelativePath;s&&or(o,s)}i.length>0&&this.dispatchEvent(new CustomEvent("files-selected",{detail:{files:i},bubbles:!0,composed:!0})),t.value=""}_onSourceClick(e,t){if(e.stopPropagation(),t.id==="device"){const i=this.renderRoot.querySelector('input[type="file"]');i==null||i.click();return}this.dispatchEvent(new CustomEvent("source-click",{detail:{source:t},bubbles:!0,composed:!0}))}_addGlobalListeners(){requestAnimationFrame(()=>document.addEventListener("click",this._outsideClickHandler,!0)),document.addEventListener("keydown",this._onKeyDown),window.addEventListener("scroll",this._onScrollOrResize,!0),window.addEventListener("resize",this._onScrollOrResize)}_removeGlobalListeners(){document.removeEventListener("click",this._outsideClickHandler,!0),document.removeEventListener("keydown",this._onKeyDown),window.removeEventListener("scroll",this._onScrollOrResize,!0),window.removeEventListener("resize",this._onScrollOrResize)}updated(e){super.updated(e),e.has("t")&&this._moreOpen&&this._openPortal()}_toggleMore(e){e.stopPropagation(),this._moreOpen=!this._moreOpen,this._moreOpen?(this._openPortal(),this._addGlobalListeners()):(this._closePortal(),this._removeGlobalListeners())}_openPortal(){const e=this.sources.slice(this._dropTileMaxVisible);this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-tile-dropdown",""),Us(this).appendChild(this._portalContainer),this._injectTileDropdownStyles()),Pe(f`<div class="sfx-tile-dropdown">
        ${e.map(t=>f`
          ...
          >
            <span class="sfx-tile-dropdown-ico" ${Q(t.iconColor&&!t.brandHtml?{color:t.iconColor}:null)}>
              ${t.brandHtml?ze(t):Fe`<svg viewBox="0 0 24 24" class=${t.fillIcon?"fill-icon":""}>${Ce(t.icon)}</svg>`}
            </span>
            ${t.labelKey?this.t(t.labelKey,t.label):t.label}
          </button>
        `)}
      </div>`,this._portalContainer),requestAnimationFrame(()=>this._positionPortal())}_positionPortal(){var p;const e=this.renderRoot.querySelector(".drop-tile-more"),t=(p=this._portalContainer)==null?void 0:p.querySelector(".sfx-tile-dropdown");if(!e||!t)return;const i=e.getBoundingClientRect(),o=6,s=t.scrollHeight,n=t.offsetWidth,a=i.top,l=window.innerHeight-i.bottom;a>=s+o||a>l?t.style.top=`${i.top-s-o}px`:t.style.top=`${i.bottom+o}px`;let d=i.right-n;d=Math.max(8,Math.min(d,window.innerWidth-n-8)),t.style.left=`${d}px`}_closePortal(){this._portalContainer&&(Pe(S,this._portalContainer),this._portalContainer.remove(),this._portalContainer=null)}_injectTileDropdownStyles(){var t;const e=(t=this._portalContainer)==null?void 0:t.getRootNode();e&&(e.adoptedStyleSheets.includes(Bi)||(e.adoptedStyleSheets=[...e.adoptedStyleSheets,Bi]))}connectedCallback(){super.connectedCallback(),this._updateDropTileMaxVisible(),window.addEventListener("resize",this._updateDropTileMaxVisible)}disconnectedCallback(){super.disconnectedCallback(),this._moreOpen=!1,this._closePortal(),this._removeGlobalListeners(),window.removeEventListener("resize",this._updateDropTileMaxVisible)}_onMoreSourceClick(e,t){this._moreOpen=!1,this._closePortal(),this._removeGlobalListeners(),this._onSourceClick(e,t)}_renderDropTile(){const e=this._dropTileMaxVisible,t=this.sources.slice(0,e),i=this.sources.slice(e);return f`
    ...
    `}_onSelectAll(e){const t=e.target.checked;this.dispatchEvent(new CustomEvent("similar-select-all",{detail:{selected:t},bubbles:!0,composed:!0}))}_onSearchCancel(){this.dispatchEvent(new CustomEvent("check-similar-search-cancel",{bubbles:!0,composed:!0}))}_statusFor(e){return this.searchActiveIds.has(e)?"searching":this.searchRunIds.includes(e)&&!this.searchResults.has(e)?"queued":""}render(){const e=this.searchRunIds.length,t=this.searchRunIds.filter(s=>this.searchResults.has(s)).length,i=e?Math.round(t/e*100):0,o=e>0&&t===e;return f`
      ...
      <div class="grid">
        ...
        ${this.files.map((s,n)=>{var a;return f`<sfx-file-item .t=${this.t} .file=${s} .mode=${this.mode} .showLocateButton=${this.showLocateButton} .showCopyCdnButton=${this.showCopyCdnButton} .showCheckSimilar=${this.showCheckSimilar} .selectMode=${this.selectMode} .isSelected=${this.selectedIds.has(s.id)} .selectionActive=${this.selectedIds.size>0} .selectionFull=${this.selectionFull} .previewOpen=${this.previewOpen} .similarStatus=${this._statusFor(s.id)} .similarCount=${((a=this.searchResults.get(s.id))==null?void 0:a.length)??-1} .similarResults=${this.searchResults.get(s.id)??[]} ${Q({"--tile-index":String(n)})}></sfx-file-item>`})}
      </div>
    `}};fr.styles=le`
    :host {
      display: block;
  ...
  `;let K=fr;X([O({attribute:!1})],K.prototype,"t");X([O({attribute:!1})],K.prototype,"files");X([O({type:Boolean})],K.prototype,"showDropTile");X([O({attribute:!1})],K.prototype,"sources");X([O({type:String})],K.prototype,"accept");X([O({type:Boolean})],K.prototype,"multi");X([O({type:Boolean})],K.prototype,"directory");X([O({type:String})],K.prototype,"mode");X([O({type:Boolean})],K.prototype,"showLocateButton");X([O({type:Boolean})],K.prototype,"showCopyCdnButton");X([O({type:Boolean})],K.prototype,"showCheckSimilar");X([O({type:Boolean})],K.prototype,"selectMode");X([O({attribute:!1})],K.prototype,"selectedIds");X([O({type:Boolean})],K.prototype,"allSelected");X([O({type:Boolean})],K.prototype,"selectionFull");X([O({type:Number})],K.prototype,"maxSelection");X([O({type:Boolean})],K.prototype,"previewOpen");X([O({attribute:!1})],K.prototype,"searchRunIds");X([O({attribute:!1})],K.prototype,"searchActiveIds");X([O({attribute:!1})],K.prototype,"searchResults");X([I()],K.prototype,"_moreOpen");X([I()],K.prototype,"_dropTileMaxVisible");var jc=Object.defineProperty,te=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&jc(e,t,o),o};const hr=class hr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.mode="upload",this.showLocateButton=!1,this.showCopyCdnButton=!1,this.showCheckSimilar=!1,this.selectMode=!1,this.isSelected=!1,this.selectionActive=!1,this.selectionFull=!1,this.previewOpen=!1,this.similarStatus="",this.similarCount=-1,this.similarResults=[],this.reviewPick=!1,this._dims="",this._simPopover=!1,this._simPopLeft=0,this._simPopTop=0,this._simPopTimer=null,this._simHideTimer=null,this._copied=!1,this._copiedTimer=null,this._simPopoverShow=()=>{if(this.previewOpen||!this.similarResults.length||(this._simCancelHide(),this._simPopover))return;const e=this.getBoundingClientRect(),t=240,i=280;let o=e.right+12;o+t>window.innerWidth-8&&(o=e.left-t-12),this._simPopLeft=Math.max(8,o),this._simPopTop=Math.max(8,Math.min(e.top,window.innerHeight-i-8)),this._simPopTimer&&clearTimeout(this._simPopTimer),this._simPopTimer=window.setTimeout(()=>{this.style.zIndex="50",this._simPopover=!0},150)},this._simCancelHide=()=>{this._simHideTimer&&(clearTimeout(this._simHideTimer),this._simHideTimer=null)},this._simScheduleHide=()=>{this._simPopTimer&&(clearTimeout(this._simPopTimer),this._simPopTimer=null),this._simHideTimer&&clearTimeout(this._simHideTimer),this._simHideTimer=window.setTimeout(()=>this._simPopoverClose(),180)},this._simPopoverClose=()=>{this._simPopTimer&&(clearTimeout(this._simPopTimer),this._simPopTimer=null),this._simHideTimer&&(clearTimeout(this._simHideTimer),this._simHideTimer=null),this._simPopover&&(this._simPopover=!1),this.style.zIndex=""}}updated(e){var t,i,o,s,n;if(e.has("file")){if(this._dims="",(i=(t=this.file)==null?void 0:t.previewUrl)!=null&&i.startsWith("blob:")){const a=this.file.previewUrl,l=new Image;l.onload=()=>{var c;((c=this.file)==null?void 0:c.previewUrl)===a&&(this._dims=`${l.naturalWidth}×${l.naturalHeight}`)},l.src=a}else if((n=(s=(o=this.file)==null?void 0:o.response)==null?void 0:s.file)!=null&&n.info){const a=this.file.response.file.info;a.img_w&&a.img_h&&(this._dims=`${a.img_w}×${a.img_h}`)}}}disconnectedCallback(){super.disconnectedCallback(),this._simPopTimer!=null&&(clearTimeout(this._simPopTimer),this._simPopTimer=null),this._simHideTimer!=null&&(clearTimeout(this._simHideTimer),this._simHideTimer=null),this._copiedTimer!=null&&(clearTimeout(this._copiedTimer),this._copiedTimer=null)}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{fileId:this.file.id,...t},bubbles:!0,composed:!0}))}_remove(){this._emit("file-remove")}_retry(){this._emit("file-retry")}_pause(){this._emit("file-pause")}_resume(){this._emit("file-resume")}_rename(e){const t=e.target.value.trim();t&&this._emit("file-rename",{name:t})}_preview(e){e.stopPropagation(),this._emit("file-preview")}_checkSimilarSingle(e){e.stopPropagation(),this.file&&this._emit("check-similar-single",{file:this.file})}_toggleSimilar(e){e.stopPropagation(),!(this.selectionFull&&!this.isSelected)&&this._emit("similar-toggle")}_reviewSelect(){this._emit("similar-results-select",{fileId:this.file.id})}_openResults(e){e.stopPropagation(),this._simPopoverClose(),this._emit("similar-open-results")}_locate(e){e.stopPropagation(),this.file&&this._emit("file-locate",{file:this.file})}async _copyCdn(e){var i,o,s,n;e.stopPropagation();const t=(n=(s=(o=(i=this.file)==null?void 0:i.response)==null?void 0:o.file)==null?void 0:s.url)==null?void 0:n.cdn;if(t){try{await navigator.clipboard.writeText(t)}catch{return}this._emit("file-copy-cdn",{file:this.file,cdnUrl:t}),this._copied=!0,this._copiedTimer&&clearTimeout(this._copiedTimer),this._copiedTimer=window.setTimeout(()=>{this._copied=!1,this._copiedTimer=null},1400)}}render(){var F,k;const e=this.file;if(!e)return S;const t=ue(e),i=e.status==="complete",o=e.status==="uploading",s=e.status==="paused",n=e.status==="error"||e.status==="failed",a=e.status==="rejected",l=this.mode==="review",c=lc(e.name),d=t==="image"&&!ke(e.type),p=this.selectMode&&d&&!l,u=this.similarCount>=0,b=p&&!u&&this.similarStatus==="",x=!l&&!i&&!o&&!s&&!n&&e.status!=="rejected"&&this.similarStatus!=="searching"&&!this.reviewPick,_=x,E=["tile",i?"done":"",o?"uploading":"",s?"paused":"",a?"rejected":"",l?"review":"",b?"selectable":"",b&&this.isSelected?"selected":"",this.selectionActive&&!d&&!l?"select-dimmed":"",_?"cs-overlay":"",this.similarStatus==="queued"?"sim-queued":"",this.reviewPick?"review-pick":"",this.reviewPick&&this.isSelected?"selected":""].filter(Boolean).join(" ");return f`
      ...
      >
        ...
        <div class="preview">
          ${e.previewUrl?f`<img class="preview-img" src=${e.previewUrl} alt="" />`:f`
                ...
                <div class="type-icon">
                  <img
                    ...
                    src=${Ss(c)}
                    alt="${c?`${c} file`:"File"}"
                    @error=${w=>{const y=w.target,m=$s();!y.dataset.fallback&&y.src!==m&&(y.dataset.fallback="1",y.src=m)}}
                  />
                </div>
              `}
          ...
          <!-- Review-mode hover actions: Locate (deep-link to the asset
               ...
               dead button. -->
          ${l&&i&&((F=e.response)!=null&&F.file)&&(this.showLocateButton||this.showCopyCdnButton)?f`
        ...
        <div class="info">
          <input class="name-input" type="text" .value=${e.name} title=${e.name}
            ...
            @change=${l||this.reviewPick?S:this._rename} @click=${w=>w.stopPropagation()} />
          <div class="meta">${c||""}${e.size?` · ${Se(e.size)}`:""}${this._dims?` · ${this._dims}`:""}</div>
        </div>
      </div>
    ...
    `}_formatDuration(e){const t=Math.floor(e/60),i=Math.floor(e%60);return`${t}:${i.toString().padStart(2,"0")}`}};hr.styles=le`
    :host {
      display: block;
    }
  ...
  `;let J=hr;te([O({attribute:!1})],J.prototype,"t");te([O({attribute:!1})],J.prototype,"file");te([O({type:String})],J.prototype,"mode");te([O({type:Boolean})],J.prototype,"showLocateButton");te([O({type:Boolean})],J.prototype,"showCopyCdnButton");te([O({type:Boolean})],J.prototype,"showCheckSimilar");te([O({type:Boolean})],J.prototype,"selectMode");te([O({type:Boolean})],J.prototype,"isSelected");te([O({type:Boolean})],J.prototype,"selectionActive");te([O({type:Boolean})],J.prototype,"selectionFull");te([O({type:Boolean})],J.prototype,"previewOpen");te([O({type:String})],J.prototype,"similarStatus");te([O({type:Number})],J.prototype,"similarCount");te([O({attribute:!1})],J.prototype,"similarResults");te([O({type:Boolean})],J.prototype,"reviewPick");te([I()],J.prototype,"_dims");te([I()],J.prototype,"_simPopover");te([I()],J.prototype,"_copied");const At=le`
  .btn,
  .btn-ghost,
  .btn-primary,
  .btn-sec,
...
`;var Dc=Object.defineProperty,ye=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Dc(e,t,o),o};const Po=7,Mc=4,gr=class gr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.fileCount=0,this.totalSize=0,this.thumbnails=[],this.primaryLabel="Done",this.failedFiles=[],this.alreadyExistedCount=0,this.showMinimize=!1,this._maxThumbs=Po,this._updateMaxThumbs=()=>{const e=window.innerWidth<=768?Mc:Po;e!==this._maxThumbs&&(this._maxThumbs=e)}}connectedCallback(){super.connectedCallback(),this._updateMaxThumbs(),window.addEventListener("resize",this._updateMaxThumbs)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._updateMaxThumbs)}_uploadMore(){this.dispatchEvent(new CustomEvent("upload-more",{bubbles:!0,composed:!0}))}_reviewFiles(){this.dispatchEvent(new CustomEvent("review-files",{bubbles:!0,composed:!0}))}_primaryAction(){this.dispatchEvent(new CustomEvent("primary-action",{bubbles:!0,composed:!0}))}_retryFile(e){this.dispatchEvent(new CustomEvent("file-retry",{bubbles:!0,composed:!0,detail:{fileId:e}}))}_retryAll(){this.dispatchEvent(new CustomEvent("retry-all",{bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close-uploader",{bubbles:!0,composed:!0}))}_minimize(){this.dispatchEvent(new CustomEvent("minimize-uploader",{bubbles:!0,composed:!0}))}render(){const e=this.thumbnails.slice(0,this._maxThumbs),t=this.thumbnails.length-this._maxThumbs,i=this.fileCount>0,o=this.failedFiles.length>0,s=o&&!i,n=i&&!o&&this.alreadyExistedCount>=this.fileCount,a=this.fileCount-this.alreadyExistedCount;return f`
      ...
      <div class="card" role="status" aria-live="polite">
        ...
        ${i&&!n?f`<div class="summary">${this.t("uploadedSize","{{size}} uploaded",{size:Se(this.totalSize)})}</div>`:S}
  ...
  `];let fe=gr;ye([O({attribute:!1})],fe.prototype,"t");ye([O({type:Number})],fe.prototype,"fileCount");ye([O({type:Number})],fe.prototype,"totalSize");ye([O({type:Array})],fe.prototype,"thumbnails");ye([O({type:String})],fe.prototype,"primaryLabel");ye([O({type:Array})],fe.prototype,"failedFiles");ye([O({type:Number})],fe.prototype,"alreadyExistedCount");ye([O({type:Boolean})],fe.prototype,"showMinimize");ye([I()],fe.prototype,"_maxThumbs");var Bc=Object.defineProperty,Ft=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Bc(e,t,o),o};const mr=class mr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.files=[],this.showLocateButton=!1,this.showCopyCdnButton=!1,this._filter="all",this._setFilter=e=>()=>{this._filter=e},this._onBack=()=>{this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onClear=()=>{this.dispatchEvent(new CustomEvent("clear-history",{bubbles:!0,composed:!0}))}}get _filtered(){return this._filter==="success"?this.files.filter(e=>e.status==="complete"):this._filter==="failed"?this.files.filter(e=>e.status==="failed"||e.status==="error"):this.files}get _successCount(){return this.files.filter(e=>e.status==="complete").length}get _failedCount(){return this.files.filter(e=>e.status==="failed"||e.status==="error").length}render(){const e=this._filtered,t=this.files.length;return f`
      <div class="topbar">
  ...
  `;let Re=mr;Ft([O({attribute:!1})],Re.prototype,"t");Ft([O({attribute:!1})],Re.prototype,"files");Ft([O({type:Boolean})],Re.prototype,"showLocateButton");Ft([O({type:Boolean})],Re.prototype,"showCopyCdnButton");Ft([I()],Re.prototype,"_filter");customElements.define("sfx-last-upload-review",Re);var Nc=Object.defineProperty,pe=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Nc(e,t,o),o};const xr=class xr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.uploadState="idle",this.fileCount=0,this.totalSize=0,this.failedCount=0,this.showFillMetadata=!1,this.requireMetadataFirst=!1,this.completedCount=0,this.uploadProgress=0,this.showCheckSimilar=!1,this.selectMode=!1,this.selectedCount=0,this.maxSelection=0,this.allSelected=!1}_clear(){this.dispatchEvent(new CustomEvent("clear-all",{bubbles:!0,composed:!0}))}_addMore(){this.dispatchEvent(new CustomEvent("add-more",{bubbles:!0,composed:!0}))}_fillMetadata(){this.dispatchEvent(new CustomEvent("fill-metadata",{bubbles:!0,composed:!0}))}_upload(){if(this.requireMetadataFirst){this.dispatchEvent(new CustomEvent("require-metadata",{bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("upload-start",{bubbles:!0,composed:!0}))}_retryAll(){this.dispatchEvent(new CustomEvent("retry-all",{bubbles:!0,composed:!0}))}_checkSimilarEnter(){this.dispatchEvent(new CustomEvent("check-similar-enter",{bubbles:!0,composed:!0}))}_checkSimilarCancel(){this.dispatchEvent(new CustomEvent("check-similar-cancel",{bubbles:!0,composed:!0}))}_checkSimilarRun(){this.dispatchEvent(new CustomEvent("check-similar-run",{bubbles:!0,composed:!0}))}_similarSelectAll(){this.dispatchEvent(new CustomEvent("similar-select-all",{detail:{selected:!this.allSelected},bubbles:!0,composed:!0}))}render(){const e=this.uploadState==="uploading";return this.selectMode?this._renderSelectToolbar():f`
    ...
    `];let se=xr;pe([O({attribute:!1})],se.prototype,"t");pe([O({type:String})],se.prototype,"uploadState");pe([O({type:Number})],se.prototype,"fileCount");pe([O({type:Number})],se.prototype,"totalSize");pe([O({type:Number})],se.prototype,"failedCount");pe([O({type:Boolean})],se.prototype,"showFillMetadata");pe([O({type:Boolean})],se.prototype,"requireMetadataFirst");pe([O({type:Number})],se.prototype,"completedCount");pe([O({type:Number})],se.prototype,"uploadProgress");pe([O({type:Boolean})],se.prototype,"showCheckSimilar");pe([O({type:Boolean})],se.prototype,"selectMode");pe([O({type:Number})],se.prototype,"selectedCount");pe([O({type:Number})],se.prototype,"maxSelection");pe([O({type:Boolean})],se.prototype,"allSelected");const Hc='button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function cr(r,e){return t=>{if(t.key!=="Tab")return;const i=r();if(!i)return;const o=i.querySelector(e);if(!o)return;const s=Array.from(o.querySelectorAll(Hc));if(s.length===0)return;const n=s[0],a=s[s.length-1],l=i.activeElement;t.shiftKey?(l===n||!o.contains(l))&&(t.preventDefault(),a.focus()):(l===a||!o.contains(l))&&(t.preventDefault(),n.focus())}}var qc=Object.defineProperty,ni=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&qc(e,t,o),o};const vr=class vr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this._url="",this._name="",this._error="",this._onBackdropClick=e=>{e.target===e.currentTarget&&this._cancel()},this._onUrlInput=e=>{this._url=e.target.value,this._error="",this._autoName()},this._onNameInput=e=>{this._name=e.target.value},this._focusTrap=cr(()=>this.shadowRoot,".card"),this._onKeyDown=e=>{var t;e.key==="Escape"&&this._cancel(),e.key==="Enter"&&((t=e.target)==null?void 0:t.tagName)==="INPUT"&&this._submit(),this._focusTrap(e)}}_autoName(){var e;if(!this._name)try{const t=new URL(this._url).pathname.split("/"),i=t[t.length-1];if(i){const o=(e=this.shadowRoot)==null?void 0:e.querySelector("#nameInput");o&&(o.placeholder=i)}}catch{}}_cancel(){this.dispatchEvent(new CustomEvent("url-cancel",{bubbles:!0,composed:!0}))}_submit(){const e=this._url.trim();if(!e){this._error=this.t("pleaseEnterUrl","Please enter a URL");return}try{new URL(e)}catch{this._error=this.t("pleaseEnterValidUrl","Please enter a valid URL");return}this._error="";let t=this._name.trim();if(!t)try{const i=new URL(e).pathname.split("/");t=i[i.length-1]||"imported-file"}catch{t="imported-file"}this.dispatchEvent(new CustomEvent("url-submit",{detail:{url:e,name:t},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{var e,t;(t=(e=this.shadowRoot)==null?void 0:e.querySelector("#urlInput"))==null||t.focus()})}render(){return f`
  ...
  `];let be=yr;nt([O({attribute:!1})],be.prototype,"t");nt([I()],be.prototype,"_stream");nt([I()],be.prototype,"_recording");nt([I()],be.prototype,"_error");nt([I()],be.prototype,"_recordedBlob");nt([I()],be.prototype,"_previewUrl");var Yc=Object.defineProperty,dr=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Yc(e,t,o),o};const wr=class wr extends oe{constructor(){super(...arguments),this.t=(e,t)=>typeof t=="string"?t:e,this.duration=6e3,this._toasts=[],this._nextId=0}show(e,t="error"){const i=++this._nextId;this._toasts=[...this._toasts,{id:i,message:e,type:t,leaving:!1}],setTimeout(()=>this._dismiss(i),this.duration)}_dismiss(e){const t=this._toasts.findIndex(o=>o.id===e);if(t===-1)return;const i=[...this._toasts];i[t]={...i[t],leaving:!0},this._toasts=i,setTimeout(()=>{this._toasts=this._toasts.filter(o=>o.id!==e)},200)}_iconForType(e){return e==="error"?f`<svg class="toast-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
  ...
  `;let ot=wr;dr([O({attribute:!1})],ot.prototype,"t");dr([O({type:Number})],ot.prototype,"duration");dr([I()],ot.prototype,"_toasts");customElements.define("sfx-toast",ot);var Wc=Object.defineProperty,N=(r,e,t,i)=>{for(var o=void 0,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=n(e,t,o)||o);return o&&Wc(e,t,o),o};const Uo=new Set(["unsplash"]),_e=10,Gc=["auto","mobile","tablet","desktop","hq","sample"],Xc=["hls"],Ye={isTus:!1,tusUploadUrl:null,relativeFolder:""};var Y;const B=(Y=class extends oe{constructor(){super(),this.config=null,this._isOpen=!1,this._activeConnector=null,this._showUrlDialog=!1,this._showCameraDialog=!1,this._showScreenCastDialog=!1,this._similarSelectMode=!1,this._similarSelectedIds=new Set,this._similarRunIds=[],this._similarActiveIds=new Set,this._similarResults=new Map,this._previewPanelTab="details",this._similarSimTimers=[],this._simMockCounter=0,this._previewFileId=null,this._previewDims="—",this._fileInfoOpen=!0,this._splitPct=58,this._showSettings=!1,this._setResize=!0,this._setMaxW=2e3,this._setMaxH=2e3,this._setTranscode=!1,this._setResolution="auto",this._setResolutionOpen=!1,this._setProtocol="hls",this._setResumable=!1,this._isResizing=!1,this._splitRafId=0,this._previewDefaultApplied=!1,this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._fsZoom=1,this._fsPanX=0,this._fsPanY=0,this._fsDragging=!1,this._fsDragStartX=0,this._fsDragStartY=0,this._fsPanStartX=0,this._fsPanStartY=0,this._bodyDragOver=!1,this._isMinimized=!1,this._isPillExpanded=!1,this._metadataSchema=null,this._regionalFilters={},this._bulkMetadataOpen=!1,this._bulkMetadataInitialFieldKey=null,this._isReviewing=!1,this._reviewFiles=[],this._hasStoredReview=!1,this._metadataAutocomplete=null,this._taxonomyService=null,this._ultratagsService=null,this._onRegionalChange=e=>{const{groupUuid:t,value:i}=e.detail;t&&(this._regionalFilters={...this._regionalFilters,[t]:i})},this._videoBlobUrls=new Map,this._lastEta=0,this._engine=null,this._cachedSources=ft,this._cachedSourcesConfig=void 0,this._rejectedTimers=new Map,this._closeOnCompleteTimer=null,this._apiBase=null,this._authHeaders=null,this._authResolveId=0,this._prevStoreState=null,this._unsubStoreEvents=null,this._portalContainer=null,this._hostStyleObserver=null,this._onFileRename=e=>{this._onPreviewRename(e.detail.fileId,e.detail.name)},this._onPreviewMetadataBlur=e=>{const t=this._previewFileId;if(!t)return;const{key:i,value:o}=e.detail;if(Ec(i)){const a=Pc(i);if(!a)return;const l=o===""||o==null,c=a==="position"?{position:l?void 0:Number(o)}:{ref:l?void 0:String(o)};this.updateFileProduct(t,c);return}const s=this._store.getState().files.get(t);if(!s)return;const n=new Map(this._store.getState().files);n.set(t,{...s,meta:{...s.meta,[i]:o}}),this._store.setState({files:n})},this._onPreviewTaxonomyEntry=e=>{const t=this._previewFileId;t&&this.updateFileTaxonode(t,e.detail.key,e.detail.entry)},this._floatShownDispatched=!1,this._transformRemoteThumbnail=(e,t)=>{var o;const i=(o=this.config)==null?void 0:o.transformRemoteThumbnail;if(!i)return e;try{return i(e,t)||e}catch(s){return console.warn("[sfx-uploader] transformRemoteThumbnail threw:",s),e}},this._connectorThumbnailTransform=e=>{const t=this._activeConnector;return t?this._transformRemoteThumbnail(e,{source:"connector",providerId:t}):e},this._onFilesSelected=e=>{const{files:t,hadDirectories:i}=e.detail;if(t.length===0&&i){this._showEmptyFolderToast();return}this._processIncomingFiles(t)},this._onFolderEmpty=()=>{this._showEmptyFolderToast()},this._onDropTileSourceClick=e=>{e.stopPropagation(),this._handleSourceActivation(e.detail.source.id)},this._onSourceClick=async e=>{this._handleSourceActivation(e.detail.source)},this._handleSourceActivation=async e=>{var o,s;const t=this._mergedSources.find(n=>n.id===e);if(t!=null&&t.onActivate){try{t.onActivate(this)}catch(n){console.error(`[sfx-uploader] onActivate for custom source "${e}" threw:`,n)}return}if(e==="device"){const n=this.shadowRoot.querySelector("sfx-drop-zone");n==null||n.browse();return}if(e==="url"){this._showUrlDialog=!0;return}if(e==="camera"){this._showCameraDialog=!0;return}if(e==="screen-cast"){this._showScreenCastDialog=!0;return}if((((s=(o=this.config)==null?void 0:o.connectors)==null?void 0:s.providers)??[]).includes(e)){if(Uo.has(e)){if(!customElements.get("sfx-search-provider-browser")){const{SfxSearchProviderBrowser:a}=await V(async()=>{const{SfxSearchProviderBrowser:l}=await import("./search-provider-browser-DxvjrcfR.js");return{SfxSearchProviderBrowser:l}},[]);customElements.define("sfx-search-provider-browser",a)}}else if(!customElements.get("sfx-provider-browser")){const{SfxProviderBrowser:a}=await V(async()=>{const{SfxProviderBrowser:l}=await import("./provider-browser-DlTuWmql.js");return{SfxProviderBrowser:l}},[]);customElements.define("sfx-provider-browser",a)}this._activeConnector=e}},this._onUrlSubmit=e=>{var p,u,b;this._showUrlDialog=!1;const{url:t,name:i}=e.detail,o=(p=this.config)==null?void 0:p.callbacks,s=ko(i),n=s.startsWith("image/");if(bi(i))return;const a=this._store.getState();if([...a.files.values()].some(x=>x.name===i&&x.status!=="rejected"&&x.status!=="cancelled"))return;const c=yi({name:i,size:0,type:s},a.restrictions,a.files);if(c){const x={id:Ke(),status:"rejected",file:null,remoteUrl:t,name:i,size:0,type:s,previewUrl:null,duration:null,progress:0,speed:0,bytesUploaded:0,error:c,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...Ye};qe(this._store,x),this._dispatchPublic(M.FILE_REJECTED,{file:x,reason:c}),(u=o==null?void 0:o.onFileRejected)==null||u.call(o,x,c);return}const d={id:Ke(),status:"idle",file:null,remoteUrl:t,name:i,size:0,type:s,previewUrl:n?this._transformRemoteThumbnail(t,{source:"url-import"}):null,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...Ye};qe(this._store,d),this._dispatchPublic(M.FILE_ADDED,{file:d}),(b=o==null?void 0:o.onFileAdded)==null||b.call(o,d),this._store.getState().queueConfig.autoProceed&&this.upload()},this._onUrlCancel=()=>{this._showUrlDialog=!1},this._onCameraCapture=e=>{this._showCameraDialog=!1,this._processIncomingFiles([e.detail.file])},this._onCameraCancel=()=>{this._showCameraDialog=!1},this._onScreenCastCapture=e=>{this._showScreenCastDialog=!1,this._processIncomingFiles([e.detail.file])},this._onScreenCastCancel=()=>{this._showScreenCastDialog=!1},this._onFileRemove=e=>{this._removeFile(e.detail.fileId)},this._onFilePreview=e=>{var i,o,s;const t=this._store.getState().files.get(e.detail.fileId);t&&(this._previewFileId=t.id,this._showSettings=!1,this._previewPanelTab="details",this._dispatchPublic(M.FILE_PREVIEW,{file:t}),(s=(o=(i=this.config)==null?void 0:i.callbacks)==null?void 0:o.onFilePreview)==null||s.call(o,t))},this._onFillMetadata=()=>{var t,i,o,s;const e=[...this._store.getState().files.values()].filter(n=>Y._MODIFIABLE_STATUSES.has(n.status));(t=this.config)!=null&&t.metadataConfig&&this._metadataSchema&&(this._bulkMetadataInitialFieldKey=this._firstMissingRequiredFieldKey(),this._bulkMetadataOpen=!0),this._dispatchPublic(M.FILL_METADATA,{files:e}),(s=(o=(i=this.config)==null?void 0:i.callbacks)==null?void 0:o.onFillMetadata)==null||s.call(o,e)},this._onCheckSimilarEnter=()=>{this._similarSelectedIds=new Set,this._similarSelectMode=!0},this._onCheckSimilarCancel=()=>{this._similarSelectMode=!1,this._similarSelectedIds=new Set},this._onSimilarToggle=e=>{const t=e.detail.fileId,i=new Set(this._similarSelectedIds);if(i.has(t))i.delete(t);else{if(i.size>=_e)return;i.add(t)}this._similarSelectedIds=i},this._onSimilarSelectAll=e=>{this._similarSelectedIds=e.detail.selected?new Set(this._similarUncheckedFiles().slice(0,_e).map(t=>t.id)):new Set},this._onCheckSimilarRun=()=>{const e=this._similarImageFiles().filter(t=>this._similarSelectedIds.has(t.id));e.length&&(this._runSimilarityCheck(e),this._similarSelectMode=!1,this._similarSelectedIds=new Set)},this._onCheckSimilarSingle=e=>{const t=e.detail.file;t&&this._checkSimilarSingleFile(t)},this._onSimilarSearchCancel=()=>{this._clearSimilarRun()},this._onSimilarOpenResults=e=>{this._previewFileId=e.detail.fileId,this._showSettings=!1,this._previewPanelTab="similar"},this._onRequireMetadata=()=>{const e=this._storeCtrl.state.t;this._showToast(e("fillRequiredFieldsFirst","Please fill required fields first."),"warning"),this._onFillMetadata()},this._onFileLocate=e=>{this._locateFile(e.detail.file)},this._onFileCopyCdn=e=>{var o,s,n;const t=e.detail.file,i=e.detail.cdnUrl;!t||!i||(this._dispatchPublic(M.FILE_COPY_CDN,{file:t,cdnUrl:i}),(n=(s=(o=this.config)==null?void 0:o.callbacks)==null?void 0:s.onFileCopyCdn)==null||n.call(s,t,i))},this._onBulkMetadataSaveBatch=e=>{const{changes:t}=e.detail;if(!t.length)return;const i=new Map(this._store.getState().files);for(const{fileId:o,meta:s}of t){const n=i.get(o);n&&i.set(o,{...n,meta:{...n.meta,...s}})}this._store.setState({files:i})},this._onBulkProductSaveBatch=e=>{const{changes:t}=e.detail;t.length&&this.updateFilesProduct(t)},this._onBulkTaxonomySaveBatch=e=>{const{changes:t}=e.detail;if(!t.length)return;const i=this._store.getState().files,o=new Map(i);for(const{fileId:s,taxonodes:n}of t){const a=i.get(s);if(!a||!Y._MODIFIABLE_STATUSES.has(a.status))continue;const l={...a.taxonodes??{}};for(const[c,d]of Object.entries(n))d==null?delete l[c]:l[c]=d;o.set(s,{...a,taxonodes:l})}this._store.setState({files:o})},this._onBulkMetadataClose=()=>{this._bulkMetadataOpen=!1,this._bulkMetadataInitialFieldKey=null},this._onFileRetry=e=>{var t;this._ensureEngine(),(t=this._engine)==null||t.retryFile(e.detail.fileId)},this._onFilePause=e=>{var t;(t=this._engine)==null||t.pauseFile(e.detail.fileId)},this._onFileResume=e=>{var t;(t=this._engine)==null||t.resumeFile(e.detail.fileId)},this._onRetryAll=()=>{var e;this._ensureEngine(),(e=this._engine)==null||e.retryAll()},this._onClearAll=()=>{var i,o,s;const e=(i=this.config)==null?void 0:i.callbacks;this._clearSimilarRun(),this._similarResults=new Map,this._previewPanelTab="details",this._similarSelectMode=!1,this._similarSelectedIds=new Set,this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),(o=this._engine)==null||o.cancelAll();const t=[...this._store.getState().files.values()];for(const n of t)n.previewUrl&&URL.revokeObjectURL(n.previewUrl),this._dispatchPublic(M.FILE_REMOVED,{file:n}),(s=e==null?void 0:e.onFileRemoved)==null||s.call(e,n);this._revokeVideoBlobUrls();for(const n of this._rejectedTimers.values())clearTimeout(n);this._rejectedTimers.clear(),this._dimCache.clear(),this._previewFileId=null,this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._lastEta=0,this._store.setState({files:new Map,isUploading:!1,totalProgress:0,totalSpeed:0,totalBytesUploaded:0,totalBytes:0})},this._onAddMore=()=>{var o;const e=this.shadowRoot.querySelector("sfx-drop-zone");if(e){e.browse();return}const t=this.shadowRoot.querySelector("sfx-file-list"),i=(o=t==null?void 0:t.shadowRoot)==null?void 0:o.querySelector('input[type="file"]');i==null||i.click()},this._onUploadStart=()=>{var e;if(this._phase==="complete"){((e=this.config)==null?void 0:e.clearOnComplete)!==!1&&this._onClearAll();return}this._hasUnfilledRequiredMetadata||this.upload()},this._onUploadMore=()=>{this._onClearAll()},this._onEnterReview=()=>{const e=[...this._store.getState().files.values()].filter(o=>o.status==="complete"||o.status==="failed"||o.status==="error");if(e.length>0){this._reviewFiles=e,this._isReviewing=!0;return}const t=this._lastUploadId;if(t==null)return;const i=ct.load(t);!i||i.length===0||(this._reviewFiles=i,this._isReviewing=!0)},this._onExitReview=()=>{this._isReviewing=!1,this._reviewFiles=[]},this._onClearReview=()=>{const e=this._lastUploadId;e!=null&&ct.clear(e),this._isReviewing=!1,this._reviewFiles=[],this._hasStoredReview=!1},this._onConnectorFilesSelected=e=>{var o,s,n,a;const t=(o=this.config)==null?void 0:o.callbacks,i=((s=this.config)==null?void 0:s.preserveFolderStructure)!==!1;for(const l of e.detail.files){if(bi(l.name))continue;const c=i?l.relativeFolder??"":"",d=this._store.getState();if([...d.files.values()].some(_=>_.name===l.name&&_.size===l.size&&_.relativeFolder===c&&_.status!=="rejected"&&_.status!=="cancelled"))continue;const u=l.thumbnail?this._transformRemoteThumbnail(l.thumbnail,{source:"connector",providerId:l.provider}):null,b=yi({name:l.name,size:l.size,type:l.mimeType},d.restrictions,d.files);if(b){const _={id:Ke(),status:"rejected",file:null,remoteUrl:null,name:l.name,size:l.size,type:l.mimeType,previewUrl:u,duration:null,progress:0,speed:0,bytesUploaded:0,error:b,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:l,...Ye,relativeFolder:c};qe(this._store,_),this._dispatchPublic(M.FILE_REJECTED,{file:_,reason:b}),(n=t==null?void 0:t.onFileRejected)==null||n.call(t,_,b);continue}const x={id:Ke(),status:"idle",file:null,remoteUrl:null,name:l.name,size:l.size,type:l.mimeType,previewUrl:u,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:l,...Ye,relativeFolder:c};qe(this._store,x),this._dispatchPublic(M.FILE_ADDED,{file:x}),(a=t==null?void 0:t.onFileAdded)==null||a.call(t,x)}this._activeConnector=null,this._store.getState().queueConfig.autoProceed&&this.upload()},this._onConnectorClose=()=>{this._activeConnector=null},this._onConnectorBackdropClick=e=>{e.target===e.currentTarget&&(this._activeConnector=null)},this._onPrimaryAction=()=>{var t,i,o,s,n;this._dispatchPublic(M.COMPLETE_ACTION,{}),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCompleteAction)==null||o.call(i),(((s=this.config)==null?void 0:s.mode)??"modal")==="modal"?this.close():((n=this.config)==null?void 0:n.clearOnComplete)!==!1&&this._onClearAll()},this._onInlineDismiss=()=>{var e,t,i;(i=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onCancel)==null||i.call(t),this._dispatchPublic(M.CANCEL,{})},this._onSuccessCardClose=()=>{var e,t,i,o;((e=this.config)==null?void 0:e.mode)==="inline"?(this._dispatchPublic(M.COMPLETE_ACTION,{}),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCompleteAction)==null||o.call(i),this._onClearAll()):this._onModalDismiss()},this._onModalDismiss=()=>{var e,t,i,o;this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll()),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{}),this.close()},this._onCancelUpload=()=>{var e,t,i,o;(e=this._engine)==null||e.cancelAll(),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{}),this._onClearAll()},this._onMinimize=()=>{var e,t,i;this._isMinimized||(this._isMinimized=!0,this._isPillExpanded=!0,(i=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onMinimize)==null||i.call(t),this._dispatchFloatGeometryEvent(M.MINIMIZE),this.requestUpdate())},this._onPillClick=()=>{this._isPillExpanded=!this._isPillExpanded,this.requestUpdate()},this._onPillExpand=()=>{var e,t,i;this._isMinimized&&(this._isMinimized=!1,this._isPillExpanded=!1,this._isOpen=!0,(i=(t=(e=this.config)==null?void 0:e.callbacks)==null?void 0:t.onRestore)==null||i.call(t),this._dispatchPublic(M.RESTORE,{mode:"modal"}),this.requestUpdate())},this._onPillDismiss=()=>{var e,t,i,o;this._isMinimized=!1,this._isPillExpanded=!1,this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll(),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{})),this.close()},this._onModalBackdropClick=e=>{e.target===e.currentTarget&&this._onModalDismiss()},this._bodyLeaveTimer=null,this._onBodyDragEnter=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!0},this._onBodyDragOver=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!0},this._onBodyDragLeave=e=>{e.preventDefault(),this._bodyLeaveTimer&&clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=setTimeout(()=>{this._bodyDragOver=!1,this._bodyLeaveTimer=null},80)},this._onBodyDrop=e=>{e.preventDefault(),this._bodyLeaveTimer&&(clearTimeout(this._bodyLeaveTimer),this._bodyLeaveTimer=null),this._bodyDragOver=!1;const t=e.dataTransfer;t&&ys(t).then(({files:i,hadDirectories:o})=>{if(i.length===0){o&&this._showEmptyFolderToast();return}this._onFilesSelected(new CustomEvent("files-selected",{detail:{files:i,hadDirectories:o}}))})},this._onKeyDown=e=>{var t,i;if(e.key==="Escape"){if(this._fullscreenPreviewUrl||this._fullscreenVideoFile){this._onFsClose();return}if(this._bulkMetadataOpen||this._isMinimized)return;const o=((t=this.config)==null?void 0:t.mode)??"modal",s=((i=this.config)==null?void 0:i.header)??(o==="modal"?"close":!0);(s==="close"||s==="back")&&(o==="modal"&&this._isOpen?this._onModalDismiss():o==="inline"&&this._onInlineDismiss())}},this._dimCache=new Map,this._onSplitPointerDown=e=>{var i;e.preventDefault(),this._isResizing=!0;const t=(i=this.shadowRoot)==null?void 0:i.querySelector(".preview-layout");t==null||t.classList.add("resizing"),e.target.setPointerCapture(e.pointerId)},this._onSplitPointerMove=e=>{if(!this._isResizing||this._splitRafId)return;const t=e.clientX;this._splitRafId=requestAnimationFrame(()=>{var n;this._splitRafId=0;const i=(n=this.shadowRoot)==null?void 0:n.querySelector(".preview-layout");if(!i)return;const o=i.getBoundingClientRect(),s=(t-o.left)/o.width*100;this._splitPct=Math.max(25,Math.min(75,s))})},this._onSplitPointerUp=()=>{var t;this._isResizing=!1,this._splitRafId&&(cancelAnimationFrame(this._splitRafId),this._splitRafId=0);const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".preview-layout");e==null||e.classList.remove("resizing")},this._onFsToggleZoom=e=>{e==null||e.stopPropagation();const t=Y._FS_ZOOM_LEVELS,i=t.indexOf(this._fsZoom),o=i===-1?1:(i+1)%t.length;this._fsZoom=t[o],this._fsZoom===1&&(this._fsPanX=0,this._fsPanY=0)},this._onFsOverlayClick=e=>{this._fsDragDidMove||this._onFsToggleZoom(e)},this._fsDragDidMove=!1,this._onFsPanStart=e=>{this._fsZoom<=1||(this._fsDragging=!0,this._fsDragDidMove=!1,this._fsDragStartX=e.clientX,this._fsDragStartY=e.clientY,this._fsPanStartX=this._fsPanX,this._fsPanStartY=this._fsPanY,e.preventDefault())},this._onFsPanMove=e=>{if(!this._fsDragging)return;const t=e.clientX-this._fsDragStartX,i=e.clientY-this._fsDragStartY;(Math.abs(t)>3||Math.abs(i)>3)&&(this._fsDragDidMove=!0),this._fsPanX=this._fsPanStartX+t,this._fsPanY=this._fsPanStartY+i,this.requestUpdate()},this._onFsPanEnd=()=>{this._fsDragging=!1,requestAnimationFrame(()=>{this._fsDragDidMove=!1})},this._onFsTouchStart=e=>{if(this._fsZoom<=1||e.touches.length!==1)return;const t=e.touches[0];this._fsDragging=!0,this._fsDragDidMove=!1,this._fsDragStartX=t.clientX,this._fsDragStartY=t.clientY,this._fsPanStartX=this._fsPanX,this._fsPanStartY=this._fsPanY},this._onFsTouchMove=e=>{if(!this._fsDragging||e.touches.length!==1)return;const t=e.touches[0],i=t.clientX-this._fsDragStartX,o=t.clientY-this._fsDragStartY;(Math.abs(i)>3||Math.abs(o)>3)&&(this._fsDragDidMove=!0),this._fsPanX=this._fsPanStartX+i,this._fsPanY=this._fsPanStartY+o,this.requestUpdate(),e.preventDefault()},this._onFsClose=e=>{e==null||e.stopPropagation(),this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null,this._fsZoom=1,this._fsPanX=0,this._fsPanY=0},this._store=Mn(),this._storeCtrl=new Bn(this,this._store)}get _lastUploadId(){var i,o;const e=(i=this.config)==null?void 0:i.lastUploadReview;if(!e)return null;if(typeof e=="string")return e;const t=(o=this.config)==null?void 0:o.auth;return t?t.airboxPuid?`${t.container}:${t.airboxPuid}`:t.container:null}get _metadataDefaultLanguage(){var i,o;const e=(i=this._metadataSchema)==null?void 0:i.regionalVariantsGroups;if(!e)return;const t=e.find(s=>s.type===zi.LANGUAGES);return((o=t==null?void 0:t.variants.find(Boolean))==null?void 0:o.api_value)||void 0}get _effectiveRegionalFilters(){var t,i,o,s;const e=((i=(t=this.config)==null?void 0:t.metadataConfig)==null?void 0:i.language)??((o=this.config)==null?void 0:o.locale)??void 0;return{...wc((s=this._metadataSchema)==null?void 0:s.regionalVariantsGroups,e),...this._regionalFilters}}get _activeLanguage(){var o,s,n;const t=(((o=this._metadataSchema)==null?void 0:o.regionalVariantsGroups)??[]).find(a=>a.type===zi.LANGUAGES),i=this._effectiveRegionalFilters;return(t?i[t.uuid]:void 0)??((n=(s=this.config)==null?void 0:s.metadataConfig)==null?void 0:n.language)}get _effectiveMetadataConfig(){var o;const e=(o=this.config)==null?void 0:o.metadataConfig;if(!e)return null;const t={...e.regionalFilters??{},...this._effectiveRegionalFilters},i=this._activeLanguage??e.language;return{...e,regionalFilters:t,language:i}}open(){var t,i,o,s,n,a,l,c,d;const e=this._isMinimized;if(this._isMinimized&&(this._isMinimized=!1,this._isPillExpanded=!1),this._isOpen){e&&((o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onRestore)==null||o.call(i),this._dispatchPublic(M.RESTORE,{mode:"modal"}),this.requestUpdate());return}this._isOpen=!0,(a=(n=(s=this.config)==null?void 0:s.callbacks)==null?void 0:n.onOpen)==null||a.call(n),this._dispatchPublic(M.OPEN,{}),e&&((d=(c=(l=this.config)==null?void 0:l.callbacks)==null?void 0:c.onRestore)==null||d.call(c),this._dispatchPublic(M.RESTORE,{mode:"modal"})),this.requestUpdate()}close(){this._isOpen&&(this._isOpen=!1,this._runCloseCleanup())}getStatus(){return this._phase}dismissPanel(){var e,t,i,o;this._phase==="uploading"&&((e=this._engine)==null||e.cancelAll(),(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onCancel)==null||o.call(i),this._dispatchPublic(M.CANCEL,{})),this._isMinimized=!1,this._isPillExpanded=!1,this._isOpen=!1,this._runCloseCleanup()}_runCloseCleanup(){var e,t,i,o;this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null),((e=this.config)==null?void 0:e.clearOnClose)!==!1&&this._onClearAll(),this._previewFileId=null,this._bulkMetadataOpen=!1,this._bulkMetadataInitialFieldKey=null,(o=(i=(t=this.config)==null?void 0:t.callbacks)==null?void 0:i.onClose)==null||o.call(i),this._dispatchPublic(M.CLOSE,{}),this.requestUpdate()}upload(){var o,s,n,a,l,c,d,p,u,b;if(this._ensureEngine(),!this._engine){console.warn("[sfx-uploader] Cannot upload: auth not resolved yet");return}const e=[...this._store.getState().files.values()].filter(x=>x.status==="idle"||x.status==="queued");if((s=(o=this.config)==null?void 0:o.callbacks)!=null&&s.onBeforeUpload&&this.config.callbacks.onBeforeUpload(e)===!1)return;const t=new CustomEvent(M.BEFORE_UPLOAD,{bubbles:!0,composed:!0,cancelable:!0,detail:{files:e}});this.dispatchEvent(t)&&(this._dispatchPublic(M.UPLOAD_STARTED,{files:e}),(l=(a=(n=this.config)==null?void 0:n.callbacks)==null?void 0:a.onUploadStarted)==null||l.call(a,e),this._engine.uploadAll(),(c=this.config)!=null&&c.minimizeOnUpload&&((d=this.config)==null?void 0:d.mode)!=="inline"&&!this._isMinimized&&(this._isMinimized=!0,this._isPillExpanded=!0,(b=(u=(p=this.config)==null?void 0:p.callbacks)==null?void 0:u.onMinimize)==null||b.call(u),this._dispatchFloatGeometryEvent(M.MINIMIZE),this.requestUpdate()))}addFiles(e){this._processIncomingFiles(e)}resumeUpload(e){var t;if(e&&e.length>0){const i=this._store.getState().files,o=new Map(i);let s=!1;for(const n of e){const a=i.get(n.id);a&&(o.set(n.id,{...a,...n}),s=!0)}s&&this._store.setState({files:o})}this._ensureEngine(),(t=this._engine)==null||t.uploadAll()}cancelUpload(){var e;(e=this._engine)==null||e.cancelAll()}pauseFile(e){var t;(t=this._engine)==null||t.pauseFile(e)}resumeFile(e){var t;(t=this._engine)==null||t.resumeFile(e)}getFiles(){return[...this._store.getState().files.values()]}getFile(e){return this._store.getState().files.get(e)}updateFileMeta(e,t,i){const o=this._store.getState().files,s=o.get(e);if(!s||!Y._MODIFIABLE_STATUSES.has(s.status))return;const n=new Map(o);n.set(e,{...s,meta:t!=null?{...s.meta,...t}:s.meta,tags:i??s.tags}),this._store.setState({files:n})}updateFilesMeta(e){const t=this._store.getState().files,i=new Map(t);let o=!1;for(const{fileId:s,meta:n,tags:a}of e){const l=t.get(s);!l||!Y._MODIFIABLE_STATUSES.has(l.status)||(i.set(s,{...l,meta:n!=null?{...l.meta,...n}:l.meta,tags:a??l.tags}),o=!0)}o&&this._store.setState({files:i})}updateFileTaxonode(e,t,i){const o=this._store.getState().files,s=o.get(e);if(!s||!Y._MODIFIABLE_STATUSES.has(s.status))return;const n={...s.taxonodes??{}};i==null?delete n[t]:n[t]=i;const a=new Map(o);a.set(e,{...s,taxonodes:n}),this._store.setState({files:a})}updateFilesTaxonode(e,t,i){const o=this._store.getState().files,s=new Map(o);let n=!1;for(const a of e){const l=o.get(a);if(!l||!Y._MODIFIABLE_STATUSES.has(l.status))continue;const c={...l.taxonodes??{}};i==null?delete c[t]:c[t]=i,s.set(a,{...l,taxonodes:c}),n=!0}n&&this._store.setState({files:s})}updateFileProduct(e,t){const i=this._store.getState().files,o=i.get(e);if(!o||!Y._MODIFIABLE_STATUSES.has(o.status))return;const s=new Map(i);s.set(e,{...o,product:Xr(o.product,t)}),this._store.setState({files:s})}updateFilesProduct(e){const t=this._store.getState().files,i=new Map(t);let o=!1;for(const{fileId:s,product:n}of e){const a=t.get(s);!a||!Y._MODIFIABLE_STATUSES.has(a.status)||(i.set(s,{...a,product:Xr(a.product,n)}),o=!0)}o&&this._store.setState({files:i})}willUpdate(e){if(e.has("config")&&this.config){this._applyConfig(this.config);const t=this.config.uploadSettings;!(t!==!1&&(t==null||t.enabled!==!1))&&this._showSettings&&(this._showSettings=!1)}if(e.has("_previewFileId")&&this._previewFileId){const t=this._previewFileId,i=this._store.getState().files.get(t);i?this._getImageDimensions(i).then(o=>{this._previewFileId===t&&(this._previewDims=o?`${o.w} × ${o.h}`:"—")}):this._previewDims="—"}this._previewFileId?this._previewDefaultApplied||(this._splitPct=62.5,this._previewDefaultApplied=!0):this._previewDefaultApplied&&(this._previewDefaultApplied=!1)}updated(e){this._updateFloatingPortal()}_injectFloatStyles(){if(document.querySelector("style[data-sfx-upload-float-styles]"))return;const e=document.createElement("style");e.setAttribute("data-sfx-upload-float-styles",""),e.textContent=`
    ...
    `,document.head.appendChild(e)}_updateFloatingPortal(){const e=[...this._storeCtrl.state.files.values()];if(this._isMinimized&&e.length>0){this._injectFloatStyles();const t=!this._portalContainer;this._portalContainer||(this._portalContainer=document.createElement("div"),this._portalContainer.setAttribute("data-sfx-upload-float",""),document.body.appendChild(this._portalContainer)),this._syncPortalOffsetVars(),Pe(this._renderFloatingPill(e),this._portalContainer),t&&!this._floatShownDispatched&&(this._floatShownDispatched=!0,requestAnimationFrame(()=>{this._dispatchPublic(M.PANEL_SHOWN,this._measureFloatGeometry())}))}else this._portalContainer&&(Pe(S,this._portalContainer),this._portalContainer.remove(),this._portalContainer=null,this._floatShownDispatched=!1)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onKeyDown),this._prevStoreState=this._store.getState(),this._unsubStoreEvents=this._store.subscribe(()=>this._onStoreChange());const e=this._lastUploadId;this._hasStoredReview=e!=null&&ct.exists(e),this._initI18n(typeof navigator<"u"?navigator.language:void 0),typeof MutationObserver<"u"&&(this._hostStyleObserver=new MutationObserver(()=>this._syncPortalOffsetVars()),this._hostStyleObserver.observe(this,{attributes:!0,attributeFilter:["style"]}))}async _initI18n(e){try{const{i18n:t,isNew:i}=await Rn(e||"en");i&&t.on("missingKey",(s,n,a,l,c,d)=>{const p=a.match(/_(?:zero|one|two|few|many|other)$/),u=p&&(d!=null&&d[`defaultValue${p[0]}`])?String(d[`defaultValue${p[0]}`]):l;An.handleMissingKey(a,u,n)});const o=(s,n,a)=>typeof n=="string"?t.t(s,n,a??{}):t.t(s,n??{});this._store.setState({t:o})}catch{}}disconnectedCallback(){var e,t,i,o,s;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._hostStyleObserver)==null||e.disconnect(),this._hostStyleObserver=null,(t=this._unsubStoreEvents)==null||t.call(this),this._unsubStoreEvents=null,this._prevStoreState=null,(i=this._portalContainer)==null||i.remove(),this._portalContainer=null,document.querySelector("[data-sfx-upload-float]")||(o=document.querySelector("style[data-sfx-upload-float-styles]"))==null||o.remove(),this._revokeVideoBlobUrls();for(const n of this._rejectedTimers.values())clearTimeout(n);this._rejectedTimers.clear(),this._closeOnCompleteTimer&&(clearTimeout(this._closeOnCompleteTimer),this._closeOnCompleteTimer=null);for(const n of this._store.getState().files.values())n.previewUrl&&URL.revokeObjectURL(n.previewUrl);(s=this._engine)==null||s.destroy(),this._engine=null}_applyConfig(e){const t={};if(e.locale&&this._initI18n(e.locale),e.targetFolder&&(t.targetFolder=e.targetFolder),(e.restrictions||e.forceName!=null)&&(t.restrictions={...this._store.getState().restrictions,...e.restrictions},e.forceName!=null&&(t.restrictions.maxNumberOfFiles=1)),e.concurrency!=null){const s=this._store.getState().queueConfig;t.queueConfig={...s,concurrency:e.concurrency}}if(e.autoProceed!=null){const s=t.queueConfig??this._store.getState().queueConfig;t.queueConfig={...s,autoProceed:e.autoProceed}}Object.keys(t).length>0&&this._store.setState(t);const i=e.uploadSettings;if(i&&i.defaults){const s=i.defaults;s.resize!==void 0&&(this._setResize=s.resize),s.maxWidth!==void 0&&(this._setMaxW=s.maxWidth),s.maxHeight!==void 0&&(this._setMaxH=s.maxHeight),s.transcode!==void 0&&(this._setTranscode=s.transcode),s.resolution!==void 0&&(this._setResolution=s.resolution),s.protocol!==void 0&&(this._setProtocol=s.protocol),s.resumable!==void 0&&(this._setResumable=s.resumable)}const o=this._lastUploadId;this._hasStoredReview=o!=null&&ct.exists(o),this._resolveAuthAndEngine(e),(e.mode==="inline"||!e.mode)&&(this._isOpen=!0)}async _resolveAuthAndEngine(e){var o,s,n,a;const t=e.auth;if(t.mode==="sass-key"){this._apiBase=sr(t.container),this._authHeaders=Li(t),this._ensureEngine(),(s=this._engine)==null||s.updateConfig({apiBase:this._apiBase,authHeaders:this._authHeaders,tusConfig:this._normalizeTusConfig(),companionUrl:(o=e.connectors)==null?void 0:o.companionUrl,resolveUploadParams:this._buildUploadParamsResolver()}),this._preloadMetadataSchema(e);return}const i=++this._authResolveId;try{const l=await rc(t);if(i!==this._authResolveId)return;this._apiBase=l.apiBase,this._authHeaders=l.headers,this._ensureEngine(),(a=this._engine)==null||a.updateConfig({apiBase:this._apiBase,authHeaders:this._authHeaders,tusConfig:this._normalizeTusConfig(),companionUrl:(n=e.connectors)==null?void 0:n.companionUrl,resolveUploadParams:this._buildUploadParamsResolver()}),this._preloadMetadataSchema(e)}catch(l){if(i!==this._authResolveId)return;console.error("[sfx-uploader] Auth resolution failed:",l),this._showToast(this._formatAuthError(l))}}_formatAuthError(e){var i,o;const t=e instanceof Error?e.message:String(e);return(o=(i=this.config)==null?void 0:i.auth)!=null&&o.container?t.includes("HTTP 404")?`Authentication failed: container "${this.config.auth.container}" not found. Check your container name.`:t.includes("HTTP 401")||t.includes("HTTP 403")?"Authentication failed: invalid security template ID. Check your credentials in the Auth panel.":t.includes("timed out")?"Authentication failed: request timed out. Check your network connection.":t.includes("Failed to fetch")||t.includes("NetworkError")?"Authentication failed: network error. Check your internet connection.":`Authentication failed: ${t}`:"Authentication failed: no container specified. Open the Auth panel and enter your credentials."}_showToast(e,t="error"){var o;const i=(o=this.shadowRoot)==null?void 0:o.querySelector("sfx-toast");i==null||i.show(e,t)}_normalizeTusConfig(){var a,l,c,d;const e=(a=this.config)==null?void 0:a.uploadSettings,t=!!e&&e.showResumableSwitcher===!0,i=(l=this.config)==null?void 0:l.tusConfig;let o=i===!0?{}:i||void 0;if(t){if(!this._setResumable)return;o||(o={})}if(!o)return;const s=(d=(c=this.config)==null?void 0:c.connectors)==null?void 0:d.companionUrl;if(!s)return o;const n=s.replace(/\/+$/,"");return{...o,endpoint:o.endpoint??`${n}/files`,jsonBase:o.jsonBase??`${n}/json`}}get _remainingSlots(){const e=this._storeCtrl.state.restrictions.maxNumberOfFiles;if(e==null)return null;let t=0;for(const i of this._storeCtrl.state.files.values())i.status!=="rejected"&&i.status!=="cancelled"&&t++;return Math.max(0,e-t)}get _allowMulti(){var t;if(((t=this.config)==null?void 0:t.forceName)!=null)return!1;const e=this._remainingSlots;return e===null||e>1}get _allowFolderUpload(){var e;return((e=this.config)==null?void 0:e.preserveFolderStructure)===!1?!1:this._allowMulti}_buildUploadParamsResolver(){const e=this.config;if(!e)return;const{forceName:t,getUploadParams:i}=e;return o=>{const s={},n=ue(o);if(this._setResize&&(n==="image"||n==="pdf")&&this._setMaxW>0&&this._setMaxH>0&&(s.resize=`${this._setMaxW},${this._setMaxH}`),this._setTranscode&&n==="vid"&&(s.postprocess="transcode",s["video-resolution"]=this._setResolution,s.video_protocols=this._setProtocol),t!=null){const l=typeof t=="function"?t():t;l&&(s.opt_force_name=l)}const a=i==null?void 0:i(o);return a&&Object.assign(s,a),Object.keys(s).length>0?s:void 0}}_ensureEngine(){var e,t;!this._engine&&this._apiBase&&this._authHeaders&&(this._engine=new tc(this._store,{apiBase:this._apiBase,authHeaders:this._authHeaders,tusConfig:this._normalizeTusConfig(),companionUrl:(t=(e=this.config)==null?void 0:e.connectors)==null?void 0:t.companionUrl,resolveUploadParams:this._buildUploadParamsResolver(),transformPreviewUrl:i=>this._transformRemoteThumbnail(i,{source:"cdn-complete"})}),this._engine.start())}async _preloadMetadataSchema(e){const t=e.metadataConfig;if(!(!t||!this._apiBase||!this._authHeaders))try{const{fetchMetadataSchema:i,createTagsAutocomplete:o,createTaxonomyService:s,createUltratagsService:n}=await V(async()=>{const{fetchMetadataSchema:c,createTagsAutocomplete:d,createTaxonomyService:p,createUltratagsService:u}=await import("./index-Iu1eKN4G.js");return{fetchMetadataSchema:c,createTagsAutocomplete:d,createTaxonomyService:p,createUltratagsService:u}},[]),a=await i(this._apiBase,this._authHeaders,t.projectUuid,t);this._metadataAutocomplete=o(this._apiBase,this._authHeaders),this._taxonomyService=s(this._apiBase,this._authHeaders),this._ultratagsService=n(this._apiBase,this._authHeaders),this._metadataSchema=a.productsEnabled?Oc(a,this._storeCtrl.state.t):a;const l=this._metadataSchema.fields.filter(c=>Ps(c,t)).map(c=>c.key);this._dispatchPublic(M.METADATA_SCHEMA,{schema:this._metadataSchema,requiredFieldKeys:l})}catch(i){console.error("[sfx-uploader] Failed to load metadata schema:",i),this._showToast("Failed to load metadata schema","warning")}}_onPreviewRename(e,t){const i=t.trim();if(!i)return;const o=this._store.getState().files.get(e);if(!o||o.name===i)return;const s=new Map(this._store.getState().files);s.set(e,{...o,name:i}),this._store.setState({files:s})}_previewMeta(e){var t;return(t=this._metadataSchema)!=null&&t.productsEnabled?{...e.meta,[it]:e.product.ref,[rt]:e.product.position}:e.meta}get _metadataEnforcing(){var t;const e=(t=this.config)==null?void 0:t.metadataConfig;return!e||!this._metadataSchema||e.enforceRequiredBeforeUpload===!1?!1:e.enforceRequiredBeforeUpload===!0||this._metadataSchema.forceFillingOnUpload||e.requiredFields&&e.requiredFields.length>0?!0:this._metadataSchema.fields.some(i=>!!i.required)}_firstMissingRequiredFieldKey(){var e;return!this._metadataEnforcing||!this._metadataSchema?null:Ac(this._store.getState().files,this._metadataSchema,(e=this.config)==null?void 0:e.metadataConfig)}get _hasUnfilledRequiredMetadata(){return this._firstMissingRequiredFieldKey()!=null}_dispatchPublic(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}_measureFloatGeometry(){var o;const e=this._isPillExpanded?"card":"pill",t=(o=this._portalContainer)==null?void 0:o.querySelector(".upload-float");if(!t)return{width:0,height:0,mode:e};const i=t.getBoundingClientRect();return{width:i.width,height:i.height,mode:e}}_dispatchFloatGeometryEvent(e){this.updateComplete.then(()=>{requestAnimationFrame(()=>{this._dispatchPublic(e,this._measureFloatGeometry())})})}_syncPortalOffsetVars(){if(!this._portalContainer)return;const e=getComputedStyle(this),t=e.getPropertyValue("--sfx-up-float-offset-x").trim(),i=e.getPropertyValue("--sfx-up-float-offset-y").trim();t?this._portalContainer.style.setProperty("--sfx-up-float-offset-x",t):this._portalContainer.style.removeProperty("--sfx-up-float-offset-x"),i?this._portalContainer.style.setProperty("--sfx-up-float-offset-y",i):this._portalContainer.style.removeProperty("--sfx-up-float-offset-y")}_onStoreChange(){var o,s,n,a,l,c,d,p,u,b;const e=this._store.getState(),t=this._prevStoreState;if(this._prevStoreState=e,!t)return;e.isUploading&&!t.isUploading&&(this._lastEta=0);const i=(o=this.config)==null?void 0:o.callbacks;for(const[x,_]of e.files){const E=t.files.get(x);if(E){if(E.status!==_.status)switch(_.status){case"uploading":E.status==="paused"&&(this._dispatchPublic(M.UPLOAD_RESUMED,{file:_}),(s=i==null?void 0:i.onUploadResumed)==null||s.call(i,_));break;case"complete":_.response&&(this._dispatchPublic(M.UPLOAD_COMPLETE,{file:_,response:_.response}),(n=i==null?void 0:i.onUploadComplete)==null||n.call(i,_,_.response));break;case"error":case"failed":{const F=new Error(_.error??"Upload failed");this._dispatchPublic(M.UPLOAD_ERROR,{file:_,error:F}),(a=i==null?void 0:i.onUploadError)==null||a.call(i,_,F);break}case"retrying":this._dispatchPublic(M.UPLOAD_RETRY,{file:_,attempt:_.retryCount}),(l=i==null?void 0:i.onUploadRetry)==null||l.call(i,_,_.retryCount);break;case"paused":this._dispatchPublic(M.UPLOAD_PAUSED,{file:_}),(c=i==null?void 0:i.onUploadPaused)==null||c.call(i,_);break}_.status==="uploading"&&E.progress!==_.progress&&(this._dispatchPublic(M.UPLOAD_PROGRESS,{file:_,progress:_.progress,speed:_.speed}),(d=i==null?void 0:i.onUploadProgress)==null||d.call(i,_,_.progress,_.speed))}}if(e.totalProgress!==t.totalProgress||e.totalSpeed!==t.totalSpeed){const x=e.totalSpeed>0?(e.totalBytes-e.totalBytesUploaded)/e.totalSpeed:e.isUploading?this._lastEta:0;e.totalSpeed>0&&(this._lastEta=x),this._dispatchPublic(M.TOTAL_PROGRESS,{percentage:e.totalProgress,speed:e.totalSpeed,eta:x}),(p=i==null?void 0:i.onTotalProgress)==null||p.call(i,e.totalProgress,e.totalSpeed,x)}if(t.isUploading&&!e.isUploading){const x=[...e.files.values()];if(!x.some(E=>E.status==="cancelled")){const E=x.filter(y=>y.status==="complete"),F=x.filter(y=>y.status==="failed"||y.status==="error");if(E.length===0&&F.length===0)return;const k=this._lastUploadId;if(k!=null){const y=[...E,...F];ct.save(k,y),this._hasStoredReview=y.length>0}this._dispatchPublic(M.ALL_COMPLETE,{successful:E,failed:F}),(u=i==null?void 0:i.onAllComplete)==null||u.call(i,E,F);const w=(b=this.config)==null?void 0:b.closeOnComplete;if(w!==!1&&w!=null){const y=typeof w=="number"?w:1500;this._closeOnCompleteTimer=setTimeout(()=>{var m,R,U;this._closeOnCompleteTimer=null,this._phase==="complete"&&(this._dispatchPublic(M.COMPLETE_ACTION,{}),(U=(R=(m=this.config)==null?void 0:m.callbacks)==null?void 0:R.onCompleteAction)==null||U.call(R),this.close())},y)}}}}get _mergedSources(){var p;const e=(p=this.config)==null?void 0:p.connectors;if(e===this._cachedSourcesConfig)return this._cachedSources;if(this._cachedSourcesConfig=e,!e)return this._cachedSources=ft.filter(u=>u.id!=="url"),this._cachedSources;const t=e.providers.length>0?hc(e.providers):[],i=e.customSources??[],o=e.coreSources?new Set(e.coreSources):null,s=o?ft.filter(u=>o.has(u.id)):ft,n=e.companionUrl?s:s.filter(u=>u.id!=="url"),a=n.filter(u=>u.id==="device"||u.id==="url"),l=n.filter(u=>u.id!=="device"&&u.id!=="url"),c=new Set,d=[];for(const u of[...a,...t,...l,...i])if(!c.has(u.id)){if(Y._RESERVED_IDS.has(u.id)&&u.onActivate){console.warn(`[sfx-uploader] Custom source id "${u.id}" conflicts with a built-in source and was skipped.`);continue}c.add(u.id),d.push(u)}return this._cachedSources=d,this._cachedSources}get _phase(){const e=this._storeCtrl.state,t=[...e.files.values()];if(t.length===0)return"empty";if(e.isUploading)return"uploading";const i=new Set(["complete","rejected","cancelled","failed"]);return t.every(o=>i.has(o.status))&&t.some(o=>o.status==="complete"||o.status==="failed")?"complete":"ready"}_processIncomingFiles(e){var n,a,l,c,d;const t=(n=this.config)==null?void 0:n.callbacks;this._isReviewing&&(this._isReviewing=!1,this._reviewFiles=[]);const i=((a=this.config)==null?void 0:a.preserveFolderStructure)!==!1;let o=0,s=!1;for(const p of e){if(bi(p.name))continue;if(s){o++;continue}const u=i?Xl(Gl(p)):"",b=this._store.getState();if([...b.files.values()].some(w=>w.name===p.name&&w.size===p.size&&w.relativeFolder===u&&w.status!=="rejected"&&w.status!=="cancelled"))continue;const _=p.type||ko(p.name),E=yi({name:p.name,size:p.size,type:_},b.restrictions,b.files);if(E){if(fc(E)){s=!0,o++;continue}const w=_.startsWith("image/")&&!ke(_)?URL.createObjectURL(p):null,y={id:Ke(),status:"rejected",file:p,remoteUrl:null,name:p.name,size:p.size,type:_,previewUrl:w,duration:null,progress:0,speed:0,bytesUploaded:0,error:E,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...Ye,relativeFolder:u};qe(this._store,y),this._dispatchPublic(M.FILE_REJECTED,{file:y,reason:E}),(l=t==null?void 0:t.onFileRejected)==null||l.call(t,y,E);const m=(c=this.config)==null?void 0:c.rejectedFileAutoRemoveDelay,R=m===!1||m===0||m===void 0?0:m;if(R>0){const U=y.id,z=setTimeout(()=>{this._rejectedTimers.delete(U);const L=this._store.getState().files.get(U);L&&L.status==="rejected"&&Gr(this._store,U)},R);this._rejectedTimers.set(U,z)}continue}let F=null;_.startsWith("image/")&&!ke(_)&&(F=URL.createObjectURL(p));const k={id:Ke(),status:"idle",file:p,remoteUrl:null,name:p.name,size:p.size,type:_,previewUrl:F,duration:null,progress:0,speed:0,bytesUploaded:0,error:null,retryCount:0,response:null,addedAt:Date.now(),meta:{},tags:[],product:{},remoteInfo:null,...Ye,relativeFolder:u};if(qe(this._store,k),this._dispatchPublic(M.FILE_ADDED,{file:k}),(d=t==null?void 0:t.onFileAdded)==null||d.call(t,k),p.type.startsWith("video/")){uc(p).then(y=>{if(!y)return;const m=this._store.getState(),R=m.files.get(k.id);if(R){const U=new Map(m.files);U.set(k.id,{...R,previewUrl:y}),this._store.setState({files:U})}else URL.revokeObjectURL(y)});const w=document.createElement("video");w.preload="metadata",w.src=URL.createObjectURL(p),w.onerror=()=>{URL.revokeObjectURL(w.src)},w.onloadedmetadata=()=>{const y=w.duration;if(URL.revokeObjectURL(w.src),!isFinite(y))return;const m=this._store.getState(),R=m.files.get(k.id);if(R){const U=new Map(m.files);U.set(k.id,{...R,duration:y}),this._store.setState({files:U})}}}}if(o>0){const p=this._storeCtrl.state.t,u=this._store.getState().restrictions.maxNumberOfFiles??0;this._showToast(p("tooManyFilesSkipped",{count:o,max:u,defaultValue_one:"Skipped {{count}} file — limit is {{max}}",defaultValue_other:"Skipped {{count}} files — limit is {{max}}"}),"warning")}this._store.getState().queueConfig.autoProceed&&this.upload()}_showEmptyFolderToast(){const e=this._storeCtrl.state.t;this._showToast(e("emptyFolderDrop","The dropped folder is empty — no files were added"),"info")}_removeFile(e){var s,n,a,l,c;const t=this._store.getState().files.get(e);if(!t)return;const i={...t};if((this._fullscreenPreviewUrl&&this._fullscreenPreviewUrl===t.previewUrl||this._fullscreenVideoFile&&this._fullscreenVideoFile===t.file)&&(this._fullscreenPreviewUrl=null,this._fullscreenVideoFile=null),t.previewUrl&&URL.revokeObjectURL(t.previewUrl),t.file){const d=this._videoBlobUrls.get(t.file);d&&(URL.revokeObjectURL(d),this._videoBlobUrls.delete(t.file))}(t.status==="uploading"||t.status==="queued"||t.status==="retrying"||t.status==="paused")&&((s=this._engine)==null||s.cancelFile(e)),Gr(this._store,e),(n=this._engine)==null||n.recompute(),this._dimCache.delete(e);const o=this._rejectedTimers.get(e);if(o&&(clearTimeout(o),this._rejectedTimers.delete(e)),this._previewFileId===e){const d=[...this._store.getState().files.values()];this._previewFileId=d.length>0?d[0].id:null}this._purgeSimilarState(e),this._dispatchPublic(M.FILE_REMOVED,{file:i}),(c=(l=(a=this.config)==null?void 0:a.callbacks)==null?void 0:l.onFileRemoved)==null||c.call(l,i)}_similarImageFiles(){return[...this._store.getState().files.values()].filter(e=>ue(e)==="image"&&!ke(e.type))}_similarUncheckedFiles(){return this._similarImageFiles().filter(e=>!this._similarResults.has(e.id))}_checkSimilarSingleFile(e){if(this._similarActiveIds.has(e.id))return;this._similarActiveIds=new Set(this._similarActiveIds).add(e.id);const t=this._simMockCounter++,i=window.setTimeout(()=>{const o=new Set(this._similarActiveIds);o.delete(e.id),this._similarActiveIds=o;const s=new Map(this._similarResults);s.set(e.id,this._mockSimilarAssets(e,t)),this._similarResults=s},1100);this._similarSimTimers.push(i)}_runSimilarityCheck(e){if(this._clearSimilarRun(),!e.length)return;this._similarRunIds=e.map(o=>o.id);let t=0;const i=()=>{if(t>=e.length){if(!this._previewFileId){const l=e.find(c=>{var d;return(((d=this._similarResults.get(c.id))==null?void 0:d.length)??0)>0});l&&(this._previewFileId=l.id,this._showSettings=!1,this._previewPanelTab="similar")}const a=window.setTimeout(()=>this._clearSimilarRun(),1500);this._similarSimTimers.push(a);return}const o=e[t],s=o.id;this._similarActiveIds=new Set(this._similarActiveIds).add(s);const n=window.setTimeout(()=>{const a=new Set(this._similarActiveIds);a.delete(s),this._similarActiveIds=a;const l=new Map(this._similarResults);l.set(s,this._mockSimilarAssets(o,t)),this._similarResults=l,t+=1,i()},1100);this._similarSimTimers.push(n)};i()}_mockSimilarAssets(e,t){const i=[3,1,0,12,0,24,2][t%7],o=e.name.lastIndexOf("."),s=o>0?e.name.slice(0,o):e.name,n=o>0?e.name.slice(o+1).toLowerCase():"jpg";return Array.from({length:i},(a,l)=>({uuid:`${e.id}-sim-${l}`,score:Math.max(.6,.99-l*.04),url:e.previewUrl||"",name:`${s}-match-${l+1}.${n}`,size:e.size?Math.round(e.size*(.6+l%5*.1)):void 0,width:1920,height:1080}))}_clearSimilarRun(){this._similarSimTimers.forEach(e=>clearTimeout(e)),this._similarSimTimers=[],this._similarRunIds=[],this._similarActiveIds=new Set}_purgeSimilarState(e){if(this._similarRunIds.includes(e)&&(this._similarRunIds=this._similarRunIds.filter(t=>t!==e)),this._similarActiveIds.has(e)){const t=new Set(this._similarActiveIds);t.delete(e),this._similarActiveIds=t}if(this._similarResults.has(e)){const t=new Map(this._similarResults);t.delete(e),this._similarResults=t}if(this._similarSelectedIds.has(e)){const t=new Set(this._similarSelectedIds);t.delete(e),this._similarSelectedIds=t}}_openSimilarAsset(e){e&&window.open(e,"_blank","noopener,noreferrer")}_discardPreviewFile(){var s,n;const e=this._previewFileId;if(!e)return;const t=[...this._store.getState().files.values()],i=t.findIndex(a=>a.id===e),o=((s=t[i+1])==null?void 0:s.id)??((n=t[i-1])==null?void 0:n.id)??null;this._removeFile(e),this._previewFileId=o}_simAssetName(e){let t="";if(e.url){const i=e.url.split("?")[0].split("/").pop()||"";try{t=decodeURIComponent(i)}catch{t=i}}return e.name||t||e.uuid}_simAssetMeta(e){const t=this._simAssetName(e),i=t.lastIndexOf("."),o=i>0?t.slice(i+1).toUpperCase():"",s=[];return o&&o.length<=5&&s.push(o),e.size&&s.push(Se(e.size)),e.width&&e.height&&s.push(`${e.width}×${e.height}`),s.join(" · ")}_locateFile(e){var o,s,n;if(!e)return;const t=this.dispatchEvent(new CustomEvent(M.FILE_LOCATE,{bubbles:!0,composed:!0,cancelable:!0,detail:{file:e}}));if((n=(s=(o=this.config)==null?void 0:o.callbacks)==null?void 0:s.onFileLocate)==null||n.call(s,e),!t)return;const i=jn(e,this.config??void 0);i&&window.open(i,"_blank","noopener,noreferrer")}render(){var o;const e=((o=this.config)==null?void 0:o.mode)??"modal",t=[...this._storeCtrl.state.files.values()],i=this._storeCtrl.state.t;return e==="modal"?f`
      ...
      ${this._renderFsOverlay()}
    `}_renderFsOverlay(){if(!this._fullscreenPreviewUrl&&!this._fullscreenVideoFile)return S;const e=this._storeCtrl.state.t,t=[...this._store.getState().files.values()].filter(o=>o.previewUrl||o.type.startsWith("video/")&&o.file),i=t.findIndex(o=>o.id===this._previewFileId);return f`
      <div
      ...
      <div class="fs-toolbar" @click=${o=>o.stopPropagation()}>
        <button class="fs-btn" @click=${this._onFsToggleZoom} title=${this._fsZoom>=Y._FS_ZOOM_LEVELS[Y._FS_ZOOM_LEVELS.length-1]?e("resetZoom","Reset zoom"):e("zoomIn","Zoom in ({{zoom}}×)",{zoom:this._fsZoom})}>
          ${this._fsZoom>=Y._FS_ZOOM_LEVELS[Y._FS_ZOOM_LEVELS.length-1]?f`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`:f`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`}
        </button>
    ...
    `}_renderHeader(){var E,F,k,w,y,m;if(this._phase==="complete")return S;const e=this._storeCtrl.state.t,t=((E=this.config)==null?void 0:E.mode)??"modal";if(this._phase==="uploading"){const z=[...this._storeCtrl.state.files.values()].filter(G=>G.status!=="rejected"&&G.status!=="cancelled"),L=z.length,A=z.filter(G=>G.status==="complete").length;return f`
          ...
          <div class="float-header-left">
            ...
            <div>
              ...
              <div class="float-subtitle">
                ${e("nOfNComplete","{{completed}} of {{total}} complete",{completed:A,total:L})}${this._lastEta>0?` · ${e("etaLeft","~{{eta}} left",{eta:vi(this._lastEta)})}`:""}
              </div>
            </div>
          </div>
        </div>
      `}if(t==="inline"&&((F=this.config)!=null&&F.inlineHeader))return S;const i=((k=this.config)==null?void 0:k.header)??(t==="modal"?"close":!0);if(i===!1)return S;const o=t==="modal"?this._onModalDismiss:this._onInlineDismiss,s=i==="back"?f`<button
          ...
          </button>`:S,n=(w=this.config)==null?void 0:w.uploadSettings,a=n!==!1&&(n==null||n.enabled!==!1),l=[...this._storeCtrl.state.files.values()],c=l.some(R=>ue(R)==="image"&&!ke(R.type)),d=l.some(R=>ue(R)==="pdf"),p=l.some(R=>ue(R)==="vid"),b=a&&(c||d||p)?f`<button
          ...
          </button>`:S,x=(m=(y=this._metadataSchema)==null?void 0:y.regionalVariantsGroups)!=null&&m.length?f`<sfx-regional-settings
        ...
        ></sfx-regional-settings>`:S,_=i==="close"?f`<button
    ...
    `}_getImageDimensions(e){return e.previewUrl?this._dimCache.has(e.id)?Promise.resolve(this._dimCache.get(e.id)):new Promise(t=>{const i=new Image;i.onload=()=>{const o={w:i.naturalWidth,h:i.naturalHeight};this._dimCache.set(e.id,o),t(o)},i.onerror=()=>{this._dimCache.set(e.id,null),t(null)},i.src=e.previewUrl}):Promise.resolve(null)}_renderUploadOverlay(e){var d;const t=this._storeCtrl.state,i=t.t,o=Math.round(t.totalProgress??0),s=e.filter(p=>p.status!=="rejected"&&p.status!=="cancelled"),n=s.length,a=s.filter(p=>p.status==="complete").length,l=s.filter(p=>Ai(p.status)),c=[];return n>1&&c.push(i("nOfNComplete","{{completed}} of {{total}} complete",{completed:a,total:n})),this._lastEta>0&&c.push(i("etaLeft","~{{eta}} left",{eta:vi(this._lastEta)})),f`
    ...
    `}_renderOverlayFiles(e,t){return f`
      <div class="upload-overlay-files">
        ${e.map(i=>{const o=i.status==="paused",s=i.status==="uploading",n=i.status==="queued",a=Math.round(i.progress??0),l=o?t("paused","Paused"):n?t("queued","Queued"):`${a}%`;return f`
              ...
              <div class="upload-overlay-file-actions">
                ${s&&i.isTus?f`
                      <button
                        ...
                        @click=${()=>{var c;return(c=this._engine)==null?void 0:c.pauseFile(i.id)}}
                      >
                        <svg viewBox="0 0 24 24" fill="currentColor">
                          <rect x="6" y="4" width="4" height="16" rx="1" />
                          <rect x="14" y="4" width="4" height="16" rx="1" />
                ...
                ${o?f`
                      <button
                        ...
                        @click=${()=>{var c;return(c=this._engine)==null?void 0:c.resumeFile(i.id)}}
                      >
                        <svg viewBox="0 0 24 24" fill="currentColor">
                          <polygon points="5,3 19,12 5,21" />
                        </svg>
    ...
    `}_renderFloatingPill(e){const t=this._storeCtrl.state,i=t.t,o=Math.round(t.totalProgress??0),s=this._phase==="complete",n=e.filter(d=>d.status==="complete").length,a=e.filter(d=>d.status==="failed").length,l=e.filter(d=>d.status==="complete"&&d.alreadyExisted).length,c=n>0&&a===0&&l>=n;return this._isPillExpanded===!1?f`
      ...
      <div class="upload-float">
        ...
        <div class="float-items">
          ${e.map(d=>{var u,b,x;const p=d.status==="failed"||d.status==="error";return f`
              <div class="float-item">
                ...
                <div class="float-item-status">
                  ${d.status==="complete"?f`${(u=this.config)!=null&&u.showLocateButton&&((x=(b=d.response)==null?void 0:b.file)!=null&&x.uuid)?f`<button
                        ...
                        <button
                          ...
                          @click=${()=>{var _;this._ensureEngine(),(_=this._engine)==null||_.retryFile(d.id)}}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        <button
                          ...
                          @click=${()=>{var _;return(_=this._engine)==null?void 0:_.resumeFile(d.id)}}
                        >
                          <svg viewBox="0 0 24 24" fill="currentColor">
                            <polygon points="5,3 19,12 5,21" />
                          </svg>
                        ...
                        ${d.status==="uploading"&&d.isTus?f`<button
                              ...
                              @click=${()=>{var _;return(_=this._engine)==null?void 0:_.pauseFile(d.id)}}
                            >
                              <svg viewBox="0 0 24 24" fill="currentColor">
                                <rect x="6" y="4" width="4" height="16" rx="1" />
                                <rect x="14" y="4" width="4" height="16" rx="1" />
    ...
    `}_renderPreviewLayout(e){var x,_,E,F,k,w,y;if(e.length===0)return S;const t=this._storeCtrl.state.t,i=e.find(m=>m.id===this._previewFileId)??e[0],o=((x=i.name.split(".").pop())==null?void 0:x.toUpperCase())||"";new Date(i.addedAt).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),this._store.getState().targetFolder;const s=e.reduce((m,R)=>m+(R.size||0),0),n=!!((E=(_=this.config)==null?void 0:_.similarityCheck)!=null&&E.enabled),a=e.filter(m=>ue(m)==="image"&&!ke(m.type)&&!this._similarResults.has(m.id)).map(m=>m.id),l=Math.min(a.length,_e),c=l>0&&this._similarSelectedIds.size>=l,d=this._similarSelectedIds.size>=_e,p=this._similarResults.get(i.id),u=p!==void 0,b=u?this._previewPanelTab:"details";return f`
      <div class="preview-topbar"></div>
      <div class="preview-layout">
        <div class="file-grid-side" ${Q({flex:String(this._splitPct)})}>
          ${((F=this.config)==null?void 0:F.mode)==="inline"&&((k=this.config)!=null&&k.inlineHeader)?this._renderInlineHeader(this.config.inlineHeader):S}
          ...
          <sfx-file-list
            ...
            .accept=${So(this._storeCtrl.state.restrictions)}
        ...
        <div class="preview-panel" ${Q({flex:String(100-this._splitPct)})}>
          ...
          <div class="preview-panel-header">
            ...
            <div class="preview-header-actions">
              ${i.previewUrl||i.type.startsWith("video/")&&i.file?f`
                    <button
          ...
          ${u?f`
                <div class="preview-tabs" role="tablist">
                  ...
                  >
                    <span>${t("similarTab","Similar")}</span>${p&&p.length>0?f`<span class="preview-tab-count">${p.length}</span>`:S}
                  </button>
                  <button
              ...
              `:S}
          ${b==="similar"?this._renderSimilarPanel(i,p??[]):f`
          ${i.type.startsWith("video/")&&i.file?f`
              ...
              `:f`
                <div class="preview-media-area">
                  <div class="preview-doc-wrap ${ue(i)}">
                    <img
                      class="preview-doc-type-img"
                      src=${Ss(o)}
                      alt="${o?`${o} file`:"File"}"
                      @error=${m=>{const R=m.target,U=$s();!R.dataset.fallback&&R.src!==U&&(R.dataset.fallback="1",R.src=U)}}
                    />
                  </div>
                  <button
                    class="preview-nav prev"
          ...
          ${this._metadataSchema&&((w=this.config)!=null&&w.metadataConfig)?f`<div class="preview-meta-list">
                <div class="preview-file-info">
                  ${o}${i.size?` · ${Se(i.size)}`:""}${this._previewDims!=="—"?` · ${this._previewDims}`:""}
                </div>
              </div>`:S}
          ${this._metadataSchema&&((y=this.config)!=null&&y.metadataConfig)?f`
                <div
    ...
    `}_renderSettingsPanel(){var p;const e=this._storeCtrl.state.t,t=[...this._storeCtrl.state.files.values()],i=t.some(u=>ue(u)==="image"&&!ke(u.type)),o=t.some(u=>ue(u)==="pdf"),s=t.some(u=>ue(u)==="vid"),n=(p=this.config)==null?void 0:p.uploadSettings,a=!!n&&n.showResumableSwitcher===!0,l=u=>{switch(u){case"auto":return e("resolutionAuto","Auto");case"mobile":return e("resolutionMobile","Mobile");case"tablet":return e("resolutionTablet","Tablet");case"desktop":return e("resolutionDesktop","Desktop");case"hq":return e("resolutionHq","HQ");case"sample":return e("resolutionSample","Sample")}},c=u=>{switch(u){case"hls":return e("protocolHls","HLS")}},d=u=>b=>{const x=parseInt(b.target.value,10);u(Number.isFinite(x)?x:0)};return f`
    ...
    `}_navigatePreview(e,t){var s;const o=e.findIndex(n=>n.id===this._previewFileId)+t;if(o>=0&&o<e.length){const n=(s=this.shadowRoot)==null?void 0:s.querySelector(".preview-image[controls]");n&&(n.pause(),n.removeAttribute("src"),n.load()),this._previewFileId=e[o].id}}_renderBody(){var b,x,_,E,F,k,w,y,m,R,U,z,L;const e=this._storeCtrl.state,t=e.t,i=[...e.files.values()],o=i.filter(A=>A.status==="idle"||A.status==="queued"||A.status==="error"||A.status==="failed"),s=this._phase,n=So(e.restrictions),a=i.length>0,l=!!((x=(b=this.config)==null?void 0:b.similarityCheck)!=null&&x.enabled),c=i.filter(A=>ue(A)==="image"&&!ke(A.type)&&!this._similarResults.has(A.id)).map(A=>A.id),d=Math.min(c.length,_e),p=d>0&&this._similarSelectedIds.size>=d,u=this._similarSelectedIds.size>=_e;return f`
      <div
        class="content"
      ...
      >
        ...
        >
          ${((_=this.config)==null?void 0:_.mode)==="inline"&&((E=this.config)!=null&&E.inlineHeader)&&!this._previewFileId&&s!=="uploading"&&s!=="complete"&&!this._isReviewing?this._renderInlineHeader(this.config.inlineHeader):S}
          ${this._isReviewing?f`
              ...
              `:s==="complete"?f`
                <sfx-success-card
                  ...
                  .fileCount=${i.filter(A=>A.status==="complete").length}
                  .totalSize=${i.filter(A=>A.status==="complete"&&!A.alreadyExisted).reduce((A,G)=>A+(G.size||0),0)}
                  .thumbnails=${i.filter(A=>A.status==="complete"&&A.previewUrl).map(A=>A.previewUrl)}
                  .failedFiles=${i.filter(A=>A.status==="failed").map(A=>({id:A.id,name:A.name,error:A.error||"Upload failed"}))}
                  .alreadyExistedCount=${i.filter(A=>A.status==="complete"&&A.alreadyExisted).length}
                  .showMinimize=${!!((w=this.config)!=null&&w.minimizeOnUpload)&&((y=this.config)==null?void 0:y.mode)!=="inline"}
              ...
              `:s==="uploading"?this._renderUploadOverlay(i):f`
                ${a?S:f`<sfx-drop-zone
                        ...
                        .accept=${n}
                        .sources=${this._mergedSources}
                        .sourcesLayout=${((m=this.config)==null?void 0:m.sourcesLayout)??"pills"}
        ...
        ${a&&s!=="complete"&&s!=="uploading"?f`
              <sfx-actions-bar
                ...
                .uploadState=${"idle"}
                .fileCount=${o.length}
                .totalSize=${o.reduce((A,G)=>A+(G.size||0),0)}
                .failedCount=${i.filter(A=>A.status==="failed"||A.status==="error").length}
                .completedCount=${i.filter(A=>A.status==="complete").length}
        ...
        ${this._activeConnector&&((L=this.config)!=null&&L.connectors)?f`
              <div
                class="connector-modal-backdrop"
                @click=${this._onConnectorBackdropClick}
              >
                <div class="connector-modal">
                  ${Uo.has(this._activeConnector)?f`
        ...
        ${this._bulkMetadataOpen&&this._metadataSchema?f`
              <sfx-bulk-metadata-modal
                .schema=${this._metadataSchema}
                .files=${[...this._store.getState().files.values()].filter(A=>Y._MODIFIABLE_STATUSES.has(A.status))}
                .config=${this._effectiveMetadataConfig}
                .autocomplete=${this._metadataAutocomplete}
                .taxonomyService=${this._taxonomyService}
                .ultratags=${this._ultratagsService}
  ...
  `,Y._FS_ZOOM_LEVELS=[1,2,3,4],Y._MODIFIABLE_STATUSES=new Set(["idle","queued","rejected"]),Y._RESERVED_IDS=new Set(["device","camera","url","screen-cast"]),Y);N([O({attribute:!1})],B.prototype,"config");N([I()],B.prototype,"_isOpen");N([I()],B.prototype,"_activeConnector");N([I()],B.prototype,"_showUrlDialog");N([I()],B.prototype,"_showCameraDialog");N([I()],B.prototype,"_showScreenCastDialog");N([I()],B.prototype,"_similarSelectMode");N([I()],B.prototype,"_similarSelectedIds");N([I()],B.prototype,"_similarRunIds");N([I()],B.prototype,"_similarActiveIds");N([I()],B.prototype,"_similarResults");N([I()],B.prototype,"_previewPanelTab");N([I()],B.prototype,"_previewFileId");N([I()],B.prototype,"_previewDims");N([I()],B.prototype,"_fileInfoOpen");N([I()],B.prototype,"_splitPct");N([I()],B.prototype,"_showSettings");N([I()],B.prototype,"_setResize");N([I()],B.prototype,"_setMaxW");N([I()],B.prototype,"_setMaxH");N([I()],B.prototype,"_setTranscode");N([I()],B.prototype,"_setResolution");N([I()],B.prototype,"_setResolutionOpen");N([I()],B.prototype,"_setProtocol");N([I()],B.prototype,"_setResumable");N([I()],B.prototype,"_fullscreenPreviewUrl");N([I()],B.prototype,"_fullscreenVideoFile");N([I()],B.prototype,"_fsZoom");N([I()],B.prototype,"_bodyDragOver");N([I()],B.prototype,"_isMinimized");N([I()],B.prototype,"_isPillExpanded");N([I()],B.prototype,"_metadataSchema");N([I()],B.prototype,"_regionalFilters");N([I()],B.prototype,"_bulkMetadataOpen");N([I()],B.prototype,"_bulkMetadataInitialFieldKey");N([I()],B.prototype,"_isReviewing");N([I()],B.prototype,"_reviewFiles");N([I()],B.prototype,"_hasStoredReview");let Jc=B;const ge=(r,e)=>{typeof customElements<"u"&&!customElements.get(r)&&customElements.define(r,e)};ge("sfx-uploader",Jc);ge("sfx-drop-zone",Ic);ge("sfx-import-divider",Mi);ge("sfx-source-pills",Ut);ge("sfx-file-list",K);ge("sfx-file-item",J);ge("sfx-success-card",fe);ge("sfx-actions-bar",se);ge("sfx-url-dialog",He);ge("sfx-camera-dialog",Oe);ge("sfx-screen-cast-dialog",be);const Zc=[{pattern:"/",load:()=>V(()=>import("./landing-Bm8985x0.js"),[]).then(r=>r.default)},{pattern:"/docs/getting-started",load:()=>V(()=>import("./getting-started-BEsDf8Jc.js"),__vite__mapDeps([0,1])).then(r=>r.default)},{pattern:"/docs/configuration",load:()=>V(()=>import("./configuration-JAe1IJge.js"),__vite__mapDeps([2,1])).then(r=>r.default)},{pattern:"/docs/api",load:()=>V(()=>import("./api-C69HtrIu.js"),__vite__mapDeps([3,1])).then(r=>r.default)},{pattern:"/docs/theming",load:()=>V(()=>import("./theming-D5E2zXLD.js"),__vite__mapDeps([4,1])).then(r=>r.default)},{pattern:"/docs/types",load:()=>V(()=>import("./types-BP9Z4Qnu.js"),__vite__mapDeps([5,1])).then(r=>r.default)},{pattern:"/examples/basic",load:()=>V(()=>import("./basic-9VH_V7UN.js"),__vite__mapDeps([6,7])).then(r=>r.default)},{pattern:"/examples/auto-upload",load:()=>V(()=>import("./auto-upload-BQTllLxZ.js"),__vite__mapDeps([8,7])).then(r=>r.default)},{pattern:"/examples/restrictions",load:()=>V(()=>import("./restrictions-BV2C7rbT.js"),__vite__mapDeps([9,7,10])).then(r=>r.default)},{pattern:"/examples/target-folder",load:()=>V(()=>import("./target-folder-Bv3qwP6x.js"),__vite__mapDeps([11,7])).then(r=>r.default)},{pattern:"/examples/concurrency",load:()=>V(()=>import("./concurrency-DXPUa_a4.js"),__vite__mapDeps([12,7,10])).then(r=>r.default)},{pattern:"/examples/events",load:()=>V(()=>import("./events-BSubiJrG.js"),__vite__mapDeps([13,7])).then(r=>r.default)},{pattern:"/examples/modal",load:()=>V(()=>import("./modal-D5dtgB5U.js"),__vite__mapDeps([14,7])).then(r=>r.default)},{pattern:"/examples/inline",load:()=>V(()=>import("./inline-TniNusrC.js"),__vite__mapDeps([15,7])).then(r=>r.default)},{pattern:"/examples/sources-layout",load:()=>V(()=>import("./sources-layout-CouHEGvt.js"),__vite__mapDeps([16,7])).then(r=>r.default)},{pattern:"/examples/core-sources",load:()=>V(()=>import("./core-sources-BDFhN8aT.js"),__vite__mapDeps([17,7])).then(r=>r.default)},{pattern:"/examples/header-button",load:()=>V(()=>import("./header-button-BbjpMnaf.js"),__vite__mapDeps([18,7])).then(r=>r.default)},{pattern:"/examples/minimize-to-background",load:()=>V(()=>import("./minimize-to-background-PvdXbWRV.js"),__vite__mapDeps([19,7])).then(r=>r.default)},{pattern:"/examples/resumable-upload",load:()=>V(()=>import("./resumable-upload-D7GmU0K9.js"),__vite__mapDeps([20,7,10])).then(r=>r.default)},{pattern:"/examples/react-wrapper",load:()=>V(()=>import("./react-wrapper-DqFoKQCy.js"),__vite__mapDeps([21,1])).then(r=>r.default)},{pattern:"/examples/metadata",load:()=>V(()=>import("./metadata-DmJcQo04.js"),__vite__mapDeps([22,7])).then(r=>r.default)},{pattern:"/examples/full-screen",load:()=>V(()=>import("./full-screen-C05vHtiU.js"),[]).then(r=>r.default)},{pattern:"/examples/last-upload-review",load:()=>V(()=>import("./last-upload-review-B0ab0eJV.js"),[]).then(r=>r.default)},{pattern:"/examples/similar-check",load:()=>V(()=>import("./similar-check-KQ0w14Oa.js"),__vite__mapDeps([23,7,10])).then(r=>r.default)},{pattern:"/examples/upload-settings",load:()=>V(()=>import("./upload-settings-BT-BDqql.js"),__vite__mapDeps([24,7,10])).then(r=>r.default)}];let We=null,Ro=0;function Qc(r){const e=document.getElementById("content"),t=document.getElementById("sidebar"),i=document.getElementById("sidebar-docs"),o=document.getElementById("sidebar-examples"),s=document.querySelectorAll(".topbar-nav-link");async function n(){var k,w;const a=location.hash.slice(1)||"/",l=!a.startsWith("/");if(l&&We){(k=document.getElementById(a))==null||k.scrollIntoView({behavior:"smooth"});return}const c=l?"/":a,d=++Ro;We!=null&&We.destroy&&We.destroy();const p=Zc.find(y=>y.pattern===c);if(!p){location.hash="#/";return}const u=c.startsWith("/docs/"),b=c.startsWith("/examples/"),x=u||b,_=c==="/";t.classList.toggle("hidden",!x),document.body.classList.toggle("has-sidebar",x),document.body.classList.toggle("is-home",_),i.classList.toggle("hidden",!u),o.classList.toggle("hidden",!b),t.querySelectorAll(".sidebar-link").forEach(y=>{y.classList.toggle("active",y.getAttribute("data-route")===c)});const E=u?"docs":b?"examples":"home";s.forEach(y=>{y.classList.toggle("active",y.getAttribute("data-section")===E)}),t.classList.remove("mobile-open"),l||window.scrollTo(0,0);const F=await p.load();d===Ro&&(We=F,e.innerHTML=F.render(),F.init&&F.init(r),l&&((w=document.getElementById(a))==null||w.scrollIntoView({behavior:"smooth"})))}window.addEventListener("hashchange",n),n()}const Rs="sfx-uploader-demo-auth",Oo={container:"",securityTemplateId:""};function Os(){try{const r=localStorage.getItem(Rs);if(r)return{...Oo,...JSON.parse(r)}}catch{}return{...Oo}}function ed(r){localStorage.setItem(Rs,JSON.stringify(r))}function vd(r={}){const{container:e,securityTemplateId:t}=Os();return{auth:{mode:"security-template",container:e,securityTemplateId:t},autoProceed:!1,connectors:{companionUrl:"https://eu-on-24001.connector.filerobot.com",providers:["google-drive","dropbox","box","onedrive"]},...r}}function td(){const r=document.getElementById("auth-btn"),e=document.getElementById("auth-popover"),t=document.getElementById("auth-container"),i=document.getElementById("auth-sec-template"),o=document.getElementById("auth-save"),s=Os();t.value=s.container,i.value=s.securityTemplateId,r.addEventListener("click",n=>{n.stopPropagation(),e.classList.toggle("hidden")}),o.addEventListener("click",()=>{ed({container:t.value.trim(),securityTemplateId:i.value.trim()}),e.classList.add("hidden")}),document.addEventListener("click",n=>{!e.contains(n.target)&&!r.contains(n.target)&&e.classList.add("hidden")})}td();const id=document.getElementById("uploader");Qc(id);var Ao;(Ao=document.getElementById("sidebar-toggle"))==null||Ao.addEventListener("click",()=>{var r;(r=document.getElementById("sidebar"))==null||r.classList.toggle("mobile-open")});export{S as A,md as B,gc as C,Pc as D,Ss as E,$s as F,Se as G,xd as H,gd as I,nr as J,it as P,le as a,vd as b,f as c,nd as d,Zi as e,cd as f,hc as g,Yn as h,oe as i,Wn as j,ze as k,ad as l,Q as m,O as n,Ps as o,pd as p,Sc as q,I as r,ld as s,ud as t,fd as u,hd as v,Fe as w,ji as x,Ec as y,rt as z};
