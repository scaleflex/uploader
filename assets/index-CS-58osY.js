import{i as A,a as v,A as g,c as l,n as u,r as x,o as gt,v as xt,p as Q,q as me,t as St,w as _,u as Ct,x as ee,y as rt,P as Et,z as It,B as Tt,C as mt,D as ot,E as At,F as Ot,G as Rt}from"./index-CaKuWuAp.js";import{H as qi,I as Pi,J as Fi}from"./index-CaKuWuAp.js";function bt(a,e,t=!1){const i=(e==null?void 0:e.language)??"en",s=a.model??[],o=a.store??{},r=s.find(f=>f.applies_to==="FILES");let n=(r==null?void 0:r.groups)??[];if(Array.isArray(e==null?void 0:e.fields)){const f=new Set(e.fields);n=n.map(m=>({...m,fields:m.fields.filter(b=>f.has(b.ckey))})).filter(m=>m.fields.length>0)}n=n.map(f=>({...f,fields:f.fields.filter(m=>!m.hide)})).filter(f=>f.fields.length>0);const d=n.flatMap(f=>f.fields),c=new Map(d.map(f=>[f.key,f])),p=o.force_filling_metadata_on_upload===!0,h=o.regional_variants_groups??[];return{groups:n,fields:d,fieldsByKey:c,forceFillingOnUpload:p,regionalVariantsGroups:h,language:i,productsEnabled:t}}const Lt="https://hub.scaleflex.com/api",ne=new Map,te=new Map;async function Ti(a,e,t,i){const s=ne.get(t);if(s)return s;const o=te.get(t);if(o)return o;if(i!=null&&i.rawMetadata){const n=bt(i.rawMetadata,i,i.productsEnabled===!0);return ne.set(t,n),n}const r=Dt(e,t,i);te.set(t,r);try{const n=await r;return ne.set(t,n),n}finally{te.delete(t)}}async function Dt(a,e,t){var p,h,f,m,b;const s=`${(t==null?void 0:t.hubApiBase)??Lt}/project/${encodeURIComponent(e)}`,o=(t==null?void 0:t.hubHeaders)??a,r=await fetch(s,{headers:o});if(!r.ok)throw new Error(`Failed to fetch metadata schema (HTTP ${r.status})`);const n=await r.json(),d=((h=(p=n.data)==null?void 0:p.project)==null?void 0:h.data)??((f=n.project)==null?void 0:f.data);if(!(d!=null&&d.metadata))throw new Error("No metadata in project response");const c=(t==null?void 0:t.productsEnabled)??((b=(m=d==null?void 0:d.airstore)==null?void 0:m.ui)==null?void 0:b.products_enabled)===!0;return bt(d.metadata,t,c)}function Ai(a){var e;a?(ne.delete(a),(e=te.get(a))==null||e.catch(()=>{}),te.delete(a)):(ne.clear(),te.clear())}const zt=300,nt=2,qt=50,at="regvar:api",Pt="#ut",Ft={CREATE_ONLY:"create_only",UPSERT:"upsert"},Kt=a=>typeof a=="string"&&a.startsWith(Pt),fe=a=>`~${a.toUpperCase()}`,Bt=(a,e)=>{if(!(!a||!e))return a[e]??a[fe(e)]},ge=(a,e,t)=>{var r,n,d;const i=(r=a.i18n)==null?void 0:r[e];if(i)return{value:i,isFallback:!1,sourceLang:e};const s=(n=a.i18n)==null?void 0:n[fe(e)];if(s)return{value:s,isFallback:!0,sourceLang:fe(e)};const o=Bt(a.i18n,t);if(o){const c=(d=a.i18n)!=null&&d[t]?t:fe(t);return{value:o,isFallback:!0,sourceLang:c}}return{value:"",isFallback:!1,sourceLang:null}},lt=a=>(typeof a=="string"?a:"").toLowerCase().trim().replace(/[^\d\w]/g,"_").replace(/[\s]/g,"_").replace(/[_]{2,}/g,"_").replace(/[_]*$/g,"").replace(/^[_]*/g,""),Nt=a=>{const e={},t={};for(const i of a||[])i.sid&&(e[i.sid]=i),i.slug&&(t[i.slug]=i);return{bySid:e,bySlug:t}},xe=a=>{const e=[],t=new Map,i=o=>o.sid||o.slug||"",s=(o,r)=>{if(typeof o=="string"){if(!o||t.has(o))return;t.set(o,e.length),e.push({slug:o});return}if(!o||typeof o!="object")return;const n=o,d=i(n);if(!d)return;const c=t.get(d),p=c!==void 0?{...e[c]}:{};n.slug&&(p.slug=n.slug),n.sid&&(p.sid=n.sid),n.uuid&&(p.uuid=n.uuid);const h={...p.i18n,...n.i18n||{}};r&&n.label&&(h[r]=n.label),Object.keys(h).length>0&&(p.i18n=h),c!==void 0?e[c]=p:(t.set(d,e.length),n.slug&&n.slug!==d&&t.set(n.slug,e.length),e.push(p))};if(Array.isArray(a))for(const o of a)s(o);else if(a&&typeof a=="object"){const o=a;for(const[r,n]of Object.entries(o))if(Array.isArray(n))for(const d of n)s(d,r)}return e},pe=a=>typeof a=="string"?[a]:!a||typeof a!="object"?[]:[a.sid,a.slug,a.uuid].filter(Boolean),_e=(a,e,t)=>{if(t){const o=new Set(e.flatMap(pe));return a.filter(r=>!pe(r).some(n=>o.has(n)))}const i=new Set(a.flatMap(pe)),s=e.filter(o=>!pe(o).some(r=>i.has(r)));return[...a,...s]},jt=(a,e)=>a.map(t=>{const i=t.sid&&e.bySid[t.sid]||t.slug&&e.bySlug[t.slug]||void 0;return i?{slug:t.slug||i.slug,sid:t.sid||i.sid,uuid:t.uuid||i.uuid,i18n:{...i.i18n||{},...t.i18n||{}}}:t});function vt(a,e,t){let i=e;switch(a.regional_variants_group_uuid&&i!=null&&typeof i=="object"&&!Array.isArray(i)&&(i=i[t??"en"]),a.type){case"geopoint":return Mt(i);case"boolean":return i===!0?"true":i===!1?"false":"null";case"date":return i?new Date(i):null;case"decimal2":return i!=null?String(i):"";case"tags":return Array.isArray(i)?i.map(s=>typeof s=="string"?{value:s,label:s}:s):[];case"ultratags":return xe(e);case"multi-select":return i||[];default:return i??""}}function Ae(a,e,t,i){var o;let s;switch(a.type){case"geopoint":{const r=e;!r||r.latitude===""||r.latitude==null||r.longitude===""||r.longitude==null?s=null:s=`(${r.latitude},${r.longitude})`;break}case"boolean":e==="true"?s=!0:e==="false"?s=!1:s=null;break;case"date":{if(!e)s=null;else{const r=e instanceof Date?e:new Date(e),n=r.getFullYear(),d=String(r.getMonth()+1).padStart(2,"0"),c=String(r.getDate()).padStart(2,"0");s=`${n}-${d}-${c}`}break}case"tags":s=Array.isArray(e)?e.map(r=>(r==null?void 0:r.label)??""):[];break;case"ultratags":s=Array.isArray(e)?e.map(r=>typeof r=="string"?r:r.slug).filter(r=>!!r):[];break;case"select-one":s=e===""?null:e;break;case"numeric":{if(e===""||e==null){s=null;break}const r=Number(e);s=Number.isFinite(r)?Math.round(r):null;break}case"decimal2":{if(e===""||e==null){s=null;break}const r=Number(e);s=Number.isFinite(r)?r:null;break}default:s=e}if(a.regional_variants_group_uuid&&a.type!=="ultratags"){const r=i??"en";return{...((o=t==null?void 0:t.meta)==null?void 0:o[a.key])??{},[r]:s}}return s}function Mt(a){if(typeof a=="string"){const e=/\(([^)]+)\)/.exec(a);if(e){const t=e[1].split(",");if(t.length===2)return{latitude:t[0].trim(),longitude:t[1].trim()}}}return{latitude:"",longitude:""}}function Oi(a,e){const t=a.replace(/\/$/,"");let i=null,s=null,o=!1;return{search(r,n,d){if(i&&clearTimeout(i),s&&s.abort(),o=!1,!n.trim()){d([]);return}i=setTimeout(async()=>{var c;s=new AbortController;try{const p=`${t}/v5/metadata/autocomplete?q=${encodeURIComponent(n.trim())}&meta_key=_${encodeURIComponent(r)}&limit=20`,h=await fetch(p,{headers:e,signal:s.signal});if(o)return;if(!h.ok){d([]);return}const f=await h.json();if(o)return;const m=((c=f.data)==null?void 0:c.tags)??f.tags??[];d(m.map(b=>({sid:b.sid||void 0,value:b.tag||b.value||b.label||"",label:b.tag||b.label||b.value||""})))}catch{o||d([])}},200)},cancel(){o=!0,i&&clearTimeout(i),s&&s.abort()}}}const dt={base_node:null,nodes:[]};function Ri(a,e){const t=a.replace(/\/$/,"");let i=null,s=null,o=!1,r=null,n=null;return{fetchTaxonomies(){return n||(n=(async()=>{var c;const d=`${t}/v5/taxonomies`;try{const p=await fetch(d,{headers:e});if(!p.ok)return console.warn(`[sfx-uploader] /v5/taxonomies returned ${p.status}`),[];const h=await p.json(),f=(h==null?void 0:h.taxonomies)??((c=h==null?void 0:h.data)==null?void 0:c.taxonomies)??(h==null?void 0:h.data)??h;return Array.isArray(f)?f:(console.warn("[sfx-uploader] /v5/taxonomies returned unexpected shape",h),[])}catch(p){return console.warn("[sfx-uploader] /v5/taxonomies request failed",p),[]}})(),n.then(d=>{d.length===0&&(n=null)},()=>{n=null}),n)},async fetchNodes(d,c="",p=10){r&&r.abort(),r=new AbortController;try{const h=new URLSearchParams;c&&h.set("base",c),h.set("limit",String(p));const f=`${t}/v5/taxonomy/${encodeURIComponent(d)}/nodes?${h.toString()}`,m=await fetch(f,{headers:e,signal:r.signal});if(!m.ok)return dt;const b=await m.json(),N=(b==null?void 0:b.data)??b;return{base_node:(N==null?void 0:N.base_node)??null,nodes:Array.isArray(N==null?void 0:N.nodes)?N.nodes:[]}}catch{return dt}},autocomplete(d,c,p){if(i&&clearTimeout(i),s&&s.abort(),o=!1,!c.trim()){p([]);return}i=setTimeout(async()=>{var h;s=new AbortController;try{const f=`${t}/v5/metadata/autocomplete?q=${encodeURIComponent(c.trim())}&meta_key=_${encodeURIComponent(d)}`,m=await fetch(f,{headers:e,signal:s.signal});if(o)return;if(!m.ok){p([]);return}const b=await m.json();if(o)return;const N=((h=b==null?void 0:b.data)==null?void 0:h.tags)??(b==null?void 0:b.tags)??[];p(N.map(G=>({tag:String(G.tag??G.path??""),path:String(G.path??G.tag??""),suid:String(G.suid??""),uuid:String(G.uuid??""),approx_count:typeof G.approx_count=="number"?G.approx_count:void 0})))}catch{o||p([])}},200)},cancel(){o=!0,i&&clearTimeout(i),s&&s.abort(),r&&r.abort()}}}const Oe="/v5/meta/ultratags",Ut=(a,e)=>{const t=new URLSearchParams;e.meta&&t.set("meta",e.meta),e.q&&t.set("q",e.q),e.sort&&t.set("sort",e.sort),typeof e.limit=="number"&&t.set("limit",String(e.limit)),e.after&&t.set("after",e.after),e.format&&t.set("format",e.format),e.lang&&t.set("lang",e.lang);const i=t.toString();return`${a}${Oe}${i?`?${i}`:""}`},Vt=(a,e)=>{const t=new URLSearchParams;e.format&&t.set("format",e.format),e.lang&&t.set("lang",e.lang);const i=t.toString();return`${a}${Oe}${i?`?${i}`:""}`};function Li(a,e){let t=null,i=null;const s=()=>{t&&(clearTimeout(t),t=null),i&&(i.abort(),i=null)};return{list(o){return s(),new Promise((r,n)=>{t=setTimeout(async()=>{t=null,i=new AbortController;try{const d=Ut(a,o),c=await fetch(d,{method:"GET",headers:e,signal:i.signal});if(!c.ok){n(new Error(`ultratags list failed: HTTP ${c.status}`));return}const p=await c.json();r(p)}catch(d){n(d)}},zt)})},async getBySids(o){if(!o.sids||o.sids.length===0)return{items:[],stats:{count:0,total_count:0}};const r=Vt(a,o),n=await fetch(r,{method:"QUERY",headers:{...e,"Content-Type":"application/json"},body:JSON.stringify({ultratags_sids:o.sids})});if(!n.ok)throw new Error(`ultratags getBySids failed: HTTP ${n.status}`);return await n.json()},async create(o){const r=`${a}${Oe}`,n=await fetch(r,{method:"POST",headers:{...e,"Content-Type":"application/json"},body:JSON.stringify(o)});if(!n.ok)throw new Error(`ultratags create failed: HTTP ${n.status}`);return await n.json()},cancel(){s()}}}var Gt=Object.defineProperty,K=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&Gt(e,t,s),s};const qe=class qe extends A{constructor(){super(...arguments),this.schema=null,this.meta={},this.config=null,this.taxonodes=null,this.disabled=!1,this._collapsed=new Set}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_renderGroup(e){const t=!this._collapsed.has(e.uuid);return l`
      <div class="group">
        ...
        ${t?l`
              <div class="group-content">
                ${e.fields.map(i=>{var s,o;return l`
                    <sfx-metadata-field
                      .field=${i}
  ...
  `;let I=qe;K([u({attribute:!1})],I.prototype,"schema");K([u({attribute:!1})],I.prototype,"meta");K([u({attribute:!1})],I.prototype,"config");K([u({attribute:!1})],I.prototype,"autocomplete");K([u({attribute:!1})],I.prototype,"taxonomyService");K([u({attribute:!1})],I.prototype,"ultratags");K([u({attribute:!1})],I.prototype,"defaultLanguage");K([u({attribute:!1})],I.prototype,"taxonodes");K([u({type:Boolean})],I.prototype,"disabled");K([x()],I.prototype,"_collapsed");customElements.define("sfx-metadata-form",I);const de=v`
...
`;var Yt=Object.defineProperty,L=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&Yt(e,t,s),s};const Pe=class Pe extends A{constructor(){super(...arguments),this.config=null,this.taxonomyEntry=null,this.ultratagsRestrictToItems=null,this.regionalVariantsGroups=[],this.disabled=!1,this._error=null,this._dispatching=!1,this._handleChildBlur=e=>{this._dispatching||(e.stopPropagation(),this._onFieldBlur(e))}}get _isRequired(){return gt(this.field,this.config??void 0)}_onFieldBlur(e){const{key:t,value:i}=e.detail,s=xt(this.field,i,this.config??void 0);if(s){this._error=s;return}this._error=null;const o={meta:{[this.field.key]:this.value}},r=Q(this.field,this.config),n=Ae(this.field,i,o,r);this._dispatching=!0,this.dispatchEvent(new CustomEvent("field-blur",{detail:{key:t,value:n},bubbles:!0,composed:!0})),this._dispatching=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("field-blur",this._handleChildBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("field-blur",this._handleChildBlur)}_renderField(e,t){var s;const i=this.disabled;if(me(e))return l`<sfx-meta-unsupported-field></sfx-meta-unsupported-field>`;switch(e.type){case"text":case"attachment-uri":return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`;case"textarea":return l`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-textarea-field>`;case"select-one":return l`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-select-field>`;case"multi-select":return l`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-multi-select-field>`;case"tags":return l`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${i}></sfx-meta-tags-field>`;case"ultratags":return l`<sfx-meta-ultratags-field
          .field=${e} .value=${t}
          .ultratags=${this.ultratags}
          .language=${(s=this.config)==null?void 0:s.language}
          .defaultLanguage=${this.defaultLanguage}
          .restrictToItems=${this.ultratagsRestrictToItems??void 0}
          ?disabled=${i}></sfx-meta-ultratags-field>`;case"taxonomy-node":return l`<sfx-meta-taxonomy-node-field .field=${e} .value=${t} .taxonomyService=${this.taxonomyService} .entry=${this.taxonomyEntry} ?disabled=${i}></sfx-meta-taxonomy-node-field>`;case"boolean":return l`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return l`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-number-field>`;case"date":return l`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-date-field>`;case"geopoint":return l`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-geo-point-field>`;default:return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`}}render(){var n,d;const e=this.field;if(!e)return g;const t=Q(e,this.config),i=vt(e,this.value,t),s=St(e,this.regionalVariantsGroups,(n=this.config)==null?void 0:n.regionalFilters,(d=this.config)==null?void 0:d.language),r=e.type==="textarea"?"field-row field-row--top":"field-row";return l`
    ...
    `}};Pe.styles=[Ht];let k=Pe;L([u({attribute:!1})],k.prototype,"field");L([u({attribute:!1})],k.prototype,"value");L([u({attribute:!1})],k.prototype,"config");L([u({attribute:!1})],k.prototype,"autocomplete");L([u({attribute:!1})],k.prototype,"taxonomyService");L([u({attribute:!1})],k.prototype,"taxonomyEntry");L([u({attribute:!1})],k.prototype,"ultratags");L([u({attribute:!1})],k.prototype,"defaultLanguage");L([u({attribute:!1})],k.prototype,"ultratagsRestrictToItems");L([u({attribute:!1})],k.prototype,"regionalVariantsGroups");L([u({type:Boolean})],k.prototype,"disabled");L([x()],k.prototype,"_error");customElements.define("sfx-metadata-field",k);var Jt=Object.defineProperty,Le=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&Jt(e,t,s),s};class E extends A{constructor(){super(...arguments),this.value="",this.disabled=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{key:this.field.key,...t!==void 0?{value:t}:{}},bubbles:!0,composed:!0}))}}Le([u({attribute:!1})],E.prototype,"field");Le([u({attribute:!1})],E.prototype,"value");Le([u({type:Boolean})],E.prototype,"disabled");const Fe=class Fe extends E{_onInput(e){this._emit("field-change",e.target.value)}_onBlur(e){this._emit("field-blur",e.target.value)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){var i,s;const e=((i=this.field)==null?void 0:i.title)??"",t=e?`Enter ${e.toLowerCase()}`:"";return l`
      <input
        type="text"
        .value=${this.value??""}
    ...
    `];let se=Ne;ze([x()],se.prototype,"_open");ze([x()],se.prototype,"_search");ze([x()],se.prototype,"_activeIndex");customElements.define("sfx-meta-multi-select-field",se);function Y(a,e){var t,i;return((t=a.label)==null?void 0:t.trim().toLowerCase())===((i=e.label)==null?void 0:i.trim().toLowerCase())}function yt(a){return a.trim().replace(/\s+/g," ")}function Xt(a){return yt(a).replace(/\s/g,"-")}function he(a){return{label:yt(a),value:Xt(a)}}var Zt=Object.defineProperty,re=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&Zt(e,t,s),s};const je=class je extends E{constructor(){super(...arguments),this._query="",this._results=[],this._loading=!1,this._dropdownOpen=!1,this._activeIndex=-1,this._blurTimeout=null}get _tags(){return Array.isArray(this.value)?this.value:[]}disconnectedCallback(){var e;super.disconnectedCallback(),this._blurTimeout&&clearTimeout(this._blurTimeout),(e=this.autocomplete)==null||e.cancel()}_onInput(e){var i,s,o;const t=e.target.value;if(this._query=t,this._dropdownOpen=!0,this._activeIndex=-1,!t.trim()||!((i=this.field)!=null&&i.ckey)){this._results=[],this._loading=!1,(s=this.autocomplete)==null||s.cancel();return}this._loading=!0,(o=this.autocomplete)==null||o.search(this.field.ckey,t,r=>{this._results=r,this._loading=!1})}_addTag(e){if(this._tags.some(i=>Y(i,e)))return;const t=[...this._tags,e];this.value=t,this._query="",this._results=[],this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-change",t),this.updateComplete.then(()=>{var i;(i=this.renderRoot.querySelector(".input"))==null||i.focus()})}_removeTag(e){const t=this._tags.filter(i=>!Y(i,e));this.value=t,this._emit("field-change",t)}_onBlur(){this._blurTimeout&&clearTimeout(this._blurTimeout),this._blurTimeout=setTimeout(()=>{this._blurTimeout=null,this.renderRoot.querySelector(".dropdown:hover")||(this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-blur",this._tags))},150)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}get _itemCount(){return this._suggestions.length+(this._canCreate?1:0)}_onKeydown(e){if(e.key==="Escape"){this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-escape");return}if(e.key==="Backspace"&&!this._query&&this._tags.length){this._removeTag(this._tags[this._tags.length-1]);return}if(!this._dropdownOpen)return;const t=this._itemCount;if(this._activeIndex>=t&&(this._activeIndex=Math.max(t-1,-1)),!(t===0&&e.key!=="Enter"))switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,-1),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t-1,this._scrollActive();break;case"Enter":{e.preventDefault();const i=this._suggestions;this._activeIndex>=0&&this._activeIndex<i.length?this._addTag(i[this._activeIndex]):this._activeIndex===i.length&&this._canCreate?this._addTag(he(this._query)):this._activeIndex===-1&&this._canCreate?this._addTag(he(this._query)):this._activeIndex===-1&&i.length&&this._addTag(i[0]);break}}}get _suggestions(){var o;const e=this._query.toLowerCase().trim(),t=this._tags,i=(((o=this.field)==null?void 0:o.possible_values)??[]).map(r=>({value:r.api_value||r.internal_unique_value,label:r.label})).filter(r=>!t.some(n=>Y(n,r))).filter(r=>!e||r.label.toLowerCase().includes(e)),s=this._results.filter(r=>!t.some(n=>Y(n,r))&&!i.some(n=>Y(n,r)));return[...i,...s]}get _canCreate(){const e=this._query.trim();if(!e||this._loading)return!1;const t=he(e);return!this._tags.some(i=>Y(i,t))&&!this._suggestions.some(i=>Y(i,t))}render(){var s,o;const e=this._tags,t=this._suggestions,i=t.length;return l`
        ...
        <div class="dropdown" role="listbox">
          ...
          ${this._canCreate?l`
            <div class="option create ${i===this._activeIndex?"active":""}"
              @mousedown=${r=>{r.preventDefault(),this._addTag(he(this._query))}}
    ...
    `];let M=je;re([u({attribute:!1})],M.prototype,"autocomplete");re([x()],M.prototype,"_query");re([x()],M.prototype,"_results");re([x()],M.prototype,"_loading");re([x()],M.prototype,"_dropdownOpen");re([x()],M.prototype,"_activeIndex");customElements.define("sfx-meta-tags-field",M);var ei=Object.defineProperty,_t=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&ei(e,t,s),s};const J=[{label:"True",value:"true"},{label:"False",value:"false"}],Me=class Me extends E{constructor(){super(...arguments),this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _currentLabel(){var t;if(this.value==null)return"";const e=String(this.value);return((t=J.find(i=>i.value===e))==null?void 0:t.label)??""}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_openDropdown(){this._open=!0;const e=this.value==null?"":String(this.value);this._activeIndex=Math.max(J.findIndex(t=>t.value===e),0),document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".dropdown"))==null||t.focus()})}_closeAndSubmit(e=!1){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-blur",this.value),e&&this.updateComplete.then(()=>{var t;(t=this.renderRoot.querySelector(".trigger"))==null||t.focus()})}_onOutsideClick(e){e.composedPath().includes(this)||this._closeAndSubmit()}_onSelect(e,t=!1){this.value=e.value,this._emit("field-change",e.value),this._closeAndSubmit(t)}_clear(e){e.stopPropagation(),this.value=null,this._emit("field-change",null),this._emit("field-blur",null)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){var t;if(e.key==="Escape"){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick),this._emit("field-escape"),(t=this.renderRoot.querySelector(".trigger"))==null||t.focus();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,J.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=J.length-1,this._scrollActive();break;case"Enter":case" ":this._activeIndex>=0&&this._activeIndex<J.length&&(e.preventDefault(),this._onSelect(J[this._activeIndex],!0));break}}render(){var s,o;const e=this.value==null?"":String(this.value),t=((s=this.field)==null?void 0:s.title)??"",i=t?`Select ${t.toLowerCase()}`:"Select an option";return l`
      <button class="trigger" ?disabled=${this.disabled}
        role="combobox" aria-expanded=${this._open} aria-haspopup="listbox"
        @click=${()=>this._open?this._closeAndSubmit(!0):this._openDropdown()}
        @keydown=${this._onKeydown}>
    ...
    `];let Se=Ve;customElements.define("sfx-meta-date-field",Se);const Ge=class Ge extends E{get _geo(){const e=this.value;return{latitude:(e==null?void 0:e.latitude)??"",longitude:(e==null?void 0:e.longitude)??""}}_onInput(e,t){const i=t.target.value,s={...this._geo,[e]:i};this.value=s,this._emit("field-change",s)}_onBlur(e){const t=e.relatedTarget;t&&this.renderRoot.contains(t)||this._emit("field-blur",this._geo)}_onKeydown(e){e.key==="Escape"&&this._emit("field-escape")}render(){const e=this._geo;return l`
      <div class="grid">
        <div>
    ...
    `];let S=He;q([u({attribute:!1})],S.prototype,"taxonomyService");q([u({attribute:!1})],S.prototype,"entry");q([x()],S.prototype,"_open");q([x()],S.prototype,"_query");q([x()],S.prototype,"_drillStack");q([x()],S.prototype,"_currentNodes");q([x()],S.prototype,"_searchResults");q([x()],S.prototype,"_loading");q([x()],S.prototype,"_activeIndex");q([x()],S.prototype,"_resolvedTaxonomyUuid");q([x()],S.prototype,"_taxonomyResolutionFailed");customElements.define("sfx-meta-taxonomy-node-field",S);var ii=Object.defineProperty,V=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&ii(e,t,s),s};const si=(a,e)=>!!(e.uuid&&a.uuid===e.uuid||e.sid&&a.sid===e.sid||e.slug&&a.slug===e.slug),Ye=class Ye extends E{constructor(){super(...arguments),this._query="",this._results=[],this._loading=!1,this._dropdownOpen=!1,this._activeIndex=-1,this._blurTimeout=null,this._enrichmentAttempted=new Set}get _items(){return Array.isArray(this.value)?this.value.map(e=>typeof e=="string"?Kt(e)?{sid:e}:{slug:e}:e):[]}get _currentLang(){return this.language||"en"}get _defaultLang(){return this.defaultLanguage||this._currentLang}get _isRestricted(){return Array.isArray(this.restrictToItems)}connectedCallback(){super.connectedCallback(),this._maybeEnrichBySids()}disconnectedCallback(){var e;super.disconnectedCallback(),this._blurTimeout&&clearTimeout(this._blurTimeout),(e=this.ultratags)==null||e.cancel()}updated(e){e.has("value")&&this._maybeEnrichBySids()}async _maybeEnrichBySids(){const e=this.ultratags;if(!e)return;const t=this._items;if(t.length===0)return;const i=[];for(const s of t)s.sid&&!s.i18n&&!this._enrichmentAttempted.has(s.sid)&&i.push(s.sid);if(i.length!==0){for(const s of i)this._enrichmentAttempted.add(s);try{const s=await e.getBySids({sids:i,format:at}),o=Nt(s.items||[]),r=jt(t,o);this.value=r}catch{}}}_selectedKeys(){const e=new Set;for(const t of this._items)t.uuid&&e.add(t.uuid),t.sid&&e.add(t.sid),t.slug&&e.add(t.slug);return e}_entryAlreadySelected(e){const t=this._selectedKeys();return!!e.uuid&&t.has(e.uuid)||!!e.sid&&t.has(e.sid)||t.has(e.slug)}_labelForItem(e){const t={i18n:e.i18n,slug:e.slug||""};return ge(t,this._currentLang,this._defaultLang).value||e.slug||e.sid||""}get _restrictedEntries(){return this._isRestricted?(this.restrictToItems||[]).map(e=>({slug:e.slug||"",sid:e.sid,uuid:e.uuid||"",i18n:e.i18n})):[]}get _dropdownOptions(){const e=this._selectedKeys(),t=o=>!!o.uuid&&e.has(o.uuid)||!!o.sid&&e.has(o.sid)||e.has(o.slug),s=(this._isRestricted?this._restrictedEntries:this._results).filter(o=>!t(o)).map(o=>({entry:o,label:ge(o,this._currentLang,this._defaultLang).value||o.slug}));if(this._isRestricted){const o=this._query.trim().toLowerCase();return o?s.filter(r=>r.label.toLowerCase().includes(o)):s}return s}get _isSearching(){return this._query.trim().length>=nt}get _canCreate(){if(this._isRestricted||!this._isSearching||this._loading)return!1;const e=this._query.trim(),t=lt(e);return!(!t||this._selectedKeys().has(t)||this._dropdownOptions.some(s=>s.label.toLowerCase()===e.toLowerCase()))}get _itemCount(){return this._dropdownOptions.length+(this._canCreate?1:0)}_onInput(e){var o,r;const t=e.target.value;if(this._query=t,this._dropdownOpen=!0,this._activeIndex=-1,this._isRestricted){this._loading=!1;return}if(!this._isSearching||!((o=this.field)!=null&&o.key)){this._results=[],this._loading=!1,(r=this.ultratags)==null||r.cancel();return}const i=this.ultratags;if(!i)return;const s=t.trim().toLowerCase();this._loading=!0,i.list({meta:this.field.key,q:s,limit:qt,format:at}).then(n=>{this._query.trim().toLowerCase()===s&&(this._results=n.items||[],this._loading=!1)}).catch(()=>{this._query.trim().toLowerCase()===s&&(this._results=[],this._loading=!1)})}_addEntry(e){if(this._entryAlreadySelected(e))return;const t={slug:e.slug,sid:e.sid,uuid:e.uuid,i18n:e.i18n},i=[...this._items,t];this.value=i,this._query="",this._results=[],this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-change",i),this.updateComplete.then(()=>{var s;(s=this.renderRoot.querySelector(".input"))==null||s.focus()})}async _createFromQuery(){var o,r;const e=this._query.trim();if(!e)return;const t=this.ultratags;if(!t||!((o=this.field)!=null&&o.key))return;const i=lt(e);if(!i)return;const s=this._currentLang;try{const n=await t.create({meta:this.field.key,mode:Ft.UPSERT,items:[{slug:i,i18n:{[s]:e}}]}),d=(r=n==null?void 0:n.output)==null?void 0:r[0],c={slug:(d==null?void 0:d.slug)||i,sid:d==null?void 0:d.sid,uuid:d==null?void 0:d.uuid,i18n:(d==null?void 0:d.i18n)||{[s]:e}};if(this._entryAlreadySelected({uuid:c.uuid||"",sid:c.sid,slug:c.slug||i}))return;const p=[...this._items,c];this.value=p,this._query="",this._results=[],this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-change",p),this.updateComplete.then(()=>{var h;(h=this.renderRoot.querySelector(".input"))==null||h.focus()})}catch{console.warn("[sfx-uploader] ultratag create failed")}}_removeItem(e){const t=this._items.filter(i=>!si(i,e));this.value=t,this._emit("field-change",t)}_onBlur(){this._blurTimeout&&clearTimeout(this._blurTimeout),this._blurTimeout=setTimeout(()=>{this._blurTimeout=null,this.renderRoot.querySelector(".dropdown:hover")||(this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-blur",this._items))},150)}_scrollActive(){this.updateComplete.then(()=>{var e;(e=this.renderRoot.querySelector(".option.active"))==null||e.scrollIntoView({block:"nearest"})})}_onKeydown(e){if(e.key==="Escape"){this._dropdownOpen=!1,this._activeIndex=-1,this._emit("field-escape");return}if(e.key==="Backspace"&&!this._query&&this._items.length){this._removeItem(this._items[this._items.length-1]);return}if(!this._dropdownOpen)return;const t=this._itemCount;if(this._activeIndex>=t&&(this._activeIndex=Math.max(t-1,-1)),!(t===0&&e.key!=="Enter"))switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,-1),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t-1,this._scrollActive();break;case"Enter":{e.preventDefault();const i=this._dropdownOptions;this._activeIndex>=0&&this._activeIndex<i.length?this._addEntry(i[this._activeIndex].entry):this._activeIndex===i.length&&this._canCreate?this._createFromQuery():this._activeIndex===-1&&this._canCreate?this._createFromQuery():this._activeIndex===-1&&i.length&&this._addEntry(i[0].entry);break}}}render(){var r,n;const e=this._items,t=this._dropdownOptions,i=t.length,s=this._query.trim(),o=((r=this.field)==null?void 0:r.placeholder)||(this._isRestricted?"Search tags to remove":"Add custom tags");return l`
    ...
    `];let R=Ye;V([u({attribute:!1})],R.prototype,"ultratags");V([u({attribute:!1})],R.prototype,"language");V([u({attribute:!1})],R.prototype,"defaultLanguage");V([u({attribute:!1})],R.prototype,"restrictToItems");V([x()],R.prototype,"_query");V([x()],R.prototype,"_results");V([x()],R.prototype,"_loading");V([x()],R.prototype,"_dropdownOpen");V([x()],R.prototype,"_activeIndex");customElements.define("sfx-meta-ultratags-field",R);const le="This field is not supported during upload. You can edit it later in the asset library.",wt=l`
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ${_`<rect x="3" y="7" width="10" height="7" rx="1.5"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/>`}
  </svg>
`,Je=class Je extends A{render(){return l`
      <div
        class="unsupported"
        title=${le}
        aria-label=${le}
  ...
  `;let Ee=Je;customElements.define("sfx-meta-unsupported-field",Ee);var ri=Object.defineProperty,B=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&ri(e,t,s),s};const Qe=class Qe extends A{constructor(){super(...arguments),this.taxonomyEntry=null,this.ultratagsRestrictToItems=null,this.disabled=!1}render(){const e=this.field,t=this.value,i=this.disabled;if(me(e))return l`<sfx-meta-unsupported-field></sfx-meta-unsupported-field>`;switch(e.type){case"text":case"attachment-uri":return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`;case"textarea":return l`<sfx-meta-textarea-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-textarea-field>`;case"select-one":return l`<sfx-meta-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-select-field>`;case"multi-select":return l`<sfx-meta-multi-select-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-multi-select-field>`;case"tags":return l`<sfx-meta-tags-field .field=${e} .value=${t} .autocomplete=${this.autocomplete} ?disabled=${i}></sfx-meta-tags-field>`;case"ultratags":return l`<sfx-meta-ultratags-field
          .field=${e} .value=${t}
          .ultratags=${this.ultratags}
          .language=${this.language}
          .defaultLanguage=${this.defaultLanguage}
          .restrictToItems=${this.ultratagsRestrictToItems??void 0}
          ?disabled=${i}></sfx-meta-ultratags-field>`;case"taxonomy-node":return l`<sfx-meta-taxonomy-node-field .field=${e} .value=${t} .taxonomyService=${this.taxonomyService} .entry=${this.taxonomyEntry} ?disabled=${i}></sfx-meta-taxonomy-node-field>`;case"boolean":return l`<sfx-meta-boolean-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-boolean-field>`;case"numeric":case"decimal2":return l`<sfx-meta-number-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-number-field>`;case"date":return l`<sfx-meta-date-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-date-field>`;case"geopoint":return l`<sfx-meta-geo-point-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-geo-point-field>`;default:return l`<sfx-meta-text-field .field=${e} .value=${t} ?disabled=${i}></sfx-meta-text-field>`}}};Qe.styles=v`
    :host { display: block; }
  `;let T=Qe;B([u({attribute:!1})],T.prototype,"field");B([u({attribute:!1})],T.prototype,"value");B([u({attribute:!1})],T.prototype,"autocomplete");B([u({attribute:!1})],T.prototype,"taxonomyService");B([u({attribute:!1})],T.prototype,"taxonomyEntry");B([u({attribute:!1})],T.prototype,"ultratags");B([u({attribute:!1})],T.prototype,"language");B([u({attribute:!1})],T.prototype,"defaultLanguage");B([u({attribute:!1})],T.prototype,"ultratagsRestrictToItems");B([u({type:Boolean})],T.prototype,"disabled");customElements.define("sfx-metadata-field-edit",T);var oi=Object.defineProperty,ue=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&oi(e,t,s),s};const We=class We extends A{constructor(){super(...arguments),this.taxonomyEntry=null}_formatValue(){var i,s,o,r;const e=this.value,t=(i=this.field)==null?void 0:i.type;switch(t){case"boolean":return e==="true"?"True":e==="false"?"False":"";case"date":return e?e instanceof Date?e.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"}):typeof e=="string"&&e.length>0?e:"":"";case"numeric":case"decimal2":{if(e==null||e==="")return"";const n=Number(e);return Number.isFinite(n)?n.toLocaleString(void 0,{maximumFractionDigits:t==="decimal2"?2:0}):String(e)}case"select-one":{if(e==null||e==="")return"";const n=(s=this.field.possible_values)==null?void 0:s.find(d=>d.internal_unique_value===e||d.api_value===e);return(n==null?void 0:n.label)??String(e)}case"multi-select":return!Array.isArray(e)||e.length===0?"":e.map(n=>{var c;const d=(c=this.field.possible_values)==null?void 0:c.find(p=>p.internal_unique_value===n||p.api_value===n);return(d==null?void 0:d.label)??String(n)}).join(", ");case"tags":return!Array.isArray(e)||e.length===0?"":e.map(n=>n.label||n.value).join(", ");case"ultratags":{if(!Array.isArray(e)||e.length===0)return"";const n=this.language||"en",d=this.defaultLanguage||n;return e.map(c=>typeof c=="string"?c:ge({i18n:c.i18n,slug:c.slug||""},n,d).value||c.slug||c.sid||"").filter(Boolean).join(", ")}case"taxonomy-node":return(o=this.taxonomyEntry)!=null&&o.path?this.taxonomyEntry.path:(r=this.taxonomyEntry)!=null&&r.name?this.taxonomyEntry.name:e==null||e===""?"":String(e);case"geopoint":{const n=e;return!n||n.latitude===""||n.latitude==null||n.longitude===""||n.longitude==null?"":`(${n.latitude}, ${n.longitude})`}case"attachment-uri":return!e||typeof e=="string"&&e.length===0?"":String(e);case"text":case"textarea":default:return e==null||e===""?"":String(e)}}render(){var i;if(this.field&&me(this.field))return l`
  ...
  `;let H=We;ue([u({attribute:!1})],H.prototype,"field");ue([u({attribute:!1})],H.prototype,"value");ue([u({attribute:!1})],H.prototype,"taxonomyEntry");ue([u({attribute:!1})],H.prototype,"language");ue([u({attribute:!1})],H.prototype,"defaultLanguage");customElements.define("sfx-metadata-field-view",H);var ni=Object.defineProperty,be=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&ni(e,t,s),s};const Xe=class Xe extends A{constructor(){super(...arguments),this.groups=[],this.selectedFilters={},this._open=!1,this._activeIndex=-1,this._boundOutsideClick=this._onOutsideClick.bind(this)}get _filteredGroups(){return(this.groups??[]).filter(e=>{var t;return((t=e==null?void 0:e.variants)==null?void 0:t.length)>1})}get _options(){const e=[];for(const t of this._filteredGroups){let i=!0;for(const s of t.variants)e.push({groupUuid:t.uuid,value:s.api_value,label:s.label,isGroupStart:i,groupLabel:t.label}),i=!1}return e}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._boundOutsideClick)}_toggle(){this._open?this._close():this._openDropdown()}_openDropdown(){this._open=!0;const t=this._options.findIndex(i=>this.selectedFilters[i.groupUuid]===i.value);this._activeIndex=t>=0?t:0,document.addEventListener("mousedown",this._boundOutsideClick),this.updateComplete.then(()=>this._scrollActive())}_close(){this._open=!1,this._activeIndex=-1,document.removeEventListener("mousedown",this._boundOutsideClick)}_onOutsideClick(e){e.composedPath().includes(this)||this._close()}_onSelect(e){this._close(),this.selectedFilters[e.groupUuid]!==e.value&&this.dispatchEvent(new CustomEvent("regional-change",{detail:{groupUuid:e.groupUuid,value:e.value},bubbles:!0,composed:!0}))}_scrollActive(){const e=this.renderRoot.querySelector(".option.active");e&&typeof e.scrollIntoView=="function"&&e.scrollIntoView({block:"nearest"})}_onKeydown(e){if(e.key==="Escape"&&this._open){e.stopPropagation(),this._close();return}if(!this._open){(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._openDropdown());return}const t=this._options;if(t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._activeIndex=Math.min(this._activeIndex+1,t.length-1),this._scrollActive();break;case"ArrowUp":e.preventDefault(),this._activeIndex=Math.max(this._activeIndex-1,0),this._scrollActive();break;case"Home":e.preventDefault(),this._activeIndex=0,this._scrollActive();break;case"End":e.preventDefault(),this._activeIndex=t.length-1,this._scrollActive();break;case"Enter":this._activeIndex>=0&&this._activeIndex<t.length&&(e.preventDefault(),this._onSelect(t[this._activeIndex]));break}}_triggerSummary(){var i;const e=this._filteredGroups;if(e.length===0)return"Regional settings";const t=[];for(const s of e){const o=this.selectedFilters[s.uuid]??((i=s.variants[0])==null?void 0:i.api_value),r=s.variants.find(n=>n.api_value===o);r&&t.push(e.length===1?r.label:`${s.label}: ${r.label}`)}return t.length?t.join(", "):"Regional settings"}render(){if(this._filteredGroups.length===0)return g;const t=this._options,i=this._triggerSummary();return l`
    ...
    `];let W=Xe;be([u({attribute:!1})],W.prototype,"groups");be([u({attribute:!1})],W.prototype,"selectedFilters");be([x()],W.prototype,"_open");be([x()],W.prototype,"_activeIndex");customElements.define("sfx-regional-settings",W);const ve=new Set(["multi-select","tags","ultratags"]),ye=new Set(["text","textarea","attachment-uri"]);function ai(a){return Ct(a)?[]:ve.has(a)?[{key:"SET",label:"Set"},{key:"ADD",label:"Add to"},{key:"DELETE",label:"Remove from"}]:ye.has(a)?[{key:"SET",label:"Set"},{key:"ADD",label:"Append"},{key:"DELETE",label:"Remove"}]:[{key:"SET",label:"Set"},{key:"DELETE",label:"Clear"}]}function Ie(a,e){return a==="DELETE"?ve.has(e)||ye.has(e):!0}function li(a,e,t,i){const s=ve.has(i),o=ye.has(i);switch(a){case"SET":return t;case"ADD":{if(s){const r=Array.isArray(e)?e:[],n=Array.isArray(t)?t:[];if(n.length===0)return r;if(i==="ultratags")return _e(r,n,!1);if(i==="tags"){const p=new Set(r.map(f=>f)),h=[...r];for(const f of n){const m=typeof f=="string"?f:String(f);p.has(m)||(p.add(m),h.push(m))}return h}const d=new Set(r.map(p=>JSON.stringify(p))),c=[...r];for(const p of n){const h=JSON.stringify(p);d.has(h)||(d.add(h),c.push(p))}return c}if(o){const r=typeof t=="string"?t:"";if(!r)return e??"";const n=typeof e=="string"?e:"";return n?`${n} ${r}`:r}return t}case"DELETE":{if(s){const r=Array.isArray(e)?e:[],n=Array.isArray(t)?t:[];if(n.length===0)return r;if(i==="ultratags")return _e(r,n,!0);if(i==="tags"){const c=new Set(n.map(p=>typeof p=="string"?p:String(p)));return r.filter(p=>!c.has(typeof p=="string"?p:String(p)))}const d=new Set(n.map(c=>JSON.stringify(c)));return r.filter(c=>!d.has(JSON.stringify(c)))}if(o){const r=typeof t=="string"?t:"";return r?(typeof e=="string"?e:"").replaceAll(r,"").replace(/\s{2,}/g," ").trim():""}return i==="geopoint"?{latitude:"",longitude:""}:null}default:return t}}function kt(a,e,t,i,s){const o=s??"en",r=!!a.regional_variants_group_uuid,n={meta:{[a.key]:e}},d=Ae(a,t,n,s),c=m=>r&&m!==null&&typeof m=="object"&&!Array.isArray(m),p=c(e)?e[o]:e,h=c(d)?d[o]:d,f=li(i,p,h,a.type);return r?{...c(e)?e:{},[o]:f}:f}const $t=v`
  .fm-checkbox {
...
`;var gi=Object.defineProperty,w=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&gi(e,t,s),s};const Ze=class Ze extends A{constructor(){super(...arguments),this.files=[],this.config=null,this.initialFieldKey=null,this._activeFieldKey="",this._staged=new Map,this._stagedTaxonodes=new Map,this._selected=new Set,this._sortAsc=!0,this._pendingOp=null,this._confirmVisible=!1,this._missingRequiredFieldKey=null,this._missingRequiredKeys=new Set,this._confirmResolve=null,this._originalFiles=new Map,this._onKeyDown=async e=>{if(e.key!=="Escape")return;if(this._confirmVisible){e.stopPropagation(),this._onConfirmCancel();return}e.composedPath().some(s=>s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement)||await this._confirmDiscardPending()&&this._emitClose()},this._onConfirmOk=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!0),this._confirmResolve=null},this._onConfirmCancel=()=>{var e;this._confirmVisible=!1,(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null},this._onConfirmKeydown=e=>{var n,d;if(e.key!=="Tab")return;const t=(n=this.shadowRoot)==null?void 0:n.querySelector(".fm-confirm");if(!t)return;const i=t.querySelectorAll("button");if(i.length===0)return;const s=i[0],o=i[i.length-1],r=(d=this.shadowRoot)==null?void 0:d.activeElement;e.shiftKey&&r===s?(e.preventDefault(),o.focus()):!e.shiftKey&&r===o&&(e.preventDefault(),s.focus())},this._onPendingChange=e=>{const{operation:t,value:i}=e.detail,s=this._activeField;ee(i)&&(!s||Ie(t,s.type))?this._pendingOp=null:this._pendingOp={operation:t,value:i}},this._onFieldSelect=async e=>{await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e.detail.fieldKey)},this._onJumpToNextRequired=async()=>{const e=this._missingRequiredFieldKey;e&&this._activeFieldKey!==e&&await this._confirmDiscardPending()&&(this._pendingOp=null,this._activeFieldKey=e)},this._onBulkApply=e=>{const t=this._activeField;if(!t)return;const{operation:i,value:s,taxonomyEntry:o}=e.detail,r=Q(t,this.config),n=[];for(const d of this._selected){const c=this._staged.get(d),p=c!=null&&c.has(t.key)?c.get(t.key):this._originalValue(d,t.key)??null,h=kt(t,p,s,i,r);n.push([d,t.key,h])}this._setStagedBulk(n),t.type==="taxonomy-node"&&o!==void 0&&this._setStagedTaxonodeBulk(this._selected,t.key,o)},this._onRowTaxonomyEntry=e=>{const{fileId:t,fieldKey:i,entry:s}=e.detail;this._setStagedTaxonodeSingle(t,i,s)},this._onRowFieldChange=e=>{const t=this._activeField;t&&this._setStagedValue(e.detail.fileId,t.key,e.detail.value)},this._onRowToggle=e=>{const t=new Set(this._selected);t.has(e.detail.fileId)?t.delete(e.detail.fileId):t.add(e.detail.fileId),this._selected=t},this._onSelectAll=()=>{this._selected.size===this.files.length?this._selected=new Set:this._selected=new Set(this.files.map(e=>e.id))},this._onSortToggle=()=>{this._sortAsc=!this._sortAsc},this._onSave=async()=>{if(this._missingRequiredFieldKey!=null||!await this._confirmDiscardPending())return;const e=[],t=[];for(const[s,o]of this._staged){if(!this._originalFiles.get(s))continue;const n={},d={};for(const[c,p]of o){const h=this._originalValue(s,c);if(JSON.stringify(p)!==JSON.stringify(h))if(rt(c)){const f=ot(c);if(!f)continue;const m=p===""||p==null;f==="position"?d.position=m?void 0:Number(p):d.ref=m?void 0:String(p)}else n[c]=p}Object.keys(n).length>0&&e.push({fileId:s,meta:n}),Object.keys(d).length>0&&t.push({fileId:s,product:d})}this.dispatchEvent(new CustomEvent("metadata-save-batch",{detail:{changes:e},bubbles:!0,composed:!0})),t.length>0&&this.dispatchEvent(new CustomEvent("product-save-batch",{detail:{changes:t},bubbles:!0,composed:!0}));const i=[];for(const[s,o]of this._stagedTaxonodes){const r=this._originalFiles.get(s);if(!r)continue;const n=r.taxonodes??{},d={};for(const[c,p]of o){const h=n[c]??null;JSON.stringify(p??null)!==JSON.stringify(h??null)&&(d[c]=p??null)}Object.keys(d).length>0&&i.push({fileId:s,taxonodes:d})}i.length>0&&this.dispatchEvent(new CustomEvent("taxonomy-save-batch",{detail:{changes:i},bubbles:!0,composed:!0})),this._emitClose()},this._onCancel=async()=>{await this._confirmDiscardPending()&&this._emitClose()},this._onClose=async()=>{await this._confirmDiscardPending()&&this._emitClose()}}connectedCallback(){super.connectedCallback(),this._initStaged(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),(e=this._confirmResolve)==null||e.call(this,!1),this._confirmResolve=null}_initStaged(){var n,d;const e=new Map,t=new Map,i=new Set,s=new Map,o=((n=this.schema)==null?void 0:n.productsEnabled)===!0;for(const c of this.files){const p=new Map;if(c.meta)for(const[h,f]of Object.entries(c.meta))p.set(h,f);if(o){const h=c.product;h.ref!==void 0&&p.set(Et,h.ref),h.position!==void 0&&p.set(It,h.position)}e.set(c.id,p),c.taxonodes&&t.set(c.id,new Map(Object.entries(c.taxonodes))),i.add(c.id),s.set(c.id,c)}this._staged=e,this._stagedTaxonodes=t,this._selected=i,this._originalFiles=s;const r=this.initialFieldKey;r&&((d=this.schema)!=null&&d.fieldsByKey.has(r))?this._activeFieldKey=r:this.schema&&this.schema.fields.length>0&&(this._activeFieldKey=this.schema.fields[0].key)}_setStagedValue(e,t,i){const s=new Map(this._staged),o=new Map(s.get(e)??new Map);o.set(t,i),s.set(e,o),this._staged=s}_setStagedBulk(e){const t=new Map(this._staged);for(const[i,s,o]of e){const r=new Map(t.get(i)??new Map);r.set(s,o),t.set(i,r)}this._staged=t}_setStagedTaxonodeBulk(e,t,i){const s=new Map(this._stagedTaxonodes);for(const o of e){const r=new Map(s.get(o)??new Map);r.set(t,i),s.set(o,r)}this._stagedTaxonodes=s}_setStagedTaxonodeSingle(e,t,i){const s=new Map(this._stagedTaxonodes),o=new Map(s.get(e)??new Map);o.set(t,i),s.set(e,o),this._stagedTaxonodes=s}get _activeField(){var e,t;return(t=(e=this.schema)==null?void 0:e.fieldsByKey)==null?void 0:t.get(this._activeFieldKey)}get _ultratagsPresentOnSelection(){var i,s;const e=this._activeField;if(!e||e.type!=="ultratags")return[];let t=[];for(const o of this._selected){const r=this._originalFiles.get(o),n=(i=this._staged.get(o))==null?void 0:i.get(e.key),d=n!==void 0?n:(s=r==null?void 0:r.meta)==null?void 0:s[e.key],c=xe(d);c.length&&(t=_e(t,c,!1))}return t.filter(o=>typeof o!="string")}_originalValue(e,t){var s,o;const i=this._originalFiles.get(e);if(i){if(rt(t)){const r=ot(t);return r?(s=i.product)==null?void 0:s[r]:void 0}return(o=i.meta)==null?void 0:o[t]}}_refreshMissingRequired(){const e=this.schema?Tt(this._staged,this._originalFiles,this.schema,this.config??void 0):new Set;let t=null;if(this.schema&&e.size>0){for(const o of this.schema.fields)if(e.has(o.key)){t=o.key;break}}t!==this._missingRequiredFieldKey&&(this._missingRequiredFieldKey=t);const i=this._missingRequiredKeys;let s=i.size!==e.size;if(!s){for(const o of e)if(!i.has(o)){s=!0;break}}s&&(this._missingRequiredKeys=e)}get _filledFields(){var t;const e=new Set;for(const i of((t=this.schema)==null?void 0:t.fields)??[])for(const[s,o]of this._staged){const r=o.get(i.key),n=this._originalValue(s,i.key);if(r!==void 0&&!ee(r)&&JSON.stringify(r)!==JSON.stringify(n)){e.add(i.key);break}}return e}get _hasPendingValue(){return this._pendingOp!=null&&!ee(this._pendingOp.value)}_confirmDiscardPending(){return this._hasPendingValue?new Promise(e=>{this._confirmResolve=e,this._confirmVisible=!0}):Promise.resolve(!0)}willUpdate(e){(e.has("_staged")||e.has("schema")||e.has("config"))&&this._refreshMissingRequired()}updated(e){var t;(t=super.updated)==null||t.call(this,e),e.has("_confirmVisible")&&this._confirmVisible&&requestAnimationFrame(()=>{var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector(".fm-confirm .btn-ghost");i==null||i.focus()})}_emitClose(){this.dispatchEvent(new CustomEvent("metadata-close",{bubbles:!0,composed:!0}))}get _sortedFiles(){const e=[...this.files];return e.sort((t,i)=>{const s=t.name.localeCompare(i.name)||t.id.localeCompare(i.id);return this._sortAsc?s:-s}),e}render(){var c,p,h,f,m;if(!((p=(c=this.schema)==null?void 0:c.fields)!=null&&p.length))return l`
      ...
      `;const e=this._activeField,t=this._sortedFiles,i=this._selected.size===this.files.length&&this.files.length>0,s=this._selected.size>0&&!i,o=this._missingRequiredFieldKey,r=o?((h=this.schema.fieldsByKey.get(o))==null?void 0:h.title)||o:"",n=o!=null&&this._activeFieldKey===o,d=o!=null&&!n;return l`
      <div class="fm-overlay" @click=${this._onClose}>
        <div class="fm-modal" @click=${b=>b.stopPropagation()}>
          <!-- Top bar -->
          <div class="fm-topbar">
          ...
          <div class="fm-footer">
            ...
            <button
              class=${mt({"btn-primary":!0,"btn-primary--next":d})}
    ...
    `}};Ze.styles=[di];let y=Ze;w([u({attribute:!1})],y.prototype,"schema");w([u({attribute:!1})],y.prototype,"files");w([u({attribute:!1})],y.prototype,"config");w([u({attribute:!1})],y.prototype,"autocomplete");w([u({attribute:!1})],y.prototype,"taxonomyService");w([u({attribute:!1})],y.prototype,"ultratags");w([u({attribute:!1})],y.prototype,"defaultLanguage");w([u({attribute:!1})],y.prototype,"initialFieldKey");w([x()],y.prototype,"_activeFieldKey");w([x()],y.prototype,"_staged");w([x()],y.prototype,"_stagedTaxonodes");w([x()],y.prototype,"_selected");w([x()],y.prototype,"_sortAsc");w([x()],y.prototype,"_pendingOp");w([x()],y.prototype,"_confirmVisible");w([x()],y.prototype,"_missingRequiredFieldKey");w([x()],y.prototype,"_missingRequiredKeys");customElements.define("sfx-bulk-metadata-modal",y);const ct={text:l`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  </svg>`};function xi(a){return ct[a]??ct.text}var mi=Object.defineProperty,X=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&mi(e,t,s),s};const et=class et extends A{constructor(){super(...arguments),this.activeFieldKey="",this.filledFields=new Set,this.missingRequiredKeys=new Set,this.config=null,this._collapsed=new Set,this._isNarrow=!1,this._resizeTimer=null,this._onResize=()=>{this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(this._updateNarrow,100)},this._updateNarrow=()=>{this._resizeTimer=null;const e=window.innerWidth<=768;e!==this._isNarrow&&(this._isNarrow=e)}}connectedCallback(){super.connectedCallback(),this._updateNarrow(),window.addEventListener("resize",this._onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._onResize),this._resizeTimer&&(clearTimeout(this._resizeTimer),this._resizeTimer=null)}_isRequired(e){return gt(e,this.config??void 0)}_toggleGroup(e){const t=new Set(this._collapsed);t.has(e)?t.delete(e):t.add(e),this._collapsed=t}_onFieldClick(e){this.dispatchEvent(new CustomEvent("field-select",{detail:{fieldKey:e},bubbles:!0,composed:!0}))}updated(e){var i,s;if((i=super.updated)==null||i.call(this,e),!e.has("activeFieldKey")||!this.activeFieldKey)return;const t=(s=this.renderRoot)==null?void 0:s.querySelector(".field-item.active");t==null||t.scrollIntoView({block:"nearest"})}render(){return this.schema?l`
    ...
    `}},j.styles=[ui],j._ENTER_APPLY_TYPES=new Set(["text","numeric","decimal2","date","geopoint","attachment-uri"]),j);D([u({attribute:!1})],O.prototype,"field");D([u({attribute:!1})],O.prototype,"autocomplete");D([u({attribute:!1})],O.prototype,"taxonomyService");D([u({attribute:!1})],O.prototype,"ultratags");D([u({attribute:!1})],O.prototype,"defaultLanguage");D([u({attribute:!1})],O.prototype,"ultratagsPresentOnSelection");D([u({attribute:!1})],O.prototype,"config");D([u({type:Number})],O.prototype,"selectedCount");D([x()],O.prototype,"_operation");D([x()],O.prototype,"_value");D([x()],O.prototype,"_pendingTaxonode");D([x()],O.prototype,"_opDropdownOpen");let vi=O;customElements.define("sfx-bulk-meta-op-bar",vi);var yi=Object.defineProperty,P=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&yi(e,t,s),s};const tt=class tt extends A{constructor(){super(...arguments),this.files=[],this.staged=new Map,this.stagedTaxonodes=new Map,this.selected=new Set,this.pendingOp=null,this.config=null}_getEffectiveValue(e){const t=this.staged.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key):e.meta[this.field.key]}_getTaxonodeEntry(e){var i;const t=this.stagedTaxonodes.get(e.id);return t!=null&&t.has(this.field.key)?t.get(this.field.key)??null:((i=e.taxonodes)==null?void 0:i[this.field.key])??null}render(){return l`
      ${this.files.map(e=>l`
          <sfx-bulk-meta-row
            .file=${e}
            .field=${this.field}
          ...
          ></sfx-bulk-meta-row>
        `)}
    `}};tt.styles=[fi];let C=tt;P([u({attribute:!1})],C.prototype,"files");P([u({attribute:!1})],C.prototype,"field");P([u({attribute:!1})],C.prototype,"staged");P([u({attribute:!1})],C.prototype,"stagedTaxonodes");P([u({attribute:!1})],C.prototype,"selected");P([u({attribute:!1})],C.prototype,"pendingOp");P([u({attribute:!1})],C.prototype,"config");P([u({attribute:!1})],C.prototype,"autocomplete");P([u({attribute:!1})],C.prototype,"taxonomyService");P([u({attribute:!1})],C.prototype,"ultratags");P([u({attribute:!1})],C.prototype,"defaultLanguage");customElements.define("sfx-bulk-meta-table",C);var _i=Object.defineProperty,z=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&_i(e,t,s),s};const it=class it extends A{constructor(){super(...arguments),this.taxonomyEntry=null,this.selected=!1,this.pendingOp=null,this.config=null,this._error=null,this._onFieldBlur=e=>{e.stopPropagation();const{value:t}=e.detail,i=xt(this.field,t,this.config??void 0);if(i){this._error=i;return}this._error=null;const s={meta:{...this.file.meta,[this.field.key]:this.value}},o=Ae(this.field,t,s,Q(this.field,this.config));JSON.stringify(o)!==JSON.stringify(this.value)&&this.dispatchEvent(new CustomEvent("row-field-change",{detail:{fileId:this.file.id,value:o},bubbles:!0,composed:!0}))},this._onTaxonomyEntryChange=e=>{e.stopPropagation(),this.dispatchEvent(new CustomEvent("row-taxonomy-entry",{detail:{fileId:this.file.id,fieldKey:e.detail.key,entry:e.detail.entry},bubbles:!0,composed:!0}))}}willUpdate(e){e.has("field")&&(this._error=null)}_onCheckboxChange(){this.dispatchEvent(new CustomEvent("row-toggle",{detail:{fileId:this.file.id},bubbles:!0,composed:!0}))}_computePreviewValue(){const e=this.pendingOp;return!e||!this.field?this.value:kt(this.field,this.value,e.value,e.operation,Q(this.field,this.config))}_getExtension(e){const t=e.lastIndexOf(".");return t>0?e.slice(t+1).toUpperCase():"?"}render(){var t,i;const e=this.file;return l`
      <div class="row">
        <div class="row-check">
          <input
            type="checkbox"
        ...
        ${e.previewUrl?l`<img class="row-thumb" src=${e.previewUrl} alt="" />`:l`<img class="row-thumb row-thumb-fallback"
              ...
              @error=${s=>{const o=s.target,r=Ot();!o.dataset.fallback&&o.src!==r&&(o.dataset.fallback="1",o.src=r)}}
            />`}
    ...
    `}};it.styles=[pi];let $=it;z([u({attribute:!1})],$.prototype,"file");z([u({attribute:!1})],$.prototype,"field");z([u({attribute:!1})],$.prototype,"value");z([u({attribute:!1})],$.prototype,"taxonomyEntry");z([u({type:Boolean})],$.prototype,"selected");z([u({attribute:!1})],$.prototype,"pendingOp");z([u({attribute:!1})],$.prototype,"config");z([u({attribute:!1})],$.prototype,"autocomplete");z([u({attribute:!1})],$.prototype,"taxonomyService");z([u({attribute:!1})],$.prototype,"ultratags");z([u({attribute:!1})],$.prototype,"defaultLanguage");z([x()],$.prototype,"_error");customElements.define("sfx-bulk-meta-row",$);const wi=new Set(["multi-select","tags","ultratags"]);function ut(a,e,t){return!e.regional_variants_group_uuid||a==null||typeof a!="object"||Array.isArray(a)?a:a[t??"en"]}function pt(a){return Array.isArray(a)?a:[]}function ht(a){return a==null||a===""||Array.isArray(a)&&a.length===0?!0:typeof a=="object"&&!Array.isArray(a)?!Object.values(a).some(e=>e!=null&&e!==""):!1}function Te(a,e){var i;const t=(i=a.possible_values)==null?void 0:i.find(s=>s.internal_unique_value===e||s.api_value===e);return(t==null?void 0:t.label)??String(e)}function ft(a,e){if(e==null||e==="")return"";switch(a.type){case"boolean":return e===!0?"True":e===!1?"False":"None";case"date":{if(typeof e!="string"||e.length===0)return"";try{return new Date(e+"T00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return e}}case"numeric":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:0}):String(e)}case"decimal2":{const t=Number(e);return Number.isFinite(t)?t.toLocaleString(void 0,{maximumFractionDigits:2}):String(e)}case"select-one":return Te(a,String(e));case"geopoint":{if(typeof e=="object"&&e!==null&&!Array.isArray(e)){const t=e;return!t.latitude&&!t.longitude?"":`(${t.latitude??""}, ${t.longitude??""})`}if(typeof e=="string"){const t=e.match(/^\((.+),(.+)\)$/);if(t)return`(${t[1].trim()}, ${t[2].trim()})`}return String(e)}default:return String(e)}}function ki(a,e){const t=a.map(n=>typeof n=="string"?n:String(n)),i=e.map(n=>typeof n=="string"?n:String(n)),s=new Set(t),o=new Set(i),r=[];for(const n of i)r.push({label:n,state:s.has(n)?"kept":"added"});for(const n of t)o.has(n)||r.push({label:n,state:"removed"});return r}function $i(a,e,t){const i=xe(a),s=xe(e),o=t||"en",r=h=>h.sid||h.slug||h.uuid||"",n=h=>ge({i18n:h.i18n,slug:h.slug||""},o,o).value||h.slug||h.sid||"",d=new Set(i.map(r).filter(Boolean)),c=new Set(s.map(r).filter(Boolean)),p=[];for(const h of s){const f=r(h);p.push({label:n(h),state:d.has(f)?"kept":"added"})}for(const h of i){const f=r(h);c.has(f)||p.push({label:n(h),state:"removed"})}return p}function Si(a,e,t){const i=new Set(a.map(r=>JSON.stringify(r))),s=new Set(e.map(r=>JSON.stringify(r))),o=[];for(const r of e){const n=JSON.stringify(r),d=typeof r=="string"?Te(t,r):String(r);o.push({label:d,state:i.has(n)?"kept":"added"})}for(const r of a){const n=JSON.stringify(r);if(!s.has(n)){const d=typeof r=="string"?Te(t,r):String(r);o.push({label:d,state:"removed"})}}return o}function Ci(a,e,t,i){const s=Q(a,i),o=i==null?void 0:i.language,r=ut(e,a,s),n=ut(t,a,s);if(wi.has(a.type)){if(a.type==="ultratags")return{kind:"array",items:$i(e,t,o)};const d=pt(r),c=pt(n);return a.type==="tags"?{kind:"array",items:ki(d,c)}:{kind:"array",items:Si(d,c,a)}}return{kind:"scalar",oldDisplay:ft(a,r),newDisplay:ft(a,n),oldEmpty:ht(r),newEmpty:ht(n)}}var Ei=Object.defineProperty,oe=(a,e,t,i)=>{for(var s=void 0,o=a.length-1,r;o>=0;o--)(r=a[o])&&(s=r(e,t,s)||s);return s&&Ei(e,t,s),s};const st=class st extends A{constructor(){super(...arguments),this.oldTaxonomyEntry=null,this.newTaxonomyEntry=null,this.config=null}_renderArrayDiff(e){return l`
    ...
    `}_renderTaxonomyScalar(){var r,n;const e=((r=this.newTaxonomyEntry)==null?void 0:r.path)??"",t=((n=this.oldTaxonomyEntry)==null?void 0:n.path)??"",i=!t,s=!e,o=`Will change from ${i?"empty":t} to ${s?"empty":e}`;return l`
      <div class="diff-wrap diff-scalar-text" aria-label="Bulk operation preview">
        <span class="sr-only">${o}</span>
        ${s?g:l`<span class="diff-new" aria-hidden="true">${e}</span>`}
      </div>
    `}render(){if(!this.field)return g;if(this.field.type==="taxonomy-node")return this._renderTaxonomyScalar();const e=Ci(this.field,this.oldValue,this.newValue,this.config);return e.kind==="array"?this._renderArrayDiff(e):this._renderScalarDiff(e)}};st.styles=[hi];let U=st;oe([u({attribute:!1})],U.prototype,"field");oe([u({attribute:!1})],U.prototype,"oldValue");oe([u({attribute:!1})],U.prototype,"newValue");oe([u({attribute:!1})],U.prototype,"oldTaxonomyEntry");oe([u({attribute:!1})],U.prototype,"newTaxonomyEntry");oe([u({attribute:!1})],U.prototype,"config");customElements.define("sfx-bulk-meta-diff-view",U);export{y as SfxBulkMetadataModal,Ai as clearSchemaCache,Oi as createTagsAutocomplete,Ri as createTaxonomyService,Li as createUltratagsService,qi as deepMergeMeta,Ti as fetchMetadataSchema,Pi as getFilesWithMissingRequired,Fi as isAssetHasMetadataValue,ee as isEmpty,vt as mapValueFromBackend,Ae as mapValueToBackend,bt as parseMetadataSchema,xt as validateField};
