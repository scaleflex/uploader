 ...
 */
export type UltratagsCreateItem =
  | string
...
export type UltratagsCreateMode =
  (typeof ULTRATAGS_CREATE_MODES)[keyof typeof ULTRATAGS_CREATE_MODES];
